...
void BrowseAndFillPhysicsSelectionOADB(Bool_t fill = kFALSE) {
  ...
  oadbDefaultPP->AddCollisionTriggerClass   ( AliVEvent::kZED,"+C1ZED-B-NOPF-CENTNOTRD", "B",  8);
  oadbDefaultPP->AddBGTriggerClass          ( AliVEvent::kZED,"+C1ZED-AC-NOPF-CENTNOTRD","AC", 8);
  oadbDefaultPP->AddBGTriggerClass          ( AliVEvent::kZED,"+C1ZED-E-NOPF-CENTNOTRD", "E",  8);
  oadbDefaultPP->SetHardwareTrigger         ( 8,"");
  oadbDefaultPP->SetOfflineTrigger          ( 8,"(ZDCTDCA || kZDCTDCC) !V0ABG && !V0CBG && !TPCLaserWarmUp");
