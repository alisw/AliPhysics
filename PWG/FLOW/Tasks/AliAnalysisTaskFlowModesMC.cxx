...
// AliAnalysisTaskFlowModesMC - ALICE Flow framework
//
...
#include "AliAnalysisTaskFlowModesMC.h"
#include "AliLog.h"
...
class AliAnalysisTaskFlowModesMC;

ClassImp(AliAnalysisTaskFlowModesMC); // classimp: necessary for root

Int_t AliAnalysisTaskFlowModesMC::fHarmonics[] = {2,3,4,5,6};
Int_t AliAnalysisTaskFlowModesMC::fMixedHarmonics[] = {422,633,523,6222};// 422: v4{psi2}, 523: v5{psi2, psi3}, 633: v6{psi3} and 6222: v6{psi2}

Double_t AliAnalysisTaskFlowModesMC::fEtaGap[] = {0.};//,0.4,0.8};



AliAnalysisTaskFlowModesMC::AliAnalysisTaskFlowModesMC() : AliAnalysisTaskSE(),
fEventAOD(0x0),
fEventMC(0x0),
fPIDResponse(0x0),
fPIDCombined(0x0),
...
fFlowCentMin(0),
fFlowCentMax(100),
fFlowCentNumBins(1000),
fImpactParameterMin(0),
fImpactParameterMax(50),
...
AliAnalysisTaskFlowModesMC::AliAnalysisTaskFlowModesMC(const char* name) : AliAnalysisTaskSE(name),
fEventAOD(0x0),
fEventMC(0x0),
fPIDResponse(0x0),
fPIDCombined(0x0),
...
//_____________________________________________________________________________
AliAnalysisTaskFlowModesMC::~AliAnalysisTaskFlowModesMC()
{
    // destructor
    // if(fPIDCombined)
    // {
...
//_____________________________________________________________________________
void AliAnalysisTaskFlowModesMC::UserCreateOutputObjects()
{
    ...
    fhEventSampling = new TH2D("fhEventSampling","Event sampling; centrality/multiplicity/impactParameter; sample index", fFlowCentNumBins,0,100, fNumSamples,0,fNumSamples);
    fQAEvents->Add(fhEventSampling);
    fhEventCentrality = new TH1D("fhEventCentrality",Form("Event centrality (%s); centrality/multiplicity/impactParameter",fMultEstimator.Data()), fFlowCentNumBins,0,100);
    fQAEvents->Add(fhEventCentrality);
    fh2EventCentralityNumSelCharged = new TH2D("fh2EventCentralityNumSelCharged",Form("Event centrality (%s) or impact parameter (b) vs. N^{sel}_{ch}; N^{sel}_{ch}; centrality/multiplicity/impactParameter",fMultEstimator.Data()), 3000,0,3000, fFlowCentNumBins,0,100);
    ...
    if(fAnalType == kAOD && fFlowUseNUAWeights)
    {
    ...
    if(fAnalType == kAOD && fFlowUseNUEWeights){
    ...
    fh2RefsMult = new TH2D("fh2RefsMult","RFPs: Centrality: Multiplicity; centrality; multiplicity",fFlowCentNumBins,0,100,1000,0,1000);
    fQACharged->Add(fh2RefsMult);
    fh2RefsPt = new TH2D("fh2RefsPt","RFPs: #it{p}_{T};  centrality; #it{p}_{T} (GeV/#it{c})",fFlowCentNumBins,0,100,300,0,30);
    fQACharged->Add(fh2RefsPt);
    fh2RefsEta = new TH2D("fh2RefsEta","RFPs: #eta; centrality; #eta",fFlowCentNumBins,0,100, 151,-1.5,1.5);
    fQACharged->Add(fh2RefsEta);
    fh2RefsPhi = new TH2D("fh2RefsPhi","RFPs: #varphi; centrality; #varphi",fFlowCentNumBins,0,100,100,0,TMath::TwoPi());
    ...
    if(fProcessPID)
    {
        fh2PIDPionMult = new TH2D("fh2PIDPionMult","PID: #pi: Multiplicity; centrality; multiplicity", fFlowCentNumBins,0,100,200,0,200);
        fQAPID->Add(fh2PIDPionMult);
        fh2PIDKaonMult = new TH2D("fh2PIDKaonMult","PID: K: Multiplicity; centrality; multiplicity", fFlowCentNumBins,0,100,100,0,100);
        fQAPID->Add(fh2PIDKaonMult);
        fh2PIDProtonMult = new TH2D("fh2PIDProtonMult","PID: p: Multiplicity; centrality; multiplicity", fFlowCentNumBins,0,100,100,0,100);
        fQAPID->Add(fh2PIDProtonMult);
        
        if(fFillQA)
        {
            fh2PIDPionPt = new TH2D("fh2PIDPionPt","PID: #pi: centrality vs. #it{p}_{T}; centrality; #it{p}_{T}", fFlowCentNumBins,0,100,150,0.,30.);
            fQAPID->Add(fh2PIDPionPt);
            fh2PIDPionPhi = new TH2D("fh2PIDPionPhi","PID: #pi: centrality vs. #varphi; centrality; #varphi", fFlowCentNumBins,0,100,100,0,TMath::TwoPi());
            fQAPID->Add(fh2PIDPionPhi);
            fh2PIDPionEta = new TH2D("fh2PIDPionEta","PID: #pi: centrality vs. #eta; centrality; #eta", fFlowCentNumBins,0,100,151,-1.5,1.5);
            ...
            fh2PIDKaonPt = new TH2D("fh2PIDKaonPt","PID: K: centrality vs. #it{p}_{T}; centrality; #it{p}_{T}", fFlowCentNumBins,0,100,150,0.,30.);
            fQAPID->Add(fh2PIDKaonPt);
            fh2PIDKaonPhi = new TH2D("fh2PIDKaonPhi","PID: K: centrality vs. #varphi; centrality; #varphi", fFlowCentNumBins,0,100,100,0,TMath::TwoPi());
            fQAPID->Add(fh2PIDKaonPhi);
            fh2PIDKaonEta = new TH2D("fh2PIDKaonEta","PID: K: centrality vs. #eta; centrality; #eta", fFlowCentNumBins,0,100,151,-1.5,1.5);
            fQAPID->Add(fh2PIDKaonEta);
            fhPIDKaonCharge = new TH1D("fhPIDKaonCharge","PID: K: charge; charge", 3,-1.5,1.5);
            fQAPID->Add(fhPIDKaonCharge);
            fh2PIDProtonPt = new TH2D("fh2PIDProtonPt","PID: p: centrality vs. #it{p}_{T}; centrality; #it{p}_{T}", fFlowCentNumBins,0,100,150,0.,30.);
            fQAPID->Add(fh2PIDProtonPt);
            fh2PIDProtonPhi = new TH2D("fh2PIDProtonPhi","PID: p: centrality vs. #varphi; centrality; #varphi", fFlowCentNumBins,0,100,100,0,TMath::TwoPi());
            fQAPID->Add(fh2PIDProtonPhi);
            fh2PIDProtonEta = new TH2D("fh2PIDProtonEta","PID: p: centrality vs. #eta; centrality; #eta", fFlowCentNumBins,0,100,151,-1.5,1.5);
    ...
    return;
}//AliAnalysisTaskFlowModesMC::UserCreateOutputObjects()
//_____________________________________________________________________________
void AliAnalysisTaskFlowModesMC::ListParameters()
{
...
//_____________________________________________________________________________
Bool_t AliAnalysisTaskFlowModesMC::InitializeTask()
{
    ...
    printf("====== InitializeTask AliAnalysisTaskFlowModesMC =========================\n");
    if(fAnalType != kESD && fAnalType != kAOD && fAnalType != kMC && fAnalType != kMCAOD)
    {
    ...
    if(fAnalType == kMCAOD)
    {
        ::Error("InitializeTask","Analysis type: MCAOD not implemented! Terminating!");
        return kFALSE;
    }
    ...
    if(fAnalType == kAOD){ //Add later kMCAOD
...
//_____________________________________________________________________________
void AliAnalysisTaskFlowModesMC::UserExec(Option_t *)
{
    ...
    // event selection
    if(fAnalType == kAOD) fEventAOD = dynamic_cast<AliAODEvent*>(InputEvent());

    if(fAnalType == kMC){fEventMC = dynamic_cast<AliMCEvent*>(MCEvent());}
...
//_____________________________________________________________________________
Bool_t AliAnalysisTaskFlowModesMC::EventSelection()
{
    ...
    if(fAnalType == kAOD && !fEventAOD) return kFALSE;
    if(fAnalType == kMC && !fEventMC) return kFALSE;
    // Fill event QA BEFORE cuts
    if(fAnalType == kAOD && fFillQA) FillEventsQA(0);
    if(fAnalType == kMC){
        AliAnalysisManager* mgr = AliAnalysisManager::GetAnalysisManager();
        AliInputEventHandler* inputHandler = (AliInputEventHandler*) mgr->GetInputEventHandler();
        eventSelected = kTRUE;
...
//_____________________________________________________________________________
Bool_t AliAnalysisTaskFlowModesMC::IsEventSelected_PbPb()
{
...
//_____________________________________________________________________________
Bool_t AliAnalysisTaskFlowModesMC::IsEventSelected_pp()
{
...
//_____________________________________________________________________________
void AliAnalysisTaskFlowModesMC::FillEventsQA(const Short_t iQAindex)
{
...
//_____________________________________________________________________________
Bool_t AliAnalysisTaskFlowModesMC::Filtering() //void
{
    ...
    if(fAnalType == kMC){
        ...
        if(fColSystem == kPbPb){
            fIndexImpactParameter = GetImpactParameter();
            if(fIndexImpactParameter < 0) return kFALSE; // return; not succesfull estimation

        }
        if(fColSystem == kPP){fIndexImpactParameter = 1;}
        fh2EventCentralityNumSelCharged->Fill(fVectorCharged->size(),fIndexImpactParameter);
        fhEventCentrality->Fill(fIndexImpactParameter);
        fIndexSampling = GetSamplingIndex();
        fhEventSampling->Fill(fIndexImpactParameter,fIndexSampling);
    }
...
//_____________________________________________________________________________
void AliAnalysisTaskFlowModesMC::FilterCharged()
{
    ...
    AliMCParticle* particle = 0x0;
    Int_t iNumRefs = 0;
    
    Double_t NUAweight = 0;
    Double_t NUEweight = 0;
    const Double_t iNumTracks = (fAnalType == kAOD) ? fEventAOD->GetNumberOfTracks() : fEventMC->GetNumberOfTracks();

    if(iNumTracks < 1) return;
    /*
     if(fAnalType == kAOD){
     if(fIndexCentrality>=0 && fIndexCentrality<10){
     Int_t c = fIndexCentrality/5;
     }else if(fIndexCentrality>=10 && fIndexCentrality<50){
     Int_t c = 1 + fIndexCentrality/10;
     }else if(fIndexCentrality>=50){ Int_t c = -1;}
     }else{Int_t c=-1;}
     */
    
    for(Double_t iTrack(0); iTrack < iNumTracks; iTrack++)
    {
        if(fAnalType == kMC){
            particle = static_cast<AliMCParticle*>(fEventMC->GetTrack(iTrack));
            if(fFillQA) FillQACharged(0,particle);
            fVectorCharged->emplace_back( FlowPart(particle->Pt(),particle->Phi(),particle->Eta(), particle->Charge(), kCharged) );
            if(fFillQA) FillQACharged(1,particle); // QA after selection

            if(fCutFlowRFPsPtMin > 0. && particle->Pt() >= fCutFlowRFPsPtMin && fCutFlowRFPsPtMax > 0. && particle->Pt() <= fCutFlowRFPsPtMax){ 
		iNumRefs++;
     		FillQARefs(1,particle);           
	    }
	}
        ...
        if(fAnalType == kAOD){
            ...
            if(fFlowUseNUEWeights){
                /*
                 ...
                 Int_t c = 1 + fIndexCentrality/10;
                 }else if(fIndexCentrality>=50){continue;}
                 */
                if(track->Charge()>0 && fIndexCentrality<50){NUEweight = fhNUEWeightChargedPlus[fIndexCentrality/10]->GetBinContent( fhNUEWeightChargedPlus[fIndexCentrality/10]->FindBin(track->Pt()));}
                if(track->Charge()<0 && fIndexCentrality<50){NUEweight = fhNUEWeightChargedMinus[fIndexCentrality/10]->GetBinContent( fhNUEWeightChargedMinus[fIndexCentrality/10]->FindBin(track->Pt()));}
            ...
            if(fCutFlowRFPsPtMin > 0. && track->Pt() >= fCutFlowRFPsPtMin && fCutFlowRFPsPtMax > 0. && track->Pt() <= fCutFlowRFPsPtMax)
            {
                ...
                if(fFlowUseNUEWeights)
                {
                     ...
                     */
                    if(track->Charge()>0 && fIndexCentrality<50){NUEweight = fhNUEWeightRefsPlus[fIndexCentrality/10]->GetBinContent( fhNUEWeightRefsPlus[fIndexCentrality/10]->FindBin(track->Pt()) );}
                    if(track->Charge()<0 && fIndexCentrality<50){NUEweight = fhNUEWeightRefsMinus[fIndexCentrality/10]->GetBinContent( fhNUEWeightRefsMinus[fIndexCentrality/10]->FindBin(track->Pt()) );}
    ...
    if(fAnalType == kAOD) fh2RefsMult->Fill(fIndexCentrality,iNumRefs);
    if(fAnalType == kMC) fh2RefsMult->Fill(fIndexImpactParameter,iNumRefs);
    
    if(fFillQA)
    {
        fhQAChargedMult[0]->Fill(iNumTracks);
...
//_____________________________________________________________________________
Bool_t AliAnalysisTaskFlowModesMC::IsChargedSelected(const AliAODTrack* track)
{
...
//_____________________________________________________________________________
void AliAnalysisTaskFlowModesMC::FillQARefs(const Short_t iQAindex, const AliAODTrack* track)
{
...
//_____________________________________________________________________________
void AliAnalysisTaskFlowModesMC::FillQARefs(const Short_t iQAindex, const AliMCParticle* particle)
{
    if(!particle) return;
    if(iQAindex == 0) return; // NOTE implemented only for selected RFPs

    fh2RefsPt->Fill(fIndexImpactParameter,particle->Pt());
    fh2RefsEta->Fill(fIndexImpactParameter,particle->Eta());
    fh2RefsPhi->Fill(fIndexImpactParameter,particle->Phi());
   
    return;
}
//_____________________________________________________________________________
void AliAnalysisTaskFlowModesMC::FillQACharged(const Short_t iQAindex, const AliAODTrack* track)
{
...
//_____________________________________________________________________________
void AliAnalysisTaskFlowModesMC::FillQACharged(const Short_t iQAindex, const AliMCParticle* particle)
{
    fhQAChargedPt[iQAindex]->Fill(particle->Pt());
    fhQAChargedPhi[iQAindex]->Fill(particle->Phi());
    fhQAChargedEta[iQAindex]->Fill(particle->Eta());

    return;
}
//_____________________________________________________________________________
void AliAnalysisTaskFlowModesMC::FilterPID()
{
    ...
    const Double_t iNumTracks = (fAnalType == kAOD) ? fEventAOD->GetNumberOfTracks() : fEventMC->GetNumberOfTracks();
    if(iNumTracks < 1) return;
    //if(fAnalType == kAOD) const Short_t iNumTracks = fEventAOD->GetNumberOfTracks();
    //if(fAnalType == kMC) const Short_t iNumTracks = fEventMC->GetNumberOfTracks();
    ...
    for(Double_t iTrack(0); iTrack < iNumTracks; iTrack++)
    {
        if(fAnalType == kAOD) track = static_cast<AliAODTrack*>(fEventAOD->GetTrack(iTrack));
        if(fAnalType == kMC) particle = static_cast<AliMCParticle*>(fEventMC->GetTrack(iTrack));
        if(fAnalType == kAOD && !track) continue;
        if(fAnalType == kMC && !particle) continue;
            ...
            switch (species)
            {
                case kPion:
                    ...
                    if(fFlowUseNUEWeights)
                    {
                         ...
                         */
                        if(track->Charge() > 0 && fIndexCentrality<50){ NUEweight = fhNUEWeightPionPlus[fIndexCentrality/10]->GetBinContent( fhNUEWeightPionPlus[fIndexCentrality/10]->FindBin(track->Pt()) );}
                        if(track->Charge() < 0 && fIndexCentrality<50){ NUEweight = fhNUEWeightPionMinus[fIndexCentrality/10]->GetBinContent( fhNUEWeightPionMinus[fIndexCentrality/10]->FindBin(track->Pt()) );}
                ...
                case kKaon:
                    ...
                    if(fFlowUseNUEWeights)
                    {
                         ...
                         */
                        if(track->Charge() > 0 && fIndexCentrality<50){ NUEweight = fhNUEWeightKaonPlus[fIndexCentrality/10]->GetBinContent( fhNUEWeightKaonPlus[fIndexCentrality/10]->FindBin(track->Pt()) );}
                        if(track->Charge() < 0 && fIndexCentrality<50){ NUEweight = fhNUEWeightKaonMinus[fIndexCentrality/10]->GetBinContent( fhNUEWeightKaonMinus[fIndexCentrality/10]->FindBin(track->Pt()) );}
                ...
                case kProton:
                    ...
                    if(fFlowUseNUEWeights)
                    {
                         ...
                         */
                        if(track->Charge() > 0 && fIndexCentrality<50){ NUEweight = fhNUEWeightProtonPlus[fIndexCentrality/10]->GetBinContent( fhNUEWeightProtonPlus[fIndexCentrality/10]->FindBin(track->Pt()) );}
                        if(track->Charge() < 0 && fIndexCentrality<50){ NUEweight = fhNUEWeightProtonMinus[fIndexCentrality/10]->GetBinContent( fhNUEWeightProtonMinus[fIndexCentrality/10]->FindBin(track->Pt()) );}
        ...
        if(fAnalType == kMC){
	    if(fFillQA) FillPIDQA(0,particle,kUnknown); // filling QA for tracks AFTER selection

            switch (TMath::Abs(particle->PdgCode())) {
                case 211:
                    species = kPion;
                    fVectorPion->emplace_back( FlowPart(particle->Pt(),particle->Phi(),particle->Eta(), particle->Charge(), kPion, fPDGMassPion, particle->Px(), particle->Py(), particle->Pz()) );
                    break;
                    
                case 321:
                    species = kKaon;
                    fVectorKaon->emplace_back( FlowPart(particle->Pt(),particle->Phi(),particle->Eta(), particle->Charge(), kKaon, fPDGMassKaon, particle->Px(), particle->Py(), particle->Pz()) );
                    break;
                    
                case 2212:
                    species = kProton;
                    fVectorProton->emplace_back( FlowPart(particle->Pt(),particle->Phi(),particle->Eta(), particle->Charge(), kProton, fPDGMassProton, particle->Px(), particle->Py(), particle->Pz()) );
                    break;
                    
                default:
                    break;
            }
            if(fFillQA) FillPIDQA(1,particle,species); // filling QA for tracks AFTER selection
        }
    }
    if(fAnalType == kAOD){
    ...
    if(fAnalType == kMC){
        fh2PIDPionMult->Fill(fIndexImpactParameter,fVectorPion->size());
        fh2PIDKaonMult->Fill(fIndexImpactParameter,fVectorKaon->size());
        fh2PIDProtonMult->Fill(fIndexImpactParameter,fVectorProton->size());
    }
...
//_____________________________________________________________________________
AliAnalysisTaskFlowModesMC::PartSpecies AliAnalysisTaskFlowModesMC::IsPIDSelected(const AliAODTrack* track)
{
    // Selection of PID tracks (pi,K,p) - track identification
    // nSigma cutting is used
    // returns AliAnalysisTaskFlowModesMC::PartSpecies enum : kPion, kKaon, kProton if any of this passed kUnknown otherwise
    // *************************************************************
...
//_____________________________________________________________________________
void AliAnalysisTaskFlowModesMC::FillPIDQA(const Short_t iQAindex, const AliAODTrack* track, const PartSpecies species)
{
...
//_____________________________________________________________________________
void AliAnalysisTaskFlowModesMC::FillPIDQA(const Short_t iQAindex, const AliMCParticle* particle, const PartSpecies species)
{
    switch (species)
    {
        case kPion:
            fh2PIDPionPt->Fill(fIndexImpactParameter,particle->Pt());
            fh2PIDPionPhi->Fill(fIndexImpactParameter,particle->Phi());
            fh2PIDPionEta->Fill(fIndexImpactParameter,particle->Eta());
            fhPIDPionCharge->Fill(particle->Charge());
            break;
        case kKaon:
            fh2PIDKaonPt->Fill(fIndexImpactParameter,particle->Pt());
            fh2PIDKaonPhi->Fill(fIndexImpactParameter,particle->Phi());
            fh2PIDKaonEta->Fill(fIndexImpactParameter,particle->Eta());
            fhPIDKaonCharge->Fill(particle->Charge());
	    break;
        case kProton:
            fh2PIDProtonPt->Fill(fIndexImpactParameter,particle->Pt());
            fh2PIDProtonPhi->Fill(fIndexImpactParameter,particle->Phi());
            fh2PIDProtonEta->Fill(fIndexImpactParameter,particle->Eta());
            fhPIDProtonCharge->Fill(particle->Charge());
            break;
	default:
	    break;
    }
...
//_____________________________________________________________________________
Bool_t AliAnalysisTaskFlowModesMC::ProcessEvent()
{
    ...
    if(fAnalType==kAOD){
        ...
        {
            TDirectory* dirFlowNUEWeights[5] = {0x0};
            
            const char* gCentrality[] = {"0-10cc","10-20cc","20-30cc","30-40cc","40-50cc"};
            for(int iCentrality = 0; iCentrality<fNumCentralities;iCentrality++){
    ...
    if(fVectorCharged->size() < 1) return kFALSE;
...
//_____________________________________________________________________________
void AliAnalysisTaskFlowModesMC::DoFlowRefs(const Short_t iEtaGapIndex)
{
        ...
        if(Cn2 != 0)
        {
            for(Short_t iHarm(0); iHarm < fNumHarmonics; iHarm++)
            {
                ...
                if( TMath::Abs(dValue < 1) )
                    if(fAnalType == kAOD) fpRefsCor2[fIndexSampling][iEtaGapIndex][iHarm]->Fill(fIndexCentrality, dValue, Cn2);
                if(fAnalType == kMC)  fpRefsCor2[fIndexSampling][iEtaGapIndex][iHarm]->Fill(fIndexImpactParameter, dValue, Cn2);
    ...
    if(fDoOnlyMixedCorrelations){
        ...
        if(Dn4GapP != 0)
        {
            ...
            if(fAnalType == kAOD) fpMixedRefsCor4[fIndexSampling][iEtaGapIndex][0]->Fill(fIndexCentrality, c4_2222_GapP, Dn4GapP);
            if(fAnalType == kMC)  fpMixedRefsCor4[fIndexSampling][iEtaGapIndex][0]->Fill(fIndexImpactParameter, c4_2222_GapP, Dn4GapP);
            ...
            if(fAnalType == kAOD) fpMixedRefsCor4[fIndexSampling][iEtaGapIndex][1]->Fill(fIndexCentrality, c4_3333_GapP, Dn4GapP);
            if(fAnalType == kMC)  fpMixedRefsCor4[fIndexSampling][iEtaGapIndex][1]->Fill(fIndexImpactParameter, c4_3333_GapP, Dn4GapP);
            ...
            if(fAnalType == kAOD) fpMixedRefsCor4[fIndexSampling][iEtaGapIndex][2]->Fill(fIndexCentrality, c4_3232_GapP, Dn4GapP);
            if(fAnalType == kMC)  fpMixedRefsCor4[fIndexSampling][iEtaGapIndex][2]->Fill(fIndexImpactParameter, c4_3232_GapP, Dn4GapP);
        }
        //estimating <6>
        ...
        if(Dn6GapP != 0)
        {
            ...
            if(fAnalType == kAOD) fpMixedRefsCor6[fIndexSampling][iEtaGapIndex]->Fill(fIndexCentrality, c6_222222_GapP, Dn6GapP);
            if(fAnalType == kMC)  fpMixedRefsCor6[fIndexSampling][iEtaGapIndex]->Fill(fIndexImpactParameter, c6_222222_GapP, Dn6GapP);
        }
    }
    return;
}
//_____________________________________________________________________________
void AliAnalysisTaskFlowModesMC::DoFlowCharged(const Short_t iEtaGapIndex)
{
        ...
        if(!fDoOnlyMixedCorrelations){
            ...
            if(Dn2 != 0)
            {
                for(Short_t iHarm(0); iHarm < fNumHarmonics; iHarm++)
                {
                    ...
                    if( TMath::Abs(dValue < 1) )
                        if(fAnalType == kAOD) fp2ChargedCor2Pos[fIndexSampling][iEtaGapIndex][iHarm]->Fill(fIndexCentrality, iPt*dPtBinWidth, dValue, Dn2);
                    if(fAnalType == kMC)  fp2ChargedCor2Pos[fIndexSampling][iEtaGapIndex][iHarm]->Fill(fIndexImpactParameter, iPt*dPtBinWidth, dValue, Dn2);
                }
            }
            ...
            if(Dn2 != 0)
            {
                for(Short_t iHarm(0); iHarm < fNumHarmonics; iHarm++)
                {
                    ...
                    dValue = vector.Re()/Dn2;
                    if( TMath::Abs(dValue < 1) )
                        if(fAnalType == kAOD) fp2ChargedCor2Neg[fIndexSampling][iEtaGapIndex][iHarm]->Fill(fIndexCentrality, iPt*dPtBinWidth, dValue, Dn2);
                    if(fAnalType == kMC)  fp2ChargedCor2Neg[fIndexSampling][iEtaGapIndex][iHarm]->Fill(fIndexImpactParameter, iPt*dPtBinWidth, dValue, Dn2);
                }
            }
        }
        if(fDoOnlyMixedCorrelations){
            ...
            if(DDn3GapP!=0)
            {
                for(Short_t iMixedHarm(0); iMixedHarm < fNumMixedHarmonics-1; iMixedHarm++)
                {
                    ...
                    if( TMath::Abs(dValue < 1) ){
                        if(fAnalType == kAOD) fpMixedChargedCor3Pos[fIndexSampling][iEtaGapIndex][iMixedHarm]->Fill(fIndexCentrality,iPt*dPtBinWidth, dValue, DDn3GapP);
                        if(fAnalType == kMC) fpMixedChargedCor3Pos[fIndexSampling][iEtaGapIndex][iMixedHarm]->Fill(fIndexImpactParameter,iPt*dPtBinWidth, dValue, DDn3GapP);
                    }
                }
            }
            // POIs in negative eta
            ...
            if(DDn3GapP!=0)
            {
                for(Short_t iMixedHarm(0); iMixedHarm < fNumMixedHarmonics-1; iMixedHarm++)
                {
                    ...
                    dValue = vector.Re()/DDn3GapP;
                    if( TMath::Abs(dValue < 1) ){
                        if(fAnalType == kAOD) fpMixedChargedCor3Neg[fIndexSampling][iEtaGapIndex][iMixedHarm]->Fill(fIndexCentrality,iPt*dPtBinWidth, dValue, DDn3GapP);
                        if(fAnalType == kMC)  fpMixedChargedCor3Neg[fIndexSampling][iEtaGapIndex][iMixedHarm]->Fill(fIndexImpactParameter,iPt*dPtBinWidth, dValue, DDn3GapP);
                    }
                }
            }
            // estimating <4'>
            ...
            if(DDn4GapP!=0)
            {
                ...
                if( TMath::Abs(dValue < 1) ){
                    if(fAnalType == kAOD) fpMixedChargedCor4Pos[fIndexSampling][iEtaGapIndex]->Fill(fIndexCentrality,iPt*dPtBinWidth, dValue, DDn4GapP);
                    if(fAnalType == kMC)  fpMixedChargedCor4Pos[fIndexSampling][iEtaGapIndex]->Fill(fIndexImpactParameter,iPt*dPtBinWidth, dValue, DDn4GapP);
                }
            }
            // POIs in negative eta
            ...
            if(DDn4GapP!=0)
            {
                ...
                if( TMath::Abs(dValue < 1) ){
                    if(fAnalType == kAOD) fpMixedChargedCor4Neg[fIndexSampling][iEtaGapIndex]->Fill(fIndexCentrality,iPt*dPtBinWidth, dValue, DDn4GapP);
                    if(fAnalType == kMC) fpMixedChargedCor4Neg[fIndexSampling][iEtaGapIndex]->Fill(fIndexImpactParameter,iPt*dPtBinWidth, dValue, DDn4GapP);
                }
            }
        }
    } // endfor {iPt}
...
//_____________________________________________________________________________
void AliAnalysisTaskFlowModesMC::DoFlowPID(const Short_t iEtaGapIndex, const PartSpecies species)
{
        ...
        if(!fDoOnlyMixedCorrelations){
            ...
            if(Dn2 != 0)
            {
                for(Short_t iHarm(0); iHarm < fNumHarmonics; iHarm++)
                {
                    ...
                    dValue = vector.Re()/Dn2;
                    if( TMath::Abs(dValue < 1) ){
                        if(fAnalType == kAOD) profile2Pos[iHarm]->Fill(fIndexCentrality, iPt*dPtBinWidth, dValue, Dn2);
                        if(fAnalType == kMC) profile2Pos[iHarm]->Fill(fIndexImpactParameter, iPt*dPtBinWidth, dValue, Dn2);
                    }
                }
            }
            // POIs in negative eta
            ...
            if(Dn2 != 0)
            {
                for(Short_t iHarm(0); iHarm < fNumHarmonics; iHarm++)
                {
                    ...
                    dValue = vector.Re()/Dn2;
                    if( TMath::Abs(dValue < 1) ){
                        if(fAnalType == kAOD) profile2Neg[iHarm]->Fill(fIndexCentrality, iPt*dPtBinWidth, dValue, Dn2);
                        if(fAnalType == kMC) profile2Neg[iHarm]->Fill(fIndexImpactParameter, iPt*dPtBinWidth, dValue, Dn2);
                    }
                }
            }
        }
        if(fDoOnlyMixedCorrelations){
            ...
            if(DDn3GapP!=0)
            {
                for(Short_t iMixedHarm(0); iMixedHarm < fNumMixedHarmonics-1; iMixedHarm++)
                {
                    ...
                    dValue = vector.Re()/DDn3GapP;
                    if( TMath::Abs(dValue < 1) ){
                        if(fAnalType == kAOD) profile3Pos[iMixedHarm]->Fill(fIndexCentrality,iPt*dPtBinWidth, dValue, DDn3GapP);
                        if(fAnalType == kMC) profile3Pos[iMixedHarm]->Fill(fIndexImpactParameter,iPt*dPtBinWidth, dValue, DDn3GapP);
                    }
                }
            }
            // POIs in negative eta
            ...
            if(DDn3GapP!=0)
            {
                ...
                {   
                    ...
                    dValue = vector.Re()/DDn3GapP;
                    if( TMath::Abs(dValue < 1) ){
                        if(fAnalType == kAOD) profile3Neg[iMixedHarm]->Fill(fIndexCentrality,iPt*dPtBinWidth, dValue, DDn3GapP);
                        if(fAnalType == kMC) profile3Neg[iMixedHarm]->Fill(fIndexImpactParameter,iPt*dPtBinWidth, dValue, DDn3GapP);
                    }
                }
            }
            ...
            if(DDn4GapP!=0)
            {
                ...
                if( TMath::Abs(dValue < 1) ){
                    if(fAnalType == kAOD) profile4Pos->Fill(fIndexCentrality,iPt*dPtBinWidth, dValue, DDn4GapP);
                    if(fAnalType == kMC) profile4Pos->Fill(fIndexImpactParameter,iPt*dPtBinWidth, dValue, DDn4GapP);
                }
            }
            //POIs in negative eta
            DDn4GapP = Four13DiffGapNeg(0,0,0,0,iPt).Re();
            if(DDn4GapP!=0)
            {
                ...
                dValue = vector.Re()/DDn4GapP;
                if( TMath::Abs(dValue < 1) ){
                    if(fAnalType == kAOD) profile4Neg->Fill(fIndexCentrality,iPt*dPtBinWidth, dValue, DDn4GapP);
                    if(fAnalType == kMC) profile4Neg->Fill(fIndexImpactParameter,iPt*dPtBinWidth, dValue, DDn4GapP);
                }
            }
        }
    } // endfor {iPt}
...
void AliAnalysisTaskFlowModesMC::FillRefsVectors(const Short_t iEtaGapIndex)
{
    ...
    for (auto part = fVectorCharged->begin(); part != fVectorCharged->end(); part++)
    {
        ...
        if(fAnalType == kAOD && fFlowUseNUEWeights)
        {
            if(part->charge >0 && fIndexCentrality<50) hNUEWeights = fhNUEWeightRefsPlus[fIndexCentrality/10];
            if(part->charge <0 && fIndexCentrality<50) hNUEWeights = fhNUEWeightRefsMinus[fIndexCentrality/10];
        ...
        if(fAnalType == kAOD && fFlowUseNUAWeights && h3NUAWeights)
        {
        ...
        if(fAnalType == kAOD && fFlowUseNUEWeights && hNUEWeights)
        {
...
//_____________________________________________________________________________
void AliAnalysisTaskFlowModesMC::FillPOIsVectors(const Short_t iEtaGapIndex, const PartSpecies species, const Short_t iMassIndex)
{
        ...
        if(fAnalType == kAOD){
            ...
            switch (species)
            {
                case kCharged:
                    ...
                    if(fFlowUseNUEWeights) {
                        if(part->charge >0 && fIndexCentrality<50) hNUEWeights = fhNUEWeightChargedPlus[fIndexCentrality/10];
                        if(part->charge <0 && fIndexCentrality<50) hNUEWeights = fhNUEWeightChargedMinus[fIndexCentrality/10];
                    }
                    break;
                ...
                case kPion:
                    ...
                    if(fFlowUseNUEWeights) {
                        if(part->charge >0 && fIndexCentrality<50) hNUEWeights = fhNUEWeightPionPlus[fIndexCentrality/10];
                        if(part->charge <0 && fIndexCentrality<50) hNUEWeights = fhNUEWeightPionMinus[fIndexCentrality/10];
                    }
                    break;
                ...
                case kKaon:
                    ...
                    if(fFlowUseNUEWeights) {
                        if(part->charge >0 && fIndexCentrality<50) hNUEWeights = fhNUEWeightKaonPlus[fIndexCentrality/10];
                        if(part->charge <0 && fIndexCentrality<50) hNUEWeights = fhNUEWeightKaonMinus[fIndexCentrality/10];
                    }
                    break;
                ...
                case kProton:
                    ...
                    if(fFlowUseNUEWeights) {
                        if(part->charge >0 && fIndexCentrality<50) hNUEWeights = fhNUEWeightProtonPlus[fIndexCentrality/10];
                        if(part->charge <0 && fIndexCentrality<50) hNUEWeights = fhNUEWeightProtonMinus[fIndexCentrality/10];
                    }
                    break;
...
//_____________________________________________________________________________
Short_t AliAnalysisTaskFlowModesMC::GetPOIsPtBinIndex(const Double_t pt)
{
...
//_____________________________________________________________________________
void AliAnalysisTaskFlowModesMC::ResetRFPsVector(TComplex (&array)[fFlowNumHarmonicsMax][fFlowNumWeightPowersMax])
{
...
//_____________________________________________________________________________
void AliAnalysisTaskFlowModesMC::ResetPOIsVector(TComplex (&array)[fFlowNumHarmonicsMax][fFlowNumWeightPowersMax][fFlowPOIsPtNumBins])
{
    for(Short_t iHarm(0); iHarm < fFlowNumHarmonicsMax; iHarm++)
        for(Short_t iPower(0); iPower < fFlowNumWeightPowersMax; iPower++)
            for(Short_t iPt(0); iPt < fFlowPOIsPtNumBins; iPt++)
...
//_____________________________________________________________________________
void AliAnalysisTaskFlowModesMC::ListFlowVector(TComplex (&array)[fFlowNumHarmonicsMax][fFlowNumWeightPowersMax])
{
...
//_____________________________________________________________________________
Short_t AliAnalysisTaskFlowModesMC::GetSamplingIndex()
{
...
//_____________________________________________________________________________
Short_t AliAnalysisTaskFlowModesMC::GetCentralityIndex()
{
...
//_____________________________________________________________________________
Double_t AliAnalysisTaskFlowModesMC::GetImpactParameter()
{
    if(fAnalType == kMC){
        if(fCutImpactParameter) {
            Double_t gImpactParameter = 0.;
            if(fEventMC) {
                AliCollisionGeometry* headerH = dynamic_cast<AliCollisionGeometry*>(dynamic_cast<AliMCEvent*>(fEventMC)->GenEventHeader());
                if(headerH) gImpactParameter = headerH->ImpactParameter();
            }
            if ((gImpactParameter > fImpactParameterMin) && (gImpactParameter < fImpactParameterMax )) return gImpactParameter;
            if ((gImpactParameter < fImpactParameterMin) || (gImpactParameter >= fImpactParameterMax )) return -1;
        }
    }
    return -1;
}
//____________________________
Double_t AliAnalysisTaskFlowModesMC::GetWDist(const AliAODVertex* v0, const AliAODVertex* v1) {
...
void AliAnalysisTaskFlowModesMC::Terminate(Option_t* option)
{
...
TComplex AliAnalysisTaskFlowModesMC::Q(const Short_t n, const Short_t p)
{
    if (n < 0) return TComplex::Conjugate(fFlowVecQpos[-n][p]);
    else return fFlowVecQpos[n][p];
}
//____________________________________________________________________
TComplex AliAnalysisTaskFlowModesMC::QGapPos(const Short_t n, const Short_t p)
{
    if (n < 0) return TComplex::Conjugate(fFlowVecQpos[-n][p]);
    else return fFlowVecQpos[n][p];
}
//____________________________________________________________________
TComplex AliAnalysisTaskFlowModesMC::QGapNeg(const Short_t n, const Short_t p)
{
    if(n < 0) return TComplex::Conjugate(fFlowVecQneg[-n][p]);
    else return fFlowVecQneg[n][p];
}
//____________________________________________________________________
TComplex AliAnalysisTaskFlowModesMC::P(const Short_t n, const Short_t p, const Short_t pt)
{
    if(n < 0) return TComplex::Conjugate(fFlowVecPpos[-n][p][pt]);
    else return fFlowVecPpos[n][p][pt];
}
//____________________________________________________________________
TComplex AliAnalysisTaskFlowModesMC::PGapPos(const Short_t n, const Short_t p, const Short_t pt)
{
    if(n < 0) return TComplex::Conjugate(fFlowVecPpos[-n][p][pt]);
    else return fFlowVecPpos[n][p][pt];
}
//____________________________________________________________________
TComplex AliAnalysisTaskFlowModesMC::PGapNeg(const Short_t n, const Short_t p, const Short_t pt)
{
    if(n < 0) return TComplex::Conjugate(fFlowVecPneg[-n][p][pt]);
    else return fFlowVecPneg[n][p][pt];
}
//____________________________________________________________________
TComplex AliAnalysisTaskFlowModesMC::S(const Short_t n, const Short_t p, const Short_t pt)
{
...
TComplex AliAnalysisTaskFlowModesMC::Two(const Short_t n1, const Short_t n2)
{
    TComplex formula = Q(n1,1)*Q(n2,1) - Q(n1+n2,2);
    return formula;
}
//____________________________________________________________________
TComplex AliAnalysisTaskFlowModesMC::TwoGap(const Short_t n1, const Short_t n2)
{
    TComplex formula = QGapPos(n1,1)*QGapNeg(n2,1);
    return formula;
}
//____________________________________________________________________
TComplex AliAnalysisTaskFlowModesMC::TwoDiff(const Short_t n1, const Short_t n2, const Short_t pt)
{
    TComplex formula = P(n1,1,pt)*Q(n2,1) - S(n1+n2,1,pt);
    return formula;
}
//____________________________________________________________________
TComplex AliAnalysisTaskFlowModesMC::TwoDiffGapPos(const Short_t n1, const Short_t n2, const Short_t pt)
{
    TComplex formula = PGapPos(n1,1,pt)*QGapNeg(n2,1);
    return formula;
}
//____________________________________________________________________
TComplex AliAnalysisTaskFlowModesMC::TwoDiffGapNeg(const Short_t n1, const Short_t n2, const Short_t pt)
{
    TComplex formula = PGapNeg(n1,1,pt)*QGapPos(n2,1);
    return formula;
}
//____________________________________________________________________
TComplex AliAnalysisTaskFlowModesMC::ThreeDiffGapPos(const Short_t n1, const Short_t n2, const Short_t n3,const Short_t pt)
{
    TComplex formula = PGapPos(n1,1,pt)*QGapNeg(n2,1)*QGapNeg(n3,1)- PGapPos(n1,1,pt)*QGapNeg(n2+n3,2);
    return formula;
}
//____________________________________________________________________
TComplex AliAnalysisTaskFlowModesMC::ThreeDiffGapNeg(const Short_t n1, const Short_t n2, const Short_t n3,const Short_t pt)
{
    TComplex formula = PGapNeg(n1,1,pt)*QGapPos(n2,1)*QGapPos(n3,1)- PGapNeg(n1,1,pt)*QGapPos(n2+n3,2);
    return formula;
}
//____________________________________________________________________
TComplex AliAnalysisTaskFlowModesMC::Four(const Short_t n1, const Short_t n2, const Short_t n3, const Short_t n4)
{
...
// //____________________________________________________________________
TComplex AliAnalysisTaskFlowModesMC::FourDiff(const Short_t n1, const Short_t n2, const Short_t n3, const Short_t n4, const Short_t pt)
{
...
//____________________________________________________________________
TComplex AliAnalysisTaskFlowModesMC::FourGapPos(const Short_t n1, const Short_t n2, const Short_t n3, const Short_t n4) //  n1+n2 = n3+n4;  n1, n2 from P & n3, n4 from M
{
...
//____________________________________________________________________
TComplex AliAnalysisTaskFlowModesMC::FourGapNeg(const Short_t n1, const Short_t n2, const Short_t n3, const Short_t n4) //  n1+n2 = n3+n4;  n1, n2 from M & n3, n4 from P
{
...
//____________________________________________________________________
TComplex AliAnalysisTaskFlowModesMC::Four13DiffGapPos(const Short_t n1, const Short_t n2, const Short_t n3, const Short_t n4,const Short_t pt) // n1 = n2 + n3 + n4
{
...
//____________________________________________________________________
TComplex AliAnalysisTaskFlowModesMC::Four13DiffGapNeg(const Short_t n1, const Short_t n2, const Short_t n3, const Short_t n4,const Short_t pt) // n1 = n2 + n3 + n4
{
...
//____________________________________________________________________
TComplex AliAnalysisTaskFlowModesMC::SixGapPos(const Short_t n1, const Short_t n2, const Short_t n3, const Short_t n4, const Short_t n5, const Short_t n6) // n1 + n2 + n3 = n4 + n5 + n6
{
...
//____________________________________________________________________
TComplex AliAnalysisTaskFlowModesMC::SixGapNeg(const Short_t n1, const Short_t n2, const Short_t n3, const Short_t n4, const Short_t n5, const Short_t n6) // n1 + n2 + n3 = n4 + n5 + n6
{
...
//-----------------------------------------------------------------------
void AliAnalysisTaskFlowModesMC::SetPriors(Float_t centrCur){
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
Bool_t AliAnalysisTaskFlowModesMC::TPCTOFagree(const AliVTrack *track)
{
