...
#ifndef ALIANALYSISTASKCMWPUeqAch_H
#define ALIANALYSISTASKCMWPUeqAch_H
...
class AliAnalysisTaskCMWPUeqAch : public AliAnalysisTaskSE {

 public:

  //-----> Mandatory Functions:
  AliAnalysisTaskCMWPUeqAch();
  AliAnalysisTaskCMWPUeqAch(const char *name);
  virtual ~AliAnalysisTaskCMWPUeqAch();
 ...
 private:
  ...
  AliAnalysisTaskCMWPUeqAch(const AliAnalysisTaskCMWPUeqAch &other);
  AliAnalysisTaskCMWPUeqAch &operator=(const AliAnalysisTaskCMWPUeqAch &other);    
  ClassDef(AliAnalysisTaskCMWPUeqAch, 1) 
