...
#ifndef ALIANALYSISTASKCMWPU2018eqAchCLdca_H
#define ALIANALYSISTASKCMWPU2018eqAchCLdca_H
...
class AliAnalysisTaskCMWPU2018eqAchCLdca : public AliAnalysisTaskSE {

 public:

  //-----> Mandatory Functions:
  AliAnalysisTaskCMWPU2018eqAchCLdca();
  AliAnalysisTaskCMWPU2018eqAchCLdca(const char *name);
  virtual ~AliAnalysisTaskCMWPU2018eqAchCLdca();
 ...
 private:
  ...
  AliAnalysisTaskCMWPU2018eqAchCLdca(const AliAnalysisTaskCMWPU2018eqAchCLdca &other);
  AliAnalysisTaskCMWPU2018eqAchCLdca &operator=(const AliAnalysisTaskCMWPU2018eqAchCLdca &other);    
  ClassDef(AliAnalysisTaskCMWPU2018eqAchCLdca, 1) 
