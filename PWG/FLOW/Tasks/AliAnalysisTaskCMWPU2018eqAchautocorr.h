...
#ifndef ALIANALYSISTASKCMWPU2018eqAchautocorr_H
#define ALIANALYSISTASKCMWPU2018eqAchautocorr_H
...
class AliAnalysisTaskCMWPU2018eqAchautocorr : public AliAnalysisTaskSE {

 public:

  //-----> Mandatory Functions:
  AliAnalysisTaskCMWPU2018eqAchautocorr();
  AliAnalysisTaskCMWPU2018eqAchautocorr(const char *name);
  virtual ~AliAnalysisTaskCMWPU2018eqAchautocorr();
  ...
  void SetEtaRangeMinAch(Double_t emnAch)        {this->fMinEtaCutAch   = emnAch;}
  void SetEtaRangeMaxAch(Double_t emxAch)        {this->fMaxEtaCutAch   = emxAch;}
 ...
 private:
  ...
  Float_t              fMinEtaCut;  //
  Float_t              fMaxEtaCut;  //
  Float_t              fMinEtaCutAch;  //
  Float_t              fMaxEtaCutAch;  //
  Float_t             fTrkChi2Min;  //
  Float_t                fdEdxMin;  // 
  ...
  */
  ...
  AliAnalysisTaskCMWPU2018eqAchautocorr(const AliAnalysisTaskCMWPU2018eqAchautocorr &other);
  AliAnalysisTaskCMWPU2018eqAchautocorr &operator=(const AliAnalysisTaskCMWPU2018eqAchautocorr &other);    
  ClassDef(AliAnalysisTaskCMWPU2018eqAchautocorr, 1) 
