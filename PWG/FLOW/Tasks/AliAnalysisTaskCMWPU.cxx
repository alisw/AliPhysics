...
#include "AliAnalysisTaskCMWPU.h"
...
ClassImp(AliAnalysisTaskCMWPU)

AliAnalysisTaskCMWPU::AliAnalysisTaskCMWPU(const char *name): AliAnalysisTaskSE(name),
  fVevent(NULL),
  fESD(NULL),
  fAOD(NULL),
  fPIDResponse(NULL),
...
AliAnalysisTaskCMWPU::AliAnalysisTaskCMWPU():
  fVevent(NULL),
  fESD(NULL),
  fAOD(NULL),
  fPIDResponse(NULL),
...
void AliAnalysisTaskCMWPU::UserCreateOutputObjects()
{
...
void AliAnalysisTaskCMWPU::UserExec(Option_t*) {
...
Bool_t AliAnalysisTaskCMWPU::CheckEventIsPileUp(AliAODEvent *faod) {
...
Bool_t AliAnalysisTaskCMWPU::PileUpMultiVertex(const AliAODEvent* faod)
...
double AliAnalysisTaskCMWPU::GetWDist(const AliVVertex* v0, const AliVVertex* v1)
{
...
void AliAnalysisTaskCMWPU::SetupEventAndTaskConfigInfo(){
...
Int_t AliAnalysisTaskCMWPU::GetCentralityScaled0to10(Double_t fCent){
...
void AliAnalysisTaskCMWPU::GetNUACorrectionHist(Int_t run, Int_t kParticleID)
{
...
void AliAnalysisTaskCMWPU::GetMCCorrectionHist(Int_t run,Float_t centr){
