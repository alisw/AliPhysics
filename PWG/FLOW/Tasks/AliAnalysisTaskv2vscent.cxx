...
#include "AliAnalysisTaskv2vscent.h"
...
ClassImp(AliAnalysisTaskv2vscent)

AliAnalysisTaskv2vscent::AliAnalysisTaskv2vscent(const char *name): AliAnalysisTaskSE(name),
  fVevent(NULL),
  fESD(NULL),
  fAOD(NULL),
  fPIDResponse(NULL),
...
//bSkipNUA(kFALSE), 
  ...
  fHistv2cumCentChrgPos(NULL),
  fHistv2cumCentChrgNeg(NULL),
  fHistv2cumCentChrgPosChrgNeg(NULL),
  fHistv2cumCentChrgNegChrgPos(NULL),
  fHistv2cumCentPionPos(NULL),
  fHistv2cumCentPionNeg(NULL),
  fHistv2cumCentPionPosPionNeg(NULL),
  fHistv2cumCentPionNegPionPos(NULL),
...
AliAnalysisTaskv2vscent::AliAnalysisTaskv2vscent():
  fVevent(NULL),
  fESD(NULL),
  fAOD(NULL),
  fPIDResponse(NULL),
...
void AliAnalysisTaskv2vscent::UserCreateOutputObjects()
{
  ...
  sprintf(name,"fHistv2cumCentChrgPosQcumCent%d",0);
  sprintf(title,"Cent %2.0f-%2.0f; p_{T}; v_{2}",centRange[0],centRange[1]);
  fHistv2cumCentChrgPos = new TProfile(name,title,18,0,90,"");
  fHistv2cumCentChrgPos ->Sumw2();
  fListHist->Add(fHistv2cumCentChrgPos);


  sprintf(name,"fHistv2cumCentChrgNegQcumCent%d",0);
  sprintf(title,"Cent %2.0f-%2.0f; p_{T}; v_{2}",centRange[0],centRange[1]);
  fHistv2cumCentChrgNeg = new TProfile(name,title,18,0,90,"");
  fHistv2cumCentChrgNeg ->Sumw2();
  fListHist->Add(fHistv2cumCentChrgNeg);

  sprintf(name,"fHistv2cumCentChrgPosChrgNegQcumCent%d",0);
  sprintf(title,"Cent %2.0f-%2.0f; p_{T}; v_{2}",centRange[0],centRange[1]);
  fHistv2cumCentChrgPosChrgNeg = new TProfile(name,title,18,0,90,"");
  fHistv2cumCentChrgPosChrgNeg ->Sumw2();
  fListHist->Add(fHistv2cumCentChrgPosChrgNeg);

  sprintf(name,"fHistv2cumCentChrgNegChrgPosQcumCent%d",0);
  sprintf(title,"Cent %2.0f-%2.0f; p_{T}; v_{2}",centRange[0],centRange[1]);
  fHistv2cumCentChrgNegChrgPos = new TProfile(name,title,18,0,90,"");
  fHistv2cumCentChrgNegChrgPos ->Sumw2();
  fListHist->Add(fHistv2cumCentChrgNegChrgPos);




  sprintf(name,"fHistv2cumCentPionPosQcumCent%d",0);
  sprintf(title,"Cent %2.0f-%2.0f; p_{T}; v_{2}",centRange[0],centRange[1]);
  fHistv2cumCentPionPos = new TProfile(name,title,18,0,90,"");
  fHistv2cumCentPionPos ->Sumw2();
  fListHist->Add(fHistv2cumCentPionPos);


  sprintf(name,"fHistv2cumCentPionNegQcumCent%d",0);
  sprintf(title,"Cent %2.0f-%2.0f; p_{T}; v_{2}",centRange[0],centRange[1]);
  fHistv2cumCentPionNeg = new TProfile(name,title,18,0,90,"");
  fHistv2cumCentPionNeg ->Sumw2();
  fListHist->Add(fHistv2cumCentPionNeg);

  sprintf(name,"fHistv2cumCentPionPosPionNegQcumCent%d",0);
  sprintf(title,"Cent %2.0f-%2.0f; p_{T}; v_{2}",centRange[0],centRange[1]);
  fHistv2cumCentPionPosPionNeg = new TProfile(name,title,18,0,90,"");
  fHistv2cumCentPionPosPionNeg ->Sumw2();
  fListHist->Add(fHistv2cumCentPionPosPionNeg);

  sprintf(name,"fHistv2cumCentPionNegPionPosQcumCent%d",0);
  sprintf(title,"Cent %2.0f-%2.0f; p_{T}; v_{2}",centRange[0],centRange[1]);
  fHistv2cumCentPionNegPionPos = new TProfile(name,title,18,0,90,"");
  fHistv2cumCentPionNegPionPos ->Sumw2();
  fListHist->Add(fHistv2cumCentPionNegPionPos);
...
void AliAnalysisTaskv2vscent::UserExec(Option_t*) {
  ...
  fHistv2cumCentChrgAll->Fill(centrality, c2cumulantChrg, c2WeightChrg*eventwgtcharge);   /// for denominator
    }
  ...
  if((NumOfChrgPosEtaPos*fSumWgtEtaNeg)!=0.0){
    ...
    fHistv2cumCentChrgPos->Fill(centrality, c2cumulantChrgPos, c2WeightChrgPos*eventwgtcharge);   /// for denominator
  }
  ...
  if((NumOfChrgNegEtaPos*fSumWgtEtaNegChNeg)!=0.0){  
    ...
    fHistv2cumCentChrgNeg->Fill(centrality, c2cumulantChrgNeg, c2WeightChrgNeg*eventwgtcharge);   /// for denominator
  }
...
Double_t c2cumulantChrgPosChrgNeg =  (sumQ2xChrgPosEtaPos*fSumTPCQn2xNegChNeg + sumQ2yChrgPosEtaPos*fSumTPCQn2yNegChNeg)/c2WeightChrgPosChrgNeg;
 fHistv2cumCentChrgPosChrgNeg->Fill(centrality, c2cumulantChrgPosChrgNeg, c2WeightChrgPosChrgNeg*eventwgtcharge);   /// for denominator
  }
  ...
  if((c2WeightChrgNegChrgPos)!=0.0){  
    ...
    fHistv2cumCentChrgNegChrgPos->Fill(centrality, c2cumulantChrgNegChrgPos, c2WeightChrgNegChrgPos*eventwgtcharge);   /// for denominator
  }
  ...
  if(fParticle==1){
    if((NumOfPionPosEtaPos*fSumWgtEtaNeg)!=0.0){
      ...
      fHistv2cumCentPionPos->Fill(centrality, c2cumulantPionPos, c2WeightPionPos*eventwgtcharge);   /// for denominator
    }
    if((NumOfPionNegEtaPos*fSumWgtEtaNegChNeg)!=0.0){  
      ...
      fHistv2cumCentPionNeg->Fill(centrality, c2cumulantPionNeg, c2WeightPionNeg*eventwgtcharge);   /// for denominator
    }
    ...
    if((c2WeightPionPosPionNeg)!=0.0){
      ...
      fHistv2cumCentPionPosPionNeg->Fill(centrality, c2cumulantPionPosPionNeg, c2WeightPionPosPionNeg*eventwgtcharge);   /// for denominator
    }
    ...
    fHistv2cumCentPionNegPionPos->Fill(centrality, c2cumulantPionNegPionPos, c2WeightPionNegPionPos*eventwgtcharge);   /// for denominator
    } 
...
Bool_t AliAnalysisTaskv2vscent::CheckEventIsPileUp2018(AliAODEvent *faod) {
...
Bool_t AliAnalysisTaskv2vscent::CheckEventIsPileUp(AliAODEvent *faod) {
...
Bool_t AliAnalysisTaskv2vscent::PileUpMultiVertex(const AliAODEvent* faod)
...
double AliAnalysisTaskv2vscent::GetWDist(const AliVVertex* v0, const AliVVertex* v1)
{
...
void AliAnalysisTaskv2vscent::SetupEventAndTaskConfigInfo(){
...
Int_t AliAnalysisTaskv2vscent::GetCentralityScaled0to10(Double_t fCent){
...
void AliAnalysisTaskv2vscent::GetNUACorrectionHist(Int_t run, Int_t kParticleID)
{
...
void AliAnalysisTaskv2vscent::GetV0MCorrectionHist(Int_t run, Int_t kParticleID)
{
...
void AliAnalysisTaskv2vscent::GetMCCorrectionHist(Int_t run,Float_t centr){
