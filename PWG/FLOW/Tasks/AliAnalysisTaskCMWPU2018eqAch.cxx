...
void AliAnalysisTaskCMWPU2018eqAch::UserCreateOutputObjects()
{
  ...
  // Acharge Binning with Equal Event per bin:
  //Cent 0-5
  Double_t fAchBinCent00[11] = {-0.136, -0.028, -0.018, -0.01, -0.004, 0.002, 0.008, 0.014, 0.02, 0.03, 1 };
  //Cent 5-10
  Double_t fAchBinCent11[11] = {-0.15, -0.03, -0.018, -0.012, -0.004, 0.002, 0.008, 0.016, 0.022, 0.034, 1 };
  //Cent 10-20 
  Double_t fAchBinCent22[11] = {-0.176, -0.036, -0.022, -0.014, -0.006, 0.002, 0.01, 0.018, 0.026, 0.038, 1 };
  //Cent 20-30 
  Double_t fAchBinCent33[11] = {-0.206, -0.044, -0.028, -0.016, -0.008, 0.002, 0.01, 0.02, 0.032, 0.048, 1 };
  //Cent 30-40 
  Double_t fAchBinCent44[11] = {-0.258, -0.056, -0.036, -0.022, -0.01, 0.002, 0.012, 0.024, 0.04, 0.058, 1 };
  //Cent 40-50 
  Double_t fAchBinCent55[11] = {-0.368, -0.072, -0.046, -0.028, -0.012, 0.002, 0.016, 0.032, 0.05, 0.076, 1};
  //Cent 50-60 
  Double_t fAchBinCent66[11] = {-0.48, -0.098, -0.064, -0.038, -0.018, 0.002, 0.02, 0.042, 0.066, 0.102, 1 };
  /*//Cent 60-70 
  ...
  */
  ...
  //Cent 60-80 
  Double_t fAchBinCent77[11] = {-0.996, -0.176, -0.11, -0.068, -0.032, 0.002, 0.036, 0.07, 0.112, 0.18, 1 };
  //Cent 80-90 
  Double_t fAchBinCent88[11] = {-0.996, -0.176, -0.11, -0.068, -0.032, 0.002, 0.036, 0.07, 0.112, 0.18, 1 };
