...
#include "AliAnalysisTaskLegacyPhiFlow.h"
...
ClassImp(AliAnalysisTaskLegacyPhiFlow)

AliAnalysisTaskLegacyPhiFlow::AliAnalysisTaskLegacyPhiFlow() : AliAnalysisTaskSE(),
...
AliAnalysisTaskLegacyPhiFlow::AliAnalysisTaskLegacyPhiFlow(const char *name) : AliAnalysisTaskSE(name),
   fDebug(0), fIsMC(0), fEventMixing(0), fTypeMixing(0), fQA(0), fV0(0), fMassBins(1), fMinMass(-1.), fMaxMass(0.), fCutsRP(NULL), fNullCuts(0), fPIDResponse(0), fFlowEvent(0), fBayesianResponse(0), fCandidates(0), fCandidateEtaPtCut(0), fCandidateMinEta(0), fCandidateMaxEta(0), fCandidateMinPt(0), fCandidateMaxPt(0), fCandidateYCut(kFALSE), fCandidateMinY(-.5), fCandidateMaxY(.5), fNPtBins(18), fCentrality(999), fVertex(999), fAOD(0), fPoolManager(0), fOutputList(0), fEventStats(0), fCentralityPass(0), fCentralityNoPass(0), fNOPID(0), fPIDk(0), fNOPIDTOF(0), fPIDTOF(0), fPtP(0), fPtN(0), fPtKP(0), fPtKN(0), fMultCorAfterCuts(0), fMultvsCentr(0), fCentralityMin(0), fCentralityMax(100), fkCentralityMethodA(0), fkCentralityMethodB(0), fCentralityCut2010(0), fCentralityCut2011(0), fPOICuts(0), fVertexRange(0), fPhi(0), fPt(0), fEta(0), fVZEROA(0), fVZEROC(0), fTPCM(0)/*, fDeltaDipAngle(0), fDeltaDipPt(0), fApplyDeltaDipCut(0)*/, fDCAAll(0), fDCAXYQA(0), fDCAZQA(0), fDCAPrim(0), fDCASecondaryWeak(0), fDCAMaterial(0), fSubEventDPhiv2(0), fSkipEventSelection(0), fUsePidResponse(0), fPIDCombined(0)
{
   // Constructor
   for(Int_t i(0); i < 7; i++) fPIDConfig[i] = 0.;
   ...
   if(fDebug > 0) cout << " === Created instance of AliAnaysisTaskLegacyPhiFlow === " << endl;
}
//_____________________________________________________________________________
AliAnalysisTaskLegacyPhiFlow::~AliAnalysisTaskLegacyPhiFlow()
{
   // Destructor
   ...
   if (fDebug > 0) cout << " === Deleted instance of AliAnalysisTaskLegacyPhiFlow === " << endl;
}
//_____________________________________________________________________________
TH1F* AliAnalysisTaskLegacyPhiFlow::BookHistogram(const char* name)
{
...
//_____________________________________________________________________________
TH2F* AliAnalysisTaskLegacyPhiFlow::BookPIDHistogram(const char* name, Bool_t TPC)
{
...
//_____________________________________________________________________________
TH1F* AliAnalysisTaskLegacyPhiFlow::InitPtSpectraHistograms(Float_t nmin, Float_t nmax)
{
...
//_____________________________________________________________________________
TH1F* AliAnalysisTaskLegacyPhiFlow::BookPtHistogram(const char* name)
{
...
//_____________________________________________________________________________
void AliAnalysisTaskLegacyPhiFlow::AddPhiIdentificationOutputObjects()
{
...
//_____________________________________________________________________________
void AliAnalysisTaskLegacyPhiFlow::UserCreateOutputObjects()
{
...
//_____________________________________________________________________________
AliEventPoolManager* AliAnalysisTaskLegacyPhiFlow::InitializeEventMixing()
{
...
//_____________________________________________________________________________
template <typename T> Double_t AliAnalysisTaskLegacyPhiFlow::InvariantMass(const T* track1, const T* track2) const
{
...
//_____________________________________________________________________________
/*
template <typename T> Double_t AliAnalysisTaskLegacyPhiFlow::DeltaDipAngle(const T* track1, const T* track2) const
{
...
//_____________________________________________________________________________
template <typename T> Bool_t AliAnalysisTaskLegacyPhiFlow::CheckDeltaDipAngle(const T* track1, const T* track2) const
{
...
*/
//_____________________________________________________________________________
template <typename T> Bool_t AliAnalysisTaskLegacyPhiFlow::CheckCandidateEtaPtCut(const T* track1, const T* track2) const
{
...
//_____________________________________________________________________________
template <typename T> Bool_t AliAnalysisTaskLegacyPhiFlow::EventCut(T* event)
{
   // Impose event cuts
...
//_____________________________________________________________________________
template <typename T> void AliAnalysisTaskLegacyPhiFlow::PlotMultiplcities(const T* event) const
{
...
//_____________________________________________________________________________
template <typename T> Bool_t AliAnalysisTaskLegacyPhiFlow::CheckVertex(const T* event)
{
...
//_____________________________________________________________________________
template <typename T> Bool_t AliAnalysisTaskLegacyPhiFlow::CheckCentrality(T* event)
{
...
//_____________________________________________________________________________
void AliAnalysisTaskLegacyPhiFlow::InitializeBayesianPID(AliAODEvent* event)
{
...
//_____________________________________________________________________________
template <typename T> Bool_t AliAnalysisTaskLegacyPhiFlow::PassesTPCbayesianCut(T* track) const
{
...
//_____________________________________________________________________________
Bool_t AliAnalysisTaskLegacyPhiFlow::PassesDCACut(AliAODTrack* track) const
{
...
//_____________________________________________________________________________
Bool_t AliAnalysisTaskLegacyPhiFlow::IsKaon(AliAODTrack* track) const
{
...
//_____________________________________________________________________________
template <typename T> Double_t AliAnalysisTaskLegacyPhiFlow::PhiPt(const T* track1, const T* track2) const
{
...
//_____________________________________________________________________________
template <typename T> void AliAnalysisTaskLegacyPhiFlow::PtSelector(Int_t tracktype, const T* track1, const T* track2) const
{
...
//_____________________________________________________________________________
template <typename T> Bool_t AliAnalysisTaskLegacyPhiFlow::PhiTrack(T* track) const
{
...
//_____________________________________________________________________________
template <typename T> void AliAnalysisTaskLegacyPhiFlow::SetNullCuts(T* event)
{
   // Set null cuts
...
//_____________________________________________________________________________
void AliAnalysisTaskLegacyPhiFlow::PrepareFlowEvent(Int_t iMulti)
{
   // Prepare flow events
...
//_____________________________________________________________________________
void AliAnalysisTaskLegacyPhiFlow::VZEROSubEventAnalysis()
{
...
//_____________________________________________________________________________
void AliAnalysisTaskLegacyPhiFlow::UserExec(Option_t *)
{
...
//_____________________________________________________________________________
void AliAnalysisTaskLegacyPhiFlow::Exec(Option_t* c)
{
    // skip the event selection for SE task (e.g. for MC productions)
    if(fSkipEventSelection) AliAnalysisTaskLegacyPhiFlow::UserExec(c);
    // exec of task se will do event selection and call UserExec 
    else AliAnalysisTaskSE::Exec(c);
}
//_____________________________________________________________________________
void AliAnalysisTaskLegacyPhiFlow::ReconstructionWithEventMixing(TObjArray* MixingCandidates) const
{
...
//_____________________________________________________________________________
void AliAnalysisTaskLegacyPhiFlow::Terminate(Option_t *)
{
    // terminate
    if(fDebug > 0) cout << " *** Terminate() *** " << endl;
}
//______________________________________________________________________________
void  AliAnalysisTaskLegacyPhiFlow::MakeTrack(Double_t mass, Double_t pt, Double_t phi, Double_t eta, Int_t nDau, Int_t iID[], Double_t p, Double_t pz) const
{
...
//_____________________________________________________________________________
void AliAnalysisTaskLegacyPhiFlow::IsMC()
{
