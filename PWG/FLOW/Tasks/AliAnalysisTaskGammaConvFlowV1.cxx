...
#include "AliESDpid.h"
#include "AliAnalysisTaskGammaConvFlowV1.h"
...
ClassImp(AliAnalysisTaskGammaConvFlowV1)

    //________________________________________________________________________
    AliAnalysisTaskGammaConvFlowV1::AliAnalysisTaskGammaConvFlowV1() : AliAnalysisTaskSE(),
                                                                       fV0Reader(NULL),
...
//________________________________________________________________________
AliAnalysisTaskGammaConvFlowV1::AliAnalysisTaskGammaConvFlowV1(const char *name) : AliAnalysisTaskSE(name),
                                                                                   fV0Reader(NULL),
                                                                                   fV0ReaderName("V0ReaderV1"),
                                                                                   fDoLightOutput(kFALSE),
                                                                                   fBGHandler(NULL),
...
AliAnalysisTaskGammaConvFlowV1::~AliAnalysisTaskGammaConvFlowV1()
{
  if (fGammaCandidates)
  {
...
void AliAnalysisTaskGammaConvFlowV1::InitBack()
{
...
//________________________________________________________________________
void AliAnalysisTaskGammaConvFlowV1::UserCreateOutputObjects()
{
  if (fBranchSet)
  {
    ...
    {
      fOutputAODBranchName = Form("pi0Array_%i", fRun);
      AliInfo("Cluster branch name not set, set it to pi0Array");
    }
    if (fOutputBGBranchName.Length() == 0)
    {
      fOutputBGBranchName = Form("pi0BackgroundArray_%i", fRun);
  ...
  if (fDoMesonAnalysis)
  {
    if (((AliConversionMesonCuts *)fMesonCutArray->At(0))->DoIsolatedAnalysis())
      fDoIsolatedAnalysis = kTRUE;
  }
  if (((AliConversionMesonCuts *)fMesonCutArray->At(0))->DoHighPtHadronAnalysis())
      ...
      ((AliConvEventCuts *)fV0Reader->GetEventCuts())->GetEnergyEnum() == AliConvEventCuts::k13TeVLowB)
  {
    ...
    for (Int_t i = 0; i < nBinsClusterPt + 1; i++)
    {
      if (i < 1)
        ...
        arrClusPtBinning[i] = 16. + 0.25 * (i - 128);
      else if (i < 224)
        arrClusPtBinning[i] = 30. + 0.5 * (i - 184);
      else if (i < 274)
        arrClusPtBinning[i] = 50. + 1.0 * (i - 224);
      else
  ...
  else if (((AliConvEventCuts *)fV0Reader->GetEventCuts())->GetEnergyEnum() == AliConvEventCuts::kXeXe5440GeV)
  {
    ...
    for (Int_t i = 0; i < nBinsPt + 1; i++)
    {
      if (i < 1)
        ...
        arrPtBinning[i] = 6. + 0.25 * (i - 58);
      else if (i < 90)
        arrPtBinning[i] = 12. + 1.0 * (i - 82);
      else
        arrPtBinning[i] = maxPt;
    }
    nBinsQAPt = 92;
  ...
  else if (((AliConvEventCuts *)fV0Reader->GetEventCuts())->GetEnergyEnum() == AliConvEventCuts::kPbPb5TeV)
  {
    ...
    {
      if (i <= 20)
        arrPtBinning[i] = 0.0 + 0.2 * i; // 0.2 GeV bin width until 4 GeV
      else if (i <= 30)
        arrPtBinning[i] = 4.0 + 0.5 * (i - 20); // 0.5 GeV                 9 GeV
      else if (i <= 36)
        arrPtBinning[i] = 9.0 + 1.0 * (i - 30);  // 1.0 GeV                 15 GeV
      else                                       /*i<=nBinsPt*/
        arrPtBinning[i] = 15.0 + 5.0 * (i - 36); // 5.0 GeV                 25 GeV
    }
    ...
    {
      if (i <= 20)
        arrQAPtBinning[i] = 0.0 + 0.2 * i; // 0.2 GeV bin width until 4 GeV
      else if (i <= 30)
        arrQAPtBinning[i] = 4.0 + 0.5 * (i - 20); // 0.5 GeV                 9 GeV
      else if (i <= 36)
        arrQAPtBinning[i] = 9.0 + 1.0 * (i - 30);  // 1.0 GeV                 15 GeV
      else                                         /*i<=nBinsPt*/
        arrQAPtBinning[i] = 15.0 + 5.0 * (i - 36); // 5.0 GeV                 25 GeV
    }
  ...
  for (Int_t iCut = 0; iCut < fnCuts; iCut++)
  {
    ...
    if (fDoPlotVsCentrality)
    {
      ...
      if (fDoCentralityFlat > 0 || fIsMC > 1)
        fHistoCentralityVsPrimaryTracks[iCut]->Sumw2();
    ...
    if (fDoPhotonQA > 0 && fIsMC < 2)
    {
      ...
      if ((fDoPhotonQA == 4) || (fDoPhotonQA == 5))
      {
        ...
        if (fDoCentralityFlat > 0)
          fHistoConvGammaInvMass[iCut]->Sumw2();
        ...
        if (fDoCentralityFlat > 0)
          fHistoConvGammaInvMassReco[iCut]->Sumw2();
  ...
  if (fIsMC > 0)
  {
    ...
    {
      if (fIsHeavyIon == 1)
        fHistoCombinatorialMothersPt = new TH3F *[fnCuts];
  ...
  if (fV0Reader && fV0Reader->GetProduceImpactParamHistograms())
  ...
  for (Int_t iCut = 0; iCut < fnCuts; iCut++)
  {
    ...
    if (!((AliConversionPhotonCuts *)fCutArray->At(iCut)))
      continue;
...
Bool_t AliAnalysisTaskGammaConvFlowV1::Notify()
{
  fFileWasAlreadyReported = kFALSE;
...
//_____________________________________________________________________________
void AliAnalysisTaskGammaConvFlowV1::UserExec(Option_t *)
{
  //
  ...
  //  cout << "From GammaV1 fOutputAODBranchName===" << fOutputAODBranchName.Data() << endl;
  // cout << "From UserExec" << fTrainConfig << endl;
  // cout << "From UserExec    fRun==" << fRun << endl;
  // Set MC events
  if (fIsMC > 0)
  {
    fMCEvent = MCEvent();
    ...
    if (fInputEvent->IsA() == AliAODEvent::Class())
    {
      ...
      if (lOldAddress && fAODMCTrackArray != lOldAddress)
        fAddressChanges->Fill(0.5);
  ...
  if (fInputEvent->IsIncompleteDAQ() == kTRUE || fV0Reader->GetErrorAODRelabeling())
    eventQuality = 2; // incomplete event or relabeling failed
  ...
  if (eventQuality == 2 || eventQuality == 3)
  {
    ...
    for (Int_t iCut = 0; iCut < fnCuts; iCut++)
    {
      ...
      if (fDoCentralityFlat > 0)
        fHistoNEventsWeighted[iCut]->Fill(eventQuality, fWeightCentrality[iCut]);
    }
    return;
  }
  ...
  for (Int_t iCut = 0; iCut < fnCuts; iCut++)
  {
    ...
    if (fIsMC)
      fiEventCut->ResetAODMCTrackArray();
    ...
    if (eventNotAccepted != 0)
    {
      ...
      if (fDoCentralityFlat > 0)
        fHistoNEventsWeighted[iCut]->Fill(eventNotAccepted, fWeightCentrality[iCut] * fWeightJetJetMC);

      if (fIsMC > 0)
      {
        if (eventNotAccepted == 3 && (eventQuality == 0 || eventQuality == 3 || eventQuality == 5))
    ...
    { // Event Not Accepted
      ...
      if (fIsMC > 1)
        fHistoNEventsWOWeight[iCut]->Fill(eventQuality);
      if (fDoCentralityFlat > 0)
        fHistoNEventsWeighted[iCut]->Fill(eventQuality, fWeightCentrality[iCut] * fWeightJetJetMC);

      if (fIsMC > 0)
      {
        if (eventQuality == 3 || eventQuality == 5)
        { // 3 = wrong trigger, 5 = GetNumberOfContributorsVtx
          if (fInputEvent->IsA() == AliESDEvent::Class())
    ...
    else
    {
      ...
      if (fIsMC > 1)
        fHistoNEventsWOWeight[iCut]->Fill(eventQuality);
      if (fDoCentralityFlat > 0)
        fHistoNEventsWeighted[iCut]->Fill(eventQuality, fWeightCentrality[iCut] * fWeightJetJetMC); // Should be 0 here

      fHistoNGoodESDTracks[iCut]->Fill(fV0Reader->GetNumberOfPrimaryTracks(), fWeightJetJetMC);
      if (fDoCentralityFlat > 0)
        fHistoNGoodESDTracksWeighted[iCut]->Fill(fV0Reader->GetNumberOfPrimaryTracks(), fWeightCentrality[iCut] * fWeightJetJetMC);

      fHistoVertexZ[iCut]->Fill(fInputEvent->GetPrimaryVertex()->GetZ(), fWeightJetJetMC);
      if (fDoCentralityFlat > 0)
        fHistoVertexZWeighted[iCut]->Fill(fInputEvent->GetPrimaryVertex()->GetZ(), fWeightCentrality[iCut] * fWeightJetJetMC);

      if (fDoPlotVsCentrality)
        fHistoCentrality[iCut]->Fill(fiEventCut->GetCentrality(fInputEvent), fWeightJetJetMC);
      if (fDoCentralityFlat > 0)
        fHistoCentralityFlattened[iCut]->Fill(fiEventCut->GetCentrality(fInputEvent), fWeightCentrality[iCut] * fWeightJetJetMC);

      if (fDoCentralityFlat > 0)
        fHistoCentralityVsPrimaryTracks[iCut]->Fill(fiEventCut->GetCentrality(fInputEvent), fV0Reader->GetNumberOfPrimaryTracks(), fWeightCentrality[iCut] * fWeightJetJetMC);
      else if (fDoPlotVsCentrality)
        fHistoCentralityVsPrimaryTracks[iCut]->Fill(fiEventCut->GetCentrality(fInputEvent), fV0Reader->GetNumberOfPrimaryTracks(), fWeightJetJetMC);
      ...
      if (!fDoLightOutput)
      {
        ...
        {
          if (fDoCentralityFlat > 0)
            fHistoSPDClusterTrackletBackground[iCut]->Fill(fInputEvent->GetMultiplicity()->GetNumberOfTracklets(), (fInputEvent->GetNumberOfITSClusters(0) + fInputEvent->GetNumberOfITSClusters(1)), fWeightCentrality[iCut]);
          else
    ...
    if (fIsMC > 0)
    {
      ...
      if (fiEventCut->GetSignalRejection() != 0)
      {
        ...
        {
          if (fiEventCut->GetSignalRejection() == 5)
            fiEventCut->ResetMcHeader();
          fiEventCut->GetNotRejectedParticles(fiEventCut->GetSignalRejection(),
                                              fiEventCut->GetAcceptedHeader(),
                                              fInputEvent);
        }
    ...
    if (fEnableBDT)
      ProcessPhotonBDT(); //
    if (fDoHighPtHadronAnalysis)
      ProcessPhotonsHighPtHadronAnalysis();
    ...
    if (!fDoLightOutput)
    {
      if (fDoCentralityFlat > 0)
      {
        ...
        if (fIsMC < 2)
          fHistoNGoodESDTracksVsNGammaCandidates[iCut]->Fill(fV0Reader->GetNumberOfPrimaryTracks(), fGammaCandidates->GetEntries(), fWeightCentrality[iCut]);
      }
      else
      {
        fHistoNGammaCandidates[iCut]->Fill(fGammaCandidates->GetEntries(), fWeightJetJetMC);
        if (fIsMC < 2)
          fHistoNGoodESDTracksVsNGammaCandidates[iCut]->Fill(fV0Reader->GetNumberOfPrimaryTracks(), fGammaCandidates->GetEntries());
      }
    }
...
//________________________________________________________________________
void AliAnalysisTaskGammaConvFlowV1::ProcessPhotonCandidates()
{
  ...
  auto fillHistosAndTree = [&](AliAODConversionPhoton *thePhoton)
  {
    ...
    {
      if (fInputEvent->IsA() == AliESDEvent::Class())
        ProcessTruePhotonCandidates(thePhoton);
      if (fInputEvent->IsA() == AliAODEvent::Class())
        ProcessTruePhotonCandidatesAOD(thePhoton);
    }
  ...
  for (TObject *iObj : *fReaderGammas)
  {
    ...
    if (!iCandidate)
    {
      AliWarning("Non AliAODConversionPhoton type object in fReaderGammas.\n");
      continue;
    }
  ...
  if (lUseElecShareCut)
    fiPhotonCut->RemovePhotonsWithSharedTracks(fMapPhotonHeaders);
  if (lUseTooCloseCut)
    fiPhotonCut->RemoveTooClosePhotons(fMapPhotonHeaders);
...
//________________________________________________________________________
void AliAnalysisTaskGammaConvFlowV1::ProcessPhotonsHighPtHadronAnalysis()
{
  ...
  for (Int_t iTracks = 0; iTracks < NTotalTracks; iTracks++)
  {
    ...
    if (curTrack->GetID() < 0)
      continue; // Avoid double counting of tracks
    if (!curTrack->IsHybridGlobalConstrainedGlobal())
      continue;
    if (TMath::Abs(curTrack->Eta()) > 0.8)
      continue;
    if (curTrack->Pt() < 0.50)
      continue;
    if (curTrack->Pt() > 10)
      DoesEventContainHighPtHadron = kTRUE;
    NTracks++;
  }
...
//________________________________________________________________________
void AliAnalysisTaskGammaConvFlowV1::InitializeBDT()
{
...
//________________________________________________________________________
void AliAnalysisTaskGammaConvFlowV1::ProcessPhotonBDT()
{
  // Loop over Photon Candidates allocated by ReaderV1
  for (Int_t i = 0; i < fGammaCandidates->GetEntries(); i++)
  {
    ...
    if (fiPhotonCut->GetBDTVariableValues(PhotonCandidate, fInputEvent, SingleTrackBDTVariableValues))
    {
      ...
      if (BDToutput > 0.)
        fHistoBDToutputPt[fiCut]->Fill(PhotonCandidate->Pt());
            ...
            if (posDaughter->GetMother() == negDaughter->GetMother())
            {
              if ((pdgCode[0] == 11 && pdgCode[1] == 11) && posDaughter->GetPdgCode() != negDaughter->GetPdgCode())
              {
                ...
                if (Photon->GetPdgCode() == 22)
                  fHistoBDToutputMCTrue[fiCut]->Fill(BDToutput);
              }
            }
          }
        }
...
//________________________________________________________________________
void AliAnalysisTaskGammaConvFlowV1::ProcessTruePhotonCandidatesAOD(AliAODConversionPhoton *TruePhotonCandidate)
{
  ...
  if (fAODMCTrackArray != NULL && TruePhotonCandidate != NULL)
  {
    ...
    if (posDaughter->GetMother() != negDaughter->GetMother())
    {
      ...
      if (fDoPhotonQA == 3 && fIsHeavyIon == 1)
      {
        ...
        { // contamination is not a primary
...
//________________________________________________________________________
void AliAnalysisTaskGammaConvFlowV1::ProcessTruePhotonCandidates(AliAODConversionPhoton *TruePhotonCandidate)
{
  Double_t magField = fInputEvent->GetMagneticField();
  Double_t magFieldFlip = 1.0;
  if (magField < 0.0)
  ...
  { // gamma contamination is a primary
    FillPhotonCombinatorialBackgroundHist(TruePhotonCandidate, pdgCode, PhiParticle);
    if (fDoPhotonQA == 3 && fIsHeavyIon == 1)
    {
  ...
  if (posDaughter->Particle()->GetUniqueID() != 5 || negDaughter->Particle()->GetUniqueID() != 5)
    return; // check if the daughters come from a conversion
...
//________________________________________________________________________
void AliAnalysisTaskGammaConvFlowV1::ProcessAODMCParticles(int isCurrentEventSelected)
{
  const AliVVertex *primVtxMC = fMCEvent->GetPrimaryVertex();
  Double_t mcProdVtxX = primVtxMC->GetX();
  Double_t mcProdVtxY = primVtxMC->GetY();
    ...
    for (Int_t i = 0; i < fAODMCTrackArray->GetEntriesFast(); i++)
    {
      ...
      if (isPrimary)
      {
        ...
        if (fiEventCut->GetSignalRejection() != 0)
        {
          ...
          if (isMCFromMBHeader == 0 && fiEventCut->GetSignalRejection() != 3)
            continue;
        }
          ...
          if (fiMesonCut->MesonIsSelectedAODMC(particle, fAODMCTrackArray, fiEventCut->GetEtaShift()))
          {
            ...
            if (particle->GetPdgCode() == 111)
            {
              ...
              if (fDoMesonQA > 0)
              {
                ...
                if (fIsMC == 2)
                  fHistoMCPi0PtJetPt[fiCut]->Fill(particle->Pt(), fiEventCut->GetMaxPtJet(), fWeightJetJetMC);
              }
            }
            else if (particle->GetPdgCode() == 221)
            {
              ...
              if (fDoMesonQA > 0)
              {
                ...
                if (fIsMC == 2)
                  fHistoMCEtaPtJetPt[fiCut]->Fill(particle->Pt(), fiEventCut->GetMaxPtJet(), fWeightJetJetMC);
              }
            }
                ...
                fiPhotonCut->InPlaneOutOfPlaneCut(daughter1->Phi(), fEventPlaneAngle, kFALSE))
            {
              ...
              {
                if (fIsMC > 1)
                  fHistoMCPi0WOEvtWeightInAccPt[fiCut]->Fill(particle->Pt());                // MC Pi0 with gamma in acc NOT weighted at all
              ...
              {
                if (fIsMC > 1)
                  fHistoMCEtaWOEvtWeightInAccPt[fiCut]->Fill(particle->Pt());                // MC Eta with gamma in acc NOT weighted at all
...
//________________________________________________________________________
void AliAnalysisTaskGammaConvFlowV1::ProcessMCParticles(int isCurrentEventSelected)
{
  const AliVVertex *primVtxMC = fMCEvent->GetPrimaryVertex();
  Double_t mcProdVtxX = primVtxMC->GetX();
  Double_t mcProdVtxY = primVtxMC->GetY();
    ...
    if (fiEventCut->IsConversionPrimaryESD(fMCEvent, i, mcProdVtxX, mcProdVtxY, mcProdVtxZ))
    {
      ...
      if (fDoMesonAnalysis)
      {
        ...
        if ((mesonY > fiMesonCut->GetRapidityCutValueMin()) && (mesonY < fiMesonCut->GetRapidityCutValueMax()))
        {
          ...
          else if (TMath::Abs(particle->PdgCode()) == 223)
          { // Omega
            fHistoMCPrimaryPtvsSource[fiCut]->Fill(particle->Pt(), 7., fWeightJetJetMC);
          }
          else if (TMath::Abs(particle->PdgCode()) == 333)
          { // Phi
            fHistoMCPrimaryPtvsSource[fiCut]->Fill(particle->Pt(), 8., fWeightJetJetMC);
          }
          else if (TMath::Abs(particle->PdgCode()) == 113)
          { // Rho0
            fHistoMCPrimaryPtvsSource[fiCut]->Fill(particle->Pt(), 9., fWeightJetJetMC);
          }
        }
      ...
      if (fDoMesonAnalysis)
      {
        if (fiMesonCut->MesonIsSelectedMC(particle, fMCEvent, fiEventCut->GetEtaShift()))
        {
          ...
          if (particle->PdgCode() == 111)
          {
            ...
            if (fDoMesonQA > 0 && fIsMC < 2)
              fHistoMCSecPi0RvsSource[fiCut]->Fill(realRadius3D, source);
            fHistoMCSecPi0Source[fiCut]->Fill(pdgCode);
          }
          else if (particle->PdgCode() == 221)
          {
...
//________________________________________________________________________
void AliAnalysisTaskGammaConvFlowV1::CalculatePi0Candidates()
{
    ...
    for (Int_t firstGammaIndex = 0; firstGammaIndex < fGammaCandidates->GetEntries() - 1; firstGammaIndex++)
    {
      ...
      for (Int_t secondGammaIndex = firstGammaIndex + 1; secondGammaIndex < fGammaCandidates->GetEntries(); secondGammaIndex++)
      {
        ...
        if (gamma0->GetTrackLabelPositive() == gamma1->GetTrackLabelPositive() ||
            ...
            gamma0->GetTrackLabelPositive() == gamma1->GetTrackLabelNegative())
          continue;
        ...
        if ((fiMesonCut->MesonIsSelected(pi0cand, kTRUE, fiEventCut->GetEtaShift())))
        {
          if (fDoCentralityFlat > 0)
          {
            if (fBranchSet)
            {
              pi0cand->SetWeight(fWeightCentrality[fiCut] * fWeightJetJetMC);
            ...
            if (TMath::Abs(pi0cand->GetAlpha()) < 0.1)
              fHistoMotherInvMassEalpha[fiCut]->Fill(pi0cand->M(), pi0cand->E(), fWeightCentrality[fiCut] * fWeightJetJetMC);
          }
          else
          {
            if (TMath::Abs(pi0cand->GetAlpha()) < 0.1)
            ...
            if (fBranchSet)
            {
              pi0cand->SetWeight(fWeightJetJetMC);
              new ((*fOutputAODBranch)[pi0Count]) AliAODConversionMother(*pi0cand);
            }
            pi0Count++;
            ...
            if (fDoIsolatedAnalysis)
            {
              ...
              if (fIsMC > 0)
              {
                ...
                for (Long_t iTracks = 0; iTracks < fAODMCTrackArray->GetEntriesFast(); iTracks++)
                {
                  ...
                  if (!curTrack)
                    continue;
                  if (!curTrack->IsPhysicalPrimary())
                    continue;
                  if (!curTrack->Pt())
                    continue;
                  if (curTrack->Charge() == 0)
                    continue;
                  if (curTrack->Pt() < 0.15)
                    continue;
                  if (TMath::Abs(curTrack->Eta()) > 0.8)
          ...
          if (fDoTHnSparse && fiMesonCut->DoBGCalculation())
          {
            ...
            if (fDoCentralityFlat > 0)
              sESDMotherInvMassPtZM[fiCut]->Fill(sparesFill, fWeightCentrality[fiCut] * fWeightJetJetMC); // instead of weight 1
            else
              sESDMotherInvMassPtZM[fiCut]->Fill(sparesFill, fWeightJetJetMC);
          }
          ...
          if (fDoMesonQA == 2)
          {
            ...
            {
              if (fInvMass > 0.08 && fInvMass < 0.2)
                tESDMesonsInvMassPtDcazMinDcazMaxFlag[fiCut]->Fill();
              if ((fInvMass > 0.45 && fInvMass < 0.6) && (fPt > 0.999 && fPt < 20.))
                tESDMesonsInvMassPtDcazMinDcazMaxFlag[fiCut]->Fill();
            }
            else if (fiPhotonCut->GetSingleElectronPtCut() < 0.04 && fPt > 0.099 && fPt < 20.)
            {
              if ((fInvMass > 0.08 && fInvMass < 0.6))
                tESDMesonsInvMassPtDcazMinDcazMaxFlag[fiCut]->Fill();
            }
...
void AliAnalysisTaskGammaConvFlowV1::ProcessTrueMesonCandidates(AliAODConversionMother *Pi0Candidate, AliAODConversionPhoton *TrueGammaCandidate0, AliAODConversionPhoton *TrueGammaCandidate1)
{
  Double_t magField = fInputEvent->GetMagneticField();
  // Process True Mesons
  const AliVVertex *primVtxMC = fMCEvent->GetPrimaryVertex();
  ...
  if (TrueGammaCandidate0->GetV0Index() < fInputEvent->GetNumberOfV0s())
  {
    ...
    { // Gamma is Combinatorial; MC Particles don't belong to the same Mother
      ...
      if (TMath::Abs(negativeMC->PdgCode()) == 11 && TMath::Abs(positiveMC->PdgCode()) == 11)
      { // Electrons ...
        if (negativeMC->Particle()->GetUniqueID() == 5 && positiveMC->Particle()->GetUniqueID() == 5)
        { // ... From Conversion ...
          if (gammaMC0->PdgCode() == 22)
          { // ... with Gamma Mother
            gamma0MotherLabel = gammaMC0->GetMother();
          }
        }
        if (gammaMC0->PdgCode() == 111)
        { // Dalitz candidate
          gamma0DalitzCand = kTRUE;
          gamma0MotherLabel = -111;
        }
        if (gammaMC0->PdgCode() == 221)
        { // Dalitz candidate
          gamma0DalitzCand = kTRUE;
    ...
    if (TrueGammaCandidate1->GetV0Index() < fInputEvent->GetNumberOfV0s())
    {
      ...
      { // Gamma is Combinatorial; MC Particles don't belong to the same Mother
        ...
        { // Electrons ...
          if (negativeMC->Particle()->GetUniqueID() == 5 && positiveMC->Particle()->GetUniqueID() == 5)
          { // ... From Conversion ...
            if (gammaMC1->PdgCode() == 22)
            { // ... with Gamma Mother
              gamma1MotherLabel = gammaMC1->GetMother();
            }
          }
          if (gammaMC1->PdgCode() == 111)
          { // Dalitz candidate
            gamma1DalitzCand = kTRUE;
            gamma1MotherLabel = -111;
          }
          if (gammaMC1->PdgCode() == 221)
          { // Dalitz candidate
            gamma1DalitzCand = kTRUE;
      ...
      if (gamma1DalitzCand || gamma0DalitzCand)
      {
        ...
        {
          if (gamma0MotherLabel == -111)
            isTruePi0Dalitz = kTRUE;
          if (gamma0MotherLabel == -221)
            isTrueEtaDalitz = kTRUE;
        }
        if (gamma1DalitzCand && gamma1MCLabel >= 0 && gamma1MCLabel == gamma0MotherLabel)
        {
          if (gamma1MotherLabel == -111)
            isTruePi0Dalitz = kTRUE;
          if (gamma1MotherLabel == -221)
            isTrueEtaDalitz = kTRUE;
        }
      }
      ...
      { // True Pion or Eta
        ...
        if (!isPrimary && gamma1MotherLabel > -1)
        { // Secondary Meson
          ...
          if (secMotherLabel > -1)
          {
            if (fMCEvent->GetTrack(secMotherLabel)->PdgCode() == 310)
            {
              ...
              if (fDoMesonQA > 0 && fIsMC < 2)
                fHistoTrueK0sWithPi0DaughterMCPt[fiCut]->Fill(fMCEvent->GetTrack(secMotherLabel)->Pt());
            }
            if (fMCEvent->GetTrack(secMotherLabel)->PdgCode() == 130)
            {
              ...
              if (fDoMesonQA > 0 && fIsMC < 2)
                fHistoTrueK0lWithPi0DaughterMCPt[fiCut]->Fill(fMCEvent->GetTrack(secMotherLabel)->Pt());
            }
            if (fMCEvent->GetTrack(secMotherLabel)->PdgCode() == 221)
            {
              ...
              if (fDoMesonQA > 0 && fIsMC < 2)
                fHistoTrueEtaWithPi0DaughterMCPt[fiCut]->Fill(fMCEvent->GetTrack(secMotherLabel)->Pt());
            }
            if (fMCEvent->GetTrack(secMotherLabel)->PdgCode() == 3122)
            {
              ...
              if (fDoMesonQA > 0 && fIsMC < 2)
                fHistoTrueLambdaWithPi0DaughterMCPt[fiCut]->Fill(fMCEvent->GetTrack(secMotherLabel)->Pt());
            }
          }
        }
        else
...
//______________________________________________________________________
void AliAnalysisTaskGammaConvFlowV1::ProcessTrueMesonCandidatesAOD(AliAODConversionMother *Pi0Candidate, AliAODConversionPhoton *TrueGammaCandidate0, AliAODConversionPhoton *TrueGammaCandidate1)
{
  Double_t magField = fInputEvent->GetMagneticField();
  const AliVVertex *primVtxMC = fMCEvent->GetPrimaryVertex();
  Double_t mcProdVtxX = primVtxMC->GetX();
      ...
      { // Secondary Meson
        ...
        if (secMotherLabel > -1)
        {
          if (static_cast<AliAODMCParticle *>(fAODMCTrackArray->At(secMotherLabel))->GetPdgCode() == 310)
          {
            ...
            fHistoTrueSecondaryMotherFromK0sInvMassPt[fiCut]->Fill(Pi0Candidate->M(), Pi0Candidate->Pt(), weightedSec * fWeightJetJetMC * weightMatBudget);
            if (fDoMesonQA > 0 && fIsMC < 2)
              fHistoTrueK0sWithPi0DaughterMCPt[fiCut]->Fill(static_cast<AliAODMCParticle *>(fAODMCTrackArray->At(secMotherLabel))->Pt());
          }
          if (static_cast<AliAODMCParticle *>(fAODMCTrackArray->At(secMotherLabel))->GetPdgCode() == 130)
          {
            ...
            fHistoTrueSecondaryMotherFromK0lInvMassPt[fiCut]->Fill(Pi0Candidate->M(), Pi0Candidate->Pt(), weightedSec * fWeightJetJetMC * weightMatBudget);
            if (fDoMesonQA > 0 && fIsMC < 2)
              fHistoTrueK0lWithPi0DaughterMCPt[fiCut]->Fill(static_cast<AliAODMCParticle *>(fAODMCTrackArray->At(secMotherLabel))->Pt());
          }
          if (static_cast<AliAODMCParticle *>(fAODMCTrackArray->At(secMotherLabel))->GetPdgCode() == 221)
          {
            ...
            fHistoTrueSecondaryMotherFromEtaInvMassPt[fiCut]->Fill(Pi0Candidate->M(), Pi0Candidate->Pt(), weightedSec * weightMatBudget * fWeightJetJetMC);
            if (fDoMesonQA > 0 && fIsMC < 2)
              fHistoTrueEtaWithPi0DaughterMCPt[fiCut]->Fill(static_cast<AliAODMCParticle *>(fAODMCTrackArray->At(secMotherLabel))->Pt());
          }
          if (static_cast<AliAODMCParticle *>(fAODMCTrackArray->At(secMotherLabel))->GetPdgCode() == 3122)
          {
            ...
            fHistoTrueSecondaryMotherFromLambdaInvMassPt[fiCut]->Fill(Pi0Candidate->M(), Pi0Candidate->Pt(), weightedSec * fWeightJetJetMC * weightMatBudget);
            if (fDoMesonQA > 0 && fIsMC < 2)
              fHistoTrueLambdaWithPi0DaughterMCPt[fiCut]->Fill(static_cast<AliAODMCParticle *>(fAODMCTrackArray->At(secMotherLabel))->Pt());
          }
        }
      }
      else
...
//________________________________________________________________________
void AliAnalysisTaskGammaConvFlowV1::CalculateBackground()
{
  Int_t pi0BGCount = 0;
      ...
      for (Int_t iCurrent2 = iCurrent + 1; iCurrent2 < fGammaCandidates->GetEntries(); iCurrent2++)
      {
        for (Int_t nRandom = 0; nRandom < fiMesonCut->GetNumberOfBGEvents(); nRandom++)
        {
          ...
          if ((fiMesonCut->MesonIsSelected(backgroundCandidate, kFALSE, fiEventCut->GetEtaShift())))
          {
            if (fDoCentralityFlat > 0)
            {
              fHistoMotherBackInvMassPt[fiCut]->Fill(backgroundCandidate->M(), backgroundCandidate->Pt(), fWeightCentrality[fiCut] * fWeightJetJetMC);
              if (fBranchSet)
              {
                backgroundCandidate->SetWeight(fWeightCentrality[fiCut] * fWeightJetJetMC);
            ...
            else
            {
              ...
              if (fBranchSet)
              {
                backgroundCandidate->SetWeight(fWeightJetJetMC);
                new ((*fOutputBGBranch)[pi0BGCount]) AliAODConversionMother(*backgroundCandidate);
              }
              pi0BGCount++;
            }
            ...
            {
              if (fDoCentralityFlat > 0)
                fHistoMotherBackInvMassPtCalib[fiCut]->Fill(backgroundCandidate->M(), currentEventGoodV0.E(), fWeightCentrality[fiCut] * fWeightJetJetMC);
              else
                fHistoMotherBackInvMassPtCalib[fiCut]->Fill(backgroundCandidate->M(), currentEventGoodV0.E(), fWeightJetJetMC);
            }
            if (fDoTHnSparse)
            {
              Double_t sparesFill[4] = {backgroundCandidate->M(), backgroundCandidate->Pt(), (Double_t)zbin, (Double_t)mbin};
              if (fDoCentralityFlat > 0)
                sESDMotherBackInvMassPtZM[fiCut]->Fill(sparesFill, fWeightCentrality[fiCut] * fWeightJetJetMC); // instead of weight 1
              else
                sESDMotherBackInvMassPtZM[fiCut]->Fill(sparesFill, fWeightJetJetMC);
            }
          }
...
//________________________________________________________________________
void AliAnalysisTaskGammaConvFlowV1::CalculateBackgroundSwapp()
{
  ...
  if (fiMesonCut->DoGammaSwappForBg())
  {
    ...
    if (fGammaCandidates->GetEntries() > 2)
    {
      for (Int_t iCurrent1 = 0; iCurrent1 < fGammaCandidates->GetEntries(); iCurrent1++)
      {
        ...
        for (Int_t iCurrent2 = iCurrent1 + 1; iCurrent2 < fGammaCandidates->GetEntries(); iCurrent2++)
        {
          ...
          for (int iSwapp = 0; iSwapp < fiMesonCut->GetNumberOfSwappsForBg(); ++iSwapp)
          {
            ...
            {
              if (fiMesonCut->GammaSwappMethodBg() == 0)
                rotationAngle = TMath::Pi() / 2.0; // rotate by 90 degree
              else if (fiMesonCut->GammaSwappMethodBg() == 1)
            ...
            {
              if (currentEventGoodV0Temp1 == ((AliAODConversionPhoton *)kCurrentGammaCandidates) || currentEventGoodV0Temp2 == ((AliAODConversionPhoton *)kCurrentGammaCandidates))
                continue;
      ...
      for (Int_t i = 0; i < (Int_t)vSwappingInvMassPT.size(); i++)
      {
        if (fDoCentralityFlat > 0)
        {
          fHistoMotherBackInvMassPt[fiCut]->Fill(vSwappingInvMassPT.at(i)[0], vSwappingInvMassPT.at(i)[1], tempMultWeightSwapping * fWeightCentrality[fiCut] * fWeightJetJetMC);
          if (fBranchSet)
          {
            ...
            backgroundCandidate0->SetWeight(tempMultWeightSwapping * fWeightCentrality[fiCut] * fWeightJetJetMC);
...
//________________________________________________________________________
void AliAnalysisTaskGammaConvFlowV1::CalculateBackgroundRP()
{
  Int_t pi0BGCount = 0;
  Int_t psibin = 0;
  Int_t zbin = 0;
  ...
  if (fiMesonCut->UseRotationMethod())
  {
    ...
    for (Int_t firstGammaIndex = 0; firstGammaIndex < fGammaCandidates->GetEntries(); firstGammaIndex++)
    {
      ...
      for (Int_t secondGammaIndex = firstGammaIndex + 1; secondGammaIndex < fGammaCandidates->GetEntries(); secondGammaIndex++)
      {
        ...
        if (gamma1 == NULL)
          continue;
        if (!fiPhotonCut->PhotonIsSelected(gamma1, fInputEvent))
          continue;
        for (Int_t nRandom = 0; nRandom < fiMesonCut->GetNumberOfBGEvents(); nRandom++)
        {
          ...
          if (fiMesonCut->MesonIsSelected(&backgroundCandidate, kFALSE, fiEventCut->GetEtaShift()))
          {
            ...
            {
              if (fDoCentralityFlat > 0)
                fHistoMotherBackInvMassPtCalib[fiCut]->Fill(backgroundCandidate.M(), gamma0->E(), fWeightCentrality[fiCut] * fWeightJetJetMC);
              else
                fHistoMotherBackInvMassPtCalib[fiCut]->Fill(backgroundCandidate.M(), gamma0->E(), fWeightJetJetMC);
            }
            if (fDoTHnSparse)
            {
              //               Double_t sparesFill[4] = {backgroundCandidate.M(),backgroundCandidate.Pt(),(Double_t)zbin,(Double_t)mbin};
              ...
              if (fDoCentralityFlat > 0)
                sESDMotherBackInvMassPtZM[fiCut]->Fill(sparesFill, weight * fWeightCentrality[fiCut] * fWeightJetJetMC);
              else
                sESDMotherBackInvMassPtZM[fiCut]->Fill(sparesFill, weight * fWeightJetJetMC);
            }
          }
        }
      }
...
//________________________________________________________________________
void AliAnalysisTaskGammaConvFlowV1::RotateParticle(AliAODConversionPhoton *gamma)
{
...
//________________________________________________________________________
void AliAnalysisTaskGammaConvFlowV1::RotateParticleAccordingToEP(AliAODConversionPhoton *gamma, Double_t previousEventEP, Double_t thisEventEP)
{
...
//________________________________________________________________________
void AliAnalysisTaskGammaConvFlowV1::MoveParticleAccordingToVertex(AliAODConversionPhoton *particle, const AliGammaConversionAODBGHandler::GammaConversionVertex *vertex)
{
...
//________________________________________________________________________
void AliAnalysisTaskGammaConvFlowV1::UpdateEventByEventData()
{
  // see header file for documentation
  if (fGammaCandidates->GetEntries() > 1)
  {
...
//________________________________________________________________________
void AliAnalysisTaskGammaConvFlowV1::FillPhotonCombinatorialBackgroundHist(AliAODConversionPhoton *TruePhotonCandidate, Int_t pdgCode[], Double_t PhiParticle[])
{
  ...
  if (fDoPhotonQA == 3 && fIsMC < 2)
  {
    if ((pdgCode[0] == 11 && pdgCode[1] == 211) || (pdgCode[0] == 211 && pdgCode[1] == 11))
    {
      if (pdgCode[0] == 11)
      {
        fHistoCombinatorialPtDeltaPhi_epi[fiCut]->Fill(TruePhotonCandidate->Pt(), TMath::Abs((TruePhotonCandidate->Phi() - PhiParticle[1])));
      }
      else if (pdgCode[0] == 211)
      {
        fHistoCombinatorialPtDeltaPhi_epi[fiCut]->Fill(TruePhotonCandidate->Pt(), TMath::Abs((TruePhotonCandidate->Phi() - PhiParticle[0])));
      }
    }
    else if ((pdgCode[0] == 11 && pdgCode[1] == 321) || (pdgCode[0] == 321 && pdgCode[1] == 11))
    {
      if (pdgCode[0] == 11)
      {
        fHistoCombinatorialPtDeltaPhi_ek[fiCut]->Fill(TruePhotonCandidate->Pt(), TMath::Abs((TruePhotonCandidate->Phi() - PhiParticle[1])));
      }
      else if (pdgCode[0] == 321)
      {
        fHistoCombinatorialPtDeltaPhi_ek[fiCut]->Fill(TruePhotonCandidate->Pt(), TMath::Abs((TruePhotonCandidate->Phi() - PhiParticle[0])));
      }
    }
    else if ((pdgCode[0] == 11 && pdgCode[1] == 2212) || (pdgCode[0] == 2212 && pdgCode[1] == 11))
    {
      if (pdgCode[0] == 11)
      {
        fHistoCombinatorialPtDeltaPhi_ep[fiCut]->Fill(TruePhotonCandidate->Pt(), TMath::Abs((TruePhotonCandidate->Phi() - PhiParticle[1])));
      }
      else if (pdgCode[0] == 2212)
      {
        fHistoCombinatorialPtDeltaPhi_ep[fiCut]->Fill(TruePhotonCandidate->Pt(), TMath::Abs((TruePhotonCandidate->Phi() - PhiParticle[0])));
      }
    }
    else if ((pdgCode[0] == 211 && pdgCode[1] == 321) || (pdgCode[0] == 321 && pdgCode[1] == 211))
    {
      if (pdgCode[0] == 211)
      {
        fHistoCombinatorialPtDeltaPhi_pik[fiCut]->Fill(TruePhotonCandidate->Pt(), TMath::Abs((TruePhotonCandidate->Phi() - PhiParticle[1])));
      }
      else if (pdgCode[0] == 321)
      {
        fHistoCombinatorialPtDeltaPhi_pik[fiCut]->Fill(TruePhotonCandidate->Pt(), TMath::Abs((TruePhotonCandidate->Phi() - PhiParticle[0])));
      }
    }
    else if ((pdgCode[0] == 211 && pdgCode[1] == 2212) || (pdgCode[0] == 2212 && pdgCode[1] == 211))
    {
      if (pdgCode[0] == 211)
      {
        fHistoCombinatorialPtDeltaPhi_pip[fiCut]->Fill(TruePhotonCandidate->Pt(), TMath::Abs((TruePhotonCandidate->Phi() - PhiParticle[1])));
      }
      else if (pdgCode[0] == 2212)
      {
        fHistoCombinatorialPtDeltaPhi_pip[fiCut]->Fill(TruePhotonCandidate->Pt(), TMath::Abs((TruePhotonCandidate->Phi() - PhiParticle[0])));
      }
    }
  }
}
...
//________________________________________________________________________
void AliAnalysisTaskGammaConvFlowV1::FillPhotonCombinatorialMothersHistESD(AliMCParticle *daughter, AliMCParticle *motherCombPart)
{
  ...
  if (pdgCombPart == 11)
  { // comb particle is an electron
    if (pdgMotherCombPart == 11)
      fHistoCombinatorialMothersPt[fiCut]->Fill(0., 0., motherCombPart->Pt());
    else if (pdgMotherCombPart == 211)
      fHistoCombinatorialMothersPt[fiCut]->Fill(0., 1., motherCombPart->Pt());
    else if (pdgMotherCombPart == 321)
      fHistoCombinatorialMothersPt[fiCut]->Fill(0., 2., motherCombPart->Pt());
    else if (pdgMotherCombPart == 2212)
      fHistoCombinatorialMothersPt[fiCut]->Fill(0., 3., motherCombPart->Pt());
    else if (pdgMotherCombPart == 111)
      fHistoCombinatorialMothersPt[fiCut]->Fill(0., 4., motherCombPart->Pt());
    else if (pdgMotherCombPart == 221)
      fHistoCombinatorialMothersPt[fiCut]->Fill(0., 5., motherCombPart->Pt());
    else if (pdgMotherCombPart == 223)
      fHistoCombinatorialMothersPt[fiCut]->Fill(0., 6., motherCombPart->Pt());
    else if (pdgMotherCombPart == 333)
      fHistoCombinatorialMothersPt[fiCut]->Fill(0., 7., motherCombPart->Pt());
    else if (pdgMotherCombPart == 331)
      fHistoCombinatorialMothersPt[fiCut]->Fill(0., 8., motherCombPart->Pt());
    else if (pdgMotherCombPart == 310)
      fHistoCombinatorialMothersPt[fiCut]->Fill(0., 9., motherCombPart->Pt());
    else if (pdgMotherCombPart == 3122)
      fHistoCombinatorialMothersPt[fiCut]->Fill(0., 10., motherCombPart->Pt());
    else if (pdgMotherCombPart == 113 || pdgMotherCombPart == 213)
      fHistoCombinatorialMothersPt[fiCut]->Fill(0., 11., motherCombPart->Pt());
    else
      fHistoCombinatorialMothersPt[fiCut]->Fill(0., 12., motherCombPart->Pt());
  }
  else if (pdgCombPart == 211)
  { // comb particle is a pion
    if (pdgMotherCombPart == 11)
      fHistoCombinatorialMothersPt[fiCut]->Fill(1., 0., motherCombPart->Pt());
    else if (pdgMotherCombPart == 211)
      fHistoCombinatorialMothersPt[fiCut]->Fill(1., 1., motherCombPart->Pt());
    else if (pdgMotherCombPart == 321)
      fHistoCombinatorialMothersPt[fiCut]->Fill(1., 2., motherCombPart->Pt());
    else if (pdgMotherCombPart == 2212)
      fHistoCombinatorialMothersPt[fiCut]->Fill(1., 3., motherCombPart->Pt());
    else if (pdgMotherCombPart == 111)
      fHistoCombinatorialMothersPt[fiCut]->Fill(1., 4., motherCombPart->Pt());
    else if (pdgMotherCombPart == 221)
      fHistoCombinatorialMothersPt[fiCut]->Fill(1., 5., motherCombPart->Pt());
    else if (pdgMotherCombPart == 223)
      fHistoCombinatorialMothersPt[fiCut]->Fill(1., 6., motherCombPart->Pt());
    else if (pdgMotherCombPart == 333)
      fHistoCombinatorialMothersPt[fiCut]->Fill(1., 7., motherCombPart->Pt());
    else if (pdgMotherCombPart == 331)
      fHistoCombinatorialMothersPt[fiCut]->Fill(1., 8., motherCombPart->Pt());
    else if (pdgMotherCombPart == 310)
      fHistoCombinatorialMothersPt[fiCut]->Fill(1., 9., motherCombPart->Pt());
    else if (pdgMotherCombPart == 3122)
      fHistoCombinatorialMothersPt[fiCut]->Fill(1., 10., motherCombPart->Pt());
    else if (pdgMotherCombPart == 113 || pdgMotherCombPart == 213)
      fHistoCombinatorialMothersPt[fiCut]->Fill(1., 11., motherCombPart->Pt());
    else
      fHistoCombinatorialMothersPt[fiCut]->Fill(1., 12., motherCombPart->Pt());
  }
  else if (pdgCombPart == 321)
  { // comb particle is a kaon
    if (pdgMotherCombPart == 11)
      fHistoCombinatorialMothersPt[fiCut]->Fill(2., 0., motherCombPart->Pt());
    else if (pdgMotherCombPart == 211)
      fHistoCombinatorialMothersPt[fiCut]->Fill(2., 1., motherCombPart->Pt());
    else if (pdgMotherCombPart == 321)
      fHistoCombinatorialMothersPt[fiCut]->Fill(2., 2., motherCombPart->Pt());
    else if (pdgMotherCombPart == 2212)
      fHistoCombinatorialMothersPt[fiCut]->Fill(2., 3., motherCombPart->Pt());
    else if (pdgMotherCombPart == 111)
      fHistoCombinatorialMothersPt[fiCut]->Fill(2., 4., motherCombPart->Pt());
    else if (pdgMotherCombPart == 221)
      fHistoCombinatorialMothersPt[fiCut]->Fill(2., 5., motherCombPart->Pt());
    else if (pdgMotherCombPart == 223)
      fHistoCombinatorialMothersPt[fiCut]->Fill(2., 6., motherCombPart->Pt());
    else if (pdgMotherCombPart == 333)
      fHistoCombinatorialMothersPt[fiCut]->Fill(2., 7., motherCombPart->Pt());
    else if (pdgMotherCombPart == 331)
      fHistoCombinatorialMothersPt[fiCut]->Fill(2., 8., motherCombPart->Pt());
    else if (pdgMotherCombPart == 310)
      fHistoCombinatorialMothersPt[fiCut]->Fill(2., 9., motherCombPart->Pt());
    else if (pdgMotherCombPart == 3122)
      fHistoCombinatorialMothersPt[fiCut]->Fill(2., 10., motherCombPart->Pt());
    else if (pdgMotherCombPart == 113 || pdgMotherCombPart == 213)
      fHistoCombinatorialMothersPt[fiCut]->Fill(2., 11., motherCombPart->Pt());
    else
      fHistoCombinatorialMothersPt[fiCut]->Fill(2., 12., motherCombPart->Pt());
  }
  else if (pdgCombPart == 2212)
  { // comb particle is a proton
    if (pdgMotherCombPart == 11)
      fHistoCombinatorialMothersPt[fiCut]->Fill(3., 0., motherCombPart->Pt());
    else if (pdgMotherCombPart == 211)
      fHistoCombinatorialMothersPt[fiCut]->Fill(3., 1., motherCombPart->Pt());
    else if (pdgMotherCombPart == 321)
      fHistoCombinatorialMothersPt[fiCut]->Fill(3., 2., motherCombPart->Pt());
    else if (pdgMotherCombPart == 2212)
      fHistoCombinatorialMothersPt[fiCut]->Fill(3., 3., motherCombPart->Pt());
    else if (pdgMotherCombPart == 111)
      fHistoCombinatorialMothersPt[fiCut]->Fill(3., 4., motherCombPart->Pt());
    else if (pdgMotherCombPart == 221)
      fHistoCombinatorialMothersPt[fiCut]->Fill(3., 5., motherCombPart->Pt());
    else if (pdgMotherCombPart == 223)
      fHistoCombinatorialMothersPt[fiCut]->Fill(3., 6., motherCombPart->Pt());
    else if (pdgMotherCombPart == 333)
      fHistoCombinatorialMothersPt[fiCut]->Fill(3., 7., motherCombPart->Pt());
    else if (pdgMotherCombPart == 331)
      fHistoCombinatorialMothersPt[fiCut]->Fill(3., 8., motherCombPart->Pt());
    else if (pdgMotherCombPart == 310)
      fHistoCombinatorialMothersPt[fiCut]->Fill(3., 9., motherCombPart->Pt());
    else if (pdgMotherCombPart == 3122)
      fHistoCombinatorialMothersPt[fiCut]->Fill(3., 10., motherCombPart->Pt());
    else if (pdgMotherCombPart == 113 || pdgMotherCombPart == 213)
      fHistoCombinatorialMothersPt[fiCut]->Fill(3., 11., motherCombPart->Pt());
    else
      fHistoCombinatorialMothersPt[fiCut]->Fill(3., 12., motherCombPart->Pt());
  }
  else if (motherCombPart->GetMother() > -1)
  {
    if (pdgMotherCombPart == 11)
      fHistoCombinatorialMothersPt[fiCut]->Fill(5., 0., motherCombPart->Pt());
    else if (pdgMotherCombPart == 211)
      fHistoCombinatorialMothersPt[fiCut]->Fill(5., 1., motherCombPart->Pt());
    else if (pdgMotherCombPart == 321)
      fHistoCombinatorialMothersPt[fiCut]->Fill(5., 2., motherCombPart->Pt());
    else if (pdgMotherCombPart == 2212)
      fHistoCombinatorialMothersPt[fiCut]->Fill(5., 3., motherCombPart->Pt());
    else if (pdgMotherCombPart == 111)
      fHistoCombinatorialMothersPt[fiCut]->Fill(5., 4., motherCombPart->Pt());
    else if (pdgMotherCombPart == 221)
      fHistoCombinatorialMothersPt[fiCut]->Fill(5., 5., motherCombPart->Pt());
    else if (pdgMotherCombPart == 223)
      fHistoCombinatorialMothersPt[fiCut]->Fill(5., 6., motherCombPart->Pt());
    else if (pdgMotherCombPart == 333)
      fHistoCombinatorialMothersPt[fiCut]->Fill(5., 7., motherCombPart->Pt());
    else if (pdgMotherCombPart == 331)
      fHistoCombinatorialMothersPt[fiCut]->Fill(5., 8., motherCombPart->Pt());
    else if (pdgMotherCombPart == 310)
      fHistoCombinatorialMothersPt[fiCut]->Fill(5., 9., motherCombPart->Pt());
    else if (pdgMotherCombPart == 3122)
      fHistoCombinatorialMothersPt[fiCut]->Fill(5., 10., motherCombPart->Pt());
    else if (pdgMotherCombPart == 113 || pdgMotherCombPart == 213)
      fHistoCombinatorialMothersPt[fiCut]->Fill(5., 11., motherCombPart->Pt());
    else
      fHistoCombinatorialMothersPt[fiCut]->Fill(5., 12., motherCombPart->Pt());
  }
  else
  {
    if (pdgMotherCombPart == 11)
      fHistoCombinatorialMothersPt[fiCut]->Fill(4., 0., motherCombPart->Pt());
    else if (pdgMotherCombPart == 211)
      fHistoCombinatorialMothersPt[fiCut]->Fill(4., 1., motherCombPart->Pt());
    else if (pdgMotherCombPart == 321)
      fHistoCombinatorialMothersPt[fiCut]->Fill(4., 2., motherCombPart->Pt());
    else if (pdgMotherCombPart == 2212)
      fHistoCombinatorialMothersPt[fiCut]->Fill(4., 3., motherCombPart->Pt());
    else if (pdgMotherCombPart == 111)
      fHistoCombinatorialMothersPt[fiCut]->Fill(4., 4., motherCombPart->Pt());
    else if (pdgMotherCombPart == 221)
      fHistoCombinatorialMothersPt[fiCut]->Fill(4., 5., motherCombPart->Pt());
    else if (pdgMotherCombPart == 223)
      fHistoCombinatorialMothersPt[fiCut]->Fill(4., 6., motherCombPart->Pt());
    else if (pdgMotherCombPart == 333)
      fHistoCombinatorialMothersPt[fiCut]->Fill(4., 7., motherCombPart->Pt());
    else if (pdgMotherCombPart == 331)
      fHistoCombinatorialMothersPt[fiCut]->Fill(4., 8., motherCombPart->Pt());
    else if (pdgMotherCombPart == 310)
      fHistoCombinatorialMothersPt[fiCut]->Fill(4., 9., motherCombPart->Pt());
    else if (pdgMotherCombPart == 3122)
      fHistoCombinatorialMothersPt[fiCut]->Fill(4., 10., motherCombPart->Pt());
    else if (pdgMotherCombPart == 113 || pdgMotherCombPart == 213)
      fHistoCombinatorialMothersPt[fiCut]->Fill(4., 11., motherCombPart->Pt());
    else
      fHistoCombinatorialMothersPt[fiCut]->Fill(4., 12., motherCombPart->Pt());
  }
}

//________________________________________________________________________
void AliAnalysisTaskGammaConvFlowV1::FillPhotonCombinatorialMothersHistAOD(AliAODMCParticle *daughter, AliAODMCParticle *motherCombPart)
{
...
//________________________________________________________________________
void AliAnalysisTaskGammaConvFlowV1::RelabelAODPhotonCandidates(Bool_t mode)
{
...
//________________________________________________________________________
void AliAnalysisTaskGammaConvFlowV1::SetLogBinningXTH2(TH2 *histoRebin)
{
...
Bool_t AliAnalysisTaskGammaConvFlowV1::CheckVectorForDoubleCount(vector<Int_t> &vec, Int_t tobechecked)
{
  if (tobechecked > -1)
  {
...
//_________________________________________________________________________________
void AliAnalysisTaskGammaConvFlowV1::FillMultipleCountMap(map<Int_t, Int_t> &ma, Int_t tobechecked)
{
...
//_________________________________________________________________________________
void AliAnalysisTaskGammaConvFlowV1::FillMultipleCountHistoAndClear(map<Int_t, Int_t> &ma, TH1F *hist)
{
...
//________________________________________________________________________
void AliAnalysisTaskGammaConvFlowV1::Terminate(const Option_t *)
{
...
//________________________________________________________________________
Int_t AliAnalysisTaskGammaConvFlowV1::GetSourceClassification(Int_t daughter, Int_t pdgCode)
{
...
//________________________________________________________________________
void AliAnalysisTaskGammaConvFlowV1::ProcessClusters()
{
...
///________________________________________________________________________
Double_t AliAnalysisTaskGammaConvFlowV1::GetOriginalInvMass(const AliConversionPhotonBase *photon, AliVEvent *event) const
{
...
///________________________________________________________________________
void AliAnalysisTaskGammaConvFlowV1::SetEventBranch()
{
