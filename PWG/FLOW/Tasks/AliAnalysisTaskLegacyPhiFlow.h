...
#ifndef ALIANALYSISTASKLEGACYPHIFLOW_H
#define ALIANALYSISTASKLEGACYPHIFLOW_H
...
class AliAnalysisTaskLegacyPhiFlow : public AliAnalysisTaskSE
{
public:
   AliAnalysisTaskLegacyPhiFlow();
   AliAnalysisTaskLegacyPhiFlow(const char *name);
   virtual ~AliAnalysisTaskLegacyPhiFlow();
...
//   Bool_t               fApplyDeltaDipCut; // enforce delta dip cut
   ...
   AliAnalysisTaskLegacyPhiFlow(const AliAnalysisTaskLegacyPhiFlow&); // Not implemented
   AliAnalysisTaskLegacyPhiFlow& operator=(const AliAnalysisTaskLegacyPhiFlow&); // Not implemented
