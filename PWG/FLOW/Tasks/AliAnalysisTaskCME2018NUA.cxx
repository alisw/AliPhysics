 ...
 **************************************************************************/
/* $Id: AliAnalysisTaskCME2018NUA.cxx  Shi Qiu, 17/08/2022 (ver1) $ */
/* This class is derived from AliAnalysisTaskCVE           */
/* This analysis Task contains trivial corrections to CME */
...
#include "AliAnalysisTaskCME2018NUA.h"
...
ClassImp(AliAnalysisTaskCME2018NUA)

AliAnalysisTaskCME2018NUA::AliAnalysisTaskCME2018NUA(const char *name): AliAnalysisTaskSE(name),
  fVevent(NULL),
  fESD(NULL),
  fAOD(NULL),
  fPIDResponse(NULL),
...
AliAnalysisTaskCME2018NUA::AliAnalysisTaskCME2018NUA():
  fVevent(NULL),
  fESD(NULL),
  fAOD(NULL),
  fPIDResponse(NULL),
...
void AliAnalysisTaskCME2018NUA::UserCreateOutputObjects()
{
  ...
  */
  ...
  // use add task to set removal functions
...
void AliAnalysisTaskCME2018NUA::UserExec(Option_t*) {
...
Bool_t AliAnalysisTaskCME2018NUA::CheckEventIsPileUp2018(AliAODEvent *faod) {
...
Bool_t AliAnalysisTaskCME2018NUA::CheckEventIsPileUp(AliAODEvent *faod) {
...
Bool_t AliAnalysisTaskCME2018NUA::PileUpMultiVertex(const AliAODEvent* faod)
...
double AliAnalysisTaskCME2018NUA::GetWDist(const AliVVertex* v0, const AliVVertex* v1)
{
...
void AliAnalysisTaskCME2018NUA::SetupEventAndTaskConfigInfo(){
...
Int_t AliAnalysisTaskCME2018NUA::GetCentralityScaled0to10(Double_t fCent){
...
void AliAnalysisTaskCME2018NUA::GetNUACorrectionHist(Int_t run, Int_t kParticleID)
{
...
void AliAnalysisTaskCME2018NUA::GetV0MCorrectionHist(Int_t run, Int_t kParticleID)
{
...
void AliAnalysisTaskCME2018NUA::GetMCCorrectionHist(Int_t run,Float_t centr){
...
void AliAnalysisTaskCME2018NUA::SetupPileUpRemovalFunctions18() { 
...
void AliAnalysisTaskCME2018NUA::SetupPileUpRemovalFunctions18qPass3() { //@Shi for 2018 period Pass3 data
	// 18q pass3
...
void AliAnalysisTaskCME2018NUA::SetupPileUpRemovalFunctions18rPass3() { //@Shi for 2018 period Pass3 data
    // 18r pass3
    fSPDCutPU = new TF1("fSPDCutPU", "480. + 3.95*x", 0, 50000);
