...
#ifndef ALIANALYSISTASKGAMMANONISOTROPICCORR_H
#define ALIANALYSISTASKGAMMANONISOTROPICCORR_H
...
class    AliAnalysisTaskGammaNonIsotropicCorr;
class    AliVEvent;      
class    AliVVertex;
class    AliAODv0;
class    AliESDEvent;       
...
class AliAnalysisTaskGammaNonIsotropicCorr : public AliAnalysisTaskSE {

 public:

  //-----> Mandatory Functions:
  AliAnalysisTaskGammaNonIsotropicCorr();
  AliAnalysisTaskGammaNonIsotropicCorr(const char *name);
  virtual ~AliAnalysisTaskGammaNonIsotropicCorr();
 ...
 private:
  ...
  AliAnalysisTaskGammaNonIsotropicCorr(const AliAnalysisTaskGammaNonIsotropicCorr &other);
  AliAnalysisTaskGammaNonIsotropicCorr &operator=(const AliAnalysisTaskGammaNonIsotropicCorr &other);    
  ClassDef(AliAnalysisTaskGammaNonIsotropicCorr, 1) 
