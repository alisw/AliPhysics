...
#include "AliAnalysisTaskCMWPUuncAch.h"
...
ClassImp(AliAnalysisTaskCMWPUuncAch)

AliAnalysisTaskCMWPUuncAch::AliAnalysisTaskCMWPUuncAch(const char *name): AliAnalysisTaskSE(name),
  fVevent(NULL),
  fESD(NULL),
  fAOD(NULL),
  fPIDResponse(NULL),
...
AliAnalysisTaskCMWPUuncAch::AliAnalysisTaskCMWPUuncAch():
  fVevent(NULL),
  fESD(NULL),
  fAOD(NULL),
  fPIDResponse(NULL),
...
void AliAnalysisTaskCMWPUuncAch::UserCreateOutputObjects()
{
...
void AliAnalysisTaskCMWPUuncAch::UserExec(Option_t*) {
...
Bool_t AliAnalysisTaskCMWPUuncAch::CheckEventIsPileUp(AliAODEvent *faod) {
...
Bool_t AliAnalysisTaskCMWPUuncAch::PileUpMultiVertex(const AliAODEvent* faod)
...
double AliAnalysisTaskCMWPUuncAch::GetWDist(const AliVVertex* v0, const AliVVertex* v1)
{
...
void AliAnalysisTaskCMWPUuncAch::SetupEventAndTaskConfigInfo(){
...
Int_t AliAnalysisTaskCMWPUuncAch::GetCentralityScaled0to10(Double_t fCent){
...
void AliAnalysisTaskCMWPUuncAch::GetNUACorrectionHist(Int_t run, Int_t kParticleID)
{
...
void AliAnalysisTaskCMWPUuncAch::GetV0MCorrectionHist(Int_t run, Int_t kParticleID)
{
...
void AliAnalysisTaskCMWPUuncAch::GetMCCorrectionHist(Int_t run,Float_t centr){
