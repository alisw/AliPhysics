...
void AliAnalysisTaskPhiFlow::UserExec(Option_t *)
{
    ...
    if (fAOD) {
        ...
        for (Int_t iTracks = 0; iTracks < unTracks; iTracks++) { // select analysis candidates
            ...
            qx+=TMath::Cos(2.*track->Phi());
            qy+=TMath::Sin(2.*track->Phi());
            if (fQA) {
