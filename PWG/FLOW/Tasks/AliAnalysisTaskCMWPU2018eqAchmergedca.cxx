...
#include "AliAnalysisTaskCMWPU2018eqAchmergedca.h"
...
ClassImp(AliAnalysisTaskCMWPU2018eqAchmergedca)

AliAnalysisTaskCMWPU2018eqAchmergedca::AliAnalysisTaskCMWPU2018eqAchmergedca(const char *name): AliAnalysisTaskSE(name),
  fVevent(NULL),
  fESD(NULL),
  fAOD(NULL),
  fPIDResponse(NULL),
...
AliAnalysisTaskCMWPU2018eqAchmergedca::AliAnalysisTaskCMWPU2018eqAchmergedca():
  fVevent(NULL),
  fESD(NULL),
  fAOD(NULL),
  fPIDResponse(NULL),
...
void AliAnalysisTaskCMWPU2018eqAchmergedca::UserCreateOutputObjects()
{
...
void AliAnalysisTaskCMWPU2018eqAchmergedca::UserExec(Option_t*) {
...
Bool_t AliAnalysisTaskCMWPU2018eqAchmergedca::CheckEventIsPileUp2018(AliAODEvent *faod) {
...
Bool_t AliAnalysisTaskCMWPU2018eqAchmergedca::CheckEventIsPileUp(AliAODEvent *faod) {
...
Bool_t AliAnalysisTaskCMWPU2018eqAchmergedca::PileUpMultiVertex(const AliAODEvent* faod)
...
double AliAnalysisTaskCMWPU2018eqAchmergedca::GetWDist(const AliVVertex* v0, const AliVVertex* v1)
{
...
void AliAnalysisTaskCMWPU2018eqAchmergedca::SetupEventAndTaskConfigInfo(){
...
Int_t AliAnalysisTaskCMWPU2018eqAchmergedca::GetCentralityScaled0to10(Double_t fCent){
...
void AliAnalysisTaskCMWPU2018eqAchmergedca::GetNUACorrectionHist(Int_t run, Int_t kParticleID)
{
...
void AliAnalysisTaskCMWPU2018eqAchmergedca::GetV0MCorrectionHist(Int_t run, Int_t kParticleID)
{
...
void AliAnalysisTaskCMWPU2018eqAchmergedca::GetMCCorrectionHist(Int_t run,Float_t centr){
