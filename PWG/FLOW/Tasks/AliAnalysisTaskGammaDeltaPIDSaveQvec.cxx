...
///Track variables:
  ...
  for(Int_t c=0;c<4;c++) {
    for (Int_t h=0;h<fCRCnHar;h++) {
      ...
      if(fCMEQRePion[c][h]) fCMEQRe[c][h]->Reset();
      if(fCMEQImPion[c][h]) fCMEQIm[c][h]->Reset();
      if(fCMEMultPion[c][h]) fCMEMult[c][h]->Reset();
      if(fCMEQReKaon[c][h]) fCMEQRe[c][h]->Reset();
      if(fCMEQImKaon[c][h]) fCMEQIm[c][h]->Reset();
      if(fCMEMultKaon[c][h]) fCMEMult[c][h]->Reset();
      if(fCMEQReProton[c][h]) fCMEQRe[c][h]->Reset();
      if(fCMEQImProton[c][h]) fCMEQIm[c][h]->Reset();
      if(fCMEMultProton[c][h]) fCMEMult[c][h]->Reset();
    }
  }
  ...
  for(Int_t c=0;c<2;c++) {
    for (Int_t h=0;h<fCRCnHar;h++) {
      ...
      if(fCMEQRePionBothCharge[c][h]) fCMEQReBothCharge[c][h]->Reset();
      if(fCMEQImPionBothCharge[c][h]) fCMEQImBothCharge[c][h]->Reset();
      if(fCMEMultPionBothCharge[c][h]) fCMEMultBothCharge[c][h]->Reset();
      if(fCMEQReKaonBothCharge[c][h]) fCMEQReBothCharge[c][h]->Reset();
      if(fCMEQImKaonBothCharge[c][h]) fCMEQImBothCharge[c][h]->Reset();
      if(fCMEMultKaonBothCharge[c][h]) fCMEMultBothCharge[c][h]->Reset();
      if(fCMEQReProtonBothCharge[c][h]) fCMEQReBothCharge[c][h]->Reset();
      if(fCMEQImProtonBothCharge[c][h]) fCMEQImBothCharge[c][h]->Reset();
      if(fCMEMultProtonBothCharge[c][h]) fCMEMultBothCharge[c][h]->Reset();
    }
  }
...
void AliAnalysisTaskGammaDeltaPIDSaveQvec::SetupAnalysisHistograms(){
  ...
  for(Int_t c=0;c<4;c++) {
    for (Int_t h=0;h<fCRCnHar;h++) {
      fCMEQRe[c][h] = new TH1D(Form("fCMEQRe[%d][%d]",c,h),Form("fCMEQRe[%d][%d]",c,h),fCMEnEtaBin,fCRCEtaBin);
      fTempList->Add(fCMEQRe[c][h]);
      fCMEQIm[c][h] = new TH1D(Form("fCMEQIm[%d][%d]",c,h),Form("fCMEQIm[%d][%d]",c,h),fCMEnEtaBin,fCRCEtaBin);
      fTempList->Add(fCMEQIm[c][h]);
      fCMEMult[c][h] = new TH1D(Form("fCMEMult[%d][%d]",c,h),Form("fCMEMult[%d][%d]",c,h),fCMEnEtaBin,fCRCEtaBin);
      fTempList->Add(fCMEMult[c][h]);
      
      fCMEQRePion[c][h] = new TH1D(Form("fCMEQRePion[%d][%d]",c,h),Form("fCMEQRePion[%d][%d]",c,h),fCMEnEtaBin,fCRCEtaBin);
      fTempList->Add(fCMEQRePion[c][h]);
      fCMEQImPion[c][h] = new TH1D(Form("fCMEQImPion[%d][%d]",c,h),Form("fCMEQImPion[%d][%d]",c,h),fCMEnEtaBin,fCRCEtaBin);
      fTempList->Add(fCMEQImPion[c][h]);
      fCMEMultPion[c][h] = new TH1D(Form("fCMEMultPion[%d][%d]",c,h),Form("fCMEMultPion[%d][%d]",c,h),fCMEnEtaBin,fCRCEtaBin);
      fTempList->Add(fCMEMultPion[c][h]);
      
      fCMEQReKaon[c][h] = new TH1D(Form("fCMEQReKaon[%d][%d]",c,h),Form("fCMEQReKaon[%d][%d]",c,h),fCMEnEtaBin,fCRCEtaBin);
      fTempList->Add(fCMEQReKaon[c][h]);
      fCMEQImKaon[c][h] = new TH1D(Form("fCMEQImKaon[%d][%d]",c,h),Form("fCMEQImKaon[%d][%d]",c,h),fCMEnEtaBin,fCRCEtaBin);
      fTempList->Add(fCMEQImKaon[c][h]);
      fCMEMultKaon[c][h] = new TH1D(Form("fCMEMultKaon[%d][%d]",c,h),Form("fCMEMultKaon[%d][%d]",c,h),fCMEnEtaBin,fCRCEtaBin);
      fTempList->Add(fCMEMultKaon[c][h]);
      
      fCMEQReProton[c][h] = new TH1D(Form("fCMEQReProton[%d][%d]",c,h),Form("fCMEQReProton[%d][%d]",c,h),fCMEnEtaBin,fCRCEtaBin);
      fTempList->Add(fCMEQReProton[c][h]);
      fCMEQImProton[c][h] = new TH1D(Form("fCMEQImProton[%d][%d]",c,h),Form("fCMEQImProton[%d][%d]",c,h),fCMEnEtaBin,fCRCEtaBin);
      fTempList->Add(fCMEQImProton[c][h]);
      fCMEMultProton[c][h] = new TH1D(Form("fCMEMultProton[%d][%d]",c,h),Form("fCMEMultProton[%d][%d]",c,h),fCMEnEtaBin,fCRCEtaBin);
  ...
  for(Int_t c=0;c<2;c++) { // c is the index for the power of weight: weight^c*cos((h+1)*phi)
    for (Int_t h=0;h<fCRCnHar;h++) {
      fCMEQReBothCharge[c][h] = new TH1D(Form("fCMEQReBothCharge[%d][%d]",c,h),Form("fCMEQReBothCharge[%d][%d]",c,h),fCMEnEtaBin,fCRCEtaBin);
      fTempList->Add(fCMEQReBothCharge[c][h]);
      fCMEQImBothCharge[c][h] = new TH1D(Form("fCMEQImBothCharge[%d][%d]",c,h),Form("fCMEQImBothCharge[%d][%d]",c,h),fCMEnEtaBin,fCRCEtaBin);
      fTempList->Add(fCMEQImBothCharge[c][h]);
      fCMEMultBothCharge[c][h] = new TH1D(Form("fCMEMultBothCharge[%d][%d]",c,h),Form("fCMEMultBothCharge[%d][%d]",c,h),fCMEnEtaBin,fCRCEtaBin);
      fTempList->Add(fCMEMultBothCharge[c][h]);
      
      fCMEQRePionBothCharge[c][h] = new TH1D(Form("fCMEQRePionBothCharge[%d][%d]",c,h),Form("fCMEQRePionBothCharge[%d][%d]",c,h),fCMEnEtaBin,fCRCEtaBin);
      fTempList->Add(fCMEQRePionBothCharge[c][h]);
      fCMEQImPionBothCharge[c][h] = new TH1D(Form("fCMEQImPionBothCharge[%d][%d]",c,h),Form("fCMEQImPionBothCharge[%d][%d]",c,h),fCMEnEtaBin,fCRCEtaBin);
      fTempList->Add(fCMEQImPionBothCharge[c][h]);
      fCMEMultPionBothCharge[c][h] = new TH1D(Form("fCMEMultPionBothCharge[%d][%d]",c,h),Form("fCMEMultPionBothCharge[%d][%d]",c,h),fCMEnEtaBin,fCRCEtaBin);
      fTempList->Add(fCMEMultPionBothCharge[c][h]);
      
      fCMEQReKaonBothCharge[c][h] = new TH1D(Form("fCMEQReKaonBothCharge[%d][%d]",c,h),Form("fCMEQReKaonBothCharge[%d][%d]",c,h),fCMEnEtaBin,fCRCEtaBin);
      fTempList->Add(fCMEQReKaonBothCharge[c][h]);
      fCMEQImKaonBothCharge[c][h] = new TH1D(Form("fCMEQImKaonBothCharge[%d][%d]",c,h),Form("fCMEQImKaonBothCharge[%d][%d]",c,h),fCMEnEtaBin,fCRCEtaBin);
      fTempList->Add(fCMEQImKaonBothCharge[c][h]);
      fCMEMultKaonBothCharge[c][h] = new TH1D(Form("fCMEMultKaonBothCharge[%d][%d]",c,h),Form("fCMEMultKaonBothCharge[%d][%d]",c,h),fCMEnEtaBin,fCRCEtaBin);
      fTempList->Add(fCMEMultKaonBothCharge[c][h]);
      
      fCMEQReProtonBothCharge[c][h] = new TH1D(Form("fCMEQReProtonBothCharge[%d][%d]",c,h),Form("fCMEQReProtonBothCharge[%d][%d]",c,h),fCMEnEtaBin,fCRCEtaBin);
      fTempList->Add(fCMEQReProtonBothCharge[c][h]);
      fCMEQImProtonBothCharge[c][h] = new TH1D(Form("fCMEQImProtonBothCharge[%d][%d]",c,h),Form("fCMEQImProtonBothCharge[%d][%d]",c,h),fCMEnEtaBin,fCRCEtaBin);
      fTempList->Add(fCMEQImProtonBothCharge[c][h]);
      fCMEMultProtonBothCharge[c][h] = new TH1D(Form("fCMEMultProtonBothCharge[%d][%d]",c,h),Form("fCMEMultProtonBothCharge[%d][%d]",c,h),fCMEnEtaBin,fCRCEtaBin);
