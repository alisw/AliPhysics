...
#ifndef ALIANALYSISTASKCVE_H
#define ALIANALYSISTASKCVE_H
...
class AliAnalysisTaskCVE : public AliAnalysisTaskSE {
 ...
 private:
  ...
  AliAnalysisTaskCVE(const AliAnalysisTaskCVE &other);
  AliAnalysisTaskCVE &operator=(const AliAnalysisTaskCVE &other);    
