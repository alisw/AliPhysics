...
#ifndef ALIANALYSISTASKCMWPU_H
#define ALIANALYSISTASKCMWPU_H
...
class AliAnalysisTaskCMWPU : public AliAnalysisTaskSE {

 public:

  //-----> Mandatory Functions:
  AliAnalysisTaskCMWPU();
  AliAnalysisTaskCMWPU(const char *name);
  virtual ~AliAnalysisTaskCMWPU();
 ...
 private:
  ...
  AliAnalysisTaskCMWPU(const AliAnalysisTaskCMWPU &other);
  AliAnalysisTaskCMWPU &operator=(const AliAnalysisTaskCMWPU &other);    
  ClassDef(AliAnalysisTaskCMWPU, 1) 
