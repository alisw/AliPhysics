...
#ifndef ALIANALYSISTASKCMWPU2018_H
#define ALIANALYSISTASKCMWPU2018_H
...
class AliAnalysisTaskCMWPU2018 : public AliAnalysisTaskSE {

 public:

  //-----> Mandatory Functions:
  AliAnalysisTaskCMWPU2018();
  AliAnalysisTaskCMWPU2018(const char *name);
  virtual ~AliAnalysisTaskCMWPU2018();
 ...
 private:
  ...
  AliAnalysisTaskCMWPU2018(const AliAnalysisTaskCMWPU2018 &other);
  AliAnalysisTaskCMWPU2018 &operator=(const AliAnalysisTaskCMWPU2018 &other);    
  ClassDef(AliAnalysisTaskCMWPU2018, 1) 
