...
#ifndef ALIANALYSISTASKCMWPU2018eqAchdca_H
#define ALIANALYSISTASKCMWPU2018eqAchdca_H
...
class AliAnalysisTaskCMWPU2018eqAchdca : public AliAnalysisTaskSE {

 public:

  //-----> Mandatory Functions:
  AliAnalysisTaskCMWPU2018eqAchdca();
  AliAnalysisTaskCMWPU2018eqAchdca(const char *name);
  virtual ~AliAnalysisTaskCMWPU2018eqAchdca();
  ...
  */
  ...
  AliAnalysisTaskCMWPU2018eqAchdca(const AliAnalysisTaskCMWPU2018eqAchdca &other);
  AliAnalysisTaskCMWPU2018eqAchdca &operator=(const AliAnalysisTaskCMWPU2018eqAchdca &other);    
  ClassDef(AliAnalysisTaskCMWPU2018eqAchdca, 1) 
