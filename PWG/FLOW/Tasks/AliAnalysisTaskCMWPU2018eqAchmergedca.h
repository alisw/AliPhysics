...
#ifndef ALIANALYSISTASKCMWPU2018eqAchmergedca_H
#define ALIANALYSISTASKCMWPU2018eqAchmergedca_H
...
class AliAnalysisTaskCMWPU2018eqAchmergedca : public AliAnalysisTaskSE {

 public:

  //-----> Mandatory Functions:
  AliAnalysisTaskCMWPU2018eqAchmergedca();
  AliAnalysisTaskCMWPU2018eqAchmergedca(const char *name);
  virtual ~AliAnalysisTaskCMWPU2018eqAchmergedca();
  ...
  */
  ...
  AliAnalysisTaskCMWPU2018eqAchmergedca(const AliAnalysisTaskCMWPU2018eqAchmergedca &other);
  AliAnalysisTaskCMWPU2018eqAchmergedca &operator=(const AliAnalysisTaskCMWPU2018eqAchmergedca &other);    
  ClassDef(AliAnalysisTaskCMWPU2018eqAchmergedca, 1) 
