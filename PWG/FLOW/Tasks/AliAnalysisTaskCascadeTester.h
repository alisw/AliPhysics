...
#ifndef AliAnalysisTaskCascadeTester_H
#define AliAnalysisTaskCascadeTester_H
...
class AliAnalysisTaskCascadeTester : public AliAnalysisTaskSE
{
public:
   AliAnalysisTaskCascadeTester();
   AliAnalysisTaskCascadeTester(const char *name);
   virtual ~AliAnalysisTaskCascadeTester();
...
//   Float_t                              GetDeltaDipPt() const {return fDeltaDipPt; }
   ...
   Bool_t                               fOmega; // do omegas
   Bool_t                               fXi;    // do xi
   void                                 DoOmega()      {fOmega = kTRUE, fXi = kFALSE;}
   void                                 DoXi()         {fXi = kTRUE, fOmega = kFALSE;}
...
//   Bool_t               fApplyDeltaDipCut; // enforce delta dip cut
   ...
   AliAnalysisTaskCascadeTester(const AliAnalysisTaskCascadeTester&); // Not implemented
   AliAnalysisTaskCascadeTester& operator=(const AliAnalysisTaskCascadeTester&); // Not implemented
   void                 MakeTrack(Double_t, Double_t, Double_t, Double_t) const;

   ClassDef(AliAnalysisTaskCascadeTester, 1);
};
