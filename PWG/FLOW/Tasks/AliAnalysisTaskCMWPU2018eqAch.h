...
#ifndef ALIANALYSISTASKCMWPU2018eqAch_H
#define ALIANALYSISTASKCMWPU2018eqAch_H
...
class AliAnalysisTaskCMWPU2018eqAch : public AliAnalysisTaskSE {

 public:

  //-----> Mandatory Functions:
  AliAnalysisTaskCMWPU2018eqAch();
  AliAnalysisTaskCMWPU2018eqAch(const char *name);
  virtual ~AliAnalysisTaskCMWPU2018eqAch();
 ...
 private:
  ...
  AliAnalysisTaskCMWPU2018eqAch(const AliAnalysisTaskCMWPU2018eqAch &other);
  AliAnalysisTaskCMWPU2018eqAch &operator=(const AliAnalysisTaskCMWPU2018eqAch &other);    
  ClassDef(AliAnalysisTaskCMWPU2018eqAch, 1) 
