...
private:
  ...
  static TF1*     fV2Parametrization[19];     // pt paramtrizations
  static Int_t    fV2RefParameterization[19]; // ID of a hadron used for parameterization of V2 for Et scaling
