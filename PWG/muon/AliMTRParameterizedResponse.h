...
class AliMTRParameterizedResponse : public TObject {
 public:
  ...
  Double_t WeightPerBoard ( Double_t pt, Int_t iboard, Int_t itype, Bool_t isMC, Bool_t useFit );
  Double_t WeightPerEta ( Double_t pt, Double_t eta, Int_t itype, Bool_t isMC, Bool_t useFit );
...
//                                       const char* outputNameData = "MTRResponseOut", const char* outputNameMC = "MTRResponseOut" const char* identifierData = "out", const char* identifierMC = "out");
  ...
  Bool_t ShowResponses ( Int_t itype, Bool_t isMC, Bool_t perBoard );
  Bool_t CompareResponses ( Int_t itype, Bool_t perBoard );


 private:

  Double_t GetWeight ( Double_t pt, Int_t ibin, Int_t itype, Bool_t isMC, Bool_t useFit, Bool_t perBoard );
  Bool_t SetRatio ( TH2* histoNum, TH2* histoDen, Int_t itype, Bool_t isMC, Int_t rebin = 1 );
  TObjArray* GetResponse ( Int_t itype, Bool_t isMC, Bool_t perBoard, Bool_t warn = kTRUE );
  Bool_t AddResponse ( Int_t itype, Bool_t isMC, Bool_t perBoard, TObjArray* resp );

  TString GetStdName ( Int_t itype, Bool_t isMC, Bool_t perBoard );
