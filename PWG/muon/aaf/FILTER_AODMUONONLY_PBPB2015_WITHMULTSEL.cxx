...
///
/// Convert a full (std) AOD to a muon only AOD (for real data), including the
/// centrality objects (MultSel)
///
...
void FILTER_AODMUONONLY_PBPB2015_WITHMULTSEL(const char* from, const char* to)
{
  ...
  gROOT->ProcessLine(".x $ALICE_PHYSICS/OADB/COMMON/MULTIPLICITY/macros/AddTaskMultSelection.C(kFALSE)");
