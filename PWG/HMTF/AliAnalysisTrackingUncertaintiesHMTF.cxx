...
#include "AliLog.h"
//
#include "AliAnalysisTrackingUncertaintiesHMTF.h"


ClassImp(AliAnalysisTrackingUncertaintiesHMTF)


//________________________________________________________________________
AliAnalysisTrackingUncertaintiesHMTF::AliAnalysisTrackingUncertaintiesHMTF()
...
//________________________________________________________________________
AliAnalysisTrackingUncertaintiesHMTF::AliAnalysisTrackingUncertaintiesHMTF(const char *name)
...
//________________________________________________________________________
void AliAnalysisTrackingUncertaintiesHMTF::UserCreateOutputObjects()
{
  // create track cuts
...
//________________________________________________________________________
void AliAnalysisTrackingUncertaintiesHMTF::UserExec(Option_t *)
{
  //
  // main event loop
  //
...
//________________________________________________________________________
void AliAnalysisTrackingUncertaintiesHMTF::ProcessTracks(AliStack *stack) {
...
//________________________________________________________________________
void AliAnalysisTrackingUncertaintiesHMTF::Terminate(Option_t *)
{
...
//________________________________________________________________________
void AliAnalysisTrackingUncertaintiesHMTF::BinLogAxis(const THnSparseF *h, Int_t axisNumber) {
  //
...
//________________________________________________________________________
Bool_t AliAnalysisTrackingUncertaintiesHMTF::IsVertexAccepted(AliESDEvent * esd) {
  //
...
//________________________________________________________________________
Bool_t AliAnalysisTrackingUncertaintiesHMTF::IsConsistentWithPid(Int_t type, const AliESDtrack * const tr) {
  //
...
//________________________________________________________________________
Bool_t AliAnalysisTrackingUncertaintiesHMTF::IsElectron(const AliESDtrack * const tr, Bool_t useTPCTOF) const {
  //
...
//________________________________________________________________________
Bool_t AliAnalysisTrackingUncertaintiesHMTF::IsPion(const AliESDtrack * const tr,Bool_t useTPCTOF) const{
  //
...
//________________________________________________________________________
Bool_t AliAnalysisTrackingUncertaintiesHMTF::IsKaon(const AliESDtrack * const tr,Bool_t useTPCTOF) const {
  //
...
//________________________________________________________________________
Bool_t AliAnalysisTrackingUncertaintiesHMTF::IsProton(const AliESDtrack * const tr,Bool_t useTPCTOF) const{
  //
...
//________________________________________________________________________
void AliAnalysisTrackingUncertaintiesHMTF::InitializeTrackCutHistograms() {
  //
