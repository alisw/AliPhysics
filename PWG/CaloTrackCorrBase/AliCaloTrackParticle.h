...
class AliCaloTrackParticle : public AliVParticle {
 ...
 public:
  ...
  Double_t GetPairMass(AliCaloTrackParticle * p) const { return (*(p->fMomentum)+*fMomentum).M() ; }
...
///
inline Double_t AliCaloTrackParticle::Phi() const
{
