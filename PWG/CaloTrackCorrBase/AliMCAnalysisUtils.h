...
class AliMCAnalysisUtils : public TObject {
 ...
 public: 
  ...
  Int_t   CheckOriginInStack(const Int_t *labels, Int_t nlabels, AliMCEvent* mcevent            , const TObjArray *arrayCluster) ; // ESD
  Int_t   CheckOriginInAOD  (const Int_t *labels, Int_t nlabels, const TClonesArray* mcparticles, const TObjArray *arrayCluster) ; // AOD
  
  void    CheckOverlapped2GammaDecay(const Int_t *labels, Int_t nlabels, Int_t mesonIndex, AliMCEvent* mcevent,             Int_t & tag); // ESD
  ...
  void    CheckLostDecayPair(const TObjArray *arrayCluster, Int_t iMom, Int_t iParent, AliMCEvent* mcevent,             Int_t & tag); // ESD
