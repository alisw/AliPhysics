...
class AliAnalysisTaskCaloTrackCorrelation : public AliAnalysisTaskSE
{
 public:
  ...
  void         SetSelectPtHardBin(Int_t bin)      { fSelectPtHardBin  = bin     ; }
  Int_t        SelectedPtHardBin()          const { return fSelectPtHardBin     ; }

  void         SetSelectPtHardPattern(TString st) { fSelectPtHardPattern = st   ; }
  TString      SelectedPtHardPattern()      const { return fSelectPtHardPattern ; }
  
  void         SetSelectPtHardEmbed(Bool_t emb)   { fSelectPtHardEmbed = emb    ; }
  Bool_t       SelectedEmbedPtHardBin()     const { return fSelectPtHardEmbed   ; }
 ...
 private:
  ...
  Int_t   fSelectPtHardBin;        ///< Select events generated with this pT hard bin
  TString fSelectPtHardPattern;    ///< Select events generated with this pattern in file path
  Bool_t  fSelectPtHardEmbed;      ///< Select events generated by embedded pT hard bin  fSelectPtHardBin
  TString fPtHardCurrentFileName;  ///< Current file path, internal

  Bool_t  fStoreEventSummary;      ///<  Store in output histograms list 2 histograms with event summary, off by default.
  
  /// \cond CLASSIMP
  ClassDef(AliAnalysisTaskCaloTrackCorrelation, 7) ; 
  /// \endcond
