...
void AliEmcalCorrectionTask::Initialize()
{
  ...
  PrintRequestedContainersInformation(AliEmcalContainerUtils::kCaloCells);
  // Create cluster input objects
  CreateInputObjects(AliEmcalContainerUtils::kCluster);
  PrintRequestedContainersInformation(AliEmcalContainerUtils::kCluster);
  // Create track input objects
  CreateInputObjects(AliEmcalContainerUtils::kTrack);
  PrintRequestedContainersInformation(AliEmcalContainerUtils::kTrack);
...
void AliEmcalCorrectionTask::PrintRequestedContainersInformation(AliEmcalContainerUtils::InputObject_t inputObjectType)
{
  if (inputObjectType == AliEmcalContainerUtils::kCaloCells) {
    ...
    AliInfoStream() << (inputObjectType == AliEmcalContainerUtils::kCluster ? "Cluster" : "Track") << " container info: " << std::endl;
    AliEmcalContainer * cont = 0;
