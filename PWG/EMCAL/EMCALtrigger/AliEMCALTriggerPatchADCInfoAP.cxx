...
ClassImp(AliEMCALTriggerPatchADCInfoAP)
...
void AliEMCALTriggerPatchADCInfoAP::SetADC(Int_t adc, UChar_t col, UChar_t row){
  try{
...
Int_t AliEMCALTriggerPatchADCInfoAP::GetADC(UChar_t col, UChar_t row) const {
  try{
