 ...
 **************************************************************************/
#ifndef ALIEMCALTRIGGERFASTORAP_H
#define ALIEMCALTRIGGERFASTORAP_H
/**
 * Trigger FastOR data struct
 *
 * @file   AliEmcalTriggerFastORAP.h
...
class AliEmcalTriggerFastORAP {
 ...
 public:
  ...
  AliEmcalTriggerFastORAP();
  AliEmcalTriggerFastORAP(UInt_t L0amp, UInt_t L1amp, Int_t absId, const AliEMCALGeometry* geom);
  AliEmcalTriggerFastORAP(UInt_t L0amp, UInt_t L1amp, Int_t globalRow, Int_t glocalCol, const AliEMCALGeometry* geom);
