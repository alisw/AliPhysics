#ifndef ALIMUONTRIGGERSEGMENTATIONV2_H
#define ALIMUONTRIGGERSEGMENTATIONV2_H
...
/// \ingroup base
/// \class AliMUONTriggerSegmentationV2
...
class AliMUONTriggerSegmentationV2 : public AliMUONVGeometryDESegmentation 
{
 public:
