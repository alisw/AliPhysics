...
void MakeMUONCDBObjects()
{
  ...
  AliMUONCDB::WriteTracker();  // MUON/Calib/MappingData MUON/Calib/MappingRunData MUON/Calib/HV MUON/Calib/Pedestals MUON/Calib/OccupancyMap MUON/Calib/RejectList MUON/Calib/Config
