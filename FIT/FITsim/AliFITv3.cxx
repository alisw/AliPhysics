...
//--------------------------------------------------------------------
AliFITv3::AliFITv3(const char *name, const char *title):
  AliFIT(name,title),
  fIdSens1(0),
  fIdSens2(0),
  fPMTeff(0x0)
...
//------------------------------------------------------------------------
void AliFITv3::AddAlignableVolumes() const
{
  //
...
//-------------------------------------------------------------------
void AliFITv3::DefineOpticalProperties()
{
...
//------------------------------------------------------------------------
Bool_t AliFITv3::RegisterPhotoE(Double_t energy)
{
