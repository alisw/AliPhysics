#ifndef ALITRDRAWHLTSTREAM_H
#define ALITRDRAWHLTSTREAM_H
...
{ // class def begin
 ...
 public:
  ...
  Int_t GetGlobalNTimeBins() {return fGlobalNTimeBins;} // get number of time information for the digit container
