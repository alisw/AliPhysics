...
#ifndef AliAnalysisTaskHFEmultTPCEMCAL_cxx
#define AliAnalysisTaskHFEmultTPCEMCAL_cxx
...
class AliAnalysisTaskHFEmultTPCEMCAL;
class AliCFManager;
class AliHFEcuts;
class AliHFEpidQAmanager;
...
class AliAnalysisTaskHFEmultTPCEMCAL : public AliAnalysisTaskSE {
 public:
   ...
   enum ESourceType {kNoMotherE, kPi0NoFeedDown, kEtaNoFeedDown, kGPi0NoFeedDown, kGEtaNoFeedDown, kDirectGamma, kOthersE};//0,1,2,3,4,5,6
	...
	AliAnalysisTaskHFEmultTPCEMCAL() ;
	AliAnalysisTaskHFEmultTPCEMCAL(const char *name);
	virtual ~AliAnalysisTaskHFEmultTPCEMCAL() ;
...
//====================MC================
   ...
   TH1F                *fULSElecPt;//!
	...
	AliAnalysisTaskHFEmultTPCEMCAL(const AliAnalysisTaskHFEmultTPCEMCAL&); // not implemented
	AliAnalysisTaskHFEmultTPCEMCAL& operator=(const AliAnalysisTaskHFEmultTPCEMCAL&); // not implemented
	  
	ClassDef(AliAnalysisTaskHFEmultTPCEMCAL, 1); // ClassDef(ClassName,ClassVersionID)  
};
