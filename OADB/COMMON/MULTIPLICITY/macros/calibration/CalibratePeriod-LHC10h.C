...
CalibratePeriod_LHC10h(TString lPeriodName = "LHC10h"){
  ...
  //Plus and Minus
  AliMultEstimator *fEstCL0plus10 = new AliMultEstimator("CL0plus10", "", "(fnSPDClusters0)");
  ...
  AliMultEstimator *fEstCL0plus05 = new AliMultEstimator("CL0plus05", "", "(fnSPDClusters0)");
  ...
  AliMultEstimator *fEstCL0minus10 = new AliMultEstimator("CL0minus10", "", "(fnSPDClusters0)");
  ...
  AliMultEstimator *fEstCL0minus05 = new AliMultEstimator("CL0minus05", "", "(fnSPDClusters0)");
  ...
  //Plus and Minus
  AliMultEstimator *fEstCL1plus10 = new AliMultEstimator("CL1plus10", "", "(fnSPDClusters1)");
  ...
  AliMultEstimator *fEstCL1plus05 = new AliMultEstimator("CL1plus05", "", "(fnSPDClusters1)");
  ...
  AliMultEstimator *fEstCL1minus10 = new AliMultEstimator("CL1minus10", "", "(fnSPDClusters1)");
  ...
  AliMultEstimator *fEstCL1minus05 = new AliMultEstimator("CL1minus05", "", "(fnSPDClusters1)");
  ...
  //AliMultEstimator *fEstnSPDTracklets = new AliMultEstimator("SPDTracklets", "", "(fnTracklets)");
  //fEstnSPDTracklets->SetIsInteger(kTRUE); //deprecated
   ...
   */
  lCalib->SetRunToUseAsDefault(137161);
  
  //============================================================
  // --- Definition of Input/Output ---
  //============================================================
  lCalib -> SetInputFile  ( "/storage1/grgarcia/alice/ServiceTask/LHC10h.root");
  //lCalib -> SetInputFile  ( "/hera/alice/alberica/centrality/Trees/Merged/PbPb/MergedLHC10h.root");
  lCalib -> SetBufferFile ( "buffer.root" );
  lCalib -> SetOutputFile ( "TESTOADB-LHC10h.root" );
  lCalib -> Calibrate     ();
