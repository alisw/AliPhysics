...
void CalibratePeriod_LHC15o(TString lPeriodName = "LHC15o"){
  ...
  if( lPeriodName.Contains("LHC15o") ) {
    fEstV0A = new AliMultEstimator("V0A", "", "((fAmplitude_V0A)/(1 + ((fEvSel_VtxZ)-1.11974)*(-0.00529266 - ((fEvSel_VtxZ)-1.11974)*0.000153883)))");
    fEstV0A -> SetUseAnchor        ( kTRUE   ) ;
    fEstV0A -> SetAnchorPoint      ( 49.0854 ) ;
    fEstV0A -> SetAnchorPercentile ( 90.007  ) ;

    fEstV0C = new AliMultEstimator("V0C", "", "((fAmplitude_V0C)/(1 + ((fEvSel_VtxZ)-1.12997)*(4.04273e-07 - ((fEvSel_VtxZ)-1.12997)* 2.94567e-05 )))");
  ...
  if( lPeriodName.Contains("LHC10h") ) {
    fEstnSPDClustersCorr = new AliMultEstimator("SPDClustersCorr", "", "(fnSPDClusters)/(1 + ((fEvSel_VtxZ)-1.08384)*(0.00131615 - ((fEvSel_VtxZ)-1.08384)*(-0.000659206)))");
    ...
    fEstCL0 = new AliMultEstimator("CL0", "", "(fnSPDClusters0)/(1+((fEvSel_VtxZ)-1.08424)*(0.000662816-((fEvSel_VtxZ)-1.08424)*(-0.00154626)))");
    fEstCL0 -> SetUseAnchor        ( kTRUE  ) ;
    fEstCL0 -> SetAnchorPoint      ( lDefaultCL0Anchor    ) ;
    fEstCL0 -> SetAnchorPercentile ( lDefaultCL0Percentile  );

    fEstCL1 = new AliMultEstimator("CL1", "", "(fnSPDClusters1)/(1+((fEvSel_VtxZ)-1.07316)*(-0.000665863-((fEvSel_VtxZ)-1.07316)*(-0.0011758)))");
  ...
  if( lPeriodName.Contains("LHC15o") ) {
    ...
    fEstnSPDClustersCorr = new AliMultEstimator("SPDClustersCorr", "", "(fnSPDClusters)/(1 + ((fEvSel_VtxZ)-1.14951)*(0.000249854 - ((fEvSel_VtxZ)-1.14951)*(-0.000176228)))");
    fEstnSPDClustersCorr -> SetUseAnchor        ( kTRUE    ) ;
    fEstnSPDClustersCorr -> SetAnchorPercentile ( 90.0    ) ;
    ...
    //Config central CL0
    fEstCL0 = new AliMultEstimator("CL0", "", "(fnSPDClusters0)/(1+((fEvSel_VtxZ)-1.0)*(0.004+((fEvSel_VtxZ)-1.0)*(-0.001)))");
    fEstCL0 -> SetUseAnchor        ( kTRUE  ) ;
    fEstCL0 -> SetAnchorPoint      ( lDefaultCL0Anchor   ) ;
    fEstCL0 -> SetAnchorPercentile ( lDefaultCL0Percentile  ) ;

    //Config central CL1
    fEstCL1 = new AliMultEstimator("CL1", "", "(fnSPDClusters1)/(1+((fEvSel_VtxZ)-1.0)*(0.0008+((fEvSel_VtxZ)-1.0)*(-0.0009)))");
    fEstCL1 -> SetUseAnchor        ( kTRUE   ) ;
    fEstCL1 -> SetAnchorPoint      ( lDefaultCL1Anchor    ) ;
    fEstCL1 -> SetAnchorPercentile ( lDefaultCL1Percentile  ) ;

    //Plus and Minus
    fEstCL1plus10 = new AliMultEstimator("CL1plus10", "", "(fnSPDClusters1)/(1+((fEvSel_VtxZ)-1.0)*(0.0008+((fEvSel_VtxZ)-1.0)*(-0.0009)))");
    ...
    fEstCL1plus05 = new AliMultEstimator("CL1plus05", "", "(fnSPDClusters1)/(1+((fEvSel_VtxZ)-1.0)*(0.0008+((fEvSel_VtxZ)-1.0)*(-0.0009)))");
    ...
    fEstCL1minus05 = new AliMultEstimator("CL1minus05", "", "(fnSPDClusters1)/(1+((fEvSel_VtxZ)-1.0)*(0.0008+((fEvSel_VtxZ)-1.0)*(-0.0009)))");
    ...
    fEstCL1minus10 = new AliMultEstimator("CL1minus10", "", "(fnSPDClusters1)/(1+((fEvSel_VtxZ)-1.0)*(0.0008+((fEvSel_VtxZ)-1.0)*(-0.0009)))");
