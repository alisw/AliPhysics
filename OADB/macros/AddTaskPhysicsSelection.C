AliPhysicsSelectionTask* AddTaskPhysicsSelection(Bool_t mCAnalysisFlag = kFALSE, Bool_t deprecatedFlag = kTRUE, UInt_t deprecatedFlag2 = 0, Bool_t useSpecialOutput=kFALSE) 
{
