...
void BrowseAndFillPhysicsSelectionOADB(Bool_t fill = kFALSE) {
  ...
  triggerCount=0;
  oadbLHC15m->AddCollisionTriggerClass( AliVEvent::kMB,"+CINT1-B-NOPF-CENTNOTRD","B", triggerCount);
  ...
  oadbLHC15m->AddBGTriggerClass       ( AliVEvent::kINT7,"+CINT7-E-NOPF-CENT","E", triggerCount);
  oadbLHC15m->SetHardwareTrigger      ( triggerCount,"V0A && V0C");
  oadbLHC15m->SetOfflineTrigger       ( triggerCount,"V0A && V0C && !TPCLaserWarmUp && !TPCHVdip");
  ...
  oadbLHC15m->SetOfflineTrigger       ( triggerCount,"!T0BG && !TPCLaserWarmUp && !TPCHVdip");
  
  triggerCount++;
  oadbLHC15m->AddCollisionTriggerClass( AliVEvent::kMUS7,"+CMSL7-B-NOPF-MUFAST","B",triggerCount);
  oadbLHC15m->AddBGTriggerClass       ( AliVEvent::kMUS7,"+CMSL7-A-NOPF-MUFAST","A",triggerCount);
  oadbLHC15m->AddBGTriggerClass       ( AliVEvent::kMUS7,"+CMSL7-C-NOPF-MUFAST","C",triggerCount);
  oadbLHC15m->AddBGTriggerClass       ( AliVEvent::kMUS7,"+CMSL7-E-NOPF-MUFAST","E",triggerCount);
  oadbLHC15m->SetHardwareTrigger      ( triggerCount,"V0A && V0C");
  oadbLHC15m->SetOfflineTrigger       ( triggerCount,"V0A && V0C");

  triggerCount++;
  oadbLHC15m->AddCollisionTriggerClass( AliVEvent::kMUSH7,"+CMSH7-B-NOPF-MUFAST","B",triggerCount);
  oadbLHC15m->SetHardwareTrigger      ( triggerCount,"V0A && V0C");
  oadbLHC15m->SetOfflineTrigger       ( triggerCount,"V0A && V0C");

  triggerCount++;
  oadbLHC15m->AddCollisionTriggerClass( AliVEvent::kMUL7,"+CMLL7-B-NOPF-MUFAST","B",triggerCount);
  oadbLHC15m->SetHardwareTrigger      ( triggerCount,"V0A && V0C");
  oadbLHC15m->SetOfflineTrigger       ( triggerCount,"V0A && V0C");

  triggerCount++;
  oadbLHC15m->AddCollisionTriggerClass( AliVEvent::kMUU7,"+CMUL7-B-NOPF-MUFAST","B",triggerCount);
  oadbLHC15m->SetHardwareTrigger      ( triggerCount,"V0A && V0C");
  oadbLHC15m->SetOfflineTrigger       ( triggerCount,"V0A && V0C");

  triggerCount++;
  oadbLHC15m->AddCollisionTriggerClass   ( AliVEvent::kEMC7,"+C[E|D]MC7-B-NOPF-CENTNOPMD","B",triggerCount);
  oadbLHC15m->AddBGTriggerClass          ( AliVEvent::kEMC7,"+C[E|D]MC7-A-NOPF-CENTNOPMD","A",triggerCount);
  oadbLHC15m->AddBGTriggerClass          ( AliVEvent::kEMC7,"+C[E|D]MC7-C-NOPF-CENTNOPMD","C",triggerCount);
  oadbLHC15m->AddBGTriggerClass          ( AliVEvent::kEMC7,"+C[E|D]MC7-E-NOPF-CENTNOPMD","E",triggerCount);
  oadbLHC15m->SetHardwareTrigger         ( triggerCount,"V0A && V0C");
  oadbLHC15m->SetOfflineTrigger          ( triggerCount,"V0A && V0C && !TPCLaserWarmUp && !TPCHVdip");

  triggerCount++;
  oadbLHC15m->AddCollisionTriggerClass   ( AliVEvent::kPHI7,"+CPHI7-B-NOPF-CENTNOPMD","B",triggerCount);
  oadbLHC15m->AddBGTriggerClass          ( AliVEvent::kPHI7,"+CPHI7-A-NOPF-CENTNOPMD","A",triggerCount);
  oadbLHC15m->AddBGTriggerClass          ( AliVEvent::kPHI7,"+CPHI7-C-NOPF-CENTNOPMD","C",triggerCount);
  oadbLHC15m->AddBGTriggerClass          ( AliVEvent::kPHI7,"+CPHI7-E-NOPF-CENTNOPMD","E",triggerCount);
  oadbLHC15m->SetHardwareTrigger         ( triggerCount,"V0A && V0C");
  oadbLHC15m->SetOfflineTrigger          ( triggerCount,"V0A && V0C && !TPCLaserWarmUp && !TPCHVdip");
  
  triggerCount++;
  oadbLHC15m->AddCollisionTriggerClass   ( AliVEvent::kEMCEJE,"+CEMC7EJ[1|2]-B-NOPF-CENTNOPMD,CDMC7DJ[1|2]-B-NOPF-CENTNOPMD","B",triggerCount);
  oadbLHC15m->SetHardwareTrigger         ( triggerCount,"V0A && V0C");
  oadbLHC15m->SetOfflineTrigger          ( triggerCount,"V0A && V0C && !TPCLaserWarmUp && !TPCHVdip");

  triggerCount++;
  oadbLHC15m->AddCollisionTriggerClass   ( AliVEvent::kEMCEGA,"+CEMC7EG[1|2]-B-NOPF-CENTNOPMD,CDMC7DG[1|2]-B-NOPF-CENTNOPMD","B",triggerCount);
  oadbLHC15m->SetHardwareTrigger         ( triggerCount,"V0A && V0C");
  oadbLHC15m->SetOfflineTrigger          ( triggerCount,"V0A && V0C && !TPCLaserWarmUp && !TPCHVdip");
  ...
  triggerCount++;
  oadbDefaultPP->AddCollisionTriggerClass   ( AliVEvent::kMUS7,"+CMSL7-[B|S|SC]-NOPF-[MUON|MUFAST|ALLNOTRD]","B",triggerCount);
  oadbDefaultPP->AddBGTriggerClass          ( AliVEvent::kMUS7,"+CMSL7-ACE-NOPF-[MUON|MUFAST|ALLNOTRD]","ACE",triggerCount);
  oadbDefaultPP->SetHardwareTrigger         ( triggerCount,"V0A && V0C");
  oadbDefaultPP->SetOfflineTrigger          ( triggerCount,"V0A && V0C && !TPCLaserWarmUp && !TPCHVdip");

  triggerCount++;
  oadbDefaultPP->AddCollisionTriggerClass   ( AliVEvent::kMUL7,"+CMLL7-[B|S]-NOPF-[MUON|MUFAST|ALLNOTRD]","B",triggerCount);
  oadbDefaultPP->AddBGTriggerClass          ( AliVEvent::kMUL7,"+CMLL7-ACE-NOPF-[MUON|MUFAST|ALLNOTRD]","ACE",triggerCount);
  oadbDefaultPP->SetHardwareTrigger         ( triggerCount,"V0A && V0C");
  oadbDefaultPP->SetOfflineTrigger          ( triggerCount,"V0A && V0C && !TPCLaserWarmUp && !TPCHVdip");

  triggerCount++;
  oadbDefaultPP->AddCollisionTriggerClass   ( AliVEvent::kMUU7,"+CMUL7-[B|S]-NOPF-[MUON|MUFAST|ALLNOTRD]","B",triggerCount);
  ...
  oadbDefaultPP->AddBGTriggerClass          ( AliVEvent::kEMC8,"+C[E|D]MC8-ACE-NOPF-[ALL|CENT][NOTRD|]","ACE",triggerCount);
  oadbDefaultPP->SetHardwareTrigger         ( triggerCount,"T0");
  oadbDefaultPP->SetOfflineTrigger          ( triggerCount,"!T0BG && !TPCLaserWarmUp && !TPCHVdip");
  ...
  oadbDefaultPP->SetOfflineTrigger          ( triggerCount,"V0A && V0C && SPDGFOL1 >= 100 && !TPCLaserWarmUp && !TPCHVdip");
  ...
  oadbDefaultPP->SetOfflineTrigger          ( triggerCount,"V0A && V0C && SPDGFOL1 >= 10 && !TPCLaserWarmUp && !TPCHVdip");

  triggerCount++;
  oadbDefaultPP->AddCollisionTriggerClass   ( AliVEvent::kSPI,"+CSPI8-[B|S]-NOPF-ALLNOTRD,CSPI8-[B|S]-NOPF-CENTNOTRD","B",triggerCount);
  oadbDefaultPP->SetHardwareTrigger         ( triggerCount,"T0");
  oadbDefaultPP->SetOfflineTrigger          ( triggerCount,"!T0BG && SPDGFOL1 >= 10 && !TPCLaserWarmUp && !TPCHVdip");
  ...
  oadbDefaultPP->SetHardwareTrigger         ( triggerCount,"V0A && V0C");
  oadbDefaultPP->SetOfflineTrigger          ( triggerCount,"V0A && V0C && !TPCLaserWarmUp && !TPCHVdip && TRDHJT");
  ...
  oadbDefaultPP->SetHardwareTrigger         ( triggerCount,"V0A && V0C");
  oadbDefaultPP->SetOfflineTrigger          ( triggerCount,"V0A && V0C && !TPCLaserWarmUp && !TPCHVdip && TRDHSE");
  ...
  oadbDefaultPP->SetHardwareTrigger         ( triggerCount,"V0A && V0C");
  oadbDefaultPP->SetOfflineTrigger          ( triggerCount,"V0A && V0C && !TPCLaserWarmUp && !TPCHVdip && TRDHQU");
  ...
  oadbDefaultPP->SetHardwareTrigger         ( triggerCount,"T0");
  oadbDefaultPP->SetOfflineTrigger          ( triggerCount,"!T0BG && !TPCLaserWarmUp && !TPCHVdip && TRDHJT");
  ...
  oadbDefaultPP->SetHardwareTrigger         ( triggerCount,"T0");
  oadbDefaultPP->SetOfflineTrigger          ( triggerCount,"!T0BG && !TPCLaserWarmUp && !TPCHVdip && TRDHSE");
  ...
  oadbDefaultPP->SetHardwareTrigger         ( triggerCount,"T0");
  oadbDefaultPP->SetOfflineTrigger          ( triggerCount,"!T0BG && !TPCLaserWarmUp && !TPCHVdip && TRDHQU");
  ...
  oadbDefaultPbPb->SetOfflineTrigger          ( triggerCount,"V0A && V0C && !TPCLaserWarmUp && ZDCTime");
...
//  oadbLHC11h->AddCollisionTriggerClass   ( AliVEvent::kSemiCentral,"+CVHN[|_R2]-B-[NOPF|PF]-[ALL|CENT]NOTRD,CVLN[|_B2]-B-[NOPF|PF]-ALLNOTRD","B",triggerCount);
  ...
  oadbContPS->AppendObject(oadbLHC13g, 197412, 197692);
  // ------------------------------------------------------------------------------------------------------------
