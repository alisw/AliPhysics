...
void AliMultSelectionTask::UserCreateOutputObjects()
{
    ...
    // A.T.
    fTreeEvent->Branch("fCentrality_TRK",&fCentrality_TRK,"fCentrality_TRK/F");
    fTreeEvent->Branch("fCentrality_CL1",&fCentrality_CL1,"fCentrality_CL1/F");
    fTreeEvent->Branch("fCentrality_ZNA",&fCentrality_ZNA,"fCentrality_ZNA/F");
    fTreeEvent->Branch("fCentrality_ZNC",&fCentrality_ZNC,"fCentrality_ZNC/F");
    fTreeEvent->Branch("fCentrality_ZPA",&fCentrality_ZPA,"fCentrality_ZPA/F");
    fTreeEvent->Branch("fCentrality_ZPC",&fCentrality_ZPC,"fCentrality_ZPC/F");
    fTreeEvent->Branch("fCentrality_ZEMvsZDC",&fCentrality_ZEMvsZDC,"fCentrality_ZEMvsZDC/F");
     */
    ...
    //A.T.
    fTreeEvent->Branch("fEvSel_nSPDClusters0", &fEvSel_nSPDClusters0, "fEvSel_nSPDClusters0/I");
    fTreeEvent->Branch("fEvSel_nSPDClusters1", &fEvSel_nSPDClusters1, "fEvSel_nSPDClusters1/I");
 ...
 */
    ...
    //===============================================
    //Compute Percentiles + post to object

     /* ongoing work
     
     AliMultContainer *container = 0x0; //to store the estimators to be acquired by users
...
{
    //return fMultSelectionCuts->IsEventSelected( lEvent );
    return kFALSE;
}

/*
//________________________________________________________________________
Bool_t AliMultSelectionTask::SetupRun( AliVEvent *lEvent )
{
    //Setup: Loads OADB for calibration histograms + event selection criteria
    return kFALSE; //not yet in this version
}
*/