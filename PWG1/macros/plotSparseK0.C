...
sparseK0=(THnSparseF*)(outputTRD->FindObject("sparseK0"));

sparseK0->GetAxis(5)->SetRangeUser(0.,3.9);
sparseK0->GetAxis(9)->SetRangeUser(0.,3.9);


TH1* ptgeantPPhys=sparseK0->Projection(5);
TH1* etageantPPhys=sparseK0->Projection(6);
TH1* phigeantPPhys=sparseK0->Projection(7);

TH1* ptResSinglePPhys=sparseK0->Projection(13);
TH1* etasinglePPhys=sparseK0->Projection(14);
TH1* phisinglePPhys=sparseK0->Projection(15);


TH1* ptgeantNPhys=sparseK0->Projection(9);
TH1* etageantNPhys=sparseK0->Projection(10);
TH1* phigeantNPhys=sparseK0->Projection(11);

TH1* ptResSingleNPhys=sparseK0->Projection(21);
TH1* etasingleNPhys=sparseK0->Projection(22);
TH1* phisingleNPhys=sparseK0->Projection(23);
...
// track Lenght
sparseK0->GetAxis(8)->SetRangeUser(50,200);
sparseK0->GetAxis(12)->SetRangeUser(50,200);
// momentum
sparseK0->GetAxis(5)->SetRangeUser(0.,3.9);
sparseK0->GetAxis(9)->SetRangeUser(0.,3.9);
...
TH1* rgeantTrk=sparseK0->Projection(3);
TH1* ptgeantPTrk=sparseK0->Projection(5);
TH1* etageantPTrk=sparseK0->Projection(6);
TH1* phigeantPTrk=sparseK0->Projection(7);


TH1* ptgeantNTrk=sparseK0->Projection(9);
TH1* etageantNTrk=sparseK0->Projection(10);
TH1* phigeantNTrk=sparseK0->Projection(11);

 sparseK0->GetAxis(20)->SetRangeUser(0,2.);
 sparseK0->GetAxis(28)->SetRangeUser(0,2.);

TH1* rsingleTrk=sparseK0->Projection(3);
TH1* ptsinglePTrk=sparseK0->Projection(5);
TH1* etasinglePTrk=sparseK0->Projection(6);
TH1* phisinglePTrk=sparseK0->Projection(7);




TH1* ptsingleNTrk=sparseK0->Projection(9);
TH1* etasingleNTrk=sparseK0->Projection(10);
TH1* phisingleNTrk=sparseK0->Projection(11);


 sparseK0->GetAxis(32)->SetRangeUser(0,2.);
 sparseK0->GetAxis(36)->SetRangeUser(0,2.);

TH1* rV0Trk=sparseK0->Projection(3);
TH1* ptV0PTrk=sparseK0->Projection(5);
TH1* etaV0PTrk=sparseK0->Projection(6);
TH1* phiV0PTrk=sparseK0->Projection(7);



TH1* ptV0NTrk=sparseK0->Projection(9);
TH1* etaV0NTrk=sparseK0->Projection(10);
TH1* phiV0NTrk=sparseK0->Projection(11);
...
sparseK0->GetAxis(32)->SetRangeUser(-2,0.);
 sparseK0->GetAxis(36)->SetRangeUser(-2,0.);



TH1* sigbXYZEPlusRecSingle=sparseK0->Projection(17);
TH1* sigbXYZEMinusRecSingle=sparseK0->Projection(25);

TH1* ptsinglePTrkNo=sparseK0->Projection(5);
TH1* etasinglePTrkNo=sparseK0->Projection(6);
TH1* phisinglePTrkNo=sparseK0->Projection(7);

TH1* ptsingleNTrkNo=sparseK0->Projection(9);
TH1* etasingleNTrkNo=sparseK0->Projection(10);
TH1* phisingleNTrkNo=sparseK0->Projection(11);
...
//c1->Print("Effi-K0-norefit-v416rev08-090709.ps"); 
