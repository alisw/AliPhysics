...
/**************************************************************************
	...
	Macro created for storing the OCDB Config data of ACORDE
	in $ALICE_ROOT/OCDB/ACORDE/Config/ModulesActivity 
...
**************************************************************************/
void MakeACORDEOCDBConfigModAct()
{
	...
	AliACORDECalibData *calibda = new AliACORDECalibData("OCDBConfigModAct");
	...
	TObjString str("ACORDE OCDB Reference Config Modules Activity Data");      // object that will be stored

	AliCDBMetaData *md= new AliCDBMetaData(); // metaData describing the object

	AliCDBId id("ACORDE/Config/ModulesActivity",0,9999999);
