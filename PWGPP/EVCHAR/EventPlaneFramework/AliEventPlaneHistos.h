...
class AliEventPlaneHistos : public TNamed{
public:

    
  AliEventPlaneHistos();
  AliEventPlaneHistos(const char* name, const char* title);
  virtual ~AliEventPlaneHistos();
  ...
  static AliEventPlaneHistos* Instance() {if(!fgEventPlaneHistos) fgEventPlaneHistos = new AliEventPlaneHistos(); return fgEventPlaneHistos;}
  
  static AliEventPlaneHistos* fgEventPlaneHistos;

private:
    
  static const Int_t kNothing=-1;
  AliEventPlaneHistos(const AliEventPlaneHistos &hist);
  AliEventPlaneHistos& operator = (const AliEventPlaneHistos &hist);
  ...
  ClassDef(AliEventPlaneHistos,1)
