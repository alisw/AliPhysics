...
ClassImp(AliEventPlaneHistos)

Int_t gkNVars = 999;

AliEventPlaneHistos* AliEventPlaneHistos::fgEventPlaneHistos = NULL;
AliEventPlaneHistos::AliEventPlaneHistos() :
//   TCollection(),
  TNamed("AliEventPlaneHistos","EventPlane Histogram Container"),
...
AliEventPlaneHistos::AliEventPlaneHistos(const char* name, const char* title) :
//   TCollection(),
  TNamed(name, title),
  //fHistLists(0x0),   // main histogram list for the current running process
  fHistFile(0x0)      // pointer to a TFile opened for reading
...
void AliEventPlaneHistos::FillHistClass(const Char_t* className, Float_t* values){// Bool_t* usedvalues) {
  //
...
//__________________________________________________________________
void AliEventPlaneHistos::AddHistClass(const Char_t* histClass) {
  //
...
void AliEventPlaneHistos::AddHistogram(const Char_t* histClass,
...
void AliEventPlaneHistos::MakeAxisLabels(TAxis* ax, const Char_t* labels) {
  //
...
//__________________________________________________________________
void AliEventPlaneHistos::WriteOutput(TFile* save) {
  //
