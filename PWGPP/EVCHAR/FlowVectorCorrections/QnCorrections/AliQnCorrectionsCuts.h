#ifndef ALIQNCORRECTIONS_CUTS_H
#define ALIQNCORRECTIONS_CUTS_H
/***************************************************************************
...
class AliQnCorrectionsCuts : public TNamed {

 public:
  AliQnCorrectionsCuts();
  AliQnCorrectionsCuts(const Char_t* name);
  AliQnCorrectionsCuts(const AliQnCorrectionsCuts &c);
  ~AliQnCorrectionsCuts();
  ...
  void CopyCuts(AliQnCorrectionsCuts* cuts);
 ...
 private:
  ...
  Float_t fCuts[AliQnCorrectionsConstants::nCuts][4];
  Int_t fNcuts;
  //TString fCutsName;


  ClassDef(AliQnCorrectionsCuts, 1);
};



//_____________________________________________________________________
inline Bool_t AliQnCorrectionsCuts::IsSelected(Float_t* values) const {
  //
