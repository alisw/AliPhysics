/// \file AliQnCorrectionsHistogramSparse.cxx
...
/// \cond CLASSIMP
ClassImp(AliQnCorrectionsHistogramSparse);
/// \endcond

/// Default constructor
AliQnCorrectionsHistogramSparse::AliQnCorrectionsHistogramSparse() :
...
AliQnCorrectionsHistogramSparse::AliQnCorrectionsHistogramSparse(const char *name,
      const char *title,
...
Bool_t AliQnCorrectionsHistogramSparse::CreateHistogram(TList *histogramList) {
...
Long64_t AliQnCorrectionsHistogramSparse::GetBin(const Float_t *variableContainer) {
...
Bool_t AliQnCorrectionsHistogramSparse::BinContentValidated(Long64_t) {
...
Float_t AliQnCorrectionsHistogramSparse::GetBinContent(Long64_t bin) {
...
Float_t AliQnCorrectionsHistogramSparse::GetBinError(Long64_t bin) {
...
void AliQnCorrectionsHistogramSparse::Fill(const Float_t *variableContainer, Float_t weight) {
