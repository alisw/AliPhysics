/// \file AliQnCorrectionsHistogramChannelized.cxx
...
/// \cond CLASSIMP
ClassImp(AliQnCorrectionsHistogramChannelized);
/// \endcond
...
Bool_t AliQnCorrectionsHistogramChannelized::CreateChannelizedHistogram(TList *histogramList, const Bool_t *bUsedChannel) {
...
Long64_t AliQnCorrectionsHistogramChannelized::GetBin(const Float_t *variableContainer, Int_t nChannel) {
...
Bool_t AliQnCorrectionsHistogramChannelized::BinContentValidated(Long64_t) {
...
Float_t AliQnCorrectionsHistogramChannelized::GetBinContent(Long64_t bin) {
...
Float_t AliQnCorrectionsHistogramChannelized::GetBinError(Long64_t bin) {
...
void AliQnCorrectionsHistogramChannelized::Fill(const Float_t *variableContainer, Int_t nChannel, Float_t weight) {
