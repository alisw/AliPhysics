...
void MakeReport(const char* mcrddir){
  ...
  { // matching efficiency
    ...
    graph = TStatToolkit::MakeMultGraph(treeMC,"","tpcItsMatchHighPtA;TPC.Anchor.tpcItsMatchHighPtA;tpcItsMatchHighPtC;TPC.Anchor.tpcItsMatchHighPtC:run","defaultcut","25;21;25;21","2;2;4;4",1,0.75,6,legend,kTRUE);  
 ...
 { // Separation Power
   ...
   { // VertX
    ...
    dtrendingDraw->AppendStatusPad(0.3, 0.4, 0.05);}
    legend->Draw();
