...
Int_t DrawPerformanceZDCQAMatchTrends(const char* inFile = "trending.root"){
  ...
  Double_t ZNA_mean_value = 0;
  Double_t ZPA_mean_value = 0;
  Double_t ZPC_mean_value = 0;
  Double_t ZNCuncalib_mean = 0;
  Double_t ZNAuncalib_mean = 0;
  Double_t ZPAuncalib_mean = 0;
  Double_t ZPCuncalib_mean = 0;
  Double_t ZEM1_mean_value = 0;
  Double_t ZEM2_mean_value = 0;
  Double_t ZNC_X_Centroid = 0;
  Double_t ZNC_Y_Centroid = 0;
  Double_t ZNA_X_Centroid =0;
  Double_t ZNA_Y_Centroid = 0;
  Double_t ZNC_X_Centroid_Err = 0;
  Double_t ZNC_Y_Centroid_Err = 0;
  Double_t ZNA_X_Centroid_Err = 0;
  Double_t ZNA_Y_Centroid_Err = 0;
  ...
  tree->SetBranchAddress("ZNC_mean_value",&ZNC_mean_value);
  tree->SetBranchAddress("ZNA_mean_value",&ZNA_mean_value);
  tree->SetBranchAddress("ZPC_mean_value",&ZPC_mean_value);
  tree->SetBranchAddress("ZPA_mean_value",&ZPA_mean_value);
  tree->SetBranchAddress("ZPA_mean_value",&ZNCuncalib_mean);
  tree->SetBranchAddress("ZNAuncalib_mean",&ZNAuncalib_mean);
  tree->SetBranchAddress("ZPCuncalib_mean",&ZPCuncalib_mean);
  tree->SetBranchAddress("ZPAuncalib_mean",&ZPAuncalib_mean);
  tree->SetBranchAddress("ZEM1_mean_value",&ZEM1_mean_value);
  tree->SetBranchAddress("ZEM2_mean_value",&ZEM2_mean_value);
  tree->SetBranchAddress("ZNC_X_Centroid",&ZNC_X_Centroid);
  tree->SetBranchAddress("ZNC_Y_Centroid",&ZNC_Y_Centroid);
  tree->SetBranchAddress("ZNA_X_Centroid",&ZNA_X_Centroid);
  tree->SetBranchAddress("ZNA_Y_Centroid",&ZNA_Y_Centroid);
  tree->SetBranchAddress("ZNC_X_Centroid_Err",&ZNC_X_Centroid_Err);
  tree->SetBranchAddress("ZNC_Y_Centroid_Err",&ZNC_Y_Centroid_Err);
  tree->SetBranchAddress("ZNA_X_Centroid_Err",&ZNA_X_Centroid_Err);
  tree->SetBranchAddress("ZNA_Y_Centroid_Err",&ZNA_Y_Centroid_Err);
  ...
  TGraphErrors *gr_zncUncal = (TGraphErrors*) TStatToolkit::MakeGraphSparse(tree,"ZNCuncalib_mean:run","",21,kAzure+8,1.2);
  TGraphErrors *gr_znaUncal = (TGraphErrors*) TStatToolkit::MakeGraphSparse(tree,"ZNAuncalib_mean:run","",20,kPink,1.2);
  TGraphErrors *gr_zpcUncal = (TGraphErrors*) TStatToolkit::MakeGraphSparse(tree,"ZPCuncalib_mean:run","",21,kAzure+8,1.2);
  TGraphErrors *gr_zpaUncal = (TGraphErrors*) TStatToolkit::MakeGraphSparse(tree,"ZPAuncalib_mean:run","",20,kPink,1.2);
  ...
  for (int i=0; i<entries; i++){
     tree->GetEntry(i);
     //printf("ZNC %f ZNA %f\n", ZNC_mean_value, ZNA_mean_value);
     //printf("ZEM1 %f ZEM2 %f\n", ZEM1_mean, ZEM2_mean);
     ZNC_tot += ZNC_mean_value;
     ZNA_tot += ZNA_mean_value;
     ZPC_tot += ZPC_mean_value;
     ZPA_tot += ZPA_mean_value;
     ZNC_uncal_tot += ZNCuncalib_mean;
     ZNA_uncal_tot += ZNAuncalib_mean;
     ZPC_uncal_tot += ZPCuncalib_mean;
     ZPA_uncal_tot += ZPAuncalib_mean;
     ZEM1_tot += ZEM1_mean_value;
     ZEM2_tot += ZEM2_mean_value;
     ZNCx_tot += ZNCx_mean;
     ZNCy_tot += ZNCy_mean;
     ZNAx_tot += ZNAx_mean;
     ZNAy_tot += ZNAy_mean;
  ...
  TCanvas *c1 = new TCanvas("c1","<ZNC>",0,0,1600,1000);
  ...
  c2u->cd(1);
  gr_zpcUncal->Draw("");
  gr_zpcUncal->SetTitle("ZPA uncalibrated average");
