...
void DrawPerformanceZDCQAMatchTrends(const char* inFile = "trending.root"){
  ...
  TGraphErrors *gr_zncUncal = (TGraphErrors*) TStatToolkit::MakeGraphSparse(tree,"ZNC_mean_uncalib:run","",20,kRed,1.0);
  TGraphErrors *gr_znaUncal = (TGraphErrors*) TStatToolkit::MakeGraphSparse(tree,"ZNA_mean_uncalib:run","",22,kBlue,1.2);
  TGraphErrors *gr_zpcUncal = (TGraphErrors*) TStatToolkit::MakeGraphSparse(tree,"ZPC_mean_uncalib:run","",20,kRed,1.0);
  TGraphErrors *gr_zpaUncal = (TGraphErrors*) TStatToolkit::MakeGraphSparse(tree,"ZPA_mean_uncalib:run","",22,kBlue,1.2);
  ...
  c1u->cd(1);
  gr_zncUncal->Draw("");
  gr_zncUncal->SetTitle("ZNC uncalib average");
  gr_zncUncal->GetYaxis()->SetTitle("ZNC");
  gr_zncUncal->GetYaxis()->SetRangeUser(ZNC_avg-offset_signals, ZNC_avg+offset_signals);
  c1u->cd(2);
  gr_znaUncal->Draw("");
  gr_znaUncal->SetTitle("ZNA uncalib average");
  gr_znaUncal->GetYaxis()->SetTitle("ZNA");
  gr_znaUncal->GetYaxis()->SetRangeUser(ZNA_avg-offset_signals, ZNA_avg+offset_signals);
  ...
  c2u->cd(1);
  gr_zpcUncal->Draw("");
  gr_zpcUncal->SetTitle("ZPC uncalib average");
  gr_zpcUncal->GetYaxis()->SetTitle("(ADC ch.)");
  gr_zpcUncal->GetYaxis()->SetRangeUser(ZPC_avg-offset_signals, ZPC_avg+offset_signals);
  c2u->cd(2);
  gr_zpaUncal->Draw("");
  gr_zpaUncal->SetTitle("ZPA uncalib average");
  gr_zpaUncal->GetYaxis()->SetTitle("(ADC ch.)");
  gr_zpaUncal->GetYaxis()->SetRangeUser(ZPA_avg-offset_signals, ZPA_avg+offset_signals);
