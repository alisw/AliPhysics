...
sparseAL=(THnSparseF*)(outputTRD->FindObject("sparseAL"));

sparseAL->GetAxis(5)->SetRangeUser(0.,3.9);
sparseAL->GetAxis(9)->SetRangeUser(0.,3.9);


TH1* ptgeantPPhys=sparseAL->Projection(5);
TH1* etageantPPhys=sparseAL->Projection(6);
TH1* phigeantPPhys=sparseAL->Projection(7);

TH1* ptResSinglePPhys=sparseAL->Projection(13);
TH1* etasinglePPhys=sparseAL->Projection(14);
TH1* phisinglePPhys=sparseAL->Projection(15);


TH1* ptgeantNPhys=sparseAL->Projection(9);
TH1* etageantNPhys=sparseAL->Projection(10);
TH1* phigeantNPhys=sparseAL->Projection(11);

TH1* ptResSingleNPhys=sparseAL->Projection(21);
TH1* etasingleNPhys=sparseAL->Projection(22);
TH1* phisingleNPhys=sparseAL->Projection(23);
...
// track Lenght
sparseAL->GetAxis(8)->SetRangeUser(50,200);
sparseAL->GetAxis(12)->SetRangeUser(50,200);
// momentum
sparseAL->GetAxis(5)->SetRangeUser(0.,3.9);
sparseAL->GetAxis(9)->SetRangeUser(0.,3.9);


TH1* rgeantTrk=sparseAL->Projection(3);
TH1* ptgeantPTrk=sparseAL->Projection(5);
TH1* etageantPTrk=sparseAL->Projection(6);
TH1* phigeantPTrk=sparseAL->Projection(7);


TH1* ptgeantNTrk=sparseAL->Projection(9);
TH1* etageantNTrk=sparseAL->Projection(10);
TH1* phigeantNTrk=sparseAL->Projection(11);

 sparseAL->GetAxis(20)->SetRangeUser(0,2.);
 sparseAL->GetAxis(28)->SetRangeUser(0,2.);

TH1* rsingleTrk=sparseAL->Projection(3);
TH1* ptsinglePTrk=sparseAL->Projection(5);
TH1* etasinglePTrk=sparseAL->Projection(6);
TH1* phisinglePTrk=sparseAL->Projection(7);




TH1* ptsingleNTrk=sparseAL->Projection(9);
TH1* etasingleNTrk=sparseAL->Projection(10);
TH1* phisingleNTrk=sparseAL->Projection(11);


 sparseAL->GetAxis(32)->SetRangeUser(0,2.);
 sparseAL->GetAxis(36)->SetRangeUser(0,2.);

TH1* rV0Trk=sparseAL->Projection(3);
TH1* ptV0PTrk=sparseAL->Projection(5);
TH1* etaV0PTrk=sparseAL->Projection(6);
TH1* phiV0PTrk=sparseAL->Projection(7);



TH1* ptV0NTrk=sparseAL->Projection(9);
TH1* etaV0NTrk=sparseAL->Projection(10);
TH1* phiV0NTrk=sparseAL->Projection(11);
...
sparseAL->GetAxis(32)->SetRangeUser(-2,0.);
sparseAL->GetAxis(36)->SetRangeUser(-2,0.);



TH1* sigbXYZEPlusRecSingle=sparseAL->Projection(17);
TH1* sigbXYZEMinusRecSingle=sparseAL->Projection(25);

TH1* ptsinglePTrkNo=sparseAL->Projection(5);
TH1* etasinglePTrkNo=sparseAL->Projection(6);
TH1* phisinglePTrkNo=sparseAL->Projection(7);

TH1* ptsingleNTrkNo=sparseAL->Projection(9);
TH1* etasingleNTrkNo=sparseAL->Projection(10);
TH1* phisingleNTrkNo=sparseAL->Projection(11);
...
c1->Print("Effi-AL-norefit-v416rev08_090709.ps"); 
