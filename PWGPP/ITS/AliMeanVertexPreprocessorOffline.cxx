...
void AliMeanVertexPreprocessorOffline::ProcessOutput(const char *filename, AliCDBStorage *db, Int_t runNb){
  ...
  TH1F *histTRKdefMultX=0x0;
  TH1F *histTRKdefMultY=0x0;
  TH1F *histTRKHighMultX=0x0;
  TH1F *histTRKHighMultY=0x0;
  TH2F *histTRKVertexXZ=0x0;
  TH2F *histTRKVertexYZ=0x0;
  ...
  if ((histTRKvsMultX) && (histTRKvsMultY)){
