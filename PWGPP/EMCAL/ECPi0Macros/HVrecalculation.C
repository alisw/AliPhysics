...
{int i,ism,icol,irow,choice,oldFlag;
 ...
 sprintf(fchNameBase,"output_HVrecalculation_%s",ident.Data());
 ...
 //For pass1 :
 //sprintf(fchNameBadGainIn,"/cebaf/cebaf/EMCAL/calibPi0_run2/recalculateHV_4_with2015data/output_HVrecalculation_pass0/output_HVrecalculation_pass0_badGain_Custom.txt");
 //For pass2 :
 sprintf(fchNameBadGainIn,"/cebaf/cebaf/EMCAL/calibPi0_run2/recalculateHV_4_with2015data/output_HVrecalculation_pass1/output_HVrecalculation_pass1_badGain_Custom.txt");
