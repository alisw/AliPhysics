...
///
/// How to run :
///   aliroot -b -q "macros/multiplyPi0CalibrationFactors_TextToHisto_Final.C" >& multiplyPi0CalibrationFactors_TextToHisto_Final.out &
///
///
...
{int a,b,c,d,aTot,bTot,cTot,dTot,i,j,jFile,kNbFiles,iSM;
 ...
 txtFileOut  =   fopen("multiplyPi0CalibrationFactors_TextToHisto_Final.txt","w");
 TFile * f = new TFile("multiplyPi0CalibrationFactors_TextToHisto_Final.root","recreate");
 sprintf(psfile,"multiplyPi0CalibrationFactors_TextToHisto_Final.ps");
 ...
 //CUSTOMIZE customize :
 calibCoeffsInput[0] = fopen("/cebaf/cebaf/EMCAL/calibPi0_run2/calibPi0_4_with2015data/output/pass0_mergedDCALandThirdSMs/output_calibPi0_coeffs_clean_veryHighTowers.txt","r"); //Chosen for pass0.
 calibCoeffsInput[1] = fopen("/cebaf/cebaf/EMCAL/calibPi0_run2/calibPi0_4_with2015data/output/pass1_DCALandThirdSMs/output_calibPi0_coeffs_clean_veryHighTowers.txt","r"); //Chosen for pass1.
 calibCoeffsInput[2] = fopen("/cebaf/cebaf/EMCAL/calibPi0_run2/calibPi0_4_with2015data/output/pass2_DCALandThirdSMsVeryHighTowers/output_calibPi0_coeffs_clean_finalFile4HVcalculation_setUntrustedToOne.txt","r"); //Chosen for pass2.
 //Histoes definition :
 TH2F **h2Coeffs;
