...
//  TArrayD * GetThrustParamMC(AliMCEvent* mcEvent, Int_t  nstudymin, Double_t ptcutoff, Double_t etacutoff, Bool_t chom, TArrayD * evsh);
  virtual void GetThrustAxis(TVector3 &n01, TVector3 * p_track, Int_t &nTracks);
  ...
  Double_t Exponent(Double_t x, Double_t * par);
  Double_t Exponent2(Double_t x, Double_t * par);
