...
#ifndef ALIHLTT0AGENT_H
#define ALIHLTT0AGENT_H

/* This file is property of and copyright by the ALICE HLT Project        * 
 * ALICE Experiment at CERN, All rights reserved.                         *
 * See cxx source for full Copyright notice                               */

/** @file    AliHLTT0Agent.h
...
/**
 * @class AliHLTT0Agent
 * This is the agent for the AliHLTT0 library.<br>
 *
 ...
 * @ref gAliHLTT0Agent of the agent is defined in the source code.
 * 
 * @ingroup alihlt_system
 */
class AliHLTT0Agent : public AliHLTModuleAgent {
 public:
  ...
  /**
   * Register all configurations belonging to the T0 library with the
  ...
  /**
   * Register components for the AliHLTT0 library.
...
private:
  ...
  AliHLTT0Agent(const AliHLTT0Agent&);

  /** assignment operator prohibited */
  AliHLTT0Agent& operator=(const AliHLTT0Agent&);
