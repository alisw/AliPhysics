...
void HLTT0Test(const Char_t *filename, const Char_t *cdbURI,
  ...
  printf (" ============================================= \n\n");
  printf ("        TEST T0 Calibration             \n\n");
  printf (" ============================================= \n");

  if(!gSystem->AccessPathName("galice.root")){
    cerr << "AliCalibration on raw data requires to delete galice.root, ";
  ...
  // define configuration of the T0Calibration component
  AliHLTConfiguration vzeroReco("T0-Calibration", 
				"T0Calibration", 
				"RAW-Publisher",
				""
				);
  ...
  AliHLTConfiguration rootWriter("RootWriter", 
				 "ROOTFileWriter",
				 "T0-Calibration GLOBAL-ESD-Converter",
...
// ---------------------------------------------------------------------------- 
void HLTT0Test() {
  cout << "HLTT0Test: Run HLT component 'T0Calibration' in AliReconstruction" << endl;
