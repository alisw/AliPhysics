...
//    this->SetLayoutBroken(kTRUE);
    ...
    fLabel2713->MoveResize(10,100,67,20);
    ...
    fLabel2726->MoveResize(20,20,23,16);
    TGLabel *fLabel2727 = new TGLabel(fGroupFrame2717,"port");
    fLabel2727->SetTextJustify(36);
    ...
    fLabel2727->MoveResize(20,45,21,16);
    TGLabel *fLabel2728 = new TGLabel(fGroupFrame2717,"database");
    fLabel2728->SetTextJustify(36);
    ...
    fLabel2728->MoveResize(20,70,51,16);
    TGLabel *fLabel2729 = new TGLabel(fGroupFrame2717,"user");
    fLabel2729->SetTextJustify(36);
    ...
    fLabel2729->MoveResize(20,95,24,16);
    TGLabel *fLabel2730 = new TGLabel(fGroupFrame2717,"password");
    fLabel2730->SetTextJustify(36);
