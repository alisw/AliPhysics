...
std::string AliExternalFormatConverter::AddPolylinesToMuonTracks(int trackNumber,AliMinimalisticTrack &minimalisticMuonTrack) const
{
    // setup CDB
    ...
    trkProp->SetMagFieldObj(new AliEveMagField(field));
