...
*/
void CheckOutput();
void AliAnalisysTaskFilteredTest( const char* esdList,   
...
void CheckOutput(){
  ...
  printf("#UnitTest:\tAliAnalisysTaskFiltered\tRatioPtToV0Entries\t%f\n",ratioHighPtV0Entries);
  printf("#UnitTest:\tAliAnalisysTaskFiltered\tRatioPtToV0Size\t%f\n",ratioHighPtV0Size);
  //
  //
  ...
  printf("#UnitTest:\tAliAnalisysTaskFiltered\tRatioPointsV0\t%f\n",ratioPointsV0);
  printf("#UnitTest:\tAliAnalisysTaskFiltered\tRatioPointsHighPt\t%f\n",ratioPointsHighPt);
