...
#   $ALICE_ROOT/test/testAliAnalisysTaskFiltered/AliAnalisysTaskFilteredTest.sh
#   To test:
...
#run FilterTask
    echo aliroot -l -b -q $ALICE_ROOT/test/testAliAnalisysTaskFiltered/AliAnalisysTaskFilteredTest.C\($inputListfiles,$filterT,$filterV,$OCDBpath,$maxFiles,$offsetFile,$maxEvents,$offsetEvent\)
    aliroot -l -b -q $ALICE_ROOT/test/testAliAnalisysTaskFiltered/AliAnalisysTaskFilteredTest.C\($inputListfiles,$filterT,$filterV,$filterFriend,$OCDBpath,$maxFiles,$offsetFile,$maxEvents,$offsetEvent\)
exit
