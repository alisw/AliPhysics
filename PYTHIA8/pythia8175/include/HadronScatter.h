...
public:
 ...
 HadronScatter():
  infoPtr(0), rndmPtr(0), 
    doHadronScatter(0), afterDecay(0), allowDecayProd(0),
    scatterRepeat(0), doTile(0),
    hadronSelect(0), scatterProb(0),
    Npar(0), kPar(0), pPar(0), jPar(0), rMax(0), rMax2(0), 
    pTsigma(0), pTsigma2(0), pT0MPI(0),
    ytMax(0), ptMax(0), 
    yMin(0), yMax(0), ytSize(0), ptSize(0), sigElMax(0)
  {}
