...
public:
  ...
  Sigma2gg2qGqGbar(int idIn, int codeIn, int spinIn, 
    string nameIn = "g g -> qG qGbar") : idNew(idIn), codeSave(codeIn),
      spinSave(spinIn), nameSave(nameIn), hasKappa(false), 
      openFracPair(0), sigma(0), sigTS(0), sigUS(0), sigSum(0), kappam1(0) {}
...
public:
  ...
  Sigma2qqbar2qGqGbar(int idIn, int codeIn, int spinIn, 
    string nameIn = "q qbar -> qG qGbar") : idNew(idIn), codeSave(codeIn),
      ...
      openFracPair(0), sigma(0), sigTS(0), sigUS(0), sigSum(0), kappa(0) {}
...
public:
  ...
  Sigma2ffbar2fGfGbar(int idIn, int codeIn, int spinIn, 
    string nameIn = "q qbar -> qG qGbar") : idNew(idIn), codeSave(codeIn),
      spinSave(spinIn), nameSave(nameIn), hasColour(true),
      eQHV2(0), openFracPair(0), sigma0(0), sigTS(0), sigUS(0), sigSum(0), kappa(0), colFac(0){}
...
public:
  ...
  // Constructor.
  Sigma1ffbar2Zv() : idZv(0), mRes(0), GammaRes(0), m2Res(0), GamMRat(0), sigOut(0), particlePtr(0x0) {}
