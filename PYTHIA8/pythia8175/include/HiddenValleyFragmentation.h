...
public:
  ...
  // Constructor. 
  HVStringFlav():nFlav(0), probVector(0) {}
...
public:
  ...
  // Constructor. 
  HVStringZ(): mqv2(0), bmqv2(0), rFactqv(0), mhvMeson(0) {}
...
public:
  ...
  // Constructor. 
 HiddenValleyFragmentation() : infoPtr(0), particleDataPtr(0), rndmPtr(0),
    doHVfrag(false), nFlav(0), hvOldSize(0), hvNewSize(0), 
    mhvMeson(0), mSys(0), 
    hvFlavSelPtr(NULL), 
