...
/*  
 *  
 *  AliAnalysisTaskSimSpectraLFpPb.cxx
 *  
...
#include "AliAnalysisTaskSimSpectraLFpPb.h"

//_____ STL includes
#include <iostream>
using namespace std;

ClassImp( AliAnalysisTaskSimSpectraLFpPb )

//_____________________________________________________________________________

AliAnalysisTaskSimSpectraLFpPb::AliAnalysisTaskSimSpectraLFpPb():
  AliAnalysisTaskSE(),
  fMcEvent(0x0),
  fMcHandler(0x0),
  fStack(0),
...
AliAnalysisTaskSimSpectraLFpPb::AliAnalysisTaskSimSpectraLFpPb(const char *name):
...
void AliAnalysisTaskSimSpectraLFpPb::UserCreateOutputObjects(){
  ...
  InitHisto<TH1F>("fHistMultPrimary","Multiplicity Primary", 200, 0., 4000., "N_{prim.}", "Entries");
...
inline void AliAnalysisTaskSimSpectraLFpPb::FillHisto(const char* objkey, Double_t x)
{
...
template <class T> T* AliAnalysisTaskSimSpectraLFpPb::InitHisto(const char* hname, const char* htitle, Int_t nxbins, Double_t xmin, Double_t xmax, const char* xtitle, const char* ytitle)
{
...
void AliAnalysisTaskSimSpectraLFpPb::Init(){
  //
...
void AliAnalysisTaskSimSpectraLFpPb::UserExec(Option_t *){
  ...
  else { if(fDebug > 1) printf("AliAnalysisTaskSimSpectraLFpPb::Handler() fMcHandler = NULL\n"); return; }

  // ### MC event
  if( !fMcEvent ) { if(fDebug > 1) printf("AliAnalysisTaskSimSpectraLFpPb::UserExec() fMcEvent = NULL \n"); return; }
...
Bool_t AliAnalysisTaskSimSpectraLFpPb::IsMCEventSelected(TObject* obj){
...
void AliAnalysisTaskSimSpectraLFpPb::EventSel(TObject* obj){
...
void AliAnalysisTaskSimSpectraLFpPb::Terminate(Option_t*){
...
Int_t AliAnalysisTaskSimSpectraLFpPb::GetPidCode(Int_t pdgCode) const  {
