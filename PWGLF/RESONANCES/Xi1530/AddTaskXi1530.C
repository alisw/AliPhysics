AliAnalysisTaskXi1530* AddTaskXi1530(const char* taskname = "Xi1530",
    ...
    AliAnalysisTaskXi1530* taskXi1530 = new AliAnalysisTaskXi1530(
        Form("%s%s", taskname, suffix), Form("%s_%s", taskname, option));
    ...
    if (foption.Contains("Mix")) {
        ...
        std::cout << "AliAnaylsisTaskXi1530:: Event Mix(" << nmix << ") mode "
                  << std::endl;
    }
    ...
    if (foption.Contains("SYS")) {
        ...
        std::cout << "AliAnaylsisTaskXi1530:: Systematic Study mode "
                  << std::endl;
    }
    ...
    AliAnalysisDataContainer* coutputXi1530 = mgr->CreateContainer(
