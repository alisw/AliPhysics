...
//enum ERsnCollType_t { kPP=0,      kPPb,      kPbPb};
 ...
 #include <PWGLF/RESONANCES/macros/mini/ConfigKStarPlusMinusTest_AOD.C>
 #endif
...
AliRsnMiniAnalysisTask *AddTaskKStarPlusMinusTest_AOD
(
 Bool_t      isMC,
  ...
  // retrieve analysis manager
	...
	// -- EVENT CUTS (same for all configs) ---------------------------------------------------------
	 ...
	 outMult->AddAxis(multID,400,0.5,400.5);
       ...
       TH2F* hmc=new TH2F("MultiVsCent","", 100,0.,100., 100isAOD,0.5,100.5);
    ...
    // -- CONFIG ANALYSIS --------------------------------------------------------------------------/ 
    #ifdef __CINT__
      gROOT->LoadMacro("$ALICE_PHYSICS/PWGLF/RESONANCES/macros/mini/ConfigKStarPlusMinusTest_AOD.C");
    #endif
       if (isMC) {
