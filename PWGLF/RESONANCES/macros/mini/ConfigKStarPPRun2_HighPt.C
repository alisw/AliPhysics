/***************************************************************************
              ...
              dmallick@cern.ch last modified 16/05/2019, 18/12/2020
...
Bool_t ConfigKStarPPRun2_HighPt(  
                                 ...
                                 )
{
  ...
  Bool_t  use     [12] = {isDATA    ,isDATA    ,isDATA    ,isDATA    ,isDATA  ,isDATA       ,isMC     ,isMC     ,isMC     ,isMC     ,isMC    ,isMC   };
  ...
  for (Int_t i = 0; i < 12; i++) {
    ...
    out->AddAxis(cosThStarID, Cosbin, lCosbin, hCosbin);
