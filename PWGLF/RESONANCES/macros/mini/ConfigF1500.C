...
Bool_t ConfigF1500(AliRsnMiniAnalysisTask *task = 0x0, 
		   Bool_t                 isMC = kFALSE, 
		   ...
		   Bool_t                 enableMonitor = kTRUE) //enable single track QA plots
{
  ...
  //General 
  //-----------------------
  TString partname="f1500";
  Int_t   pdgCode=9030221;
  Float_t mass = 1.505;// 2014 PDG: M = 1505 ± 6 MeV
  ...
  //Set custom quality cuts for systematic checks
    cutSetKaon = new AliRsnCutSetDaughterParticle("cutKaon", trkQualityCut, cutPid, AliPID::kKaon, nsigma);
    cutSetQuality = new AliRsnCutSetDaughterParticle("cutQuality", trkQualityCut, AliRsnCutSetDaughterParticle::kQualityStd2011, AliPID::kKaon, 10.0);
  }else{
  //use default quality cuts std 2010 with crossed rows TPC
  Bool_t useCrossedRows = 1; 
  cutSetKaon = new AliRsnCutSetDaughterParticle("cutKaon", cutPid, AliPID::kKaon, nsigma, aodFilterBit, useCrossedRows);
  ...
  //Template for BG
  TString bgTemplate[8]  = {"rho", "f0", "omega", "Kstar", "antiKstar", "K0s", "phi","f2"};
  Char_t bgTemplateC1[8] = {'+', '+', '+', '+', '+', '+', '+', '+'};
  Char_t bgTemplateC2[8] = {'-', '-', '-', '-', '-', '-', '-', '-'};
  Int_t bgTemplatePDG[8] = {113, 9010221, 223, 313, -313, 310, 333, 225};
  Double_t bgTemplateM[8]   = {775.26, 990., 8.49, 891.66, 891.66, 497.611, 1019.461, 1275.5};
  RSNPID bgID1[8] = {AliRsnDaughter::kPion,AliRsnDaughter::kPion,AliRsnDaughter::kPion,AliRsnDaughter::kKaon, AliRsnDaughter::kPion, AliRsnDaughter::kPion, AliRsnDaughter::kKaon, AliRsnDaughter::kPion};
  RSNPID bgID2[8] = {AliRsnDaughter::kPion,AliRsnDaughter::kPion,AliRsnDaughter::kPion,AliRsnDaughter::kPion, AliRsnDaughter::kKaon, AliRsnDaughter::kPion, AliRsnDaughter::kKaon, AliRsnDaughter::kPion};
