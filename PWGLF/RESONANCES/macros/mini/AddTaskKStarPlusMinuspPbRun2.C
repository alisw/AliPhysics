...
AliRsnMiniAnalysisTask *AddTaskKStarPlusMinuspPbRun2
(
 Bool_t      isMC,
 Bool_t      isPP,
 Float_t     cutV = 10.0,
 ...
 )
{
  ...
  task->UseMultiplicity("AliMultSelection_V0A");
	...
	*/
    ...
    if (!ConfigKStarPlusMinuspPbRun2(task, isMC, isPP, isGT, piPIDCut,nsigmaTOF,customQualityCutsID, cutPiCandidate, pi_k0s_PIDCut, aodFilterBit, enableMonitor, monitorOpt.Data(), massTol, massTolVeto, tol_switch, tol_sigma, pLife, radiuslow, Switch, k0sDCA, k0sCosPoinAn, k0sDaughDCA, NTPCcluster, "", PairCutsSame, PairCutsMix, DCAxy, enableSys, crossedRows, rowsbycluster, v0rapidity, Sys)) return 0x0;
