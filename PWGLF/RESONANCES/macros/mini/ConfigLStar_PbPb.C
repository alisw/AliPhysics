			...
			)
{
  ...
  // proton cut
  AliRsnCutSetDaughterParticle_hack *cutP = new AliRsnCutSetDaughterParticle_hack("cutProton", 
									pidCut, 
									AliPID::kProton, 
									nsPr,
									aodFilterBit, 
  ...
  // kaon cut
  AliRsnCutSetDaughterParticle_hack *cutK = new AliRsnCutSetDaughterParticle_hack("cutKaon", 
									pidCut, 
									AliPID::kKaon, 
									nsKa,
									aodFilterBit, 
