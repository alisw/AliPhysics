...
//kTPCpidphipp2015
{
  ...
  Int_t iCutK=task->AddTrackCuts(cutSetK);
   ...
   /////////////////////////////////////////////////////////////
    ...
    cutK0sbkg->SetMinCosPointingAngle(k0sCosPoinAn);
    ...
    //cutK0s->SetpT_Tolerance(0);
    cutK0sbkg->SetMassTolSigma(tol_sigma);
    //cutK0s->SetMassTolSigma(2.0);
    ...
    rsnfinderbkg->SetPairCuts(cutsKstar);
    ...
    antirsnfinderbkg->SetPairCuts(cutsKstar);
