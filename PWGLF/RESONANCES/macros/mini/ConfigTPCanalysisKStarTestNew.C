...
Bool_t ConfigTPCanalysisKStarTestNew
(  
...
AliESDtrackCuts* MyTrackCuts(Int_t clusterCut = 1,  Bool_t selPrimaries = kTRUE, TString optSyt="Default")
{
  ...
  TString   PtDcaFormula              = "0.0105+0.0350/pt^1.01";//7sigma
  ...
  if(optSyt.Contains("PtDCAXY5s")) {PtDcaFormula = "0.0075+0.025/pt^1.01";}
  if(optSyt.Contains("PtDCAXY6s")) {PtDcaFormula = "0.0090+0.030/pt^1.01";}
  if(optSyt.Contains("PtDCAXY7s")) {PtDcaFormula = "0.0105+0.035/pt^1.01";}//Default
  if(optSyt.Contains("PtDCAXY8s")) {PtDcaFormula = "0.0120+0.040/pt^1.01";}
  if(optSyt.Contains("PtDCAXY9s")) {PtDcaFormula = "0.0135+0.045/pt^1.01";}

  if(optSyt.Contains("FixDCAZ1")) {dcazmax = 1.;}
  if(optSyt.Contains("FixDCAZ2")) {dcazmax = 2.;}//Default
  if(optSyt.Contains("FixDCAZ3")) {dcazmax = 3.;}
  
  if(optSyt.Contains("NCrRows60")){minCrossedRows = 60;}
  if(optSyt.Contains("NCrRows70")){minCrossedRows = 70;}//Default
  ...
  if(optSyt.Contains("Default")){
    ...
    if(selPrimaries) {
      // 7*(0.0015+0.0050/pt^1.01)
      esdTrackCuts->SetMaxDCAToVertexXYPtDep("0.0105+0.0350/pt^1.01");
