...
AliRsnMiniAnalysisTask *AddTaskKStarPlusMinusRun2_sp
(
 Bool_t      HIST = kFALSE,
 Bool_t      isMC,
 Bool_t      isPP,
...
//  }
    ...
    //
    // -- CONFIG ANALYSIS --------------------------------------------------------------------------
    gROOT->LoadMacro("$ALICE_PHYSICS/PWGLF/RESONANCES/macros/mini/ConfigKStarPlusMinusRun2_sp.C");
    //gROOT->LoadMacro("ConfigKStarPlusMinusRun2_sp.C");
    if (isMC) {
