/***************************************************************************
            ...
            dmallcik@cern.ch - last modified on 25/03/2019
//
...
AliRsnMiniAnalysisTask * AddTaskKStarpPbRunII_Rapidity(
						Bool_t      isMC                = kFALSE,
						Bool_t      isPP                = kFALSE,
						Int_t       Strcut              = 2011,
...
{  
  ...
  AliAnalysisManager *mgr = AliAnalysisManager::GetAnalysisManager();
   ...
   cutY->SetRangeD(-0.9, 0.9);// 0 < y_cm < 0.5; y_cm = y_lab + 0.465
   ...
   // -- CONFIG ANALYSIS --------------------------------------------------------------------------
   //
   gROOT->LoadMacro("$ALICE_PHYSICS/PWGLF/RESONANCES/macros/mini/ConfigKStarpPbRunII_Rapidity.C");
   // gROOT->LoadMacro("ConfigKStarPbPbRunII.C");
   if (!ConfigKStarpPbRunII_Rapidity(task, isMC, isPP, cutsPair,Strcut,customQualityCutsID,cutKaCandidate,nsigmaPi,nsigmaK,nsigmaTOF,enableMonitor)) return 0x0;
