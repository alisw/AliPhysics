/*=================================================================================
 Prottay das   -last modified on 12 October 2022
...
//kTPCpidphipp2015
{
  ...
  Int_t iCutK=task->AddTrackCuts(cutSetK);
   ...
   /////////////////////////////////////////////////////////////
    ...
    Float_t LE=massNKS-(nNKS*sigNKS);
    Float_t RE=massNKS+(nNKS*sigNKS);
    ...
    AliRsnMiniResonanceFinder* likepprsnfinder=new AliRsnMiniResonanceFinder(Form("%s_LikeppResonanceFinder",task->GetName()));
    ...
    likepprsnfinder->SetResonanceMass(0.895);
    ...
    likemmrsnfinder->SetResonanceMass(0.895);
    ...
    Int_t   cutID2  [10] = { iCutKstar0         ,iCutantiKstar0           ,iCutKstar0             ,iCutantiKstar0              , iCutlikeppKstar0, iCutlikemmKstar0,   iCutKstar0,  iCutantiKstar0,  iCutKstar0,  iCutantiKstar0};
