...
AliRsnMiniAnalysisTask *AddTaskKStarPlusMinusTest
(
 Bool_t      isMC,
 Bool_t      isPP,
 Float_t     cutV = 10.0,
 ...
 )
{
  ...
  //    UInt_t      triggerMask=AliVEvent::kINT7;
    ...
    cutY->SetRangeD(-0.5, 0.5);// 0 < y_cm < 0.5; y_cm = y_lab + 0.465
    ...
    gROOT->LoadMacro("$ALICE_PHYSICS/PWGLF/RESONANCES/macros/mini/ConfigKStarPlusMinusTest.C");
    //    gROOT->LoadMacro("ConfigKStarPlusMinusTest.C");
    ...
    if (!ConfigKStarPlusMinusTest(task, isPP, isMC, isGT, piPIDCut,customQualityCutsID, cutPiCandidate, pi_k0s_PIDCut, aodFilterBit, enableMonitor, monitorOpt.Data(), massTol, massTolVeto, tol_switch, tol_sigma, pLife, radiuslow, Switch, k0sDCA, k0sCosPoinAn, k0sDaughDCA, NTPCcluster, "", PairCutsSame, PairCutsMix, DCAxy, enableSys, crossedRows, rowsbycluster, v0rapidity, Sys)) return 0x0;
