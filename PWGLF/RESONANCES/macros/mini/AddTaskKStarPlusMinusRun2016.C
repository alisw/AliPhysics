...
AliRsnMiniAnalysisTask *AddTaskKStarPlusMinusRun2016
(
 Bool_t      isMC,
 Bool_t      isPP,
 Float_t     cutV = 10.0,
 ...
 )
{
    ...
    //gROOT->LoadMacro("$ALICE_PHYSICS/PWGLF/RESONANCES/macros/mini/ConfigKStarPlusMinusRun2016.C");
    //gROOT->LoadMacro("ConfigKStarPlusMinusRun2016.C");
    if (isMC) {
