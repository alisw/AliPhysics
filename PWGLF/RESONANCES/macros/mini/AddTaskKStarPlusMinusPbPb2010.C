...
AliRsnMiniAnalysisTask *AddTaskKStarPlusMinusPbPb2010
(
 Bool_t      isMC,
 ...
 )
{
  ...
  //vertex                                                                                                                                                 
   ...
   outVtx->AddAxis(vtxID, 400, -20.0, 20.0);
    ...
    gROOT->LoadMacro("$ALICE_PHYSICS/PWGLF/RESONANCES/macros/mini/ConfigKStarPlusMinusPbPb2010.C");
    //gROOT->LoadMacro("ConfigKStarPlusMinuspPbRun2.C");
    //gROOT->LoadMacro("ConfigKStarPlusMinusPbPb2010.C");
