/*=================================================================================
 ...
 Suman Deb - last modified 19 June 2019 (suman.deb@cern.ch)
...
//
Bool_t ConfigKStarPlusMinusRun2_sp_mc
(
...
//kTPCpidphipp2015
{
	...
	out->AddAxis(SpherocityID,1000,0.,1.); //ST
        ...
        outps->AddAxis(centID,400,0.5,400.5);//SD	else outps->AddAxis(centID,400,0.5,400.5);//SD
        outps->AddAxis(SpherocityID,1000,0.,1.); //SD
	...
	outpsf->AddAxis(centID,400,0.5,400.5);//else outpsf->AddAxis(centID,400,0.5,400.5);//ST
