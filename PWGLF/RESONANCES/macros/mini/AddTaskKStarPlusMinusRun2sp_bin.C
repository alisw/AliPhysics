/***************************************************************************
 ...
 //            Modified by Suman Deb - 11/07/2019 (suman.deb@cern.ch)
...
(
 Int_t       binning_sphero=1000,
 Double_t    min_sphero=0.0,
 Double_t    max_sphero=1.0,
 Int_t       mult_binning=10,
 Double_t    mult_min=0.0,
 Double_t    mult_max=10.0,
 Bool_t      HIST = kFALSE,
 Bool_t      isMC,
 Bool_t      isPP,
 Bool_t      Sphero = kTRUE,
...
//  }
    ...
    //
    // -- CONFIG ANALYSIS --------------------------------------------------------------------------
    gROOT->LoadMacro("$ALICE_PHYSICS/PWGLF/RESONANCES/macros/mini/ConfigKStarPlusMinusRun2sp_bin.C");
