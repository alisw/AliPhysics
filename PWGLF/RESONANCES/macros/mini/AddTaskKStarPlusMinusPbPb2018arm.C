...
AliRsnMiniAnalysisTask *AddTaskKStarPlusMinusPbPb2018arm
(
 Bool_t      isMC,
 ...
 )
{
  ...
  //vertex                                                                                                                                                 
   ...
   outVtx->AddAxis(vtxID, 400, -20.0, 20.0);
    ...
    //gROOT->LoadMacro("ConfigKStarPlusMinusPbPb2018arm.C");
    ...
    //gROOT->LoadMacro("ConfigKStarPlusMinusPbPb2018grid.C");
     ...
     if(!ConfigKStarPlusMinusPbPb2018arm(task, isMC, piPIDCut,nsigmaTOF,customQualityCutsID, cutPiCandidate, pi_k0s_PIDCut, enableMonitor, monitorOpt.Data(), UseTolCut, ArmentousParameter, massTol, tol_switch, tol_sigma, pLife, radiuslow, k0sDCA, k0sCosPoinAn, k0sDaughDCA, NTPCcluster, "", PairCutsSame,PairCutsMix, DCAxy, enableSys, crossedRows, rowsbycluster, Sys, imbin, limbin, himbin, ptbin, lptbin, hptbin, multbin, lmultbin, hmultbin)) return 0x0;
