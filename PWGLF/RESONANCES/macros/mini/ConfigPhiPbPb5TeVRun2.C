        ...
        )
{
    ...
    for(Int_t i=0;i<9;i++){
        ...
        if (!isPP)
            out->AddAxis(cosThSIDAbs, thetaBin, thetaMin , thetaMax);
        else
            out->AddAxis(cosThSIDAbs, thetaBin, thetaMin , thetaMax);

        out->AddAxis(etaID, etaBin, etaMin, etaMax);
    }
    ...
    if(isMC){
        ...
        //axis 3 - Costheta
        if (!isPP)
            outm->AddAxis(cosThSIDAbs, thetaBin, thetaMin , thetaMax);
        else
            outm->AddAxis(cosThSIDAbs, thetaBin, thetaMin , thetaMax);
        //axis 4 - eta
        outm->AddAxis(etaID, etaBin, etaMin, etaMax);
        ...
        if (!isPP)
            outmf->AddAxis(cosThSIDAbs, thetaBin, thetaMin , thetaMax);
        else
            outmf->AddAxis(cosThSIDAbs, thetaBin, thetaMin , thetaMax);

        outmf->AddAxis(etaID, etaBin, etaMin, etaMax);
	...
	outps->AddAxis(etaID, etaBin, etaMin, etaMax);
        ...
        if (!isPP)
            outpsf->AddAxis(cosThSIDAbs, thetaBin, thetaMin , thetaMax);
        else
            outpsf->AddAxis(cosThSIDAbs, thetaBin, thetaMin , thetaMax);

        outpsf->AddAxis(etaID, etaBin, etaMin, etaMax);
