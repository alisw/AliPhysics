...
{  
  ...
  AliAnalysisManager *mgr = AliAnalysisManager::GetAnalysisManager();
   ...
   task->UseCentrality("V0M");   // for centrality in PbPb
   ...
   gROOT->LoadMacro("ConfigLStar_PbPb.C");
   ConfigLStar_PbPb(task, yCut, aodFilterBit, useTPCCrossedRows, qualityCut, pidCut, nsPr, nsPr, isMC, suffix);
