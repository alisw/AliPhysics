...
//Rsn output is instead configured in the ConfigF1500.C macro
//
****************************************************************************/
#ifdef __CLING__
...
AliRsnMiniAnalysisTask * AddTaskF1500
(
