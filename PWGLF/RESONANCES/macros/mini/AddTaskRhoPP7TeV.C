...
AliRsnMiniAnalysisTask * AddTaskRhoPP7TeV
(
 Bool_t      isMC = kFALSE,
 Bool_t      isPP = kTRUE,
...
{  
  ...
  AliAnalysisManager *mgr = AliAnalysisManager::GetAnalysisManager();
   ...
   TString taskName = Form("Rho_%s%s_%i%i", (isPP? "pp" : "PbPb"), (isMC ? "MC" : "Data"), (Int_t)cutPi1Candidate,(Int_t)cutPi2Candidate );
   ...
   ::Info("AddAnalysisTaskRho", Form("Event mixing configuration: \n events to mix = %i \n max diff. vtxZ = cm %5.3f \n max diff multi = %5.3f", nmix, maxDiffVzMix, maxDiffMultMix));
