...
AliRsnMiniAnalysisTask * AddTaskKStarpPbRunII_ROOT6(
						Bool_t      isMC                = kFALSE,
						Bool_t      isPP                = kFALSE,
						Int_t       Strcut              = 2011,
						Int_t       customQualityCutsID = AliRsnCutSetDaughterParticle::kDisableCustom,
...
{  
  ...
  AliAnalysisManager *mgr = AliAnalysisManager::GetAnalysisManager();
   ...
   task->UseMC(isMC);
   ::Info("AddTaskKStarPbPbRunTwo", "%s", Form("Event mixing configuration: \n events to mix = %i \n max diff. vtxZ = cm %5.3f \n max diff multi = %5.3f \n", nmix, maxDiffVzMix, maxDiffMultMix));
...
Bool_t ConfigKStarpPbRunII(AliRsnMiniAnalysisTask *task, Bool_t isMC, Bool_t isPP, AliRsnCutSet *cutsPair, Int_t Strcut, Int_t customQualityCutsID, AliRsnCutSetDaughterParticle::ERsnDaughterCutSet cutKaCandidate, Float_t nsigmaPi, Float_t nsigmaK, Float_t nsigmaTOF, Bool_t enableMonitor )
{
