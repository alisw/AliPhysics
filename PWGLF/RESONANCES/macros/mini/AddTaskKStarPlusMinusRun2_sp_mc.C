...
//             Last Modified by Suman Deb - 19/06/2019 (suman.deb@cern.ch)
...
AliRsnMiniAnalysisTask *AddTaskKStarPlusMinusRun2_sp_mc
(
 Bool_t      HIST = kFALSE,
 Bool_t      isMC,
 Bool_t      isPP,
...
//  }
    ...
    //
    // -- CONFIG ANALYSIS --------------------------------------------------------------------------
    gROOT->LoadMacro("$ALICE_PHYSICS/PWGLF/RESONANCES/macros/mini/ConfigKStarPlusMinusRun2_sp_mc.C");
