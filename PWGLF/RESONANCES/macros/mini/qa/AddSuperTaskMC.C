...
{  
  ...
  const Int_t Np = 8;
  TString partname [Np] = {"Rho","Kstar","aKstar", "Phi", "Lstar", "aLstar", "f0", "f2"};
  Int_t    pdgCode [Np] = {113, 313, -313, 333, 3124, -3124, 9010221, 225};
  Float_t mass     [Np] = {0.770, 0.89495, 0.89445, 1.019461, 1.51954, 1.51954, 0.990, 1.270};
  Float_t masslow  [Np] = {0.5, 0.7, 0.7, 0.9, 1.3, 1.3, 0.8, 0.8};
  Float_t massup   [Np] = {1.0, 1.0, 1.0, 1.1, 1.7, 1.7, 1.2, 1.6};
  Char_t  charge1  [Np] = {'+', '+','-','+','+','-','+', '+'};
  Char_t  charge2  [Np] = {'-', '-','+','-','-','+','-','-'};
  ...
  RSNPID d1[Np] = { AliRsnDaughter::kPion, AliRsnDaughter::kKaon,  AliRsnDaughter::kKaon, 
		    ...
		    AliRsnDaughter::kPion, AliRsnDaughter::kPion};
