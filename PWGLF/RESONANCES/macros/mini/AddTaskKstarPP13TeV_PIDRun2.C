...
AliRsnMiniAnalysisTask * AddTaskKstarPP13TeV_PIDRun2
(
 Bool_t      isMC=kFALSE,
 Bool_t      isPP=kTRUE,
...
{  
 ...
 // task->UseESDTriggerMask(AliVEvent::kINT7); //ESD ****** check this *****
  ...
  // -- CONFIG ANALYSIS --------------------------------------------------------------------------
  gROOT->LoadMacro("$ALICE_PHYSICS/PWGLF/RESONANCES/macros/mini/ConfigKstarPP13TeV_PIDRun2..C");
 // gROOT->LoadMacro("./ConfigKstarPP13TeV_PIDRun2.C");
  if(!ConfigKstarPP13TeV_PIDRun2(task,isMC,isPP,"",cutsPair,aodFilterBit,customQualityCutsID,cutKaCandidate, cutPiCandidate, nsigmaKa,nsigmaPi,enableMonitor,isMC&IsMcTrueOnly,monitorOpt.Data(),useMixLS,isMC&checkReflex,yaxisvar)) return 0x0;

  // -- CONTAINERS --------------------------------------------------------------------------------

  TString outputFileName = AliAnalysisManager::GetCommonFileName();
  //  outputFileName += ":Rsn";
  Printf("AddAnalysisTaskKstarPP13TeV_PID - Set OutputFileName : \n %s\n",outputFileName.Data());
