/***************************************************************************
 ...
 //            Modified by Sudipan De - 10/04/2019 (sde@cern.ch)
 //            Modified by Dukhishyam Mallick -10/04/2019(dmallick@cern.ch)
...
AliRsnMiniAnalysisTask *AddTaskKStarPlusMinuspPbRun2_Rotational
(
 Bool_t      isMC,
 Bool_t      isPP,
 Bool_t      isRotate,
 ...
 )
{
  ...
  task->UseMultiplicity("AliMultSelection_V0A");
	...
	*/
    ...
    //
    // -- CONFIG ANALYSIS --------------------------------------------------------------------------
      gROOT->LoadMacro("$ALICE_PHYSICS/PWGLF/RESONANCES/macros/mini/ConfigKStarPlusMinuspPbRun2_Rotational.C");
    ...
    if (!ConfigKStarPlusMinuspPbRun2_Rotational(task, isMC, isPP, isRotate, isGT, piPIDCut,nsigmaTOF,customQualityCutsID, cutPiCandidate, pi_k0s_PIDCut, aodFilterBit, enableMonitor, monitorOpt.Data(), massTol, massTolVeto, tol_switch, tol_sigma, pLife, radiuslow, Switch, k0sDCA, k0sCosPoinAn, k0sDaughDCA, NTPCcluster, "", PairCutsSame, PairCutsMix, DCAxy, enableSys, crossedRows, rowsbycluster, v0rapidity, Sys)) return 0x0;
