/***************************************************************************
 ...
 //            Modified by Kunal Garg - 13/05/2018 (kgarg@cern.ch)
	       ...
	       Modified by Prottay           -11/10/2022
...
#include <PWGLF/RESONANCES/macros/mini/ConfigKShKpi.C>
//#include "ConfigKShKpi.C"
#endif


AliRsnMiniAnalysisTask *AddTaskKShKpi
(
 Bool_t      isMC,
...
//
    ...
    //gROOT->LoadMacro("ConfigKShKpi.C");
