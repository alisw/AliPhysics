...
//
Bool_t ConfigKStarPlusMinusRun2_sp
(
...
//kTPCpidphipp2015
{
	...
	else outps->AddAxis(centID,400,0.5,400.5);//ST
        outps->AddAxis(SpherocityID,1000,0.,1.); //ST
	...
	else outpsf->AddAxis(centID,400,0.5,400.5);//ST
        outpsf->AddAxis(SpherocityID,1000,0.,1.); //ST
