...
vector<double> FitParticleReturn(TH1 * h, const char * partName, Float_t min , Float_t max, Float_t scaleHisto, Int_t fitFunc, Int_t vartype, const char * fileOut, Bool_t wait, Float_t meanMin, Float_t meanMax);
...
vector<double> FitParticleReturn(TH1 * h, const char * partName, Float_t min , Float_t max, Float_t scaleHisto, Int_t fitFunc, Int_t vartype, const char * fileOut, Bool_t wait, Float_t meanMin, Float_t meanMax) { 
  // This function will return a vector array with:
  // rArray[0]: Yield
  // rArray[1]: Yield error
  // rArray[3]: Mean pT
  // rArray[4]: Mean pT error
...
//   Float_t yieldE = func->IntegralError(0.45,1.05);
  ...
  rArray.push_back(yield);
  rArray.push_back(yieldE);
  rArray.push_back(mean);
  rArray.push_back(meane);
