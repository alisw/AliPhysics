...
char const* datafile = "LHC16k_novertexer"; //LHC16 no vertexer
//char const* datafile = "LHC16q_pass1_CENT_wSDD";  //pPb

//char const* rsnmcfile = "LHC17f2b_cent"; // pPb


char const* rsnmcfile = "LHC18c6b4_novertexer"; //LHC16
char const* rsnmcfile2 = "LHC18c6b_part2"; //LHC16
char const* rsnmcfile3 = "LHC18c6b4"; // LHC16 pass2
char const* rsnmcfile4 = "LHC18c6a_part1"; // LHC17
char const* rsnmcfile5 = "LHC18c6a_part2"; // LHC17
char const* rsnmcfile6 = "LHC18c6c"; // LHC15

char const* genmcfile = "LHC17_GenMC_novertexer"; 
...
//__________________________________________________________
//__________________________________________________________
void DrawXi1530temp(const int sys = 1,
