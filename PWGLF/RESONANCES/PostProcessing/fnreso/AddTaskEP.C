...
void AddTaskEP(const char *suffix = "CMWchrg", Int_t frame =0, TString sMCfilePath = "a.root",TString sNUAFilePath = "b.root", TString sEVNTWGTFilePath = "alien:///alice/cern.ch/user/m/mhaque/calib2021/CalibV0GainCorrectionLHC18q_Oct2021.root")

{
  ...
  AliAnalysisTaskEP *task_CMW = new AliAnalysisTaskEP(TaskCMWPID);
