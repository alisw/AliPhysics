...
void AddTaskSAphi(const char *suffix = "CMWchrg", Int_t frame =0, TString sMCfilePath = "a.root",TString sNUAFilePath = "b.root", TString sEVNTWGTFilePath = "c.root")

{
  ...
  AliAnalysisTaskSAphi *task_CMW = new AliAnalysisTaskSAphi(TaskCMWPID);
