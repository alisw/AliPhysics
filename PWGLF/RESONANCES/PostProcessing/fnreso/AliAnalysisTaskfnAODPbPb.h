 ...
 **************************************************************************/
#ifndef AliAnalysisTaskfnAODPbPb_H
#define AliAnalysisTaskfnAODPbPb_H
...
class AliAnalysisTaskfnAODPbPb : public AliAnalysisTaskSE {
 public:
  AliAnalysisTaskfnAODPbPb();
  AliAnalysisTaskfnAODPbPb(const char *name);
  virtual ~AliAnalysisTaskfnAODPbPb();
...
//---------------------------------------------------------------------------------------
 ...
 private:
  ...
  AliAnalysisTaskfnAODPbPb(const AliAnalysisTaskfnAODPbPb&);
  AliAnalysisTaskfnAODPbPb& operator=(const AliAnalysisTaskfnAODPbPb&);  
  ClassDef(AliAnalysisTaskfnAODPbPb, 1);
};
...
class AliReducedPbPbTrack : public TObject
{
 public:
  AliReducedPbPbTrack(Double_t px, Double_t py, Double_t pz, Short_t charge)
    : fPxReducedPbPb(px), fPyReducedPbPb(py), fPzReducedPbPb(pz), fChargeReducedPbPb(charge)
  {
  }
  ~AliReducedPbPbTrack() {}
   

  virtual Double_t Px() const { return fPxReducedPbPb; }
  virtual Double_t Py() const { return fPyReducedPbPb; }
  virtual Double_t Pz() const { return fPzReducedPbPb; }
  virtual Short_t Charge() const{ return fChargeReducedPbPb; }
    
 private:
    
  Double_t fPxReducedPbPb;    
  Double_t fPyReducedPbPb;    
  Double_t fPzReducedPbPb;    
  Short_t fChargeReducedPbPb; 

  ClassDef(AliReducedPbPbTrack, 1);
};
