...
Bool_t loadRunOptions(Bool_t verb,const char *path, Int_t dataperiod) {
  ...
  */
  ...
  if (bGRIDPlugin || bTrainScope) {
    ...
    //else { szDataLocFilename = "GRIDrealdata.txt"; }
      ...
      if (dataperiod==0)
      szDataLocFilename = "GRIDOfficialrealdata.txt";
      else
	szDataLocFilename = "GRIDOfficialrealdata_18r.txt";}
