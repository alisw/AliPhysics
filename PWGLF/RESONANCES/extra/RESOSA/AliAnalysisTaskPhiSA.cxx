...
AliAnalysisTaskPhiSA::AliAnalysisTaskPhiSA() // All data members should be initialised here
:AliAnalysisTaskSE(0),
  fOutput(0),
  ...
  fhInvMassMixSAEPvzeroC(0)
{
  ...
  for(Int_t i = 0; i < kDimBuf; i++){
    ...
    if(i < 100){
      fBufferEventNEvents[i] = 0;
      fBufferEventFull[i] = 0;
    }
...
//________________________________________________________________________
AliAnalysisTaskPhiSA::~AliAnalysisTaskPhiSA()
{
...
//________________________________________________________________________
void AliAnalysisTaskPhiSA::UserCreateOutputObjects()
{
  // Create histograms
...
//________________________________________________________________________
void AliAnalysisTaskPhiSA::UserExec(Option_t *) 
{
  // Main loop
  ...
  //________________________________________________________________________
void AliAnalysisTaskPhiSA::Terminate(Option_t *) 
{
  // Draw result to screen, or perform fitting, normalizations
  // Called once at the end of the query
}
//-------------------------------------------------------------------------------------
Bool_t AliAnalysisTaskPhiSA::PassEvent(AliVEvent *evt){
...
//-------------------------------------------------------------------------------------
Int_t AliAnalysisTaskPhiSA::MakeRealPair(TVector2 * QvA, TVector2 * QvC)
{
...
//-------------------------------------------------------------------------------------
Int_t AliAnalysisTaskPhiSA::MakeLikePair(TVector2 * QvA, TVector2 * QvC)
{
...
//-------------------------------------------------------------------------------------
Int_t AliAnalysisTaskPhiSA::MakeMixedPair(Int_t bufferPointer, TVector2 * QvA, TVector2 * QvC)
{
...
//--------------------------------------------------------------------------------//
//-------------------------------------------------------------------------------------
void AliAnalysisTaskPhiSA::CopyCurrentToBuffer(Int_t bufferPointer,TVector2 *Qv)
{
...
//-------------------------------------------------------------------------------------
Double_t AliAnalysisTaskPhiSA::GetDipAngle(Double_t aX,Double_t aY,Double_t aZ,Double_t bX,Double_t bY,Double_t bZ)
{ 
  Double_t p,adotb;
...
Double_t AliAnalysisTaskPhiSA::CosThetaStar(TLorentzVector mother, TLorentzVector daughter0,TVector2& Qvect)
{
  //
...
//________________________________________________________________________
void AliAnalysisTaskPhiSA::SetPOIAndRPTrackType(TString tracktype, TString rptracktype){
...
//--------------------------------------------------------------------
Bool_t AliAnalysisTaskPhiSA::IsSelectedPION(AliVTrack *track)
{
//
// Check flags
//
...
//-----------------------------------------------------
Bool_t AliAnalysisTaskPhiSA::IsSelectedKAON(AliVTrack *track)
{
  //
  // Check flags
  //
...
Double_t AliAnalysisTaskPhiSA::GetTOFBeta(AliVTrack *track)
{
...
//______________________________________________________________________________
Bool_t AliAnalysisTaskPhiSA::GetStatus(const AliVTrack *vtrack)
{
  //
...
//______________________________________________________________________________
Bool_t AliAnalysisTaskPhiSA::MatchTOF(const AliVTrack *vtrack)
{
//
...
//______________________________________________________________________________
Double_t AliAnalysisTaskPhiSA::GetNSigmaCut(Double_t pTrack)
{
  Double_t nSigCut = 0;
...
//______________________________________________________________________________
void AliAnalysisTaskPhiSA::ReSet()
{
