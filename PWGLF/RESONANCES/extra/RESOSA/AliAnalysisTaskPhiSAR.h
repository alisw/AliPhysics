...
/* AliAnalysisTaskPhiSAR.h*/

#ifndef ALIANALYSISTASKPHISAR_H
#define ALIANALYSISTASKPHISAR_H
...
class AliAnalysisTaskPhiSAR : public AliAnalysisTaskSE {
 public:
  AliAnalysisTaskPhiSAR();
  AliAnalysisTaskPhiSAR(const char *name,  const Bool_t useshift);
  virtual ~AliAnalysisTaskPhiSAR();
 ...
 private:
    ...
    */
    ...
    TH3F *fhNumInvMassvsPtPhi[9];//!
    TH3F *fhDenInvMassvsPtPhi[9];//!
    TH3F *fhDenInvMassvsPtPhi_likepp[9];
    TH3F *fhDenInvMassvsPtPhi_likemm[9];
    ...
    AliAnalysisTaskPhiSAR(const AliAnalysisTaskPhiSAR&); // not implemented
    AliAnalysisTaskPhiSAR& operator=(const AliAnalysisTaskPhiSAR&); // not implemented
    ClassDef(AliAnalysisTaskPhiSAR, 1); // example of analysis
};
//__________________________________________________________________________________________________
inline Bool_t AliAnalysisTaskPhiSAR::CheckVertex(const AliVVertex *vertex)
{
  //
