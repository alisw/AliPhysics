...
#include "AliXiStarPbPb_RUN2.h"
#define PI 3.1415927


// Author: Jihye Song

ClassImp(AliXiStarPbPb_RUN2)

//________________________________________________________________________
AliXiStarPbPb_RUN2::AliXiStarPbPb_RUN2():
AliAnalysisTaskSE(),
fname(0),
fESD(0x0),
fOutputList(0x0),
...
//________________________________________________________________________
AliXiStarPbPb_RUN2::AliXiStarPbPb_RUN2(const char *name, Bool_t AODdecision,  Bool_t MCdecision, Int_t CutListOption)
...
//________________________________________________________________________
AliXiStarPbPb_RUN2::AliXiStarPbPb_RUN2(const AliXiStarPbPb_RUN2 &obj)
...
//________________________________________________________________________
AliXiStarPbPb_RUN2 &AliXiStarPbPb_RUN2::operator=(const AliXiStarPbPb_RUN2 &obj)
{
    // Assignment operator
    if (this == &obj)
        return *this;
...
//________________________________________________________________________
void AliXiStarPbPb_RUN2::XiStarInit()
{
    //
    //Inits cuts and analysis settings
    //
    
    //* cout<<"AliXiStarPbPb_RUN2 XiStarInit() call"<<endl;
...
//________________________________________________________________________
void AliXiStarPbPb_RUN2::UserCreateOutputObjects()
{
    XiStarInit();
    ...
    TH1F *fMultDist_BeforeCut = new TH1F("fMultDist_BeforeCut","Multiplicity Distribution",kNbinsM,0,kNbinsM*100);
    fMultDist_BeforeCut->GetXaxis()->SetTitle("Multiplicity");
    fOutputList->Add(fMultDist_BeforeCut);
    
    TH1F *fMultDist_After_IncomDAQ = new TH1F("fMultDist_After_IncomDAQ","Multiplicity Distribution After Incomplete DAQ cut",kNbinsM,0,kNbinsM*100);
    fMultDist_After_IncomDAQ->GetXaxis()->SetTitle("Multiplicity");
    fOutputList->Add(fMultDist_After_IncomDAQ);
    
    TH1F *fMultDist_After_ClsTrk = new TH1F("fMultDist_After_ClsTrk","Multiplicity Distribution After SPD vs Cluster BG cut",kNbinsM,0,kNbinsM*100);
    fMultDist_After_ClsTrk->GetXaxis()->SetTitle("Multiplicity");
    fOutputList->Add(fMultDist_After_ClsTrk);
    
    TH1F *fMultDist_After_Pileup = new TH1F("fMultDist_After_Pileup","Multiplicity Distribution After reject pile up from SPD",kNbinsM,0,kNbinsM*100);
    fMultDist_After_Pileup->GetXaxis()->SetTitle("Multiplicity");
    fOutputList->Add(fMultDist_After_Pileup);
    
    TH1F *fMultDist_After_NContri = new TH1F("fMultDist_After_NContri","Multiplicity Distribution : Primary NContributor > 1 ",kNbinsM,0,kNbinsM*100);
    fMultDist_After_NContri->GetXaxis()->SetTitle("Multiplicity");
    fOutputList->Add(fMultDist_After_NContri);
    
    TH1F *fMultDist_After_Vz = new TH1F("fMultDist_After_Vz","Multiplicity Distribution After Vz selection",kNbinsM,0,kNbinsM*100);
    fMultDist_After_Vz->GetXaxis()->SetTitle("Multiplicity");
    fOutputList->Add(fMultDist_After_Vz);
    
    TH1F *fMultDist_myTracks = new TH1F("fMultDist_myTracks","Multiplicity Distribution of mytrack",kNbinsM,0,kNbinsM*100);
    fMultDist_myTracks->GetXaxis()->SetTitle("Multiplicity");
    fOutputList->Add(fMultDist_myTracks);
    
    TH1F *fMultDist_withmyTracks = new TH1F("fMultDist_withmyTracks","Multiplicity Distribution",kNbinsM,0,kNbinsM*100);
    fMultDist_withmyTracks->GetXaxis()->SetTitle("Multiplicity");
    fOutputList->Add(fMultDist_withmyTracks);
    ...
    TH1F *hCentralitySelectedkINT7 = new TH1F("hCentralitySelectedkINT7","hCentralitySelectedkINT7",100,0,100);
    hCentralitySelectedkINT7->GetXaxis()->SetTitle("Centrality");
    fOutputList->Add(hCentralitySelectedkINT7);
    ...
    TH3F *fMCinputTotalXiStar1 = new TH3F("fMCinputTotalXiStar1","Invariant Mass Distribution", 100,0,10,10,0,100, 200,2.4,2.6);
    TH3F *fMCinputTotalXiStarbar1 = new TH3F("fMCinputTotalXiStarbar1","Invariant Mass Distribution",100,0,10,10,0,100, 200,2.4,2.6);
    ...
    TH3F *fMCinputTotalXiStar3 = new TH3F("fMCinputTotalXiStar3","Invariant Mass Distribution", 100,0,10,10,0,100, 200,2.4,2.6);
    TH3F *fMCinputTotalXiStarbar3 = new TH3F("fMCinputTotalXiStarbar3","Invariant Mass Distribution", 100,0,10,10,0,100, 200,2.4,2.6);
    ...
    for(Int_t cv=0; cv<kNCutVariations; cv++){
        ...
        *nameXiPlusPiMinusbkg += cv; */
        CutVar[cv].fXiMinusPiPlus  = new TH3F(nameXiMinusPiPlus->Data(),"Invariant Mass Distribution", 100,0,10,10,0,100, 200,2.4,2.6);
        CutVar[cv].fXiMinusPiMinus = new TH3F(nameXiMinusPiMinus->Data(),"Invariant Mass Distribution", 100,0,10,10,0,100, 200,2.4,2.6);
        CutVar[cv].fXiPlusPiPlus   = new TH3F(nameXiPlusPiPlus->Data(),"Invariant Mass Distribution", 100,0,10,10,0,100, 200,2.4,2.6);
        CutVar[cv].fXiPlusPiMinus  = new TH3F(nameXiPlusPiMinus->Data(),"Invariant Mass Distribution", 100,0,10,10,0,100, 200,2.4,2.6);
     /*   CutVar[cv].fXiMinusPiPlusbkg  = new TH3F(nameXiMinusPiPlusbkg->Data(),"Invariant Mass Distribution", 100,0,10,10,0,100, 200,2.4,2.6);
        CutVar[cv].fXiMinusPiMinusbkg = new TH3F(nameXiMinusPiMinusbkg->Data(),"Invariant Mass Distribution", 100,0,10,10,0,100, 200,2.4,2.6);
        CutVar[cv].fXiPlusPiPlusbkg   = new TH3F(nameXiPlusPiPlusbkg->Data(),"Invariant Mass Distribution", 100,0,10,10,0,100, 200,2.4,2.6);
        CutVar[cv].fXiPlusPiMinusbkg  = new TH3F(nameXiPlusPiMinusbkg->Data(),"Invariant Mass Distribution",100,0,10,10,0,100, 200,2.4,2.6); */
        ...
        *nameMCrecXiPlusPiMinus += cv;
        CutVar[cv].fMCrecXiMinusPiPlus  = new TH3F(nameMCrecXiMinusPiPlus->Data(),"Invariant Mass Distribution", 100,0,10,10,0,100, 200,2.4,2.6);
        CutVar[cv].fMCrecXiPlusPiMinus  = new TH3F(nameMCrecXiPlusPiMinus->Data(),"Invariant Mass Distribution", 100,0,10,10,0,100, 200,2.4,2.6);
...
//________________________________________________________________________
void AliXiStarPbPb_RUN2::Exec(Option_t *)
{
  ...
  //  centralityV0M = fCentrality->GetCentralityPercentile("V0M");
    ...
    if(isSelectedkINT7) ((TH1F*)fOutputList->FindObject("hEventSelecInfo"))->Fill(4);
    ...
    if(isSelectedkINT7)((TH1F*)fOutputList->FindObject("hCentralitySelectedkINT7"))->Fill(centralityV0M);
    
    if(!fMCcase){
        if(!(isSelectedkINT7|isSelectedkCentral|isSelectedkSemiCentral)) {
            return;
    ...
    ((TH1F*)fOutputList->FindObject("fMultDist_BeforeCut"))->Fill(fESD->GetNumberOfTracks());
    ...
    Bool_t IncompleteDAQ = fESD->IsIncompleteDAQ();
    ((TH1F*)fOutputList->FindObject("fMultDist_After_IncomDAQ"))->Fill(fESD->GetNumberOfTracks());
    ...
    if (!AnalysisUtils) {
        ...
        SPDvsClustersBG = AnalysisUtils->IsSPDClusterVsTrackletBG(fESD);
    if(SPDvsClustersBG) return;
    ((TH1F*)fOutputList->FindObject("fMultDist_After_ClsTrk"))->Fill(fESD->GetNumberOfTracks());
    
       // Pile up rejection-----------------------------------------------------
    if(fESD->IsPileupFromSPD()) return;
    ((TH1F*)fOutputList->FindObject("fMultDist_After_Pileup"))->Fill(fESD->GetNumberOfTracks());
    
    // Number of Contributors-----------------------------------------------------
    if(PrimaryVertexESD->GetNContributors() < 1) return;
    ((TH1F*)fOutputList->FindObject("fMultDist_After_NContri"))->Fill(fESD->GetNumberOfTracks());
    ...
    ((TH1F*)fOutputList->FindObject("fMultDist_After_Vz"))->Fill(fESD->GetNumberOfTracks());
    ...
    if(myTracks >= 1) {
        ((TH1F*)fOutputList->FindObject("fMultDist_myTracks"))->Fill(myTracks);
        ((TH1F*)fOutputList->FindObject("fMultDist_withmyTracks"))->Fill(fESD->GetNumberOfTracks());
    }
...
//________________________________________________________________________
void AliXiStarPbPb_RUN2::Terminate(Option_t *)
{
    //* cout<<"Done"<<endl;
}

//________________________________________________________________________
Double_t AliXiStarPbPb_RUN2::Det(Double_t a00, Double_t a01, Double_t a10, Double_t a11) const {// Taken from AliCascadeVertexer
    //--------------------------------------------------------------------
...
//________________________________________________________________________
Double_t AliXiStarPbPb_RUN2::Det(Double_t a00,Double_t a01,Double_t a02,
