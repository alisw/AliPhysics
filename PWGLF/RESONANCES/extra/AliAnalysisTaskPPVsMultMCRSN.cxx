...
//
// Code comes from "https://github.com/alisw/AliPhysics/blob/master/PWGLF/STRANGENESS/Cascades/AliAnalysisTaskPPVsMultCrossCheckMC.cxx" and modified by Jihye.Song@cern.ch
// To include resonances f0(9820),Sigma(1385), Lambda(1520) and Xi(1530)
//
// +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
...
ClassImp(AliAnalysisTaskPPVsMultMCRSN)

AliAnalysisTaskPPVsMultMCRSN::AliAnalysisTaskPPVsMultMCRSN()
...
AliAnalysisTaskPPVsMultMCRSN::AliAnalysisTaskPPVsMultMCRSN(const char *name)
...
void AliAnalysisTaskPPVsMultMCRSN::UserCreateOutputObjects()
{
    //------------------------------------------------
...
//________________________________________________________________________
void AliAnalysisTaskPPVsMultMCRSN::UserExec(Option_t *)
{
    // Main loop
    ...
    if ( !lPureMonteCarlo )
    {
     ...
     if(fkMultSelection){
       AliMultSelection *MultSelection = (AliMultSelection*) lESDevent -> FindListObject("MultSelection");
    //Below two lines are under investigation [Jihye Song]
...
//________________________________________________________________________
void AliAnalysisTaskPPVsMultMCRSN::Terminate(Option_t *)
{
    ...
    if(!cRetrievedList) {
        Printf("ERROR - AliAnalysisTaskPPVsMultMCRSN : ouput data container list not available\n");
        return;
    }
    
    fHistEventCounter = dynamic_cast<TH1F*> (  cRetrievedList->FindObject("fHistEventCounter")  );
    if (!fHistEventCounter) {
        Printf("ERROR - AliAnalysisTaskPPVsMultMCRSN : fHistEventCounter not available");
        return;
    }
    
    TCanvas *canCheck = new TCanvas("AliAnalysisTaskPPVsMultMCRSN","Event Multiplicity",10,10,510,510);
...
//----------------------------------------------------------------------------
Double_t AliAnalysisTaskPPVsMultMCRSN::MyRapidity(Double_t rE, Double_t rPz) const
{
...
//----------------------------------------------------------------------------
Double_t AliAnalysisTaskPPVsMultMCRSN::GetV0MAmplitude( AliESDEvent *lInputEvent ) const
{
