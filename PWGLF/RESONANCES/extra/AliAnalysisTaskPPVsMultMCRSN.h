...
#ifndef AliAnalysisTaskPPVsMultMCRSN_H
#define AliAnalysisTaskPPVsMultMCRSN_H
...
public:
    AliAnalysisTaskPPVsMultMCRSN();
    AliAnalysisTaskPPVsMultMCRSN(const char *name);
    virtual ~AliAnalysisTaskPPVsMultMCRSN();
...
private:
    ...
    AliAnalysisTaskPPVsMultMCRSN& operator=(const AliAnalysisTaskPPVsMultMCRSN&); // not implemented

    ClassDef(AliAnalysisTaskPPVsMultMCRSN, 1);
};
