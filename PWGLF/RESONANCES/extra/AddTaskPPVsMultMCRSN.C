AliAnalysisTaskPPVsMultMCRSN *AddTaskPPVsMultMCRSN( const TString lMasterJobSessionFlag = "")
{
    ...
    if (!mgr) {
        ::Error("AliAnalysisTaskPPVsMultMCRSN", "No analysis manager to connect to.");
        return NULL;
    }
    ...
    AliAnalysisTaskPPVsMultMCRSN *taskAuxiliary = new AliAnalysisTaskPPVsMultMCRSN("taskAuxiliary");
