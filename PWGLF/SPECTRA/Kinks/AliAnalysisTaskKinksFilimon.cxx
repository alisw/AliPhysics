...
//________________________________________________________________________
AliAnalysisTaskKinksFilimon::AliAnalysisTaskKinksFilimon(const char *name, const AliBits offlineTriggerType, AliESDkinkCuts* esdKinkCuts, AliESDtrackCuts* esdTrackCutsKinkMother, AliESDtrackCuts* esdTrackCutsKinkDaughter, AliESDtrackCuts* esdTrackCutsPartner, TArrayF esdPIDCutsResonances, /*const AliCFParticleGenCuts* genTrackCuts, const TH1* histPtTemplate=0x0,*/ const Bool_t useMC, const Bool_t fillCutHist, const TH2* histPtYTemplate, const THnSparseF* histRPhiZTemplate, const ECollisionType collisionType, TClass* outputContClass, const UInt_t aodFilterMap)
