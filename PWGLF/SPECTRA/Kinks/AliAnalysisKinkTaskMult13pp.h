#ifndef ALIANALYSISKINKTASKMULT13pp_H
#define ALIANALYSISKINKTASKMULT13pp_H
...
class AliAnalysisKinkTaskMult13pp : public AliAnalysisTaskSE {
 public:
  AliAnalysisKinkTaskMult13pp(const char *name = "AliAnalysisKinkTaskMult13pp");
  virtual ~AliAnalysisKinkTaskMult13pp() {}
...
//   AliAnalysisUtils   *fUtils; // Analysis Utils
   ...
   AliAnalysisKinkTaskMult13pp(const AliAnalysisKinkTaskMult13pp&); // not implemented
   AliAnalysisKinkTaskMult13pp& operator=(const AliAnalysisKinkTaskMult13pp&); // not implemented
   
   ClassDef(AliAnalysisKinkTaskMult13pp, 1); // example of analysis
};
