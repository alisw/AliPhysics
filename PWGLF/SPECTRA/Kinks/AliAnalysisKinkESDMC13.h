#ifndef ALIANALYSISKINKESDMC13_H
#define ALIANALYSISKINKESDMC13_H
...
class AliAnalysisKinkESDMC13 : public AliAnalysisTaskSE {
 public:
  AliAnalysisKinkESDMC13(const char *name = "AliAnalysisKinkESDMC13");
  virtual ~AliAnalysisKinkESDMC13() {}
...
//*/
 private:
   TH1F        *fIncompletEv; //!MC  charged mult after Incomplete DAQ
   TH1F        *fPileupEv; //!MC  charged mult after Pileup cut        
   TH1F        *fSPDsel; //!MC  charged mult after SPD selection     
   TH1F        *fMultiplMC; //!charge multipl MC 
   TH1F        *fMultMCK; //!MC K charged mult
   TH1F        *fMultESDK; //!ESD charged mult unside god vertex
   TH1D        *fZpr;//!Z distrio of main vertex                  
   TH1F        *fESDMult; //!ESD charged mult after all cuts
...
*/
 AliPIDResponse *fPIDResponse;     //! PID response object
  AliAnalysisKinkESDMC13(const AliAnalysisKinkESDMC13&); // not implemented
  AliAnalysisKinkESDMC13& operator=(const AliAnalysisKinkESDMC13&); // not implemented

  ClassDef(AliAnalysisKinkESDMC13, 1); // example of analysis
};
