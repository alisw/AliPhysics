#ifndef ALIANALYSISKINKESDat13_H
#define ALIANALYSISKINKESDat13_H
...
class AliAnalysisKinkESDat13 : public AliAnalysisTaskSE {
 public:
  AliAnalysisKinkESDat13(const char *name = "AliAnalysisKinkESDat13");
  virtual ~AliAnalysisKinkESDat13() {}
...
//*/
AliPIDResponse *fPIDResponse;     //! PID response object
  AliAnalysisKinkESDat13(const AliAnalysisKinkESDat13&); // not implemented
  AliAnalysisKinkESDat13& operator=(const AliAnalysisKinkESDat13&); // not implemented

  ClassDef(AliAnalysisKinkESDat13, 1); // example of analysis
};
