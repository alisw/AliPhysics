#ifndef ALIANALYSISKINKESDat13ppHM_H
#define ALIANALYSISKINKESDat13ppHM_H
...
class AliAnalysisKinkESDat13ppHM : public AliAnalysisTaskSE {
 public:
  AliAnalysisKinkESDat13ppHM(const char *name = "AliAnalysisKinkESDat13ppHM");
  virtual ~AliAnalysisKinkESDat13ppHM() {}
...
//   TH1F        *f1;// theor curve, max angle of kink as a function of mother momentum 
   ...
   TH1F        *fcentrality;//centrality distribution       after HM trigger selection 
   TH1F        *fcentral0To1;//centrality distribution       after HM trigger selection 
   TH1F        *fcentral0To01;//centrality distribution       after HM trigger selection 
...
AliPIDResponse *fPIDResponse;     //! PID response object
  ...
  AliAnalysisKinkESDat13ppHM(const AliAnalysisKinkESDat13ppHM&); // not implemented
  AliAnalysisKinkESDat13ppHM& operator=(const AliAnalysisKinkESDat13ppHM&); // not implemented

  ClassDef(AliAnalysisKinkESDat13ppHM, 1); // example of analysis
};
