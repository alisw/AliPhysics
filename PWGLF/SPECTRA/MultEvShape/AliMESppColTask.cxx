...
//         TObjArray *selectedTracks1=FindLeadingObjects(fTracks, 0);
      ...
      if((pTlead>=1. && pTlead<=2.) && mult_comb08>50 && mult_comb08<=80 && TMath::Abs(fEvInfo->GetVertexZ())<10.0 && sfer>0.3 && sfer<=0.6){
//         TObjArray *selectedTracks2=FindLeadingObjects(fTracks, 0);
      ...
      if((pTlead>=1. && pTlead<=2.) && mult_comb08>50 && mult_comb08<=80 && TMath::Abs(fEvInfo->GetVertexZ())<10.0 && sfer>0.6 && sfer<=1.0){
...
// 		TObjArray *selectedTracksMC1=FindLeadingObjects(fMCtracks, 1);
      ...
      if((pTMClead>=1.0 && pTMClead<=2.0) && MC_mult_glob08>50 && MC_mult_glob08<=80 && TMath::Abs(fMCevInfo->GetVertexZ())<10.0 && MC_sfer>0.3 && MC_sfer<=0.6){
// 		TObjArray *selectedTracksMC2=FindLeadingObjects(fMCtracks, 1);
      ...
      if((pTMClead>=1.0 && pTMClead<=2.0) && MC_mult_glob08>50 && MC_mult_glob08<=80 && TMath::Abs(fMCevInfo->GetVertexZ())<10.0 && MC_sfer>0.6 && MC_sfer<=1.0){
