...
#include "PWGLF/SPECTRA/MultEvShape/AliMESppColTask.h"
#endif

void AddMESppColTask(AliAnalysisDataContainer **ci, Bool_t mc)
{
  ...
  AliMESppColTask *ppCol = new AliMESppColTask("PID");
  mgr->AddTask(ppCol);
