...
Bool_t AliAnalysisTaskMKBase::ReadEvent() {
    ...
    if (!fAnalysisManager) {
        ...
        fInputEventHandler = dynamic_cast<AliInputEventHandler*>(
            fAnalysisManager->GetInputEventHandler());
    }
...
Bool_t AliAnalysisTaskMKBase::InitEventMult() {
    ...
    fMultSelection = 0;
    fMultSelection = dynamic_cast<AliMultSelection*>(
        fEvent->FindListObject("MultSelection"));
    if (!fMultSelection) {
...
AliAnalysisTaskMKBase::AddTaskMKBase(const char* name, const char* outfile) {
