...
TFormula *AliAnalysisTrack::fgMaxDCAToVertexXYPtDepFormula = new TFormula("f1MaxDCAToVertexXYPtDepFormula", "0.0105+0.0350/x^1.1");
...
Int_t AliAnalysisTrack::fgAcceptTrackClusterCut = 1;
...
Float_t AliAnalysisTrack::fgMatchTrackDeltaX = 10.;
Float_t AliAnalysisTrack::fgMatchTrackDeltaZ = 10.;
...
Bool_t
AliAnalysisTrack::HasTOFPID(TH1 *henabled) const
{
  /*
   * has TOF PID
   */
