AliAnalysisTaskTOFppSpectra *AddTaskTOFppSpectra(const char *PeriodName=NULL, Int_t nTPC_CR=70, Int_t Chi2_TPCcluser=4, Int_t DCAz=2, Int_t DCAxy=7, Int_t value_Sigma=80, Float_t value_Slope=0.0)
{
...
*/
  ...
  TString outputFileName = AliAnalysisManager::GetCommonFileName();
	...
	if(value_Slope==0.0)	Double_t slope=0.0125;
	else if(value_Slope==+1.0)	Double_t slope=0.01375;
	else if(value_Slope==-1.0)	Double_t slope=0.01125;
