...
//_________________________________________________________________________________________________
void GetHistogram(TList *lin, TString hname, TH1F *& histo){//Gets the histogram from the list
...
//_________________________________________________________________________________________________
void GetHistogram(TList *lin, TString hname, TH1D *& histo){//Gets the histogram from the list
  //   if(histo) Fatalmsg("GetHistogram", Form("Histogram %s already exists!", histo->GetName()));
...
//_________________________________________________________________________________________________
void GetHistogram(TFile *fin, TString hname, TH1F *& histo){//Gets the histogram from the file
  //   if(histo) Fatalmsg("GetHistogram", Form("Histogram %s already exists!", histo->GetName()));
...
//_________________________________________________________________________________________________
void GetHistogram(TFile *fin, TString hname, TH1D *& histo){//Gets the histogram from the file
  //   if(histo) Fatalmsg("GetHistogram", Form("Histogram %s already exists!", histo->GetName()));
  fin->GetObject(hname, histo);
  if(!histo){
    fin->ls();
...
//_________________________________________________________________________________________________
void GetHistogram(TFile *fin, TString hname, TH2I *& histo){//Gets the histogram from the file
  //   if(histo) Fatalmsg("GetHistogram", Form("Histogram %s already exists!", histo->GetName()));
  fin->GetObject(hname, histo);
  if(!histo){
...
//_________________________________________________________________________________________________
void GetHistogram(TFile *fin, TString hname, TH2F *& histo){//Gets the histogram from the file
  //   if(histo) Fatalmsg("GetHistogram", Form("Histogram %s already exists!", histo->GetName()));
  fin->GetObject(hname, histo);
  if(!histo){
    fin->ls();
...
//_________________________________________________________________________________________________
void GetHistogram(TList *lin, TString hname, TH2F *& histo){//Gets the histogram from the list
  //   if(histo) Fatalmsg("GetHistogram", Form("Histogram %s already exists!", histo->GetName()));
...
//_________________________________________________________________________________________________
void GetHistogram(TList *lin, TString hname, TH2I *& histo){//Gets the histogram from the list
  //   if(histo) Fatalmsg("GetHistogram", Form("Histogram %s already exists!", histo->GetName()));
...
//_________________________________________________________________________________________________
void GetHistogram(TDirectory *dir, TString hname, TH1F *& histo){//Gets the histogram from the directory
  //   if(histo) Fatalmsg("GetHistogram", Form("Histogram %s already exists!", histo->GetName()));
