...
AliAnalysisTaskDoubleHypNucTree::AliAnalysisTaskDoubleHypNucTree()
	...
	//Histos
	fHistogramList(NULL), fHistdEdx(0), fHistNumEvents(0), fHistTrigger(0), fCentrality1(), fHistTrigger1(), fCentrality2(), fHistTrigger2(),
	//saved in tree
	...
	//  
	fptDaughterUnProp(-99), fpxDaughterUnProp(-99), fpyDaughterUnProp(-99), fpzDaughterUnProp(-99), fyDaughterUnProp(-99),
	fptDaughter1UnProp(-99), fpxDaughter1UnProp(-99), fpyDaughter1UnProp(-99), fpzDaughter1UnProp(-99), fyDaughter1UnProp(-99),
	fptDaughter2UnProp(-99), fpxDaughter2UnProp(-99), fpyDaughter2UnProp(-99), fpzDaughter2UnProp(-99), fyDaughter2UnProp(-99),
	fptDaughter3UnProp(-99), fpxDaughter3UnProp(-99), fpyDaughter3UnProp(-99), fpzDaughter3UnProp(-99), fyDaughter3UnProp(-99),
	//
...
void AliAnalysisTaskDoubleHypNucTree::UserCreateOutputObjects() {
	...
	fTree->Branch("fTriggerString", &fTriggerString, "fTriggerString/C");
	...
	fTreeD->Branch("fTrackPIDDaughter", &fTrackPIDDaughter, "fTrackPIDDaughter/I");
	fTreeD->Branch("fLabelDaughterKF", &fLabelDaughterKF, "fLabelDaughterKF/D");
	fTreeD->Branch("fpDaughter", &fpDaughter, "fpDaughter/D");
	fTreeD->Branch("fptDaughterUnProp", &fptDaughterUnProp, "fptDaughterUnProp/D");
	fTreeD->Branch("fpxDaughterUnProp", &fpxDaughterUnProp, "fpxDaughterUnProp/D");
	fTreeD->Branch("fpyDaughterUnProp", &fpyDaughterUnProp, "fpyDaughterUnProp/D");
	fTreeD->Branch("fpzDaughterUnProp", &fpzDaughterUnProp, "fpzDaughterUnProp/D");
	...
	fTreeD->Branch("fTrackPIDDaughter1", &fTrackPIDDaughter1, "fTrackPIDDaughter1/I");
	fTreeD->Branch("fLabelDaughter1KF", &fLabelDaughter1KF, "fLabelDaughter1KF/D");
	fTreeD->Branch("fpDaughter1", &fpDaughter1, "fpDaughter1/D");
	fTreeD->Branch("fptDaughter1UnProp", &fptDaughter1UnProp, "fptDaughter1UnProp/D");
	fTreeD->Branch("fpxDaughter1UnProp", &fpxDaughter1UnProp, "fpxDaughter1UnProp/D");
	fTreeD->Branch("fpyDaughter1UnProp", &fpyDaughter1UnProp, "fpyDaughter1UnProp/D");
	fTreeD->Branch("fpzDaughter1UnProp", &fpzDaughter1UnProp, "fpzDaughter1UnProp/D");
	...
	fTreeD->Branch("fTrackPIDDaughter2", &fTrackPIDDaughter2, "fTrackPIDDaughter2/I");
	fTreeD->Branch("fLabelDaughter2KF", &fLabelDaughter2KF, "fLabelDaughter2KF/D");
	fTreeD->Branch("fpDaughter2", &fpDaughter2, "fpDaughter2/D");
	fTreeD->Branch("fptDaughter2UnProp", &fptDaughter2UnProp, "fptDaughter2UnProp/D");
	fTreeD->Branch("fpxDaughter2UnProp", &fpxDaughter2UnProp, "fpxDaughter2UnProp/D");
	fTreeD->Branch("fpyDaughter2UnProp", &fpyDaughter2UnProp, "fpyDaughter2UnProp/D");
	fTreeD->Branch("fpzDaughter2UnProp", &fpzDaughter2UnProp, "fpzDaughter2UnProp/D");
	...
	fTreeD->Branch("fTrackPIDDaughter3", &fTrackPIDDaughter3, "fTrackPIDDaughter3/I");
	fTreeD->Branch("fLabelDaughter3KF", &fLabelDaughter3KF, "fLabelDaughter3KF/D");
	fTreeD->Branch("fpDaughter3", &fpDaughter3, "fpDaughter3/D");
	fTreeD->Branch("fptDaughter3UnProp", &fptDaughter3UnProp, "fptDaughter3UnProp/D");
	fTreeD->Branch("fpxDaughter3UnProp", &fpxDaughter3UnProp, "fpxDaughter3UnProp/D");
	fTreeD->Branch("fpyDaughter3UnProp", &fpyDaughter3UnProp, "fpyDaughter3UnProp/D");
	fTreeD->Branch("fpzDaughter3UnProp", &fpzDaughter3UnProp, "fpzDaughter3UnProp/D");
	...
	fTreeKF->Branch("fTriggerString", &fTriggerString, "fTriggerString/C");
	...
	gTree->Branch("fTriggerString", &fTriggerString, "fTriggerString/C");
	...
	gTreeD->Branch("fTrackPIDDaughter", &fTrackPIDDaughter, "fTrackPIDDaughter/I");
	gTreeD->Branch("fLabelDaughterKF", &fLabelDaughterKF, "fLabelDaughterKF/D");
	gTreeD->Branch("fpDaughter", &fpDaughter, "fpDaughter/D");
	gTreeD->Branch("fptDaughterUnProp", &fptDaughterUnProp, "fptDaughterUnProp/D");
	gTreeD->Branch("fpxDaughterUnProp", &fpxDaughterUnProp, "fpxDaughterUnProp/D");
	gTreeD->Branch("fpyDaughterUnProp", &fpyDaughterUnProp, "fpyDaughterUnProp/D");
	gTreeD->Branch("fpzDaughterUnProp", &fpzDaughterUnProp, "fpzDaughterUnProp/D");
	...
	gTreeD->Branch("fTrackPIDDaughter1", &fTrackPIDDaughter1, "fTrackPIDDaughter1/I");
	gTreeD->Branch("fLabelDaughter1KF", &fLabelDaughter1KF, "fLabelDaughter1KF/D");
	gTreeD->Branch("fpDaughter1", &fpDaughter1, "fpDaughter1/D");
	gTreeD->Branch("fptDaughter1UnProp", &fptDaughter1UnProp, "fptDaughter1UnProp/D");
	gTreeD->Branch("fpxDaughter1UnProp", &fpxDaughter1UnProp, "fpxDaughter1UnProp/D");
	gTreeD->Branch("fpyDaughter1UnProp", &fpyDaughter1UnProp, "fpyDaughter1UnProp/D");
	gTreeD->Branch("fpzDaughter1UnProp", &fpzDaughter1UnProp, "fpzDaughter1UnProp/D");
	...
	gTreeD->Branch("fTrackPIDDaughter2", &fTrackPIDDaughter2, "fTrackPIDDaughter2/I");
	gTreeD->Branch("fLabelDaughter2KF", &fLabelDaughter2KF, "fLabelDaughter2KF/D");
	gTreeD->Branch("fpDaughter2", &fpDaughter2, "fpDaughter2/D");
	gTreeD->Branch("fptDaughter2UnProp", &fptDaughter2UnProp, "fptDaughter2UnProp/D");
	gTreeD->Branch("fpxDaughter2UnProp", &fpxDaughter2UnProp, "fpxDaughter2UnProp/D");
	gTreeD->Branch("fpyDaughter2UnProp", &fpyDaughter2UnProp, "fpyDaughter2UnProp/D");
	gTreeD->Branch("fpzDaughter2UnProp", &fpzDaughter2UnProp, "fpzDaughter2UnProp/D");
	...
	gTreeKF->Branch("fTriggerString", &fTriggerString, "fTriggerString/C");
	...
	hTree->Branch("fTriggerString", &fTriggerString, "fTriggerString/C");
	...
	hTreeKF->Branch("fTriggerString", &fTriggerString, "fTriggerString/C");
...
void AliAnalysisTaskDoubleHypNucTree::UserExec(Option_t*) {
	...
	fTriggerString = fESDevent->GetFiredTriggerClasses();
	...
	if (!fisWOTrackVertex) fHistNtracks1->Fill(fESDevent->GetNumberOfTracks());
	if (fisWOTrackVertex) fHistNtracks2->Fill(fESDevent->GetNumberOfTracks());
...
void AliAnalysisTaskDoubleHypNucTree::InitArrays() {
	...
	kMin4LHMass = 3.88;//3.924 - nsigma * 0.003;
	kMax4LHMass = 4.00;//3.924 + nsigma * 0.003;
...
void AliAnalysisTaskDoubleHypNucTree::FindTracks() {
	...
	for (Int_t qTracks = 0; qTracks < nTracksEvent; qTracks++) {
		...
		if (!fMCtrue) {
			...
			if (trackq->GetSign() > 0) {
				if (TMath::Abs(AliAnalysisTaskDoubleHypNucTree::Bethe(*trackq, AliPID::ParticleMass(AliPID::kAlpha), 2, fBetheParamsHe)) <= kPIDSelecCut) {
		...
		if (fMCtrue) {
			...
			if (trackq->GetSign() > 0) {
				...
				if (tparticle->PdgCode() == fgkPdgCode[kPDGHelium4]) {
					if ((kMCPIDCheck && TMath::Abs(fPID->NumberOfSigmasTPC(trackq, AliPID::kAlpha)) <= kPIDSelecCut) || !kMCPIDCheck) {
						if (!CustomTrackCut(*trackq, 1)) continue;
						He4PosArray.push_back(qTracks);
						He4PosCounter++;
					}
			...
			if (trackq->GetSign() < 0) {
				...
				if (tparticle->PdgCode() == fgkPdgCode[kPDGAntiHelium4]) {
					if ((kMCPIDCheck && TMath::Abs(fPID->NumberOfSigmasTPC(trackq, AliPID::kAlpha)) <= kPIDSelecCut) || !kMCPIDCheck) {
						if (!CustomTrackCut(*trackq, 1)) continue;
						He4NegArray.push_back(qTracks);
						He4NegCounter++;
...
void AliAnalysisTaskDoubleHypNucTree::CalcPosDaughterHypNuc() {
		...
		for (const Int_t& PPosTracks : PPosArray) {
			...
			for (const Int_t& PiNegTracks : PiNegArray) {
				...
				*sublorentzsum = *particle1 + *particle2 + *particle3;
				...
				int status_KFreco = 0;
				if (kKFReco) status_KFreco = AliAnalysisTaskDoubleHypNucTree::KFReconstruction("4LHe", 1, 1);//1 = 4LHe, 2 = 3LH, 3 = 3LH (tert check, 4LHe), 4 = 3LH (sec check), 5 = Lambda (tert check), 6 = Lambda (sec check), 7 = Lambda (4LHe), 8 = 4LH 2B
				...
				if (kStandardReco) status_standardreco = AliAnalysisTaskDoubleHypNucTree::StandardReconstruction("4LHe", 1, 1);//1 = 4LHe, 2 = 3LH, 3 = 3LH (tert check, 4LHe), 4 = 3LH (sec check), 5 = Lambda (tert check), 6 = Lambda (sec check), 7 = Lambda (4LHe), 8 = 4LH 2B
		...
		for (const Int_t& He3PosTracks : He3PosArray) {
			...
			for (const Int_t& PiNegTracks : PiNegArray) {
				...
				*sublorentzsum = *particle1 + *particle3;
				...
				// __ vertex reconstruction with KF method __ //
				int status_KFreco = 0;
				if (kKFReco) status_KFreco = AliAnalysisTaskDoubleHypNucTree::KFReconstruction("3LH", 2, 1);//1 = 4LHe, 2 = 3LH, 3 = 3LH (tert check, 4LHe), 4 = 3LH (sec check), 5 = Lambda (tert check), 6 = Lambda (sec check), 7 = Lambda (4LHe), 8 = 4LH 2B
				if (status_KFreco) {
				...
				// __ standard vertex reconstruction __ //
				int status_standardreco = 0;
				if (kStandardReco) status_standardreco = AliAnalysisTaskDoubleHypNucTree::StandardReconstruction("3LH", 2, 1);//1 = 4LHe, 2 = 3LH, 3 = 3LH (tert check, 4LHe), 4 = 3LH (sec check), 5 = Lambda (tert check), 6 = Lambda (sec check), 7 = Lambda (4LHe), 8 = 4LH 2B
				if (status_standardreco) {
					fParticleID = TMath::Abs(fEventID) + He3PosTracks + PiNegTracks;
					if (fMCtrue) fParticleID = fParticleID * (labelMother1 - label1);
					gTree->Fill();
	...
	if (!kSkip4LHAnalysis) {
		...
		for (const Int_t& He4PosTracks : He4PosArray) {
			...
			track1 = dynamic_cast<AliESDtrack*>(fESDevent->GetTrack(He4PosTracks));
			exTrack1->CopyFromVTrack(track1);
			// __ MC part __ //
			if (fMCtrue && konlySig) {
				...
				ParticleMother1 = new AliMCParticle(mcEvent->GetTrack(TMath::Abs(labelMother1))->Particle());
				if (ParticleMother1->PdgCode() != fgkPdgCode[kPDGHyperHydrogen4]) continue;
				if (ParticleMother1) delete ParticleMother1;
			}
			// __ set pxpypz __ //
			particle1->SetXYZM(0., 0., 0., 0.);
			...
			for (const Int_t& PiNegTracks : PiNegArray) {
				...
				if (fMCtrue && konlySig) {
					...
					ParticleMother3 = new AliMCParticle(mcEvent->GetTrack(TMath::Abs(labelMother3))->Particle());
					if (ParticleMother3->PdgCode() != fgkPdgCode[kPDGHyperHydrogen4]) continue;
					if (ParticleMother3) delete ParticleMother3;
				}
				// __ dca rejection __ //
				if (exTrack1->GetDCA(exTrack3, kMagF, xthiss, xpp) > kDCATracksCut) continue;
				...
				*sublorentzsum = *particle1 + *particle3;
				...
				// __ vertex reconstruction with KF method __ //
				int status_KFreco = 0;
				if (kKFReco) status_KFreco = AliAnalysisTaskDoubleHypNucTree::KFReconstruction("4LH", 8, 1);//1 = 4LHe, 2 = 3LH, 3 = 3LH (tert check, 4LHe), 4 = 3LH (sec check), 5 = Lambda (tert check), 6 = Lambda (sec check), 7 = Lambda (4LHe), 8 = 4LH 2B
				if (status_KFreco) {
					fParticleID = TMath::Abs(fEventID) + He3PosTracks + PiNegTracks;
					if (fMCtrue) fParticleID = fParticleID * (labelMother1 - label1);
					gTreeKF->Fill();
				...
				// __ standard vertex reconstruction __ //
				int status_standardreco = 0;
				if (kStandardReco) status_standardreco = AliAnalysisTaskDoubleHypNucTree::StandardReconstruction("4LH", 8, 1);//1 = 4LHe, 2 = 3LH, 3 = 3LH (tert check, 4LHe), 4 = 3LH (sec check), 5 = Lambda (tert check), 6 = Lambda (sec check), 7 = Lambda (4LHe), 8 = 4LH 2B 
				if (status_standardreco) {
					fParticleID = TMath::Abs(fEventID) + He3PosTracks + PiNegTracks;
					if (fMCtrue) fParticleID = fParticleID * (labelMother1 - label1);
					gTree->Fill();
...
void AliAnalysisTaskDoubleHypNucTree::CalcNegDaughterHypNuc() {
	...
	if (!kSkip4LHAnalysis) {
		...
		for (const Int_t& He4NegTracks : He4NegArray) {
			...
			track1 = dynamic_cast<AliESDtrack*>(fESDevent->GetTrack(He4NegTracks));
			exTrack1->CopyFromVTrack(track1);
			// __ MC part __ //
			if (fMCtrue && konlySig) {
				...
				ParticleMother1 = new AliMCParticle(mcEvent->GetTrack(TMath::Abs(labelMother1))->Particle());
				if (ParticleMother1->PdgCode() != fgkPdgCode[kPDGAntiHyperHydrogen4]) continue;
				if (ParticleMother1) delete ParticleMother1;
			}
			// __ set pxpypz __ //
			particle1->SetXYZM(0., 0., 0., 0.);
			...
			for (const Int_t& PiPosTracks : PiPosArray) {
				...
				// __ reject using same track twice __ //
				if (He4NegArray == PiPosTracks) continue;
				...
				if (fMCtrue && konlySig) {
					...
					ParticleMother3 = new AliMCParticle(mcEvent->GetTrack(TMath::Abs(labelMother3))->Particle());
					if (ParticleMother3->PdgCode() != fgkPdgCode[kPDGAntiHyperHydrogen4]) continue;
					if (ParticleMother3) delete ParticleMother3;
				}
				// __ dca rejection __ //
				if (exTrack1->GetDCA(exTrack3, kMagF, xthiss, xpp) > kDCATracksCut) continue;
...
Int_t AliAnalysisTaskDoubleHypNucTree::StandardReconstruction(TString Mother, Int_t kDecayChannel, Int_t ksign) {
	...
	if (Mother == "3LH") {
		...
		*sublorentzsum = *particle1 + *particle3;
		...
		if (kDecayChannel == 2) AliAnalysisTaskDoubleHypNucTree::SetDaughterInformation("3LH", kDecayChannel);
		// _________________________________________________ //	  	
	...
	// _________________________________ //      
		...
		*sublorentzsum = *particle1 + *particle3;
		...
		// _________________________________________________ //
		// __ track information __ //
		AliAnalysisTaskDoubleHypNucTree::SetDaughterInformation("4LH", kDecayChannel);
		// _________________________________________________ //	  	
		// __ daughter hypernucleus information __ //
	...
	// _________________________________ //      
		...
		*sublorentzsum = *particle1 + *particle2 + *particle3;
		...
		// _________________________________________________ //
		// __ track information __ //
		AliAnalysisTaskDoubleHypNucTree::SetDaughterInformation("4LHe", kDecayChannel);
		// _________________________________________________ //	  	
		// __ daughter hypernucleus information __ //
...
Int_t AliAnalysisTaskDoubleHypNucTree::KFReconstruction(TString Mother, Int_t kDecayChannel, Int_t ksign) {
	...
	// _________________________________________________ //
		...
		exTrack1->CopyFromVTrack(track1);
		exTrack3->CopyFromVTrack(track3);
		KFtrack1 = AliAnalysisTaskDoubleHypNucTree::CreateKFParticle(*exTrack1, AliPID::ParticleMass(AliPID::kAlpha), 2);
		KFtrack3 = AliAnalysisTaskDoubleHypNucTree::CreateKFParticle(*exTrack3, AliPID::ParticleMass(AliPID::kPion), 1);
		// __ construct mother particle __ //
		checkval = 1;
		KFParticleHypNuc KFChecktrack3;
...
void AliAnalysisTaskDoubleHypNucTree::SetDaughterInformation(TString Mother, Int_t kDecayChannel) {
	...
	Float_t xv[2], yv[3];
	AliMCParticle* part;
	if (Mother == "4LHe" || Mother == "4LLH" || Mother == "3LH" || Mother == "4LH") {
		// _________________________________ //
		// __ He3 track __ //
		...
		if (Mother != "4LH") {
			...
			fdEdxSigmaDaughter = AliAnalysisTaskDoubleHypNucTree::Bethe(*track1, AliPID::ParticleMass(AliPID::kAlpha), 2, fBetheParamsHe);
			if (fMCtrue) fdEdxSigmaDaughter = fPID->NumberOfSigmasTPC(track1, AliPID::kAlpha);
			fdEdxSigmaTriton = AliAnalysisTaskDoubleHypNucTree::Bethe(*track1, AliPID::ParticleMass(AliPID::kTriton), 1, fBetheParamsT);
			fdEdxSigmaAlpha = AliAnalysisTaskDoubleHypNucTree::Bethe(*track1, AliPID::ParticleMass(AliPID::kHe3), 2, fBetheParamsHe);
		}
