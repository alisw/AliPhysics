...
#ifndef ALIANALYSISTASKDOUBLEHYPNUCTREELS_H
#define ALIANALYSISTASKDOUBLEHYPNUCTREELS_H
...
class KFParticleHypNuc;

using namespace std;
// _________________________________________________ //
class AliAnalysisTaskDoubleHypNucTreeLS : public AliAnalysisTaskSE {
public:
  AliAnalysisTaskDoubleHypNucTreeLS();
  AliAnalysisTaskDoubleHypNucTreeLS(const char *name);
  virtual ~AliAnalysisTaskDoubleHypNucTreeLS();
...
private:
  ...
  //
  AliAnalysisTaskDoubleHypNucTreeLS(const AliAnalysisTaskDoubleHypNucTreeLS&);
  AliAnalysisTaskDoubleHypNucTreeLS &operator=(const AliAnalysisTaskDoubleHypNucTreeLS&);

  /// \cond CLASSIMP
  ClassDef(AliAnalysisTaskDoubleHypNucTreeLS, 1);
  /// \endcond
};
#endif
