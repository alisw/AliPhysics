...
///////////////////////////////////////////////////////////////////////////
// AliAnalysisTaskHypertriton3New class
...
ClassImp(AliAnalysisTaskHypertriton3New)

    using std::cout;
using std::endl;

//________________________________________________________________________
AliAnalysisTaskHypertriton3New::AliAnalysisTaskHypertriton3New()
    : AliAnalysisTaskSE(),
      // parameter settings
      fIsMC{0}, fNSigma{0., 0., 0.},
      // support objects
      fESDevent{nullptr}, fEventCuts{}, fTrackCuts{nullptr}, fPrimaryVertex{nullptr}, fPIDResponse{nullptr},
      fMagneticField{0.0},
      // setting parameters
      fCosPoiningAngleLimit{0},
      // output objects
      fMInvBackgroundStd{nullptr}, fMInvBackgroundCuts{nullptr}, fHistCosPAngle{nullptr}, fOutputList{nullptr} {
  // Constructor
}

//________________________________________________________________________
AliAnalysisTaskHypertriton3New::AliAnalysisTaskHypertriton3New(bool isMC, TString taskname)
...
//________________________________________________________________________
void AliAnalysisTaskHypertriton3New::UserCreateOutputObjects() {
...
//________________________________________________________________________
void AliAnalysisTaskHypertriton3New::UserExec(Option_t *) {
...
//________________________________________________________________________
void AliAnalysisTaskHypertriton3New::Terminate(Option_t *) {
  // Merge output
...
//________________________________________________________________________
bool AliAnalysisTaskHypertriton3New::PassPIDSelection(AliESDtrack *track, AliPID::EParticleType specie,
                                                      float nSigmaCut) {
