AliAnalysisCODEXS3task* AddCODEXS3task (TString tskname = "AliCODEXS3", TString suffix = "") {
  ...
  AliAnalysisCODEXS3task* task = new AliAnalysisCODEXS3task(tskname.Data());
  
  UInt_t triggerMask = AliVEvent::kTRD | AliVEvent::kHighMultV0 | AliVEvent::kHighMultSPD;
