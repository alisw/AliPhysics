...
#include <Rtypes.h>
#include <TString.h>
#include "AliAnalysisTaskHypertriton3Dev.h"
...
AliAnalysisTaskHypertriton3Dev *AddTaskHypertriton3Dev(Bool_t readMC=kFALSE,
  ...
  //==============================================================================
  ::Info("AddTaskHypertriton3Dev","Adding a new task with this settings readMC = %i",readMC);
  ...
  AliAnalysisTaskHypertriton3Dev *taskhyp = new AliAnalysisTaskHypertriton3Dev();
  ...
  coutput = mgr->CreateContainer(Form("hyper3dev_%s",tskname.Data()),
				 TList::Class(),
  ...
  if(fillTree){
    AliAnalysisDataContainer *coutput2 = mgr->CreateContainer("HyperTree", TTree::Class(),
							      AliAnalysisManager::kOutputContainer,
							      AliAnalysisManager::GetCommonFileName());   
