...
//   reducedTree_Helium -> Branch("Ntrk_SPDClusters",&Ntrk_SPDClusters,"Ntrk_SPDClusters/I"); //NOT FILLED FOR LHC16q (p--Pb)
   ...
   reducedTree_Helium -> Branch("HasPointOnITSLayer0",&HasPointOnITSLayer0,"HasPointOnITSLayer0/I");
   reducedTree_Helium -> Branch("HasPointOnITSLayer1",&HasPointOnITSLayer1,"HasPointOnITSLayer1/I");
   reducedTree_Helium -> Branch("HasPointOnITSLayer2",&HasPointOnITSLayer2,"HasPointOnITSLayer2/I");
   reducedTree_Helium -> Branch("HasPointOnITSLayer3",&HasPointOnITSLayer3,"HasPointOnITSLayer3/I");
   reducedTree_Helium -> Branch("HasPointOnITSLayer4",&HasPointOnITSLayer4,"HasPointOnITSLayer4/I");
   reducedTree_Helium -> Branch("HasPointOnITSLayer5",&HasPointOnITSLayer5,"HasPointOnITSLayer5/I");
   reducedTree_Helium -> Branch("HasSharedPointOnITSLayer0",&HasSharedPointOnITSLayer0,"HasSharedPointOnITSLayer0/I");
   reducedTree_Helium -> Branch("HasSharedPointOnITSLayer1",&HasSharedPointOnITSLayer1,"HasSharedPointOnITSLayer1/I");
   reducedTree_Helium -> Branch("HasSharedPointOnITSLayer2",&HasSharedPointOnITSLayer2,"HasSharedPointOnITSLayer2/I");
   reducedTree_Helium -> Branch("HasSharedPointOnITSLayer3",&HasSharedPointOnITSLayer3,"HasSharedPointOnITSLayer3/I");
   reducedTree_Helium -> Branch("HasSharedPointOnITSLayer4",&HasSharedPointOnITSLayer4,"HasSharedPointOnITSLayer4/I");
   reducedTree_Helium -> Branch("HasSharedPointOnITSLayer5",&HasSharedPointOnITSLayer5,"HasSharedPointOnITSLayer5/I");
...
void AliAnalysisTaskReducedTreeNuclei::UserExec(Option_t *)
{
   ...
   for (Int_t i=0 ; i<fAODevent->GetNumberOfTracks() ; i++)  {
      ...
      if (track->HasSharedPointOnITSLayer(0)) HasSharedPointOnITSLayer0 = 1;
      if (track->HasSharedPointOnITSLayer(1)) HasSharedPointOnITSLayer1 = 1;
      if (track->HasSharedPointOnITSLayer(2)) HasSharedPointOnITSLayer2 = 1;
      if (track->HasSharedPointOnITSLayer(3)) HasSharedPointOnITSLayer3 = 1;
      if (track->HasSharedPointOnITSLayer(4)) HasSharedPointOnITSLayer4 = 1;
      if (track->HasSharedPointOnITSLayer(5)) HasSharedPointOnITSLayer5 = 1;
   ...
   for ( Int_t iV0=0 ; iV0<fAODevent->GetNumberOfV0s() ; iV0++ ) {
      ...
      if (posTrack->HasPointOnITSLayer(0)) HasPointOnITSLayer0_Daughter1 = 1;
      if (posTrack->HasPointOnITSLayer(1)) HasPointOnITSLayer1_Daughter1 = 1;
      if (posTrack->HasPointOnITSLayer(2)) HasPointOnITSLayer2_Daughter1 = 1;
      if (posTrack->HasPointOnITSLayer(3)) HasPointOnITSLayer3_Daughter1 = 1;
      if (posTrack->HasPointOnITSLayer(4)) HasPointOnITSLayer4_Daughter1 = 1;
      if (posTrack->HasPointOnITSLayer(5)) HasPointOnITSLayer5_Daughter1 = 1;

      if (posTrack->HasSharedPointOnITSLayer(0)) HasSharedPointOnITSLayer0_Daughter1 = 1;
      if (posTrack->HasSharedPointOnITSLayer(1)) HasSharedPointOnITSLayer1_Daughter1 = 1;
      if (posTrack->HasSharedPointOnITSLayer(2)) HasSharedPointOnITSLayer2_Daughter1 = 1;
      if (posTrack->HasSharedPointOnITSLayer(3)) HasSharedPointOnITSLayer3_Daughter1 = 1;
      if (posTrack->HasSharedPointOnITSLayer(4)) HasSharedPointOnITSLayer4_Daughter1 = 1;
      if (posTrack->HasSharedPointOnITSLayer(5)) HasSharedPointOnITSLayer5_Daughter1 = 1;
      ...
      if (negTrack->HasPointOnITSLayer(0)) HasPointOnITSLayer0_Daughter2 = 1;
      if (negTrack->HasPointOnITSLayer(1)) HasPointOnITSLayer1_Daughter2 = 1;
      if (negTrack->HasPointOnITSLayer(2)) HasPointOnITSLayer2_Daughter2 = 1;
      if (negTrack->HasPointOnITSLayer(3)) HasPointOnITSLayer3_Daughter2 = 1;
      if (negTrack->HasPointOnITSLayer(4)) HasPointOnITSLayer4_Daughter2 = 1;
      if (negTrack->HasPointOnITSLayer(5)) HasPointOnITSLayer5_Daughter2 = 1;

      if (negTrack->HasSharedPointOnITSLayer(0)) HasSharedPointOnITSLayer0_Daughter2 = 1;
      if (negTrack->HasSharedPointOnITSLayer(1)) HasSharedPointOnITSLayer1_Daughter2 = 1;
      if (negTrack->HasSharedPointOnITSLayer(2)) HasSharedPointOnITSLayer2_Daughter2 = 1;
      if (negTrack->HasSharedPointOnITSLayer(3)) HasSharedPointOnITSLayer3_Daughter2 = 1;
      if (negTrack->HasSharedPointOnITSLayer(4)) HasSharedPointOnITSLayer4_Daughter2 = 1;
      if (negTrack->HasSharedPointOnITSLayer(5)) HasSharedPointOnITSLayer5_Daughter2 = 1;
...
Bool_t AliAnalysisTaskReducedTreeNuclei::GetInputEvent ()  {
   ...
   //   yVertex = vertex->GetY();
   //   zVertex = vertex->GetZ();
   //   nVertexContributors = vertex->GetNContributors();
   //
   //   if ( TMath::Abs(zVertex) > 10.0 ) return false;
...
Double_t AliAnalysisTaskReducedTreeNuclei::GetDCAz (AliAODTrack *track)  {
   ...
   /*
    ...
    Double_t DCAz = TMath::Abs(pos[2] - v[2]);
