#ifndef AliAnalysisTaskHe3_cxx
#define AliAnalysisTaskHe3_cxx
...
public:
	AliAnalysisTaskHe3();
	AliAnalysisTaskHe3(const char *name);
	virtual ~AliAnalysisTaskHe3();
...
private:
	...
	AliAnalysisTaskHe3(const AliAnalysisTaskHe3&); // not implemented
	AliAnalysisTaskHe3& operator=(const AliAnalysisTaskHe3&); // not implemented
    
	ClassDef(AliAnalysisTaskHe3, 1);
};
