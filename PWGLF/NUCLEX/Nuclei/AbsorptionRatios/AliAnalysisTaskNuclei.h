...
public:
  ...
  void SetfYlimitFlag(Float_t ylimit) { fYlimit = ylimit; }//somehow this doesn't actually set the limit. Unsure why. It is now set in the constructor. 
  ...
  void SetCentralityFramework(int centralityFramework) { fEventCut.fCentralityFramework = centralityFramework; }
...
private:
  ...
  Float_t fYlimit; //!switch for rapidity cut
