AliAnalysisTaskHe3_ESD* AddHighMultHe3Task_ESD(TString name = "name", ULong64_t triggerMask = AliVEvent::kHighMultV0)
{
    ...
    AliAnalysisTaskHe3_ESD* task = new AliAnalysisTaskHe3_ESD(name.Data());   
    if(!task) return 0x0;
	...
	trackCuts->SetMinNClustersITS(1);//This seems very high?
