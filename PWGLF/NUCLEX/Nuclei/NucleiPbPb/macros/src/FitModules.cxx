...
FitGausGaus::FitGausGaus(RooRealVar *x, bool extended_likelihood) : FitModule(x, extended_likelihood){
  ...
  mTemplate = (mExtended) ? std::make_unique<RooAddPdf>("mTemplate","Template",RooArgList(*mSignal,*mBackground),
                                     RooArgList(*mSigCounts,*mBkgCounts)) : std::make_unique<RooAddPdf>("mTemplate","Template",RooArgList(*mSignal,*mBackground),
