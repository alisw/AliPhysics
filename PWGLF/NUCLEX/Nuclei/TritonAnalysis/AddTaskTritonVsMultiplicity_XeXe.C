...
AliAnalysisTask *AddTaskTritonVsMultiplicity_XeXe(unsigned long fTriggerMask, Double_t CentralityMin, Double_t CentralityMax, Double_t VertexZmin, Double_t VertexZmax, Int_t NumberOfVertexContributorsMin, const char *CentralityEstimator, Double_t PtMin, Double_t PtMax, Double_t EtaMax, Double_t YMax, Int_t NumberClustersITSMin, Int_t NumberClustersTPCMin, Int_t NumberCrossedRowsTPCMin, Double_t CrossedRowsFindableClsMin, Int_t NumberClustersTPCdEdxMin, Double_t ChiSquarePerNDFMax, const char *ITSrequirement, Double_t DCAzMax, Double_t DCAxyMax, Double_t nSigmaTOFmax, Double_t nSigmaTPCmax, Int_t TRDntracklets, Double_t par0_mean_TPC, Double_t par1_mean_TPC, Double_t par0_sigma_TPC, Double_t par0_mean_TOF, Double_t par1_mean_TOF, Double_t par0_sigma_TOF, Double_t par1_sigma_TOF )  {

  //Get the current analysis manager
  AliAnalysisManager *mgr = AliAnalysisManager::GetAnalysisManager();
  if (!mgr) {
    Error("AddTaskTritonVsMultiplicity_XeXe","No analysis manager found.");
    return 0;
  }
  ...
  if (!mgr->GetInputEventHandler()) {
    ::Error("AddTaskTritonVsMultiplicity_XeXe", "This task requires an input event handler");
    return NULL;
  }
  ...
  //Analysis Task
    AliAnalysisTaskTritonVsMultiplicity_XeXe *task = new AliAnalysisTaskTritonVsMultiplicity_XeXe ("task");
