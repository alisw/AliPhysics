#ifndef AliAnalysisTaskDeuteronVsMultiplicity_XeXe_cxx
#define AliAnalysisTaskDeuteronVsMultiplicity_XeXe_cxx
...
class AliAnalysisTaskDeuteronVsMultiplicity_XeXe : public AliAnalysisTaskSE {

public:
    AliAnalysisTaskDeuteronVsMultiplicity_XeXe();
    AliAnalysisTaskDeuteronVsMultiplicity_XeXe(const char *name);
    virtual ~AliAnalysisTaskDeuteronVsMultiplicity_XeXe();
    ...
    Bool_t      IsCleanDeuteronCandidate         (AliAODTrack *track);
...
private:
    ...
    TH2F        *histoNsigmaTPCDeuteron_vs_pt;//!
    TH2F        *histoNsigmaTOFDeuteron_vs_pt;//!

    TH2F        *histoNsigmaTPCantiDeuteron_vs_pt;//!
    TH2F        *histoNsigmaTOFantiDeuteron_vs_pt;//!

    TH2F        *histoNsigmaTPCDeuteron_vs_pt_centered;//!
    TH2F        *histoNsigmaTPCantiDeuteron_vs_pt_centered;//!

    TH2F        *histoNsigmaTOFDeuteron_vs_pt_centered;//!
    TH2F        *histoNsigmaTOFantiDeuteron_vs_pt_centered;//!

    TH2F        *histoDCAxyDeuteron_vs_pt;//!
    TH2F        *histoDCAxyAntiDeuteron_vs_pt;//!

    TH2F        *histoNsigmaTOFDeuteron_vs_pt_trd;//!
    TH2F        *histoNsigmaTOFantiDeuteron_vs_pt_trd;//!

    TH2F        *histoNsigmaTPCDeuteron_vs_p;//!
    TH2F        *histoNsigmaTPCantiDeuteron_vs_p;//!

    TH2F        *histoNsigmaTOFDeuteron_vs_p;//!
    TH2F        *histoNsigmaTOFantiDeuteron_vs_p;//!

    TH2F        *histoNsigmaTPCDeuteron_vs_p_notof;//!
    TH2F        *histoNsigmaTPCantiDeuteron_vs_p_notof;//!

    //Reduced Trees
    TTree *reducedTree_Deuteron;//!
    ...
    AliAnalysisTaskDeuteronVsMultiplicity_XeXe(const AliAnalysisTaskDeuteronVsMultiplicity_XeXe&);
    AliAnalysisTaskDeuteronVsMultiplicity_XeXe& operator=(const AliAnalysisTaskDeuteronVsMultiplicity_XeXe&);
    ClassDef(AliAnalysisTaskDeuteronVsMultiplicity_XeXe, 1);
