#ifndef   AliAnalysisTaskDeuteron_XeXe_MC_cxx
#define   AliAnalysisTaskDeuteron_XeXe_MC_cxx
...
class AliAnalysisTaskDeuteron_XeXe_MC : public AliAnalysisTaskSE {

public:
    AliAnalysisTaskDeuteron_XeXe_MC();
    AliAnalysisTaskDeuteron_XeXe_MC(const char *name);
    virtual ~AliAnalysisTaskDeuteron_XeXe_MC();
...
private:
    ...
    AliAnalysisTaskDeuteron_XeXe_MC(const AliAnalysisTaskDeuteron_XeXe_MC&);
    AliAnalysisTaskDeuteron_XeXe_MC& operator=(const AliAnalysisTaskDeuteron_XeXe_MC&);
    ClassDef(AliAnalysisTaskDeuteron_XeXe_MC, 1);
};
#endif
