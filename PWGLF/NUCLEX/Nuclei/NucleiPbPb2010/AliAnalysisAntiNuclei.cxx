...
#include "AliAnalysisAntiNuclei.h"


ClassImp(AliAnalysisAntiNuclei)

//________________________________________________________________________
AliAnalysisAntiNuclei::AliAnalysisAntiNuclei() 
  ...
  fHistEtaPtGen(0)
{
  ...
  /* fast compilation test
     ...
     .L AliAnalysisAntiNuclei.cxx++
   */
}


//________________________________________________________________________
AliAnalysisAntiNuclei::AliAnalysisAntiNuclei(const char *name) 
...
//________________________________________________________________________
void AliAnalysisAntiNuclei::Initialize()
{
  //
...
//________________________________________________________________________
void AliAnalysisAntiNuclei::UserCreateOutputObjects() 
{
  // Create histograms
  // Called once
  fListHist = new TList();
...
//________________________________________________________________________
void AliAnalysisAntiNuclei::UserExec(Option_t *) 
{
  //
  // main event loop
  //
...
//________________________________________________________________________
void AliAnalysisAntiNuclei::Terminate(Option_t *) 
{
...
//________________________________________________________________________
void AliAnalysisAntiNuclei::BinLogAxis(const TH1 *h) {
  //
