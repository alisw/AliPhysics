...
AliAnalysisTaskPythiaCoalescence *addTaskPythiaCoalescence (Double_t Nch_Transv=7.295, Int_t iShift=0)  {
    ...
    //Analysis Task
    AliAnalysisTaskPythiaCoalescence *task = new AliAnalysisTaskPythiaCoalescence ("task_deuteron_coalescence");
    task -> AliAnalysisTaskPythiaCoalescence::SetAverageTransverseMultiplicity(Nch_Transv);
    task -> AliAnalysisTaskPythiaCoalescence::SetReshapingProtons (hProtWeights,fProtWeights);
    task -> AliAnalysisTaskPythiaCoalescence::SetReshapingProtonsDiff (hWeight_toward,hWeight_transv,hWeight_away);
    task -> AliAnalysisTaskPythiaCoalescence::SetDeuteronWaveFunc (fDeuteronWF);
    task -> AliAnalysisTaskPythiaCoalescence::SetSourceSizeRadius (hSourceR0);
    mgr -> AddTask(task);
