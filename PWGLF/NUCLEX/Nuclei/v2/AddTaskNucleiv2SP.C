...
AliAnalysisTask *AddTaskNucleiv2SP(TString name="name",Int_t ptctype =1,Bool_t dcacut = kFALSE, Float_t vzmax=10., TString CentEstim = "V0M", TString AnalysisType = "ESD", Bool_t isFlat = kTRUE, Int_t year = 2011){
