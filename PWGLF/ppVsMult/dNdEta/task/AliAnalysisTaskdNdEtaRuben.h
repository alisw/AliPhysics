#ifndef AliAnalysisTaskdNdEtaRuben_H
#define AliAnalysisTaskdNdEtaRuben_H
...
class AliAnalysisTaskdNdEtaRuben : public AliAnalysisTaskSE {
 public:
  ...
  //
  AliAnalysisTaskdNdEtaRuben(const char *name = "AliAnalysisTaskdNdEtaRuben");
  virtual ~AliAnalysisTaskdNdEtaRuben(); 
 ...
 private:    
  AliAnalysisTaskdNdEtaRuben(const AliAnalysisTaskdNdEtaRuben&); // not implemented
  AliAnalysisTaskdNdEtaRuben& operator=(const AliAnalysisTaskdNdEtaRuben&); // not implemented 
  
  ClassDef(AliAnalysisTaskdNdEtaRuben, 1);  
};
