...
void MultYields2QA(TH2F *hParMass, Int_t particleMode, Int_t ihist,Int_t Nev = 1, Int_t MultBin, Char_t* label){
  ...
  if(particleMode == 1 || particleMode == 3){ // Lambda or Lambda+Anti-Lambda
    if(ihist ==0){
      ...
      //	     controllerArray->AddLast(new AliMassFitControl(0.5,0.6, 2,2, 1.095,1.17)); //4
            controllerArray->AddLast(new AliMassFitControl(0.6,0.7, 1,2, 1.1,1.14)); //5    //1
       controllerArray->AddLast(new AliMassFitControl(0.7,0.8, 2,2, 1.099,1.14)); //6        //2
       controllerArray->AddLast(new AliMassFitControl(0.8,0.9, 2,2, 1.097,1.14)); //7        //3
       controllerArray->AddLast(new AliMassFitControl(0.9,1.0, 2,2, 1.096,1.144)); //1   //4
      controllerArray->AddLast(new AliMassFitControl(1.0,1.1, 2,2, 1.095,1.14)); //2         //5
      controllerArray->AddLast(new AliMassFitControl(1.1,1.2, 2,2, 1.099,1.14)); //3         //6
      controllerArray->AddLast(new AliMassFitControl(1.2,1.3, 2,2, 1.099,1.14)); //4         //7
      controllerArray->AddLast(new AliMassFitControl(1.3,1.4, 2,2, 1.099,1.14)); //5         //8
      controllerArray->AddLast(new AliMassFitControl(1.4,1.5, 2,2, 1.095,1.14)); //6         //9
      controllerArray->AddLast(new AliMassFitControl(1.5,1.6, 2,2, 1.095,1.14)); //7        //10
      controllerArray->AddLast(new AliMassFitControl(1.6,1.7, 2,2, 1.095,1.152)); //8        //11
      controllerArray->AddLast(new AliMassFitControl(1.7,1.8, 2,2, 1.096,1.143)); //9        //12
      controllerArray->AddLast(new AliMassFitControl(1.8,1.9, 2,2, 1.098,1.143)); //10       //13
      controllerArray->AddLast(new AliMassFitControl(1.9,2.0, 2,2, 1.098,1.143)); //11       //14
      controllerArray->AddLast(new AliMassFitControl(2.0,2.2, 2,2, 1.098,1.16)); //12        //15
      controllerArray->AddLast(new AliMassFitControl(2.2,2.4, 2,2, 1.095,1.16)); //13        //16
      controllerArray->AddLast(new AliMassFitControl(2.4,2.6, 2,2, 1.095,1.17)); //14       //17
      controllerArray->AddLast(new AliMassFitControl(2.6,2.8, 2,2, 1.095,1.17)); //15        //18
      controllerArray->AddLast(new AliMassFitControl(2.8,3.0, 2,2, 1.095,1.16)); //16        //19
      controllerArray->AddLast(new AliMassFitControl(3.0,3.2, 2,2, 1.095,1.16)); //17
      controllerArray->AddLast(new AliMassFitControl(3.2,3.4, 2,2, 1.095,1.17)); //18
      controllerArray->AddLast(new AliMassFitControl(3.4,3.6, 2,2, 1.094,1.17)); //19
      controllerArray->AddLast(new AliMassFitControl(3.6,3.8, 2,2, 1.095,1.17)); //20
      controllerArray->AddLast(new AliMassFitControl(3.8,4.0, 2,2, 1.095,1.17)); //21
      controllerArray->AddLast(new AliMassFitControl(4.0,4.5, 2,2, 1.095,1.16)); //22
      controllerArray->AddLast(new AliMassFitControl(4.5,5.0, 1,2, 1.083,1.15)); //23
            controllerArray->AddLast(new AliMassFitControl(5.0,5.5, 1,2, 1.08,1.17)); //24  bin05
  ...
  /// ANTI LAMBDA ---->
    ...
    controllerArray->AddLast(new AliMassFitControl(0.6,0.7, 1,2, 1.098,1.142)); //5    //1
       controllerArray->AddLast(new AliMassFitControl(0.7,0.8, 2,2, 1.1,1.143)); //6        //2
       controllerArray->AddLast(new AliMassFitControl(0.8,0.9, 2,2, 1.091,1.143)); //7        //3
       controllerArray->AddLast(new AliMassFitControl(0.9,1.0, 2,2, 1.091,1.143)); //1   //4
      controllerArray->AddLast(new AliMassFitControl(1.0,1.1, 2,2, 1.091,1.14)); //2         //5
      controllerArray->AddLast(new AliMassFitControl(1.1,1.2, 2,2, 1.095,1.14)); //3         //6
      controllerArray->AddLast(new AliMassFitControl(1.2,1.3, 2,2, 1.097,1.143)); //4         //7
      controllerArray->AddLast(new AliMassFitControl(1.3,1.4, 2,2, 1.099,1.14)); //5         //8
      controllerArray->AddLast(new AliMassFitControl(1.4,1.5, 2,2, 1.095,1.15)); //6         //9
      controllerArray->AddLast(new AliMassFitControl(1.5,1.6, 2,2, 1.095,1.14)); //7        //10
      controllerArray->AddLast(new AliMassFitControl(1.6,1.7, 2,2, 1.095,1.152)); //8        //11
      controllerArray->AddLast(new AliMassFitControl(1.7,1.8, 2,2, 1.096,1.15)); //9        //12
      controllerArray->AddLast(new AliMassFitControl(1.8,1.9, 2,2, 1.098,1.143)); //10       //13
      controllerArray->AddLast(new AliMassFitControl(1.9,2.0, 2,2, 1.098,1.143)); //11       //14
      controllerArray->AddLast(new AliMassFitControl(2.0,2.2, 2,2, 1.098,1.15)); //12        //15
      controllerArray->AddLast(new AliMassFitControl(2.2,2.4, 2,2, 1.095,1.16)); //13        //16
      controllerArray->AddLast(new AliMassFitControl(2.4,2.6, 2,2, 1.095,1.175)); //14       //17
      controllerArray->AddLast(new AliMassFitControl(2.6,2.8, 2,2, 1.095,1.17)); //15        //18
      controllerArray->AddLast(new AliMassFitControl(2.8,3.0, 2,2, 1.095,1.175)); //16        //19
      ...
      controllerArray->AddLast(new AliMassFitControl(3.8,4.0, 2,2, 1.095,1.17)); //21
      controllerArray->AddLast(new AliMassFitControl(4.0,4.5, 2,2, 1.095,1.16)); //22
      controllerArray->AddLast(new AliMassFitControl(4.5,5.0, 1,2, 1.083,1.16)); //23
            controllerArray->AddLast(new AliMassFitControl(5.0,5.5, 1,2, 1.08,1.17)); //24  bin05
	    controllerArray->AddLast(new AliMassFitControl(5.5,6.5, 1,2, 1.08,1.15)); //25
       // controllerArray->AddLast(new AliMassFitControl(6.5,8.0, 1,2, 1.095,1.17)); //33
      //  controllerArray->AddLast(new AliMassFitControl(8.0,12.0, 1,2, 1.096,1.17));//34
    ...
    if(ihist == 0){
           controllerArray->AddLast(new AliMassFitControl(0.2,0.3, 2,2, 0.44,0.55)); //1
      controllerArray->AddLast(new AliMassFitControl(0.3,0.4, 2,2, 0.45,0.55)); //2
     controllerArray->AddLast(new AliMassFitControl(0.4,0.5, 2,2, 0.45,0.6)); //3
     controllerArray->AddLast(new AliMassFitControl(0.5,0.6, 2,2, 0.45,0.59)); //4
     ...
     controllerArray->AddLast(new AliMassFitControl(0.7,0.8, 2,2, 0.45,0.55)); //6
      controllerArray->AddLast(new AliMassFitControl(0.8,0.9, 2,2, 0.45,0.55)); //7
      controllerArray->AddLast(new AliMassFitControl(0.9,1.0, 2,2, 0.455,0.55)); //8
      controllerArray->AddLast(new AliMassFitControl(1.0,1.1, 2,2, 0.455,0.55)); //9
      controllerArray->AddLast(new AliMassFitControl(1.1,1.2, 2,2, 0.455,0.56)); //10
      controllerArray->AddLast(new AliMassFitControl(1.2,1.3, 2,2, 0.455,0.55)); //11 
      controllerArray->AddLast(new AliMassFitControl(1.3,1.4, 2,2, 0.455,0.55)); //12
      controllerArray->AddLast(new AliMassFitControl(1.4,1.5, 2,2, 0.455,0.56)); //13
      controllerArray->AddLast(new AliMassFitControl(1.5,1.6, 2,2, 0.455,0.55)); //14
      controllerArray->AddLast(new AliMassFitControl(1.6,1.7, 2,2, 0.455,0.55)); //15
      controllerArray->AddLast(new AliMassFitControl(1.7,1.8, 2,2, 0.453,0.55)); //16
      controllerArray->AddLast(new AliMassFitControl(1.8,1.9, 2,2, 0.455,0.55)); //17
      controllerArray->AddLast(new AliMassFitControl(1.9,2.0, 2,2, 0.455,0.55)); //18
      controllerArray->AddLast(new AliMassFitControl(2.0,2.2, 2,2, 0.453,0.53)); //19
      controllerArray->AddLast(new AliMassFitControl(2.2,2.4, 2,2, 0.455,0.55)); //20
      controllerArray->AddLast(new AliMassFitControl(2.4,2.6, 2,2, 0.455,0.55)); //21
      controllerArray->AddLast(new AliMassFitControl(2.6,2.8, 2,2, 0.455,0.54)); //22
      controllerArray->AddLast(new AliMassFitControl(2.8,3.0, 2,2, 0.453,0.535)); //23
      ...
      controllerArray->AddLast(new AliMassFitControl(5.5,6.5, 1,2, 0.44,0.54)); //32
            controllerArray->AddLast(new AliMassFitControl(6.5,8.0, 1,2, 0.442,0.56)); //33
      controllerArray->AddLast(new AliMassFitControl(8.0,12.0, 1,2, 0.43,0.58));//34
