...
*/
  ...
  // Define production directory LFN
   ...
   //     plugin->SetGridDataDir("/alice/sim/LHC11a10a/139471/AOD048/");
   ...
   /*    plugin->AddRunNumber("139507");
          plugin->AddRunNumber("139517");
      plugin->AddRunNumber("139467");
      plugin->AddRunNumber("139510");
      plugin->AddRunNumber("139511");
      plugin->AddRunNumber("139513");
      plugin->AddRunNumber("139514");
   */
   //Real
      plugin->AddRunNumber("000139507");
      /*plugin->AddRunNumber("000139517");
      plugin->AddRunNumber("000139467");
      plugin->AddRunNumber("000139510");
      plugin->AddRunNumber("000139511");
      plugin->AddRunNumber("000139513");
      plugin->AddRunNumber("000139514");
*/
   plugin->SetGridWorkingDir("LK0Real_ESD_5sigPID_01");
