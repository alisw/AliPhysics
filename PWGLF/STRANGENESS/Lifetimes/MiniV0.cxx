...
const int MiniV0::fgkArmAlpha_n = 240;
const float MiniV0::fgkArmAlpha_f = -60.f;
const float MiniV0::fgkArmAlpha_l = 60.f;
...
const float MiniV0::fgkXedOverFindable_f = 0.;
const float MiniV0::fgkXedOverFindable_l = 1.;
...
const float MiniV0::fgkChi2xCluster_f = 0.;
const float MiniV0::fgkChi2xCluster_l = 10.;
...
const float MiniV0::fgkTPCsigma_f = 0.;
const float MiniV0::fgkTPCsigma_l = 6.;
...
const float MiniV0::fgkEta_f = -1.;
const float MiniV0::fgkEta_l = 1.;
