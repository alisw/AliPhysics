...
/* $Id$ */
#ifndef AliTrackInfoContainer_H
#define AliTrackInfoContainer_H
...
class AliTrackInfoContainer : public TObject
{
public:
    AliTrackInfoContainer(); // default constructor
    AliTrackInfoContainer(const AliTrackInfoContainer &source); // copy constructor 
    virtual ~AliTrackInfoContainer();//destructor.
    
    void Fill(const AliAODTrack* primTrack, const AliPIDResponse* fPIDResponse, Double_t lBestPrimaryVtxPos[3], Double_t lMagField);
    void Reset();
    
    void Copy(AliTrackInfoContainer *source);
...
private:
    ...
    //------------------------------------------------
    ClassDef(AliTrackInfoContainer, 1);
};
#endif
