...
#ifndef AliAnalysisTaskStrangenessVsMultVsEffEnergyAODRun2_H
#define AliAnalysisTaskStrangenessVsMultVsEffEnergyAODRun2_H
...
class AliAnalysisTaskStrangenessVsMultVsEffEnergyAODRun2 : public AliAnalysisTaskSE {
public:
    AliAnalysisTaskStrangenessVsMultVsEffEnergyAODRun2();
    AliAnalysisTaskStrangenessVsMultVsEffEnergyAODRun2(Bool_t lSaveEventTree, Bool_t lSaveV0Tree, Bool_t lSaveCascadeTree, const char *name, TString lExtraOptions = "");
    virtual ~AliAnalysisTaskStrangenessVsMultVsEffEnergyAODRun2();
...
//===========================================================================================
    ...
    AliAnalysisTaskStrangenessVsMultVsEffEnergyAODRun2(const AliAnalysisTaskStrangenessVsMultVsEffEnergyAODRun2&);            // not implemented
    AliAnalysisTaskStrangenessVsMultVsEffEnergyAODRun2& operator=(const AliAnalysisTaskStrangenessVsMultVsEffEnergyAODRun2&); // not implemented

    ClassDef(AliAnalysisTaskStrangenessVsMultVsEffEnergyAODRun2, 1);
