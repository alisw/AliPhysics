...
class AliMCTrackInfoContainer;    // your analysis class

ClassImp(AliMCTrackInfoContainer) // classimp: necessary for root

//_____________________________________________________________________________
AliMCTrackInfoContainer::AliMCTrackInfoContainer() :
TObject                     (), 
//===========================================================================================
...
//------------MONTE-CARLO-INFO------------------
fTreePrimVarPdgCode(-9999),
fTreePrimVarMassMC(-1),
...
fTreePrimVarMotherPdgCode       (-9999),
fTreePrimVarGrandMotherPdgCode  (-9999),
fTreePrimVarMotherLabel         (-1),
fTreePrimVarGrandMotherLabel    (-1),

fTreePrimVarIsPhysicalPrimary               (kFALSE),
fTreePrimVarIsPhysicalPrimaryMother         (kFALSE),
fTreePrimVarIsPhysicalPrimaryGrandMother    (kFALSE)
{
    // default constructor, don't allocate memory here!
    // this is used by root for IO purposes, it needs to remain empty
}
//_____________________________________________________________________________
AliMCTrackInfoContainer::~AliMCTrackInfoContainer() // destructor
{
    // destructor
}
//_____________________________________________________________________________
void AliMCTrackInfoContainer::Reset()
{
    //===========================================================================================
    //   Variables for Primary tracks Tree
    //===========================================================================================
...
//_____________________________________________________________________________
void AliMCTrackInfoContainer::Fill(const AliAODTrack* primTrack, const AliPIDResponse* fPIDResponse, Double_t lBestPrimaryVtxPos[3], Double_t lMagField, const AliMCEvent* lMCEvent) 
{
    //------------------------------------------------
    // Initializations
    //------------------------------------------------
    ...
    AliMCParticle* primTrackMC = (AliMCParticle*)lMCEvent->GetTrack( lLabel  );
    ...
    //________________________________________________________________________
    // PID & label info
    fTreePrimVarPdgCode = primTrackMC->PdgCode();  //PDG Code
    ...
    if( TMath::Abs(fTreePrimVarPdgCode) == 2212 || TMath::Abs(fTreePrimVarPdgCode) == 211 || TMath::Abs(fTreePrimVarPdgCode) == 321 ) 
        fTreePrimVarRapMC = primTrackMC->Y(); //Perfect Y
    //fTreePrimVarMassMC    = primTrackMC->Particle()->GetMass();//
    ...
    // Extra: check mother particle pdg code 
    Int_t lMotherLabel  = primTrackMC->GetMother();
    if ( lMotherLabel >= 0 )
    {
        AliMCParticle* lMother = (AliMCParticle*) lMCEvent->GetTrack( lMotherLabel );
        
        //if( lMCEvent->IsPhysicalPrimary(lBachMotherLabel) ) fTreeCascVarIsPhysicalPrimaryBachMother = kTRUE;
        if( lMother->IsPhysicalPrimary() ) fTreePrimVarIsPhysicalPrimaryMother = kTRUE;
        //Mother PdgCode
        fTreePrimVarMotherPdgCode   = lMother->PdgCode();
        fTreePrimVarMotherLabel     = lMotherLabel;
        
        //Go further than that, please
        Int_t lGrandMotherLabel = lMother->GetMother();
        if( lGrandMotherLabel >= 0 )
        {
            AliMCParticle* lGrandMother = (AliMCParticle*) lMCEvent->GetTrack( lGrandMotherLabel );
            if( lGrandMother->IsPhysicalPrimary() ) fTreePrimVarIsPhysicalPrimaryGrandMother = kTRUE;
            // Grand Mother PdgCode
            fTreePrimVarGrandMotherPdgCode      = lGrandMother->PdgCode();
            fTreePrimVarGrandMotherLabel        = lGrandMotherLabel;
        }
    }
...
//_____________________________________________________________________________
Float_t AliMCTrackInfoContainer::GetLengthInActiveZone(const AliAODTrack *gt, Float_t deltaY, Float_t deltaZ, Float_t b ){
...
//_____________________________________________________________________________
Float_t AliMCTrackInfoContainer::GetDCAz(AliAODTrack *lTrack)
...
//_____________________________________________________________________________
Bool_t AliMCTrackInfoContainer::IsSelected( const AliESDtrackCuts* lPrimTrackCuts )
{
...
//_____________________________________________________________________________
Bool_t AliMCTrackInfoContainer::CheckITSClusterRequirement(AliESDtrackCuts::ITSClusterRequirement req, Bool_t clusterL1, Bool_t clusterL2)
{
    //
