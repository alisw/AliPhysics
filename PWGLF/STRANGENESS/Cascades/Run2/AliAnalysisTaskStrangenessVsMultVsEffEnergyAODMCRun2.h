...
#ifndef AliAnalysisTaskStrangenessVsMultVsEffEnergyAODMCRun2_H
#define AliAnalysisTaskStrangenessVsMultVsEffEnergyAODMCRun2_H
...
class AliAnalysisTaskStrangenessVsMultVsEffEnergyAODMCRun2 : public AliAnalysisTaskSE {
public:
    AliAnalysisTaskStrangenessVsMultVsEffEnergyAODMCRun2();
    AliAnalysisTaskStrangenessVsMultVsEffEnergyAODMCRun2(Bool_t lSaveEventTree, Bool_t lSaveV0Tree, Bool_t lSaveCascadeTree, const char *name, TString lExtraOptions = "");
    virtual ~AliAnalysisTaskStrangenessVsMultVsEffEnergyAODMCRun2();
    ...
    Float_t GetCosPA(AliAODTrack *lPosTrack, AliAODTrack *lNegTrack, AliAODEvent *lEvent);
    Float_t GetLengthInActiveZone( AliAODTrack *gt, Float_t deltaY, Float_t deltaZ, Float_t b );
    //---------------------------------------------------------------------------------------
    
    Double_t PropagateToDCA(AliAODv0 *v, AliExternalTrackParam *t, AliAODEvent *event, Double_t b);
    //Helper functions
...
private:
    ...
    Bool_t    fkDoV0Refit;              // if true, will invoke AliAODv0::Refit() to improve precision
    ...
    TH2D *fHistPtVsSPDcl_GenK0Short;
    TH2D *fHistPtVsSPDcl_GenLambda;
    TH2D *fHistPtVsSPDcl_GenAntiLambda;
    TH2D *fHistPtVsSPDcl_GenXiMinus;
    TH2D *fHistPtVsSPDcl_GenXiPlus;
    TH2D *fHistPtVsSPDcl_GenOmegaMinus;
    TH2D *fHistPtVsSPDcl_GenOmegaPlus;

    //Histograms for efficiency denominators (at final analysis level selections)
    //V0s
    TH2D *fHistGeneratedPtVsSPDclK0Short;
    TH2D *fHistGeneratedPtVsSPDclLambda;
    TH2D *fHistGeneratedPtVsSPDclAntiLambda;
    
    //Cascades
    TH2D *fHistGeneratedPtVsSPDclXiMinus;
    TH2D *fHistGeneratedPtVsSPDclXiPlus;
    TH2D *fHistGeneratedPtVsSPDclOmegaMinus;
    TH2D *fHistGeneratedPtVsSPDclOmegaPlus;

    //Double differential SPDcl vs V0M
    TH3D *fHistPtVsSPDclVsCentV0M_GenK0Short;
    TH3D *fHistPtVsSPDclVsCentV0M_GenLambda;
    TH3D *fHistPtVsSPDclVsCentV0M_GenAntiLambda;
    TH3D *fHistPtVsSPDclVsCentV0M_GenXiMinus;
    TH3D *fHistPtVsSPDclVsCentV0M_GenXiPlus;
    TH3D *fHistPtVsSPDclVsCentV0M_GenOmegaMinus;
    TH3D *fHistPtVsSPDclVsCentV0M_GenOmegaPlus;

    //Histograms for efficiency denominators (at final analysis level selections)
    //V0s
    TH3D *fHistGeneratedPtVsSPDclVsCentV0MK0Short;
    TH3D *fHistGeneratedPtVsSPDclVsCentV0MLambda;
    TH3D *fHistGeneratedPtVsSPDclVsCentV0MAntiLambda;
    
    //Cascades
    TH3D *fHistGeneratedPtVsSPDclVsCentV0MXiMinus;
    TH3D *fHistGeneratedPtVsSPDclVsCentV0MXiPlus;
    TH3D *fHistGeneratedPtVsSPDclVsCentV0MOmegaMinus;
    TH3D *fHistGeneratedPtVsSPDclVsCentV0MOmegaPlus;

    //Double differential SPDcl vs ZDC
    TH3D *fHistPtVsSPDclVsZDC_GenK0Short;
    TH3D *fHistPtVsSPDclVsZDC_GenLambda;
    TH3D *fHistPtVsSPDclVsZDC_GenAntiLambda;
    TH3D *fHistPtVsSPDclVsZDC_GenXiMinus;
    TH3D *fHistPtVsSPDclVsZDC_GenXiPlus;
    TH3D *fHistPtVsSPDclVsZDC_GenOmegaMinus;
    TH3D *fHistPtVsSPDclVsZDC_GenOmegaPlus;

    //Histograms for efficiency denominators (at final analysis level selections)
    //V0s
    TH3D *fHistGeneratedPtVsSPDclVsZDCK0Short;
    TH3D *fHistGeneratedPtVsSPDclVsZDCLambda;
    TH3D *fHistGeneratedPtVsSPDclVsZDCAntiLambda;
    
    //Cascades
    TH3D *fHistGeneratedPtVsSPDclVsZDCXiMinus;
    TH3D *fHistGeneratedPtVsSPDclVsZDCXiPlus;
    TH3D *fHistGeneratedPtVsSPDclVsZDCOmegaMinus;
    TH3D *fHistGeneratedPtVsSPDclVsZDCOmegaPlus;
    
    AliAnalysisTaskStrangenessVsMultVsEffEnergyAODMCRun2(const AliAnalysisTaskStrangenessVsMultVsEffEnergyAODMCRun2&);            // not implemented
    AliAnalysisTaskStrangenessVsMultVsEffEnergyAODMCRun2& operator=(const AliAnalysisTaskStrangenessVsMultVsEffEnergyAODMCRun2&); // not implemented
    
    ClassDef(AliAnalysisTaskStrangenessVsMultVsEffEnergyAODMCRun2, 1);
