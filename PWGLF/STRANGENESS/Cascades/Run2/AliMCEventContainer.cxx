...
class AliMCEventContainer;    // your analysis class

ClassImp(AliMCEventContainer) // classimp: necessary for root

//_____________________________________________________________________________
AliMCEventContainer::AliMCEventContainer() :
TObject                     (), 
fV0MPercCorr                (-1),
fV0MPercentile              (-1),
fV0APercentile              (-1),
...
//_____________________________________________________________________________
AliMCEventContainer::AliMCEventContainer(const AliMCEventContainer &source): // copy constructor 
TObject(source)
{
    // copy constructor
...
//_____________________________________________________________________________
AliMCEventContainer::~AliMCEventContainer() // destructor
{
    // destructor
}
//_____________________________________________________________________________
void AliMCEventContainer::Reset()
{
    fV0MPercCorr                = -1;
    fV0MPercentile              = -1;
    fV0APercentile              = -1;
...
//_____________________________________________________________________________
void AliMCEventContainer::Fill(AliMultSelection* MultSelection, AliAnalysisUtils* Utils, AliAODEvent *AODEvent) 
{
    //--------------SPD-MULTIPLICITY-----------------
...
//_____________________________________________________________________________
Bool_t AliMCEventContainer::IsGoodSPDvertexRes(const AliAODVertex * spdVertex)
{
