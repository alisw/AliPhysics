...
private:
    ...
    Float_t fTreeVariableCentrality_V0C; //!
    ...
    Float_t fTreeCascVarCentrality_V0C; //!
    ...
    TH1D *fHistCentrality_V0A; //!
    TH1D *fHistCentrality_V0C; //!
    TH1D *fHistCentrality_V0M; //!
    ...
    ClassDef(AliAnalysisTaskStrangenessVsMultiplicityRun2pPb, 3);
