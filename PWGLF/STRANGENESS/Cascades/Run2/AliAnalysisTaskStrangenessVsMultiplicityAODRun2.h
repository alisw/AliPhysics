...
#ifndef AliAnalysisTaskStrangenessVsMultiplicityAODRun2_H
#define AliAnalysisTaskStrangenessVsMultiplicityAODRun2_H
...
class AliAnalysisTaskStrangenessVsMultiplicityAODRun2 : public AliAnalysisTaskSE {
public:
    AliAnalysisTaskStrangenessVsMultiplicityAODRun2();
    AliAnalysisTaskStrangenessVsMultiplicityAODRun2(Bool_t lSaveEventTree, Bool_t lSaveV0Tree, Bool_t lSaveCascadeTree, const char *name, TString lExtraOptions = "");
    virtual ~AliAnalysisTaskStrangenessVsMultiplicityAODRun2();
...
//===========================================================================================
    ...
    AliAnalysisTaskStrangenessVsMultiplicityAODRun2(const AliAnalysisTaskStrangenessVsMultiplicityAODRun2&);            // not implemented
    AliAnalysisTaskStrangenessVsMultiplicityAODRun2& operator=(const AliAnalysisTaskStrangenessVsMultiplicityAODRun2&); // not implemented

    ClassDef(AliAnalysisTaskStrangenessVsMultiplicityAODRun2, 1);
