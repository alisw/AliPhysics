...
private:
  ...
  TH2D *fHistEtaTriggeredMeson[78];              //! for keeping track of base spectra
  TH2D *fHistEtaTriggeredCharm[78];              //! for keeping track of base spectra
  TH2D *fHistEtaTriggeredBeauty[78];              //! for keeping track of base spectra
