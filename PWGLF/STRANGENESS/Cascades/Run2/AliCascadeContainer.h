...
/* $Id$ */
#ifndef AliCascadeContainer_H
#define AliCascadeContainer_H
...
class AliCascadeContainer : public TObject
{
public:
    AliCascadeContainer(); // default constructor
    AliCascadeContainer(const AliCascadeContainer& source);
    virtual ~AliCascadeContainer();//destructor.
    
    void Fill(AliAODcascade* cascade, AliPIDResponse* fPIDResponse, Double_t lBestPrimaryVtxPos[3], Double_t lMagField);
    void Reset();
...
private:
    ...
    //------------------------------------------------
    ClassDef(AliCascadeContainer, 1);
};
#endif
