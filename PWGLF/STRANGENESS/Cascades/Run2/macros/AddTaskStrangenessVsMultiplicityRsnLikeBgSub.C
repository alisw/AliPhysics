AliAnalysisTaskStrangenessVsMultiplicityRsnLikeBgSub *AddTaskStrangenessVsMultiplicityRsnLikeBgSub( Bool_t lSaveEventTree = kTRUE, Bool_t lSaveV0 = kTRUE, Bool_t lSaveCascade = kTRUE, TString lExtraOptions = "", const TString lMasterJobSessionFlag = "")
{
    ...
    AliAnalysisTaskStrangenessVsMultiplicityRsnLikeBgSub *taskAuxiliary = new AliAnalysisTaskStrangenessVsMultiplicityRsnLikeBgSub(lSaveEventTree, lSaveV0, lSaveCascade, "taskAuxiliaryRsnLikeBgSub", lExtraOptions);
