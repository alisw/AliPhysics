AliAnalysisTaskStrangenessVsMultVsEffEnergyAODMCRun2 *AddTaskStrangenessVsMultVsEffEnergyAODMCRun2( Bool_t lSaveEventTree = kTRUE, Bool_t lSaveV0 = kTRUE, Bool_t lSaveCascade = kTRUE, TString lExtraOptions = "", const TString lMasterJobSessionFlag = "", TString lExtraOutputName = "")
{
    ...
    AliAnalysisTaskStrangenessVsMultVsEffEnergyAODMCRun2 *taskAuxiliary = new AliAnalysisTaskStrangenessVsMultVsEffEnergyAODMCRun2(kTRUE, kTRUE, kTRUE, Form("taskAuxiliary%s",lExtraOutputName.Data()), lExtraOptions);
