AliAnalysisTaskStrangenessVsMultiplicityEERun2 *AddTaskStrangenessVsMultiplicityEERun2( Bool_t lSaveEventTree = kTRUE, Bool_t lSaveV0 = kTRUE, Bool_t lSaveCascade = kTRUE, TString lExtraOptions = "", const TString lMasterJobSessionFlag = "", TString lExtraOutputName = "")
{
    ...
    AliAnalysisTaskStrangenessVsMultiplicityEERun2 *taskAuxiliary = new AliAnalysisTaskStrangenessVsMultiplicityEERun2(lSaveEventTree, lSaveV0, lSaveCascade, Form("taskAuxiliary%s",lExtraOutputName.Data()), lExtraOptions);
