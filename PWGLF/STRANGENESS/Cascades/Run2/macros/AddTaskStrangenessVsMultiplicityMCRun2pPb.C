AliAnalysisTaskStrangenessVsMultiplicityMCRun2pPb *AddTaskStrangenessVsMultiplicityMCRun2pPb( Bool_t lSaveEventTree = kTRUE, Bool_t lSaveV0 = kTRUE, Bool_t lSaveCascade = kTRUE, TString lExtraOptions = "", const TString lMasterJobSessionFlag = "")
{
    ...
    if (!mgr) {
        ::Error("AddTaskStrangenessVsMultiplicitypPb", "No analysis manager to connect to.");
        return NULL;
    }
    ...
    if (!mgr->GetInputEventHandler()) {
        ::Error("AddTaskStrangenessVsMultiplicitypPb", "This task requires an input event handler");
        return NULL;
    }
    TString type = mgr->GetInputEventHandler()->GetDataType(); // can be "ESD" or "AOD"
    
    // Create and configure the task
    AliAnalysisTaskStrangenessVsMultiplicityMCRun2pPb *taskAuxiliary = new AliAnalysisTaskStrangenessVsMultiplicityMCRun2pPb(lSaveEventTree, lSaveV0, lSaveCascade, "taskAuxiliary", lExtraOptions);
