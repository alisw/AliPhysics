...
#ifndef AliAnalysisTaskStrangenessVsMultiplicityEEMCRun2_H
#define AliAnalysisTaskStrangenessVsMultiplicityEEMCRun2_H
...
class AliAnalysisTaskStrangenessVsMultiplicityEEMCRun2 : public AliAnalysisTaskSE {
public:
    AliAnalysisTaskStrangenessVsMultiplicityEEMCRun2();
    AliAnalysisTaskStrangenessVsMultiplicityEEMCRun2(Bool_t lSaveEventTree, Bool_t lSaveV0Tree, Bool_t lSaveCascadeTree, const char *name, TString lExtraOptions = "");
    virtual ~AliAnalysisTaskStrangenessVsMultiplicityEEMCRun2();
...
private:
    ...
    ClassDef(AliAnalysisTaskStrangenessVsMultiplicityEEMCRun2, 1);
