...
class AliCascadeContainer;    // your analysis class

ClassImp(AliCascadeContainer) // classimp: necessary for root

//_____________________________________________________________________________
AliCascadeContainer::AliCascadeContainer() :
TObject                     (), 
//-----------BASIC-INFO---------------------------
...
//_____________________________________________________________________________
AliCascadeContainer::~AliCascadeContainer() // destructor
{
    // destructor
}
//_____________________________________________________________________________
void AliCascadeContainer::Reset()
{
    //-----------BASIC-INFO---------------------------
    fTreeCascVarCharge = 0;
    fTreeCascVarMassAsXi = 0;
...
//_____________________________________________________________________________
void AliCascadeContainer::Fill(AliAODcascade* cascade, AliPIDResponse* fPIDResponse, Double_t lBestPrimaryVtxPos[3], Double_t lMagField) 
{
    //------------------------------------------------
    // Initializations
    //------------------------------------------------
    if(!cascade)
    {
        printf("Error in AliCascadeContainer::Fill : cascade is a null ptr ! \n");
        return;
    }
...
//_____________________________________________________________________________
Float_t AliCascadeContainer::GetLengthInActiveZone( AliAODTrack *gt, Float_t deltaY, Float_t deltaZ, Float_t b ){
...
//_____________________________________________________________________________
Float_t AliCascadeContainer::GetDCAz(AliAODTrack *lTrack)
...
//_____________________________________________________________________________
Bool_t AliCascadeContainer::IsSelected( const AliCascadeResult* lCascadeResult )
{
