#ifndef AliV0vertexerUncheckedCharges_H
#define AliV0vertexerUncheckedCharges_H
...
class AliV0vertexerUncheckedCharges : public TObject {
public:
    AliV0vertexerUncheckedCharges();
...
private:
    ...
    ClassDef(AliV0vertexerUncheckedCharges,3)  // V0 verterxer
};

inline AliV0vertexerUncheckedCharges::AliV0vertexerUncheckedCharges() :
TObject(),
fChi2max(fgChi2max),
fDNmin(fgDNmin),
fDPmin(fgDPmin),
...
inline void AliV0vertexerUncheckedCharges::SetCuts(const Double_t cuts[7]) {
    fChi2max=cuts[0];
...
inline void AliV0vertexerUncheckedCharges::SetDefaultCuts(const Double_t cuts[7]) {
    fgChi2max=cuts[0];
...
inline void AliV0vertexerUncheckedCharges::GetCuts(Double_t cuts[7]) const {
    cuts[0]=fChi2max;
...
inline void AliV0vertexerUncheckedCharges::GetDefaultCuts(Double_t cuts[7]) {
    cuts[0]=fgChi2max;
...
inline void AliV0vertexerUncheckedCharges::SetDefaultMaxEta(Double_t lMaxEta) {
    fgMaxEta = lMaxEta;
}
inline void AliV0vertexerUncheckedCharges::SetDefaultMinClusters(Double_t lMinClusters) {
    fgMinClusters = lMinClusters;
}
inline void AliV0vertexerUncheckedCharges::SetMaxEta(Double_t lMaxEta) {
    fMaxEta = lMaxEta;
}
inline void AliV0vertexerUncheckedCharges::SetMinClusters(Double_t lMinClusters) {
