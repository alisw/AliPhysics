AliAnalysisTaskpANormalizationCheckMC *AddTaskpANormalizationCheckMC( const TString lMasterJobSessionFlag = "")
{
// Creates, configures and attaches to the train a cascades check task.
  ...
  AliAnalysisTaskpANormalizationCheckMC *taskAuxiliary = new AliAnalysisTaskpANormalizationCheckMC("taskAuxiliary");
  mgr->AddTask(taskAuxiliary);
  TString outputFileName = AliAnalysisManager::GetCommonFileName();
   
  outputFileName += ":PWGLF_pANormCheck";
