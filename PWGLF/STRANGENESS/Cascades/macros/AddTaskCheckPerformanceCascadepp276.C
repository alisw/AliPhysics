...
AliAnalysisTaskCheckPerformanceCascadepp276 *AddTaskCheckPerformanceCascadepp276( TString  collidingSystem        = "pp",
   ...
   TString tasknameperf = Form("TaskCheckPerformanceCascade_minnTPCcls%i_vtxlim%.1f-%.1f_minptdghtrk%.1f_etacutdghtrk%.1f%s",minnTPCcls,vtxlim,vtxlimmin,minptondaughtertracks,etacutondaughtertracks,sddstatus);
   AliAnalysisTaskCheckPerformanceCascadepp276 *taskCheckPerfCascadepp276 = new AliAnalysisTaskCheckPerformanceCascadepp276(tasknameperf);
     ...
     taskCheckPerfCascadepp276->SetINT7Trigger                (lSwitchINT7);            // choose for "pp" system the trigger class for physics sel.: kTRUE=="kINT7", kFALSE=="kMB"
     ...
     taskCheckPerfCascadepp276->SetSDDSelection               (ksddselection);          // choose if apply SDD event selection
     ...
     taskCheckPerfCascadepp276->SetWithSDDOn                  (kwithsdd);               // which SDD selection do you want apply? [if kTRUE select SDDon events]
   ...
   // - Objects name
   TString outputnameperf0 = Form("clistCascPerf_minnTPCcls%i_vtxlim%.1f-%.1f_minptdghtrk%.1f_etacutdghtrk%.1f%s",minnTPCcls,vtxlim,vtxlimmin,minptondaughtertracks,etacutondaughtertracks,sddstatus);
   TString outputnameperf1 = Form("cfcontPIDAsXiM_minnTPCcls%i_vtxlim%.1f-%.1f_minptdghtrk%.1f_etacutdghtrk%.1f%s",minnTPCcls,vtxlim,vtxlimmin,minptondaughtertracks,etacutondaughtertracks,sddstatus);
   TString outputnameperf2 = Form("cfcontPIDAsXiP_minnTPCcls%i_vtxlim%.1f-%.1f_minptdghtrk%.1f_etacutdghtrk%.1f%s",minnTPCcls,vtxlim,vtxlimmin,minptondaughtertracks,etacutondaughtertracks,sddstatus);
   TString outputnameperf3 = Form("cfcontPIDAsOmegaM_minnTPCcls%i_vtxlim%.1f-%.1f_minptdghtrk%.1f_etacutdghtrk%.1f%s",minnTPCcls,vtxlim,vtxlimmin,minptondaughtertracks,etacutondaughtertracks,sddstatus);
   TString outputnameperf4 = Form("cfcontPIDAsOmegaP_minnTPCcls%i_vtxlim%.1f-%.1f_minptdghtrk%.1f_etacutdghtrk%.1f%s",minnTPCcls,vtxlim,vtxlimmin,minptondaughtertracks,etacutondaughtertracks,sddstatus);
   TString outputnameperf5 = Form("cfcontAsCuts_minnTPCcls%i_vtxlim%.1f-%.1f_minptdghtrk%.1f_etacutdghtrk%.1f%s",minnTPCcls,vtxlim,vtxlimmin,minptondaughtertracks,etacutondaughtertracks,sddstatus);
