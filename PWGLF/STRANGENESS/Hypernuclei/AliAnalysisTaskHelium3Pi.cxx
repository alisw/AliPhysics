...
void AliAnalysisTaskHelium3Pi::UserCreateOutputObjects()
{
  ...
  if(! fhBB ){
    ...
    fhBB->GetXaxis()->SetTitle("p/z [GeV/c]");
  ...
  if(! fhTOF ){
    ...
    fhTOF->GetXaxis()->SetTitle("p/z [GeV/c]");
  ...
  if(! fhBBHe ){
    ...
    fhBBHe->GetXaxis()->SetTitle("p/z [GeV/c]");
  ...
  if(! fhNaPos ){
    ...
    fhNaPos->GetXaxis()->SetTitle("p/z [GeV/c]");
  ...
  if(! fhNaNeg ){
    ...
    fhNaNeg->GetXaxis()->SetTitle("p/z [GeV/c]");
  ...
  if(! fHelium3TOF){
    ...
    fHelium3TOF->GetXaxis()->SetTitle("p/z [GeV/c]");
  ...
  if(! fhTreeESD){
    fhTreeESD = new TTree("fhTreeESD","Lista ESD file");
    fhTreeESD->Branch("nameESD", &nameESD,25000,0); 
    fhTreeESD->Branch("nEvent", &nEv);
    fListHistCascade->Add(fhTreeESD);
  }
...
void AliAnalysisTaskHelium3Pi::UserExec(Option_t *) 
{
  ...
  Bool_t   isTPC,isTOF,isTOFHe,IsHeITSRefit,isTOFPi,IsPiITSRefit ;
  ...
  Double_t fgCPAmin=0.99;     //! min cosine of V0's pointing angle  //qui
  ...
  for (Int_t j=0; j<TrackNumber; j++) { //loop on tracks
	...
	nameESD=(TString)AliAnalysisTaskSE::CurrentFileName();
	nameESD.Data();
	nEv=(Int_t)AliAnalysisTaskSE::Entry();
	fhTreeESD->Fill();
