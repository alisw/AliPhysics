#ifndef ALIANALYSISTASKHYPERTRITON3AOD_H
#define ALIANALYSISTASKHYPERTRITON3AOD_H
...
class AliAnalysisTaskHypertriton3AOD : public AliAnalysisTaskSE {

 public:
  AliAnalysisTaskHypertriton3AOD(TString taskname = "taskHypertritonAOD");
  virtual ~AliAnalysisTaskHypertriton3AOD();
  ...
  void SetConvertedAODVertices(AliESDVertex *ESDvtxs) const;

 private:

  Bool_t AcceptTrack(AliAODTrack *t, Int_t part = 0);  ///< Method to accept/reject tracks similar to the one in AliESDtrackCuts but with personal selections
  
  AliVEvent          *fAODevent;                   ///< AOD event
  AliAODVertex       *fPrimaryVertex;              //!<! Primary vertex of the current event
  ...
  //Track quality
  Int_t              fRequireMinTPCcls;            ///< minimum number of TPC clusters
  Int_t              fRequireMinPionTPCcls;        ///< minimum number of TPC clusters for candidate pion
  Int_t              fRequireMinTPCclsSignal;      ///< minimum number of TPC clusters for PID
  Float_t            fRequireMaxChi2perNDF;        ///< maximum value of Chi2/NDF
  Float_t            fRequireEtaMin;               ///< minimum value of pseudorapidity
  Float_t            fRequireEtaMax;               ///< maximum value of pseudorapidity
  Bool_t             fRequireTPCrefit;             ///< TPC refit
  Bool_t             fRequireNoKinks;              ///< No kinks
  Float_t            fMinPionPt;                   ///< minimum transverse momentum for candidate pion
  Float_t            fMaxPionPt;                   ///< maximum transverse momentum for candidate pion
  ...
  AliAnalysisTaskHypertriton3AOD(const AliAnalysisTaskHypertriton3AOD&); // not implemented
  AliAnalysisTaskHypertriton3AOD& operator=(const AliAnalysisTaskHypertriton3AOD&); // not implemented
  
  ClassDef(AliAnalysisTaskHypertriton3AOD, 1); // analysisclass
