#ifndef AliAnalysisTaskStrVsMult_SelectionStudies_H
#define AliAnalysisTaskStrVsMult_SelectionStudies_H
...
class AliAnalysisTaskStrVsMult_SelectionStudies : public AliAnalysisTaskSE {
  public:
    AliAnalysisTaskStrVsMult_SelectionStudies();
    AliAnalysisTaskStrVsMult_SelectionStudies(const char *name, TString lExtraOptions = "");
    virtual ~AliAnalysisTaskStrVsMult_SelectionStudies();
  ...
  private:
    ...
    AliAnalysisTaskStrVsMult_SelectionStudies(const AliAnalysisTaskStrVsMult_SelectionStudies&);            // not implemented
    AliAnalysisTaskStrVsMult_SelectionStudies& operator=(const AliAnalysisTaskStrVsMult_SelectionStudies&); // not implemented

    ClassDef(AliAnalysisTaskStrVsMult_SelectionStudies, 6); 
