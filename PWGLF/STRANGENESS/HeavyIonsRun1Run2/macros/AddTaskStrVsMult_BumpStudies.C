AliAnalysisTaskStrVsMult_BumpStudies *AddTaskStrVsMult_BumpStudies(bool K0s = false, bool Lam = false, bool Xi = true, bool Om = true, TString suffix = "")
{
  // analysis manager
  ...
  TString tskname = Form("StrVsMult_Task_BumpStudies_%s", suffix.Data());
  AliAnalysisTaskStrVsMult_BumpStudies *mytask = new AliAnalysisTaskStrVsMult_BumpStudies(tskname);
  mgr->AddTask(mytask);
