AliAnalysisTaskStrVsMult_SelectionStudies *AddTaskStrVsMult_SelectionStudies(bool K0s = true, bool Lam = true, bool Xi = true, bool Om = true, TString suffix = "")
{
  // analysis manager
  ...
  AliAnalysisTaskStrVsMult_SelectionStudies *mytask = new AliAnalysisTaskStrVsMult_SelectionStudies(tskname);
  mgr->AddTask(mytask);
