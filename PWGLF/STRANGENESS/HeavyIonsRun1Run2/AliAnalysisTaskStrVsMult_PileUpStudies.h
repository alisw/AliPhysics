#ifndef AliAnalysisTaskStrVsMult_PileUpStudies_H
#define AliAnalysisTaskStrVsMult_PileUpStudies_H
...
class AliAnalysisTaskStrVsMult_PileUpStudies : public AliAnalysisTaskSE {
  public:
    AliAnalysisTaskStrVsMult_PileUpStudies();
    AliAnalysisTaskStrVsMult_PileUpStudies(const char *name, TString lExtraOptions = "");
  ...
  private:
    ...
    THistManager* fHistos_CascTopology;                       //!
    ...
    AliAnalysisTaskStrVsMult_PileUpStudies(const AliAnalysisTaskStrVsMult_PileUpStudies&);            // not implemented
    AliAnalysisTaskStrVsMult_PileUpStudies& operator=(const AliAnalysisTaskStrVsMult_PileUpStudies&); // not implemented

    ClassDef(AliAnalysisTaskStrVsMult_PileUpStudies, 1); 
