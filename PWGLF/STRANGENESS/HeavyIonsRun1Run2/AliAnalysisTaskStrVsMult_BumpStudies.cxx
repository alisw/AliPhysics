...
#include "AliAnalysisTaskStrVsMult_BumpStudies.h"

#include "TMath.h"

ClassImp(AliAnalysisTaskStrVsMult_BumpStudies)

AliAnalysisTaskStrVsMult_BumpStudies::AliAnalysisTaskStrVsMult_BumpStudies() : AliAnalysisTaskSE(),
//outputs
fHistos_eve(nullptr),
fHistos_K0S(nullptr),
fHistos_Lam(nullptr),
...
AliAnalysisTaskStrVsMult_BumpStudies::AliAnalysisTaskStrVsMult_BumpStudies(const char *name, TString lExtraOptions) : AliAnalysisTaskSE(name),
//outputs
fHistos_eve(nullptr),
fHistos_K0S(nullptr),
fHistos_Lam(nullptr),
...
AliAnalysisTaskStrVsMult_BumpStudies::~AliAnalysisTaskStrVsMult_BumpStudies()
{
    //------------------------------------------------
    // DESTRUCTOR
    //------------------------------------------------
...
void AliAnalysisTaskStrVsMult_BumpStudies::UserCreateOutputObjects()
{
...
//________________________________________________________________________
void AliAnalysisTaskStrVsMult_BumpStudies::UserExec(Option_t *)
{
    ...
    for (Int_t iV0 = 0; iV0 < nv0s; iV0++) {
      ...
      if (isESD) {
        ...
        if(fisMC){
          ...
          if(fisMCantiassoc && pdgV0==310) assFlag[kk0s] = kFALSE;
          if(fisMCantiassoc && pdgV0==3122) assFlag[klam] = kFALSE;
          if(fisMCantiassoc && pdgV0==-3122) assFlag[kalam] = kFALSE;
          //Feeddown matrix
    ...
    for (int i_casc = 0; i_casc < ncasc; i_casc++) {
      ...
      if(isESD){
        ...
        if(fisMC){
          ...
          if(fisMCantiassoc && pdgCasc==3312) assFlag[kxim] = kFALSE;
          if(fisMCantiassoc && pdgCasc==-3312) assFlag[kxip] = kFALSE;
          if(fisMCantiassoc && pdgCasc==3334) assFlag[komm] = kFALSE;
          if(fisMCantiassoc && pdgCasc==-3334) assFlag[komp] = kFALSE;
        }
...
//________________________________________________________________________
void AliAnalysisTaskStrVsMult_BumpStudies::Terminate(Option_t *)
{

}

//________________________________________________________________________
void AliAnalysisTaskStrVsMult_BumpStudies::SetCutVal(bool defchange, bool iscasc, int cutnum, double cval) {
  if (!iscasc) {
...
//________________________________________________________________________
void AliAnalysisTaskStrVsMult_BumpStudies::SetDefCutVals() {
  //V0 part
  if (fParticleAnalysisStatus[kk0s] || fParticleAnalysisStatus[klam]) {
...
//________________________________________________________________________
void AliAnalysisTaskStrVsMult_BumpStudies::SetCutVariation(bool iscasc, int cutnum, int nvar, double lowval, double highval) {
  if (!iscasc) {
...
//________________________________________________________________________
void AliAnalysisTaskStrVsMult_BumpStudies::SetDefCutVariations() {
...
//________________________________________________________________________
void AliAnalysisTaskStrVsMult_BumpStudies::SetDefOnly(bool isdefonly) {
  fDefOnly = isdefonly;
}

//________________________________________________________________________
bool AliAnalysisTaskStrVsMult_BumpStudies::ApplyCuts(int part) {
...
void AliAnalysisTaskStrVsMult_BumpStudies::SetParticleAnalysisStatus(bool k0s, bool lambda, bool xi, bool omega) {
...
bool AliAnalysisTaskStrVsMult_BumpStudies::GetParticleAnalysisStatus(int part) {
  if (part<0 || part>=ksignednumpart) {
    ::Error("AliAnalysisTaskStrVsMult_BumpStudies::GetParticleAnalysisStatus", "Wrong particle selected: accepted values from 0 to 3");
    return false;
  }
  return fParticleAnalysisStatus[part];
}

void AliAnalysisTaskStrVsMult_BumpStudies::SetCentbinning(int ipart, int numcentbins, double *centbins) {
...
void AliAnalysisTaskStrVsMult_BumpStudies::SetPtbinning(int ipart, int numptbins, double *ptbins) {
...
void AliAnalysisTaskStrVsMult_BumpStudies::SetMassbinning(int ipart, int nummassbins, double valminmass, double valmaxmass) {
...
//________________________________________________________________________
void AliAnalysisTaskStrVsMult_BumpStudies::DataPosting() {
...
//________________________________________________________________________
void AliAnalysisTaskStrVsMult_BumpStudies::FillHistCutVariations(bool iscasc, double perc, bool phypri, bool *associFlag, double ptassxi) {
