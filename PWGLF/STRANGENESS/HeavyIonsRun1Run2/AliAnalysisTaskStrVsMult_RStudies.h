#ifndef AliAnalysisTaskStrVsMult_RStudies_H
#define AliAnalysisTaskStrVsMult_RStudies_H
...
class AliAnalysisTaskStrVsMult_RStudies : public AliAnalysisTaskSE {
  public:
    AliAnalysisTaskStrVsMult_RStudies();
    AliAnalysisTaskStrVsMult_RStudies(const char *name, TString lExtraOptions = "");
    virtual ~AliAnalysisTaskStrVsMult_RStudies();
    ...
    enum cutnumb_Casc{kCasc_DcaCascDaught, kCasc_CascCosPA, kCasc_CascRad, kCasc_NSigPID, kCasc_LeastCRaws, kCasc_LeastCRawsOvF, kCasc_TrackLengthCut, kCasc_MaxChi2perCls, kCasc_InvMassLam, kCasc_DcaV0Daught, kCasc_V0CosPA, kCasc_DcaV0ToPV, kCasc_DcaBachToPV, kCasc_ITSTOFtracks, kCasc_TOFtracks, kCasc_y, kCasc_etaDaugh, kCasc_PropLifetXi, kCasc_PropLifetOm, kCasc_V0Rad, kCasc_MaxV0Rad, kCasc_DcaMesToPV, kCasc_DcaBarToPV, kCasc_BacBarCosPA, kCasccutsnum}; 
  ...
  private:
    ...
    AliAnalysisTaskStrVsMult_RStudies(const AliAnalysisTaskStrVsMult_RStudies&);            // not implemented
    AliAnalysisTaskStrVsMult_RStudies& operator=(const AliAnalysisTaskStrVsMult_RStudies&); // not implemented

    ClassDef(AliAnalysisTaskStrVsMult_RStudies, 1); 
    //version 1: new task to study R_V0 dependence
};
