...
#ifndef AliAnalysisTaskCorrelationhCascDATA_H
#define AliAnalysisTaskCorrelationhCascDATA_H
...
class AliAnalysisTaskCorrelationhCascDATA : public AliAnalysisTaskSE  
{
 public:
  AliAnalysisTaskCorrelationhCascDATA();
  AliAnalysisTaskCorrelationhCascDATA(const char *name);
  virtual                 ~AliAnalysisTaskCorrelationhCascDATA();
 ...
 private:
  ...
  AliAnalysisTaskCorrelationhCascDATA(const AliAnalysisTaskCorrelationhCascDATA&); 
  AliAnalysisTaskCorrelationhCascDATA& operator=(const AliAnalysisTaskCorrelationhCascDATA&); 

  ClassDef(AliAnalysisTaskCorrelationhCascDATA, 1);
};
