...
AliAnalysisTaskCorrelationhhK0s* AddTaskCorrelationhhK0s(Float_t minpt=3, Float_t maxpt=15, Bool_t ishhCorr=0,bool isLocal=kTRUE, bool isMC=kTRUE, bool isEff=kTRUE, bool isHybridMCTr = kTRUE, Int_t EvtToMix=50, Float_t EtaTrigger=0.8, Float_t EtahAssoc=0.8,Float_t EtaV0Assoc=0.8, Int_t FilterBitValue=128, Int_t year=2010, TString AssocParticle="K0s", Bool_t isInclusiveAnalysis = 0, Bool_t isHM =0, Float_t PercentileMin =0, Float_t PercentileMax=0, TString suffix = ""){
