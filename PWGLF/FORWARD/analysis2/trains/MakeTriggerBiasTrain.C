 ...
 * 
 * @brief  Train to analyse for trigger bias 
 * 
...
//====================================================================
/**
 * Analysis train to make trigger bias corretion
 ...
 * @ingroup pwglf_forward_scripts_tasks_vz
 */
class MakeTriggerBiasTrain : public TrainSetup
{
public:
  /** 
   * Constructor.  
...
protected:
  ...
  {
    // --- Output file name ------------------------------------------
    AliAnalysisManager::SetCommonFileName("forward_trigger.root");
    ...
    // --- Add the task ----------------------------------------------
    AliAnalysisTaskSE* tsk = CoupleSECar("AddTaskTriggerCorrection.C",
					 AliVEvent::kAny);
  ...
  //__________________________________________________________________
  const char* ClassName() const { return "MakeTriggerBiasTrain"; }
  //__________________________________________________________________
