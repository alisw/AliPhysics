...
regions with the \FMD{} detector \cite{FWD:2004mz,cholm:2009}. The
document also include a summary (see section \ref{prelim}) of the request for preliminary figures
for the measurement of $\dndeta$ with SPD\cite{ruben,Aamodt:2010cz},
VZERO\cite{maxime}, and FMD. 
...
\item[Corrections] The 5 (one for each FMD ring) $\dndetadphi[incl,r,v,i]$ are corrected for
...
\begin{figure}[hbp]
  \centering
  \includegraphics[keepaspectratio,width=\textwidth]{coverage}
...
\begin{figure}[hbp]
   \centering
  \includegraphics[keepaspectratio,width=\textwidth]{spdfmdvzero}
...
\begin{figure}
  ...
  \centering
  \includegraphics[keepaspectratio,width=\textwidth]{ratiofmdvzero}
  \end{minipage}%
  \begin{minipage}{0.5\linewidth}
  \centering
  \includegraphics[keepaspectratio,width=\textwidth]{ratiospdfmdvzero}
\end{minipage}%
...
\begin{figure}
  \centering
  \includegraphics[keepaspectratio,width=\textwidth]{dNdphi040612}
...
\begin{figure}
  \centering
  \includegraphics[keepaspectratio,width=\textwidth]{dNdphi_neg_040612}
...
\begin{figure}
  ...
  \centering
  \includegraphics[keepaspectratio,width=0.8\textwidth]{dNdeta_per_vertex160612_negfield}
  %\end{minipage}%
  % \begin{minipage}{\linewidth}
  %\begin{minipage}{\columnwidth}
  \centering
  \includegraphics[keepaspectratio,width=0.8\textwidth]{dNdeta_per_vertex160612_posfield}
%\end{minipage}%
...
\begin{figure}
  \centering
  \includegraphics[keepaspectratio,width=0.7\textwidth]{disp_dndeta_ratios_leftright}
...
\begin{figure}
  \centering
  \includegraphics[keepaspectratio,width=\textwidth]{combineddndeta}
...
\begin{figure}
  \centering
  \includegraphics[keepaspectratio,width=\textwidth]{dndetaoverNpart}
...
\begin{figure}
  \centering
  \includegraphics[keepaspectratio,width=\textwidth]{RatiodndetaoverNpart}
...
\begin{figure}
  \centering
  \includegraphics[keepaspectratio,width=\textwidth]{totalNch}
...
\begin{figure}
  ...
  \begin{minipage}{0.5\linewidth}
  \centering
  \includegraphics[keepaspectratio,width=\textwidth]{prelim_wrong150612}
  \end{minipage}%
  \begin{minipage}{0.5\linewidth}
  \centering
  \includegraphics[keepaspectratio,width=\textwidth]{prelim_right150612}
\end{minipage}%
