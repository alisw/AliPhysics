...
\begin{table}[h!tbp]
  ...
  \caption[Summary of systematic errors]{Summary of systematic
    ...
    \textsuperscript{***}The additional 2\% in the FMD1 region
    should be added in quadrature and stems from the additional
    sensitivity to the hadron chemistry discussed elsewhere
    in \secref{sec:sub:sub:secmap}.} 
  \small
  \begin{tabular}[t]{|cc|c|cccc|cc|c|}
    ...
    & 1\%\\ 
    \hline
    \multicolumn{2}{|c|}{Secondary map\textsuperscript{*}\hspace*{3em}} 
    & n 
    ...
    & As--applied\textsuperscript{***} 
    & n 
    & \multicolumn{4}{c|}{6.1\% (+2\% \FMD{1})} 
    & \multicolumn{2}{c|}{6.1\% (+2\% \FMD{1})} 
    & 6.1\%\\ 
    \hline
    &   \INEL{}
    & 
...
\begin{figure}[h!tbp]
  \centering
  \figinput[.9\linewidth]{satellites_dndeta}
