...
\item[Hadron Chemistry] An additional 2\% in the \FMD{1} region should
  ...
  \secref{sec:sub:sub:secmap}. Note that the systematic error on the
  empirical correction already contain 2\% error on this in the FMD
  region --- see \tabref{tab:satellite:syserrs}.
\end{description}
...
errors as weights, and finally the common systematics errors were added
