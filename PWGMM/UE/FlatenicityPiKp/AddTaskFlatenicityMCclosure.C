///////////////////////////////////////////////////////////////////
//                                                               //
//            AddTaskFlatenicityMCclosure macro                           //
//                                                               //
///////////////////////////////////////////////////////////////////
class AliAnalysisDataContainer;

AliAnalysisTaskFlatenicityMCclosure *
AddTaskFlatenicityMCclosure(const Char_t *taskname = "Flat", TString detForFlat = "V0",
...

{
	...
	AliAnalysisTaskFlatenicityMCclosure *taskFlat =
		new AliAnalysisTaskFlatenicityMCclosure("taskFlat");
	if (!taskFlat)
		return 0x0;
