///////////////////////////////////////////////////////////////////
//                                                               //
//            AddTaskSystematicsV0M macro                       //
//                                                               //
///////////////////////////////////////////////////////////////////
class AliAnalysisDataContainer;

AliAnalysisTaskSystematicsV0M *
AddTaskSystematicsV0M(const Char_t *taskname = "V0_Calibrated", TString detForFlat = "V0",
...

{
	...
	AliAnalysisTaskSystematicsV0M *taskFlat =
		new AliAnalysisTaskSystematicsV0M("taskFlat");
	if (!taskFlat)
		return 0x0;
	...
	taskFlat->IsSystVarTrkCuts(true);
