...
AliAnalysisTaskMcKnoUe* AddTaskMcKnoUe(const Char_t* taskname="McKnoUe", Bool_t  useMC  = kTRUE, Bool_t performMCclosuretest = kFALSE, Bool_t isPythia=kTRUE,Bool_t IsppData=kTRUE,Bool_t IspPbData=kTRUE, Double_t minpT=0.5)
{
