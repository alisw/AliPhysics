 ...
 **************************************************************************/
#ifndef AliAnalysisTaskDeutFlucpp_H
#define AliAnalysisTaskDeutFlucpp_H
...
class AliAnalysisTaskDeutFlucpp : public AliAnalysisTaskSE {
 public:
  AliAnalysisTaskDeutFlucpp();
  AliAnalysisTaskDeutFlucpp(const char *name);
  virtual ~AliAnalysisTaskDeutFlucpp();
