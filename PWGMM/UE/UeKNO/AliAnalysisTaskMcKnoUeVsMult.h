...
#ifndef AliAnalysisTaskMcKnoUeVsMult_H
#define AliAnalysisTaskMcKnoUeVsMult_H
...
class AliAnalysisTaskMcKnoUeVsMult : public AliAnalysisTaskSE
{
public:
    AliAnalysisTaskMcKnoUeVsMult();
	AliAnalysisTaskMcKnoUeVsMult(const char *name);
	
    virtual                 ~AliAnalysisTaskMcKnoUeVsMult();
    ...
    void       SetV0Amin(Double_t V0Amin)          {fV0Amin = V0Amin;}   // Set V0M min value
    void       SetV0Amax(Double_t V0Amax)          {fV0Amax = V0Amax;}   // Set V0M max value
...
private:
    ...
    Double_t fpercentileV0A;
    Double_t fv0Apercentilebefvtx;
...
//     
    ...
    TH1D * hMultV0A;
    TH1D *hV0Amultbefvtx;
    TH2D * hRefMultvsMultV0A;

	AliAnalysisTaskMcKnoUeVsMult(const AliAnalysisTaskMcKnoUeVsMult&);                  // not implemented
	AliAnalysisTaskMcKnoUeVsMult& operator=(const AliAnalysisTaskMcKnoUeVsMult&);       // not implemented

	ClassDef(AliAnalysisTaskMcKnoUeVsMult, 3);
};
