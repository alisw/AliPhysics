...
AliAnalysisTask* AddTaskUeMultDep()
{
  ...
  AliAnalysisManager *mgr = AliAnalysisManager::GetAnalysisManager();
   if(!mgr){
    ::Error("AddTaskUeMultDep", "No analysis manager to connect to.");
      return NULL; 
    }
// Check the analysis type using the event handlers connected to the analysis manager.  
//==============================================================================
  if(!mgr->GetInputEventHandler()){
   ::Error("AddTaskUeMultDep", "This task requires an input event handler");
      return NULL;   
   }
  ...
  AliAnalysisTaskUeMultDep * Mytask = new AliAnalysisTaskUeMultDep("AnalysisUeMultDep");
