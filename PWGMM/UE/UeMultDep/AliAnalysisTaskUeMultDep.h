...
//	virtual void  SetTrigger(UInt_t ktriggerInt) {ftrigBit = ktriggerInt;}
	...
	private:
		...
		TH2D * hMultTSvsRefMult08;
		TH2D * hSumptVsTrackRT;//SumpT vs Nch plot...
		TH3D * hpTLvsRefMult08vsRT;
		TH3D * hDeltaphiVspTLVsRT;
		TH3D * hDeltaphiVsMultVsRT;
		...
		TH2D * hMultTSvsRefMult08pTL5;
		TH2D * hSumptVsTrackRTpTL5;//SumpT vs Nch plot...
		TH3D * hpTLvsRefMult08vsRTpTL5;
		TH3D * hDeltaphiVspTLVsRTpTL5;
		TH3D * hDeltaphiVsMultVsRTpTL5;
