...
#include "AliPMDppAnalysisTaskData.h"
...
ClassImp(AliPMDppAnalysisTaskData)

//.......................................................//

AliPMDppAnalysisTaskData::AliPMDppAnalysisTaskData(const char *name)
...
void AliPMDppAnalysisTaskData::UserCreateOutputObjects() {
  ...
  fHistTotEvent->GetXaxis()->SetBinLabel(3, "Pileup from SPD");
...
//________________________________________________________________________
void AliPMDppAnalysisTaskData::UserExec(Option_t *) {
  // Main loop
  ...
  Float_t fV0mult = 0.0, fV0Amult = 0.0, fV0Cmult = 0.0, GlobalTracks = 0.0, VtxZ;
  ...
  Bool_t pileUp = fESD->IsPileupFromSPD(3, 0.8, 3., 2., 5.);
  if(pileUp) return;
...
//________________________________________________________________________
void AliPMDppAnalysisTaskData::Terminate(Option_t *) {
