#ifndef ALIEMCAGEOMETRY_H
#define ALIEMCAGEOMETRY_H
...
class AliEMCAGeometry : public TObject {

public: 

           AliEMCAGeometry();
  virtual ~AliEMCAGeometry(void) {}
...
private:
  ...
  ClassDef(AliEMCAGeometry,1)             // EMCA geometry class 

} ;

#endif // AliEMCAGEOMETRY_H
