#ifndef ALICPVBASEGEOMETRY_H
#define ALICPVBASEGEOMETRY_H
...
class AliCPVBaseGeometry : public TObject {

public: 

           AliCPVBaseGeometry()     {}
  virtual ~AliCPVBaseGeometry(void) {}
  ...
  ClassDef(AliCPVBaseGeometry,1)        // CPV base geometry class 

} ;

#endif // ALICPVBASEGEOMETRY_H
