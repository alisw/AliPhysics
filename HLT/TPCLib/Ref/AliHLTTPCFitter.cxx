...
void AliHLTTPCFitter::SortTrackClusters(AliHLTTPCTrack *track)
{
...
void AliHLTTPCFitter::UpdateTrack(AliHLTTPCTrack *track)
{
...
//
  ...
  if ( fVertexConstraint == kTRUE)
  ...
  else 
    {
      ...
      if ( phi0 < 0 ) phi0 += 2*AliHLTTPCTransform::Pi();
