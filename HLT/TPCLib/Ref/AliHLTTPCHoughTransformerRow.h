...
struct AliHLTTPCPadHoughParams {
...
class AliHLTTPCHoughTransformerRow : public AliHLTTPCHoughBaseTransformer {
 ...
 private:
  ...
  AliHLTTPCPadHoughParams **fStartPadParams; //!
  AliHLTTPCPadHoughParams **fEndPadParams; //!
  Float_t **fLUTr; //!
  ...
  inline void FillCluster(UChar_t i,Int_t etaindex,AliHLTTPCEtaRow *etaclust,Int_t ilastpatch,Int_t firstbinx,Int_t lastbinx,Int_t nbinx,Int_t firstbiny);
#ifdef do_mc
  inline void FillClusterMCLabels(AliHLTTPCDigitData digpt,AliHLTTPCEtaRow *etaclust);
#endif
