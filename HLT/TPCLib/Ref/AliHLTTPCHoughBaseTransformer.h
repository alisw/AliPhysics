...
typedef struct AliHLTTPCTrackIndex AliHLTTPCTrackIndex;
#endif
...
class AliHLTTPCHoughBaseTransformer {
 ...
 public:
  ...
  AliHLTTPCHoughBaseTransformer(Int_t slice,Int_t patch,Int_t netasegments,Float_t zvertex=0.0);
  virtual ~AliHLTTPCHoughBaseTransformer();
  ...
  AliHLTTPCHoughBaseTransformer *GetLastTransfromer() const {return fLastTransformer;}
  ...
  void SetLastTransformer(AliHLTTPCHoughBaseTransformer *transformer) {fLastTransformer = transformer;}
 ...
 protected:
  ...
  AliHLTTPCHoughBaseTransformer *fLastTransformer;//Pointer to the previous hough transformer
 ...
 private:
  ...
  ClassDef(AliHLTTPCHoughBaseTransformer,1) //Hough transformation base class
