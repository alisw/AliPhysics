...
const AliHLTComponentDataType& AliHLTTPCDefinitions::UnpackedRawLateDataType() {
  static AliHLTComponentDataType dt = AliHLTComponentDataTypeInitializer("RAWUPAKL", kAliHLTDataOriginTPC);
  return dt;
}
