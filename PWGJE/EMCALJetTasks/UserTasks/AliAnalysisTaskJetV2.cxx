...
void AliAnalysisTaskJetV2::UserCreateOutputObjects()
{
   ...
   // vn profile
    ...
    fHistQxV0aBC = BookTH2F("fHistQxV0aBC", "Q_{x} V0A", "centrality class", 140, -700, 500, 70, -.5, 9.5);
    fHistQyV0aBC = BookTH2F("fHistQyV0aBC", "Q_{y} V0A", "centrality class", 140, -700, 500, 70, -.5, 9.5);
    fHistQxV0cBC = BookTH2F("fHistQxV0cBC", "Q_{x} V0C", "centrality class", 140, -700, 500, 70, -.5, 9.5);
    fHistQyV0cBC = BookTH2F("fHistQyV0cBC", "Q_{y} V0C", "centrality class", 140, -700, 500, 70, -.5, 9.5);
