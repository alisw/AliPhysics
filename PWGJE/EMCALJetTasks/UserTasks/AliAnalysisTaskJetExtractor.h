...
class AliEmcalJetTree : public TNamed
{
  public:
    ...
    // ######################################
    Bool_t          AddJetToTree(AliEmcalJet* jet, Double_t* vertex = 0, Float_t centrality = 0, Int_t multiplicity = 0, Long64_t eventID = 0, Float_t magField = 0,
    ...
    {
      return AddJetToTree(jet, vertex, centrality, multiplicity, eventID, magField, motherParton, motherHadron, partonInitialCollision, matchDistance, matchedPt, matchedMass, truePtFraction, ptHard, eventWeight, impactParameter,
    ...
    Bool_t          AddJetToTree(AliEmcalJet* jet, Double_t* vertex, Float_t centrality, Int_t multiplicity, Long64_t eventID, Float_t magField,
