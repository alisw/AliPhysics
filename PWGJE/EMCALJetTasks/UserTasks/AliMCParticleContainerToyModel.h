/// \class AliMCParticleContainerToyModel
/// \brief Allows to modify the tracks to implement toy models
///
/// This class derives from AliMCParticleContainer.
...
#ifndef ALIMCPARTICLECONTAINERTOYMODEL_H
#define ALIMCPARTICLECONTAINERTOYMODEL_H
...
class AliMCParticleContainerToyModel : public AliMCParticleContainer {
public:
