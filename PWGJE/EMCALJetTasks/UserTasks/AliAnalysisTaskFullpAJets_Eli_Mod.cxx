#include "AliAnalysisTaskFullpAJets_Eli_Mod.h"
...
AliAnalysisTaskFullpAJets_Eli_Mod::AliAnalysisTaskFullpAJets_Eli_Mod() :
...
//________________________________________________________________________
AliAnalysisTaskFullpAJets_Eli_Mod::AliAnalysisTaskFullpAJets_Eli_Mod(const char *name) :
...
//________________________________________________________________________
void AliAnalysisTaskFullpAJets_Eli_Mod::UserCreateOutputObjects()
{
    // Create histograms
...
void AliAnalysisTaskFullpAJets_Eli_Mod::UserExecOnce()
{
    ...
    cout<<"get charged jets"<<endl;
    // Get charged jets
    if(fkTChargedName!="")  fmyKTChargedJets = dynamic_cast <TClonesArray*>(InputEvent()->FindListObject(fkTChargedName));
    if(fAkTChargedName!="")fmyAKTChargedJets = dynamic_cast <TClonesArray*>(InputEvent()->FindListObject(fAkTChargedName));

    cout<<"get full jets"<<endl;
     // Get the full jets
    if(fkTFullName!="")  fmyKTFullJets = dynamic_cast <TClonesArray*>(InputEvent()->FindListObject(fkTFullName));
...
cout<<"1"<<endl;
   ...
   //Eli       InitChargedJets();
        ...
        if (fCalculateRhoJet>=1)
        {
            if (fDoJetRhoDensity == kTRUE && fDo3DHistos == kTRUE)
            {
            	//ELI ChargedJetEnergyDensityProfile();
            }
            if (fMCPartLevel==kTRUE)
            {
            	//ELI EstimateChargedRhoCMS();
            }
        }
 ...
 //Eli   InitChargedJets();
    ...
    {
        cout<<"91"<<endl;
       //ELI  EstimateChargedRhoCMSScale();
   }
    if (fCalculateRhoJet>=1)
    {
        cout<<"92"<<endl;
        //ELI    EstimateChargedRhoScale();
        if (fDoJetRhoDensity == kTRUE && fDo3DHistos == kTRUE)
        {
        	//ELI        ChargedJetEnergyDensityProfile();
...
void AliAnalysisTaskFullpAJets_Eli_Mod::TrackCuts()
{
...
void AliAnalysisTaskFullpAJets_Eli_Mod::ClusterCuts()
{
...
void AliAnalysisTaskFullpAJets_Eli_Mod::EventCounts()
{
    TrackCuts();
    if (fMCPartLevel == kTRUE)
    {
...
void AliAnalysisTaskFullpAJets_Eli_Mod::TrackHisto()
{
...
void AliAnalysisTaskFullpAJets_Eli_Mod::ClusterHisto()
{
...
void AliAnalysisTaskFullpAJets_Eli_Mod::InitChargedJets()
{
...
void AliAnalysisTaskFullpAJets_Eli_Mod::GenerateEMCalRandomConesPt()
{
    Int_t i,j;
    Double_t E_tracks_total=0.;
...
// Charged Rho's
void AliAnalysisTaskFullpAJets_Eli_Mod::EstimateChargedRho0()
{
    Int_t i;
...
void AliAnalysisTaskFullpAJets_Eli_Mod::EstimateChargedRho1()
{
    Int_t i;
    Double_t E_tracks_total=0.0;
    Double_t TPC_rho=0.;
...
void AliAnalysisTaskFullpAJets_Eli_Mod::EstimateChargedRho2()
{
    Int_t i;
    Double_t E_tracks_total=0.0;
    Double_t TPC_rho=0.;
...
void AliAnalysisTaskFullpAJets_Eli_Mod::EstimateChargedRhoN()
{
    Int_t i,j;
...
void AliAnalysisTaskFullpAJets_Eli_Mod::EstimateChargedRhoScale()
{
    Int_t i,j;
    Bool_t track_away_from_jet;
    Double_t E_tracks_total=0.0;
...
void AliAnalysisTaskFullpAJets_Eli_Mod::EstimateChargedRhokT()
{
    Int_t i;
    Double_t kTRho = 0.0;
...
void AliAnalysisTaskFullpAJets_Eli_Mod::EstimateChargedRhokTScale()
{
    Int_t i;
    Double_t kTRho = 0.0;
    Double_t *pTArray = new Double_t[fTPCkTFullJet->GetTotalJets()];
...
void AliAnalysisTaskFullpAJets_Eli_Mod::EstimateChargedRhoCMS()
{
    Int_t i,k;
    Double_t kTRho = 0.0;
...
void AliAnalysisTaskFullpAJets_Eli_Mod::EstimateChargedRhoCMSScale()
{
    Int_t i,k;
    Double_t kTRho = 0.0;
    Double_t CMSTotalkTArea = 0.0;
...
// Full Rho's
void AliAnalysisTaskFullpAJets_Eli_Mod::EstimateFullRho0()
{
    Int_t i;
    Double_t E_tracks_total=0.0;
...
void AliAnalysisTaskFullpAJets_Eli_Mod::EstimateFullRho1()
{
    Int_t i;
    Double_t E_tracks_total=0.0;
    Double_t E_caloclusters_total=0.0;
...
void AliAnalysisTaskFullpAJets_Eli_Mod::EstimateFullRho2()
{
    Int_t i;
    Double_t E_tracks_total=0.0;
    Double_t E_caloclusters_total=0.0;
...
void AliAnalysisTaskFullpAJets_Eli_Mod::EstimateFullRhoN()
{
    Int_t i,j;
    Bool_t track_away_from_jet;
...
void AliAnalysisTaskFullpAJets_Eli_Mod::EstimateFullRhoDijet()
{
    Int_t i;
    Double_t E_tracks_total=0.0;
    Double_t E_caloclusters_total=0.0;
...
void AliAnalysisTaskFullpAJets_Eli_Mod::EstimateFullRhokT()
{
    Int_t i;
    Double_t kTRho = 0.0;
...
void AliAnalysisTaskFullpAJets_Eli_Mod::EstimateFullRhoCMS()
{
    Int_t i,k;
    Double_t kTRho = 0.0;
    Double_t CMSTotalkTArea = 0.0;
...
void AliAnalysisTaskFullpAJets_Eli_Mod::FullJetEnergyDensityProfile()
{
    Int_t i,j;
    Double_t delta_R;
    Double_t dR=0.0;
...
void AliAnalysisTaskFullpAJets_Eli_Mod::ChargedJetEnergyDensityProfile()
{
    Int_t i,j;
    Double_t delta_R;
    Double_t dR=0.0;
...
void AliAnalysisTaskFullpAJets_Eli_Mod::DeleteJetData(Int_t delOption)
{
    if (delOption ==0)
    {
        delete fRecoUtil;
...
Bool_t AliAnalysisTaskFullpAJets_Eli_Mod::IsDiJetEvent()
{
...
Bool_t AliAnalysisTaskFullpAJets_Eli_Mod::InsideRect(Double_t phi,Double_t phi_min,Double_t phi_max,Double_t eta,Double_t eta_min,Double_t eta_max)
{
...
Bool_t AliAnalysisTaskFullpAJets_Eli_Mod::IsInEMCal(Double_t phi,Double_t eta)
{
    return InsideRect(phi,fEMCalPhiMin,fEMCalPhiMax,eta,fEMCalEtaMin,fEMCalEtaMax);
}

Bool_t AliAnalysisTaskFullpAJets_Eli_Mod::IsInEMCalFull(Double_t r,Double_t phi,Double_t eta)
{
    return InsideRect(phi,fEMCalPhiMin+r,fEMCalPhiMax-r,eta,fEMCalEtaMin+r,fEMCalEtaMax-r);
}

Bool_t AliAnalysisTaskFullpAJets_Eli_Mod::IsInEMCalPart(Double_t r,Double_t phi,Double_t eta)
{
    return InsideRect(phi,fEMCalPhiMin-r,fEMCalPhiMax+r,eta,fEMCalEtaMin-r,fEMCalEtaMax+r);
}

Bool_t AliAnalysisTaskFullpAJets_Eli_Mod::IsInTPCFull(Double_t r,Double_t phi,Double_t eta)
{
...
Bool_t AliAnalysisTaskFullpAJets_Eli_Mod::IsInTPC(Double_t r,Double_t phi,Double_t eta,Bool_t Complete)
{
    if (Complete==kTRUE)
    {
...
Bool_t AliAnalysisTaskFullpAJets_Eli_Mod::IsJetOverlap(AliEmcalJet *jet1,AliEmcalJet *jet2,Bool_t EMCalOn)
{
    Int_t i,j;
    Int_t jetTrack1=0;
    Int_t jetTrack2=0;
...
Double_t AliAnalysisTaskFullpAJets_Eli_Mod::AreaWithinTPC(Double_t r,Double_t eta)
{
    Double_t z;
    if (eta<(fTPCEtaMin+r))
    {
...
Double_t AliAnalysisTaskFullpAJets_Eli_Mod::AreaWithinEMCal(Double_t r,Double_t phi,Double_t eta)
{
    Double_t x,y;
...
Double_t AliAnalysisTaskFullpAJets_Eli_Mod::AreaEdge(Double_t r,Double_t z)
{
    Double_t a=TMath::Sqrt(r*r-z*z);
    return r*r*TMath::ASin(a/r)-a*z;
}

Double_t AliAnalysisTaskFullpAJets_Eli_Mod::AreaOverlap(Double_t r,Double_t x,Double_t y)
{
    Double_t a=TMath::Sqrt(r*r-x*x);
    Double_t b=TMath::Sqrt(r*r-y*y);
...
Double_t AliAnalysisTaskFullpAJets_Eli_Mod::TransverseArea(Double_t r,Double_t psi0,Double_t phi,Double_t eta)
{
...
Double_t AliAnalysisTaskFullpAJets_Eli_Mod::MedianRhokT(Double_t *pTkTEntries, Double_t *RhokTEntries, Int_t nEntries)
{
...
AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetData::AlipAJetData(const char *name, Bool_t isFull, Int_t nEntries) :
...
void AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetData::InitializeJetData(TClonesArray *jetList, Int_t nEntries)
{
    Int_t i=0;
    Int_t k=0;
    Int_t l=0;
...
// Setters
void AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetData::SetName(const char *name)
{
    fName = name;
}

void AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetData::SetIsJetsFull(Bool_t isFull)
{
    fIsJetsFull = isFull;
}

void AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetData::SetTotalEntries(Int_t nEntries)
{
    fnTotal = nEntries;
...
void AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetData::SetTotalJets(Int_t nJets)
{
    fnJets = nJets;
}

void AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetData::SetTotalSignalJets(Int_t nSignalJets)
{
    fnJetsSC = nSignalJets;
}

void AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetData::SetSignalCut(Double_t Pt)
{
    fSignalPt = Pt;
}

void AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetData::SetLeading(Int_t index, Double_t Pt)
{
    fPtMaxIndex = index;
    fPtMax = Pt;
}

void AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetData::SetSubLeading(Int_t index, Double_t Pt)
{
    fPtSubLeadingIndex = index;
    fPtSubLeading = Pt;
}

void AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetData::SetJetIndex(Int_t index, Int_t At)
{
    fJetsIndex[At] = index;
}

void AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetData::SetSignalJetIndex(Int_t index, Int_t At)
{
    fJetsSCIndex[At] = index;
}

void AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetData::SetIsJetInArray(Bool_t isInArray, Int_t At)
{
    fIsJetInArray[At] = isInArray;
}

void AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetData::SetAreaCutFraction(Double_t areaFraction)
{
    fAreaCutFrac = areaFraction;
}

void AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetData::SetJetR(Double_t jetR)
{
    fJetR = jetR;
}

void AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetData::SetNEF(Double_t nef)
{
    fNEF = nef;
}

void AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetData::SetSignalTrackPtBias(Bool_t chargedBias)
{
    fSignalTrackBias = chargedBias;
}

// Getters
Int_t AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetData::GetTotalEntries()
{
    return fnTotal;
}

Int_t AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetData::GetTotalJets()
{
    return fnJets;
}

Int_t AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetData::GetTotalSignalJets()
{
    return fnJetsSC;
}

Double_t AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetData::GetSignalCut()
{
    return fSignalPt;
}

Int_t AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetData::GetLeadingIndex()
{
    return fPtMaxIndex;
}

Double_t AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetData::GetLeadingPt()
{
    return fPtMax;
}

Int_t AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetData::GetSubLeadingIndex()
{
    return fPtSubLeadingIndex;
}

Double_t AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetData::GetSubLeadingPt()
{
    return fPtSubLeading;
}

Int_t AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetData::GetJetIndex(Int_t At)
{
    return fJetsIndex[At];
}

Int_t AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetData::GetSignalJetIndex(Int_t At)
{
    return fJetsSCIndex[At];
}

Bool_t AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetData::GetIsJetInArray(Int_t At)
{
    return fIsJetInArray[At];
}

Double_t AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetData::GetJetMaxChargedPt(Int_t At)
{
    return fJetMaxChargedPt[At];
}

Double_t AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetData::GetNEF()
{
    return fNEF;
}
...
// Constructors
AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetHistos::AlipAJetHistos() :
...
AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetHistos::AlipAJetHistos(const char *name) :
...
AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetHistos::AlipAJetHistos(const char *name, TString centag, Bool_t doNEF) :
...
AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetHistos::AlipAJetHistos(const char *name, TString centag, Bool_t doNEF, Bool_t doNEFSignalOnly, Bool_t doTHnSparse, Bool_t do3DPlotting) :
...
void AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetHistos::Init()
{
    Int_t i;
...
void AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetHistos::SetName(const char *name)
{
    fName = name;
}

void AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetHistos::SetCentralityTag(TString name)
{
    fCentralityTag = name.Data();
}

void AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetHistos::SetCentralityRange(Int_t bins, Double_t low, Double_t up)
{
...
void AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetHistos::SetPtRange(Int_t bins, Double_t low, Double_t up)
{
    fPtBins=bins;
    fPtLow=low;
    fPtUp=up;
...
void AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetHistos::SetRhoPtRange(Int_t bins, Double_t low, Double_t up)
{
    fRhoPtBins=bins;
    fRhoPtLow=low;
    fRhoPtUp=up;
...
void AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetHistos::SetDeltaPtRange(Int_t bins, Double_t low, Double_t up)
{
    fDeltaPtBins=bins;
    fDeltaPtLow=low;
    fDeltaPtUp=up;
...
void AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetHistos::SetBackgroundFluctuationsPtRange(Int_t bins, Double_t low, Double_t up)
{
...
void AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetHistos::SetLeadingJetPtRange(Int_t bins, Double_t low, Double_t up)
{
    fLJetPtBins=bins;
    fLJetPtLow=low;
    fLJetPtUp=up;
...
void AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetHistos::SetLeadingChargedTrackPtRange(Int_t bins, Double_t low, Double_t up)
{
...
void AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetHistos::SetNEFRange(Int_t bins, Double_t low, Double_t up)
{
    fNEFBins=bins;
    fNEFLow=low;
    fNEFUp=up;
...
void AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetHistos::SetSignalTrackPtBias(Bool_t chargedBias)
{
    fSignalTrackBias = chargedBias;
}

void AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetHistos::SetNEFJetDimensions(Int_t n)
{
    fnDimJet = n;
}

void AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetHistos::SetNEFClusterDimensions(Int_t n)
{
    fnDimCluster = n;
}

void AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetHistos::SetRhoValue(Double_t value)
{
    fRhoValue = value;
}

void AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetHistos::DoTHnSparse(Bool_t doTHnSparse)
{
    fDoTHnSparse = doTHnSparse;
}

void AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetHistos::Do3DPlotting(Bool_t do3DPlotting)
{
    fDo3DHistos = do3DPlotting;
}

void AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetHistos::FillRho(Double_t eventCentrality, Double_t rho)
{
    SetRhoValue(rho);
    fhRho->Fill(rho);
...
void AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetHistos::FillBSJS(Double_t eventCentrality, Double_t rho, Double_t signalCut, TClonesArray *jetList, Int_t *indexJetList, Int_t nIndexJetList)
{
    Int_t i;
    Double_t tempPt=0.0;
...
void AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetHistos::FillDeltaPt(Double_t eventCentrality, Double_t rho, Double_t jetRadius, Double_t *RCArray, Int_t nRC)
{
    Int_t i;
    Double_t tempPt=0.0;
...
void AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetHistos::FillDeltaPtSignal(Double_t eventCentrality, Double_t rho, Double_t jetRadius, Double_t *RCArray, Int_t nRC)
{
    Int_t i;
    Double_t tempPt=0.0;
...
void AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetHistos::FillDeltaPtNColl(Double_t eventCentrality, Double_t rho, Double_t jetRadius, Double_t *RCArray, Int_t nRC)
{
    Int_t i;
    Double_t tempPt=0.0;
...
void AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetHistos::FillBackgroundFluctuations(Double_t eventCentrality, Double_t rho, Double_t jetRadius)
{
    Double_t tempPt=0.0;
...
void AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetHistos::FillLeadingJetPtRho(Double_t jetPt, Double_t rho)
{
    fpLJetRho->Fill(jetPt,rho);
}

void AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetHistos::DoNEFQAPlots(Bool_t doNEFAna)
{
    fDoNEFQAPlots = doNEFAna;
}

void AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetHistos::DoNEFSignalOnly(Bool_t doNEFSignalOnly)
{
    fDoNEFSignalOnly = doNEFSignalOnly;
}

void AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetHistos::DoNEFAnalysis(Double_t nefCut, Double_t signalCut, TClonesArray *jetList, Int_t *indexJetList, Int_t nIndexJetList, TObjArray *clusterList, TClonesArray *orgClusterList, AliVEvent *event, AliEMCALGeometry *geometry, AliEMCALRecoUtils *recoUtils, AliVCaloCells *cells)
{
...
void AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetHistos::FillMiscJetStats(TClonesArray *jetList, Int_t *indexJetList, Int_t nIndexJetList, TClonesArray *trackList, TClonesArray *clusterList, Double_t *vertex)
{
    Int_t i,j;
...
void AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetHistos::FillJetEventCentrality(Double_t leadingJetPt, AliVEvent *event)
{
    Double_t event_centrality = event->GetCentrality()->GetCentralityPercentile(fCentralityTag);
...
TList* AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetHistos::GetOutputHistos()
{
    return fOutput;
}

Double_t AliAnalysisTaskFullpAJets_Eli_Mod::AlipAJetHistos::GetRho()
{
    return fRhoValue;
}
