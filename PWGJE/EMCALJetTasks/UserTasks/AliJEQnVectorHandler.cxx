...
using namespace std;
/// \cond CLASSIMP
ClassImp(AliJEQnVectorHandler);
/// \endcond

//________________________________________________________________
AliJEQnVectorHandler::AliJEQnVectorHandler():
    fHarmonic(2),
    fNormMethod(kQoverM),
    fCalibType(kQnCalib),
    fEtaMinTPC(0.),
...
//________________________________________________________________
AliJEQnVectorHandler::AliJEQnVectorHandler(int calibType, int normMeth, int harmonic, TString OADBfileName):
    fHarmonic(harmonic),
...
//________________________________________________________________
bool AliJEQnVectorHandler::SetAODEvent(AliAODEvent* event)
{
    if(!event) {
...
//________________________________________________________________
void AliJEQnVectorHandler::ResetAODEvent() 
{
    fAODEvent       = nullptr;
    fRun            = -9999;
    fCentrality     = -9999.;
...
//________________________________________________________________
bool AliJEQnVectorHandler::ComputeCalibratedQnVectorTPC(bool forceCalc) 
{
...
//________________________________________________________________
bool AliJEQnVectorHandler::ComputeCalibratedQnVectorV0(bool forceCalc) 
{
...
//________________________________________________________________
void AliJEQnVectorHandler::GetQnVecTPC(double QnVecFullTPC[2], double QnVecPosTPC[2], double QnVecNegTPC[2])
{
    switch(fNormMethod) {
...
//________________________________________________________________
void AliJEQnVectorHandler::GetQnVecV0(double QnVecFullV0[2], double QnVecV0A[2], double QnVecV0C[2])
{
    switch(fNormMethod) {
        case 0: //kQoverQlength
            for(int iComp=0; iComp<2; iComp++) {
...
//________________________________________________________________
void AliJEQnVectorHandler::GetUnNormQnVecTPC(double QnVecFullTPC[2], double QnVecPosTPC[2], double QnVecNegTPC[2])
{
    for(int iComp=0; iComp<2; iComp++) {
        QnVecFullTPC[iComp] = fQnVecFullTPC[iComp];
        QnVecPosTPC[iComp]  = fQnVecPosTPC[iComp];
...
//________________________________________________________________
void AliJEQnVectorHandler::GetUnNormQnVecV0(double QnVecFullV0[2], double QnVecV0A[2], double QnVecV0C[2])
{
    for(int iComp=0; iComp<2; iComp++) {
        QnVecFullV0[iComp] = fQnVecFullV0[iComp];
        QnVecV0A[iComp]  = fQnVecV0A[iComp];
...
//________________________________________________________________
void AliJEQnVectorHandler::GetMultQnVecTPC(double &MultFullTPC, double &MultPosTPC, double &MultNegTPC)
{
...
//________________________________________________________________
void AliJEQnVectorHandler::GetMultQnVecV0(double &MultFullV0, double &MultV0A, double &MultV0C)
{
...
//________________________________________________________________
void AliJEQnVectorHandler::GetEventPlaneAngleTPC(double &EvPlaneFullTPC, double &EvPlanePosTPC, double &EvPlaneNegTPC)
{
...
//________________________________________________________________
void AliJEQnVectorHandler::GetEventPlaneAngleV0(double &EvPlaneFullV0, double &EvPlaneV0A, double &EvPlaneV0C)
{
...
//________________________________________________________________
void AliJEQnVectorHandler::RemoveTracksFromQnTPC(vector<AliAODTrack*> trToRem, double QnVecFullTPC[2], double QnVecPosTPC[2], double QnVecNegTPC[2], double &multFullTPC, double &multPosTPC, double &multNegTPC, bool getUnNormalised) 
{
    for(int iComp=0; iComp<2; iComp++) {
        QnVecFullTPC[iComp] = fQnVecFullTPC[iComp];
        QnVecPosTPC[iComp]  = fQnVecPosTPC[iComp];
...
//________________________________________________________________
void AliJEQnVectorHandler::EnablePhiDistrHistos() 
{
...
//________________________________________________________________
void AliJEQnVectorHandler::ComputeQvecQnFrameworkTPC() 
{
...
//________________________________________________________________
void AliJEQnVectorHandler::ComputeQvecQnFrameworkV0() 
{
    if(!fQnVectorTask || !fQnVectorMgr) {
        AliWarning("Qn-framework task not found!");
        return;
...
void AliJEQnVectorHandler::ComputeQvecTPC() 
{
    short centbin = GetCentBin();
...
//__________________________________________________________
void AliJEQnVectorHandler::ComputeQvecV0()
{
    //initialise Q vectors
    for(int iComp=0; iComp<2; iComp++) {
...
//__________________________________________________________
short AliJEQnVectorHandler::GetVertexZbin() const
{
    if(!fV0CalibZvtxDiff)
...
//__________________________________________________________
short AliJEQnVectorHandler::GetCentBin() const
{
    short centbin = -10;
...
//__________________________________________________________
bool AliJEQnVectorHandler::IsTrackSelected(AliAODTrack* track) {
