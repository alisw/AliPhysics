/**
 * Implemenation for AliAnalysisTaskEmcalJetHPerformanceConstits
 */

#include "AliAnalysisTaskEmcalJetHPerformanceConstits.h"
...
ClassImp(PWGJE::EMCALJetTasks::AliAnalysisTaskEmcalJetHPerformanceConstits);
 ...
 * Default constructor
 */
AliAnalysisTaskEmcalJetHPerformanceConstits::AliAnalysisTaskEmcalJetHPerformanceConstits():
  AliAnalysisTaskEmcalJet("AliAnalysisTaskEmcalJetHPerformanceConstits", kFALSE),
  fYAMLConfig(),
 ...
 */
AliAnalysisTaskEmcalJetHPerformanceConstits::AliAnalysisTaskEmcalJetHPerformanceConstits(const char * name):
 ...
 * Copy constructor
 */
AliAnalysisTaskEmcalJetHPerformanceConstits::AliAnalysisTaskEmcalJetHPerformanceConstits(const AliAnalysisTaskEmcalJetHPerformanceConstits & other):
 ...
 */
AliAnalysisTaskEmcalJetHPerformanceConstits & AliAnalysisTaskEmcalJetHPerformanceConstits::operator=(AliAnalysisTaskEmcalJetHPerformanceConstits other)
{
  swap(*this, other);
  return *this;
}
 ...
 */
double AliAnalysisTaskEmcalJetHPerformanceConstits::DetermineTrackingEfficiency(double trackPt, double trackEta)
{
  return AliAnalysisTaskEmcalJetHUtils::DetermineTrackingEfficiency(
   trackPt, trackEta, fCentBin, fEfficiencyPeriodIdentifier,
   "PWGJE::EMCALJetTasks::AliAnalysisTaskEmcalJetHPerformanceConstits");
}

/**
 * Retrieve task properties from the YAML configuration.
 */
void AliAnalysisTaskEmcalJetHPerformanceConstits::RetrieveAndSetTaskPropertiesFromYAMLConfig()
{
  // Base class options
 ...
 */
void AliAnalysisTaskEmcalJetHPerformanceConstits::SetupJetContainersFromYAMLConfig()
{
 ...
 */
void AliAnalysisTaskEmcalJetHPerformanceConstits::SetupParticleContainersFromYAMLConfig()
{
 ...
 */
void AliAnalysisTaskEmcalJetHPerformanceConstits::SetupClusterContainersFromYAMLConfig()
{
 ...
 * Initialize task.
 */
bool AliAnalysisTaskEmcalJetHPerformanceConstits::Initialize()
{
  fConfigurationInitialized = false;
 ...
 */
void AliAnalysisTaskEmcalJetHPerformanceConstits::UserCreateOutputObjects()
{
 ...
 */
void AliAnalysisTaskEmcalJetHPerformanceConstits::SetupCellQAHistsWithPrefix(const std::string & prefix)
{
 ...
 */
void AliAnalysisTaskEmcalJetHPerformanceConstits::SetupCellQAHists()
{
 ...
 */
void AliAnalysisTaskEmcalJetHPerformanceConstits::SetupQAHists()
{
  // Cell level QA
 ...
 */
void AliAnalysisTaskEmcalJetHPerformanceConstits::SetupJetMatchingQA()
{
  // Setup
 ...
 */
void AliAnalysisTaskEmcalJetHPerformanceConstits::SetupResponseMatrixHists()
{
  ...
  for (unsigned int iJet = 1; iJet < 3; iJet++)
  {
    ...
    fResponseMatrixFillMap.insert(std::make_pair(std::string("p_{T,particle,") + std::to_string(iJet) + "}^{leading} (GeV/c)", std::make_pair(iJet, &ResponseMatrixFillWrapper::fLeadingHadronPt)));
     // pt Jet Constituents //CHARLES EDITS
    fResponseMatrixFillMap.insert(std::make_pair(std::string("p_{T, ") + std::to_string(iJet) + "}^{MC constit.}", std::make_pair(iJet, &ResponseMatrixFillWrapper::fPtconstit)));
  }
 ...
 * Main event loop
 */
Bool_t AliAnalysisTaskEmcalJetHPerformanceConstits::Run()
{
 ...
 */
void AliAnalysisTaskEmcalJetHPerformanceConstits::QAHists()
{
 ...
 */
void AliAnalysisTaskEmcalJetHPerformanceConstits::FillCellQAHists(const std::string & prefix, AliVCaloCells * cells)
{
 ...
 */
void AliAnalysisTaskEmcalJetHPerformanceConstits::FillCellQAHists()
{
 ...
 * Fill QA histograms.
 */
void AliAnalysisTaskEmcalJetHPerformanceConstits::FillQAHists()
{
  if (fCreateCellQAHists) {
    FillCellQAHists();
  }
 ...
 */
void AliAnalysisTaskEmcalJetHPerformanceConstits::ResetMatching(const AliJetContainer &c) const
{
  for(auto j : c.all()){
    j->ResetMatching();
  }
 ...
 */
bool AliAnalysisTaskEmcalJetHPerformanceConstits::PerformGeometricalJetMatching(AliJetContainer& contBase,
 ...
 */
void AliAnalysisTaskEmcalJetHPerformanceConstits::FillJetMatchingQA(AliJetContainer& contBase, AliJetContainer& contTag,
 ...
 */
void AliAnalysisTaskEmcalJetHPerformanceConstits::ResponseMatrix()
{
  //cout<<"\nWe stepped into the function !!!!!!!!!!\n"<<endl;
  AliJetContainer * jetsHybrid = GetJetContainer("hybridLevelJets");
  AliJetContainer * jetsDetLevel = GetJetContainer("detLevelJets");
  AliJetContainer * jetsPartLevel = GetJetContainer("partLevelJets");
  ...
  for (auto jet1 : jetsHybrid->accepted())
  {
    ...
    if (fResponseFromThreeJetCollections) {
      ...
      jetToPass = jet3;
      container = 3; //particle level pythia
    }
    else {
      // Use for the response
      AliDebugStream(4) << "Using one stage matching for response\n";
      jetToPass = jet2;
      container = 2; //detector level pythia
    }

    // Fill response
    FillResponseMatrix(jet1, jetToPass, rhoHybrid, container);
  }
 ...
 */
void AliAnalysisTaskEmcalJetHPerformanceConstits::FillResponseMatrix(AliEmcalJet * jet1, AliEmcalJet * jet2, const double jet1Rho, const Int_t container)
{
  if (!jet1 || !jet2) {
  ...
  AliJetContainer * jetsHybrid = GetJetContainer("hybridLevelJets");
  AliJetContainer * jetsDetLevel = GetJetContainer("detLevelJets"); // container == 2
  AliJetContainer * jetsPartLevel = GetJetContainer("partLevelJets");  //container == 3
...
/*
  std::map<unsigned int, ResponseMatrixFillWrapper> jetNumberToJet = {
    std::make_pair(1, CreateResponseMatrixFillWrapper(jet1, jet1Rho, container)),
    // We would never want to rho subtract the second jet, regardless of whether it's external
    // detector level or particle level.
    std::make_pair(2, CreateResponseMatrixFillWrapper(jet2, 0, container))
  };
*/

  //temporary code to explore extracting jet constituents: (CHARLES ADDED THESE LINES !!!!)
  std::cout<<"\n\n\n___________________You are in Charles' EDIT block now !!!___________________\n\n\n"<<std::endl;

  std::map<unsigned int, ResponseMatrixFillWrapper> jetNumberToJet; //create map to be filled when you have a constit match !

  AliJetContainer * jetsmatched = 0; //EITHER partleveljets OR detleveljets, TBD below
  if(container == 2){
    std::cout<<"\ndetLevelJets is the appropriate container\n"<<std::endl;
    jetsmatched = jetsDetLevel;
  }
  else if(container == 3){
    std::cout<<"\npartLevelJets is the appropriate container\n"<<std::endl;
    jetsmatched = jetsPartLevel;
  }

    Int_t ntrjet1= jet1->GetNumberOfTracks();
    AliVParticle* jetTrk1 = 0;

    Int_t ntrjet2= jet2->GetNumberOfTracks();
    AliVParticle* jetTrk2 = 0;

    for(Int_t itrk=0;itrk<ntrjet1;itrk++){
      jetTrk1=jet1->Track(itrk);
      std::cout<<""<<itrk<<"nth constit in jet1: pT = "<<jetTrk1->Pt()<<", px = "<<jetTrk1->Px()<<", py = "<<jetTrk1->Py()<<", pz = "<<jetTrk1->Pz()<<", E = "<<jetTrk1->E()<<", Label = "<<jetTrk1->GetLabel()<<std::endl;
    
         
    for(Int_t jtrk=0;jtrk<ntrjet2;jtrk++){
        jetTrk2=jet2->Track(jtrk);
        std::cout<<""<<jtrk<<"nth constit in jet2: pT = "<<jetTrk2->Pt()<<", px = "<<jetTrk2->Px()<<", py = "<<jetTrk2->Py()<<", pz = "<<jetTrk2->Pz()<<", E = "<<jetTrk2->E()<<", Label = "<<jetTrk2->GetLabel()<<std::endl;
        
      if( jetTrk1->GetLabel() == jetTrk2->GetLabel() ){ // you have a matched constituent !!!!

          jetNumberToJet = { std::make_pair(1, CreateResponseMatrixFillWrapper(jet1, jet1Rho, jetTrk1->Pt())), std::make_pair(2, CreateResponseMatrixFillWrapper(jet2, 0, jetTrk2->Pt()))  };
  ...
  /*
    const std::vector< PWG::JETFW::AliEmcalParticleJetConstituent > Jet1Constits = jet1->GetParticleConstituents();
    const std::vector< PWG::JETFW::AliEmcalParticleJetConstituent > Jet2Constits = jet2->GetParticleConstituents();
  
    Int_t constitcounterjet1 = 1;
    for(auto constit1 : Jet1Constits){
      //const AliVParticle *track1 = constit1.GetParticle(); //get the full damn particle (AliVParticle)
      //std::cout<<""<<constitcounterjet1<<"nth constit in jet1: pT = "<<track1->Pt()<<", px = "<<track1->Px()<<", py = "<<track1->Py()<<", pz = "<<track1->Pz()<<", E = "<<track1->E()<<", GenI = "<<track1->GetGeneratorIndex()<<std::endl;
      if( constit1.IsFromEmbeddedEvent() ){
        std::cout<<""<<constitcounterjet1<<"nth Pythia constit in jet1: pT = "<<constit1.Pt()<<", px = "<<constit1.Px()<<", py = "<<constit1.Py()<<", pz = "<<constit1.Pz()<<", E = "<<constit1.E()<<", GI = "<<constit1.GetGlobalIndex()<<std::endl;
        constitcounterjet1++;
      }
    }

    Int_t constitcounterjet2 = 1;
    for(auto constit2 : Jet2Constits){
      //const AliVParticle *track2 = constit2.GetParticle(); //get the full damn particle (AliVParticle)
      //std::cout<<""<<constitcounterjet2<<"nth constit in jet2: pT = "<<track2->Pt()<<", px = "<<track2->Px()<<", py = "<<track2->Py()<<", pz = "<<track2->Pz()<<", E = "<<track2->E()<<", GenI = "<<track2->GetGeneratorIndex()<<std::endl;
      if( constit2.IsFromEmbeddedEvent() ){
        std::cout<<""<<constitcounterjet2<<"nth Pythia constit in jet2: pT = "<<constit2.Pt()<<", px = "<<constit2.Px()<<", py = "<<constit2.Py()<<", pz = "<<constit2.Pz()<<", E = "<<constit2.E()<<", GI = "<<constit2.GetGlobalIndex()<<std::endl;
        constitcounterjet2++;
      }
    }
  */
  std::cout<<"\n\n\n___________________You are out of Charles' EDIT block now !!!___________________\n\n\n"<<std::endl;
/* 
  // Fill histograms
  std::string histName = "response/fHistResponseMatrix";
  std::vector<double> values;
 ...
 *
 */
AliAnalysisTaskEmcalJetHPerformanceConstits::ResponseMatrixFillWrapper AliAnalysisTaskEmcalJetHPerformanceConstits::CreateResponseMatrixFillWrapper(AliEmcalJet * jet, const double rho, const Double_t pT_matched_constit) const
{
  ...
  wrapper.fPtconstit = pT_matched_constit;
 ...
 */
AliAnalysisTaskEmcalJetHPerformanceConstits * AliAnalysisTaskEmcalJetHPerformanceConstits::AddTaskEmcalJetHPerformanceConstits(const char * suffix)
{
  ...
  // Setup task name
  std::string taskName = "AliAnalysisTaskEmcalJetHPerformanceConstits";
  ...
  AliAnalysisTaskEmcalJetHPerformanceConstits * task = new AliAnalysisTaskEmcalJetHPerformanceConstits(taskName.c_str());
 ...
 */
std::string AliAnalysisTaskEmcalJetHPerformanceConstits::toString() const
{
 ...
 * AliAnalysisTaskEmcalJetHPerformanceConstits::toString. Used by operator<<
 * @param in output stream stream
 * @return reference to the output stream
 */
std::ostream & AliAnalysisTaskEmcalJetHPerformanceConstits::Print(std::ostream & in) const {
  in << toString();
  return in;
}
 ...
 * AliAnalysisTaskEmcalJetHPerformanceConstits::toString
 *
 * @param[in] opt Unused
 */
void AliAnalysisTaskEmcalJetHPerformanceConstits::Print(Option_t* opt) const
{
...
/**
 * Implementation of the output stream operator for AliAnalysisTaskEmcalJetHPerformanceConstits. Printing
