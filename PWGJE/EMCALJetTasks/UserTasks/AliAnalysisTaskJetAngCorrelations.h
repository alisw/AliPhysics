...
public:
    ...
    void     SetTrackBuffer             (AliAODTrack  *track, int particle);
...
private:
    ...
    TList           *fOutputData;   //!
    TList           *fQAList;       //!
    // AliAODTrack    **fTrackBufferProton; //!
    // AliAODTrack    **fTrackBufferAntiproton; //!
    // AliAODTrack    **fTrackBufferDeuteron; //!
    // AliAODTrack    **fTrackBufferAntideuteron; //!
    std::vector<AliAODTrack*> fTrackBufferProton; //!
    std::vector<AliAODTrack*> fTrackBufferAntiproton; //!
    std::vector<AliAODTrack*> fTrackBufferDeuteron; //!
    std::vector<AliAODTrack*> fTrackBufferAntideuteron; //!
