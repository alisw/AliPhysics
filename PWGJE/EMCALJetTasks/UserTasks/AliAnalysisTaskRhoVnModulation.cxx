...
void AliAnalysisTaskRhoVnModulation::UserCreateOutputObjects()
{
   ...
   // vn profile
    ...
    fHistPvalueCDFCent = BookTH2F("fHistPvalueCDFCent", "centrality", "p-value", 20, 0, 100, 20, 0, 1);
    fHistChi2Cent = BookTH2F("fHistChi2Cent", "centrality", "#tilde{#chi^{2}}", 20, 0, 100, 20, 0, 3);
    fHistKolmogorovTest = BookTH1F("fHistKolmogorovTest", "KolmogorovTest", 50, 0, 1);
    fHistKolmogorovTestCent = BookTH2F("fHistKolmogorovTestCent", "centrality", "Kolmogorov p", 20, 0, 100, 20, 0, 3); 
    fHistPvalueCDFROOT = BookTH1F("fHistPvalueCDFROOT", "CDF #chi^{2} ROOT", 50, 0, 1);
    fHistPvalueCDFROOTCent = BookTH2F("fHistPvalueCDFROOTCent", "centrality", "p-value ROOT", 20, 0, 100, 20, 0, 3);
    fHistChi2ROOTCent = BookTH2F("fHistChi2ROOTCent", "centrality", "#tilde{#chi^{2}}", 20, 0, 100, 20, 0, 3);
...
Bool_t AliAnalysisTaskRhoVnModulation::CorrectRho(Double_t psi2, Double_t psi3) 
{
    ...
    fHistPvalueCDFROOTCent->Fill(fCent, CDF);
