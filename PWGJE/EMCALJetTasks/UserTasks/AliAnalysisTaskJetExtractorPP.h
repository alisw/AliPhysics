#ifndef ALIANALYSISTASKJetExtractorPP_H
#define ALIANALYSISTASKJetExtractorPP_H
...
class AliEmcalJetTreePP;
class AliHFJetsTaggingVertex;

/**
 * \class AliAnalysisTaskJetExtractorPP
 * \brief Analysis task that implements AliEmcalJetTreePP to extract jets to a tree
 *
 ...
 * with adjustments by Sebastian Bysiak <sebastian.bysiak@cern.ch>
 * \date Jul 27, 2018
 */
//

class AliAnalysisTaskJetExtractorPP : public AliAnalysisTaskEmcalJet {
 public:
  ...
  AliAnalysisTaskJetExtractorPP();
  AliAnalysisTaskJetExtractorPP(const char *name);
  virtual ~AliAnalysisTaskJetExtractorPP();
  static AliAnalysisTaskJetExtractorPP* AddTaskJetExtractorPP(TString trackArray, TString clusterArray, TString jetArray, TString rhoObject, Double_t jetRadius, AliRDHFJetsCutsVertex* vertexerCuts, const char* taskNameSuffix);
  void                        UserCreateOutputObjects();
  void                        Terminate(Option_t *option);
  AliEmcalJetTreePP*            GetJetTree() {return fJetTree;}
 ...
 private:
  AliAnalysisTaskJetExtractorPP(const AliAnalysisTaskJetExtractorPP&);            // not implemented
  AliAnalysisTaskJetExtractorPP &operator=(const AliAnalysisTaskJetExtractorPP&); // not implemented

  /// \cond CLASSIMP
  ClassDef(AliAnalysisTaskJetExtractorPP, 4) // Jet extraction task
  /// \endcond
};


//###############################################################################################################################################3
const Int_t kMaxNumConstits = 500;
/**
 * \class AliEmcalJetTreePP
 ...
 */
//
class AliEmcalJetTreePP : public TNamed
{
  public:
    AliEmcalJetTreePP();
    AliEmcalJetTreePP(const char* name);
  ...
  private:
    ...
    /// \cond CLASSIMP
    ClassDef(AliEmcalJetTreePP, 10) // Jet tree class
    /// \endcond
};
