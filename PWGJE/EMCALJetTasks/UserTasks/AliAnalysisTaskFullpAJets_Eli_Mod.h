#ifndef AliAnalysisTaskFullpAJets_Eli_Mod_H
#define AliAnalysisTaskFullpAJets_Eli_Mod_H
...
class AliAnalysisTaskFullpAJets_Eli_Mod : public AliAnalysisTaskEmcalJet
{
    ...
    public:
    AliAnalysisTaskFullpAJets_Eli_Mod();
    AliAnalysisTaskFullpAJets_Eli_Mod(const char *name);
    ...
    AliAnalysisTaskFullpAJets_Eli_Mod(const AliAnalysisTaskFullpAJets_Eli_Mod&); // not implemented
    AliAnalysisTaskFullpAJets_Eli_Mod& operator=(const AliAnalysisTaskFullpAJets_Eli_Mod&); // not implemented
    
    ClassDef(AliAnalysisTaskFullpAJets_Eli_Mod, 1); // example of analysis
};
#endif
