#ifndef AliAnalysisTaskEmcalJetHPerformanceConstits_H
#define AliAnalysisTaskEmcalJetHPerformanceConstits_H

/**
 * @class AliAnalysisTaskEmcalJetHPerformanceConstits
...
namespace PWGJE { namespace EMCALJetTasks { class AliAnalysisTaskEmcalJetHPerformanceConstits; } }
std::ostream & operator<< (std::ostream &in, const PWGJE::EMCALJetTasks::AliAnalysisTaskEmcalJetHPerformanceConstits &myTask);
void swap(PWGJE::EMCALJetTasks::AliAnalysisTaskEmcalJetHPerformanceConstits & first, PWGJE::EMCALJetTasks::AliAnalysisTaskEmcalJetHPerformanceConstits & second);

namespace PWGJE {
namespace EMCALJetTasks {

class AliAnalysisTaskEmcalJetHPerformanceConstits : public AliAnalysisTaskEmcalJet {
 public:
  /**
  ...
  struct ResponseMatrixFillWrapper {
    ...
    double fPtconstit;          //!<! Constit of Jet pt //CHARLES EDITS 
  };

  AliAnalysisTaskEmcalJetHPerformanceConstits();
  AliAnalysisTaskEmcalJetHPerformanceConstits(const char * name);
  // Additional constructors
  AliAnalysisTaskEmcalJetHPerformanceConstits(const AliAnalysisTaskEmcalJetHPerformanceConstits & other);
  AliAnalysisTaskEmcalJetHPerformanceConstits& operator=(AliAnalysisTaskEmcalJetHPerformanceConstits other);
  friend void ::swap(AliAnalysisTaskEmcalJetHPerformanceConstits & first, AliAnalysisTaskEmcalJetHPerformanceConstits & second);
  ...
  // Utility functions
  // AddTask
  static AliAnalysisTaskEmcalJetHPerformanceConstits * AddTaskEmcalJetHPerformanceConstits(const char * suffix = "");
  // Printing
  std::string toString() const;
  friend std::ostream & ::operator<<(std::ostream &in, const AliAnalysisTaskEmcalJetHPerformanceConstits &myTask);
 ...
 private:
  ...
  void ResponseMatrix();
  void FillResponseMatrix(AliEmcalJet* jet1, AliEmcalJet* jet2, const double jet1Rho, const Int_t container);
  ResponseMatrixFillWrapper CreateResponseMatrixFillWrapper(AliEmcalJet * jet, const double rho, const Double_t pT_matched_constit) const;
  ...
  ClassDef(AliAnalysisTaskEmcalJetHPerformanceConstits, 7);
};

} /* namespace EMCALJetTasks */
} /* namespace PWGJE */

#endif /* AliAnalysisTaskEmcalJetHPerformanceConstits.h */
