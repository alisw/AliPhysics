AliAnalysisTaskRecursiveSoftDrop* AliAnalysisTaskRecursiveSoftDrop::AddTaskRecursiveSoftDrop(
  ...
  return AliAnalysisTaskRecursiveSoftDrop::AddTaskRecursiveSoftDrop(njetsData,njetsTrue,njetsDet,njetsHybridUs,njetsHybridS,R,nrhoBase,ntracksData,ntracksTrue,ntracksDet,ntracksHybridUs,ntracksHybridS,type,CentEst,pSel,trigClass,kEmcalTriggers,tag,jetShapeSub,fjetType);
