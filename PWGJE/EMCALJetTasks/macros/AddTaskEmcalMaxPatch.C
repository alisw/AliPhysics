EMCalTriggerPtAnalysis::AliAnalysisTaskEmcalMaxPatch *AddTaskMaxPatch(const char *dummy = "", const char *suffix = ""){
  AliAnalysisManager *mgr = AliAnalysisManager::GetAnalysisManager();

  TString taskname(Form("MaxPatchTask%s", suffix));
  EMCalTriggerPtAnalysis::AliAnalysisTaskEmcalMaxPatch *patchtask = EMCalTriggerPtAnalysis::AliAnalysisTaskEmcalMaxPatch(taskname.Data());
