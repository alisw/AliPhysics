...
)
{
  ...
  if (trackName == "mcparticles") {
    AliMCParticleContainer* mcpartCont = SpectraTriggerQA ->AddMCParticleContainer(trackName);
  }
  else if (trackName == "tracks" || trackName == "Tracks") {
    AliTrackContainer* trackCont = SpectraTriggerQA ->AddTrackContainer(trackName);
  }
  else if (!trackName.IsNull()) {
    SpectraTriggerQA ->AddParticleContainer(trackName);
  }
  SpectraTriggerQA ->AddClusterContainer(clusName);

  //-------------------------------------------------------
  // Final settings, pass to manager and set the containers
  //-------------------------------------------------------

  mgr->AddTask(SpectraTriggerQA);
  ...
  mgr->ConnectInput  (SpectraTriggerQA , 0,  cinput1 );
  mgr->ConnectOutput (SpectraTriggerQA , 1, coutput1 );
