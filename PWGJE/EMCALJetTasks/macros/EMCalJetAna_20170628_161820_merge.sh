...
export ARG="EMCalJetAna_20170628_161820_merge.C(\"$1\",$2)"
root -b -q -x $ARG
RET=$?
if [ "$RET" != "0" ];then
  echo "======== ERROR : EMCalJetAna_20170628_161820.C finished with NON zero code: $RET ========"
...
echo "======== EMCalJetAna_20170628_161820_merge.C finished with exit code: $? ========"
echo "############## memory after: ##############"
free -m
