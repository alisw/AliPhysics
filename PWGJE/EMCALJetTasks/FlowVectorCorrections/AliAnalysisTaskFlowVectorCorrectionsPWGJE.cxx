...
ClassImp(AliAnalysisTaskFlowVectorCorrectionsPWGJE)


AliAnalysisTaskFlowVectorCorrectionsPWGJE::AliAnalysisTaskFlowVectorCorrectionsPWGJE() :
...
AliAnalysisTaskFlowVectorCorrectionsPWGJE::AliAnalysisTaskFlowVectorCorrectionsPWGJE(const char* name) :
...
//_________________________________________________________________________________
void AliAnalysisTaskFlowVectorCorrectionsPWGJE::DefineInOutput(){
...
void AliAnalysisTaskFlowVectorCorrectionsPWGJE::SetCalibrationHistogramsFile(CalibrationFileSource source, const char *filename) {
...
//_________________________________________________________________________________
void AliAnalysisTaskFlowVectorCorrectionsPWGJE::UserCreateOutputObjects()
{
  //
  ...
  if (fFillEventQA) {
    if(fUseAliEventCuts)
      fAliEventCuts->AddQAplotsToList(fEventQAList);    
...
void AliAnalysisTaskFlowVectorCorrectionsPWGJE::NotifyRun() {
...
void AliAnalysisTaskFlowVectorCorrectionsPWGJE::UserExec(Option_t *){
  //
  ...
  if(!fUseAliEventCuts) {
    if (IsEventSelected((Float_t*)fDataBank)) {
    ...
    if (IsEventSelected((AliVEvent*)fEvent)) {
      fEventHistos->FillHistClass("Event_Analysis", fDataBank);
...
void AliAnalysisTaskFlowVectorCorrectionsPWGJE::FinishTaskOutput()
{
  //
  // Finish Task
  //
...
Bool_t AliAnalysisTaskFlowVectorCorrectionsPWGJE::IsEventSelected(Float_t* values) {

  if(!fEventCuts) return kTRUE;
  return fEventCuts->IsSelected(values);
}

Bool_t AliAnalysisTaskFlowVectorCorrectionsPWGJE::IsEventSelected(AliVEvent* fEvent) {

  if(!fEvent) return kFALSE;
  return fAliEventCuts->AcceptEvent(fEvent);
}
