...
// are taken from there but may be altered by CheckModuleFlags.
   ...
   */
   ...
   if(iPhysicsSelection && !iAODanalysis){
     ...
     iPhysicsSelectionFlag = AliTrigger::kMB;
   }
   ...
   if (iESDfilter && !iAODanalysis) {
      ...
      gROOT->LoadMacro("$ALICE_PHYSICS/PWGJE/macros/AddTaskESDFilterPWGJETrain.C");
   ...
   if (iPWG4FastEmbedding) {
     gROOT->LoadMacro("$ALICE_PHYSICS/PWGJE/macros/AddTaskFastEmbedding.C");
   ...
   // Jet analysis DEV
   if (iJETANReader) {
      gROOT->LoadMacro("$ALICE_PHYSICS/PWGJE/macros/AddTaskJetsReader.C");
  ...
  if ( !taskjets ) ::Warning("AnalysisTrainPWG4Jets", "AliAnalysisTaskJetsReader cannot run for this train conditions - EXCLUDED");
   ...
   if (iJETANFinder && iJETANReader) {
      gROOT->LoadMacro("$ALICE_PHYSICS/PWGJE/macros/AddTaskJetsFinder.C");
 ...
 if ( !taskjetsFinder || !taskjets ) ::Warning("AnalysisTrainPWG4Jets", "AliAnalysisTaskJetsFinder cannot run for this train conditions - EXCLUDED"); 
   ...
   if (iDIJETAN) {
      gROOT->LoadMacro("$ALICE_PHYSICS/PWGJE/macros/AddTaskDiJets.C");
   ...
   if(iPWG4TmpSourceSara){
     gROOT->LoadMacro("$ALICE_PHYSICS/PWGJE/macros/AddTaskEta.C");
   ...
   if(iPWG4JetServices){
     gROOT->LoadMacro("$ALICE_PHYSICS/PWGJE/macros/AddTaskJetServices.C");
   ...
   if(iPWG4JetSpectrum){
     gROOT->LoadMacro("$ALICE_PHYSICS/PWGJE/macros/AddTaskJetSpectrum2.C");
	 ...
	 for(int iJF = 0;iJF < kJetListSpectrum.GetSize();iJF++){
	   ...
	   for(int ic = 0;ic<5;ic++){
	     ...
	     for(int i = 0;i<TMath::Max(iPartner,1);i++){
	       if(bName2[i].Length()){
		 taskjetSpectrum = AddTaskJetSpectrum2(bName1.Data(),bName2[i].Data(),kDeltaAODJetName.Data(),kHighPtFilterMask,AliTrigger::kMB,0,ic);
		 bDone = kTRUE; 
	       }
	       else{
		 if(!bDone){
	 ...
	 taskjetSpectrum = AddTaskJetSpectrum2(kDefaultJetBranch.Data(),
					       "",kDeltaAODJetName.Data(),kHighPtFilterMask,AliTrigger::kMB,0,i);
	 

	 
	 if(kDefaultJetBranchMC.Length()){
	   taskjetSpectrum = AddTaskJetSpectrum2(kDefaultJetBranch.Data(),
					       kDefaultJetBranchMC.Data(),kDeltaAODJetName.Data(),kHighPtFilterMask,AliTrigger::kMB,0,i);
	 ...
	 if(kDefaultJetBranchMC2.Length()){
	   taskjetSpectrum = AddTaskJetSpectrum2(kDefaultJetBranch.Data(),
						 kDefaultJetBranchMC2.Data(),kDeltaAODJetName.Data(),kHighPtFilterMask,AliTrigger::kMB,0,i);
	   //	   taskjetSpectrum->SetMinJetPt(10);
	   taskjetSpectrum->SetTrackEtaWindow(fTrackEtaWindow);
	   taskjetSpectrum->SetJetEtaWindow(fJetEtaWindow);
	   taskjetSpectrum->SetBranchBkgRec(bkgClusters.Data());
	 ...
	 taskjetSpectrum = AddTaskJetSpectrum2(tmp2.Data(),kDefaultJetBranch.Data(),kDeltaAODJetName.Data(),kHighPtFilterMask,AliTrigger::kMB,0,i);
	 ...
	 taskjetSpectrum = AddTaskJetSpectrum2(tmp3.Data(),kDefaultJetBranch.Data(),kDeltaAODJetName.Data(),kHighPtFilterMask,AliTrigger::kMB,0,i);
	 //	 taskjetSpectrum->SetDebugLevel(3);
	 //	   taskjetSpectrum->SetMinJetPt(10);
	 taskjetSpectrum->SetBranchBkgRec(bkgClusters.Data());
	 taskjetSpectrum->SetBranchBkgGen(bkgClusters.Data());
   ...
   if(iPWG4JetChem){
     gROOT->LoadMacro("$ALICE_PHYSICS/PWGJE/macros/AddTaskJetChem.C");
   ...
   if (iPWG4JetResponse) {
     gROOT->LoadMacro("$ALICE_PHYSICS/PWGJE/macros/AddTaskJetResponse.C");
   ...
   if(iPWG4JCORRAN){
     gROOT->LoadMacro("$ALICE_PHYSICS/PWGJE/macros/AddTaskJCORRANTask.C");
   ...
   if(iPWG4UE){
     gROOT->LoadMacro("$ALICE_PHYSICS/PWGJE/macros/AddTaskUE.C");
   ...
   if(iPWG4LeadingUE){
     gROOT->LoadMacro("$ALICE_PHYSICS/PWGJE/macros/AddTaskLeadingTrackUE.C");
   ...
   if(iPWG4CorrectionsUE){
     gROOT->LoadMacro("$ALICE_PHYSICS/PWGJE/macros/AddTaskCorrectionsUE.C");
   ...
   if(iPWG4ThreeJets){
     gROOT->LoadMacro("$ALICE_PHYSICS/PWGJE/macros/AddTaskThreeJets.C");
   ...
   if(iPWG4QGSep){
     gROOT->LoadMacro("$ALICE_PHYSICS/PWGJE/macros/AddTaskQGSep.C");
   ...
   if(iPWG4Minijet){
     gROOT->LoadMacro("$ALICE_PHYSICS/PWGJE/macros/AddTaskMinijet.C");
   ...
   if(iPWG4PtQAMC){
     gROOT->LoadMacro("$ALICE_PHYSICS/PWGJE/macros/AddTaskPWG4HighPtQAMC.C");
   ...
   if(iPWG4PtTrackQA){
     gROOT->LoadMacro("$ALICE_PHYSICS/PWGJE/macros/AddTaskPWG4HighPtTrackQA.C");
   ...
   if(iPWG4PtQATPC){
     gROOT->LoadMacro("$ALICE_PHYSICS/PWGJE/macros/AddTaskPWG4HighPtQATPConly.C");
 ...
 if (!taskQATPC) ::Warning("AnalysisTrainPWG4Jets", "AliAnalysisTaskQATPC cannot run for this train conditions - EXCLUDED");
   ...
   if(iPWG4Cosmics){
     gROOT->LoadMacro("$ALICE_PHYSICS/PWGJE/macros/AddTaskPWG4CosmicCandidates.C");
   ...
   if(iPWG4PtSpectra){
     gROOT->LoadMacro("$ALICE_PHYSICS/PWGJE/macros/AddTaskPWG4HighPtSpectra.C");
