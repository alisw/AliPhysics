...
{  
  ...
  if (strRunPeriod == "lhc11h" || strRunPeriod == "lhc13b" || strRunPeriod == "lhc13c" || strRunPeriod == "lhc13d" || strRunPeriod == "lhc13e" || strRunPeriod == "lhc13f" || strRunPeriod == "lhc13g" || strRunPeriod == "lhc12g" || strRunPeriod == "lhc12a15e" || strRunPeriod == "lhc13b4" || strRunPeriod == "lhc13b4_fix" || strRunPeriod == "lhc13b4_plus" || strRunPeriod == "lhc12a15f") {
    filterBit  = 768;
    filterBit1 = 256;
    filterBit2 = 512;
    bIncludeNoITS = kFALSE;
  }
  else if (strRunPeriod == "lhc11a" || strRunPeriod == "lhc10h" || runPeriod.Contains("lhc12a15a") || runPeriod.Contains("lhc11a2")) {
    filterBit  = 272; 
    filterBit1 = 16;
    filterBit2 = 256;
    bIncludeNoITS = kTRUE;
