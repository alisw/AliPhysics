AliAnalysisTaskJetHadronCorrelation *AddTaskJetHadronCorrelation(Char_t *jf="ANTIKT",Float_t radius=0.4,UInt_t filter=256,Int_t backM=0,Float_t tPtcut=0.15,Int_t skipCone=0,Bool_t IsMC=true)
{
   ...
   AliAnalysisDataContainer *cout_jetsqamc = mgr->CreateContainer("histlist", TList::Class(),AliAnalysisManager::kOutputContainer,Form("%s:PWG4_JetHadronCorrelation_%s",AliAnalysisManager::GetCommonFileName(),Branch.Data()));
   ...
   mgr->ConnectOutput(jethadron,1, cout_jetsqamc);
