...
class AliAnalysisTaskNtuple : public AliAnalysisTaskSE {
private:
...
public:
    AliAnalysisTaskNtuple(const char *name = "Ntuple");
    AliAnalysisTaskNtuple(const AliAnalysisTaskNtuple &);
    AliAnalysisTaskNtuple &operator=(const AliAnalysisTaskNtuple &);
    ~AliAnalysisTaskNtuple(void);
    ...
    ClassDef(AliAnalysisTaskNtuple, 1);
