...
class AliAnalysisTaskJetFFMoments : public AliAnalysisTaskSE
{
 public:
  ...
  void SetFFMScalePower(Int_t f)                       {fFFMScalePower = f;}                               // Set FFM scale power
  void SetFFMBckgTypeAndBounds(Int_t bType, Double_t bpar1, Double_t bpar2, double mu)
  ...
  void SetAxisForTracks(Int_t nPt = 40,  Double_t minPt = 0.,   Double_t maxPt = 200.,
			Int_t nEta = 80, Double_t minEta = -1., Double_t maxEta = 1.,
  ...
  void SetAxisForJets(Int_t nPt = 40,            Double_t minPt = 0.,             Double_t maxPt = 200.,
		      Int_t nEta = 80,           Double_t minEta = -1.,           Double_t maxEta = 1.,
		      Int_t nPhi = 90,           Double_t minPhi = 0.,            Double_t maxPhi = 2*TMath::Pi(),
		      Int_t nArea = 20,          Double_t minArea = 0.,           Double_t maxArea = 1.,
  ...
  void SetFFMAxis(Int_t nFFM = 750,  Double_t minFFM = 0., Double_t maxFFM = 30.)
  ...
  void SetJetStructureAxis( Int_t nz = 44,   Double_t minz = 0.,                 Double_t maxz = 1.1,            //z
			    Int_t nxi = 28,  Double_t minxi = 0.,                Double_t maxxi = 7.,            //xi
			    Int_t njT = 25,  Double_t minjT = 4.-2*TMath::Pi(),  Double_t maxjT = 4.,            //jT
			    Int_t nDT = 20,  Double_t minDT = 0,                 Double_t maxDT = 0.5 )          //DeltaTheta
  ...
  void SetCentralityAxis( Int_t nv0 = 20,    Double_t minv0 = 0.,    Double_t maxv0 = 100.,          //v0 centrality
			  Int_t nntr = 80,   Double_t minntr = 0.,   Double_t maxntr = 400.,         //ntr
  ...
  enum {kDoughnut = 0, kRectangle, kEtaRange};
 ...
 private:
  ...
  Bool_t     SelectJet(AliAODJet * jet); // Jet selection: eta, pt, track pt, etc. cuts  
  ...
  Int_t              fFFMScalePower;		    // ((N+1)/2)^(fFFMScalePower)*M_{N}
  ...
  TH2D*    	    fh2Constituents[fgkFFMNJetBranches][4];     //! Distributions of (0: generated, 1: reconstructed) jet structure: 0: Z, 1: log(1/Z), 2: ln(jT), 3: Delta Theta
  TH1D*	            fh1TracksInJets[fgkFFMNJetBranches][3];     //! Distributions of (0: generated, 1: reconstructed) tracks in jets: 0: pt, 1: eta, 2: phi 
  ...
  ClassDef(AliAnalysisTaskJetFFMoments, 1);
