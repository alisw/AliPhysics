AliAnalysisTaskHFEECorrelators* AddTaskHFSubstructure(const char * ntracksData,
                                                                    const char * ntracksDet,
                                                                    const char * ntracksTrue,
								    const Double_t R,
                                    const Double_t CandidateMinPt,
                                    const Double_t CandidateMaxRap,
								    AliAnalysisTaskHFEECorrelators::ECandidateType_t ECandidateType = AliAnalysisTaskHFEECorrelators::kD0toKpi,
						     AliAnalysisTaskHFEECorrelators::JetShapeType jetShapeType = AliAnalysisTaskHFEECorrelators::kData, Bool_t IncludeInclusive=kFALSE) {
