...
/* $Id: AliITSMFTChip.h 53509 2011-12-10 18:55:52Z masera $ */
///////////////////////////////////////////////////////////////////////
//                                                                   //
//  Class AliITSMFTChip                                                //
...
class AliITSMFTChip: public TObject {
 ...
 public:
  AliITSMFTChip();             // default constructor
    AliITSMFTChip(Int_t index); //, AliITSUGeomTGeo* tg);
...
//  void       AddHit(AliITSUHit *hit)                          {fHitsM->AddLast(hit);}
 ...
 //   AliITSUGeomTGeo    *fGeomTG;    // pointed to geometry
    //
    ClassDef(AliITSMFTChip,1) // Copy the hits into a more useful order
};
