...
//______________________________________________________________________
Bool_t AliITSMFTGeomTGeo::GetChipId(Int_t index,Int_t &lay,Int_t &sta,Int_t &hsta, Int_t &mod, Int_t &chip)  const
{
  //
...
//______________________________________________________________________
TGeoHMatrix* AliITSMFTGeomTGeo::ExtractMatrixSens(Int_t index) const
{
...
//______________________________________________________________________
void AliITSMFTGeomTGeo::BuildITS(Bool_t loadSegm)
{
...
//______________________________________________________________________
void AliITSMFTGeomTGeo::Print(Option_t *) const
{
  // print
