#ifndef AliMFTHeatExchanger_H
#define AliMFTHeatExchanger_H
...
class AliMFTHeatExchanger : public TNamed {
 ...
 private:
  ...
  //TString fNameHalf[kNHalves] = {"Top", "Bottom"};
  const static Int_t fNMaxDisks = AliMFTConstants::fNMaxPlanes;
