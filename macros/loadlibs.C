void loadlibs () 
{
  ...
  gSystem->Load("$(ALICE_ROOT)/lib/tgt_$(ALICE_TARGET)/libdummyhbtproc");
  gSystem->Load("$(ALICE_ROOT)/lib/tgt_$(ALICE_TARGET)/libTHBTprocessor");
  ...
  gSystem->Load("$(ALICE_ROOT)/lib/tgt_$(ALICE_TARGET)/libhbtprocessor"); 
