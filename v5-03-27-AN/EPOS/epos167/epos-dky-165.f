...
c  ordinary decay
     ...
     *.and.ida.ne.0.and.ida.lt.10000)goto1000
      ...
      if(nrnody.gt.0)then
      do nod=1,nrnody
      if(idptl(i).eq.nody(nod))goto1000
      enddo 
      endif
...
2000  continue ! ---successful decay---
...
1     continue             !select one of the decay channel
...
c     ----
 ...
 1000 continue
      ip=ipp
      if(iret.ne.0.and.ish.ge.1)write(ifmt,'(a)')'hdecay: redo event'
