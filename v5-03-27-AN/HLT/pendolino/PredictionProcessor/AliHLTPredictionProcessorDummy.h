...
#ifndef ALI_HLT_PREDICTION_PROCESSOR_DUMMY_H
#define ALI_HLT_PREDICTION_PROCESSOR_DUMMY_H
//* This file is property of and copyright by the ALICE HLT Project        * 
//* ALICE Experiment at CERN, All rights reserved.                         *
//* See cxx source for full Copyright notice                               *

/** @file   AliHLTPredictionProcessorDummy.h
...
/**
 * Dummy implementation of the AliHLTPredictionProcessorInterface. 
 * This class is just for testing purpose of the PredictionProcessor interface.
 *
 * @author Sebastian Bablok
 *
 * @date 2007-10-24
 */
class AliHLTPredictionProcessorDummy : public AliHLTPredictionProcessorInterface {
    public:
		 ...
		 * 			AliShuttleInterface)
		 */
		AliHLTPredictionProcessorDummy(const char* detector, 
						AliHLTPendolino* pendolino);

		/**
		 * Destructor for AliHLTPredictionProcessorDummy
		 */
		virtual ~AliHLTPredictionProcessorDummy();
	...
	private:
		 ...
		 */
		AliHLTPredictionProcessorDummy(
						const AliHLTPredictionProcessorDummy& predictPro);

		/**
		 * Disabled Assignment operator
		 * (parent class is disabled so derived class does the same)
		 */
		AliHLTPredictionProcessorDummy& operator=(
						const AliHLTPredictionProcessorDummy& rhs);
...
inline Bool_t AliHLTPredictionProcessorDummy::ProcessDCS() {
	// getter for flag indicating if DCS values are processed; always true
	return true;
}
