#ifndef ALIANALYSISTASKKPFEMTO_H
#define ALIANALYSISTASKKPFEMTO_H
//NUOVO
...
class AliAnalysisTaskKPFemto : public AliAnalysisTaskSE {
 ...
 public:
  ...
  AliAnalysisTaskKPFemto();
  AliAnalysisTaskKPFemto(const char *name);
  virtual ~AliAnalysisTaskKPFemto();// {}
 ...
 private:
  ...
  AliAnalysisKPEventCollection ***fEventColl; //!
  AliAnalysisKPEventCollection ****fEventCollwSp; //!
  ...
  //
  AliAnalysisTaskKPFemto(const AliAnalysisTaskKPFemto&); // not implemented
  AliAnalysisTaskKPFemto& operator=(const AliAnalysisTaskKPFemto&); // not implemented
  //
  ClassDef(AliAnalysisTaskKPFemto, 2);
};
