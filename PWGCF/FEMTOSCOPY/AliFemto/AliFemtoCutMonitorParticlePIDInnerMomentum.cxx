...
//                                                                            //
////////////////////////////////////////////////////////////////////////////////
#include "AliFemtoCutMonitorParticlePIDInnerMomentum.h"
...
AliFemtoCutMonitorParticlePIDInnerMomentum::AliFemtoCutMonitorParticlePIDInnerMomentum():
  AliFemtoCutMonitor()
  , fTOFParticle(0)
  , fIfUsePt(false)
  , fTPCdEdx(nullptr)
...
AliFemtoCutMonitorParticlePIDInnerMomentum::AliFemtoCutMonitorParticlePIDInnerMomentum(const char *aName, Int_t aTOFParticle, Double_t yTOFTimeMin, Double_t yTOFTimeMax):
  AliFemtoCutMonitor()
...
AliFemtoCutMonitorParticlePIDInnerMomentum::AliFemtoCutMonitorParticlePIDInnerMomentum(const AliFemtoCutMonitorParticlePIDInnerMomentum &aCut):
...
AliFemtoCutMonitorParticlePIDInnerMomentum& AliFemtoCutMonitorParticlePIDInnerMomentum::operator=(const AliFemtoCutMonitorParticlePIDInnerMomentum& aCut)
{
  // assignment operator
  if (this == &aCut)
    return *this;
...
AliFemtoString AliFemtoCutMonitorParticlePIDInnerMomentum::Report()
{
  // Prepare report from the execution
  TString report = "*** AliFemtoCutMonitorParticlePIDInnerMomentum report";
  return AliFemtoString(report.Data());
}

void AliFemtoCutMonitorParticlePIDInnerMomentum::Fill(const AliFemtoTrack* aTrack)
{
  // Fill in the monitor histograms with the values from the current track
  // float tMom =  aTrack->InnerMomentum();
  float tMom = (fIfUsePt) ? aTrack->Pt() : aTrack->InnerMomentum(); 
...
void AliFemtoCutMonitorParticlePIDInnerMomentum::Write()
{
...
TList *AliFemtoCutMonitorParticlePIDInnerMomentum::GetOutputList()
{
