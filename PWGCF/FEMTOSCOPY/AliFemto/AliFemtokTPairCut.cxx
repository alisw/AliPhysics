...
//__________________
AliFemtokTPairCut::AliFemtokTPairCut(double minbetat, double maxbetat, double masspart1, double masspart2):
  AliFemtoPairCut(),
  fBetaTMin(minbetat),
  fBetaTMax(maxbetat),
...
TList *AliFemtokTPairCut::ListSettings() {
  ...
  tListSetttings->Add(new TObjString(
    TString::Format("AliFemtokTPairCut.betatmax=%f", fBetaTMax)));

  tListSetttings->Add(new TObjString(
    TString::Format("AliFemtokTPairCut.betatmin=%f", fBetaTMin)));

  return tListSetttings;
}

//__________________
void AliFemtokTPairCut::SetBetaTRange(double minbetat, double maxbetat)
{
  fBetaTMin = minbetat;
  fBetaTMax = maxbetat;
}
...
//__________________
void AliFemtokTPairCut::SetParticleMasses(double masspart1, double masspart2)
{
  fMassPart1 = masspart1;
  fMassPart2 = masspart2;
}
