////////////////////////////////////////////////////////////////////////////////
//                                                                            //
// AliFemtoCutMonitorParticleYPt_pion - the cut monitor for particles to study    //
...
AliFemtoCutMonitorParticleYPt_pion::AliFemtoCutMonitorParticleYPt_pion():
  fYPt(0),
  fYPhi(0),
  fPtPhi(0),
  fEtaPhi(0),
  ...
  fMass(0.13957)
{
  ...
  fDCARPt = new TH2D("DCARPt", "DCA in XY vs. Pt", 500, -5.0, 5.0, 7,0.19,1.5);
  fDCAZPt = new TH2D("DCAZPt", "DCA in Z vs. Pt", 500, -5.0, 5.0, 7,0.19,1.5);


}

AliFemtoCutMonitorParticleYPt_pion::AliFemtoCutMonitorParticleYPt_pion(const char *aName, float aMass):
  fYPt(0),
  fYPhi(0),
  fPtPhi(0),
  fEtaPhi(0),
  ...
  fMass(aMass)
{
  ...
  fDCARPt = new TH2D(name, "DCA in XY vs. Pt", 500, -5.0, 5.0, 7,0.19,1.5);
  snprintf(name, 200, "DCAZPt%s", aName);
  fDCAZPt = new TH2D(name, "DCA in Z vs. Pt", 500, -5.0, 5.0, 7,0.19,1.5);


}

AliFemtoCutMonitorParticleYPt_pion::AliFemtoCutMonitorParticleYPt_pion(const AliFemtoCutMonitorParticleYPt_pion &aCut):
  fYPt(0),
  fYPhi(0),
  fPtPhi(0),
  fEtaPhi(0),
...
AliFemtoCutMonitorParticleYPt_pion& AliFemtoCutMonitorParticleYPt_pion::operator=(const AliFemtoCutMonitorParticleYPt_pion& aCut)
{
  // assignment operator
  if (this == &aCut) 
    return *this;
...
AliFemtoString AliFemtoCutMonitorParticleYPt_pion::Report(){ 
  // Prepare report from the execution
  string stemp = "*** AliFemtoCutMonitorParticleYPt_pion report"; 
  AliFemtoString returnThis = stemp;
  return returnThis; 
}

void AliFemtoCutMonitorParticleYPt_pion::Fill(const AliFemtoTrack* aTrack)
{
...
void AliFemtoCutMonitorParticleYPt_pion::Write()
{
...
TList *AliFemtoCutMonitorParticleYPt_pion::GetOutputList()
{
