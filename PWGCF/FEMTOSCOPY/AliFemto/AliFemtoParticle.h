...
inline AliFemtoTrack *AliFemtoParticle::Track() const
{
  return fTrack;
}
inline int  AliFemtoParticle::TrackId() const
{
  return fTrack->TrackId();
}
inline const AliFemtoLorentzVector &AliFemtoParticle::FourMomentum() const
{
  return fFourMomentum;
}
inline AliFmPhysicalHelixD &AliFemtoParticle::Helix()
{
  return fHelix;
}
...
inline unsigned long AliFemtoParticle::TopologyMap(const int /* word */) const
{
  return 1;
}
inline int AliFemtoParticle::NumberOfHits() const
{
  return 1;
}

inline AliFemtoV0 *AliFemtoParticle::V0() const
{
  return fV0;
}
...
inline int AliFemtoParticle::PosTrackId() const
{
  return fV0->IdPos();
}
inline const AliFemtoThreeVector AliFemtoParticle::DecayVertexPosition() const
{
  return fV0->DecayVertexV0();
}
// ***
...
inline void AliFemtoParticle::ResetFourMomentum(const AliFemtoLorentzVector &vec)
{
  fFourMomentum = vec;
}

inline AliFemtoKink *AliFemtoParticle::Kink() const
{
  return fKink;
}
