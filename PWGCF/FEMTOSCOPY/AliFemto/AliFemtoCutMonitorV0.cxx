  ...
  fParticleId(0)
{
  ...
  fInvMassK0s= new TH1F("InvmassK0s", "K0s Invariant Mass Distribution", 200, 0.4, 0.6);
  ...
  fEtaV0 = new TH1F("EtaV0", "|Eta| distribution of V0s", 500, -0.8, 8.);
  ...
  fInvMassK0sPt = new TH2D("fInvMassK0sPt", "Invarint mass K0s vs Pt",50, 0., 5., 1000, 0., 2.);
  ...
  fParticleId(0)
{
  ...
  snprintf(name, 200, "fInvMassK0sPt%s", aName);
  fInvMassK0sPt = new  TH2D(name, "Invarint mass K0s vs Pt", 50, 0., 5., 1000, 0., 2.);
  ...
  fParticleId(0)
{
  ...
  if (fInvMassK0s) delete fInvMassK0s;
  fInvMassK0s = new TH1F(*aCut.fInvMassK0s);
  ...
  if(fInvMassK0sPt) delete fInvMassK0sPt;
  fInvMassK0sPt = new TH2D(*aCut.fInvMassK0sPt);
...
void AliFemtoCutMonitorV0::Fill(const AliFemtoV0* aV0)
{
  ...
  fInvMassK0sPt->Fill(aV0->PtV0(),aV0->MassK0Short());
