///////////////////////////////////////////////////////////////////////////
//                                                                       //
// AliFemtoBPLCMS3DCorrFctnKK: a class to calculate 3D correlation         //
...
inline  TH3D* AliFemtoBPLCMS3DCorrFctnKK::Numerator(){return fNumerator;}
inline  TH3D* AliFemtoBPLCMS3DCorrFctnKK::Denominator(){return fDenominator;}
//inline  TH3D* AliFemtoBPLCMS3DCorrFctnKK::UncorrectedDenominator(){return fUncorrectedDenominator;}
inline  TH3D* AliFemtoBPLCMS3DCorrFctnKK::Ratio(){return fRatio;}
inline  TH3D* AliFemtoBPLCMS3DCorrFctnKK::QinvHisto(){return fQinvHisto;}
inline  void AliFemtoBPLCMS3DCorrFctnKK::SetNormRangeLo(float qLo){fQinvNormLo = qLo;}
inline  void AliFemtoBPLCMS3DCorrFctnKK::SetNormRangeHi(float qHi){fQinvNormHi = qHi;}
inline  float AliFemtoBPLCMS3DCorrFctnKK::GetNormRangeLo() const{return fQinvNormLo;}
inline  float AliFemtoBPLCMS3DCorrFctnKK::GetNormRangeHi() const{return fQinvNormHi;}
...
inline  void AliFemtoBPLCMS3DCorrFctnKK::SetRout(double r){fRout2 = r*r;}
inline  void AliFemtoBPLCMS3DCorrFctnKK::SetRside(double r){fRside2 = r*r;}
inline  void AliFemtoBPLCMS3DCorrFctnKK::SetRlong(double r){fRlong2 = r*r;}
inline  void AliFemtoBPLCMS3DCorrFctnKK::SetLambda(double l){fLambda = l;}
