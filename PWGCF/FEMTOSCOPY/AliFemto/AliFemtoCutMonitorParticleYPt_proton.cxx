////////////////////////////////////////////////////////////////////////////////
//                                                                            //
// AliFemtoCutMonitorParticleYPt_proton - the cut monitor for particles to study    //
...
AliFemtoCutMonitorParticleYPt_proton::AliFemtoCutMonitorParticleYPt_proton():
  fYPt(0),
  fYPhi(0),
  fPtPhi(0),
  fEtaPhi(0),
  ...
  fMass(0.13957)
{
  ...
  fDCARPt = new TH2D("DCARPt", "DCA in XY vs. Pt", 500, -5.0, 5.0, 7,0.5,4.0);
  fDCAZPt = new TH2D("DCAZPt", "DCA in Z vs. Pt", 500, -5.0, 5.0, 7,0.5,4.0);


}

AliFemtoCutMonitorParticleYPt_proton::AliFemtoCutMonitorParticleYPt_proton(const char *aName, float aMass):
  fYPt(0),
  fYPhi(0),
  fPtPhi(0),
  fEtaPhi(0),
...
AliFemtoCutMonitorParticleYPt_proton::AliFemtoCutMonitorParticleYPt_proton(const AliFemtoCutMonitorParticleYPt_proton &aCut):
  fYPt(0),
  fYPhi(0),
  fPtPhi(0),
  fEtaPhi(0),
...
AliFemtoCutMonitorParticleYPt_proton& AliFemtoCutMonitorParticleYPt_proton::operator=(const AliFemtoCutMonitorParticleYPt_proton& aCut)
{
  // assignment operator
  if (this == &aCut) 
    return *this;
...
AliFemtoString AliFemtoCutMonitorParticleYPt_proton::Report(){ 
  // Prepare report from the execution
  string stemp = "*** AliFemtoCutMonitorParticleYPt_proton report"; 
  AliFemtoString returnThis = stemp;
  return returnThis; 
}

void AliFemtoCutMonitorParticleYPt_proton::Fill(const AliFemtoTrack* aTrack)
{
...
void AliFemtoCutMonitorParticleYPt_proton::Write()
{
...
TList *AliFemtoCutMonitorParticleYPt_proton::GetOutputList()
{
