...

{
  ...
  fMINVvsPt = new TH2D("fMINVvsPt", "Invarint mass Xi vs Pt", 1000, 0., 10., 500, 0., 5.);
  ...
  fnsigmaBacK(0)
{
  ...
  fMINVvsPt = new  TH2D(name, "Invarint mass Xi vs Pt", 1000, 0., 10., 500, 0., 5.);
  ...
  fnsigmaBacK(0)
{
  ...
  if(fCPAvsPt) delete fCPAvsPt;
  fCPAvsPt = new TH2D(*aCut.fCPAvsPt);
...
void AliFemtoCutMonitorXi::Fill(const AliFemtoXi* aXi)
{
  ...
  fCPAvsPt->Fill(aXi->PtXi(),aXi->CosPointingAngle());
