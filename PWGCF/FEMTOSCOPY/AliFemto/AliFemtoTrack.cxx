...
AliFemtoTrack::AliFemtoTrack(const AliFemtoTrack& t) :
  ...
  fPidProbDeuteron(t.fPidProbDeuteron),
  fPidProbTriton(t.fPidProbTriton),
  fPidProbHe3(t.fPidProbHe3),
  fPidProbAlpha(t.fPidProbAlpha),
  fTrackId(t.fTrackId),
...
AliFemtoTrack& AliFemtoTrack::operator=(const AliFemtoTrack& aTrack)
{
  ...
  fPidProbDeuteron = aTrack.fPidProbDeuteron;
  fPidProbTriton = aTrack.fPidProbTriton;
  fPidProbHe3 = aTrack.fPidProbHe3;
  fPidProbAlpha=aTrack.fPidProbAlpha;
...
void AliFemtoTrack::SetPidProbDeuteron(const float& x){fPidProbDeuteron = x;}
void AliFemtoTrack::SetPidProbTriton(const float& x){fPidProbTriton = x;}
void AliFemtoTrack::SetPidProbHe3(const float& x){fPidProbHe3 = x;}
void AliFemtoTrack::SetPidProbAlpha(const float& x){fPidProbAlpha = x;}
...
void AliFemtoTrack::SetNSigmaTPCD(const float& aNSigmaTPCD){fNSigmaTPCPi=aNSigmaTPCD;}
void AliFemtoTrack::SetNSigmaTPCT(const float& aNSigmaTPCT){fNSigmaTPCK=aNSigmaTPCT;}
void AliFemtoTrack::SetNSigmaTPCH(const float& aNSigmaTPCH){fNSigmaTPCP=aNSigmaTPCH;}
void AliFemtoTrack::SetNSigmaTPCA(const float& aNSigmaTPCA){fNSigmaTPCE=aNSigmaTPCA;}
...
void AliFemtoTrack::SetNSigmaTOFD(const float& aNSigmaTPCD){fNSigmaTPCPi=aNSigmaTPCD;}
void AliFemtoTrack::SetNSigmaTOFT(const float& aNSigmaTPCT){fNSigmaTPCK=aNSigmaTPCT;}
void AliFemtoTrack::SetNSigmaTOFH(const float& aNSigmaTPCH){fNSigmaTPCP=aNSigmaTPCH;}
void AliFemtoTrack::SetNSigmaTOFA(const float& aNSigmaTPCA){fNSigmaTPCE=aNSigmaTPCA;}
