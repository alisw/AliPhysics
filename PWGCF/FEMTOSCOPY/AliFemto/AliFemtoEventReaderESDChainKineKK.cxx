...
//                                                                            //
////////////////////////////////////////////////////////////////////////////////
#include "AliFemtoEventReaderESDChainKineKK.h"
...
AliFemtoEventReaderESDChainKineKK::AliFemtoEventReaderESDChainKineKK():
  fFileName(" "),
  fConstrained(true),
  fReadInner(false),
  fUseTPCOnly(false),
...
//__________________
AliFemtoEventReaderESDChainKineKK::AliFemtoEventReaderESDChainKineKK(const AliFemtoEventReaderESDChainKineKK& aReader):
...
//__________________
AliFemtoEventReaderESDChainKineKK& AliFemtoEventReaderESDChainKineKK::operator=(const AliFemtoEventReaderESDChainKineKK& aReader)
{
  // Assignment operator
  if (this == &aReader)
    return *this;
...
//__________________
// Simple report
AliFemtoString AliFemtoEventReaderESDChainKineKK::Report()
{
  AliFemtoString temp = "\n This is the AliFemtoEventReaderESDChainKineKK\n";
  return temp;
}

//__________________
void AliFemtoEventReaderESDChainKineKK::SetConstrained(const bool constrained)
{
  // Select whether to read constrained or not constrained momentum
  fConstrained=constrained;
}
//__________________
bool AliFemtoEventReaderESDChainKineKK::GetConstrained() const
{
  // Check whether we read constrained or not constrained momentum
  return fConstrained;
}
//__________________
void AliFemtoEventReaderESDChainKineKK::SetReadTPCInner(const bool readinner)
{
  fReadInner=readinner;
}

bool AliFemtoEventReaderESDChainKineKK::GetReadTPCInner() const
{
  return fReadInner;
}

//__________________
void AliFemtoEventReaderESDChainKineKK::SetUseTPCOnly(const bool usetpconly)
{
  fUseTPCOnly=usetpconly;
}

bool AliFemtoEventReaderESDChainKineKK::GetUseTPCOnly() const
{
  return fUseTPCOnly;
}
void AliFemtoEventReaderESDChainKineKK::SetUseMultiplicity(EstEventMult aType)
{
  fEstEventMult = aType;
}
//__________________
AliFemtoEvent* AliFemtoEventReaderESDChainKineKK::ReturnHbtEvent()
{
  ...
  cout << "AliFemtoEventReaderESDChainKineKK::Starting to read event: "<<fCurEvent<<endl;
...
//     }
  ...
  for (int i=0;i<nofTracks;i++)
  {
    ...
    //ML after discussion with Ruben Shahoyan
   if (esdtrack->GetStatus()&AliESDtrack::kTOFout){
   ...
   trackCopy->SetTofExpectedTimes(tTOF-esdpid[2], tTOF-esdpid[3], tTOF-esdpid[4],tTOF);
    ...
    //  if (///old, working// (esdtrack->GetStatus()&AliESDtrack::kTOFpid) &&
...
//___________________
void AliFemtoEventReaderESDChainKineKK::SetESDSource(AliESDEvent *aESD)
{
...
//___________________
void AliFemtoEventReaderESDChainKineKK::SetStackSource(AliStack *aStack)
{
...
//___________________
void AliFemtoEventReaderESDChainKineKK::SetGenEventHeader(AliGenEventHeader *aGenHeader)
{
  // The chain loads the generator event header for us
  // You must provide the address where it can be found
  fGenHeader = aGenHeader;
}
void AliFemtoEventReaderESDChainKineKK::SetRotateToEventPlane(short dorotate)
{
  fRotateToEventPlane=dorotate;
}
Float_t AliFemtoEventReaderESDChainKineKK::GetSigmaToVertex(double *impact, double *covar)
{
...
void AliFemtoEventReaderESDChainKineKK::SetReadTrackType(ReadTrackType aType)
{
  fTrackType = aType;
}

void AliFemtoEventReaderESDChainKineKK::SetReadV0(bool a)
{
  fReadV0 = a;
}

void AliFemtoEventReaderESDChainKineKK::SetKaonAnalysis(Bool_t a)
{
  isKaonAnalysis = a;
}

void AliFemtoEventReaderESDChainKineKK::SetProtonAnalysis(Bool_t a)
{
  isProtonAnalysis = a;
}

void AliFemtoEventReaderESDChainKineKK::SetPionAnalysis(Bool_t a)
{
  isPionAnalysis = a;
}

void AliFemtoEventReaderESDChainKineKK::SetOnlyPrimaries(Bool_t a)
{
  fOnlyPrimaries = a;
}

void AliFemtoEventReaderESDChainKineKK::CopyESDtoFemtoV0(AliESDv0 *tESDv0, AliFemtoV0 *tFemtoV0, AliESDEvent *tESDevent)
{
...
void AliFemtoEventReaderESDChainKineKK::SetMagneticFieldSign(int s)
{
  if(s>0)
    fMagFieldSign = 1;
  else if(s<0)
...
void AliFemtoEventReaderESDChainKineKK::GetGlobalPositionAtGlobalRadiiThroughTPC(AliESDtrack *track, Float_t bfield, Float_t globalPositionsAtRadii[9][3])
{
