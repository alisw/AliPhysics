AliAnalysisTaskSE *AddTaskFemtoDreamRhoSyst(bool isMC = false,
                                        ...
                                        const char *cutVariation = "0")
{
  ...
  ///////////
  //for now no Var on rho pT and SB/Signal regions
  //systematics generic set-up
  ...
  if (suffix == "001"){
    ...
    TrackPosProtonCuts->SetNClsTPC(Proton_Clusters_VarLow);
    TrackNegProtonCuts->SetNClsTPC(Proton_Clusters_VarLow);
 
    TrackPosPionCuts->SetPID(AliPID::kPion, 0.5,Pion_Sigma_VarHigh);
    TrackNegPionCuts->SetPID(AliPID::kPion, 0.5,Pion_Sigma_VarHigh);
 
  } else if (suffix == "002"){
 
    TrackPosProtonCuts->SetEtaRange(-Proton_Eta_VarHigh,Proton_Eta_VarHigh);
    TrackNegProtonCuts->SetEtaRange(-Proton_Eta_VarHigh,Proton_Eta_VarHigh);
    TrackPosProtonCuts->SetPtRange(Proton_pT_VarHigh,4.05);
    TrackNegProtonCuts->SetPtRange(Proton_pT_VarHigh,4.05);
    TrackPosProtonCuts->SetNClsTPC(Proton_Clusters_VarHigh);
    TrackNegProtonCuts->SetNClsTPC(Proton_Clusters_VarHigh);
    ...
    TrackPosPionCuts->SetPID(AliPID::kPion, 0.5,Pion_Sigma_VarHigh);
    TrackNegPionCuts->SetPID(AliPID::kPion, 0.5,Pion_Sigma_VarHigh);
    TrackPosPionCuts->SetEtaRange(-Pion_Eta_VarLow,Pion_Eta_VarLow);
    TrackNegPionCuts->SetEtaRange(-Pion_Eta_VarLow,Pion_Eta_VarLow);
    TrackPosPionCuts->SetPtRange(Pion_pT_VarHigh,4.0);
    TrackNegPionCuts->SetPtRange(Pion_pT_VarHigh,4.0);
 
  } else if (suffix == "004"){
 
    TrackPosProtonCuts->SetPID(AliPID::kProton, 0.75,Proton_Sigma_VarHigh);
    TrackNegProtonCuts->SetPID(AliPID::kProton, 0.75,Proton_Sigma_VarHigh);
    TrackPosProtonCuts->SetEtaRange(-Proton_Eta_VarHigh,Proton_Eta_VarHigh);
    TrackNegProtonCuts->SetEtaRange(-Proton_Eta_VarHigh,Proton_Eta_VarHigh);
    TrackPosProtonCuts->SetPtRange(Proton_pT_VarHigh,4.05);
    TrackNegProtonCuts->SetPtRange(Proton_pT_VarHigh,4.05);
    ...
    TrackPosPionCuts->SetPID(AliPID::kPion, 0.5,Pion_Sigma_VarHigh);
    TrackNegPionCuts->SetPID(AliPID::kPion, 0.5,Pion_Sigma_VarHigh);
    TrackPosPionCuts->SetEtaRange(-Pion_Eta_VarHigh,Pion_Eta_VarHigh);
    TrackNegPionCuts->SetEtaRange(-Pion_Eta_VarHigh,Pion_Eta_VarHigh);
    TrackPosPionCuts->SetPtRange(Pion_pT_VarLow,4.0);
    TrackNegPionCuts->SetPtRange(Pion_pT_VarLow,4.0);
    TrackPosPionCuts->SetNClsTPC(Pion_Clusters_VarHigh);
    TrackNegPionCuts->SetNClsTPC(Pion_Clusters_VarHigh);
 
  } else if (suffix == "005"){
 
    TrackPosPionCuts->SetPID(AliPID::kPion, 0.5,Pion_Sigma_VarLow);
    TrackNegPionCuts->SetPID(AliPID::kPion, 0.5,Pion_Sigma_VarLow);
    TrackPosPionCuts->SetPtRange(Pion_pT_VarLow,4.0);
    TrackNegPionCuts->SetPtRange(Pion_pT_VarLow,4.0);
    ...
    TrackPosProtonCuts->SetPID(AliPID::kProton, 0.75,Proton_Sigma_VarHigh);
    TrackNegProtonCuts->SetPID(AliPID::kProton, 0.75,Proton_Sigma_VarHigh);
    TrackPosProtonCuts->SetEtaRange(-Proton_Eta_VarLow,Proton_Eta_VarLow);
    TrackNegProtonCuts->SetEtaRange(-Proton_Eta_VarLow,Proton_Eta_VarLow);
    TrackPosProtonCuts->SetPtRange(Proton_pT_VarLow,4.05);
    TrackNegProtonCuts->SetPtRange(Proton_pT_VarLow,4.05);
 
    TrackPosPionCuts->SetPID(AliPID::kPion, 0.5,Pion_Sigma_VarLow);
    TrackNegPionCuts->SetPID(AliPID::kPion, 0.5,Pion_Sigma_VarLow);
    TrackPosPionCuts->SetPtRange(Pion_pT_VarLow,4.0);
    TrackNegPionCuts->SetPtRange(Pion_pT_VarLow,4.0);
    TrackPosPionCuts->SetNClsTPC(Pion_Clusters_VarLow);
    TrackNegPionCuts->SetNClsTPC(Pion_Clusters_VarLow);
    ...
    TrackPosProtonCuts->SetPID(AliPID::kProton, 0.75,Proton_Sigma_VarLow);
    TrackNegProtonCuts->SetPID(AliPID::kProton, 0.75,Proton_Sigma_VarLow);
    TrackPosProtonCuts->SetPtRange(Proton_pT_VarLow,4.05);
    TrackNegProtonCuts->SetPtRange(Proton_pT_VarLow,4.05);
    TrackPosProtonCuts->SetNClsTPC(Proton_Clusters_VarLow);
    TrackNegProtonCuts->SetNClsTPC(Proton_Clusters_VarLow);
