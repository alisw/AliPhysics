...
AliFemtoManager* ConfigFemtoAnalysis(const char* params) {
	...
	int runmults[numOfMultBins] = {1, 1, 1, 1, 0};
	if(runmultdep)	  {runmults[0]=1; runmults[1]=1; runmults[2]=1;	  }
	int multbins[numOfMultBins+1] = {0, 200, 400, 600, 1000, 1000};
	...
	Reader->SetUseMultiplicity(AliFemtoEventReaderAOD::kCentrality); //	V0M
