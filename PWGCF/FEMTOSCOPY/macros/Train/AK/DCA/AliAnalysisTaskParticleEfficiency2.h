#ifndef ALIANALYSISTASKPARTICLEEFFICIENCY2
#define ALIANALYSISTASKPARTICLEEFFICIENCY2
...
class AliAnalysisTaskParticleEfficiency2 :public AliAnalysisTaskSE{
 public:
 ...
 AliAnalysisTaskParticleEfficiency2() :  AliAnalysisTaskSE(), centrality(0), fHistoList(0),  fMassInvLambdaPass(0),fMassInvAntiLambdaPass(0), fMassInvLambdaFail(0), fMassInvAntiLambdaFail(0),fEtaLambda(0),fPtLambda(0), fEtaAntiLambda(0),fPtAntiLambda(0), fCutsLambda(0), fCutsAntiLambda(0), fTruePtLambdaMC(0), fRecPtLambdaMC(0), fTruePtAntiLambdaMC(0),fRecPtAntiLambdaMC(0), fMassInvXimPass(0),fMassInvXipPass(0), fMassInvXimFail(0), fMassInvXipFail(0),fEtaXim(0),fPtXim(0), fEtaXip(0),fPtXip(0), fCutsXim(0), fCutsXip(0), recoParticleArrayXi(0), fTruePtXimMC(0), fRecPtXimMC(0), fTruePtXipMC(0),fRecPtXipMC(0), fDCAtoPrimVtx(0), fIfAliEventCuts(kFALSE), fFB(96), fPidMethod(kExclusivePIDDiffRejection), fEstEventMult(kRefMult), fIfXiAnalysis(kFALSE), fpidResponse(0), fAODpidUtil(0), fEventCuts(0)
  ...
  AliAnalysisTaskParticleEfficiency2(TString name, int pidMethod=-1, int filterbit=96); // default constructor
  virtual ~AliAnalysisTaskParticleEfficiency2(); // default destructor
 ...
 private:
  AliAnalysisTaskParticleEfficiency2(const AliAnalysisTaskParticleEfficiency2 &); // copy constructor
  AliAnalysisTaskParticleEfficiency2 &operator=(const AliAnalysisTaskParticleEfficiency2 &); // operator=
  ...
  TH2F *fPrimVsDCAXY[MULTBINS*PARTTYPES][2];
  TH2F *fSecWeakVsDCAXY[MULTBINS*PARTTYPES][2];
  TH2F *fSecMatVsDCAXY[MULTBINS*PARTTYPES][2];
  TH2F *fFakeVsDCAXY[MULTBINS*PARTTYPES][2];

  TH2F *fPrimVsDCAZ[MULTBINS*PARTTYPES][2];
  TH2F *fSecWeakVsDCAZ[MULTBINS*PARTTYPES][2];
  TH2F *fSecMatVsDCAZ[MULTBINS*PARTTYPES][2];
  TH2F *fFakeVsDCAZ[MULTBINS*PARTTYPES][2];
  ...
  TH2F *fAllVsDCAXY[MULTBINS*PARTTYPES][2];
  TH2F *fAllVsDCAZ[MULTBINS*PARTTYPES][2];
  ...
  ClassDef(AliAnalysisTaskParticleEfficiency2, 0);
  
};

#endif /* AliAnalysisTaskParticleEfficiency2 */
