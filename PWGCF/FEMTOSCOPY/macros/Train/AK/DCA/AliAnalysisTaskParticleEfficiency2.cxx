...
#include "AliAnalysisTaskParticleEfficiency2.h"




ClassImp(AliAnalysisTaskParticleEfficiency2)
//ClassImp(AliAnalysisTaskParticleEfficiency2)
...
AliAnalysisTaskParticleEfficiency2::AliAnalysisTaskParticleEfficiency2(TString name, int pidMethod, int filterbit) :
  AliAnalysisTaskSE(name), centrality(0), fHistoList(0),  fMassInvLambdaPass(0),fMassInvAntiLambdaPass(0), fMassInvLambdaFail(0), fMassInvAntiLambdaFail(0),fEtaLambda(0),fPtLambda(0), fEtaAntiLambda(0),fPtAntiLambda(0), fCutsLambda(0), fCutsAntiLambda(0), fTruePtLambdaMC(0), fRecPtLambdaMC(0), fTruePtAntiLambdaMC(0),fRecPtAntiLambdaMC(0), fMassInvXimPass(0),fMassInvXipPass(0), fMassInvXimFail(0), fMassInvXipFail(0),fEtaXim(0),fPtXim(0), fEtaXip(0),fPtXip(0), fCutsXim(0), fCutsXip(0), recoParticleArrayXi(0), fTruePtXimMC(0), fRecPtXimMC(0), fTruePtXipMC(0), fRecPtXipMC(0), fDCAtoPrimVtx(0), fIfAliEventCuts(kFALSE), fFB(96), fPidMethod(kNSigma),  fEstEventMult(kRefMult),fIfXiAnalysis(kFALSE), fpidResponse(0), fAODpidUtil(0), fEventCuts(0)
{
  for(Int_t i = 0; i < MULTBINS*PARTTYPES; i++)  {
    for(Int_t chg=0;chg<2;chg++){
      ...
      fPrimVsDCAXY[i][chg] = NULL;
      fSecWeakVsDCAXY[i][chg] = NULL;
      fSecMatVsDCAXY[i][chg] = NULL;
      fFakeVsDCAXY[i][chg] = NULL;

      fPrimVsDCAZ[i][chg] = NULL;
      fSecWeakVsDCAZ[i][chg] = NULL;
      fSecMatVsDCAZ[i][chg] = NULL;
      fFakeVsDCAZ[i][chg] = NULL;
...
AliAnalysisTaskParticleEfficiency2::~AliAnalysisTaskParticleEfficiency2()
{
...
void AliAnalysisTaskParticleEfficiency2::UserCreateOutputObjects()
{
  ...
  TString hname1, hname2, hname3, hname4, hname5, hname6, hname7, hname8, hname9, hname10, hname11,hname12,hname13,hname14,hname15,hname16,hname17,hname18,hname19,hname20,hname21,hname22,hname23,hname24,hname25,hname26, hname6xy, hname6z, hname7xy, hname7z, hname8xy, hname8z, hname9xy, hname9z ;

  TString htitle1, htitle2, htitle3, htitle4,htitle6,htitle5,htitle7,htitle8,htitle9,htitle10,htitle11,htitle12,htitle13,htitle14,htitle15,htitle16,htitle17,htitle18,htitle19,htitle20,htitle21,htitle22,htitle23,htitle24,htitle25,htitle26,htitle6xy,htitle6z,htitle7xy,htitle7z,htitle8xy,htitle8z,htitle9xy,htitle9z;
  ...
  for(Int_t j = 0; j < PARTTYPES; j++)  {
    ...
    for(Int_t i = 0; i < MULTBINS; i++)  {
      ...
      fPrimVsDCA[i*PARTTYPES+j][0] = new TH2F(hname6.Data(),htitle6.Data(),1000,-5.0,5.0,7,0.5,4);
      hname6+="Minus"; htitle6+="Minus";
      fPrimVsDCA[i*PARTTYPES+j][1] = new TH2F(hname6.Data(),htitle6.Data(),1000,-5.0,5.0,7,0.5,4);
      hname7 = "hSecWeakVsDCAM"; hname7+=i; hname7+=parttypename;
      htitle7 = "Sec. weak decay vs DCA M"; htitle7+=i; htitle7+=parttypename;
      fSecWeakVsDCA[i*PARTTYPES+j][0] = new TH2F(hname7.Data(),htitle7.Data(),1000,-5.0,5.0,7,0.5,4);
      hname7+="Minus"; htitle7+="Minus";
      fSecWeakVsDCA[i*PARTTYPES+j][1] = new TH2F(hname7.Data(),htitle7.Data(),1000,-5.0,5.0,7,0.5,4);
      hname8 = "hSecMatVsDCAM"; hname8+=i; hname8+=parttypename;
      htitle8 = "Sec. material vs DCA M"; htitle8+=i; htitle8+=parttypename;
      fSecMatVsDCA[i*PARTTYPES+j][0] = new TH2F(hname8.Data(),htitle8.Data(),1000,-5.0,5.0,7,0.5,4);
      hname8+="Minus"; htitle8+="Minus";
      fSecMatVsDCA[i*PARTTYPES+j][1] = new TH2F(hname8.Data(),htitle8.Data(),1000,-5.0,5.0,7,0.5,4);
      hname9 = "hFakeVsDCAM"; hname9+=i; hname9+=parttypename;
      htitle9 = "Fake vs DCA M"; htitle9+=i; htitle9+=parttypename;
      fFakeVsDCA[i*PARTTYPES+j][0] = new TH2F(hname9.Data(),htitle9.Data(),1000,-5.0,5.0,7,0.5,4);
      hname9+="Minus"; htitle9+="Minus";
      fFakeVsDCA[i*PARTTYPES+j][1] = new TH2F(hname9.Data(),htitle9.Data(),1000,-5.0,5.0,7,0.5,4);

      hname6xy = "hPrimVsDCAXYM"; hname6xy+=i; hname6xy+=parttypename;
      htitle6xy = "Primaries vs DCA XY M"; htitle6xy+=i; htitle6xy+=parttypename;
      fPrimVsDCAXY[i*PARTTYPES+j][0] = new TH2F(hname6xy.Data(),htitle6xy.Data(),400,-3.0,3.0,7,0.5,4);
      hname6xy+="Minus"; htitle6xy+="Minus";
      fPrimVsDCAXY[i*PARTTYPES+j][1] = new TH2F(hname6xy.Data(),htitle6xy.Data(),400,-3.0,3.0,7,0.5,4);
      hname7xy = "hSecWeakVsDCAXYM"; hname7xy+=i; hname7xy+=parttypename;
      htitle7xy = "Sec. weak decay vs DCA XY M"; htitle7xy+=i; htitle7xy+=parttypename;
      fSecWeakVsDCAXY[i*PARTTYPES+j][0] = new TH2F(hname7xy.Data(),htitle7xy.Data(),400,-3.0,3.0,7,0.5,4);
      hname7xy+="Minus"; htitle7xy+="Minus";
      fSecWeakVsDCAXY[i*PARTTYPES+j][1] = new TH2F(hname7xy.Data(),htitle7xy.Data(),400,-3.0,3.0,7,0.5,4);
      hname8xy = "hSecMatVsDCAXYM"; hname8xy+=i; hname8xy+=parttypename;
      htitle8xy = "Sec. material vs DCA XY M"; htitle8xy+=i; htitle8xy+=parttypename;
      fSecMatVsDCAXY[i*PARTTYPES+j][0] = new TH2F(hname8xy.Data(),htitle8xy.Data(),400,-3.0,3.0,7,0.5,4);
      hname8xy+="Minus"; htitle8xy+="Minus";
      fSecMatVsDCAXY[i*PARTTYPES+j][1] = new TH2F(hname8xy.Data(),htitle8xy.Data(),400,-3.0,3.0,7,0.5,4);
      hname9xy = "hFakeVsDCAXYM"; hname9xy+=i; hname9xy+=parttypename;
      htitle9xy = "Fake vs DCA XY M"; htitle9xy+=i; htitle9xy+=parttypename;
      fFakeVsDCAXY[i*PARTTYPES+j][0] = new TH2F(hname9xy.Data(),htitle9xy.Data(),400,-3.0,3.0,7,0.5,4);
      hname9xy+="Minus"; htitle9xy+="Minus";
      fFakeVsDCAXY[i*PARTTYPES+j][1] = new TH2F(hname9xy.Data(),htitle9xy.Data(),400,-3.0,3.0,7,0.5,4);

      hname6z = "hPrimVsDCAZM"; hname6z+=i; hname6z+=parttypename;
      htitle6z = "Primaries vs DCA Z M"; htitle6z+=i; htitle6z+=parttypename;
      fPrimVsDCAZ[i*PARTTYPES+j][0] = new TH2F(hname6z.Data(),htitle6z.Data(),400,-3.0,3.0,7,0.5,4);
      hname6z+="Minus"; htitle6z+="Minus";
      fPrimVsDCAZ[i*PARTTYPES+j][1] = new TH2F(hname6z.Data(),htitle6z.Data(),400,-3.0,3.0,7,0.5,4);
      hname7z = "hSecWeakVsDCAZM"; hname7z+=i; hname7z+=parttypename;
      htitle7z = "Sec. weak decay vs DCA Z M"; htitle7z+=i; htitle7z+=parttypename;
      fSecWeakVsDCAZ[i*PARTTYPES+j][0] = new TH2F(hname7z.Data(),htitle7z.Data(),400,-3.0,3.0,7,0.5,4);
      hname7z+="Minus"; htitle7z+="Minus";
      fSecWeakVsDCAZ[i*PARTTYPES+j][1] = new TH2F(hname7z.Data(),htitle7z.Data(),400,-3.0,3.0,7,0.5,4);
      hname8z = "hSecMatVsDCAZM"; hname8z+=i; hname8z+=parttypename;
      htitle8z = "Sec. material vs DCA Z M"; htitle8z+=i; htitle8z+=parttypename;
      fSecMatVsDCAZ[i*PARTTYPES+j][0] = new TH2F(hname8z.Data(),htitle8z.Data(),400,-3.0,3.0,7,0.5,4);
      hname8z+="Minus"; htitle8z+="Minus";
      fSecMatVsDCAZ[i*PARTTYPES+j][1] = new TH2F(hname8z.Data(),htitle8z.Data(),400,-3.0,3.0,7,0.5,4);
      hname9z = "hFakeVsDCAZM"; hname9z+=i; hname9z+=parttypename;
      htitle9z = "Fake vs DCA Z M"; htitle9z+=i; htitle9z+=parttypename;
      fFakeVsDCAZ[i*PARTTYPES+j][0] = new TH2F(hname9z.Data(),htitle9z.Data(),400,-3.0,3.0,7,0.5,4);
      hname9z+="Minus"; htitle9z+="Minus";
      fFakeVsDCAZ[i*PARTTYPES+j][1] = new TH2F(hname9z.Data(),htitle9z.Data(),400,-3.0,3.0,7,0.5,4);
      ...
      Double_t min[]={-0.8,0.2,-7,0};
      Double_t max[]={0.8,2.5,7,2*TMath::Pi()};
      Int_t nbins[]={8,23,1,8};
      ...
      fPrimVsDCAXY[i*PARTTYPES+j][0]->Sumw2();
      fSecWeakVsDCAXY[i*PARTTYPES+j][0]->Sumw2();
      fSecMatVsDCAXY[i*PARTTYPES+j][0]->Sumw2();
      fFakeVsDCAXY[i*PARTTYPES+j][0]->Sumw2();
      fPrimVsDCAXY[i*PARTTYPES+j][1]->Sumw2();
      fSecWeakVsDCAXY[i*PARTTYPES+j][1]->Sumw2();
      fSecMatVsDCAXY[i*PARTTYPES+j][1]->Sumw2();
      fFakeVsDCAXY[i*PARTTYPES+j][1]->Sumw2();

      fPrimVsDCAZ[i*PARTTYPES+j][0]->Sumw2();
      fSecWeakVsDCAZ[i*PARTTYPES+j][0]->Sumw2();
      fSecMatVsDCAZ[i*PARTTYPES+j][0]->Sumw2();
      fFakeVsDCAZ[i*PARTTYPES+j][0]->Sumw2();
      fPrimVsDCAZ[i*PARTTYPES+j][1]->Sumw2();
      fSecWeakVsDCAZ[i*PARTTYPES+j][1]->Sumw2();
      fSecMatVsDCAZ[i*PARTTYPES+j][1]->Sumw2();
      fFakeVsDCAZ[i*PARTTYPES+j][1]->Sumw2();
  ...
  for (Int_t i = 0; i < MULTBINS*PARTTYPES; i++){
    for(Int_t chg=0;chg<2;chg++){
      ...
      fHistoList->Add(fPrimVsDCAXY[i][chg]);
      fHistoList->Add(fSecWeakVsDCAXY[i][chg]);
      fHistoList->Add(fSecMatVsDCAXY[i][chg]);
      fHistoList->Add(fFakeVsDCAXY[i][chg]);

      fHistoList->Add(fPrimVsDCAZ[i][chg]);
      fHistoList->Add(fSecWeakVsDCAZ[i][chg]);
      fHistoList->Add(fSecMatVsDCAZ[i][chg]);
      fHistoList->Add(fFakeVsDCAZ[i][chg]);
...
void AliAnalysisTaskParticleEfficiency2::UserExec(Option_t *)
{
  AliAODInputHandler *aodH = dynamic_cast<AliAODInputHandler *>(AliAnalysisManager::GetAnalysisManager()->GetInputEventHandler());
 ...
 //**** getting MC array ******
  ...
  for (Int_t iTracks = 0; iTracks < aodEvent->GetNumberOfTracks(); iTracks++)
  {
   ...
   //And secondaries for different particle species:
	...
	if(MCtrk->IsSecondaryFromWeakDecay()){
	  fSecWeakVsDCAXY[PARTTYPES*fcent+1][charge]->Fill(DCAXY,track->Pt());
	  fSecWeakVsDCAZ[PARTTYPES*fcent+1][charge]->Fill(DCAZ,track->Pt());
	}
	else if(MCtrk->IsSecondaryFromMaterial()){
	  fSecMatVsDCAXY[PARTTYPES*fcent+1][charge]->Fill(DCAXY,track->Pt());
	  fSecMatVsDCAZ[PARTTYPES*fcent+1][charge]->Fill(DCAZ,track->Pt());
	}
	else{
	  fFakeVsDCAXY[PARTTYPES*fcent+1][charge]->Fill(DCAXY,track->Pt());
	  fFakeVsDCAZ[PARTTYPES*fcent+1][charge]->Fill(DCAZ,track->Pt());
	}
	...
	fPrimVsDCAXY[PARTTYPES*fcent+1][charge]->Fill(DCAXY,track->Pt());
	fPrimVsDCAZ[PARTTYPES*fcent+1][charge]->Fill(DCAZ,track->Pt());
	...
	if(MCtrk->IsSecondaryFromWeakDecay()){
	  fSecWeakVsDCAXY[PARTTYPES*fcent+2][charge]->Fill(DCAXY,track->Pt());
	  fSecWeakVsDCAZ[PARTTYPES*fcent+2][charge]->Fill(DCAZ,track->Pt());
	}
	else if(MCtrk->IsSecondaryFromMaterial()){
	  fSecMatVsDCAXY[PARTTYPES*fcent+2][charge]->Fill(DCAXY,track->Pt());
	  fSecMatVsDCAZ[PARTTYPES*fcent+2][charge]->Fill(DCAZ,track->Pt());
	}
	else{
	  fFakeVsDCAXY[PARTTYPES*fcent+2][charge]->Fill(DCAXY,track->Pt());
	  fFakeVsDCAZ[PARTTYPES*fcent+2][charge]->Fill(DCAZ,track->Pt());
	}
	...
	fPrimVsDCAXY[PARTTYPES*fcent+2][charge]->Fill(DCAXY,track->Pt());
	fPrimVsDCAZ[PARTTYPES*fcent+2][charge]->Fill(DCAZ,track->Pt());
	...
	if(MCtrk->IsSecondaryFromWeakDecay()){
	  fSecWeakVsDCAXY[PARTTYPES*fcent+3][charge]->Fill(DCAXY,track->Pt());
	  fSecWeakVsDCAZ[PARTTYPES*fcent+3][charge]->Fill(DCAZ,track->Pt());
	}
	else if(MCtrk->IsSecondaryFromMaterial()){
	  fSecMatVsDCAXY[PARTTYPES*fcent+3][charge]->Fill(DCAXY,track->Pt());
	  fSecMatVsDCAZ[PARTTYPES*fcent+3][charge]->Fill(DCAZ,track->Pt());
	}
	else{
	  fFakeVsDCAXY[PARTTYPES*fcent+3][charge]->Fill(DCAXY,track->Pt());
	  fFakeVsDCAZ[PARTTYPES*fcent+3][charge]->Fill(DCAZ,track->Pt());
	}
	...
	fPrimVsDCAXY[PARTTYPES*fcent+3][charge]->Fill(DCAXY,track->Pt());
	fPrimVsDCAZ[PARTTYPES*fcent+3][charge]->Fill(DCAZ,track->Pt());
...
//void AliAnalysisTaskParticleEfficiency2::Terminate(Option_t *)
//{}


AliAnalysisTaskParticleEfficiency2 & AliAnalysisTaskParticleEfficiency2::operator=(const AliAnalysisTaskParticleEfficiency2 &copy)
{
...
AliAnalysisTaskParticleEfficiency2::AliAnalysisTaskParticleEfficiency2(const AliAnalysisTaskParticleEfficiency2 &copy)
{
  fPidMethod = copy.fPidMethod;
  fFB = copy.fFB;
...
void AliAnalysisTaskParticleEfficiency2::AnalyseCascades(int fcent, AliAODEvent* aodEvent, TClonesArray  *arrayMC)
{
...
void AliAnalysisTaskParticleEfficiency2::SetAliEventCuts(Bool_t ec)
{
  fIfAliEventCuts = ec;
}

void AliAnalysisTaskParticleEfficiency2::SetFB(int fb)
{
  fFB = fb;
}

void AliAnalysisTaskParticleEfficiency2::SetPidMethod(PidMethod method)
{
  fPidMethod = method;
}

int AliAnalysisTaskParticleEfficiency2::GetPidMethod()
{
  return (int)fPidMethod;
}

void AliAnalysisTaskParticleEfficiency2::SetPidMethod(int method)
{
  switch(method){
...
void AliAnalysisTaskParticleEfficiency2::SetMultMethod(EventMult method)
{
  fEstEventMult = method;
}

void AliAnalysisTaskParticleEfficiency2::SetIfXiAnalysis(Bool_t xi)
{
  fIfXiAnalysis = xi;
}
