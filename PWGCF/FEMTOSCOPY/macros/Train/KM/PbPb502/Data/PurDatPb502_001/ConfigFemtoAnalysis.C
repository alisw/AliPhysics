...
//---------------------------------------------------------------->
// DATA PURITY Pb-Pb 5.02 TeV  -->  PurDatPb502_001
// ConfigFemtoAnalysis.C 
// September 2024, Konstantin.Mikhaylov@cern.ch
// AddTaskFemto from (It is not known where to get the file, silent Gleb):
// PWGCF/FEMTOSCOPY/macros/Train/Romanenko/Mar2020_MC/add/AddTaskFemto.C
//
//  few multiplicities and one kT to find out MC purity
//  -> NO! SetMostProbableKaon()
//----------------------------------------------------------------<
...
//	  dtc1etaphitpc[aniter] = new AliFemtoESDTrackCut();
	  ...
	  dtc1etaphitpc[aniter]->SetPt(0.14,2.0);//1.5);//extend pT
