//This file are from  PWGCF/FEMTOSCOPY/macros/Train/Gleb/Nov_2020/2kT/ConfigFemtoAnalysis.C according to Gleb suggestion
//KM: comment dtc1etaphitpc[aniter]->SetMostProbableKaon();
//to study kaon purity with data dE/dx
//konstantin.Mikhaylov@cern.ch 9-SEPT-2024
/********************************************************************* 
 *                                                                   * 
