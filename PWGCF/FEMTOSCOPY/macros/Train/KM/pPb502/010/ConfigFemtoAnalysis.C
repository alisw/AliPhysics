// Konstantin Mikhaylov: 10-NOV-2023
// comment: 010-->KM pipi 02_05 05_10
// 010: PWGCF/FEMTOSCOPY/macros/Train/KM/pPb502/010/ConfigFemtoAnalysis.C
// Test for pi+pi+(pi-pi-) for Elena w/ 3d
// kT bins as for KK: 0.2-0.5, 0.5-1.0 -> {0.2, 0.5, 1.0};
// others are same as wagon 007
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
AliFemtoManager* ConfigFemtoAnalysis() {
  ...
  //AliFemtoKKTrackCut           *dtc2etaphitpc[20];
     //AliFemtoKpm45TrackCut           *dtc1etaphitpc[20];//K+K-
