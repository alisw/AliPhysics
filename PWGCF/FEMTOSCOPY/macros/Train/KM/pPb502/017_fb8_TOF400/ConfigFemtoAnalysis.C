...
//              ~~~~~~~~~~~~~~~~~~~~~~~~~~~~
// wagon: KM_pPb502_017_fb8_TOF400
//
// pPb5.02(run2) -> K+K-
// PID is the same as in PbPb2.76->K+K- paper
// 0.2-0.5,0.5-1.5; 0-20,20-40,40-90%
//  ----: TOF from p_tot>0.4 GeV/c: pid_[pa][ix]->SetPMinTOF45(0.4001);
// event shape: St:
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
AliFemtoManager* ConfigFemtoAnalysis() {
  ...
  for (int m=0; m<cMu; m++) {
	...
	pid_[pa][ix]->SetPMinTOF45(0.4001);//TOF starts to select from p_tot=0.4001 (p_tot should be > 0.4000001)
	...
	pid_[pa][ix]->SetNsigmaTPC250_400(1.0);  // 2.0 - standard
	pid_[pa][ix]->SetNsigmaTPC400_450(0.01);  //to remove e-peak decrease from 3.0(default) to smaller value = 1.0(orig!!!!) --> Do not work (see AliFemtoKpm45TrackCut.cxx)
