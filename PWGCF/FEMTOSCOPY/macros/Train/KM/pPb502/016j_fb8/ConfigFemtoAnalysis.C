...
AliFemtoManager* ConfigFemtoAnalysis() {
  ...
  AliFemtoSphericityEventCut    *bcut[iz];//AliFemtoBasicEventCut         *bcut[iz];
  ...
  AliFemtoKpm45TrackCut             *pid_[2][iz];
  ...
  for (int m=0; m<cMu; m++) {
    ...
    ix = m;//ichg*3+imult;
      ...
      bcut[ix] = new AliFemtoSphericityEventCut();//bcut[ix] = new AliFemtoBasicEventCut();
