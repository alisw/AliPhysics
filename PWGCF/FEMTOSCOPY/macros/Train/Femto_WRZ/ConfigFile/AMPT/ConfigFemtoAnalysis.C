...
//int year=2015;
  ...
  */
  ...
  AliFemtoAnalysisReactionPlane    *anetaphitpc[size];
  ...
  for (int imult = 0; imult < numOfMultBins; imult++) {
	...
	if (runch[ichg]) {
	  ...
	  anetaphitpc[aniter] = new AliFemtoAnalysisReactionPlane(10, -10.0, 10.0, 4, multbins[imult], multbins[imult+1]);
