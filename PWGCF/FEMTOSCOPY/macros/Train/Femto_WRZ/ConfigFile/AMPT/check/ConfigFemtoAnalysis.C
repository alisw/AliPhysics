...
//int year=2015;
  ...
  if(year==2015)
  {
    AliFemtoEventReaderAODMultSelection* Reader2015 = GetReader2015(kTRUE);
  ...
  */
  ...
  for (int imult = 0; imult < numOfMultBins; imult++) {
	...
	if (runch[ichg]) {
	  ...
	  dtc2etaphitpc[aniter]->SetNsigma(4.2426);
