...
//old pp
  //int multbins[6] = {1, 18, 30, 1000, 1000, 10000};
  // int multbins[6] = {1, 9, 18, 30, 10000, 10000};
...
//	  mecetaphitpc[aniter]->AddCutMonitor(cutPassColletaphitpc[aniter], cutFailColletaphitpc[aniter]);
	  ...
	  //  dtc2etaphitpc[aniter] = new AliFemtoKKTrackCutTest();
	...
	//  dtc1etaphitpc[aniter] = new AliFemtoESDTrackCut();
	  ...
	  dtc2etaphitpc[aniter]->SetPt(0.15,4.0);
	  //	  dtc1etaphitpc[aniter]->SetEta(-1.2,1.2);
	  dtc1etaphitpc[aniter]->SetEta(-0.8,0.8); //0.5
	  dtc2etaphitpc[aniter]->SetEta(-0.8,0.8); //0.5
...
/*
	    ...
	    dtc2etaphitpc[aniter]->SetminTPCncls(80); //was "0"
	    ...
	    dtc2etaphitpc[aniter]->SetMaxImpactZ(DCAz);  //3.0
*/
