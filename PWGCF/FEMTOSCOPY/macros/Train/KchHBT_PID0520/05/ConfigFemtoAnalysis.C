...
//------------------- November 2013 -----------------------------------< 
	 ...
	 dtc1etaphitpc[aniter]->SetNsigmaTPCle250(0.5);
	 dtc1etaphitpc[aniter]->SetNsigmaTPC250_400(0.5);
	  dtc1etaphitpc[aniter]->SetNsigmaTPC400_450(0.5);
	  dtc1etaphitpc[aniter]->SetNsigmaTPC450_500(0.5);
