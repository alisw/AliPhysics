                ...
                if (runmults[imult]) {
                        ...
                        for (int ichg = 0; ichg < numOfChTypes; ichg++) {
                                if (runch[ichg]) {
                                        ...
                                        if (ichg == 2) {
                                                ckstartpc[aniter] = new AliFemtoCorrFctnNonIdDR(Form("ckstar%stpcM%i", chrgs[ichg], imult),nbinssh,0.0,2*shqmax);
                                        ...
                                        cylmkttpc[aniter] = new AliFemtoCorrFctnDirectYlm(Form("cylm%stpcM%i", chrgs[ichg], imult),2,nbinssh, 0.0,2*shqmax,runshlcms);
                                        ...
                                        if (runktdep) {
                                                ...
                                                for (int ikt=0; ikt<numOfkTbins; ikt++) {
                                                        ...
                                                        cylmkttpc[ktm] = new AliFemtoCorrFctnDirectYlm(Form("cylm%stpcM%ikT%i", chrgs[ichg], imult, ikt),2,nbinssh,0.0,2*shqmax,0);
                                                        cylmkttpc[ktm]->SetPairSelectionCut(ktpcuts[ktm]);
                                                        anetaphitpc[aniter]->AddCorrFctn(cylmkttpc[ktm]);

                                                        if (ichg == 2) {
                                                                ckstarkttpc[ktm] = new AliFemtoCorrFctnNonIdDR(Form("ckstar%stpcM%ikT%i", chrgs[ichg], imult, ikt),nbinssh,0.0,2*shqmax);
