...
AliFemtoManager* ConfigFemtoAnalysis() {
  ...
  //-------Single track cuts------------------------------------------------->
  double DCAxy=2.4; //0.3; //0.2;// cm // our standard is 0.20 cm; super narrow was 0.015cm
  double DCAz =3.2; //0.3; //0.3;// cm // our standard is 0.15 cm;
  //-------Single track cuts-------------------------------------------------<
  //=======Double track cuts=================================================>
...
AliFemtoEventReaderAOD *Reader = new AliFemtoEventReaderAODMultSelection();
 Reader->SetFilterBit(7); //TPC+ITS, 7 - TPC
