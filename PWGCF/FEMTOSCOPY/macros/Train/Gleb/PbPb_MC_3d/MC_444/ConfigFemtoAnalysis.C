...
*/
    ...
    tFreeze->SetSizeOut(4.0*TMath::Sqrt(2.0));         
...
/////////////    tWeight->SetKpKmModelType(14,1);//(Martin-f0, Achasov2-a0,0->phi off;1->phi on)
 ...
 // AliFemtoCorrFctnGammaMonitorAlpha  *cgamma[20*10];
  ...
  AliFemtoModelCorrFctn3DKKGR *cq3dlcmskttpc[30*10];
...
*/
              cq3dlcmskttpc[ktm] = new AliFemtoModelCorrFctn3DKKGR(Form("cq3d%stpcM%ikT%i", chrgs[ichg], imult, ikt),60,-0.3,0.3);
