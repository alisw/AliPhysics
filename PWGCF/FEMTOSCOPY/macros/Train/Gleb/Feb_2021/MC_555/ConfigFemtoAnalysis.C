...
#include "AliFemtoModelCorrFctn3DKKGR1.h"
...
*/
    ...
    AliFemtoModelGausLCMSFreezeOutGeneratorGR *tFreeze = new AliFemtoModelGausLCMSFreezeOutGeneratorGR();
    tFreeze->SetSizeOut(5.0*TMath::Sqrt(2.0));         
    tFreeze->SetSizeSide(5.0*TMath::Sqrt(2.0));
    tFreeze->SetSizeLong(5.0*TMath::Sqrt(2.0));
...
/////////////    tWeight->SetKpKmModelType(14,1);//(Martin-f0, Achasov2-a0,0->phi off;1->phi on)
  ...
  //cout<<"fffffffffffffffffffff  "<<*(tModelManager->GetWeightGenerator())<<endl;
 ...
 // AliFemtoCorrFctnGammaMonitorAlpha  *cgamma[20*10];
  //AliFemtoModelCorrFctnTrueQ3D *cq3dlcmskttpc[30*10];
  AliFemtoModelCorrFctn3DKKGR1 *cq3dlcmskttpc[30*10];
...
//ml	    sqpcetaphitpc[aniter]->SetEtaDifferenceMinimum(0.016);
	  ...
	  anetaphitpc[aniter]->SetPairCut(sqpcetaphitpc[aniter]);
          ...
          //cq3dlcmskttpc[aniter] = new AliFemtoModelCorrFctnTrueQ3D(Form("cq3d%stpcM%ikT%i", chrgs[ichg], imult, aniter),100,-0.3,0.3);
	  ...
	  if (runktdep) {
	    ...
	    for (int ikt=0; ikt<cKt/*8*/; ikt++) {
	      ...
	      //anetaphitpc[aniter]->AddCorrFctn(cqinvsqtpc[ktm]);
           ...
           // model--------------
           /*
             cqinvkttpcmodel[ktm] = new AliFemtoModelCorrFctn(Form("cqinvModel%stpcM%ikT%i", chrgs[ichg], imult, ikt),200, 0.0,0.4);
...
*/
              cq3dlcmskttpc[ktm] = new AliFemtoModelCorrFctn3DKKGR1(Form("cq3d%stpcM%ikT%i", chrgs[ichg], imult, ikt),60,-0.3,0.3);
             
             cq3dlcmskttpc[ktm]->SetPairSelectionCut(ktpcuts[ktm]);
			 cq3dlcmskttpc[ktm]->SetFillQgenQrecInv(true);
			 cq3dlcmskttpc[ktm]->SetFillQgenQrecOutSideLong(true);
			 cq3dlcmskttpc[ktm]->SetFillDpTpTvspT(true);
			 cq3dlcmskttpc[ktm]->SetKaonPDG(kTRUE);
             cq3dlcmskttpc[ktm]->ConnectToManager(tModelManager);
