	...
	for (int imult = 0; imult < numOfMultBins; imult++)
	{
		if (runmults[imult])
		{
          ...
          dtc4etaphitpc[aniter]->SetNanoAODAnalysis(kTRUE);
					...
					dtc4etaphitpc[aniter]->SetInvariantMassLambda(0.0,100.0);
          ...
          dtc5etaphitpc[aniter]->SetNanoAODAnalysis(kTRUE);
  				if(ichg>=20 && ichg<=26)
					...
					dtc5etaphitpc[aniter]->SetInvariantMassLambda(0.0,100.0);
          ...
          if(ichg == 34 || ichg == 35 || ichg == 36 || ichg == 37){
  	        ...
  	        tXiCut[aniter]->SetNanoAODAnalysis(kTRUE);
  					tXiCut[aniter]->SetInvariantMassXi(0.0,100.0); //++ bylo 006
  				...
  				//	tXiCut[aniter]->SetNanoAODAnalysis(kTRUE);  //yes or no?
  					...
  					tAXiCut[aniter]->SetInvariantMassXi(0.0,100.0);
