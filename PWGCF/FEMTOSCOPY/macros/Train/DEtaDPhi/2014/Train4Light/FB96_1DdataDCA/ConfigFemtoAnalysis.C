					...
					if (runktdep)
					{
					  ...
					  for(int kit=0;kit<=numOfkTbins;kit++)
						...
						for (int ikt=0; ikt<numOfkTbins; ikt++)
						{
							...
							if(ichg==0 || ichg==1 || ichg==2)
							  cdedpetaphiPt[ktm]->LoadCorrectionTabFromROOTFile1D("alien:///alice/cern.ch/user/m/majanik/2014/DEtaDPhi/Trains/Corrections/Train4Light/1Dmap_FB96_DCA.root", AliFemtoCorrFctnDEtaDPhiCorrections::kPion, AliFemtoCorrFctnDEtaDPhiCorrections::kProton/*,1,1,1,1*/);
							else if(ichg==3 || ichg==4 || ichg==5)
							  ...
							  cdedpetaphiPt[ktm]->LoadCorrectionTabFromROOTFile1D("alien:///alice/cern.ch/user/m/majanik/2014/DEtaDPhi/Trains/Corrections/Train4Light/1Dmap_FB96_DCA.root", AliFemtoCorrFctnDEtaDPhiCorrections::kProton, AliFemtoCorrFctnDEtaDPhiCorrections::kPion);
							else
