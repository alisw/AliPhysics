...
AliFemtoManager* ConfigFemtoAnalysis() {
	...
	//AliFemtoCutMonitorParticlePtPDG *cutPassPtPDGetaphitpc[320];
	//AliFemtoCutMonitorParticlePtPDG *cutFailPtPDGetaphitpc[320];
	...
	//AliFemtoCorrFctnMassInvMonitor			*cMinvMonitor[320];
