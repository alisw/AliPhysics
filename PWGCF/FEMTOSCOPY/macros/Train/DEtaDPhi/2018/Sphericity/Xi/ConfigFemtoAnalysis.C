...
AliFemtoManager* ConfigFemtoAnalysis(const char* params) {
  ...
  AliFemtoVertexMultAnalysis	*anetaphitpc[noOfObjects];
  AliFemtoSphericityEventCut		*mecetaphitpc[noOfObjects];
  AliFemtoCutMonitorEventMult	*cutPassEvMetaphitpc[noOfObjects];
  AliFemtoCutMonitorEventMult	*cutFailEvMetaphitpc[noOfObjects];
  AliFemtoCutMonitorEventVertex   *cutPassEvVetaphitpc[noOfObjects];
  AliFemtoCutMonitorEventVertex   *cutFailEvVetaphitpc[noOfObjects];
  AliFemtoCutMonitorCollections   *cutPassColletaphitpc[noOfObjects];
  AliFemtoCutMonitorCollections   *cutFailColletaphitpc[noOfObjects];
  AliFemtoMJTrackCut		*dtc1etaphitpc[noOfObjects];
  AliFemtoMJTrackCut		*dtc2etaphitpc[noOfObjects];
  AliFemtoMJTrackCut		*dtc3etaphitpc[noOfObjects];
  AliFemtoV0TrackCut              *dtc4etaphitpc[noOfObjects];
  AliFemtoV0TrackCut              *dtc5etaphitpc[noOfObjects];
  AliFemtoXiTrackCut           *tXiCut[noOfObjects];
  AliFemtoXiTrackCut           *tAXiCut[noOfObjects];
  AliFemtoCutMonitorParticleYPt   *cutPass1YPtetaphitpc[noOfObjects];
  AliFemtoCutMonitorParticleYPt   *cutFail1YPtetaphitpc[noOfObjects];
  AliFemtoCutMonitorParticlePID   *cutPass1PIDetaphitpc[noOfObjects];
  AliFemtoCutMonitorParticlePID   *cutFail1PIDetaphitpc[noOfObjects];
  AliFemtoCutMonitorParticleYPt   *cutPass2YPtetaphitpc[noOfObjects];
  AliFemtoCutMonitorParticleYPt   *cutFail2YPtetaphitpc[noOfObjects];
  AliFemtoCutMonitorParticlePID   *cutPass2PIDetaphitpc[noOfObjects];
  AliFemtoCutMonitorParticlePID   *cutFail2PIDetaphitpc[noOfObjects];
  AliFemtoCutMonitorParticleYPt   *cutPass3YPtetaphitpc[noOfObjects];
  AliFemtoCutMonitorParticleYPt   *cutFail3YPtetaphitpc[noOfObjects];
  AliFemtoCutMonitorParticlePID   *cutPass3PIDetaphitpc[noOfObjects];
  AliFemtoCutMonitorParticlePID   *cutFail3PIDetaphitpc[noOfObjects];
  AliFemtoCutMonitorV0            *cutPass1V0[noOfObjects];
  AliFemtoCutMonitorV0            *cutFail1V0[noOfObjects];
  AliFemtoCutMonitorV0            *cutPass2V0[noOfObjects];
  AliFemtoCutMonitorV0            *cutFail2V0[noOfObjects];
  AliFemtoCutMonitorXi             *cutPass1Xi[noOfObjects];
  AliFemtoCutMonitorXi             *cutFail1Xi[noOfObjects];
  AliFemtoCutMonitorXi             *cutPass2Xi[noOfObjects];
  AliFemtoCutMonitorXi             *cutFail2Xi[noOfObjects];	
  //	 AliFemtoShareQualityTPCEntranceSepPairCut			*sqpcetaphitpcsame[numOfMultBins*numOfChTypes*3];
  AliFemtoPairCutAntiGamma	*sqpcetaphitpc[noOfObjects];
  //AliFemtoPairCutRadialDistance			*sqpcetaphitpc[numOfMultBins*numOfChTypes*3];
  //AliFemtoShareQualityPairCut			*sqpcetaphitpc[numOfMultBins*numOfChTypes*3];
  AliFemtoV0PairCut               *sqp1cetaphitpc[noOfObjects];
  AliFemtoV0TrackPairCut          *sqp2cetaphitpc[noOfObjects];
  AliFemtoV0TrackPairCut          *sqp3cetaphitpc[noOfObjects];
  AliFemtoV0TrackPairCut          *sqp4cetaphitpc[noOfObjects];

  AliFemtoXiTrackPairCut           *tXiTrackPairCut[noOfObjects];

	
  //	AliFemtoChi2CorrFctn					*cchiqinvetaphitpc[numOfMultBins*numOfChTypes*3];
  AliFemtoPairCutPt               *ktpcuts[noOfObjects];
  AliFemtoQinvCorrFctn		*cqinvkttpc[noOfObjects];
  AliFemtoQinvCorrFctn		*cqinvtpc[noOfObjects];
  AliFemtoCorrFctnDEtaDPhiSimpleWithCorrections *cdedpetaphi[noOfObjects];
  AliFemtoCorrFctnDEtaDPhiSimple	*cdedpetaphinocorr[noOfObjects];
  //	AliFemtoCorrFctnDYDPhiSimpleWithCorrections	*cdydpyphinocorr[numOfMultBins*numOfChTypes*3];
  AliFemtoCorrFctnDEtaDPhiCorrections *cdedpetaphiPt[noOfObjects];

  AliFemtoCorrFctnDPhiStarDEta  *cdphistardeta08[noOfObjects];
  AliFemtoCorrFctnDPhiStarDEta  *cdphistardeta12[noOfObjects];
  AliFemtoCorrFctnDPhiStarDEta  *cdphistardeta16[noOfObjects];
  AliFemtoCorrFctnDPhiStarDEta  *cdphistardeta20[noOfObjects];
	
  AliFemtoCorrFctnNonIdDR         *cnonidtpc[noOfObjects];
		  ...
		  if (runch[ichg])
		    {
		      ...
		      //aniter = ichg * numOfMultBins*3 + imult + iSphericity;
		      ...
		      if(iSphericity==0)
			{
			  mecetaphitpc[aniter]->SetStMin(0);
			  mecetaphitpc[aniter]->SetStMax(1);
			}
		      if(iSphericity==1)
			{
			  mecetaphitpc[aniter]->SetStMin(0);
		      ...
		      if(iSphericity==2)
			{
		      ...
		      //****** event monitors **********	
		    cutPassEvMetaphitpc[aniter] = new AliFemtoCutMonitorEventMult(Form("cutPass%stpcSt%iM%i", chrgs[ichg],iSphericity, imult));
		    cutFailEvMetaphitpc[aniter] = new AliFemtoCutMonitorEventMult(Form("cutFail%stpcSt%iM%i", chrgs[ichg], iSphericity, imult));
		      mecetaphitpc[aniter]->AddCutMonitor(cutPassEvMetaphitpc[aniter], cutFailEvMetaphitpc[aniter]);

		      //Study the collection multiplicity distribution
		      cutPassColletaphitpc[aniter] = new AliFemtoCutMonitorCollections(Form("cutPass%stpcSt%iM%i", chrgs[ichg], iSphericity, imult));
		      cutFailColletaphitpc[aniter] = new AliFemtoCutMonitorCollections(Form("cutFail%stpcSt%iM%i", chrgs[ichg], iSphericity, imult));
		      ...
		      if(ifMonitors)//ichg>8)
			{
			  ...
			  if(0){
			    ...
			    cutPass1V0[aniter] = new AliFemtoCutMonitorV0(Form("cutPass1%stpcSt%iM%i", chrgs[ichg], iSphericity, imult));
			    cutFail1V0[aniter] = new AliFemtoCutMonitorV0(Form("cutFail1%stpcSt%iM%i",chrgs[ichg], iSphericity, imult));
			    dtc4etaphitpc[aniter]->AddCutMonitor(cutPass1V0[aniter], cutFail1V0[aniter]);
	  
			    cutPass2V0[aniter] = new AliFemtoCutMonitorV0(Form("cutPass2%stpcSt%iM%i", chrgs[ichg], iSphericity, imult));
			    cutFail2V0[aniter] = new AliFemtoCutMonitorV0(Form("cutFail2%stpcSt%iM%i", chrgs[ichg], iSphericity, imult));
			  ...
			  if(ichg<2 || ichg==3||ichg==4 || ichg==6|| ichg==7||ichg==9||ichg==10||ichg==11){ 
			    ...
			    cutPass3YPtetaphitpc[aniter] = new AliFemtoCutMonitorParticleYPt(Form("cutPass%stpcSt%iM%i", chrgs[ichg], iSphericity, imult),PionMass);
			    cutFail3YPtetaphitpc[aniter] = new AliFemtoCutMonitorParticleYPt(Form("cutFail%stpcSt%iM%i", chrgs[ichg], iSphericity, imult),PionMass);
			  }
			  ...
			  if(ichg<2){ //PP, PaP
			    cutPass3PIDetaphitpc[aniter] = new AliFemtoCutMonitorParticlePID(Form("cutPass%stpcSt%iM%i", chrgs[ichg], iSphericity, imult),2);//0-pion,1-kaon,2-proton
			    cutFail3PIDetaphitpc[aniter] = new AliFemtoCutMonitorParticlePID(Form("cutFail%stpcSt%iM%i", chrgs[ichg], iSphericity, imult),2);
			    ...
			    cutPass3PIDetaphitpc[aniter] = new AliFemtoCutMonitorParticlePID(Form("cutPass%stpcSt%iM%i", chrgs[ichg], iSphericity, imult),1);//0-pion,1-kaon,2-proton
			    cutFail3PIDetaphitpc[aniter] = new AliFemtoCutMonitorParticlePID(Form("cutFail%stpcSt%iM%i", chrgs[ichg], iSphericity, imult),1);
			    ...
			    cutPass3PIDetaphitpc[aniter] = new AliFemtoCutMonitorParticlePID(Form("cutPass%stpcSt%iM%i", chrgs[ichg], iSphericity, imult),0);//0-pion,1-kaon,2-proton
			    cutFail3PIDetaphitpc[aniter] = new AliFemtoCutMonitorParticlePID(Form("cutFail%stpcSt%iM%i", chrgs[ichg], iSphericity, imult),0);
			    ...
			    {
			      cutPass1Xi[aniter] = new AliFemtoCutMonitorXi(Form("cutPass%stpcSt%iM%i", chrgs[ichg], iSphericity, imult));
			      cutFail1Xi[aniter] = new AliFemtoCutMonitorXi(Form("cutFail%stpcSt%iM%i", chrgs[ichg], iSphericity, imult));
		      ...
		      if(ichg == 37) //aPXip
			{
		      ...
		      //***without corrections*****
		      if(ichg >=34)
			cdedpetaphinocorr[aniter] = new AliFemtoCorrFctnDEtaDPhiSimple(Form("cdedpnocorr%stpcSt%iM%i", chrgs[ichg], iSphericity, imult),11, 11);
		      else if(ichg >= 13 || ichg < 34)
			cdedpetaphinocorr[aniter] = new AliFemtoCorrFctnDEtaDPhiSimple(Form("cdedpnocorr%stpcSt%iM%i", chrgs[ichg], iSphericity, imult),23, 23);
		      else
			cdedpetaphinocorr[aniter] = new AliFemtoCorrFctnDEtaDPhiSimple(Form("cdedpnocorr%stpcSt%iM%i", chrgs[ichg], iSphericity, imult),29, 29);

					
		      anetaphitpc[aniter]->AddCorrFctn(cdedpetaphinocorr[aniter]);
		      if(ichg==0 || ichg==1 || ichg==31 || ichg==33) //PP, aPaP, LL, ALAL
			{
			  cqinvtpc[aniter] = new AliFemtoQinvCorrFctn(Form("cqinv%stpcSt%iM%i", chrgs[ichg], iSphericity, imult),nbinssh,0.0,shqmax); //femto qinv, for identical mass particles
			...
			{
			  cnonidtpc[aniter] = new AliFemtoCorrFctnNonIdDR(Form("cnonid%stpcSt%iM%i", chrgs[ichg], iSphericity, imult), nbinssh, 0.0,shqmax); //for non-identical partcles
