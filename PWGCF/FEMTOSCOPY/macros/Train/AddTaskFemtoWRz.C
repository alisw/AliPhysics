...
AliAnalysisTaskFemto *AddTaskFemtoWRz(TString configMacroName, TString containerName="femtolist", TString configMacroParameters="",  Bool_t kGridConfig = kFALSE, TString userName = "", TString configFunName = "ConfigFemtoAnalysis")
{
...
//     else
  ...
  taskfemto->SetSelectedTriggerClass(AliVEvent::kCentral); 
