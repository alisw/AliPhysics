...
AliFemtoManager* ConfigFemtoAnalysis() {
  ...
  tFreeze->SetSizeOut(1.5*TMath::Sqrt(2.0));         
  tFreeze->SetSizeSide(1.5*TMath::Sqrt(2.0));
  tFreeze->SetSizeLong(1.5*TMath::Sqrt(2.0));
  //tFreeze->SetFillQgenQrecInv(kTRUE);
  //tFreeze->SetFillQgenQrecOutSideLong(kTRUE);
  ...
  AliFemtoModelCorrFctn3DKKGR *cq3dlcmskttpcgr[20*8];
...
//------------------- November 2013 -----------------------------------< 
	 ...
	 //dtc1etaphitpc[aniter]->SetStatus(AliESDtrack::kTPCrefit|AliESDtrack::kITSrefit);
	  ...
	  if (runktdep) {
		...
		cq3dlcmskttpcgr[ktm] = new AliFemtoModelCorrFctn3DKKGR(Form("cq3d%stpcM%ikT%i", chrgs[ichg], imult, ikt),80,-2.0,2.0);
		cq3dlcmskttpcgr[ktm]->SetPairSelectionCut(ktpcuts[ktm]);
		cq3dlcmskttpcgr[ktm]->SetKaonPDG(kTRUE);
		cq3dlcmskttpcgr[ktm]->SetFillQgenQrecInv(kFALSE);
		cq3dlcmskttpcgr[ktm]->SetFillQgenQrecOutSideLong(kTRUE);
		//cq3dlcmskttpcgr[ktm]->SetKaonPDG(kFALSE);
		cq3dlcmskttpcgr[ktm]->ConnectToManager(tModelManager);
		anetaphitpc[aniter]->AddCorrFctn(cq3dlcmskttpcgr[ktm]);
	      }
	    }
	  }
