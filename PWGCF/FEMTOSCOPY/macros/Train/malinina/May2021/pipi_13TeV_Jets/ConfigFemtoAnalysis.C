...
//old pp
  ...
  int multbins[5] = {1, 100, 30, 100, 1000};
  //.................................................
...
double ktrng[6] = {0.2, 0.5, 0.8, 2.0, 3.0, 5.0};
 
  //double ktrng[2] = {0.15, 1.2};
...
//ML jets
// Reader->SetCalcJets(1); ///0-no, 1-same, 2-diff
 //Reader->SetPtmaxJets(4.0);
...
//    AliFemtoBasicEventCut         *mecetaphitpc[20];
 ...
 // AliFemtoESDTrackCutMinusJets           *dtc1etaphitpc[20];
  //  AliFemtoESDTrackCutMinusJets           *dtc2etaphitpc[20];
	  ...
	  */
	  ...
	  mecetaphitpc[aniter] = new AliFemtoSphericityEventCut();
	    //	  mecetaphitpc[aniter] = new AliFemtoSpherocityEventCut();
          mecetaphitpc[aniter]->SetEventMult(1,100000);
          mecetaphitpc[aniter]->SetVertZPos(-10.0,10.0);
          mecetaphitpc[aniter]->SetStMin(0.001);
          mecetaphitpc[aniter]->SetStMax(0.1);
