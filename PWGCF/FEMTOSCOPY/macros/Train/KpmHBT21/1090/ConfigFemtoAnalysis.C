 ...
 *         KpmHBT19  1090  13-Mar-2018 (stict DCA other as KpmHBT18) *
 *         TOF PID from 0.45 GeV/c                                   *
 *         CUT 0.4<P<0.45 0.45 GeV/c to remove e+e- at all ----->    *
 *         SetNsigmaTPC400_450(0.0) and other set to standard        *
 *         no cut on mom and no on gamma                             *
 *         no cut on phi* eta (set to 0)                             *
 *         5 MeV/q-bin in CF                                        *
 *         DCAxy<0.24cm DCAz<0.3cm (strict cut)                      *
 *********************************************************************/
...
//------------------- November 2013 -----------------------------------< 
	 ...
	 dtc1etaphitpc[aniter]->SetNsigmaTPC400_450(2.0);//remove e+e- at all orig(2.0);--->
	 ...
	 dtc2etaphitpc[aniter]->SetNsigmaTPC400_450(2.0);//remove e+e- at all orig(2.0);--->
