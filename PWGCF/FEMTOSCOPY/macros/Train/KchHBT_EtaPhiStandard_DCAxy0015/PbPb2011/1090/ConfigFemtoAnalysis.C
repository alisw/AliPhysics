...
////	  	  dtc1etaphitpc[aniter]->SetMostProbablePion();
	  ...
	  if (runtype == 0) {
	    ...
	    dtc1etaphitpc[aniter]->SetMaxImpactXY(0.015);//0.2 - standard 
	    ...
	    //    dtc1etaphitpc[aniter]->SetMaxITSChiNdof(6.0);
	    dtc1etaphitpc[aniter]->SetMaxTPCChiNdof(4.0);
	    dtc1etaphitpc[aniter]->SetMaxImpactXY(0.0.015);//0.2 - standard 	    //            dtc1etaphitpc[aniter]->SetMaxImpactXYPtDep(0.0182, 0.0350, -1.01);
...
//ml	    sqpcetaphitpc[aniter]->SetEtaDifferenceMinimum(0.02);
	   ...
	   //--------- km: 29-April-2013, study of eta-phi* custs ----------->>>>
     	    sqpcetaphitpc[aniter]->SetPhiStarDifferenceMinimum(0.034);
