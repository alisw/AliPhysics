...
{ // Adds a Pion-Pion Femtoscopy task to the manager
  ...
  TString macro_path = DEFAULT_MACRO
        , output_filename = mgr->GetCommonFileName()
        , task_name = DEFAULT_TASK_NAME
        , container_name = DEFAULT_CONTAINER_NAME
        , output_container_name = DEFAULT_OUTPUT_CONTAINER
        ;
  ...
  const TString outputfile = (output_container_name == "")
                           ? output_filename
                           : TString::Format("%s:%s", output_filename.Data(), output_container_name.Data());
