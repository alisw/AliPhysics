///
/// \file PWGCF/FEMTOSCOPY/macros/Train/PionPionFemto/ConfigFemtoAnalysisCentralitySubtrains.C
///
...
struct MacroParams {
  ...
  bool use_subwagon_centrality;
  TString subwagon_centrality;
};
...
{
  std::cout << "[ConfigFemtoAnalysisCentralitySubtrains (PionPion)]\n";
  ...
  macro_config.use_subwagon_centrality=false;
  macro_config.subwagon_centrality = "";
  ...
  if (macro_config.use_subwagon_centrality) {
    ...
    macro_config.centrality_ranges.push_back(stop);
  }
  else if (macro_config.centrality_ranges.empty()) {
