...
AliFemtoManager* ConfigFemtoAnalysis() {
  ...
  //PhysicsSction set only in runBatch with trigger + Physics Selection Task
  ...
  Reader->SetUseMultiplicity(AliFemtoEventReaderESDChain::kCentralityV0A);
