...
AliFemtoManager* ConfigFemtoAnalysis() {
  ...
  for (int imult=0; imult<numOfMultBins; imult++) {
    if (runmults[imult]) {
	  ...
	  dtc1etaphitpc[aniter]->SetInvariantMassLambda(LambdaMass-0.0041,LambdaMass+0.0041);
	  ...
	  dtc2etaphitpc[aniter]->SetInvariantMassLambda(LambdaMass-0.0030,LambdaMass+0.0036);
          ...
          dtc4etaphitpc[aniter]->SetPt(0.6,5.0);
          ...
          dtc4etaphitpc[aniter]->SetMaxImpactZ(2.4);
	  ...
	  avgsepcorr[aniter] = new AliFemtoAvgSepCorrFctn(Form("Avgsep%stpcM%i", chrgs[ichg], imult),5000,0,500);
          ...
          sqp3cetaphitpc[aniter]->AddCutMonitor(pairOriginPass[aniter], pairOriginFail[aniter]); //antilambda-antiprotons
          sqp4cetaphitpc[aniter]->AddCutMonitor(pairOriginPass[aniter], pairOriginFail[aniter]); //(anti-)lambda-(anti-)proton mixed systems
