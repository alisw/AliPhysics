    ...
    if (runmults[imult]) {
	  ...
	  for (int iepvzero = 0; iepvzero < numOfEPvzero; iepvzero++) {
		...
		runshlcms = 1;
	      ...
	      dtc1etaphitpc[aniter]->SetPtPosDaughter(0.45,4.4); //0.5
	      dtc1etaphitpc[aniter]->SetPtNegDaughter(0.144,4.4); //0.16
	      ...
	      dtc2etaphitpc[aniter]->SetPtPosDaughter(0.144,4.4);
	      dtc2etaphitpc[aniter]->SetPtNegDaughter(0.27,4.4);
