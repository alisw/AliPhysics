    ...
    if (runmults[imult]) {
	  ...
	  for (int iepvzero = 0; iepvzero < numOfEPvzero; iepvzero++) {
		...
		runshlcms = 1;
	      ...
	      sqp1cetaphitpc[aniter]->SetMinAvgSeparation(0, 10.8); //proton-pion+
	      sqp1cetaphitpc[aniter]->SetMinAvgSeparation(1, 9); //proton-antiproton
	      sqp1cetaphitpc[aniter]->SetMinAvgSeparation(2, 13.5); //pion- - pion+
	      sqp1cetaphitpc[aniter]->SetMinAvgSeparation(3, 10.8); //antiproton - pion-
	      ...
	      sqp2cetaphitpc[aniter]->SetMinAvgSeparation(0, 13.5); //0 - track-pos, 1 - track-neg
	      sqp2cetaphitpc[aniter]->SetMinAvgSeparation(1, 13.5);  
	      ...
	      sqp3cetaphitpc[aniter]->SetMinAvgSeparation(0, 13.5); //0 - track-pos, 1 - track-neg
	      sqp3cetaphitpc[aniter]->SetMinAvgSeparation(1, 13.5);
