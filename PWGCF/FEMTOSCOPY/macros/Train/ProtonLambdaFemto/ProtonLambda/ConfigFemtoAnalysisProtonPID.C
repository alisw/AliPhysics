...
AliFemtoManager* ConfigFemtoAnalysis(Int_t fAvgSep=0, Int_t fCosPAngle=0, Int_t fDCAdaughters=0, Int_t fDCAXYprotons=0,
				     ...
				     Int_t fpTprotons=0, Int_t fpTV0=0, Int_t fInvariantMass=0, Int_t fInvariantMassK0s=0,
				     Bool_t fSharedDaughter=kTRUE) {
    ...
    if (runmults[imult]) {
	  ...
	  for (int iepvzero = 0; iepvzero < numOfEPvzero; iepvzero++) {
	    if (runepvzero[iepvzero]) {
	      ...
	      dtc1etaphitpc[aniter]->SetEta(0.8 + 0.08*fEtaV0);
	      dtc1etaphitpc[aniter]->SetPt(0.5 - 0.05*fpTV0 , 5.0 + 0.5*fpTV0);
	      dtc1etaphitpc[aniter]->SetEtaDaughters(0.8 + 0.08*fEtaDaughters);
	      dtc1etaphitpc[aniter]->SetPtPosDaughter(0.5 - 0.05*fpTdaughters, 4.0 + 0.4*fpTdaughters);
	      dtc1etaphitpc[aniter]->SetPtNegDaughter(0.16 - 0.016*fpTdaughters, 4.0 + 0.4*fpTdaughters);
	      ...
	      dtc1etaphitpc[aniter]->SetMaxDcaV0Daughters(0.4 + 0.04*fMaxDCAdaughters);
	      ...
	      dtc2etaphitpc[aniter]->SetMaxDcaV0Daughters(0.4 + 0.04*fMaxDCAdaughters);
	      ...
	      dtc2etaphitpc[aniter]->SetMaxCosPointingAngle(0.9993 + 0.09993*fCosPAngle);
