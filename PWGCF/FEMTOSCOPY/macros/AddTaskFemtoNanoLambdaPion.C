...
AliAnalysisTaskSE *AddTaskFemtoNanoLambdaPion(bool isMC = false,
                                              ...
                                              AliAnalysisTaskNanoLambdaPion::PCSettings pcsettings = AliAnalysisTaskNanoLambdaPion::PCSettings::NoPC,  // choose pair cleaner
                                              ...
                                              const char *cutVariation = "0")
{
  ...
  AliAnalysisTaskNanoLambdaPion *task =
      new AliAnalysisTaskNanoLambdaPion(
          "AliAnalysisTaskNanoLambdaPion", isMC, pcsettings, usenolambdaevt);
