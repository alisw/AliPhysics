...
AliAnalysisTaskSE* AddTaskKdMC(bool isMC = false,//1
  ...
  // Substitute Bhawani deuteron selection for oton:
  // -----------------------------------------------
  ...
  // Substitute Bhawani proton selection for kaons:
  // -----------------------------------------------
  ...
  AliFemtoDreamTrackCuts *TrackCutsProtonDCA = AliFemtoDreamTrackCuts::PrimKaonCuts(
        isMC, true, false, false);
  TrackCutsProtonDCA->SetCutCharge(1);
  TrackCutsProtonDCA->SetFilterBit(128);
  TrackCutsProtonDCA->SetPIDkd();

  AliFemtoDreamTrackCuts *TrackCutsAntiProtonDCA = AliFemtoDreamTrackCuts::PrimKaonCuts(
        isMC, true, false, false);
  TrackCutsAntiProtonDCA->SetCutCharge(-1);
  TrackCutsAntiProtonDCA->SetFilterBit(128);
  TrackCutsAntiProtonDCA->SetPIDkd();
