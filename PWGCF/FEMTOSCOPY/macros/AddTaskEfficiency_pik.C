//=============================================================================
//
// *** AliAnalysisTaskParticlePurityEfficiency_pik.C ***
//
...
AliAnalysisTaskParticlePurityEfficiency_pik *AddTaskEfficiency_pik(TString containerName="femtolist")
{
  ...
  if (!mgr) {
    Error("AddTaskEfficiency_pik", "No analysis manager to connect to.");
    return NULL;
  }
  ...
  if (!mgr->GetInputEventHandler()) {
    ::Error("AddTaskEfficiency_pik", "This task requires an input event handler");
    return NULL;
  }
