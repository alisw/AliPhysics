...
AliAnalysisTaskSE *AddTaskThreeBodyFemtoSystematics2(int trigger = 0, bool fullBlastQA = true,
  ...
  config->SetMultBinning(true);
   ...
   if (suffix == "1") {
    ...
    TrackCuts->SetPtRange(0.55, 4.05);
    AntiTrackCuts->SetPtRange(0.55, 4.05);
    ...
    TrackCuts->SetPtRange(0.45, 4.05);
    AntiTrackCuts->SetPtRange(0.45, 4.05);
