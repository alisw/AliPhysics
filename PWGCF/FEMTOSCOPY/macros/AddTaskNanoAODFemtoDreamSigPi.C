AliAnalysisTaskSE* AddTaskNanoAODFemtoDreamSigPi(
    bool isMC=true,
  ...
  //fTrackCutsPion0->SetPtRange(0.14, 4.0);
  fTrackCutsPion0->SetMinimalBooking(false);
  ...
  //fTrackCutsSigmaPlus->SetPtRange(0.14, 4.0);
  fTrackCutsSigmaPlus->SetMinimalBooking(false);
  //The same things for sigma-
  AliFemtoDreamTrackCuts *fTrackCutsSigmaMinus=new AliFemtoDreamTrackCuts();
  fTrackCutsSigmaMinus->SetIsMonteCarlo(isMC);
  //fTrackCutsSigmaMinus->SetPtRange(0.14, 4.0);
  fTrackCutsSigmaMinus->SetMinimalBooking(false);
  ...
  //fTrackCutsSigma0->SetPtRange(0.14, 4.0);
  fTrackCutsSigma0->SetMinimalBooking(false);
  ...
  AliAnalysisTaskNanoAODFemtoDreamSigPi *task=
      new AliAnalysisTaskNanoAODFemtoDreamSigPi("NanoAODFemtoDreamPionSigPi",isMC);
