//=============================================================================
//
// *** AliAnalysisTaskParticleEfficiencyMezonPhiDR.C ***
//
...
//   }
  ...
  AliAnalysisTaskParticleEfficiencyMezonPhiDR *taskEfficiency = new AliAnalysisTaskParticleEfficiencyMezonPhiDR("EfficiencyTask",method,filterbit);
