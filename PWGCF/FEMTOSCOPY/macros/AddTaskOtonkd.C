...
AliAnalysisTaskSE* AddTaskOtonkd(bool isMC = false,//1
    int KaonCut = 0,//2
    int DeuteronCut = 0,//3
...
//  TrackCutsAntiDeuteron->SetPID(AliPID::kDeuteron, 999., 4.);
...
/////////////////////////////////////////////////////////
  ...
  AliAnalysisTaskOtonkd *task =
    new AliAnalysisTaskOtonkd("FemtoDreamDefault", isMC);
