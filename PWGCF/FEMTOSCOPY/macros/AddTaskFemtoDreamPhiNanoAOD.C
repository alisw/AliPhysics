...
//  }
  ...
  if (suffix == "1") {
    TrackCutsPhi->SetCutWindow(0.987,0.991);
  }
  if (suffix == "2") {
    TrackCutsPhi->SetCutWindow(0.991,1.011);
  }
  if (suffix == "3") {
  TrackCutsPhi->SetCutWindow(1.027,1.047);
  }
  if (suffix == "4") {
  TrackCutsPhi->SetCutWindow(1.047,1.067);
  }
  if (suffix == "5") {
  TrackCutsPhi->SetCutWindow(1.067,1.087);
  }
  if (suffix == "6") {
  TrackCutsPhi->SetCutWindow(1.087,1.107);
  }
  if (suffix == "7") {
  TrackCutsPhi->SetCutWindow(1.107,1.127);
  }
  if (suffix == "8") {
  TrackCutsPhi->SetCutWindow(1.127,1.147);
  }
  if (suffix == "9") {
  TrackCutsPhi->SetCutWindow(1.147,1.167);
  }
  if (suffix == "10") {
  TrackCutsPhi->SetCutWindow(1.167,1.187);
  }
  if (suffix == "11") {
  TrackCutsPhi->SetCutWindow(1.187,1.2);
  }
  if (suffix == "12") {
  TrackCutsPhi->SetCutWindow(1.027,1.067);
  }
  if (suffix == "13") {
  TrackCutsPhi->SetCutWindow(1.067,1.107);
  }
  if (suffix == "14") {
  TrackCutsPhi->SetCutWindow(1.107,1.147);
  }
  if (suffix == "15") {
  TrackCutsPhi->SetCutWindow(1.147,1.187);
  }
  if (suffix == "16") {
