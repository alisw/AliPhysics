...
//Proton cuts:
  ...
  TrackCuts->SetNClsTPC(60);
  TrackCuts->SetDCAVtxXY(2.5);
  AntiTrackCuts->SetPtRange(0.4, 4.05);
  AntiTrackCuts->SetEtaRange(-0.9, 0.9);
  AntiTrackCuts->SetNClsTPC(60);
