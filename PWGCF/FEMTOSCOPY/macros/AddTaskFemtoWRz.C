...
AliAnalysisTaskFemto *AddTaskFemtoWRz(const char *configMacroName="ConfigFemtoAnalysis.C", const char *configMacroParameters="" )
{
// Creates a proton analysis task and adds it to the analysis manager.
  ...
  if (!mgr) {
    Error("AddTaskFemtoWRz", "No analysis manager to connect to.");
    return NULL;
  }
  ...
  if (!mgr->GetInputEventHandler()) {
    ::Error("AddTaskFemtoWRz", "This task requires an input event handler");
    return NULL;
  }  
