#ifndef ALIANALYSISTASKPARTICLEEFFPBPB5020
#define ALIANALYSISTASKPARTICLEEFFPBPB5020
...
class AliAnalysisTaskParticleEffpbpb5020 :public AliAnalysisTaskSE{
  public:
  AliAnalysisTaskParticleEffpbpb5020() : AliAnalysisTaskSE(),centrality(0), fHistoList(0),  fHistEv(0), fpidResponse(0), fAODpidUtil(0)
    {
  ...
  AliAnalysisTaskParticleEffpbpb5020(const Char_t *partName); // default constructor
  virtual ~AliAnalysisTaskParticleEffpbpb5020(); // default destructor
  virtual void UserCreateOutputObjects(); // user create output objects
  virtual void UserExec(Option_t *option); // user exec
  
  private:
  AliAnalysisTaskParticleEffpbpb5020(const AliAnalysisTaskParticleEffpbpb5020 &); // copy constructor
  AliAnalysisTaskParticleEffpbpb5020 &operator=(const AliAnalysisTaskParticleEffpbpb5020 &); // operator=
  ...
  TH3F *fMisidentification[MULTBINS*PARTTYPES][2];
  ...
  ClassDef(AliAnalysisTaskParticleEffpbpb5020, 0);
