#ifndef ALIANALYSISEFFTASKDOUBLECOUNTPID
#define ALIANALYSISEFFTASKDOUBLECOUNTPID
...
class AliAnalysisEffTaskDoubleCountPID :public AliAnalysisTaskSE{
 public:
 ...
 AliAnalysisEffTaskDoubleCountPID();

  AliAnalysisEffTaskDoubleCountPID(TString name, int pidMethod=1, int filterbit=128); // default constructor
  virtual ~AliAnalysisEffTaskDoubleCountPID(); // default destructor
 ...
 private:
  AliAnalysisEffTaskDoubleCountPID(const AliAnalysisEffTaskDoubleCountPID &); // copy constructor
  AliAnalysisEffTaskDoubleCountPID &operator=(const AliAnalysisEffTaskDoubleCountPID &); // operator=
  ...
  ClassDef(AliAnalysisEffTaskDoubleCountPID, 0);
