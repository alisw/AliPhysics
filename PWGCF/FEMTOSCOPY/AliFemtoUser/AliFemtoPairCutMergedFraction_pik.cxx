...
#ifdef __ROOT__
ClassImp(AliFemtoPairCutMergedFraction_pik)
#endif
...
//__________________
AliFemtoPairCutMergedFraction_pik::AliFemtoPairCutMergedFraction_pik(const AliFemtoPairCutMergedFraction_pik& cPairCut) :
...
//__________________
AliFemtoPairCutMergedFraction_pik::~AliFemtoPairCutMergedFraction_pik() {

}

AliFemtoPairCutMergedFraction_pik& AliFemtoPairCutMergedFraction_pik::operator=(const AliFemtoPairCutMergedFraction_pik& cPairCut) {
  if(this != &cPairCut) {
...
//__________________
bool AliFemtoPairCutMergedFraction_pik::Pass(const AliFemtoPair* pair) {
...
//__________________
AliFemtoString AliFemtoPairCutMergedFraction_pik::Report()
{
  // Prepare a report from the execution
  AliFemtoString report = "AliFemtoPairCutMergedFraction_pik Pair Cut";
...
//__________________
TList *AliFemtoPairCutMergedFraction_pik::ListSettings() {
  // return a list of settings in a writable form
  TList *tListSetttings =  AliFemtoPairCut::ListSettings();
  tListSetttings->AddLast(new TObjString(Form("AliFemtoPairCutMergedFraction_pik.radiusrange=(%f,%f)", fRadiusMin, fRadiusMax)));

  return tListSetttings;
}

//__________________
void AliFemtoPairCutMergedFraction_pik::SetDistanceMax(double maxdistance) {
  fDistanceMax = maxdistance;
}

//__________________
void AliFemtoPairCutMergedFraction_pik::SetMergedFractionLimit(double fractionlimit) {
  fMergedFractionLimit = fractionlimit;
}

//__________________
void AliFemtoPairCutMergedFraction_pik::SetDEtaMax(double maxeta) {
  fDEtaMax = maxeta;
}

//__________________
void AliFemtoPairCutMergedFraction_pik::SetMagneticFieldSign(int magsign) {
  if(magsign>1)
    fMagSign = 1;
  else if(magsign<1)
    fMagSign = -1;
...
void AliFemtoPairCutMergedFraction_pik::SetMagneticFieldValue(double magval) {
  fMagFieldVal = magval;
}

//__________________
void AliFemtoPairCutMergedFraction_pik::SetRadiusMin(double radmin) {
  fRadiusMin = radmin;
}

//__________________
void AliFemtoPairCutMergedFraction_pik::SetRadiusMax(double radmax) {
  fRadiusMax = radmax;
}

//__________________
void AliFemtoPairCutMergedFraction_pik::SetMergedFractionDataType(AliFemtoDataType datatype) {
