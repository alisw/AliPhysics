...
*/
 ...
 private:
  AliAnalysisTaskEfficiencyFB128(const AliAnalysisTaskEfficiencyFB128 &); // copy constructor
  AliAnalysisTaskEfficiencyFB128 &operator=(const AliAnalysisTaskEfficiencyFB128 &); // operator=
