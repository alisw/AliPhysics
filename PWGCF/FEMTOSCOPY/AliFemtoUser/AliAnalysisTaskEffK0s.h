#ifndef ALIANALYSISTASKEFFK0S
#define ALIANALYSISTASKEFFK0S
...
class AliAnalysisTaskEffK0s :public AliAnalysisTaskSE{
 public:
 ...
 AliAnalysisTaskEffK0s(); /*AliAnalysisTaskSE(name), centrality(0), fHistoList(0),  fMassInvK0sPass(0), fMassInvK0sFail(0),fEtaK0s(0),fPtK0s(0), fCutsK0s(0), fTruePtK0sMC(0), fRecPtK0sMC(0), fDCAtoPrimVtx(0), fIfAliEventCuts(kFALSE), fFB(128), fPidMethod(kExclusivePIDDiffRejection),  fEstEventMult(kV0M), fpidResponse(0), fAODpidUtil(0), fEventCuts(0)
  ...
  AliAnalysisTaskEffK0s(TString name, int pidMethod=3, int filterbit=128); // default constructor
  virtual ~AliAnalysisTaskEffK0s(); // default destructor
 ...
 private:
  AliAnalysisTaskEffK0s(const AliAnalysisTaskEffK0s &); // copy constructor
  AliAnalysisTaskEffK0s &operator=(const AliAnalysisTaskEffK0s &); // operator=
  ...
  ClassDef(AliAnalysisTaskEffK0s, 0);
