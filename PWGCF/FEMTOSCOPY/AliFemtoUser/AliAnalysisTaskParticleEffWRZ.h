...
class AliAnalysisTaskParticleEffWRZ :public AliAnalysisTaskSE{
  public:
  AliAnalysisTaskParticleEffWRZ() : AliAnalysisTaskSE(),centrality(0), fHistoList(0),  fHistEv(0), fpidResponse(0), fAODpidUtil(0),  fcen(0)
    {
  ...
  AliAnalysisTaskParticleEffWRZ(const Char_t *partName, int cen=0); // default constructor
