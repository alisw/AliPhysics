...
#ifdef __ROOT__
ClassImp(AliFemtoAnalysisAzimuthalPbPb2Order)
#endif
...
AliFemtoAnalysisAzimuthalPbPb2Order::AliFemtoAnalysisAzimuthalPbPb2Order(unsigned int binsVertex, double minVertex, double maxVertex,
...
AliFemtoAnalysisAzimuthalPbPb2Order::AliFemtoAnalysisAzimuthalPbPb2Order(const AliFemtoAnalysisAzimuthalPbPb2Order& a) :
...
AliFemtoAnalysisAzimuthalPbPb2Order& AliFemtoAnalysisAzimuthalPbPb2Order::operator=(const AliFemtoAnalysisAzimuthalPbPb2Order& a)
{
    // Assignment operator
    if (this == &a)
        return *this;
...
//____________________________
AliFemtoAnalysisAzimuthalPbPb2Order::~AliFemtoAnalysisAzimuthalPbPb2Order(){
...
double AliFemtoAnalysisAzimuthalPbPb2Order::GetCurrentReactionPlane()
{
    return fRP;
}
