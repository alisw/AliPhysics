...
#include "AliFemtoAnalysisAzimuthalPbPb_fixed.h"
#include <TMath.h>
#include <string>
#include <cstdio>
...
#ifdef __ROOT__
ClassImp(AliFemtoAnalysisAzimuthalPbPb_fixed)
#endif
...
AliFemtoAnalysisAzimuthalPbPb_fixed::AliFemtoAnalysisAzimuthalPbPb_fixed(unsigned int binsVertex, double minVertex, double maxVertex,
...
AliFemtoAnalysisAzimuthalPbPb_fixed::AliFemtoAnalysisAzimuthalPbPb_fixed(const AliFemtoAnalysisAzimuthalPbPb_fixed& a) :
...
AliFemtoAnalysisAzimuthalPbPb_fixed& AliFemtoAnalysisAzimuthalPbPb_fixed::operator=(const AliFemtoAnalysisAzimuthalPbPb_fixed& a)
{
    // Assignment operator
    if (this == &a)
        return *this;
...
//____________________________
AliFemtoAnalysisAzimuthalPbPb_fixed::~AliFemtoAnalysisAzimuthalPbPb_fixed(){
    // now delete every PicoEvent in the EventMixingBuffer and then the Buffer itself
    delete fPicoEventCollectionVectorHideAway;
}

//_________________________
void AliFemtoAnalysisAzimuthalPbPb_fixed::ProcessEvent(const AliFemtoEvent* hbtEvent) {
...
void AliFemtoAnalysisAzimuthalPbPb_fixed::MakePairs(const char* typeIn, AliFemtoPicoEventRP *picoevent1,
...
TVector2 AliFemtoAnalysisAzimuthalPbPb_fixed::GetQVector(AliFemtoParticleCollection* particlecollection){
...
float AliFemtoAnalysisAzimuthalPbPb_fixed::GetPsiAngle(AliFemtoParticleCollection* particlecollection){
...
double AliFemtoAnalysisAzimuthalPbPb_fixed::GetCurrentReactionPlane()
{
    return fRP;
}

//______________________________________________________________________________
void AliFemtoAnalysisAzimuthalPbPb_fixed::SetEPhistname(char* histname)
{
...
//_________________________
TList* AliFemtoAnalysisAzimuthalPbPb_fixed::GetOutputList()
{
