...
AliAnalysisEffTaskExclusivePID::AliAnalysisEffTaskExclusivePID() :
  AliAnalysisTaskSE(), centrality(0), fHistoList(0), fDCAtoPrimVtx(0), fIfAliEventCuts(kFALSE), fFB(128), fPidMethod(kExclusivePID), fpidResponse(0), fAODpidUtil(0), fEventCuts(0)
...
AliAnalysisEffTaskExclusivePID::AliAnalysisEffTaskExclusivePID(TString name, int pidMethod, int filterbit) :
  AliAnalysisTaskSE(name), centrality(0), fHistoList(0), fDCAtoPrimVtx(0), fIfAliEventCuts(kFALSE), fFB(128), fPidMethod(kExclusivePID), fpidResponse(0), fAODpidUtil(0), fEventCuts(0)
