#ifndef ALIANALYSISTASKEFFK0SS_PP
#define ALIANALYSISTASKEFFK0SS_PP
...
class AliAnalysisTaskEffK0ss_pp :public AliAnalysisTaskSE{
 public:
 ...
 AliAnalysisTaskEffK0ss_pp(); /*AliAnalysisTaskSE(name), centrality(0), fHistoList(0),  fMassInvK0sPass(0), fMassInvK0sFail(0),fEtaK0s(0),fPtK0s(0), fCutsK0s(0), fTruePtK0sMC(0), fRecPtK0sMC(0), fDCAtoPrimVtx(0), fIfAliEventCuts(kFALSE), fFB(128), fPidMethod(kExclusivePIDDiffRejection),  fEstEventMult(kV0M), fpidResponse(0), fAODpidUtil(0), fEventCuts(0)
  ...
  AliAnalysisTaskEffK0ss_pp(TString name, int pidMethod=3, int filterbit=128); // default constructor
  virtual ~AliAnalysisTaskEffK0ss_pp(); // default destructor
 ...
 private:
  AliAnalysisTaskEffK0ss_pp(const AliAnalysisTaskEffK0ss_pp &); // copy constructor
  AliAnalysisTaskEffK0ss_pp &operator=(const AliAnalysisTaskEffK0ss_pp &); // operator=
  ...
  ClassDef(AliAnalysisTaskEffK0ss_pp, 0);
