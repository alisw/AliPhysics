...
//FB768 -> 9 multiplicity in PbPb in DR task 
double fV1FB768[3];
...
AliAnalysisEffTaskFilterBit768::AliAnalysisEffTaskFilterBit768() :
  AliAnalysisTaskSE(), centrality(0), fHistoList(0), fDCAtoPrimVtx(0), fIfAliEventCuts(kFALSE), fFB(768), fPidMethod(kExclusivePIDDiffRejection), fpidResponse(0), fAODpidUtil(0), fEventCuts(0)
...
AliAnalysisEffTaskFilterBit768::AliAnalysisEffTaskFilterBit768(TString name, int pidMethod, int filterbit) :
  AliAnalysisTaskSE(name), centrality(0), fHistoList(0), fDCAtoPrimVtx(0), fIfAliEventCuts(kFALSE), fFB(768), fPidMethod(kExclusivePIDDiffRejection), fpidResponse(0), fAODpidUtil(0), fEventCuts(0)
