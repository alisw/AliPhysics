...
#ifndef AliFemtoAnalysisAzimuthalPbPbThird_H
#define AliFemtoAnalysisAzimuthalPbPbThird_H
...
class AliFemtoAnalysisAzimuthalPbPbThird : public AliFemtoSimpleAnalysis {

public:

  AliFemtoAnalysisAzimuthalPbPbThird(unsigned int binsVertex=10, double minVertex=-100., double maxVertex=+100., unsigned int binsMult=10, double minMult=-1.e9, double maxMult=+1.e9, unsigned short binsRP=10);
  AliFemtoAnalysisAzimuthalPbPbThird(const AliFemtoAnalysisAzimuthalPbPbThird& TheOriginalAnalysis);  // copy constructor

  AliFemtoAnalysisAzimuthalPbPbThird& operator=(const AliFemtoAnalysisAzimuthalPbPbThird& aAna);
...
//   virtual void FillHBTParticleCollectionRP(AliFemtoParticleCut* partCut, AliFemtoEvent* hbtEvent, AliFemtoPicoEventRP* picoevent);
  ...
  virtual ~AliFemtoAnalysisAzimuthalPbPbThird();
