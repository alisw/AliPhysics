/******************************************************************************/
/*                                                                            */
/*  AliFemtoModelCorrFctn3DKKGR1 -   numerator and denominator                 */
...
#ifdef __ROOT__
  /// \cond CLASSIMP
  ClassImp(AliFemtoModelCorrFctn3DKKGR1, 1);
  /// \endcond
#endif
...
AliFemtoModelCorrFctn3DKKGR1::AliFemtoModelCorrFctn3DKKGR1()
...
//_______________________
AliFemtoModelCorrFctn3DKKGR1::AliFemtoModelCorrFctn3DKKGR1(const char *title,
                                             Int_t aNbins,
                                             Double_t aQinvLo,
                                             Double_t aQinvHi)
  : AliFemtoModelCorrFctn()
...
//_______________________
AliFemtoModelCorrFctn3DKKGR1::AliFemtoModelCorrFctn3DKKGR1(const AliFemtoModelCorrFctn3DKKGR1& aCorrFctn)
...
//_______________________
AliFemtoModelCorrFctn3DKKGR1& AliFemtoModelCorrFctn3DKKGR1::operator=(const AliFemtoModelCorrFctn3DKKGR1& aCorrFctn)
{
  // Assignment operator
  if (this == &aCorrFctn) {
    return *this;
...
//_______________________
void AliFemtoModelCorrFctn3DKKGR1::ConnectToManager(AliFemtoModelManager *aManager)
{
  fManager = aManager;
}

//_______________________
AliFemtoString AliFemtoModelCorrFctn3DKKGR1::Report()
{
  // Prepare report
  AliFemtoString tStr = "AliFemtoModelCorrFctn3DKKGR1 report";

  return tStr;
}

//_______________________
void AliFemtoModelCorrFctn3DKKGR1::AddRealPair(AliFemtoPair* aPair)
{
...
//_______________________
void AliFemtoModelCorrFctn3DKKGR1::AddMixedPair(AliFemtoPair* aPair)
{
  if (fPairCut && !fPairCut->Pass(aPair)) {
    return;
  }
...
void AliFemtoModelCorrFctn3DKKGR1::SetSpecificPairCut(AliFemtoPairCut* aCut)
{
  fPairCut = aCut;
}

//_______________________
Double_t AliFemtoModelCorrFctn3DKKGR1::GetQinvTrue(AliFemtoPair* aPair)
{
  if(!fKaonPDG) {
...
Double_t AliFemtoModelCorrFctn3DKKGR1::GetQoutTrue(AliFemtoPair* aPair)
{
  const AliFemtoParticle *first = aPair->Track1(),
                         *second = aPair->Track2();
...
Double_t AliFemtoModelCorrFctn3DKKGR1::GetQsideTrue(AliFemtoPair* aPair)
{
  const AliFemtoParticle *first = aPair->Track1(),
                         *second = aPair->Track2();
...
Double_t AliFemtoModelCorrFctn3DKKGR1::GetQlongTrue(AliFemtoPair* aPair)
{
...
//_______________________
void AliFemtoModelCorrFctn3DKKGR1::EventBegin(const AliFemtoEvent* /* aEvent */)
{
  /* Do nothing */
}
//_______________________
void AliFemtoModelCorrFctn3DKKGR1::EventEnd(const AliFemtoEvent* /* aEvent */)
{
  /* Do nothing */
}
//_______________________
void AliFemtoModelCorrFctn3DKKGR1::Finish()
{
  /* Do nothing */
}
//_______________________
void AliFemtoModelCorrFctn3DKKGR1::Write()
{
...
TList* AliFemtoModelCorrFctn3DKKGR1::GetOutputList()
{
...
void AliFemtoModelCorrFctn3DKKGR1::SetKaonPDG(Bool_t aSetKaonAna)
{
  fKaonPDG = aSetKaonAna;
}

double AliFemtoModelCorrFctn3DKKGR1::GetParentsKt(AliFemtoPair *pair)
{
...
int AliFemtoModelCorrFctn3DKKGR1::GetPairNumber(AliFemtoPair *pair)
{
