#ifndef ALIANALYSISEFFTASKFILTERBIT16
#define ALIANALYSISEFFTASKFILTERBIT16
...
class AliAnalysisEffTaskFilterBit16 :public AliAnalysisTaskSE{
 public:
...
*/
  AliAnalysisEffTaskFilterBit16(TString name, int pidMethod=3, int filterbit=16); // default constructor
  virtual ~AliAnalysisEffTaskFilterBit16(); // default destructor
 ...
 private:
  AliAnalysisEffTaskFilterBit16(const AliAnalysisEffTaskFilterBit16 &); // copy constructor
  AliAnalysisEffTaskFilterBit16 &operator=(const AliAnalysisEffTaskFilterBit16 &); // operator=
  ...
  ClassDef(AliAnalysisEffTaskFilterBit16, 0);
