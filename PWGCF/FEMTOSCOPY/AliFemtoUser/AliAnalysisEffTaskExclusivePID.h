#ifndef ALIANALYSISEFFTASKEXCLUSIVEPID
#define ALIANALYSISEFFTASKEXCLUSIVEPID
...
class AliAnalysisEffTaskExclusivePID :public AliAnalysisTaskSE{
 public:
 ...
 AliAnalysisEffTaskExclusivePID();
  ...
  AliAnalysisEffTaskExclusivePID(TString name, int pidMethod=2, int filterbit=128); // default constructor
  virtual ~AliAnalysisEffTaskExclusivePID(); // default destructor
 ...
 private:
  AliAnalysisEffTaskExclusivePID(const AliAnalysisEffTaskExclusivePID &); // copy constructor
  AliAnalysisEffTaskExclusivePID &operator=(const AliAnalysisEffTaskExclusivePID &); // operator=
  ...
  ClassDef(AliAnalysisEffTaskExclusivePID, 0);
