#ifndef ALIANALYSISEFFICIENCYPBPBNODOUBLECOUNT
#define ALIANALYSISEFFICIENCYPBPBNODOUBLECOUNT
...
class AliAnalysisEfficiencyPbPbNodoublecount :public AliAnalysisTaskSE{
 public:
...
AliAnalysisEfficiencyPbPbNodoublecount();
...
*/
  AliAnalysisEfficiencyPbPbNodoublecount(TString name, int pidMethod=1, int filterbit=128); // default constructor
  virtual ~AliAnalysisEfficiencyPbPbNodoublecount(); // default destructor
 ...
 private:
  AliAnalysisEfficiencyPbPbNodoublecount(const AliAnalysisEfficiencyPbPbNodoublecount &); // copy constructor
  AliAnalysisEfficiencyPbPbNodoublecount &operator=(const AliAnalysisEfficiencyPbPbNodoublecount &); // operator=
  ...
  ClassDef(AliAnalysisEfficiencyPbPbNodoublecount, 0);
