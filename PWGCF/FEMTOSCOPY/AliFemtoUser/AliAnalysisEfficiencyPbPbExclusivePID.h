#ifndef ALIANALYSISEFFICIENCYPBPBEXCLUSIVEPID
#define ALIANALYSISEFFICIENCYPBPBEXCLUSIVEPID
...
class AliAnalysisEfficiencyPbPbExclusivePID :public AliAnalysisTaskSE{
 public:
...
AliAnalysisEfficiencyPbPbExclusivePID();
...
*/
  AliAnalysisEfficiencyPbPbExclusivePID(TString name, int pidMethod=2, int filterbit=128); // default constructor
  virtual ~AliAnalysisEfficiencyPbPbExclusivePID(); // default destructor
 ...
 private:
  AliAnalysisEfficiencyPbPbExclusivePID(const AliAnalysisEfficiencyPbPbExclusivePID &); // copy constructor
  AliAnalysisEfficiencyPbPbExclusivePID &operator=(const AliAnalysisEfficiencyPbPbExclusivePID &); // operator=
  ...
  ClassDef(AliAnalysisEfficiencyPbPbExclusivePID, 0);
