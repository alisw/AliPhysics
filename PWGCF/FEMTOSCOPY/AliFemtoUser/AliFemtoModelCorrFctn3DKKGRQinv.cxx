/******************************************************************************/
/*                                                                            */
/*  AliFemtoModelCorrFctn3DKKGRQinv -   numerator and denominator             */
...
#ifdef __ROOT__
  /// \cond CLASSIMP
  ClassImp(AliFemtoModelCorrFctn3DKKGRQinv, 1);
  /// \endcond
#endif

#include "AliFemtoModelGausLCMSFreezeOutGenerator.h"
#include "AliFemtoModelHiddenInfo.h"
#include "AliFemtoModelCorrFctn3DKKGRQinv.h"
...
AliFemtoModelCorrFctn3DKKGRQinv::AliFemtoModelCorrFctn3DKKGRQinv()
...
//_______________________
AliFemtoModelCorrFctn3DKKGRQinv::AliFemtoModelCorrFctn3DKKGRQinv(const char *title,
                                             Int_t aNbins,
                                             Double_t aQinvLo,
                                             Double_t aQinvHi)
  : AliFemtoModelCorrFctn()
...
//_______________________
AliFemtoModelCorrFctn3DKKGRQinv::AliFemtoModelCorrFctn3DKKGRQinv(const AliFemtoModelCorrFctn3DKKGRQinv& aCorrFctn)
...
//_______________________
AliFemtoModelCorrFctn3DKKGRQinv& AliFemtoModelCorrFctn3DKKGRQinv::operator=(const AliFemtoModelCorrFctn3DKKGRQinv& aCorrFctn)
{
  // Assignment operator
  if (this == &aCorrFctn) {
    return *this;
...
//_______________________
void AliFemtoModelCorrFctn3DKKGRQinv::ConnectToManager(AliFemtoModelManager *aManager)
{
  fManager = aManager;
}

//_______________________
AliFemtoString AliFemtoModelCorrFctn3DKKGRQinv::Report()
{
  // Prepare report
  AliFemtoString tStr = "AliFemtoModelCorrFctn3DKKGRQinv report";

  return tStr;
}

//_______________________
void AliFemtoModelCorrFctn3DKKGRQinv::AddRealPair(AliFemtoPair* aPair)
{
  ...
  if(!fKaonPDG) {
    ...
    Double_t weight = aPair->QInv();//fManager->GetWeight(aPair);
...
//_______________________
void AliFemtoModelCorrFctn3DKKGRQinv::AddMixedPair(AliFemtoPair* aPair)
{
  if (fPairCut && !fPairCut->Pass(aPair)) {
    return;
  }
  ...
  const Double_t weight=qinv_ideal;
...
void AliFemtoModelCorrFctn3DKKGRQinv::SetSpecificPairCut(AliFemtoPairCut* aCut)
{
  fPairCut = aCut;
}

//_______________________
Double_t AliFemtoModelCorrFctn3DKKGRQinv::GetQinvTrue(AliFemtoPair* aPair)
{
  if(!fKaonPDG) {
...
Double_t AliFemtoModelCorrFctn3DKKGRQinv::GetQoutTrue(AliFemtoPair* aPair)
{
  const AliFemtoParticle *first = aPair->Track1(),
                         *second = aPair->Track2();
...
Double_t AliFemtoModelCorrFctn3DKKGRQinv::GetQsideTrue(AliFemtoPair* aPair)
{
  const AliFemtoParticle *first = aPair->Track1(),
                         *second = aPair->Track2();
...
Double_t AliFemtoModelCorrFctn3DKKGRQinv::GetQlongTrue(AliFemtoPair* aPair)
{
...
//_______________________
void AliFemtoModelCorrFctn3DKKGRQinv::EventBegin(const AliFemtoEvent* /* aEvent */)
{
  /* Do nothing */
}
//_______________________
void AliFemtoModelCorrFctn3DKKGRQinv::EventEnd(const AliFemtoEvent* /* aEvent */)
{
  /* Do nothing */
}
//_______________________
void AliFemtoModelCorrFctn3DKKGRQinv::Finish()
{
  /* Do nothing */
}
//_______________________
void AliFemtoModelCorrFctn3DKKGRQinv::Write()
{
...
TList* AliFemtoModelCorrFctn3DKKGRQinv::GetOutputList()
{
...
void AliFemtoModelCorrFctn3DKKGRQinv::SetKaonPDG(Bool_t aSetKaonAna)
{
  fKaonPDG = aSetKaonAna;
}

double AliFemtoModelCorrFctn3DKKGRQinv::GetParentsKt(AliFemtoPair *pair)
{
...
int AliFemtoModelCorrFctn3DKKGRQinv::GetPairNumber(AliFemtoPair *pair)
{
