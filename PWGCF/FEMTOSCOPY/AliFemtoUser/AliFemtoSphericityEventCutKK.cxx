...
#include "AliFemtoSphericityEventCutKK.h"
//#include <cstdio>

#ifdef __ROOT__
  /// \cond CLASSIMP
  ClassImp(AliFemtoSphericityEventCutKK);
  /// \endcond
#endif

AliFemtoSphericityEventCutKK::AliFemtoSphericityEventCutKK() :
  AliFemtoEventCut(),
  fEventMult(),
  fVertZPos(),
...
//------------------------------
bool AliFemtoSphericityEventCutKK::Pass(const AliFemtoEvent* event){
...
//   cout << "AliFemtoSphericityEventCutKK:: epvzero:       " << fPsiEP[0] << " < " << epvzero << " < " << fPsiEP[1] << endl;
//   cout << "AliFemtoSphericityEventCutKK:: mult:       " << fEventMult[0] << " < " << mult << " < " << fEventMult[1] << endl;
 //  cout << "AliFemtoSphericityEventCutKK:: VertexZPos: " << fVertZPos[0] << " < " << vertexZPos << " < " << fVertZPos[1] << endl;
//   cout << "AliFemtoSphericityEventCutKK:: VertexZErr: " << event->PrimVertCov()[4] << endl;

  // cout << "AliFemtoSphericityEventCutKK:: MagneticField: " << event->MagneticField() << endl;
  // cout << "AliFemtoSphericityEventCutKK:: IsCollisionCandidate: " << event->IsCollisionCandidate() << endl;
  // cout << "AliFemtoSphericityEventCutKK:: TriggerCluster: " << event->TriggerCluster() << endl;
  // cout << "AliFemtoSphericityEventCutKK:: fSelectTrigger: " << fSelectTrigger << endl;
  // cout << "AliFemtoSphericityEventCutKK:: " << endl;
...
*/
 //  cout << "AliFemtoSphericityEventCutKK:: goodEvent" <<goodEvent << endl;

  goodEvent ? fNEventsPassed++ : fNEventsFailed++ ;
//    cout << "AliFemtoSphericityEventCutKK:: return : " << goodEvent << endl;
//     (fAcceptBadVertex || (event->PrimVertCov()[4] > -1000.0)) &&

  return (goodEvent);
}
//------------------------------
AliFemtoString AliFemtoSphericityEventCutKK::Report(){
  // Prepare report
  string stemp;
  char ctemp[100];
...
void AliFemtoSphericityEventCutKK::SetAcceptBadVertex(bool b)
{
  fAcceptBadVertex = b;
}
bool AliFemtoSphericityEventCutKK::GetAcceptBadVertex()
{
