...
//FB128 -> 9 multiplicity in PbPb in DR task 
...
AliAnalysisEffTaskDoubleCountPID::AliAnalysisEffTaskDoubleCountPID() :
  AliAnalysisTaskSE(), centrality(0), fHistoList(0), fDCAtoPrimVtx(0), fIfAliEventCuts(kFALSE), fFB(128), fPidMethod(kNSigmaNoDoubleCounting), fpidResponse(0), fAODpidUtil(0), fEventCuts(0)
...
AliAnalysisEffTaskDoubleCountPID::AliAnalysisEffTaskDoubleCountPID(TString name, int pidMethod, int filterbit) :
  AliAnalysisTaskSE(name), centrality(0), fHistoList(0), fDCAtoPrimVtx(0), fIfAliEventCuts(kFALSE), fFB(128), fPidMethod(kNSigmaNoDoubleCounting), fpidResponse(0), fAODpidUtil(0), fEventCuts(0)
