...
#ifndef ALIFEMTOMODELCORRFCTNQVALPTSUM_H
#define ALIFEMTOMODELCORRFCTNQVALPTSUM_H
...
/// \class AliFemtoModelCorrFctnQinvPtSum
...
///
///
class AliFemtoModelCorrFctnQinvPtSum : public AliFemtoModelCorrFctn {
public:
  ...
  ///
  AliFemtoModelCorrFctnQinvPtSum(const AliFemtoModelCorrFctnQinvPtSum &);

  /// assignment operator
  AliFemtoModelCorrFctnQinvPtSum& operator=(const AliFemtoModelCorrFctnQinvPtSum &);
  ...
  /// Destructor
  virtual ~AliFemtoModelCorrFctnQinvPtSum();
...
inline void
AliFemtoModelCorrFctnQinvPtSum::SetPairType(const AliFemtoAvgSepCorrFctn::PairType pairtype)
{
  fPairType = pairtype;
}

inline void
AliFemtoModelCorrFctnQinvPtSum::SetExpectedPDGCodes(const Int_t track1_pdg_code,
                                               const Int_t track2_pdg_code)
{
...
inline void
AliFemtoModelCorrFctnQinvPtSum::GetTrackV0(const AliFemtoPair* pair,
...
inline double
AliFemtoModelCorrFctnQinvPtSum::CalcTrueQinv(const AliFemtoPair *pair)
{
...
inline double AliFemtoModelCorrFctnQinvPtSum::CalcQinv(
