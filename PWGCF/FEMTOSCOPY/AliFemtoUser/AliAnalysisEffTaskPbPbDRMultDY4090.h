#ifndef AliAnalysisEffTaskPbPbDRMultDY4090_H
#define AliAnalysisEffTaskPbPbDRMultDY4090_H
...
class AliAnalysisEffTaskPbPbDRMultDY4090 :public AliAnalysisTaskSE{
public:
...
AliAnalysisEffTaskPbPbDRMultDY4090();
  AliAnalysisEffTaskPbPbDRMultDY4090(TString name, int pidMethod=3, int filterbit=128); // default constructor
  virtual ~AliAnalysisEffTaskPbPbDRMultDY4090(); // default destructor
 ...
 private:
  AliAnalysisEffTaskPbPbDRMultDY4090(const AliAnalysisEffTaskPbPbDRMultDY4090 &); // copy constructor
  AliAnalysisEffTaskPbPbDRMultDY4090 &operator=(const AliAnalysisEffTaskPbPbDRMultDY4090 &); // operator=
  ...
  ClassDef(AliAnalysisEffTaskPbPbDRMultDY4090, 0);
