/******************************************************************************/
/*                                                                            */
/*  AliFemtoModelCorrFctnKpKp -   numerator and denominator                   */
...
#ifdef __ROOT__
   ClassImp(AliFemtoModelCorrFctnKpKp, 1);
#endif
...
AliFemtoModelCorrFctnKpKp::AliFemtoModelCorrFctnKpKp():
...
//_______________________
AliFemtoModelCorrFctnKpKp::AliFemtoModelCorrFctnKpKp(const char *title, Int_t aNbins, Double_t aQinvLo, Double_t aQinvHi):
  AliFemtoModelCorrFctn(),
  fManager(0),
  fNumeratorTrue(0),
  fNumeratorFake(0),
...
//_______________________
AliFemtoModelCorrFctnKpKp::AliFemtoModelCorrFctnKpKp(const AliFemtoModelCorrFctnKpKp& aCorrFctn) :
...
//_______________________
AliFemtoModelCorrFctnKpKp& AliFemtoModelCorrFctnKpKp::operator=(const AliFemtoModelCorrFctnKpKp& aCorrFctn)
{
  // Assignment operator
  if (this == &aCorrFctn)
    return *this;
...
//_______________________
void AliFemtoModelCorrFctnKpKp::ConnectToManager(AliFemtoModelManager *aManager)
{
  fManager = aManager;
}

//_______________________
AliFemtoString AliFemtoModelCorrFctnKpKp::Report()
{
  // Prepare report
  AliFemtoString tStr = "AliFemtoModelCorrFctnKpKp report";

  return tStr;
}

//_______________________
void AliFemtoModelCorrFctnKpKp::AddRealPair(AliFemtoPair* aPair)
{
...
//_______________________
void AliFemtoModelCorrFctnKpKp::AddMixedPair(AliFemtoPair* aPair)
{
  if (fPairCut && !fPairCut->Pass(aPair)) {
    return;
  }
...
//_______________________
Double_t AliFemtoModelCorrFctnKpKp::GetQinvTrue(AliFemtoPair* aPair)
{
  if(!fKaonPDG) {
...
//_______________________
void AliFemtoModelCorrFctnKpKp::EventBegin(const AliFemtoEvent* /* aEvent */)
{
  /* Do nothing */
}
//_______________________
void AliFemtoModelCorrFctnKpKp::EventEnd(const AliFemtoEvent* /* aEvent */)
{
  /* Do nothing */
}
//_______________________
void AliFemtoModelCorrFctnKpKp::Finish()
{
  /* Do nothing */
}
//_______________________
void AliFemtoModelCorrFctnKpKp::Write()
{
...
//_______________________
AliFemtoModelCorrFctn* AliFemtoModelCorrFctnKpKp::Clone() const
{
  // Create clone
  AliFemtoModelCorrFctnKpKp *tCopy = new AliFemtoModelCorrFctnKpKp(*this);

  return tCopy;
}
//_________________________
TList* AliFemtoModelCorrFctnKpKp::GetOutputList()
{
...
void AliFemtoModelCorrFctnKpKp::SetKaonPDG(Bool_t aSetKaonAna)
{
  fKaonPDG = aSetKaonAna;
}

/*
double AliFemtoModelCorrFctnKpKp::GetParentsKt(AliFemtoPair *pair)
{
...
int AliFemtoModelCorrFctnKpKp::GetPairNumber(AliFemtoPair *pair)
{
    AliFemtoParticle *first = new AliFemtoParticle(*(pair->Track1()));
    AliFemtoParticle *second = new AliFemtoParticle(*(pair->Track2()));
