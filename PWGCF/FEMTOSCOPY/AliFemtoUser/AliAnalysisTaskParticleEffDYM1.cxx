...
#include "AliAnalysisTaskParticleEffDYM1.h"
...
void AliAnalysisTaskParticleEffDYM1::SetPidMethod(PidMethod method)
{
  fPidMethod = method;
}

int AliAnalysisTaskParticleEffDYM1::GetPidMethod()
{
  return (int)fPidMethod;
}

void AliAnalysisTaskParticleEffDYM1::SetPidMethod(int method)
{
  switch(method){
...
AliAnalysisTaskParticleEffDYM1::AliAnalysisTaskParticleEffDYM1(TString name, int pidMethod, int filterbit) :
...
AliAnalysisTaskParticleEffDYM1::~AliAnalysisTaskParticleEffDYM1()
{
...
void AliAnalysisTaskParticleEffDYM1::UserCreateOutputObjects()
{
...
void AliAnalysisTaskParticleEffDYM1::UserExec(Option_t *)
{
