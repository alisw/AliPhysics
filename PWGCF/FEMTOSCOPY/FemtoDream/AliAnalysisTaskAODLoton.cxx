...
ClassImp(AliAnalysisTaskAODLoton)
AliAnalysisTaskAODLoton::AliAnalysisTaskAODLoton()
    : AliAnalysisTaskSE(),
...
AliAnalysisTaskAODLoton::AliAnalysisTaskAODLoton(const char* name, bool isMC)
...
void AliAnalysisTaskAODLoton::UserCreateOutputObjects() {
...
void AliAnalysisTaskAODLoton::UserExec(Option_t *option) {
...
void AliAnalysisTaskAODLoton::ResetGlobalTrackReference() {
...
//____________________________________________________________________________________________________
void AliAnalysisTaskAODLoton::StoreGlobalTrackReference(AliAODTrack *track) {
  // see AliFemtoDreamAnalysis for details
