...
class AliFemtoDreamCascadeHist {
 public:
  ...
  void FillInvMass(int iBin,float mass){if(!fMinimalBooking)fInvMass[iBin]->Fill(mass);};
  void FillInvMassPt(float Pt,float mass){fInvMassPt->Fill(Pt,mass);};
  ...
  void FillMomRapOmega(int iBin,float rap,float pT){if(!fMinimalBooking)fP_Y_Omega[iBin]->Fill(rap,pT);};
  void FillDCAXiPrimVtx(int iBin,float DCA){if(!fMinimalBooking)fDCAXi[iBin]->Fill(DCA);};
  ...
  void FillDecayLength(int iBin,float len){if(!fMinimalBooking)fDecayLength[iBin]->Fill(len);};
  void Fillv0DecayLength(int iBin,float len){if(!fMinimalBooking)fv0DecayLength[iBin]->Fill(len);};
  ...
  void FillCPAv0Xi(int iBin,float cpa){if(!fMinimalBooking)fCPAv0Xi[iBin]->Fill(cpa);};
