...
void AliAnalysisTaskNanoLambdaKaon::UserExec(Option_t *) {
  ...
  fPairCleaner->CleanTrackAndDecay(&KaonPlus, &Lambdas, 0);
  fPairCleaner->CleanTrackAndDecay(&KaonMinus, &AntiLambdas, 1);
  fPairCleaner->CleanTrackAndDecay(&KaonPlus, &AntiLambdas, 2);
  fPairCleaner->CleanTrackAndDecay(&KaonMinus, &Lambdas, 3);
