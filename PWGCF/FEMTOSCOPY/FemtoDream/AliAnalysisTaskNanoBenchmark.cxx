...
ClassImp(AliAnalysisTaskNanoBenchmark)
AliAnalysisTaskNanoBenchmark::AliAnalysisTaskNanoBenchmark()
    : AliAnalysisTaskSE(),
...
AliAnalysisTaskNanoBenchmark::AliAnalysisTaskNanoBenchmark(const char* name, bool isMC)
...
void AliAnalysisTaskNanoBenchmark::UserCreateOutputObjects() {
...
void AliAnalysisTaskNanoBenchmark::UserExec(Option_t *option) {
...
void AliAnalysisTaskNanoBenchmark::ResetGlobalTrackReference() {
...
//____________________________________________________________________________________________________
void AliAnalysisTaskNanoBenchmark::StoreGlobalTrackReference(AliVTrack *track) {
  // see AliFemtoDreamAnalysis for details
