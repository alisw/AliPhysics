/*
 * AliAnalysisTaskThreeBodyFemtoPionProton.h
 *
 *  Created on: May 13, 2019
 *      Author: Laura Serksnyte 
 */

#ifndef PWGCF_FEMTOSCOPY_FEMTODREAM_ALIANALYSISTASKTHREEBODYFEMTOPIONPROTON_H_
#define PWGCF_FEMTOSCOPY_FEMTODREAM_ALIANALYSISTASKTHREEBODYFEMTOPIONPROTON_H_
...
class AliAnalysisTaskThreeBodyFemtoPionProton : public AliAnalysisTaskSE {
 public:
  AliAnalysisTaskThreeBodyFemtoPionProton();
  AliAnalysisTaskThreeBodyFemtoPionProton(const char* name, bool isMC, bool triggerOn);
  virtual ~AliAnalysisTaskThreeBodyFemtoPionProton();
 ...
 private:
  AliAnalysisTaskThreeBodyFemtoPionProton(const AliAnalysisTaskThreeBodyFemtoPionProton &task);
  AliAnalysisTaskThreeBodyFemtoPionProton &operator=(const AliAnalysisTaskThreeBodyFemtoPionProton &task);
  bool fisLightWeight;//
  ...
  AliVTrack **fGTI;  //!
  ClassDef(AliAnalysisTaskThreeBodyFemtoPionProton,1)
};

#endif /* PWGCF_FEMTOSCOPY_FEMTODREAM_AliAnalysisTaskThreeBodyFemtoPionProton_H_ */
