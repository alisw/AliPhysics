...
class AliAnalysisTaskThreeBodyProtonPrimary : public AliAnalysisTaskSE {
 ...
 private:
  ...
  AliVTrack **fGTI;  //!
  ClassDef(AliAnalysisTaskThreeBodyProtonPrimary,7)
};
