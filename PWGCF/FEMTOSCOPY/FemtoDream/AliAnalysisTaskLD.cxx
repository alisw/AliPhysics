...
ClassImp(AliAnalysisTaskLD)
AliAnalysisTaskLD::AliAnalysisTaskLD()
    : AliAnalysisTaskSE(),
...
AliAnalysisTaskLD::AliAnalysisTaskLD(const char* name)
...
void AliAnalysisTaskLD::UserCreateOutputObjects() {
...
//_____________________________________________________________________________
void AliAnalysisTaskLD::UserExec(Option_t *option) {
...
//_____________________________________________________________________________
Float_t AliAnalysisTaskLD::CalculateMassSqTOF(AliFemtoDreamTrack *track) {
...
//_____________________________________________________________________________
void AliAnalysisTaskLD::ResetGlobalTrackReference() {
...
//_____________________________________________________________________________
void AliAnalysisTaskLD::StoreGlobalTrackReference(AliAODTrack *track) {
  // see AliFemtoDreamAnalysis for details
