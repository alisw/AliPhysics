...
#ifndef PWGCF_FEMTOSCOPY_FEMTODREAM_ALIANALYSISTASKAODLOTON_H_
#define PWGCF_FEMTOSCOPY_FEMTODREAM_ALIANALYSISTASKAODLOTON_H_
...
class AliAnalysisTaskAODLoton : public AliAnalysisTaskSE {
 public:
  AliAnalysisTaskAODLoton();
  AliAnalysisTaskAODLoton(const char* name, bool isMC);
  virtual ~AliAnalysisTaskAODLoton();
 ...
 private:
  AliAnalysisTaskAODLoton(const AliAnalysisTaskAODLoton &task);
  AliAnalysisTaskAODLoton &operator=(const AliAnalysisTaskAODLoton &task);
  bool fisLightWeight;//
  ...
  AliAODTrack **fGTI;  //!
  ClassDef(AliAnalysisTaskAODLoton,1)
};
