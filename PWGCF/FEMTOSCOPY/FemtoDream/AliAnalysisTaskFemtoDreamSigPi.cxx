...
#include "AliAnalysisTaskFemtoDreamSigPi.h"
#include "AliFemtoDreamBasePart.h"
#include "AliLog.h"
#include "AliVEvent.h"
ClassImp(AliAnalysisTaskFemtoDreamSigPi)
AliAnalysisTaskFemtoDreamSigPi::AliAnalysisTaskFemtoDreamSigPi()
:AliAnalysisTaskSE()
,fIsMC(false)
,fOutput()
,fEvent()
...
AliAnalysisTaskFemtoDreamSigPi::AliAnalysisTaskFemtoDreamSigPi(const char *name, bool isMC)
...
void AliAnalysisTaskFemtoDreamSigPi::UserCreateOutputObjects() {
  fOutput = new TList();
...
void AliAnalysisTaskFemtoDreamSigPi::UserExec(Option_t *) {
...
void AliAnalysisTaskFemtoDreamSigPi::ResetGlobalTrackReference(){
...
void AliAnalysisTaskFemtoDreamSigPi::StoreGlobalTrackReference(AliAODTrack *track){
    // for documentation see AliFemtoDreamAnalysis
