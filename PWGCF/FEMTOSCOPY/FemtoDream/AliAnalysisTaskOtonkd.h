/*
 * AliAnalysisTaskOtonkd.h
 *
 *  reCreated on: 20 Oct 2021
 *      Authors: bernhardhohlweger, Bhawani, Oton
 */

#ifndef PWGCF_FEMTOSCOPY_FEMTODREAM_ALIANALYSISTASKOTONKD_H_
#define PWGCF_FEMTOSCOPY_FEMTODREAM_ALIANALYSISTASKOTONKD_H_
#include "Rtypes.h"
...
class AliAnalysisTaskOtonkd : public AliAnalysisTaskSE {
 public:
  ...
  AliAnalysisTaskOtonkd(const char *name, bool isMC, bool isMCtruth, bool isIncludeSomeProtons, bool doFDpairing);
...
//  void SetTrackCutsAntiDeuteronMass(AliFemtoDreamTrackCuts *trkCuts) {fTrackCutsAntiDeuteronMass = trkCuts;};
  ...
  private:
  AliAnalysisTaskOtonkd(const AliAnalysisTaskOtonkd &task);
  AliAnalysisTaskOtonkd &operator=(const AliAnalysisTaskOtonkd &task);
