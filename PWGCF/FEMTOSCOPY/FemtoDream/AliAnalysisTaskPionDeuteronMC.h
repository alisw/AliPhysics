...
private:
    ...
    std::vector<CustomQueue<std::vector<TLorentzVector>, 10>> fMixingBufferPosPions;      ///< Mixing buffer for positive pions
    std::vector<CustomQueue<std::vector<TLorentzVector>, 10>> fMixingBufferNegPions;      ///< Mixing buffer for negative pions
    std::vector<CustomQueue<std::vector<TLorentzVector>, 10>> fMixingBufferDeuterons;     ///< Mixing buffer for deuterons
    std::vector<CustomQueue<std::vector<TLorentzVector>, 10>> fMixingBufferAntideuterons; ///< Mixing buffer for antideuterons
    ...
    void FillMixedEvent(CustomQueue<std::vector<TLorentzVector>, 10> &bufferA, CustomQueue<std::vector<TLorentzVector>, 10> &bufferB, TH1F* histo);   ///< fill mixed event distribution
