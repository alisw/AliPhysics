...
ClassImp(AliAnalysisTaskThreeBodyFemtoAODPionProton)
AliAnalysisTaskThreeBodyFemtoAODPionProton::AliAnalysisTaskThreeBodyFemtoAODPionProton()
    : AliAnalysisTaskSE(),
...
AliAnalysisTaskThreeBodyFemtoAODPionProton::AliAnalysisTaskThreeBodyFemtoAODPionProton(const char* name, bool isMC, bool triggerOn)
...
void AliAnalysisTaskThreeBodyFemtoAODPionProton::UserCreateOutputObjects() {
  ...
  fEvent = new AliFemtoDreamEvent(true, !fisLightWeight,
                                  GetCollisionCandidates(), true, DummyFloat);
...
void AliAnalysisTaskThreeBodyFemtoAODPionProton::UserExec(Option_t *option) {
...
void AliAnalysisTaskThreeBodyFemtoAODPionProton::ResetGlobalTrackReference() {
...
//____________________________________________________________________________________________________
void AliAnalysisTaskThreeBodyFemtoAODPionProton::StoreGlobalTrackReference(AliAODTrack *track) {
  // see AliFemtoDreamAnalysis for details
...
TLorentzVector AliAnalysisTaskThreeBodyFemtoAODPionProton::RelativePairMomentum(
...
void AliAnalysisTaskThreeBodyFemtoAODPionProton::FillTripletDistributionMEPP(std::vector<std::vector<AliFemtoDreamBasePart>> &ParticleVector, std::vector<AliFemtoDreamPartContainer>  &fPartContainer, int speciesSE, int speciesME1, int speciesME2, TH1F* hist, std::vector<int> PDGCodes, int mult, TH2F* hist2d, TH2F **fEventTripletPhiThetaArray, int phiEtaHistNo, AliFemtoDreamCollConfig Config){
  // Description of function given in AliAnalysisTaskThreeBodyFemtoAODPionProton::FillTripletDistribution
...
void AliAnalysisTaskThreeBodyFemtoAODPionProton::FillTripletDistributionSE2ME1(std::vector<std::vector<AliFemtoDreamBasePart>> &ParticleVector, std::vector<AliFemtoDreamPartContainer> &fPartContainer, int speciesSE1, int speciesSE2, int speciesME, TH1F* hist, std::vector<int> PDGCodes, int mult, TH2F* hist2d, TH2F **fEventTripletPhiThetaArray, int phiEtaHistNo, AliFemtoDreamCollConfig Config){
  // Description of function given in AliAnalysisTaskThreeBodyFemtoAODPionProton::FillTripletDistribution
...
bool AliAnalysisTaskThreeBodyFemtoAODPionProton::DeltaEtaDeltaPhi(
...
double AliAnalysisTaskThreeBodyFemtoAODPionProton::CalculatePPLTriggerQ3Min(std::vector<std::vector<AliFemtoDreamBasePart>> &ParticleVector, int firstSpecies,int secondSpecies,int thirdSpecies, std::vector<int> PDGCodes, AliFemtoDreamCollConfig Config, TH2F** fEventTripletPhiThetaArray, int phiEtaHistNo){
  // This function creates a triplet distribution in Q3 bins (defined lower).
  // It requires the particle vector from PairCleaner() and the three indices of particles of interest. So
  // if you want to get distribution for particles that are saved in particle vector as 1 2 3 element, just 
  // call the function with firstSpecies=1,secondSpecies=2,thirdSpecies=3
