...
#include "AliAnalysisTaskNanoSigmaPlus.h"
#include "AliNanoAODTrack.h"

ClassImp(AliAnalysisTaskNanoSigmaPlus)
AliAnalysisTaskNanoSigmaPlus::AliAnalysisTaskNanoSigmaPlus()
    : AliAnalysisTaskSE(),
...
AliAnalysisTaskNanoSigmaPlus::AliAnalysisTaskNanoSigmaPlus(const char* name)
  ...
  DefineOutput(2, TList::Class());  //Output for the Proton Cuts - AddTask: TracksCuts
  DefineOutput(3, TList::Class());  //Output for the AntiProton Cuts - AddTask: AntiTrackCuts
...
void AliAnalysisTaskNanoSigmaPlus::UserCreateOutputObjects() {
  ...
  PostData(1, fEvtList);
  PostData(2, fProtonList); // AddTask: TrackCuts
  PostData(3, fAntiProtonList); // AddTask: AntiTrackCuts
  PostData(4, fResults);
  PostData(5, fResultsQA);
}

void AliAnalysisTaskNanoSigmaPlus::UserExec(Option_t *option) {
...
void AliAnalysisTaskNanoSigmaPlus::ResetGlobalTrackReference() {
...
//____________________________________________________________________________________________________
void AliAnalysisTaskNanoSigmaPlus::StoreGlobalTrackReference(AliVTrack *track) {
  // see AliFemtoDreamAnalysis for details
