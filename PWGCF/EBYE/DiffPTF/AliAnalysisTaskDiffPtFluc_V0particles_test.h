 ...
 **************************************************************************/
#ifndef AliAnalysisTaskDiffPtFluc_V0particles_test_H
#define AliAnalysisTaskDiffPtFluc_V0particles_test_H
...
class AliAnalysisTaskDiffPtFluc_V0particles_test : public AliAnalysisTaskSE {
 public:
  AliAnalysisTaskDiffPtFluc_V0particles_test();
  AliAnalysisTaskDiffPtFluc_V0particles_test(const char *name);
  virtual ~AliAnalysisTaskDiffPtFluc_V0particles_test();
 ...
 private:
  ...
  Int_t fNoOfV0;
  Float_t fV0_pt[kMaxTrack];
  Float_t fV0_eta[kMaxTrack];
  Float_t fV0_mass[kMaxTrack];
  ...
  AliAnalysisTaskDiffPtFluc_V0particles_test(const AliAnalysisTaskDiffPtFluc_V0particles_test&);
  AliAnalysisTaskDiffPtFluc_V0particles_test& operator=(const AliAnalysisTaskDiffPtFluc_V0particles_test&);  
  ClassDef(AliAnalysisTaskDiffPtFluc_V0particles_test, 1);
};
