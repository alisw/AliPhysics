 ...
 **************************************************************************/
#ifndef AliAnalysisTaskDiffPtFluc_PIDhadrons_v2_H
#define AliAnalysisTaskDiffPtFluc_PIDhadrons_v2_H
...
class AliAnalysisTaskDiffPtFluc_PIDhadrons_v2 : public AliAnalysisTaskSE {
 public:
  AliAnalysisTaskDiffPtFluc_PIDhadrons_v2();
  AliAnalysisTaskDiffPtFluc_PIDhadrons_v2(const char *name);
  virtual ~AliAnalysisTaskDiffPtFluc_PIDhadrons_v2();
  ...
  */
  ...
  AliAnalysisTaskDiffPtFluc_PIDhadrons_v2(const AliAnalysisTaskDiffPtFluc_PIDhadrons_v2&);
  AliAnalysisTaskDiffPtFluc_PIDhadrons_v2& operator=(const AliAnalysisTaskDiffPtFluc_PIDhadrons_v2&);  
  ClassDef(AliAnalysisTaskDiffPtFluc_PIDhadrons_v2, 1);
};
