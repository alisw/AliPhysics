...
#include "AliAnalysisTaskDiffPtFluc_MCnoESD_correction.h"
...
void AliAnalysisTaskDiffPtFluc_MCnoESD_correction::UserCreateOutputObjects()
{
  ...
  fTreeEvent->Branch("fNsum_less0",&fNsum_less0,"fNsum_less0/F");
  fTreeEvent->Branch("fNsum_less0_uncorrected",&fNsum_less0_uncorrected,"fNsum_less0_uncorrected/F");
...
//________________________________________________________________________
void AliAnalysisTaskDiffPtFluc_MCnoESD_correction::UserExec(Option_t *)
{
  ...
  if (N_sum_etaLess0_2>0 && N_sum_etaGreaterEtamin_2>0 && N_sum_etaGreaterEtamin>0 && N_sum_etaLess0>0 && N_sumPion_etaLess0>0 && N_sumKaon_etaLess0>0 && N_sumProton_etaLess0>0)
    {
      ...
      fNsum_less0=N_sum_etaLess0;
      fNsum_less0_uncorrected=N_sum_etaLess0_2;
...
//________________________________________________________________________
void AliAnalysisTaskDiffPtFluc_MCnoESD_correction::Terminate(Option_t *)
{
