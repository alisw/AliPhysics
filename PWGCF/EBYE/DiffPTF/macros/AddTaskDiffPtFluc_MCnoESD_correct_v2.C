...
AliAnalysisTaskDiffPtFluc_MCnoESD_correct_v2 *AddTaskDiffPtFluc_MCnoESD_correct_v2(Int_t fCentralityMin=0, Int_t fCentralityMax=90,/* TString sTrigger="kINT7"*/ Double_t fVzMax=10, Double_t fdcaxy=0.1, Double_t fdcaz=1, Double_t fchi2tpc=2.5, Double_t fchi2its=36, Double_t fnCrossedRows=70, TString OutFileName = "_default", Double_t fEta=0.8, Int_t fMCGenChoice=2)
{
  // standard with task
  printf("===================================================================================\n");
  ...
  AliAnalysisTaskDiffPtFluc_MCnoESD_correct_v2 *task_Mpt = new AliAnalysisTaskDiffPtFluc_MCnoESD_correct_v2(TaskMeanpt);
