AliAnalysisTaskDiffPtFluc_PiKaProtHad_pTmax5_v2 *AddTaskDiffPtFluc_PiKaProtHad_pTmax5_v2(Int_t fCentralityMin=0, Int_t fCentralityMax=90, Double_t fVzMax=10, Int_t fpileupcut = 1, Int_t fCentEstFlag = 0, Int_t fFilterBit=96, Double_t fchi2tpc=2.5, Double_t fchi2its=36, Double_t fpidnSigma=2.0, Double_t ftpccrossedrows = 70, TString OutFileName = "_default", TString sMCfilePath = "file:///media/swati/data/Ollitraut_V0/implentation_in_process/latest_data/EfficiencyHijingPbPb.root", Double_t fetaleftcut = 0.0, Double_t fetacut=0.4, Int_t feffflag=0, Int_t feffCorrFlag=0, Int_t fElRejectFlag=0, Int_t fPIDExclusiveFlag=0, Int_t fFillHistTrkQAFlag=1, Int_t fFillHistTrkPIDQAFlag=1, Int_t lBayesianPIDFlag=1, Double_t lPIDbayesPion=0.9, Double_t lPIDbayesKaon=0.9, Double_t lPIDbayesProton=0.9)
{
  // standard with task
  printf("===================================================================================\n");
  ...
  //gInterpreter->ProcessLine(".x AliAnalysisTaskDiffPtFluc_PiKaProtHad_pTmax5_v2.cxx++g");
  AliAnalysisTaskDiffPtFluc_PiKaProtHad_pTmax5_v2 *task_Mpt = new AliAnalysisTaskDiffPtFluc_PiKaProtHad_pTmax5_v2(TaskMeanpt);
