AliAnalysisTaskDiffPtFluc_PIDhadrons_v2 *AddTaskDiffPtFluc_PIDhadrons_v2(Int_t fCentralityMin=0, Int_t fCentralityMax=90, Double_t fVzMax=10, Int_t fpileupcut = 1, Int_t fCentEstFlag = 0, Int_t fFilterBit=96, Double_t fchi2tpc=4, Double_t fchi2its=36, Double_t fpidnSigma=2.0, Double_t ftpccrossedrows = 70, TString OutFileName = "_default", TString sMCfilePath ="alien:///alice/cern.ch/user/s/swati/EfficiencyPbPbLHC20j6a/CentralitywiseEff/EfficiencyHijingPbPb.root", Double_t fetacut=0.4, Int_t feffflag=0)
{
  // standard with task
  printf("===================================================================================\n");
  ...
  //gInterpreter->ProcessLine(".x AliAnalysisTaskDiffPtFluc_PIDhadrons_v2.cxx++g");
  AliAnalysisTaskDiffPtFluc_PIDhadrons_v2 *task_Mpt = new AliAnalysisTaskDiffPtFluc_PIDhadrons_v2(TaskMeanpt);
