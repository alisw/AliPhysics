...
AliAnalysisTaskNetLambdaMCTrad *AddTaskNetLambdaMCTrad( Bool_t lSaveEventTree = kTRUE, Bool_t lSaveV0 = kTRUE, TString lExtraOptions = "", const TString lMasterJobSessionFlag = "")
{
    ...
    //===========================================================================
    AliAnalysisTaskNetLambdaMCTrad* taskAuxiliary = new  AliAnalysisTaskNetLambdaMCTrad(lSaveEventTree, lSaveV0,  "taskAuxiliary", lExtraOptions);
    mgr->AddTask(taskAuxiliary);
    TString outputFileName = AliAnalysisManager::GetCommonFileName();
    
    outputFileName += ":NetLambda";
