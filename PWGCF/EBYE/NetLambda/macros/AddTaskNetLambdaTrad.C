AliAnalysisTaskNetLambdaTrad *AddTaskNetLambdaTrad(const char* outputFileName = 0, const char* containerName = "NetLambdaOutput")
{
    ...
    outputFileName = "NetLambdaMC.root";
    ...
    AliAnalysisDataContainer *coutput2 = mgr->CreateContainer("Treevariables", TTree::Class(),AliAnalysisManager::kOutputContainer,Form("%s", outputFileName));
