#ifndef ALIANALYSISTASKSIGNEDBFMC_H
#define ALIANALYSISTASKSIGNEDBFMC_H
...
class AliAnalysisTaskSignedBFMC : public AliAnalysisTaskSE {
 public:  
  AliAnalysisTaskSignedBFMC(const char *name = "AliAnalysisTaskptspectra");
  virtual ~AliAnalysisTaskSignedBFMC(); 
 ...
 private:
  ...
  AliAnalysisTaskSignedBFMC(const AliAnalysisTaskSignedBFMC&); // not implemented
  AliAnalysisTaskSignedBFMC& operator=(const AliAnalysisTaskSignedBFMC&); // not implemented
  
  ClassDef(AliAnalysisTaskSignedBFMC, 1); // example of analysis
};
