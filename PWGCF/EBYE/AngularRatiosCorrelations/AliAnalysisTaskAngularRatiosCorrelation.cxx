...
#include "AliAnalysisTaskAngularRatiosCorrelation.h"
#include "AliAODMCParticle.h"
#include "AliMultSelection.h"
class AliMultSelection;
class AliAnalysisTaskAngularRatiosCorrelation;

using namespace std;

ClassImp(AliAnalysisTaskAngularRatiosCorrelation)

    AliAnalysisTaskAngularRatiosCorrelation::AliAnalysisTaskAngularRatiosCorrelation()
    : AliAnalysisTaskSE(),
      fAOD(0),
      fOutputList(0),
      NEvents(0),
...
AliAnalysisTaskAngularRatiosCorrelation::AliAnalysisTaskAngularRatiosCorrelation(const char *name)
...
//_____________________________________________________________________________
void AliAnalysisTaskAngularRatiosCorrelation::UserExec(Option_t *)
{
...
//_____________________________________________________________________________
void AliAnalysisTaskAngularRatiosCorrelation::Terminate(Option_t *)
{
    // terminate
