...
#include "AliEventCuts.h"
#include "AliAnalysisTaskCorrPbPb_treemerge_v2.h"
...
class AliAnalysisTaskCorrPbPb_treemerge_v2;
ClassImp(AliAnalysisTaskCorrPbPb_treemerge_v2)

//_____________________________________________________________________________________________________________________________________
AliAnalysisTaskCorrPbPb_treemerge_v2::AliAnalysisTaskCorrPbPb_treemerge_v2():
  AliAnalysisTaskSE(),
  fAODeventCuts(),
  fESDevent(0),
  fAODevent(0),
...
//_____________________________________________________________________________________________________________________________________
AliAnalysisTaskCorrPbPb_treemerge_v2::AliAnalysisTaskCorrPbPb_treemerge_v2(const char *name):
...
//_____________________________________________________________________________________________________________________________________
void AliAnalysisTaskCorrPbPb_treemerge_v2::UserCreateOutputObjects()  {
...
//_____________________________________________________________________________________________________________________________________
void AliAnalysisTaskCorrPbPb_treemerge_v2::UserExec(Option_t *)  {
	...
	if (trkCharge > 0 && IsKaon)   //K+
	  {
		...
		if(trkPt > fPtMinSet1 && trkPt < fPtMaxSet1)
		  {
		...
		if(trkPt > fPtMinSet2 && trkPt < fPtMaxSet2)
		  {
    ...
    //++++++++++++++++++++++++++++++++++++++++++++
    // variable with "_ptmax2" is obtained with fPtMinSet2 < pT < fPtMaxSet2
    // variable with "_ptmax3" is obtained with fPtMinSet1 < pT < fPtMaxSet1
    //++++++++++++++++++++++++++++++++++++++++++++
...
//_____________________________________________________________________________________________________________________________________
Bool_t AliAnalysisTaskCorrPbPb_treemerge_v2::GetEvent ()  //event cuts copied from my code written earlier 
...
//_____________________________________________________________________________________________________________________________________
Bool_t AliAnalysisTaskCorrPbPb_treemerge_v2::PassedTrackQualityCuts (AliAODTrack *track)  {
...
//_____________________________________________________________________________________________________________________________________
Bool_t AliAnalysisTaskCorrPbPb_treemerge_v2::KaonSelector(AliVTrack *track, Double_t nSigmaCut)  {
...
//_____________________________________________________________________________________________________________________________________
Bool_t AliAnalysisTaskCorrPbPb_treemerge_v2::PionSelector(AliVTrack *track, Double_t nSigmaCut)  {
...
//_____________________________________________________________________________________________________________________________________
Bool_t AliAnalysisTaskCorrPbPb_treemerge_v2::ProtonSelector(AliVTrack *track, Double_t nSigmaCut)  {
...
//_____________________________________________________________________________________________________________________________________
Bool_t AliAnalysisTaskCorrPbPb_treemerge_v2::PassedPIDSelection (AliAODTrack *track, AliPID::EParticleType type)  {
 ...
 //_____________________________________________________________________________________________________________________________________
Bool_t AliAnalysisTaskCorrPbPb_treemerge_v2::PassedSingleParticlePileUpCuts(AliAODTrack *track)
{
...
//_____________________________________________________________________________________________________________________________________
void AliAnalysisTaskCorrPbPb_treemerge_v2::GetMCEffCorrectionHist()
{
  if(fListTRKCorr)
    {
 ...
 //_____________________________________________________________________________________________________________________________________
void AliAnalysisTaskCorrPbPb_treemerge_v2::Terminate(Option_t *)  {
