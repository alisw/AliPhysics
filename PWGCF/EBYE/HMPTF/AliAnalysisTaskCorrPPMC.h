 ...
 **************************************************************************/
#ifndef AliAnalysisTaskCorrPPMC_H
#define AliAnalysisTaskCorrPPMC_H
...
class AliAnalysisTaskCorrPPMC : public AliAnalysisTaskSE {
 public:
  AliAnalysisTaskCorrPPMC();
  AliAnalysisTaskCorrPPMC(const char *name);
  virtual ~AliAnalysisTaskCorrPPMC();
 ...
 private:
  ...
  Float_t fNoGenXi_ptmax2;
  Float_t fNoGenAntiXi_ptmax2;
  Float_t fNoGenXi_ptmax3;
  Float_t fNoGenAntiXi_ptmax3;
  ...
  TH1F *hist_GenXiPlus;
  TH1F *hist_GenXiMinus;
  TH1F *hist_RecXiPlus;
  TH1F *hist_RecXiMinus;
  ...
  */
  ...
  AliAnalysisTaskCorrPPMC(const AliAnalysisTaskCorrPPMC&);
  AliAnalysisTaskCorrPPMC& operator=(const AliAnalysisTaskCorrPPMC&);  
  ClassDef(AliAnalysisTaskCorrPPMC, 1);
};
