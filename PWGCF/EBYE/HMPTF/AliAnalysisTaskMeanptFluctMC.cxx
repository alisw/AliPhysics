...
#include "AliAnalysisTaskMeanptFluctMC.h"
...
void AliAnalysisTaskMeanptFluctMC::UserCreateOutputObjects()
{
  ...
  fTreeEvent->Branch("fNch_gen", &fNch_gen, "fNch_gen[3]/F");
  fTreeEvent->Branch("fQ1_gen", &fQ1_gen, "fQ1_gen[3]/F");
  fTreeEvent->Branch("fQ2_gen", &fQ2_gen, "fQ2_gen[3]/F");
  fTreeEvent->Branch("fQ3_gen", &fQ3_gen, "fQ3_gen[3]/F");
  fTreeEvent->Branch("fQ4_gen", &fQ4_gen, "fQ4_gen[3]/F");
...
//________________________________________________________________________
void AliAnalysisTaskMeanptFluctMC::UserExec(Option_t *)
{
  ...
  if (lMCevent){
	...
	if (fMCImpactParameter<impParArr[0]  || fMCImpactParameter>impParArr[9]) fCentImpBin=-10.;
      ...
      float Nch[3]={0.0,0.0,0.0}; //0 index: pion, 1 index: kaon and 2 index: proton
      ...
      for (Int_t iTrack = 0; iTrack < lMCevent->GetNumberOfTracks(); iTrack++)
	{
	  ...
	  Track_PID=trackMCgen->PdgCode();
	  //cout<<"PID of track: "<<Track_PID<<endl;
	  ...
	  if(Track_pt>0.2 && Track_pt<=3.0 && TMath::Abs(Track_PID)==2212) //! proton
	    {
	      ...
	      Q3[2]=Q3[2]+TMath::Power(Track_pt, 3.0);
	      Q4[2]=Q4[2]+TMath::Power(Track_pt, 4.0);
	      Nch[2]=Nch[2]+1;
	    }
	}
...
//________________________________________________________________________
void AliAnalysisTaskMeanptFluctMC::Terminate(Option_t *)
{
