 ...
 **************************************************************************/
#ifndef AliAnalysisTaskCorrPbPb_treemerge_H
#define AliAnalysisTaskCorrPbPb_treemerge_H
...
class AliAnalysisTaskCorrPbPb_treemerge : public AliAnalysisTaskSE {
 public:
  AliAnalysisTaskCorrPbPb_treemerge();
  AliAnalysisTaskCorrPbPb_treemerge(const char *name);
  virtual ~AliAnalysisTaskCorrPbPb_treemerge();
  ...
  */
  ...
  AliAnalysisTaskCorrPbPb_treemerge(const AliAnalysisTaskCorrPbPb_treemerge&);
  AliAnalysisTaskCorrPbPb_treemerge& operator=(const AliAnalysisTaskCorrPbPb_treemerge&);  
  ClassDef(AliAnalysisTaskCorrPbPb_treemerge, 1);
};
