...
void AliAnalysisTaskResonanceVsMultiplicity::UserCreateOutputObjects()
{
  ...
  fTreeEvent->Branch("fTreeTrackVariableDcaXY",&fTreeTrackVariableDcaXY,"fTreeTrackVariableDcaXY[fTreeEventNTrack]/F");
  fTreeEvent->Branch("fTreeTrackVariableDcaZ",&fTreeTrackVariableDcaZ,"fTreeTrackVariableDcaZ[fTreeEventNTrack]/F");
  fTreeEvent->Branch("fTreeTrackVariableTpcNCls",&fTreeTrackVariableTpcNCls,"fTreeTrackVariableTpcNCls[fTreeEventNTrack]/F");
  fTreeEvent->Branch("fTreeTrackVariableTpcNCrossedRows",&fTreeTrackVariableTpcNCrossedRows,"fTreeTrackVariableTpcNCrossedRows[fTreeEventNTrack]/F");
  fTreeEvent->Branch("fTreeTrackVariableLeastRatioCrossedRowsOverFindable",&fTreeTrackVariableLeastRatioCrossedRowsOverFindable,"fTreeTrackVariableLeastRatioCrossedRowsOverFindable[fTreeEventNTrack]/F");
  fTreeEvent->Branch("fTreeTrackVariableChiSqrPerTpcCls",&fTreeTrackVariableChiSqrPerTpcCls,"fTreeTrackVariableChiSqrPerTpcCls[fTreeEventNTrack]/F");
  fTreeEvent->Branch("fTreeTrackVariableChiSqrPerItsCls",&fTreeTrackVariableChiSqrPerItsCls,"fTreeTrackVariableChiSqrPerItsCls[fTreeEventNTrack]/F");
  */
  ...
  Profile_skewness_term1_ptmax2=new TProfile("Profile_skewness_term1_ptmax2","Profile_skewness_term1_ptmax2",3001,-0.5,3000.5);
  Profile_skewness_term2_ptmax2=new TProfile("Profile_skewness_term2_ptmax2","Profile_skewness_term2_ptmax2",3001,-0.5,3000.5);
  Profile_skewness_term3_ptmax2=new TProfile("Profile_skewness_term3_ptmax2","Profile_skewness_term3_ptmax2",3001,-0.5,3000.5);
  Profile_kurtosis_term1_ptmax2=new TProfile("Profile_kurtosis_term1_ptmax2","Profile_kurtosis_term1_ptmax2",3001,-0.5,3000.5);
  Profile_kurtosis_term2_ptmax2=new TProfile("Profile_kurtosis_term2_ptmax2","Profile_kurtosis_term2_ptmax2",3001,-0.5,3000.5);
  Profile_kurtosis_term3_ptmax2=new TProfile("Profile_kurtosis_term3_ptmax2","Profile_kurtosis_term3_ptmax2",3001,-0.5,3000.5);
  Profile_kurtosis_term4_ptmax2=new TProfile("Profile_kurtosis_term4_ptmax2","Profile_kurtosis_term4_ptmax2",3001,-0.5,3000.5);

  //histograms for ptcut 0.2 < pT < 3.0 GeV/c
  Profile_mean_term1_ptmax3=new TProfile("Profile_mean_term1_ptmax3","Profile_mean_term1_ptmax3",3001,-0.5,3000.5);
  Profile_var_term1_ptmax3=new TProfile("Profile_var_term1_ptmax3","Profile_var_term1_ptmax3",3001,-0.5,3000.5);
  Profile_var_term2_ptmax3=new TProfile("Profile_var_term2_ptmax3","Profile_var_term2_ptmax3",3001,-0.5,3000.5);
  Profile_skewness_term1_ptmax3=new TProfile("Profile_skewness_term1_ptmax3","Profile_skewness_term1_ptmax3",3001,-0.5,3000.5);
  Profile_skewness_term2_ptmax3=new TProfile("Profile_skewness_term2_ptmax3","Profile_skewness_term2_ptmax3",3001,-0.5,3000.5);
  Profile_skewness_term3_ptmax3=new TProfile("Profile_skewness_term3_ptmax3","Profile_skewness_term3_ptmax3",3001,-0.5,3000.5);
  Profile_kurtosis_term1_ptmax3=new TProfile("Profile_kurtosis_term1_ptmax3","Profile_kurtosis_term1_ptmax3",3001,-0.5,3000.5);
  Profile_kurtosis_term2_ptmax3=new TProfile("Profile_kurtosis_term2_ptmax3","Profile_kurtosis_term2_ptmax3",3001,-0.5,3000.5);
  Profile_kurtosis_term3_ptmax3=new TProfile("Profile_kurtosis_term3_ptmax3","Profile_kurtosis_term3_ptmax3",3001,-0.5,3000.5);
  Profile_kurtosis_term4_ptmax3=new TProfile("Profile_kurtosis_term4_ptmax3","Profile_kurtosis_term4_ptmax3",3001,-0.5,3000.5);
  ...
  fListHist->Add(Profile_skewness_term1_ptmax2);
  fListHist->Add(Profile_skewness_term2_ptmax2);
  fListHist->Add(Profile_skewness_term3_ptmax2);
  fListHist->Add(Profile_kurtosis_term1_ptmax2);
  fListHist->Add(Profile_kurtosis_term2_ptmax2);
  fListHist->Add(Profile_kurtosis_term3_ptmax2);
  fListHist->Add(Profile_kurtosis_term4_ptmax2);

  fListHist->Add(Profile_mean_term1_ptmax3);
  fListHist->Add(Profile_var_term1_ptmax3);
  fListHist->Add(Profile_var_term2_ptmax3);
  fListHist->Add(Profile_skewness_term1_ptmax3);
  fListHist->Add(Profile_skewness_term2_ptmax3);
  fListHist->Add(Profile_skewness_term3_ptmax3);
  fListHist->Add(Profile_kurtosis_term1_ptmax3);
  fListHist->Add(Profile_kurtosis_term2_ptmax3);
  fListHist->Add(Profile_kurtosis_term3_ptmax3);
  fListHist->Add(Profile_kurtosis_term4_ptmax3);
...
void AliAnalysisTaskResonanceVsMultiplicity::UserExec(Option_t *)
{
  ...
  fEventCuts.SetRejectTPCPileupWithITSTPCnCluCorr(kTRUE); //new
  ...
  */
  ...
  float mean_term1[2]={-100.0,-100.0};
  float var_term1[2]={-100.0,-100.0};
  float var_term2[2]={-100.0,-100.0};
  float skewness_term1[2]={-100.0,-100.0};
  float skewness_term2[2]={-100.0,-100.0};
  float skewness_term3[2]={-100.0,-100.0};
  float kurtosis_term1[2]={-100.0,-100.0};
  float kurtosis_term2[2]={-100.0,-100.0};
  float kurtosis_term3[2]={-100.0,-100.0};
  float kurtosis_term4[2]={-100.0,-100.0};
  ...
  if(Nch[0] > 0.0)
    {
      ...
      Profile_mean_term1_ptmax2->Fill(Nch[0],mean_term1[0]);
    }
  if(Nch[0] > 1.0)
    {
      var_term1[0]=(TMath::Power(Q1[0],2.0)-Q2[0])/(Nch[0]*(Nch[0]-1.0));
      var_term2[0]=(Q1[0]/Nch[0]);
      Profile_var_term1_ptmax2->Fill(Nch[0],var_term1[0]);
      Profile_var_term2_ptmax2->Fill(Nch[0],var_term2[0]);
    }
  if(Nch[0] > 2.0)
    {
      skewness_term1[0]=(TMath::Power(Q1[0],3.0)-3.0*Q2[0]*Q1[0]+2.0*Q3[0])/(Nch[0]*(Nch[0]-1.0)*(Nch[0]-2.0));
      skewness_term2[0]=(TMath::Power(Q1[0],2.0)-Q2[0])/(Nch[0]*(Nch[0]-1.0));
      skewness_term3[0]=(Q1[0]/Nch[0]);
      Profile_skewness_term1_ptmax2->Fill(Nch[0],skewness_term1[0]);
      Profile_skewness_term2_ptmax2->Fill(Nch[0],skewness_term2[0]);
      Profile_skewness_term3_ptmax2->Fill(Nch[0],skewness_term3[0]);
    }
  if(Nch[0] > 3.0)
    {
      kurtosis_term1[0]=(TMath::Power(Q1[0],4.0)-(6.0*Q4[0])+(8.0*Q1[0]*Q3[0])-(6.0*TMath::Power(Q1[0],2.0)*Q2[0])+(3.0*TMath::Power(Q2[0],2.0)))/(Nch[0]*(Nch[0]-1.0)*(Nch[0]-2.0)*(Nch[0]-3.0));
      kurtosis_term2[0]=(TMath::Power(Q1[0],3.0)-3.0*Q2[0]*Q1[0]+2.0*Q3[0])/(Nch[0]*(Nch[0]-1.0)*(Nch[0]-2.0));
      kurtosis_term3[0]=(TMath::Power(Q1[0],2.0)-Q2[0])/(Nch[0]*(Nch[0]-1.0));
      kurtosis_term4[0]=(Q1[0]/Nch[0]);
      Profile_kurtosis_term1_ptmax2->Fill(Nch[0],kurtosis_term1[0]);
      Profile_kurtosis_term2_ptmax2->Fill(Nch[0],kurtosis_term2[0]);
      Profile_kurtosis_term3_ptmax2->Fill(Nch[0],kurtosis_term3[0]);
      Profile_kurtosis_term4_ptmax2->Fill(Nch[0],kurtosis_term4[0]);
    }


  if(Nch[1] > 0.0)
    {
      mean_term1[1]=Q1[1]/Nch[1];
      Profile_mean_term1_ptmax3->Fill(Nch[1],mean_term1[1]);
    }
  if(Nch[1] > 1.0)
    {
      var_term1[1]=(TMath::Power(Q1[1],2.0)-Q2[1])/(Nch[1]*(Nch[1]-1.0));
      var_term2[1]=(Q1[1]/Nch[1]);
      Profile_var_term1_ptmax3->Fill(Nch[1],var_term1[1]);
      Profile_var_term2_ptmax3->Fill(Nch[1],var_term2[1]);
    }
  if(Nch[1] > 2.0)
    {
      skewness_term1[1]=(TMath::Power(Q1[1],3.0)-3.0*Q2[1]*Q1[1]+2.0*Q3[1])/(Nch[1]*(Nch[1]-1.0)*(Nch[1]-2.0));
      skewness_term2[1]=(TMath::Power(Q1[1],2.0)-Q2[1])/(Nch[1]*(Nch[1]-1.0));
      skewness_term3[1]=(Q1[1]/Nch[1]);
      Profile_skewness_term1_ptmax3->Fill(Nch[1],skewness_term1[1]);
      Profile_skewness_term2_ptmax3->Fill(Nch[1],skewness_term2[1]);
      Profile_skewness_term3_ptmax3->Fill(Nch[1],skewness_term3[1]);
    }
  if(Nch[1] > 3.0)
    {
      kurtosis_term1[1]=(TMath::Power(Q1[1],4.0)-(6.0*Q4[1])+(8.0*Q1[1]*Q3[1])-(6.0*TMath::Power(Q1[1],2.0)*Q2[1])+(3.0*TMath::Power(Q2[1],2.0)))/(Nch[1]*(Nch[1]-1.0)*(Nch[1]-2.0)*(Nch[1]-3.0));
      kurtosis_term2[1]=(TMath::Power(Q1[1],3.0)-3.0*Q2[1]*Q1[1]+2.0*Q3[1])/(Nch[1]*(Nch[1]-1.0)*(Nch[1]-2.0));
      kurtosis_term3[1]=(TMath::Power(Q1[1],2.0)-Q2[1])/(Nch[1]*(Nch[1]-1.0));
      kurtosis_term4[1]=(Q1[1]/Nch[1]);
      Profile_kurtosis_term1_ptmax3->Fill(Nch[1],kurtosis_term1[1]);
      Profile_kurtosis_term2_ptmax3->Fill(Nch[1],kurtosis_term2[1]);
