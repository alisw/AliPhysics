AliAnalysisTaskNetProtonCumulants_pp *AddTaskNetProtonCumulants_pp(Int_t fCentralityMin=0, Int_t fCentralityMax=90, Double_t fVzMax=10, Int_t fpileupcut = 1, Int_t fCentEstFlag = 0, Int_t fFilterBit=96, Double_t fchi2tpc=4, Double_t fchi2its=36, Double_t fnotpccrossedrows=70, Double_t fpidnSigma_Pion=2.0, Double_t fpidnSigma_Kaon=2.0, Double_t fpidnSigma_Proton=2.0, TString OutFileName = "_default", TString sMCfilePath ="alien:///alice/cern.ch/user/s/swati/EfficiencyPbPbLHC20j6a/CentralitywiseEff/EfficiencyHijingPbPb.root", Double_t fetacut=0.8, Int_t lBayesianPIDFlag=1, Double_t lPIDbayesPion=0.9, Double_t lPIDbayesKaon=0.9, Double_t lPIDbayesProton=0.9)
{
  // standard with task
  printf("===================================================================================\n");
  ...
  AliAnalysisTaskNetProtonCumulants_pp *task_Mpt = new AliAnalysisTaskNetProtonCumulants_pp(TaskMeanpt);
