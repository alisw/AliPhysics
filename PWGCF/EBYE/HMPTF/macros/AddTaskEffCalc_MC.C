...

{
  ...
  //gInterpreter->ProcessLine(".x AliAnalysisTaskEffCalc_MC.cxx++g");
  AliAnalysisTaskEffCalc_MC *task_Mpt = new AliAnalysisTaskEffCalc_MC(TaskMeanpt);
  ...
  */
  ...
  sMyOutName4 += "fTreeEvent_gen";
  sMyOutName4 += OutFileName;
  sMyOutName4 += "fTreeEvent_rec";
  sMyOutName4 += OutFileName;
  ...
  cOutPut4 = (AliAnalysisDataContainer *) mgr->CreateContainer(sMyOutName4,TTree::Class(),AliAnalysisManager::kOutputContainer,list1OutName.Data());
  cOutPut5 = (AliAnalysisDataContainer *) mgr->CreateContainer(sMyOutName5,TTree::Class(),AliAnalysisManager::kOutputContainer,list1OutName.Data());
  
  mgr->ConnectOutput(task_Mpt, 1, cOutPut1);
  mgr->ConnectOutput(task_Mpt, 2, cOutPut2);
  mgr->ConnectOutput(task_Mpt, 3, cOutPut3);
  mgr->ConnectOutput(task_Mpt, 4, cOutPut4);
  mgr->ConnectOutput(task_Mpt, 5, cOutPut5);
