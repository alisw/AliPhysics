AliAnalysisTaskCorrPbPb_treemerge_v2 *AddTaskCorrPbPb_treemerge_v2(Int_t fCentralityMin=0, Int_t fCentralityMax=90, Double_t fVzMax=10, Int_t fpileupcut = 1, Int_t fCentEstFlag = 0, Int_t fFilterBit=96, Double_t fchi2tpc=4, Double_t fchi2its=36, Double_t fnotpccrossedrows=70, Double_t fpidnSigma_Pion=2.0, Double_t fpidnSigma_Kaon=2.0, Double_t fpidnSigma_Proton=2.0, TString OutFileName = "_default", TString sMCfilePath ="alien:///alice/cern.ch/user/s/swati/EfficiencyPbPbLHC20j6a/CentralitywiseEff/EfficiencyHijingPbPb.root", Double_t fetacut=0.8, Double_t fptmin1 = 0.4, Double_t fptmax1 = 1.6, Double_t fptmin2 = 0.2, Double_t fptmax2 = 2.0)
{
  // standard with task
  printf("===================================================================================\n");
  ...
  //gInterpreter->ProcessLine(".x AliAnalysisTaskCorrPbPb_treemerge_v2.cxx++g");
  AliAnalysisTaskCorrPbPb_treemerge_v2 *task_Mpt = new AliAnalysisTaskCorrPbPb_treemerge_v2(TaskMeanpt);
  ...
  */
  ...
  task_Mpt->SetPtMaxMinCutsSet1and2(fptmin1,fptmax1,fptmin2,fptmax2);
