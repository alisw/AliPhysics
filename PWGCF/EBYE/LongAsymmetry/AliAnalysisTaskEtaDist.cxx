...
#include "AliAnalysisTaskEtaDist.h"
#include "AliAODMCParticle.h"
#include "AliEventCuts.h"
#include "AliAODMCHeader.h"


ClassImp(AliAnalysisTaskEtaDist)

AliAnalysisTaskEtaDist::AliAnalysisTaskEtaDist() :  AliAnalysisTaskSE(),
  fAOD(0), fOutputList(0), fNt(0),
  fIsMC(0), fChi2DoF(4), fTPCNcls(70), fPtmin(0.2), fPtmax(2), fEta(0.8), fBit(96),
  fIsPileUpCuts(0),  fEventCuts(0)
{
    mCentV0M = 0.;
    mCentCL0 = 0.;
    mCentCL1 = 0.;
...
AliAnalysisTaskEtaDist::AliAnalysisTaskEtaDist(const char* name) :  AliAnalysisTaskSE(name),
  fAOD(0), fOutputList(0), fNt(0), 
  fIsMC(0), fChi2DoF(4), fTPCNcls(70), fPtmin(0.2), fPtmax(2), fEta(0.8), fBit(96),
  fIsPileUpCuts(0), fEventCuts(0)
{
...
//_____________________________________________________________________________
AliAnalysisTaskEtaDist::~AliAnalysisTaskEtaDist()
{
    // destructor
    if(fOutputList) {
...
void AliAnalysisTaskEtaDist::UserCreateOutputObjects()
{
...
//_____________________________________________________________________________
void AliAnalysisTaskEtaDist::UserExec(Option_t *)
{
    ...
    if(fIsMC){
        TH1D etaPosMC("etaPosMC","",16,-fEta,fEta);
        TH1D etaNegMC("etaNegMC","",16,-fEta,fEta);
...
//_____________________________________________________________________________
void AliAnalysisTaskEtaDist::Terminate(Option_t *)
{
    // terminate
