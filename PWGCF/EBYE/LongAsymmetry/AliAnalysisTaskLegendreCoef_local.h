...
#ifndef AliAnalysisTaskLegendreCoef_local_H
#define AliAnalysisTaskLegendreCoef_local_H
class TH1;
class THn;
class TH1F;
class TH2D;
...
class AliAnalysisTaskLegendreCoef_local : public AliAnalysisTaskSE
{
  public:
                    AliAnalysisTaskLegendreCoef_local();
                    AliAnalysisTaskLegendreCoef_local(const char *name);
    virtual         ~AliAnalysisTaskLegendreCoef_local();
  ...
  private:
    ...
    void    DumpMCRec(AliAODEvent *fAOD, AliAODTrack *trackAOD, AliAODMCParticle* mcTrack);
    void    DumpMCGen(AliAODEvent *fAOD, AliAODMCParticle* mcTrack);
    void    DumpRaw(AliAODEvent *fAOD, AliAODTrack *trackAOD);
    void    BuildSignal();
    ...
    TTree            *fTreeRaw;              // tree for generatec

    AliEventCuts fEventCuts;

    AliAnalysisTaskLegendreCoef_local(const AliAnalysisTaskLegendreCoef_local&); // not implemented
    AliAnalysisTaskLegendreCoef_local& operator=(const AliAnalysisTaskLegendreCoef_local&); // not implemented

    ClassDef(AliAnalysisTaskLegendreCoef_local, 1);
};
