...
//void runEfficiencyTaskCentralityTrain(const char* runListFileName = "listOfRuns.txt",Int_t mode = mGrid,  Bool_t DATA = kFALSE) {
  ...
  if(mode==mLocal || mode == mLocalPAR) {
    ...
    chain->Add("/project/alice/users/alisrm/AcceptanceFilter/MonteCarlo/Set2/AliESDs.root");
    chain->Add("/project/alice/users/alisrm/AcceptanceFilter/MonteCarlo/Set3/AliESDs.root");
    chain->Add("/project/alice/users/alisrm/AcceptanceFilter/MonteCarlo/Set4/AliESDs.root");
    chain->Add("/project/alice/users/alisrm/AcceptanceFilter/MonteCarlo/Set5/AliESDs.root");
    chain->Add("/project/alice/users/alisrm/AcceptanceFilter/MonteCarlo/Set6/AliESDs.root");
    chain->Add("/project/alice/users/alisrm/AcceptanceFilter/MonteCarlo/Set7/AliESDs.root");
    chain->Add("/project/alice/users/alisrm/AcceptanceFilter/MonteCarlo/Set8/AliESDs.root");
    chain->Add("/project/alice/users/alisrm/AcceptanceFilter/MonteCarlo/Set9/AliESDs.root");
  ...
  gROOT->LoadMacro("AddTaskBalanceEfficiency.C");
  ...
  for (Int_t i = 0; i < 9; i++) {
    ...
    AddTaskBalanceEfficiency(centralityEstimator, lowCentralityBinEdge, highCentralityBinEdge, vertexZ, commonOutputFileName);
