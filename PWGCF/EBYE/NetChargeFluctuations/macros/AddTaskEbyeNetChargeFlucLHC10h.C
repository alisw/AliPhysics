...
AliAnalysisTaskEbyeChargeFlucLHC10h* AddTaskEbyeNetChargeFlucLHC10h(
                                                                TString suffixName = "",
...
{ // get the manager via the static access member. since it's static, you don't need
    ...
    AliAnalysisTaskEbyeChargeFlucLHC10h* task = new AliAnalysisTaskEbyeChargeFlucLHC10h("");
    if(!task) return 0x0;
