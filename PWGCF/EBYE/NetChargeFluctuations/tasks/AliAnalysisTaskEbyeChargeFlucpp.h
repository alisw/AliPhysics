#ifndef AliAnalysisTaskEbyeChargeFlucpp_H
#define AliAnalysisTaskEbyeChargeFlucpp_H
...
class AliAnalysisTaskEbyeChargeFlucpp : public AliAnalysisTaskSE
{
public:
    AliAnalysisTaskEbyeChargeFlucpp();
    AliAnalysisTaskEbyeChargeFlucpp(const char *name);
    virtual                 ~AliAnalysisTaskEbyeChargeFlucpp();
...
private:
    ...
    Float_t                 lMultiPercentile;       //! Multiplicity Percentile information
...
//    
    ...
    AliAnalysisTaskEbyeChargeFlucpp(const AliAnalysisTaskEbyeChargeFlucpp&);
    AliAnalysisTaskEbyeChargeFlucpp& operator=(const AliAnalysisTaskEbyeChargeFlucpp&);
    ClassDef(AliAnalysisTaskEbyeChargeFlucpp, 1);
};
