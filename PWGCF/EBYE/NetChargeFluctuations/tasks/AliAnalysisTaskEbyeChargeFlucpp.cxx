...
#include "AliAnalysisTaskEbyeChargeFlucpp.h"

class AliAnalysisTaskEbyeChargeFlucpp;
...
ClassImp(AliAnalysisTaskEbyeChargeFlucpp)

//================================================
//--------------Constructor-----------------------
//================================================

AliAnalysisTaskEbyeChargeFlucpp::AliAnalysisTaskEbyeChargeFlucpp()
: AliAnalysisTaskSE(),
fAOD(0x0),
fOutputList(0),
...
AliAnalysisTaskEbyeChargeFlucpp::AliAnalysisTaskEbyeChargeFlucpp(const char* name)
...
//============================================================
void AliAnalysisTaskEbyeChargeFlucpp::UserCreateOutputObjects()
{
    ...
    fhCent = new TH1F("fhCent","Multiplicity",100,0,100);
...
//----------------------UserExec------------------------------
//============================================================
void AliAnalysisTaskEbyeChargeFlucpp::UserExec(Option_t *){
...
void AliAnalysisTaskEbyeChargeFlucpp::doAODEvent(){
...
//    fHistCentralityMultSelection->Fill(fCentrality);
    fhCent->Fill(lMultiPercentile); //multiplicity dist.
...
//    Double_t centUpArray[9]  = {5., 10., 20., 30., 40., 50., 60., 70., 80.};
    //case 2: Multiplicity bins for pp
    Double_t centDownArray[9]= {0.0 , 5.0,  10., 15., 20., 30., 40., 50., 70.};
    Double_t centUpArray[9]  = {5.0, 10.0, 15., 20., 30., 40., 50., 70., 100.};
    //case 3:
                ...
                for(Int_t i(0); i < iTracks; i++) {
                 ...
                 //   if(!PassDCA(fAOD, track)) continue;
                   ...
                   if ((fpT>=momDownArray[imom])
                        &&(fpT<momUpArray[imom])
                        &&(lMultiPercentile>=centDownArray[icent])
                        &&(lMultiPercentile<centUpArray[icent])){
...
void AliAnalysisTaskEbyeChargeFlucpp::doMCAODEvent(){
...
void AliAnalysisTaskEbyeChargeFlucpp::FillMCEffMatrix(){
...
//---------------------------------------------------------------------------------------
Bool_t AliAnalysisTaskEbyeChargeFlucpp::AcceptTrack(AliAODTrack* aodtrack) const{
...
Bool_t AliAnalysisTaskEbyeChargeFlucpp::PassDCA(AliAODEvent *fAOD,AliAODTrack* aodtrack) const{
...
//------------------------------------------------------------------------------------------
void AliAnalysisTaskEbyeChargeFlucpp::Terminate(Option_t *)
{
    // terminate
    // called at the END of the analysis (when all events are processed)
    Info("AliAnalysisTaskEbyeChargeFlucpp"," Task Successfully finished");
