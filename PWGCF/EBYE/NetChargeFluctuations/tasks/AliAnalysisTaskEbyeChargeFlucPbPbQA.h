#ifndef AliAnalysisTaskEbyeChargeFlucPbPbQA_H
#define AliAnalysisTaskEbyeChargeFlucPbPbQA_H
...
class AliAnalysisTaskEbyeChargeFlucPbPbQA : public AliAnalysisTaskSE
{
public:
    AliAnalysisTaskEbyeChargeFlucPbPbQA();
    AliAnalysisTaskEbyeChargeFlucPbPbQA(const char *name);
    virtual                 ~AliAnalysisTaskEbyeChargeFlucPbPbQA();
    ...
    void                    SetMCTreeFill(Bool_t MCFill = kTRUE){fMCFill = MCFill;};
...
//    TTree                  *fTree;                  // Tree for real Data
    ...
    Bool_t                 fMCFill;                // "MC Reco tree filling"
    ...
    AliAnalysisTaskEbyeChargeFlucPbPbQA(const AliAnalysisTaskEbyeChargeFlucPbPbQA&);
    AliAnalysisTaskEbyeChargeFlucPbPbQA& operator=(const AliAnalysisTaskEbyeChargeFlucPbPbQA&);
    ClassDef(AliAnalysisTaskEbyeChargeFlucPbPbQA, 1);
};
