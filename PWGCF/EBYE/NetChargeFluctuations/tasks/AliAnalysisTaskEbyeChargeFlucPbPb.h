...
class AliAnalysisTaskEbyeChargeFlucPbPb : public AliAnalysisTaskSE
{
public:
    AliAnalysisTaskEbyeChargeFlucPbPb();
    AliAnalysisTaskEbyeChargeFlucPbPb(const char *name);
    virtual                 ~AliAnalysisTaskEbyeChargeFlucPbPb();
...
//    Double_t                fCutDCAz ;    //DCA z
    ...
    AliAnalysisTaskEbyeChargeFlucPbPb(const AliAnalysisTaskEbyeChargeFlucPbPb&);
    AliAnalysisTaskEbyeChargeFlucPbPb& operator=(const AliAnalysisTaskEbyeChargeFlucPbPb&);
    ClassDef(AliAnalysisTaskEbyeChargeFlucPbPb, 1);
};
