#ifndef AliAnalysisTaskEbyeChargeFlucLHC10h_H
#define AliAnalysisTaskEbyeChargeFlucLHC10h_H
...
class AliAnalysisTaskEbyeChargeFlucLHC10h : public AliAnalysisTaskSE
{
public:
    AliAnalysisTaskEbyeChargeFlucLHC10h();
    AliAnalysisTaskEbyeChargeFlucLHC10h(const char *name);
    virtual                 ~AliAnalysisTaskEbyeChargeFlucLHC10h();
    
    virtual void            UserCreateOutputObjects();
    virtual void            UserExec(Option_t* option);
    virtual void            Terminate(Option_t* option);
    virtual void            doAODEvent();
    virtual void            doRealdataInfo();
    virtual void            doMCAODInfo();
...
private:
    Bool_t CheckIfFromResonance(AliAODMCParticle *trackMCgen, Int_t trackIndex) ;
...
//    TTree                  *fTree;                  // Tree for real Data
    TTree                  *fTreedata;                  // Tree for real Data
    ...
    Int_t                   nRgenMomentsPos;       // MC gen Resonances positive particles
    Int_t                   nRgenMomentsNeg;       // MC gen Resonances negative particles
    Int_t                   nResgenMomentsCross;   // MC gen Resonances cross moments of pos and neg
    Int_t                   nResgenMomentsPos;     // MC gen Resonances second moments of pos
    Int_t                   nResgenMomentsNeg;     // MC gen Resonances second moments of neg
    Int_t                   nRgenMomentsPosWRes;
    Int_t                   nRgenMomentsNegWRes;
    Int_t                   nRgenMomentsPosWoRes;
    Int_t                   nRgenMomentsNegWoRes;
    Int_t                   nWoResgenMomentsCross;
    Int_t                   nWoResgenMomentsPos;
    Int_t                   nWoResgenMomentsNeg;
    ...
    TH1I                    *fEventMCStatistics;         // cut-by-cut counter of events
    TH1D                    *fHistClustersTPC;
    TH1D                    *fHistChi2perNDF;
    TH1D                    *fHistCrossedRowsTPC;
    TH1F                    *fHistDCAz;
    TH1F                    *fHistDCAxy;
    ...
    AliAnalysisTaskEbyeChargeFlucLHC10h(const AliAnalysisTaskEbyeChargeFlucLHC10h&);
    AliAnalysisTaskEbyeChargeFlucLHC10h& operator=(const AliAnalysisTaskEbyeChargeFlucLHC10h&);
    ClassDef(AliAnalysisTaskEbyeChargeFlucLHC10h, 1);
};
