...
class AliUEHistograms : public TNamed
{
 public:
  ...
  TH1F* GetInvYield() { return fInvYield; }
...
protected:
  ...
  TH1F* fInvYield; 		// invariant yield as cross check of tracking
  ...
  ClassDef(AliUEHistograms, 28)  // underlying event histogram container
};
