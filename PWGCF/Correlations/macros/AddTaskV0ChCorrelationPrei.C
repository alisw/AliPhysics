...
//=====================================  
 ...
 // task->SetTrackMCPtMin(1);
  ...
  task->SetDCAV0DaughtersMax(1);//0.8
  ...
  task->SetDCANegtoPrimVertexMinLamb(0.23);//0.25
  task->SetDCAPostoPrimVertexMinALamb(0.23);//0.25
  task->SetDCANegtoPrimVertexMinALamb(0.12);//0.1


  task->SetCosPointingAngleMin(0.975);
  task->SetLambdaCPA(0.993);//0.995
  task->Setk0sCPA(0.975);//0.98
