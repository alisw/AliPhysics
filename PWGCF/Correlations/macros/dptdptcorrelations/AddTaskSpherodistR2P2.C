//  Macro designed for use with the AliAnalysisTaskSpherodistR2P2 task.
...
AliAnalysisTaskSpherodistR2P2 * AddTaskSpherodistR2P2
(
 ...
 int    CentralityGroup         =  3,  // Diff Cent Groups dealing w/ memory limit & weight file 100M Alien limit
 int    minNch                  =  10, //Min number of charge particles for spherocity calculation
...

{
  ...
  if ( CentralityGroup == 1 )
       ...
       else if ( CentralityGroup == 4 )
    {
      ...
      minCentrality[5] = 80.;     maxCentrality[5]  = 100.;
    ...
    else if ( CentralityGroup == 5 )
    {
      ...
      minCentrality[2] = 20.;     maxCentrality[2]  = 40.;
      minCentrality[3] = 40.;     maxCentrality[3]  = 60.;
      minCentrality[4] = 60.;     maxCentrality[4]  = 100.;
  ...
  if (!analysisManager)
    {
      ::Error("AddTaskSpherodistR2P2", "No analysis manager to connect to.");
      return NULL;
    }
  ...
  AliAnalysisTaskSpherodistR2P2* task;
  ...
  for (int iCentrality=0; iCentrality < nCentrality; ++iCentrality)
   {
	...
	case 3: part1Name = "M"; part2Name = "M"; requestedCharge1 = -1; requestedCharge2 = -1; sameFilter = 1;   break;
      ...
      task = new  AliAnalysisTaskSpherodistR2P2(taskName);
      //configure my task
