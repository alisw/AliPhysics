//  Macro designed for use with the AliAnalysisTaskBFR2 task.
...
AliAnalysisTaskBFR2 * AddTaskBFR2
(
...

{
  ...
  if (!analysisManager)
    {
      ::Error("AddTaskBFR2", "No analysis manager to connect to.");
      return NULL;
    }
  ...
  for (int iCentrality=0; iCentrality < nCentrality; ++iCentrality)
	...
	case 3: part1Name = "M"; part2Name = "M"; requestedCharge1 = -1; requestedCharge2 = -1; sameFilter = 1;   break;
      ...
      task = new  AliAnalysisTaskBFR2(taskName);
      //configure my task
