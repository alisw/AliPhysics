...
(
 ...
 int    CentralityGroup         =  46,  // Diff Cent Groups dealing w/ memory limit & weight file 100M Alien limit
 int    PtGroup                 =  4,  // Diff Pt Groups dealing w/ memory limit & weight file 500M Alien limit
