//  Macro designed for use with the AliAnalysisTaskR2P2Base task.
...
AliAnalysisTaskR2P2Base * AddTaskR2P2Base
(
...

{
  ...
  if (!analysisManager)
    {
      ::Error("AddTaskR2P2Base", "No analysis manager to connect to.");
      return NULL;
    }
  ...
  for (int iCentrality=0; iCentrality < nCentrality; ++iCentrality)
	...
	case 3: part1Name = "M"; part2Name = "M"; requestedCharge1 = -1; requestedCharge2 = -1; sameFilter = 1;   break;
      ...
      task = new  AliAnalysisTaskR2P2Base(taskName);
      //configure my task
