//  Macro designed for use with the AliAnalysisTaskBFR2sphero task.
...

{
  ...
  if (!analysisManager)
    {
      ::Error("AddTaskBFR2sphero", "No analysis manager to connect to.");
      return NULL;
    }
  ...
  AliAnalysisTaskBFR2sphero* task;
    ...
    for (int isphero = 0; isphero < nSherocity; ++isphero)
  {
	...
	case 3: part1Name = "M"; part2Name = "M"; requestedCharge1 = -1; requestedCharge2 = -1; sameFilter = 1;   break;
      ...
      task = new  AliAnalysisTaskBFR2sphero(taskName);
      //configure my task
