//  Macro designed for use with the AliAnalysisTaskR2P2multEff task.
...
AliAnalysisTaskR2P2multEff * AddTaskR2P2multEff
(
...

{
  ...
  if (!analysisManager)
    {
      ::Error("AddTaskR2P2multEff", "No analysis manager to connect to.");
      return NULL;
    }
  ...
  AliAnalysisTaskR2P2multEff* task;
  ...
  for (int iCentrality=0; iCentrality < nCentrality; ++iCentrality)
	...
	case 3: part1Name = "M"; part2Name = "M"; requestedCharge1 = -1; requestedCharge2 = -1; sameFilter = 1;   break;
      ...
      task = new  AliAnalysisTaskR2P2multEff(taskName);
      //configure my task
