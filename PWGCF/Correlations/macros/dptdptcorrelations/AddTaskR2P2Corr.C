//  Macro designed for use with the AliAnalysisTaskR2P2Corr task.
...
AliAnalysisTaskR2P2Corr * AddTaskR2P2Corr
(
...

{
  ...
  if (!analysisManager)
    {
      ::Error("AddTaskR2P2Corr", "No analysis manager to connect to.");
      return NULL;
    }
  ...
  for (int iCentrality=0; iCentrality < nCentrality; ++iCentrality)
	...
	case 3: part1Name = "M"; part2Name = "M"; requestedCharge1 = -1; requestedCharge2 = -1; sameFilter = 1;   break;
      ...
      task = new  AliAnalysisTaskR2P2Corr(taskName);
      //configure my task
