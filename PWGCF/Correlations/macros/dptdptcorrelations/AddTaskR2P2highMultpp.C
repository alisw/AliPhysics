//  Macro designed for use with the AliAnalysisTaskR2P2highMultpp task.
...
AliAnalysisTaskR2P2highMultpp * AddTaskR2P2highMultpp
(
...

{
  ...
  else if ( CentralityGroup == 50 )
    {
      nCentrality = 3;

      minCentrality[0] = 0.;      maxCentrality[0]  = 30.;
      minCentrality[1] = 30.;     maxCentrality[1]  = 60.;
      minCentrality[2] = 60.;     maxCentrality[2]  = 100.;
    }
  else if ( CentralityGroup == 60 )
    {
      nCentrality = 1;
      
      minCentrality[0] = 0.;      maxCentrality[0]  = 0.1;
    }
  else if ( CentralityGroup == 61 )
    {
      nCentrality = 1;
      
      minCentrality[0] = 0.;      maxCentrality[0]  = 0.01;
    }
  else if ( CentralityGroup == 62 )
    {
      nCentrality = 1;
      
      minCentrality[0] = 0.01;      maxCentrality[0]  = 0.1;
    }
  else if ( CentralityGroup == 63 )
    {
      nCentrality = 1;
      
      minCentrality[0] = 0.1;      maxCentrality[0]  = 0.5;
    }
  else if ( CentralityGroup == 64 )
    {
      nCentrality = 1;
      
      minCentrality[0] = 0.5;      maxCentrality[0]  = 1.0;
    }
  ...
  if (!analysisManager)
    {
      ::Error("AddTaskR2P2highMultpp", "No analysis manager to connect to.");
      return NULL;
    }
  ...
  AliAnalysisTaskR2P2highMultpp* task;
  ...
  for (int iCentrality=0; iCentrality < nCentrality; ++iCentrality)
	...
	eventName += int(10*maxCentrality[iCentrality] );   
      ...
      task = new  AliAnalysisTaskR2P2highMultpp(taskName);
      //configure my task
      ...
      else task -> SelectCollisionCandidates(AliVEvent::kHighMultV0); // PbPb & pp
