...
//        chargeSet:  0: ++    1: +-    2: -+    3: --
/////////////////////////////////////////////////////////////////////////////////
AliAnalysisTaskDptDptCorrelations *AddTaskDptDptCorrelations2011(int    system                 = 0,
                                                                 int    singlesOnly            = 0,
                                                                 int    useWeights             = 1,
                                                                 ...
                                                                 int    chargeSet              = 1) 
{
  ...
  if (!analysisManager) 
    {
    ::Error("AddTaskDptDptCorrelations2011", "No analysis manager to connect to.");
    return NULL;
    }  
  ...
  for (int iCentrality=0; iCentrality < nCentrality; ++iCentrality)
    {
      ...
      inputHistogramFileName =  "alien:///alice/cern.ch/user/p/prabhat/CalibFiles/PbPb276Calibration_2011.root"; 
