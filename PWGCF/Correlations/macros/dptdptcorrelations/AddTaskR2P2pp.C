//  Macro designed for use with the AliAnalysisTaskR2P2pp task.
...
AliAnalysisTaskR2P2pp * AddTaskR2P2pp
(
 ...
 )
{
  ...
  if (!analysisManager)
    {
      printf("AddTaskR2P2pp No analysis manager to connect to.");
      return NULL;
    }
      ...
      for (int iCentrality=0; iCentrality < nCentrality; ++iCentrality)
	{
	  for (int iPt = 0; iPt < nPt; ++iPt)
	      ...
	      if ( useWeights )
		{
	      ...
	      task = new  AliAnalysisTaskR2P2pp(taskName);
	      //configure my task
