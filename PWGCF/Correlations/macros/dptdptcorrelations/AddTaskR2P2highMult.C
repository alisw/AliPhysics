//  Macro designed for use with the AliAnalysisTaskR2P2highMult task.
...
AliAnalysisTaskR2P2highMult * AddTaskR2P2highMult
(
...

{
  ...
  if (!analysisManager)
    {
      ::Error("AddTaskR2P2highMult", "No analysis manager to connect to.");
      return NULL;
    }
  ...
  AliAnalysisTaskR2P2highMult* task;
  ...
  for (int iCentrality=0; iCentrality < nCentrality; ++iCentrality)
	...
	case 3: part1Name = "M"; part2Name = "M"; requestedCharge1 = -1; requestedCharge2 = -1; sameFilter = 1;   break;
      ...
      //eventName += "0";
      eventName += "Vo";
      eventName += "0p1";//int(maxCentrality[iCentrality] );
      //eventName += "100";
      ...
      task = new  AliAnalysisTaskR2P2highMult(taskName);
      //configure my task
