//  Macro designed for use with the AliAnalysisTaskR2P2CorrGen task.
...
(
 ...
 int    chargeSet               =  0,   // 0: ++    1: +-    2: -+    3: --
 const char* taskname           = "ChPP",// ChPM, ChPP, ChMM
...

{
  ...
  if (!analysisManager)
    {
      ::Error("AddTaskR2P2CorrGen", "No analysis manager to connect to.");
      return NULL;
    }
  ...
  AliAnalysisTaskR2P2CorrGen* task;
  ...
  for (int iCentrality=0; iCentrality < nCentrality; ++iCentrality)
	...
	case 3: part1Name = "M"; part2Name = "M"; requestedCharge1 = -1; requestedCharge2 = -1; sameFilter = 1;   break;
      ...
      task = new  AliAnalysisTaskR2P2CorrGen(taskName);
      //configure my task
