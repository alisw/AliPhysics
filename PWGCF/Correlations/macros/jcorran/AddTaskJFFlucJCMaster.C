...
AliAnalysisTask *AddTaskJFFlucJCMaster(TString taskName = "JFFlucJCMAP_Run2_pass2", UInt_t period = 0, std::string ptMinArray = "0.2 0.3", int cutConfig = 0, bool saveQA = kFALSE, bool ESDpileup = false, double intercept = 15000)
{
