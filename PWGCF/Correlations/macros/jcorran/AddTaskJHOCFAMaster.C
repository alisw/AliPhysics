AliAnalysisTask *AddTaskJHOCFAMaster (TString taskName = "JHOCFAMaster", UInt_t period = 0, double ptmin = 0.5, Bool_t removebadarea = kFALSE)
{
// Load Custom Configuration and parameters.
  enum
  { lhc15o = 0, lhc18q = 1, lhc18r = 2 };
  TString speriod[3] = { "15o", "18q", "18r" }; // Needed string to load correct map config based on string.
  cout << "AddTaskJHOCFAMaster:: period=" << period << "\t ptmin=" << ptmin <<
    endl;
