...
//=====================================  
 ...
 // task->SetTrackMCPtMin(1);
  ...
  task->SetDCAV0DaughtersMax(0.8);//0.8//0.7//0.1
  task->SetDCAPostoPrimVertexMink0s(0.1);//0.1//0.12//0.12
  task->SetDCANegtoPrimVertexMink0s(0.1);//0.1//0.12//0.12
  task->SetDCAPostoPrimVertexMinLamb(0.1);//0.1//0.12//0.12
  task->SetDCANegtoPrimVertexMinLamb(0.25);//0.25//0.28//23
  task->SetDCAPostoPrimVertexMinALamb(0.25);//0.25//0.28//23
  task->SetDCANegtoPrimVertexMinALamb(0.1);//0.1//0.12//0.12

  task->SetCosPointingAngleMin(0.975);
  task->SetLambdaCPA(0.995);//0.995//0.998//0.993
