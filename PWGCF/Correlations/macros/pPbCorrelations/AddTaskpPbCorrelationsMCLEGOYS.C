AliAnalysisTaskSEpPbCorrelationsMCLEGOYS* AddTaskpPbCorrelationsMCLEGOYS(
								       ...
								       Bool_t ffillcorrelation =kTRUE						 	                                                       	       )
{
  ...
  if (!mgr) {Error("AddTaskpPbCorrelationsMCLEGOYS.C", "No Analysis Manager");return 0;}
  ...
  //Correlation task
  AliAnalysisTaskSEpPbCorrelationsMCLEGOYS *myTask = new AliAnalysisTaskSEpPbCorrelationsMCLEGOYS(fListName.Data());
