                              ...
                              )
{
 ...
 //--------------------------------Variable--------------------------------
  ...
  task->SetDCANegtoPrimVertex(0.07);//0.06//
  task->SetDCAPostoPrimVertex(0.07);//0.06
  
  
  task->SetDCAV0DaughtersMax(0.7);//0.8
  task->Setk0sCPA(0.983);//0.98
  task->SetLambdaCPA(0.999);//0.998
