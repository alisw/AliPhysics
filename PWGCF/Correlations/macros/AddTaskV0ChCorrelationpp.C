                              ...
                              )
{
 ...
 //--------------------------------Variable--------------------------------
  ...
  task->SetDCANegtoPrimVertex(0.06);//0.06//0.07//0.05
  task->SetDCAPostoPrimVertex(0.06);//0.06//0.07//0/05
  
  
  task->SetDCAV0DaughtersMax(1);//0.8//0.7//1
  task->Setk0sCPA(0.98);//0.98//0.983//0.975
  task->SetLambdaCPA(0.998);//0.998//0.999//0.995
