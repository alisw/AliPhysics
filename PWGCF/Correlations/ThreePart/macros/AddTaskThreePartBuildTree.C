...
#endif
AliAnalysisTaskBuildCorrTree* AddTaskThreePartBuildTree (const char* name = "ThreePartBuildTree",
...
{
  //Add a task AliAnalysisTaskBuildCorrTree to the analysis train in charged track analysis, for pp data 
  //Defaults to 11a data with MB trigger.
...
//   mgr->ConnectOutput(eventplaneTask,1,coutputEP);
  ...
  task->SetCollisionType(AliAnalysisTaskBuildCorrTree::pp);
