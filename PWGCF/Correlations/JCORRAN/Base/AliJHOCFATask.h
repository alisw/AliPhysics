...
// Methods from the analysis task.
  ...
  void HOCFASetParticleWeights(Bool_t weights) {fHOCFAUseWeights = weights;}
...
private:
  ...
  Bool_t fHOCFAUseWeights; // kTrue: Enable the non-unit NUE/NUA corrections.
