...
class AliAnalysisTaskCorPIDTOFhadr : public AliAnalysisTaskSE  
{
	...
	TH1I*                   hadr_per_event;         // 17	
	
	TH2F*                   dphi_pt_hadr_C;         // 18
	TH2F*                   dphi_kt_hadr_C;         // 19
	TH2F*                   dphi_et_hadr_C;         // 20
	TH2F*                   dphi_en_hadr_C;         // 21

	TH1F*                   hadr_pt_count_C;        // 22
	TH1F*                   hadr_kt_count_C;        // 23
	TH1F*                   hadr_et_count_C;        // 24
	TH1F*                   hadr_en_count_C;        // 25

	TH2F*                   dphi_pt_hadr_P;         // 26
	TH2F*                   dphi_kt_hadr_P;         // 27
	TH2F*                   dphi_et_hadr_P;         // 28
	TH2F*                   dphi_en_hadr_P;         // 29

	TH1F*                   hadr_pt_count_P;        // 30
	TH1F*                   hadr_kt_count_P;        // 31
	TH1F*                   hadr_et_count_P;        // 32
	TH1F*                   hadr_en_count_P;        // 33
	...
	TH2F*                   hadr_dphi_deta_p1_0510; // 38
	TH2F*                   hadr_dphi_deta_p1_1020; // 39
	TH2F*                   hadr_dphi_deta_p1_2030; // 40
	TH2F*                   hadr_dphi_deta_p1_3040; // 41
	TH2F*                   hadr_dphi_deta_p1_4050; // 42

	TH2F*                   hadr_dphi_deta_p2_0510; // 43
	TH2F*                   hadr_dphi_deta_p2_1020; // 44
	TH2F*                   hadr_dphi_deta_p2_2030; // 45
	TH2F*                   hadr_dphi_deta_p2_3040; // 46
	TH2F*                   hadr_dphi_deta_p2_4050; // 47
	
	TH2F*                   hadr_dphi_deta_p3_0510; // 48
	TH2F*                   hadr_dphi_deta_p3_1020; // 49
	TH2F*                   hadr_dphi_deta_p3_2030; // 50
	TH2F*                   hadr_dphi_deta_p3_3040; // 51
	TH2F*                   hadr_dphi_deta_p3_4050; // 52
	
	TH2F*                   hadr_cor_radius;        // 53
