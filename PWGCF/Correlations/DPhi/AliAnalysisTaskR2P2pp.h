#ifndef AliAnalysisTaskR2P2pp_H_Included
#define AliAnalysisTaskR2P2pp_H_Included
...
class AliAnalysisTaskR2P2pp : public AliAnalysisTaskSE
{
public:
    AliAnalysisTaskR2P2pp();
    AliAnalysisTaskR2P2pp(const TString & name);
 ...
 private:
    ...
    AliAnalysisTaskR2P2pp(const  AliAnalysisTaskR2P2pp&);
    const AliAnalysisTaskR2P2pp& operator=(const  AliAnalysisTaskR2P2pp&);
    
public:
    virtual ~AliAnalysisTaskR2P2pp();
...
*/
   ...
   //-------------------------------------------------------------------------
    ...
    ClassDef(AliAnalysisTaskR2P2pp,1)
}; 
