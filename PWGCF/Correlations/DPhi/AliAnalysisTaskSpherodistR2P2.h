#ifndef AliAnalysisTaskSpherodistR2P2_H_Included
#define AliAnalysisTaskSpherodistR2P2_H_Included
...
class AliAnalysisTaskSpherodistR2P2 : public AliAnalysisTaskSE
{
public:
    AliAnalysisTaskSpherodistR2P2();
    AliAnalysisTaskSpherodistR2P2(const TString & name);
...
private:
    ...
    AliAnalysisTaskSpherodistR2P2(const  AliAnalysisTaskSpherodistR2P2&);
    const AliAnalysisTaskSpherodistR2P2& operator=(const  AliAnalysisTaskSpherodistR2P2&);
    
public:
    virtual ~AliAnalysisTaskSpherodistR2P2();
    ...
    virtual     void    SetNchMin(int v)                    { _NchMin               = v; }
...
protected:
    ...
    ClassDef(AliAnalysisTaskSpherodistR2P2,1)
}; 
