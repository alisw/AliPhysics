 ...
 *
 */
#ifndef ALIANALYSISTASKEPCORRAA_H
#define ALIANALYSISTASKEPCORRAA_H
...
class AliAnalysisTaskEPCorrAA : public AliAnalysisTaskSE {
	public:
...
ClassDef(AliAnalysisTaskEPCorrAA, 1);
};
