#ifndef AliAnalysisTaskpxpy_H_Included
#define AliAnalysisTaskpxpy_H_Included
...
class AliAnalysisTaskpxpy : public AliAnalysisTaskSE
{
public:
  AliAnalysisTaskpxpy();  
  AliAnalysisTaskpxpy(const TString & name);
  
private:
  AliAnalysisTaskpxpy(const  AliAnalysisTaskpxpy&);
  const AliAnalysisTaskpxpy& operator=(const  AliAnalysisTaskpxpy&);

public:
  virtual ~AliAnalysisTaskpxpy();
...
protected:      
 ...
 //float * _phi_1;             //!
  ...
  ClassDef(AliAnalysisTaskpxpy,1)
}; 
