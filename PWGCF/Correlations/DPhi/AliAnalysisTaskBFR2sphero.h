#ifndef AliAnalysisTaskBFR2sphero_H_Included
#define AliAnalysisTaskBFR2sphero_H_Included
...
class AliAnalysisTaskBFR2sphero : public AliAnalysisTaskSE
{
public:
    AliAnalysisTaskBFR2sphero();
    AliAnalysisTaskBFR2sphero(const TString & name);
...
private:
    ...
    AliAnalysisTaskBFR2sphero(const  AliAnalysisTaskBFR2sphero&);
    const AliAnalysisTaskBFR2sphero& operator=(const  AliAnalysisTaskBFR2sphero&);
    
public:
    virtual ~AliAnalysisTaskBFR2sphero();
...
protected:
    ...
    ClassDef(AliAnalysisTaskBFR2sphero,1)
}; 
