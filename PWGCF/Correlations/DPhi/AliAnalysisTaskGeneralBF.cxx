...
#include "AliAnalysisTaskGeneralBF.h"
...
ClassImp(AliAnalysisTaskGeneralBF)

AliAnalysisTaskGeneralBF::AliAnalysisTaskGeneralBF()
: AliAnalysisTaskSE(),
fNSigmaPID( 2 ),
fNSigmaPID_veto( 2 ),
ptUpperLimit_1( 2.0 ),
...
AliAnalysisTaskGeneralBF::AliAnalysisTaskGeneralBF(const TString & name)
...
void AliAnalysisTaskGeneralBF::UserCreateOutputObjects()
{
  ...
  if (_useWeights)
  {
    ...
    {
      AliError("AliAnalysisTaskGeneralBF:: _weight_1 is a null pointer.");
      return;
    }
    if (!_sameFilter)
    {
  ...
  //cout<< "AliAnalysisTaskGeneralBF::CreateOutputObjects() DONE " << endl;
  
}

void  AliAnalysisTaskGeneralBF::createHistograms()
{
  AliInfo(" AliAnalysisTaskGeneralBF::createHistoHistograms() Creating Event Histos");
  TString name;
  ...
  AliInfo(" AliAnalysisTaskGeneralBF::createHistoHistograms() All Done");
}
//-----------------------//

void  AliAnalysisTaskGeneralBF::finalizeHistograms()
{
  
  AliInfo("AliAnalysisTaskGeneralBF::finalizeHistograms() starting");
  ...
  AliInfo("AliAnalysisTaskGeneralBF::finalizeHistograms()  Done ");
}
//--------------//
...
//     else    return;
    ...
    {
      AliError("AliAnalysisTaskGeneralBF::Exec(Option_t *option) iVertex<0 || iVertex>=_nBins_vertexZ ");
      return;
    }
    ...
    if ( fAnalysisType == "RealData" || fAnalysisType == "MCAODreco" )
    {
      ...
      for (int iTrack = 0; iTrack < _nTracks; iTrack++ )
      {
          ...
          //&& dedx >=  _dedxMin && dedx < _dedxMax)
        {
          ...
          {
            AliWarning(Form("AliAnalysisTaskGeneralBF::analyze(AliceEvent * event) Mismatched iPt: %d",iPt));
            continue;
          }
          ...
          {
            AliWarning("AliAnalysisTaskGeneralBF::analyze(AliceEvent * event) iZEtaPhiPt<0 || iZEtaPhiPt>=_nBins_zEtaPhiPt_1");
            continue;
          }
          ...
          else
          {
            ...
            if (k1>=arraySize)
            {
              AliError(Form("AliAnalysisTaskGeneralBF::analyze(AliceEvent * event) k1 >=arraySize; arraySize: %d",arraySize));
              return;
            }
          }
        }//if ( _requestedCharge_1 == charge )
      ...
      for (int iTrack = 0; iTrack < _nTracks; iTrack++ )
      {
          ...
          //&& dedx >=  _dedxMin && dedx < _dedxMax)
        {
          ...
          {
            AliWarning("AliAnalysisTaskGeneralBF::analyze(AliceEvent * event) iZEtaPhiPt<0 || iZEtaPhiPt>=_nBins_zEtaPhiPt_2");
            continue;
          }
  ...
  AliInfo("AliAnalysisTaskGeneralBF::UserExec()   -----------------Event Done ");
  PostData(1,_outputHistoList);
} // End of UserExec

void   AliAnalysisTaskGeneralBF::FinishTaskOutput()
{
  AliInfo("AliAnalysisTaskGeneralBF::FinishTaskOutput() Starting.");
  Printf("= 0 ====================================================================");
  finalizeHistograms();
  AliInfo("= 1 ====================================================================");
  PostData(1,_outputHistoList);
  AliInfo("= 2 ====================================================================");
  AliInfo("AliAnalysisTaskGeneralBF::FinishTaskOutput() Done.");
}

void   AliAnalysisTaskGeneralBF::Terminate(Option_t* /*option*/)
{
  AliInfo("AliAnalysisTaskGeneralBF::Terminate() Starting/Done.");
}


//Tools
//===================================================================================================
void  AliAnalysisTaskGeneralBF::fillHistoWithArray(TH1 * h, float * array, int size)
{
  int i, i1;
...
void  AliAnalysisTaskGeneralBF::fillHistoWithArray(TH2 * h, float * array, int size1, int size2)
{
  int i, i1;
  int j, j1;
  float v1, ev1, v2, ev2, sum, esum;
...
void  AliAnalysisTaskGeneralBF::fillHistoWithArray(TH3 * h, float * array, int size1, int size2, int size3)
{
  int i, i1;
  int j, j1;
  int k, k1;
...
void  AliAnalysisTaskGeneralBF::fillHistoWithArray(TH1 * h, double * array, int size)
{
  int i, i1;
...
void  AliAnalysisTaskGeneralBF::fillHistoWithArray(TH2 * h, double * array, int size1, int size2)
{
  int i, i1;
  int j, j1;
  double v1, ev1, v2, ev2, sum, esum;
...
void  AliAnalysisTaskGeneralBF::fillHistoWithArray(TH3 * h, double * array, int size1, int size2, int size3)
{
  int i, i1;
  int j, j1;
  int k, k1;
...
double *  AliAnalysisTaskGeneralBF::getDoubleArray(int size, double v)
{
...
//________________________________________________________________________
float *  AliAnalysisTaskGeneralBF::getFloatArray(int size, float v)
{
...
//________________________________________________________________________
void   AliAnalysisTaskGeneralBF::addToList(TH1 *h)
{
  if (_outputHistoList)
  {
...
void AliAnalysisTaskGeneralBF::CalculateNSigmas( AliVTrack * trk )   //defines data member fnsigmas
{
...
//____________________________________________________________________________________________________
void AliAnalysisTaskGeneralBF::CalculateTPCNSigmasElectron( AliVTrack * trk )   //defines data member fnsigmas
{
  // Compute nsigma for each hypthesis
  AliVParticle * inEvHMain = dynamic_cast < AliVParticle * > ( trk );
  // --- TPC
...
void AliAnalysisTaskGeneralBF::CheckTOF( AliVTrack * trk )     //check if the particle has TOF Matching
{
  //get the PIDResponse
...
//________________________________________________________________________________________________________________
Double_t AliAnalysisTaskGeneralBF::TOFBetaCalculation( AliVTrack * track ) const
{
  Double_t tofTime = 0;
...
//________________________________________________________________________________________________________________
Float_t AliAnalysisTaskGeneralBF::TPC_EventPlane(AliAODEvent *fAOD)
{
...
//________________________________________________________________________________________________________________
Bool_t AliAnalysisTaskGeneralBF::Is2015PileUpEvent()
{
