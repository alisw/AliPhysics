#ifndef AliAnalysisTaskR2P2multEff_H_Included
#define AliAnalysisTaskR2P2multEff_H_Included
...
class AliAnalysisTaskR2P2multEff : public AliAnalysisTaskSE
{
public:
    AliAnalysisTaskR2P2multEff();
    AliAnalysisTaskR2P2multEff(const TString & name);
...
private:
    ...
    AliAnalysisTaskR2P2multEff(const  AliAnalysisTaskR2P2multEff&);
    const AliAnalysisTaskR2P2multEff& operator=(const  AliAnalysisTaskR2P2multEff&);
    
public:
    virtual ~AliAnalysisTaskR2P2multEff();
...
protected:
    ...
    ClassDef(AliAnalysisTaskR2P2multEff,1)
}; 
