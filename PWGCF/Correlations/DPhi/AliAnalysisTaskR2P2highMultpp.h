#ifndef AliAnalysisTaskR2P2highMultpp_H_Included
#define AliAnalysisTaskR2P2highMultpp_H_Included
...
class AliAnalysisTaskR2P2highMultpp : public AliAnalysisTaskSE
{
public:
    AliAnalysisTaskR2P2highMultpp();
    AliAnalysisTaskR2P2highMultpp(const TString & name);
...
private:
    ...
    AliAnalysisTaskR2P2highMultpp(const  AliAnalysisTaskR2P2highMultpp&);
    const AliAnalysisTaskR2P2highMultpp& operator=(const  AliAnalysisTaskR2P2highMultpp&);
    
public:
    virtual ~AliAnalysisTaskR2P2highMultpp();
...
protected:
    ...
    ClassDef(AliAnalysisTaskR2P2highMultpp,1)
}; 
