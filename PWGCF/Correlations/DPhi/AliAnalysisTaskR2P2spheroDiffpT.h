#ifndef AliAnalysisTaskR2P2spheroDiffpT_H_Included
#define AliAnalysisTaskR2P2spheroDiffpT_H_Included
...
class AliAnalysisTaskR2P2spheroDiffpT : public AliAnalysisTaskSE
{
public:
    AliAnalysisTaskR2P2spheroDiffpT();
    AliAnalysisTaskR2P2spheroDiffpT(const TString & name);
...
private:
    ...
    AliAnalysisTaskR2P2spheroDiffpT(const  AliAnalysisTaskR2P2spheroDiffpT&);
    const AliAnalysisTaskR2P2spheroDiffpT& operator=(const  AliAnalysisTaskR2P2spheroDiffpT&);
    
public:
    virtual ~AliAnalysisTaskR2P2spheroDiffpT();
...
protected:
    ...
    ClassDef(AliAnalysisTaskR2P2spheroDiffpT,1)
}; 
