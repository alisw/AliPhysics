#ifndef AliAnalysisTaskR2P2wSphero_H_Included
#define AliAnalysisTaskR2P2wSphero_H_Included
...
class AliAnalysisTaskR2P2wSphero : public AliAnalysisTaskSE
{
public:
    AliAnalysisTaskR2P2wSphero();
    AliAnalysisTaskR2P2wSphero(const TString & name);
...
private:
    ...
    AliAnalysisTaskR2P2wSphero(const  AliAnalysisTaskR2P2wSphero&);
    const AliAnalysisTaskR2P2wSphero& operator=(const  AliAnalysisTaskR2P2wSphero&);
    
public:
    virtual ~AliAnalysisTaskR2P2wSphero();
    ...
    virtual     void    SetTSpherocity(double spherocityMin, double spherocityMax)
    {
        _spherocityMin = spherocityMin;
        _spherocityMax = spherocityMax;
    }
...
protected:
    ...
    double   _spherocityMin;
    double   _spherocityMax;
    ...
    ClassDef(AliAnalysisTaskR2P2wSphero,1)
}; 
