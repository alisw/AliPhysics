#ifndef AliAnalysisTaskR2P2multClassGen_H_Included
#define AliAnalysisTaskR2P2multClassGen_H_Included
...
class AliAnalysisTaskR2P2multClassGen : public AliAnalysisTaskSE
{
public:
    AliAnalysisTaskR2P2multClassGen();
    AliAnalysisTaskR2P2multClassGen(const TString & name);
...
private:
    ...
    AliAnalysisTaskR2P2multClassGen(const  AliAnalysisTaskR2P2multClassGen&);
    const AliAnalysisTaskR2P2multClassGen& operator=(const  AliAnalysisTaskR2P2multClassGen&);
    
public:
    virtual ~AliAnalysisTaskR2P2multClassGen();
...
protected:
    ...
    ClassDef(AliAnalysisTaskR2P2multClassGen,1)
}; 
