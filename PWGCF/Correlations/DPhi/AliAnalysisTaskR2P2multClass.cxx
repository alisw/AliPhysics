  ...
  if (_usePtEff)
    {
	  ...
	  for (iPt=0,iPt1=1; iPt<_nBins_pt_1; iPt++, iPt1++)
        ...
        {
	  AliError("AliAnalysisTaskR2P2multClassmultClass:: _hPtEff_1 is a null pointer.");
	  return;
        }
      if (!_sameFilter)
        {
	  if (_hPtEff_2)
	      ...
	      for (iPt=0,iPt1=1; iPt<_nBins_pt_2; iPt++, iPt1++)
		{
		  _correctionPtEff_2[iPt] = _hPtEff_2->GetBinContent(iPt1);
            ...
            {
	      AliError("AliAnalysisTaskR2P2multClassmultClass:: _hPtEff_2 is a null pointer.");
	      return;
            }
        }
    }
...
void  AliAnalysisTaskR2P2multClass::finalizeHistograms()
{
  ...
  AliInfo("AliAnalysisTaskR2P2multClass::finalizeHistograms() starting");
...
//Tools
//===================================================================================================
void  AliAnalysisTaskR2P2multClass::fillHistoWithArray(TH1 * h, float * array, int size)
{
  int i, i1;
...
void  AliAnalysisTaskR2P2multClass::fillHistoWithArray(TH2 * h, float * array, int size1, int size2)
{
  int i, i1;
  int j, j1;
  float v1, ev1, v2, ev2, sum, esum;
...
void  AliAnalysisTaskR2P2multClass::fillHistoWithArray(TH3 * h, float * array, int size1, int size2, int size3)
{
  int i, i1;
  int j, j1;
  int k, k1;
...
void  AliAnalysisTaskR2P2multClass::fillHistoWithArray(TH1 * h, double * array, int size)
{
  int i, i1;
...
void  AliAnalysisTaskR2P2multClass::fillHistoWithArray(TH2 * h, double * array, int size1, int size2)
{
  int i, i1;
  int j, j1;
  double v1, ev1, v2, ev2, sum, esum;
...
void  AliAnalysisTaskR2P2multClass::fillHistoWithArray(TH3 * h, double * array, int size1, int size2, int size3)
{
  int i, i1;
  int j, j1;
  int k, k1;
...
double *  AliAnalysisTaskR2P2multClass::getDoubleArray(int size, double v)
{
...
//________________________________________________________________________
float *  AliAnalysisTaskR2P2multClass::getFloatArray(int size, float v)
{
