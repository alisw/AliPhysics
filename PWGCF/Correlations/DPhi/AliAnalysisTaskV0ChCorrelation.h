 ...
 *
 * AliAnalysisTaskV0ChCorrelation class
 *
...
#ifndef AliAnalysisTaskV0ChCorrelation_H
#define AliAnalysisTaskV0ChCorrelation_H
...
class AliAnalysisTaskV0ChCorrelation : public AliAnalysisTaskSE {
public:
   AliAnalysisTaskV0ChCorrelation();//
   AliEventCuts *fEventCuts; /// Event cuts
   AliAnalysisTaskV0ChCorrelation(const char *name,
                                        Double_t centMin, Double_t centMax,
                                        Bool_t effCorr);
   virtual ~AliAnalysisTaskV0ChCorrelation();
  ...
  //-----------------------Variable----------------------------
   void SetVtxCut(Double_t value){fVtxCut = value;}
...
private:
   ...
   AliAnalysisTaskV0ChCorrelation(const AliAnalysisTaskV0ChCorrelation&);            //not implemented
   AliAnalysisTaskV0ChCorrelation& operator=(const AliAnalysisTaskV0ChCorrelation&); //not implemented 
  ...
  Int_t           fOStatus;   // checks for online and offline V0s 
   ...
   ClassDef(AliAnalysisTaskV0ChCorrelation, 1); 
};

class AliV0XiParticle : public AliVParticle
{
    public:
    
    AliV0XiParticle(Float_t eta, Float_t phi, Float_t pt, Short_t candidate, Int_t label,Int_t iDh)
    : fEta(eta), fPhi(phi), fPt(pt), fCandidate(candidate), fLabel(label), fIDh(iDh)
    {
    }
    AliV0XiParticle(Float_t eta, Float_t phi, Float_t pt, Short_t candidate, Int_t label,Int_t idpos, Int_t idneg, Double_t mass)
...
AliV0XiParticle(Float_t eta, Float_t phi, Float_t pt,Double_t mass)
  ...
  AliV0XiParticle(Double_t eta,Double_t phi,Double_t pt,  Double_t mass,Short_t candidate)
    :fEta(eta),fPhi(phi),fPt(pt), fMass(mass),fCandidate(candidate)
   {
    }

   virtual ~AliV0XiParticle() {}
   ...
   Int_t   MyLabel()             const { return fLabel; }
    ...
    Double_t GetMass()            const { return fMass; }
      ...
      ClassDef( AliV0XiParticle, 1) // class required for correlatios calculation and event mixing
 };
