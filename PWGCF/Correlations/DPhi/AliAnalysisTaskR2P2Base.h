#ifndef AliAnalysisTaskR2P2Base_H_Included
#define AliAnalysisTaskR2P2Base_H_Included
...
class AliAnalysisTaskR2P2Base : public AliAnalysisTaskSE
{
public:
    AliAnalysisTaskR2P2Base();
    AliAnalysisTaskR2P2Base(const TString & name);
...
private:
    ...
    AliAnalysisTaskR2P2Base(const  AliAnalysisTaskR2P2Base&);
    const AliAnalysisTaskR2P2Base& operator=(const  AliAnalysisTaskR2P2Base&);
    
public:
    virtual ~AliAnalysisTaskR2P2Base();
...
protected:
    ...
    ClassDef(AliAnalysisTaskR2P2Base,1)
}; 
