#ifndef AliAnalysisTaskR2P2CorrGen_H_Included
#define AliAnalysisTaskR2P2CorrGen_H_Included
...
class AliAnalysisTaskR2P2CorrGen : public AliAnalysisTaskSE
{
public:
    AliAnalysisTaskR2P2CorrGen();
    AliAnalysisTaskR2P2CorrGen(const TString & name);
...
private:
    ...
    AliAnalysisTaskR2P2CorrGen(const  AliAnalysisTaskR2P2CorrGen&);
    const AliAnalysisTaskR2P2CorrGen& operator=(const  AliAnalysisTaskR2P2CorrGen&);
    
public:
    virtual ~AliAnalysisTaskR2P2CorrGen();
...
protected:
    ...
    ClassDef(AliAnalysisTaskR2P2CorrGen,1)
}; 
