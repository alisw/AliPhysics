...
ClassImp(AliAnalysisTaskpzpz)

AliAnalysisTaskpzpz::AliAnalysisTaskpzpz()
: AliAnalysisTaskSE(),
fAODEvent(0), 
...
AliAnalysisTaskpzpz::AliAnalysisTaskpzpz(const TString & name)
...
void AliAnalysisTaskpzpz::UserCreateOutputObjects()
{
  OpenFile(0);
  ...
  if (_useWeights)
    ...
    if (_weight_1)
      ...
      {
      AliError("AliAnalysisTaskpzpz:: _weight_1 is a null pointer.");
      return;
      }
    if (!_sameFilter) 
      {
  ...
  //cout<< "AliAnalysisTaskpzpz::CreateOutputObjects() DONE " << endl;
  
}

void  AliAnalysisTaskpzpz::createHistograms()
{
  AliInfo(" AliAnalysisTaskpzpz::createHistoHistograms() Creating Event Histos");
  TString name;
  ...
  AliInfo(" AliAnalysisTaskpzpz::createHistoHistograms() All Done"); 
}
//-----------------------//

void  AliAnalysisTaskpzpz::finalizeHistograms()
{
  
  AliInfo("AliAnalysisTaskpzpz::finalizeHistograms() starting");
  ...
  AliInfo("AliAnalysisTaskpzpz::finalizeHistograms()  Done ");
}
//--------------//


void  AliAnalysisTaskpzpz::UserExec(Option_t */*option*/)
{
  ...
  if(fAODEvent)
    {
      ...
      if (centralityObject)
	{
	  //cout << "AliAnalysisTaskpzpz::UserExec(Option_t *option) - 6" << endl;
	...
	{
	  AliError("AliAnalysisTaskpzpz::Exec(Option_t *option) iVertex<0 || iVertex>=_nBins_vertexZ ");
	  return;
	}
      ...
      for (int iTrack=0; iTrack< _nTracks; iTrack++)
	{
	  ...
	  if( pz < _min_pt_1 || pz > _max_pt_1) continue; //condition on px and py
	  ...
	  if (_requestedCharge_1 == charge && dedx >=  _dedxMin && dedx < _dedxMax)
		...
		{
		  AliWarning("AliAnalysisTaskpzpz::analyze() iPhi<0 || iPhi>=_nBins_phi_1");
		  return;
		}
		...
		{
		  AliWarning(Form("AliAnalysisTaskpzpz::analyze(AliceEvent * event) Mismatched iEta: %d", iEta));
		  continue;
		}
	      iPt     = int((pt -_min_pt_1 )/_width_pt_1 ); 
	      if (iPt<0  || iPt >=_nBins_pt_1)
		{
		  AliWarning(Form("AliAnalysisTaskpzpz::analyze(AliceEvent * event) Mismatched iPt: %d",iPt));
		  continue;
		}
		...
		{
		  AliWarning("AliAnalysisTaskpzpz::analyze(AliceEvent * event) iZEtaPhiPt<0 || iZEtaPhiPt>=_nBins_zEtaPhiPt_1");
		  continue;
		}
	      ...
	      else
		{
		  ...
		  if (k1>=arraySize)
		    {
		      AliError(Form("AliAnalysisTaskpzpz::analyze(AliceEvent * event) k1 >=arraySize; arraySize: %d",arraySize));
		      return;
		    }
		}
	    }
	  ...
	  if (!_sameFilter && _requestedCharge_2 == charge && 
		...
		{
		  AliWarning("AliAnalysisTaskpzpz::analyze(AliceEvent * event) iZEtaPhiPt<0 || iZEtaPhiPt>=_nBins_zEtaPhiPt_2");
		  continue;
		}
	      ...
	      else
		{
		  ...
		  _iPt_2[k2]                  = iPt;            
		  _pt_2[k2]                   = pz; //pt is pz for particle 2             
		  _px_2[k2]                   = px;             
		  _py_2[k2]                   = py;             
		  _pz_2[k2]                   = pz;             
  ...
  AliInfo("AliAnalysisTaskpzpz::UserExec()   -----------------Event Done ");
  PostData(0,_outputHistoList);
  
}

void   AliAnalysisTaskpzpz::FinishTaskOutput()
{
  AliInfo("AliAnalysisTaskpzpz::FinishTaskOutput() Starting.");
  Printf("= 0 ====================================================================");
  finalizeHistograms();
  AliInfo("= 1 ====================================================================");
  PostData(0,_outputHistoList);
  AliInfo("= 2 ====================================================================");
  AliInfo("AliAnalysisTaskpzpz::FinishTaskOutput() Done.");
}

void   AliAnalysisTaskpzpz::Terminate(Option_t* /*option*/)
{
  AliInfo("AliAnalysisTaskpzpz::Terminate() Starting/Done.");
}


//Tools
//===================================================================================================
void  AliAnalysisTaskpzpz::fillHistoWithArray(TH1 * h, float * array, int size)
{
  int i, i1;
...
void  AliAnalysisTaskpzpz::fillHistoWithArray(TH2 * h, float * array, int size1, int size2)
{
  int i, i1;
  int j, j1;
  float v1, ev1, v2, ev2, sum, esum;
...
void  AliAnalysisTaskpzpz::fillHistoWithArray(TH3 * h, float * array, int size1, int size2, int size3)
{
  int i, i1;
  int j, j1;
  int k, k1;
...
void  AliAnalysisTaskpzpz::fillHistoWithArray(TH1 * h, double * array, int size)
{
  int i, i1;
...
void  AliAnalysisTaskpzpz::fillHistoWithArray(TH2 * h, double * array, int size1, int size2)
{
  int i, i1;
  int j, j1;
  double v1, ev1, v2, ev2, sum, esum;
...
void  AliAnalysisTaskpzpz::fillHistoWithArray(TH3 * h, double * array, int size1, int size2, int size3)
{
  int i, i1;
  int j, j1;
  int k, k1;
...
double *  AliAnalysisTaskpzpz::getDoubleArray(int size, double v)
{
...
//________________________________________________________________________
float *  AliAnalysisTaskpzpz::getFloatArray(int size, float v)
{
...
//________________________________________________________________________
TH1D * AliAnalysisTaskpzpz::createHisto1D(const TString &  name, const TString &  title, 
...
//________________________________________________________________________
TH2D * AliAnalysisTaskpzpz::createHisto2D(const TString &  name, const TString &  title, 
...
//// F /////
//________________________________________________________________________
TH1F * AliAnalysisTaskpzpz::createHisto1F(const TString &  name, const TString &  title, 
                                                        int n, double xMin, double xMax, 
                                                        const TString &  xTitle, const TString &  yTitle)
{
  //CreateHisto new 1D historgram
...
//________________________________________________________________________
TH2F * AliAnalysisTaskpzpz::createHisto2F(const TString &  name, const TString &  title, 
                                                        int nx, double xMin, double xMax, int ny, double yMin, double yMax, 
                                                        const TString &  xTitle, const TString &  yTitle, const TString &  zTitle)
{
  AliInfo(Form("createHisto 2D histo %s  nx: %d  xMin: %f10.4 xMax: %f10.4  ny: %d   yMin: %f10.4 yMax: %f10.4",name.Data(),nx,xMin,xMax,ny,yMin,yMax));
...
//________________________________________________________________________
TH3F * AliAnalysisTaskpzpz::createHisto3F(const TString &  name, const TString &  title, 
...
//________________________________________________________________________
TProfile * AliAnalysisTaskpzpz::createProfile(const TString & name, const TString & description, 
                                                            int nx,double xMin,double xMax,
                                                            const TString &  xTitle, const TString &  yTitle)
{
...
void   AliAnalysisTaskpzpz::addToList(TH1 *h)
{
  if (_outputHistoList)
    {
