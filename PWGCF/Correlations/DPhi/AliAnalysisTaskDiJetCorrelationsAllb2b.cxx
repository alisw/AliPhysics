...
void  AliAnalysisTaskDiJetCorrelationsAllb2b::UserExec(Option_t *) 
{
  ...
  for (Int_t iTracks = 0; iTracks < aod->GetNumberOfTracks(); iTracks++){
    ...
    fHistQA[8]->Fill(fAodTracks->Eta());
      ...
      //cout<<"adding faodtracks to array"<<endl;
