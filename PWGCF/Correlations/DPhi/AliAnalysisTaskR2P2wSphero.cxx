...
#include "AliAnalysisTaskR2P2wSphero.h"
...
ClassImp(AliAnalysisTaskR2P2wSphero)

AliAnalysisTaskR2P2wSphero::AliAnalysisTaskR2P2wSphero()
: AliAnalysisTaskSE(),
  fNSigmaPID( 2 ),
  fNSigmaPID_veto( 2 ),
  ptUpperLimit( 2.0 ),
...
AliAnalysisTaskR2P2wSphero::AliAnalysisTaskR2P2wSphero(const TString & name)
...
void AliAnalysisTaskR2P2wSphero::UserCreateOutputObjects()
{
   ...
   if ( fSystemType == "PbPb_2015_kTRUE" || fSystemType == "PbPb_2015_kFALSE" )
    ...
    if (_usePtEff)
    {
        ...
        {
            AliError("AliAnalysisTaskR2P2wSphero:: _hPtEff_1 is a null pointer.");
	        return;
        }
        ...
        if (!_sameFilter)
        {
            ...
            {
                AliError("AliAnalysisTaskR2P2wSphero:: _hPtEff_2 is a null pointer.");
	            return;
            }
    ...
    cout<< "AliAnalysisTaskR2P2wSphero::CreateOutputObjects() DONE " << endl;
  

} //void AliAnalysisTaskR2P2wSphero::UserCreateOutputObjects()


void  AliAnalysisTaskR2P2wSphero::createHistograms()
{
    AliInfo("AliAnalysisTaskR2P2wSphero::createHistoHistograms() Creating Event Histos");
    TString name;
  ...
  //--------------------------------------------------------------------
    ...
    AliInfo(" AliAnalysisTaskR2P2wSphero::createHistoHistograms() All Done");
}//void  AliAnalysisTaskR2P2wSphero::createHistograms()


void  AliAnalysisTaskR2P2wSphero::finalizeHistograms()
{
    AliInfo("\n\n\n\n\n\n AliAnalysisTaskR2P2wSphero::finalizeHistograms() starting");
    ...
    AliInfo("AliAnalysisTaskR2P2wSphero::finalizeHistograms()  Done ");

}//void  AliAnalysisTaskR2P2wSphero::finalizeHistograms()



void  AliAnalysisTaskR2P2wSphero::UserExec(Option_t */*option*/)
{
    ...
    if( fAODEvent )
    {
        ...
        {
            AliError("AliAnalysisTaskR2P2wSphero::Exec(Option_t *option) iVertex<0 || iVertex>=_nBins_vertexZ ");
                ...
                
                {
                    ...
                    for (int iTrack = 0; iTrack < _nTracks; iTrack++ )
                    {
                        ...
                        if ( _requestedCharge_1 == charge )
                        {
                            ...
                            {
                                AliWarning("AliAnalysisTaskR2P2wSphero::analyze() iPhi<0 || iPhi>=_nBins_phi_1");
                                return;
                            }
                            ...
                            {
                                AliWarning(Form("AliAnalysisTaskR2P2wSphero::analyze(AliceEvent * event) Mismatched iEta: %d", iEta));
                                continue;
                            }
                            ...
                            {
                                AliWarning(Form("AliAnalysisTaskR2P2wSphero::analyze(AliceEvent * event) Mismatched iPt: %d",iPt));
                                continue;
                            }
                            ...
                            {
                                AliWarning("AliAnalysisTaskR2P2wSphero::analyze(AliceEvent * event) iZEtaPhiPt<0 || iZEtaPhiPt>=_nBins_zEtaPhiPt_1");
                                continue;
                            }
                            ...
                            else
                            {
                                ...
                                if (k1>=arraySize)
                                {
                                    AliError(Form("AliAnalysisTaskR2P2wSphero::analyze(AliceEvent * event) k1 >=arraySize; arraySize: %d",arraySize));
                                    return;
                                }
                        ...
                        if ( !_sameFilter && _requestedCharge_2 == charge )//Particle 2
                        {
                            ...
                            {
                                AliWarning("AliAnalysisTaskR2P2wSphero::analyze(AliceEvent * event) iZEtaPhiPt<0 || iZEtaPhiPt>=_nBins_zEtaPhiPt_2");
                                continue;
                            }
    ...
    AliInfo("AliAnalysisTaskR2P2wSphero::UserExec()   -----------------Event Done ");
    PostData(1,_outputHistoList);
...
void   AliAnalysisTaskR2P2wSphero::FinishTaskOutput()
{
    AliInfo("AliAnalysisTaskR2P2wSphero::FinishTaskOutput() Starting.");
    Printf("= 0 ====================================================================");
    finalizeHistograms();
    AliInfo("= 1 ====================================================================");
    PostData(1,_outputHistoList);
    AliInfo("= 2 ====================================================================");
    AliInfo("AliAnalysisTaskR2P2wSphero::FinishTaskOutput() Done.");

}//void   AliAnalysisTaskR2P2wSphero::FinishTaskOutput()


void   AliAnalysisTaskR2P2wSphero::Terminate(Option_t* /*option*/)
{
  AliInfo("AliAnalysisTaskR2P2wSphero::Terminate() Starting/Done.");
}
...
void  AliAnalysisTaskR2P2wSphero::fillHistoWithArray(TH1 * h, float * array, int size)
{
  int i, i1;
...
void  AliAnalysisTaskR2P2wSphero::fillHistoWithArray(TH2 * h, float * array, int size1, int size2)
{
  int i, i1;
  int j, j1;
  float v1, ev1, v2, ev2, sum, esum;
...
void  AliAnalysisTaskR2P2wSphero::fillHistoWithArray(TH3 * h, float * array, int size1, int size2, int size3)
{
...
void  AliAnalysisTaskR2P2wSphero::fillHistoWithArray(TH1 * h, double * array, int size)
{
  int i, i1;
...
void  AliAnalysisTaskR2P2wSphero::fillHistoWithArray(TH2 * h, double * array, int size1, int size2)
{
  int i, i1;
  int j, j1;
  double v1, ev1, v2, ev2, sum, esum;
...
void  AliAnalysisTaskR2P2wSphero::fillHistoWithArray(TH3 * h, double * array, int size1, int size2, int size3)
{
  int i, i1;
  int j, j1;
  int k, k1;
...
double *  AliAnalysisTaskR2P2wSphero::getDoubleArray(int size, double v)
{
...
//________________________________________________________________________
float *  AliAnalysisTaskR2P2wSphero::getFloatArray(int size, float v)
{
...
//________________________________________________________________________
TH1D * AliAnalysisTaskR2P2wSphero::createHisto1D(const TString &  name, const TString &  title, int n, double xMin, double xMax, const TString &  xTitle, const TString &  yTitle)
{
...
//________________________________________________________________________
TH1D * AliAnalysisTaskR2P2wSphero::createHisto1D(const TString &  name, const TString &  title, int n, double * bins, const TString &  xTitle, const TString &  yTitle)
{
...
//________________________________________________________________________
TH2D * AliAnalysisTaskR2P2wSphero::createHisto2D(const TString &  name, const TString &  title, int nx, double xMin, double xMax, int ny, double yMin, double yMax, const TString &  xTitle, const TString &  yTitle, const TString &  zTitle)
{
...
//________________________________________________________________________
TH2D * AliAnalysisTaskR2P2wSphero::createHisto2D(const TString &  name, const TString &  title, int nx, double* xbins, int ny, double yMin, double yMax, const TString &  xTitle, const TString &  yTitle, const TString &  zTitle)
{
...
//// F /////
//________________________________________________________________________
TH1F * AliAnalysisTaskR2P2wSphero::createHisto1F(const TString &  name, const TString &  title, int n, double xMin, double xMax, const TString &  xTitle, const TString &  yTitle)
{
  //CreateHisto new 1D historgram
  AliInfo(Form("createHisto 1D histo %s   nBins: %d  xMin: %f   xMax: %f",name.Data(),n,xMin,xMax));
...
//________________________________________________________________________
TH1F * AliAnalysisTaskR2P2wSphero::createHisto1F(const TString &  name, const TString &  title, int n, double * bins, const TString &  xTitle, const TString &  yTitle)
{
  AliInfo(Form("createHisto 1D histo %s   with %d non uniform nBins",name.Data(),n));
...
//________________________________________________________________________
TH2F * AliAnalysisTaskR2P2wSphero::createHisto2F(const TString &  name, const TString &  title, int nx, double xMin, double xMax, int ny, double yMin, double yMax,const TString &  xTitle, const TString &  yTitle, const TString &  zTitle)
{
  AliInfo(Form("createHisto 2D histo %s  nx: %d  xMin: %f10.4 xMax: %f10.4  ny: %d   yMin: %f10.4 yMax: %f10.4",name.Data(),nx,xMin,xMax,ny,yMin,yMax));
...
//________________________________________________________________________
TH2F * AliAnalysisTaskR2P2wSphero::createHisto2F(const TString &  name, const TString &  title, int nx, double* xbins, int ny, double yMin, double yMax, const TString &  xTitle, const TString &  yTitle, const TString &  zTitle)
{
  AliInfo(Form("createHisto 2D histo %s   with %d non uniform nBins",name.Data(),nx));
  TH2F * h;
...
//________________________________________________________________________
TH3F * AliAnalysisTaskR2P2wSphero::createHisto3F(const TString &  name, const TString &  title, int nx, double xMin, double xMax, int ny, double yMin, double yMax, int nz, double zMin, double zMax, const TString &  xTitle, const TString &  yTitle, const TString &  zTitle)
{
...
//________________________________________________________________________
TProfile * AliAnalysisTaskR2P2wSphero::createProfile(const TString & name, const TString & description, int nx,double xMin,double xMax,const TString &  xTitle, const TString &  yTitle)
{
...
//________________________________________________________________________
TProfile * AliAnalysisTaskR2P2wSphero::createProfile(const TString &  name,const TString &  description, int nx,  double* bins,const TString &  xTitle, const TString &  yTitle)
{
...
void   AliAnalysisTaskR2P2wSphero::addToList(TH1 *h)
{
...
void AliAnalysisTaskR2P2wSphero::CalculateNSigmas( AliVTrack * trk )   //defines data member fnsigmas
{  
...
void AliAnalysisTaskR2P2wSphero::CalculateTPCNSigmasElectron( AliVTrack * trk )   //defines data member fnsigmas
{  
  // Compute nsigma for each hypthesis
  AliVParticle * inEvHMain = dynamic_cast < AliVParticle * > ( trk );
  // --- TPC
...
void AliAnalysisTaskR2P2wSphero::CheckTOF( AliVTrack * trk )     //check if the particle has TOF Matching
{ 
  //get the PIDResponse
...
Int_t AliAnalysisTaskR2P2wSphero::TellParticleSpecies( AliVTrack * trk )  //function to determine the particle ID
{  
...
Int_t AliAnalysisTaskR2P2wSphero::TellParticleSpecies_CircularCut( AliVTrack * trk )  //function to determine the particle ID
{  
  CalculateNSigmas( trk );
...
Int_t AliAnalysisTaskR2P2wSphero::TellParticleSpecies_by_P( AliVTrack * trk )  //function to determine the particle ID
{  
  CalculateNSigmas( trk );
...
//________________________________________________________________________________________________________________
Int_t AliAnalysisTaskR2P2wSphero::TellParticleSpecies_by_P_CircularCut( AliVTrack * trk )  //function to determine the particle ID
{  
  CalculateNSigmas( trk );
...
//________________________________________________________________________________________________________________
Double_t AliAnalysisTaskR2P2wSphero::TOFBetaCalculation( AliVTrack * track ) const
{
  Double_t tofTime = 0;
...
//________________________________________________________________________________________________________________
Double_t AliAnalysisTaskR2P2wSphero::massSquareCalculation( AliVTrack * track ) const
{
...
//________________________________________________________________________________________________________________
Float_t AliAnalysisTaskR2P2wSphero::TPC_EventPlane(AliAODEvent *fAOD)
{
...
//________________________________________________________________________________________________________________
Bool_t AliAnalysisTaskR2P2wSphero::Is2015PileUpEvent()
{
...
Bool_t AliAnalysisTaskR2P2wSphero::StoreEventMultiplicities(AliVEvent *event)
{  
...
//________________________________________________________________________________________________________________
Double_t AliAnalysisTaskR2P2wSphero::CalculateSharedFraction (const TBits *triggerClusterMap,const TBits *assocClusterMap,const TBits *triggerShareMap,const TBits *assocShareMap)
{
  Double_t nofhits=0;
