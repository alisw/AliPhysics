  ...
  if (_usePtEff)
    {
	  ...
	  for (iPt=0,iPt1=1; iPt<_nBins_pt_1; iPt++, iPt1++)
        ...
        {
	  AliError("AliAnalysisTaskR2P2multClassGenmultClass:: _hPtEff_1 is a null pointer.");
	  return;
        }
      if (!_sameFilter)
        {
	  if (_hPtEff_2)
	      ...
	      for (iPt=0,iPt1=1; iPt<_nBins_pt_2; iPt++, iPt1++)
		{
		  _correctionPtEff_2[iPt] = _hPtEff_2->GetBinContent(iPt1);
            ...
            {
	      AliError("AliAnalysisTaskR2P2multClassGenmultClass:: _hPtEff_2 is a null pointer.");
	      return;
            }
        }
    }
...
void  AliAnalysisTaskR2P2multClassGen::finalizeHistograms()
{
  ...
  AliInfo("AliAnalysisTaskR2P2multClassGen::finalizeHistograms() starting");
