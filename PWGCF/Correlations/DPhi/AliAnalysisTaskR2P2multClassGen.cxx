...
#include "AliAnalysisTaskR2P2multClassGen.h"
...
ClassImp(AliAnalysisTaskR2P2multClassGen)

AliAnalysisTaskR2P2multClassGen::AliAnalysisTaskR2P2multClassGen()
: AliAnalysisTaskSE(),
  fNSigmaPID( 2 ),
  fNSigmaPID_veto( 2 ),
  ptUpperLimit( 2.0 ),
...
AliAnalysisTaskR2P2multClassGen::AliAnalysisTaskR2P2multClassGen(const TString & name)
...
void AliAnalysisTaskR2P2multClassGen::UserCreateOutputObjects()
{
  ...
  if (_usePtEff)
    {
	  ...
	  for (iPt=0,iPt1=1; iPt<_nBins_pt_1; iPt++, iPt1++)
        ...
        {
	  AliError("AliAnalysisTaskR2P2multClassGen:: _hPtEff_1 is a null pointer.");
	  return;
        }
      if (!_sameFilter)
        {
	  if (_hPtEff_2)
	      ...
	      for (iPt=0,iPt1=1; iPt<_nBins_pt_2; iPt++, iPt1++)
		{
		  _correctionPtEff_2[iPt] = _hPtEff_2->GetBinContent(iPt1);
            ...
            {
	      AliError("AliAnalysisTaskR2P2multClassGen:: _hPtEff_2 is a null pointer.");
	      return;
            }
        }
    }
...
//-----------pt-efficiency ends------------
  ...
  if (_useWeights)
    {
	  ...
	  for (iZ=0,iZ1=1; iZ<_nBins_vertexZ; iZ++, iZ1++)
        ...
        {
	  AliError("AliAnalysisTaskR2P2multClassGen:: _weight_1 is a null pointer.");
	  return;
        }
      if (!_sameFilter)
        {
  ...
  cout<< "AliAnalysisTaskR2P2multClassGen::CreateOutputObjects() DONE " << endl;
  
}

void  AliAnalysisTaskR2P2multClassGen::createHistograms()
{
  //  cout << "\n\n\n\n\n\n AliAnalysisTaskR2P2multClassGen::createHistoHistograms()"<<endl;
  AliInfo("AliAnalysisTaskR2P2multClassGen::createHistoHistograms() Creating Event Histos");
  TString name;
  ...
  cout << "AliAnalysisTaskR2P2multClassGen::createHistoHistograms() All Done"<<endl;
  AliInfo(" AliAnalysisTaskR2P2multClassGen::createHistoHistograms() All Done");
}
//-----------------------//

void  AliAnalysisTaskR2P2multClassGen::finalizeHistograms()
{
  //  cout << "\n\n\n\n\n\n AliAnalysisTaskR2P2multClassGen::finalizeHistograms() starting"<<endl;
  AliInfo("\n\n\n\n\n\n AliAnalysisTaskR2P2multClassGen::finalizeHistograms() starting");
  ...
  cout << "AliAnalysisTaskR2P2multClassGen::finalizeHistograms()  Done "<<endl;
  AliInfo("AliAnalysisTaskR2P2multClassGen::finalizeHistograms()  Done ");
}
//--------------//


void  AliAnalysisTaskR2P2multClassGen::UserExec(Option_t */*option*/)
{
  ...
  if( fAODEvent )
      ...
      if ( fSystemType == "pp18_V0_kMB_kFALSE")
	{
      ...
      iVertexP2 = iVertex*_nBins_etaPhiPt_2;
        ...
        {
	  AliError("AliAnalysisTaskR2P2multClassGen::Exec(Option_t *option) iVertex<0 || iVertex>=_nBins_vertexZ ");
		  ...
		  if ( _singlesOnly )
			...
			//&& dedx >=  _dedxMin && dedx < _dedxMax)
			{
			  ...
			  if (iPhi<0 || iPhi>=_nBins_phi_1 )
			    {
			      AliWarning("AliAnalysisTaskR2P2multClassGen::analyze() iPhi<0 || iPhi>=_nBins_phi_1");
			      return;
			    }
			  ...
			  if (iEta<0 || iEta>=_nBins_eta_1)
			    {
			      AliWarning(Form("AliAnalysisTaskR2P2multClassGen::analyze(AliceEvent * event) Mismatched iEta: %d", iEta));
			      continue;
			    }
			  iPt     = int((pt -_min_pt_1 )/_width_pt_1 );
			  if (iPt<0  || iPt >=_nBins_pt_1)
			    {
			      AliWarning(Form("AliAnalysisTaskR2P2multClassGen::analyze(AliceEvent * event) Mismatched iPt: %d",iPt));
			      continue;
			    }
			  ...
			  if ( iZEtaPhiPt < 0 || iZEtaPhiPt >= _nBins_zEtaPhiPt_1 )
			    {
			      AliWarning("AliAnalysisTaskR2P2multClassGen::analyze(AliceEvent * event) iZEtaPhiPt<0 || iZEtaPhiPt>=_nBins_zEtaPhiPt_1");
			      continue;
			    }                
			  ...
			  if ( _singlesOnly )
			      ...
			      if ( fAnalysisType == "MCAODreco" ) // This block of code used to get PdgCode for MC reco tracks
				{
			      ...
			      if (k1>=arraySize)
				{
				  AliError(Form("AliAnalysisTaskR2P2multClassGen::analyze(AliceEvent * event) k1 >=arraySize; arraySize: %d",arraySize));
				  return;
				}
			    }
			}//if ( _requestedCharge_1 == charge )
			...
			//&& dedx >=  _dedxMin && dedx < _dedxMax)                
			{
			  ...
			  if (iZEtaPhiPt<0 || iZEtaPhiPt>=_nBins_zEtaPhiPt_2)
			    {
			      AliWarning("AliAnalysisTaskR2P2multClassGen::analyze(AliceEvent * event) iZEtaPhiPt<0 || iZEtaPhiPt>=_nBins_zEtaPhiPt_2");
			      continue;
			    }
  ...
  AliInfo("AliAnalysisTaskR2P2multClassGen::UserExec()   -----------------Event Done ");
  PostData(1,_outputHistoList);

  //  cout <<"AliAnalysisTaskR2P2multClassGen::UserExec()  Done "<<endl;
} // End of UserExec

void   AliAnalysisTaskR2P2multClassGen::FinishTaskOutput()
{
  AliInfo("AliAnalysisTaskR2P2multClassGen::FinishTaskOutput() Starting.");
  Printf("= 0 ====================================================================");
  finalizeHistograms();
  AliInfo("= 1 ====================================================================");
  PostData(1,_outputHistoList);
  AliInfo("= 2 ====================================================================");
  AliInfo("AliAnalysisTaskR2P2multClassGen::FinishTaskOutput() Done.");
}

void   AliAnalysisTaskR2P2multClassGen::Terminate(Option_t* /*option*/)
{
  AliInfo("AliAnalysisTaskR2P2multClassGen::Terminate() Starting/Done.");
}


//Tools
//===================================================================================================
void  AliAnalysisTaskR2P2multClassGen::fillHistoWithArray(TH1 * h, float * array, int size)
{
  int i, i1;
...
void  AliAnalysisTaskR2P2multClassGen::fillHistoWithArray(TH2 * h, float * array, int size1, int size2)
{
  int i, i1;
  int j, j1;
  float v1, ev1, v2, ev2, sum, esum;
...
void  AliAnalysisTaskR2P2multClassGen::fillHistoWithArray(TH3 * h, float * array, int size1, int size2, int size3)
{
  int i, i1;
  int j, j1;
  int k, k1;
...
void  AliAnalysisTaskR2P2multClassGen::fillHistoWithArray(TH1 * h, double * array, int size)
{
  int i, i1;
...
void  AliAnalysisTaskR2P2multClassGen::fillHistoWithArray(TH2 * h, double * array, int size1, int size2)
{
  int i, i1;
  int j, j1;
  double v1, ev1, v2, ev2, sum, esum;
...
void  AliAnalysisTaskR2P2multClassGen::fillHistoWithArray(TH3 * h, double * array, int size1, int size2, int size3)
{
  int i, i1;
  int j, j1;
  int k, k1;
...
double *  AliAnalysisTaskR2P2multClassGen::getDoubleArray(int size, double v)
{
...
//________________________________________________________________________
float *  AliAnalysisTaskR2P2multClassGen::getFloatArray(int size, float v)
{
...
//________________________________________________________________________
TH1D * AliAnalysisTaskR2P2multClassGen::createHisto1D(const TString &  name, const TString &  title, 
...
//________________________________________________________________________
TH2D * AliAnalysisTaskR2P2multClassGen::createHisto2D(const TString &  name, const TString &  title, 
...
//// F /////
//________________________________________________________________________
TH1F * AliAnalysisTaskR2P2multClassGen::createHisto1F(const TString &  name, const TString &  title, 
					  int n, double xMin, double xMax, 
					  const TString &  xTitle, const TString &  yTitle)
{
  //CreateHisto new 1D historgram
...
//________________________________________________________________________
TH2F * AliAnalysisTaskR2P2multClassGen::createHisto2F(const TString &  name, const TString &  title, 
					  int nx, double xMin, double xMax, int ny, double yMin, double yMax, 
					  const TString &  xTitle, const TString &  yTitle, const TString &  zTitle)
{
  AliInfo(Form("createHisto 2D histo %s  nx: %d  xMin: %f10.4 xMax: %f10.4  ny: %d   yMin: %f10.4 yMax: %f10.4",name.Data(),nx,xMin,xMax,ny,yMin,yMax));
...
//________________________________________________________________________
TH3F * AliAnalysisTaskR2P2multClassGen::createHisto3F(const TString &  name, const TString &  title, 
...
//________________________________________________________________________
TProfile * AliAnalysisTaskR2P2multClassGen::createProfile(const TString & name, const TString & description, 
					      int nx,double xMin,double xMax,
					      const TString &  xTitle, const TString &  yTitle)
{
...
//________________________________________________________________________
void   AliAnalysisTaskR2P2multClassGen::addToList(TH1 *h)
{
  if (_outputHistoList)
    {
...
void AliAnalysisTaskR2P2multClassGen::CalculateNSigmas( AliVTrack * trk )   //defines data member fnsigmas
{  
...
//____________________________________________________________________________________________________
void AliAnalysisTaskR2P2multClassGen::CalculateTPCNSigmasElectron( AliVTrack * trk )   //defines data member fnsigmas
{  
  // Compute nsigma for each hypthesis
  AliVParticle * inEvHMain = dynamic_cast < AliVParticle * > ( trk );
  // --- TPC
...
void AliAnalysisTaskR2P2multClassGen::CheckTOF( AliVTrack * trk )     //check if the particle has TOF Matching
{ 
  //get the PIDResponse
...
Int_t AliAnalysisTaskR2P2multClassGen::TellParticleSpecies( AliVTrack * trk )  //function to determine the particle ID
{  
...
//________________________________________________________________________________________________________________
Int_t AliAnalysisTaskR2P2multClassGen::TellParticleSpecies_CircularCut( AliVTrack * trk )  //function to determine the particle ID
{  
  CalculateNSigmas( trk );
...
//________________________________________________________________________________________________________________
Int_t AliAnalysisTaskR2P2multClassGen::TellParticleSpecies_by_P( AliVTrack * trk )  //function to determine the particle ID
{  
  CalculateNSigmas( trk );
...
//________________________________________________________________________________________________________________
Int_t AliAnalysisTaskR2P2multClassGen::TellParticleSpecies_by_P_CircularCut( AliVTrack * trk )  //function to determine the particle ID
{  
  CalculateNSigmas( trk );
...
//________________________________________________________________________________________________________________
Double_t AliAnalysisTaskR2P2multClassGen::TOFBetaCalculation( AliVTrack * track ) const
{
  Double_t tofTime = 0;
...
//________________________________________________________________________________________________________________
Double_t AliAnalysisTaskR2P2multClassGen::massSquareCalculation( AliVTrack * track ) const
{
...
//________________________________________________________________________________________________________________
Float_t AliAnalysisTaskR2P2multClassGen::TPC_EventPlane(AliAODEvent *fAOD)
{
...
//________________________________________________________________________________________________________________
Bool_t AliAnalysisTaskR2P2multClassGen::Is2015PileUpEvent()
{
...
//________________________________________________________________________________________________________________
Bool_t AliAnalysisTaskR2P2multClassGen::StoreEventMultiplicities(AliVEvent *event)
{  
...
//________________________________________________________________________________________________________________
Double_t AliAnalysisTaskR2P2multClassGen::CalculateSharedFraction (const TBits *triggerClusterMap,const TBits *assocClusterMap,const TBits *triggerShareMap,const TBits *assocShareMap)
{
  Double_t nofhits=0;
