...
class AliAnalysisTaskCorPIDTOFQA : public AliAnalysisTaskSE  
{
	...
	TH2F*                 m2_pt_pos_cut_with_trig_03;  // 15
	TH2F*                 m2_pt_neg_cut_with_trig_03;  // 16
	TH2F*                 m2_pt_pos_cut_with_trig_05;  // 17
	TH2F*                 m2_pt_neg_cut_with_trig_05;  // 18
	TH2F*                 m2_pt_pos_cut_with_trig_08;  // 19
	TH2F*                 m2_pt_neg_cut_with_trig_08;  // 20
	...
	TH1I*                 trig_03_per_event;           // 28
	TH1I*                 trig_05_per_event;           // 29
	TH1I*                 trig_08_per_event;           // 30
		
 	TH2F*                 trig_03_phi_pt_pos;          // 31
	TH2F*                 trig_03_phi_pt_neg;          // 32
 	TH2F*                 trig_05_phi_pt_pos;          // 33
	TH2F*                 trig_05_phi_pt_neg;          // 34
	TH2F*                 trig_08_phi_pt_pos;          // 35
	TH2F*                 trig_08_phi_pt_neg;          // 36
	...
	TH2F*                 deut_dphi_pt_pos_pos_03_T;   // 47
	TH2F*                 deut_dphi_pt_pos_neg_03_T;   // 48
	TH2F*                 deut_dphi_pt_neg_neg_03_T;   // 49
	TH2F*                 deut_dphi_pt_pos_pos_05_T;   // 50
	TH2F*                 deut_dphi_pt_pos_neg_05_T;   // 51
	TH2F*                 deut_dphi_pt_neg_neg_05_T;   // 52
	TH2F*                 deut_dphi_pt_pos_pos_08_T;   // 53
	TH2F*                 deut_dphi_pt_pos_neg_08_T;   // 54
	TH2F*                 deut_dphi_pt_neg_neg_08_T;   // 55

	TH2F*                 deut_dphi_pt_pos_pos_03_A;   // 56
	TH2F*                 deut_dphi_pt_pos_neg_03_A;   // 57
	TH2F*                 deut_dphi_pt_neg_neg_03_A;   // 58
	TH2F*                 deut_dphi_pt_pos_pos_05_A;   // 59
	TH2F*                 deut_dphi_pt_pos_neg_05_A;   // 60
	TH2F*                 deut_dphi_pt_neg_neg_05_A;   // 61
	TH2F*                 deut_dphi_pt_pos_pos_08_A;   // 62
	TH2F*                 deut_dphi_pt_pos_neg_08_A;   // 63
	TH2F*                 deut_dphi_pt_neg_neg_08_A;   // 64

	TH2F*                 deut_dphi_pt_pos_pos_03_B;   // 65
	TH2F*                 deut_dphi_pt_pos_neg_03_B;   // 66
	TH2F*                 deut_dphi_pt_neg_neg_03_B;   // 67
	TH2F*                 deut_dphi_pt_pos_pos_05_B;   // 68
	TH2F*                 deut_dphi_pt_pos_neg_05_B;   // 69
	TH2F*                 deut_dphi_pt_neg_neg_05_B;   // 70
	TH2F*                 deut_dphi_pt_pos_pos_08_B;   // 71
	TH2F*                 deut_dphi_pt_pos_neg_08_B;   // 72
