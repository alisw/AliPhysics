#ifndef AliAnalysisTaskR2P2highMult_H_Included
#define AliAnalysisTaskR2P2highMult_H_Included
...
class AliAnalysisTaskR2P2highMult : public AliAnalysisTaskSE
{
public:
    AliAnalysisTaskR2P2highMult();
    AliAnalysisTaskR2P2highMult(const TString & name);
...
private:
    ...
    AliAnalysisTaskR2P2highMult(const  AliAnalysisTaskR2P2highMult&);
    const AliAnalysisTaskR2P2highMult& operator=(const  AliAnalysisTaskR2P2highMult&);
    
public:
    virtual ~AliAnalysisTaskR2P2highMult();
...
protected:
    ...
    ClassDef(AliAnalysisTaskR2P2highMult,1)
}; 
