...
#include "AliAnalysisTaskBFR2sphero.h"
...
ClassImp(AliAnalysisTaskBFR2sphero)

AliAnalysisTaskBFR2sphero::AliAnalysisTaskBFR2sphero()
: AliAnalysisTaskSE(),
  fNSigmaPID( 2 ),
  fNSigmaPID_veto( 2 ),
  ptUpperLimit( 2.0 ),
...
AliAnalysisTaskBFR2sphero::AliAnalysisTaskBFR2sphero(const TString & name)
...
void AliAnalysisTaskBFR2sphero::UserCreateOutputObjects()
{
   ...
   if ( fSystemType == "PbPb_2015_kTRUE" || fSystemType == "PbPb_2015_kFALSE" )
    ...
    if (_usePtEff)
    {
        ...
        {
            AliError("AliAnalysisTaskBFR2sphero:: _hPtEff_1 is a null pointer.");
	        return;
        }
        ...
        if (!_sameFilter)
        {
            ...
            {
                AliError("AliAnalysisTaskBFR2sphero:: _hPtEff_2 is a null pointer.");
	            return;
            }
    ...
    cout<< "AliAnalysisTaskBFR2sphero::CreateOutputObjects() DONE " << endl;
  

} //void AliAnalysisTaskBFR2sphero::UserCreateOutputObjects()


void  AliAnalysisTaskBFR2sphero::createHistograms()
{
    AliInfo("AliAnalysisTaskBFR2sphero::createHistoHistograms() Creating Event Histos");
    TString name;
  ...
  //--------------------------------------------------------------------
    ...
    AliInfo(" AliAnalysisTaskBFR2sphero::createHistoHistograms() All Done");
}//void  AliAnalysisTaskBFR2sphero::createHistograms()


void  AliAnalysisTaskBFR2sphero::finalizeHistograms()
{
    AliInfo("\n\n\n\n\n\n AliAnalysisTaskBFR2sphero::finalizeHistograms() starting");
    ...
    AliInfo("AliAnalysisTaskBFR2sphero::finalizeHistograms()  Done ");

}//void  AliAnalysisTaskBFR2sphero::finalizeHistograms()



void  AliAnalysisTaskBFR2sphero::UserExec(Option_t */*option*/)
{
    ...
    if( fAODEvent )
    {
        ...
        {
            AliError("AliAnalysisTaskBFR2sphero::Exec(Option_t *option) iVertex<0 || iVertex>=_nBins_vertexZ ");
        ...
        if ( fSystemType == "pp18_V0_kMB_kFALSE")
        {
            ...
            {   
                ...
                if(nParts >= 2)
                {
                    for (int iTrack = 0; iTrack < _nTracks; iTrack++ )//Track loop 2
                    {   
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            //Analysis for "RealData" and "MCAODreco"
        
            if ( fAnalysisType == "RealData" || fAnalysisType == "MCAODreco" )

            {
                //if  ( spherocity < _spherocityMin ||  spherocity > _spherocityMax )  return;     
                if(spherocity >= _spherocityMin && spherocity <= _spherocityMax)
                {           
                if ( _useEventPlane )
                {
                ...
                for (int iTrack = 0; iTrack < _nTracks; iTrack++ )
                {
                    ...
                    if ( PIDparticle )
                    {
                        if( useAliHelperPID )
                        {
			                ...
			                if( ( pt >= _min_pt_1 ) && ( pt <= ptTOFlowerBoundary ) && ( nsigmaElectron < electronNSigmaVeto ) )    continue;
                        }
		            ...
		            if ( _requestedCharge_1 == charge )
                    {
                        ...
                        {
                            AliWarning("AliAnalysisTaskBFR2sphero::analyze() iPhi<0 || iPhi>=_nBins_phi_1");
			                return;
                        }
                        ...
                        {
                            AliWarning(Form("AliAnalysisTaskBFR2sphero::analyze(AliceEvent * event) Mismatched iEta: %d", iEta));
			                continue;
                        }
                        ...
                        {
                            AliWarning(Form("AliAnalysisTaskBFR2sphero::analyze(AliceEvent * event) Mismatched iPt: %d",iPt));
			                continue;
                        }
                        ...
                        {
                            AliWarning("AliAnalysisTaskBFR2sphero::analyze(AliceEvent * event) iZEtaPhiPt<0 || iZEtaPhiPt>=_nBins_zEtaPhiPt_1");
			                continue;
                        }
                        ...
                        else
                        {
                            ...
                            if (k1>=arraySize)
                            {
                                AliError(Form("AliAnalysisTaskBFR2sphero::analyze(AliceEvent * event) k1 >=arraySize; arraySize: %d",arraySize));
				                return;
                            }
                    ...
                    if ( !_sameFilter && _requestedCharge_2 == charge )//Particle 2
                    {
                        ...
                        {
                            AliWarning("AliAnalysisTaskBFR2sphero::analyze(AliceEvent * event) iZEtaPhiPt<0 || iZEtaPhiPt>=_nBins_zEtaPhiPt_2");
			                continue;
                        }
    ...
    AliInfo("AliAnalysisTaskBFR2sphero::UserExec()   -----------------Event Done ");
    PostData(1,_outputHistoList);
...
void   AliAnalysisTaskBFR2sphero::FinishTaskOutput()
{
    AliInfo("AliAnalysisTaskBFR2sphero::FinishTaskOutput() Starting.");
    Printf("= 0 ====================================================================");
    finalizeHistograms();
    AliInfo("= 1 ====================================================================");
    PostData(1,_outputHistoList);
    AliInfo("= 2 ====================================================================");
    AliInfo("AliAnalysisTaskBFR2sphero::FinishTaskOutput() Done.");

}//void   AliAnalysisTaskBFR2sphero::FinishTaskOutput()


void   AliAnalysisTaskBFR2sphero::Terminate(Option_t* /*option*/)
{
  AliInfo("AliAnalysisTaskBFR2sphero::Terminate() Starting/Done.");
}
...
void  AliAnalysisTaskBFR2sphero::fillHistoWithArray(TH1 * h, float * array, int size)
{
  int i, i1;
...
void  AliAnalysisTaskBFR2sphero::fillHistoWithArray(TH2 * h, float * array, int size1, int size2)
{
  int i, i1;
  int j, j1;
  float v1, ev1, v2, ev2, sum, esum;
...
void  AliAnalysisTaskBFR2sphero::fillHistoWithArray(TH3 * h, float * array, int size1, int size2, int size3)
{
...
void  AliAnalysisTaskBFR2sphero::fillHistoWithArray(TH1 * h, double * array, int size)
{
  int i, i1;
...
void  AliAnalysisTaskBFR2sphero::fillHistoWithArray(TH2 * h, double * array, int size1, int size2)
{
  int i, i1;
  int j, j1;
  double v1, ev1, v2, ev2, sum, esum;
...
void  AliAnalysisTaskBFR2sphero::fillHistoWithArray(TH3 * h, double * array, int size1, int size2, int size3)
{
  int i, i1;
  int j, j1;
  int k, k1;
...
double *  AliAnalysisTaskBFR2sphero::getDoubleArray(int size, double v)
{
...
//________________________________________________________________________
float *  AliAnalysisTaskBFR2sphero::getFloatArray(int size, float v)
{
...
//________________________________________________________________________
TH1D * AliAnalysisTaskBFR2sphero::createHisto1D(const TString &  name, const TString &  title, int n, double xMin, double xMax, const TString &  xTitle, const TString &  yTitle)
{
...
//________________________________________________________________________
TH1D * AliAnalysisTaskBFR2sphero::createHisto1D(const TString &  name, const TString &  title, int n, double * bins, const TString &  xTitle, const TString &  yTitle)
{
...
//________________________________________________________________________
TH2D * AliAnalysisTaskBFR2sphero::createHisto2D(const TString &  name, const TString &  title, int nx, double xMin, double xMax, int ny, double yMin, double yMax, const TString &  xTitle, const TString &  yTitle, const TString &  zTitle)
{
...
//________________________________________________________________________
TH2D * AliAnalysisTaskBFR2sphero::createHisto2D(const TString &  name, const TString &  title, int nx, double* xbins, int ny, double yMin, double yMax, const TString &  xTitle, const TString &  yTitle, const TString &  zTitle)
{
...
//// F /////
//________________________________________________________________________
TH1F * AliAnalysisTaskBFR2sphero::createHisto1F(const TString &  name, const TString &  title, int n, double xMin, double xMax, const TString &  xTitle, const TString &  yTitle)
{
  //CreateHisto new 1D historgram
  AliInfo(Form("createHisto 1D histo %s   nBins: %d  xMin: %f   xMax: %f",name.Data(),n,xMin,xMax));
...
//________________________________________________________________________
TH1F * AliAnalysisTaskBFR2sphero::createHisto1F(const TString &  name, const TString &  title, int n, double * bins, const TString &  xTitle, const TString &  yTitle)
{
  AliInfo(Form("createHisto 1D histo %s   with %d non uniform nBins",name.Data(),n));
...
//________________________________________________________________________
TH2F * AliAnalysisTaskBFR2sphero::createHisto2F(const TString &  name, const TString &  title, int nx, double xMin, double xMax, int ny, double yMin, double yMax,const TString &  xTitle, const TString &  yTitle, const TString &  zTitle)
{
  AliInfo(Form("createHisto 2D histo %s  nx: %d  xMin: %f10.4 xMax: %f10.4  ny: %d   yMin: %f10.4 yMax: %f10.4",name.Data(),nx,xMin,xMax,ny,yMin,yMax));
...
//________________________________________________________________________
TH2F * AliAnalysisTaskBFR2sphero::createHisto2F(const TString &  name, const TString &  title, int nx, double* xbins, int ny, double yMin, double yMax, const TString &  xTitle, const TString &  yTitle, const TString &  zTitle)
{
  AliInfo(Form("createHisto 2D histo %s   with %d non uniform nBins",name.Data(),nx));
  TH2F * h;
...
//________________________________________________________________________
TH3F * AliAnalysisTaskBFR2sphero::createHisto3F(const TString &  name, const TString &  title, int nx, double xMin, double xMax, int ny, double yMin, double yMax, int nz, double zMin, double zMax, const TString &  xTitle, const TString &  yTitle, const TString &  zTitle)
{
...
//________________________________________________________________________
TProfile * AliAnalysisTaskBFR2sphero::createProfile(const TString & name, const TString & description, int nx,double xMin,double xMax,const TString &  xTitle, const TString &  yTitle)
{
...
//________________________________________________________________________
TProfile * AliAnalysisTaskBFR2sphero::createProfile(const TString &  name,const TString &  description, int nx,  double* bins,const TString &  xTitle, const TString &  yTitle)
{
...
void   AliAnalysisTaskBFR2sphero::addToList(TH1 *h)
{
...
void AliAnalysisTaskBFR2sphero::CalculateNSigmas( AliVTrack * trk )   //defines data member fnsigmas
{  
...
void AliAnalysisTaskBFR2sphero::CalculateTPCNSigmasElectron( AliVTrack * trk )   //defines data member fnsigmas
{  
  // Compute nsigma for each hypthesis
  AliVParticle * inEvHMain = dynamic_cast < AliVParticle * > ( trk );
  // --- TPC
...
void AliAnalysisTaskBFR2sphero::CheckTOF( AliVTrack * trk )     //check if the particle has TOF Matching
{ 
  //get the PIDResponse
...
Int_t AliAnalysisTaskBFR2sphero::TellParticleSpecies( AliVTrack * trk )  //function to determine the particle ID
{  
...
Int_t AliAnalysisTaskBFR2sphero::TellParticleSpecies_CircularCut( AliVTrack * trk )  //function to determine the particle ID
{  
  CalculateNSigmas( trk );
...
Int_t AliAnalysisTaskBFR2sphero::TellParticleSpecies_by_P( AliVTrack * trk )  //function to determine the particle ID
{  
  CalculateNSigmas( trk );
...
//________________________________________________________________________________________________________________
Int_t AliAnalysisTaskBFR2sphero::TellParticleSpecies_by_P_CircularCut( AliVTrack * trk )  //function to determine the particle ID
{  
  CalculateNSigmas( trk );
...
//________________________________________________________________________________________________________________
Double_t AliAnalysisTaskBFR2sphero::TOFBetaCalculation( AliVTrack * track ) const
{
  Double_t tofTime = 0;
...
//________________________________________________________________________________________________________________
Double_t AliAnalysisTaskBFR2sphero::massSquareCalculation( AliVTrack * track ) const
{
...
//________________________________________________________________________________________________________________
Float_t AliAnalysisTaskBFR2sphero::TPC_EventPlane(AliAODEvent *fAOD)
{
...
//________________________________________________________________________________________________________________
Bool_t AliAnalysisTaskBFR2sphero::Is2015PileUpEvent()
{
...
Bool_t AliAnalysisTaskBFR2sphero::StoreEventMultiplicities(AliVEvent *event)
{  
...
//________________________________________________________________________________________________________________
Double_t AliAnalysisTaskBFR2sphero::CalculateSharedFraction (const TBits *triggerClusterMap,const TBits *assocClusterMap,const TBits *triggerShareMap,const TBits *assocShareMap)
{
  Double_t nofhits=0;
