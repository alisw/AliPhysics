#ifndef AliAnalysisTaskR2P2_H_Included
#define AliAnalysisTaskR2P2_H_Included
...
class AliAnalysisTaskR2P2 : public AliAnalysisTaskSE
{
public:
    AliAnalysisTaskR2P2();
    AliAnalysisTaskR2P2(const TString & name);
 ...
 private:
    ...
    AliAnalysisTaskR2P2(const  AliAnalysisTaskR2P2&);
    const AliAnalysisTaskR2P2& operator=(const  AliAnalysisTaskR2P2&);
    
public:
    virtual ~AliAnalysisTaskR2P2();
...
*/
   ...
   //-------------------------------------------------------------------------
    ...
    ClassDef(AliAnalysisTaskR2P2,1)
}; 
