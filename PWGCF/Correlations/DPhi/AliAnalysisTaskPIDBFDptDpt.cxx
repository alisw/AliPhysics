...
void AliAnalysisTaskPIDBFDptDpt::UserCreateOutputObjects()
{
    ...
    _outputHistoList->Add( fHelperPID->GetOutputList()); // add AliHelperPID object output list to task output list
...
void  AliAnalysisTaskPIDBFDptDpt::UserExec(Option_t */*option*/)
{
    ...
    if(fAODEvent)
    {
     ...
     if ( fAnalysisType == "RealData" )
      ...
      } //end of "if ( fAnalysisType == "RealData" )"
	...
	_nTracks = mcEvent -> GetNumberOfTracks();
     ...
     if ( fAnalysisType == "MCAODreco" )
      ...
      } //end of "if ( fAnalysisType == "MCAODreco" )"
