...
ClassImp(AliAnalysisTaskBFR2)

AliAnalysisTaskBFR2::AliAnalysisTaskBFR2()
: AliAnalysisTaskSE(),
  fNSigmaPID( 2 ),
  fNSigmaPID_veto( 2 ),
  ptUpperLimit( 2.0 ),
...
AliAnalysisTaskBFR2::AliAnalysisTaskBFR2(const TString & name)
...
void AliAnalysisTaskBFR2::UserCreateOutputObjects()
{
   ...
   if ( fSystemType == "PbPb_2015_kTRUE" || fSystemType == "PbPb_2015_kFALSE" )
    ...
    if (_usePtEff)
    {
        ...
        {
            AliError("AliAnalysisTaskBFR2:: _hPtEff_1 is a null pointer.");
	        return;
        }
        ...
        if (!_sameFilter)
        {
            ...
            {
                AliError("AliAnalysisTaskBFR2:: _hPtEff_2 is a null pointer.");
	            return;
            }
    ...
    cout<< "AliAnalysisTaskBFR2::CreateOutputObjects() DONE " << endl;
  

} //void AliAnalysisTaskBFR2::UserCreateOutputObjects()


void  AliAnalysisTaskBFR2::createHistograms()
{
    AliInfo("AliAnalysisTaskBFR2::createHistoHistograms() Creating Event Histos");
    TString name;
  ...
  //--------------------------------------------------------------------
    ...
    AliInfo(" AliAnalysisTaskBFR2::createHistoHistograms() All Done");
}//void  AliAnalysisTaskBFR2::createHistograms()


void  AliAnalysisTaskBFR2::finalizeHistograms()
{
    AliInfo("\n\n\n\n\n\n AliAnalysisTaskBFR2::finalizeHistograms() starting");
    ...
    AliInfo("AliAnalysisTaskBFR2::finalizeHistograms()  Done ");

}//void  AliAnalysisTaskBFR2::finalizeHistograms()



void  AliAnalysisTaskBFR2::UserExec(Option_t */*option*/)
{
    ...
    if( fAODEvent )
    {
        ...
        {
            AliError("AliAnalysisTaskBFR2::Exec(Option_t *option) iVertex<0 || iVertex>=_nBins_vertexZ ");
...

            {
                ...
                for (int iTrack = 0; iTrack < _nTracks; iTrack++ )
                {
		            ...
		            if ( _requestedCharge_1 == charge )
                    {
                        ...
                        {
                            AliWarning("AliAnalysisTaskBFR2::analyze() iPhi<0 || iPhi>=_nBins_phi_1");
			                return;
                        }
                        ...
                        {
                            AliWarning(Form("AliAnalysisTaskBFR2::analyze(AliceEvent * event) Mismatched iEta: %d", iEta));
			                continue;
                        }
                        ...
                        {
                            AliWarning(Form("AliAnalysisTaskBFR2::analyze(AliceEvent * event) Mismatched iPt: %d",iPt));
			                continue;
                        }
                        ...
                        {
                            AliWarning("AliAnalysisTaskBFR2::analyze(AliceEvent * event) iZEtaPhiPt<0 || iZEtaPhiPt>=_nBins_zEtaPhiPt_1");
			                continue;
                        }
                        ...
                        else
                        {
                            ...
                            if (k1>=arraySize)
                            {
                                AliError(Form("AliAnalysisTaskBFR2::analyze(AliceEvent * event) k1 >=arraySize; arraySize: %d",arraySize));
				                return;
                            }
                    ...
                    if ( !_sameFilter && _requestedCharge_2 == charge )//Particle 2
                    {
                        ...
                        {
                            AliWarning("AliAnalysisTaskBFR2::analyze(AliceEvent * event) iZEtaPhiPt<0 || iZEtaPhiPt>=_nBins_zEtaPhiPt_2");
			                continue;
                        }
    ...
    AliInfo("AliAnalysisTaskBFR2::UserExec()   -----------------Event Done ");
    PostData(1,_outputHistoList);
...
void   AliAnalysisTaskBFR2::FinishTaskOutput()
{
    AliInfo("AliAnalysisTaskBFR2::FinishTaskOutput() Starting.");
    Printf("= 0 ====================================================================");
    finalizeHistograms();
    AliInfo("= 1 ====================================================================");
    PostData(1,_outputHistoList);
    AliInfo("= 2 ====================================================================");
    AliInfo("AliAnalysisTaskBFR2::FinishTaskOutput() Done.");

}//void   AliAnalysisTaskBFR2::FinishTaskOutput()


void   AliAnalysisTaskBFR2::Terminate(Option_t* /*option*/)
{
  AliInfo("AliAnalysisTaskBFR2::Terminate() Starting/Done.");
}
...
void  AliAnalysisTaskBFR2::fillHistoWithArray(TH1 * h, float * array, int size)
{
  int i, i1;
...
void  AliAnalysisTaskBFR2::fillHistoWithArray(TH2 * h, float * array, int size1, int size2)
{
  int i, i1;
  int j, j1;
  float v1, ev1, v2, ev2, sum, esum;
...
void  AliAnalysisTaskBFR2::fillHistoWithArray(TH3 * h, float * array, int size1, int size2, int size3)
{
...
void  AliAnalysisTaskBFR2::fillHistoWithArray(TH1 * h, double * array, int size)
{
  int i, i1;
...
void  AliAnalysisTaskBFR2::fillHistoWithArray(TH2 * h, double * array, int size1, int size2)
{
  int i, i1;
  int j, j1;
  double v1, ev1, v2, ev2, sum, esum;
...
void  AliAnalysisTaskBFR2::fillHistoWithArray(TH3 * h, double * array, int size1, int size2, int size3)
{
  int i, i1;
  int j, j1;
  int k, k1;
...
double *  AliAnalysisTaskBFR2::getDoubleArray(int size, double v)
{
...
//________________________________________________________________________
float *  AliAnalysisTaskBFR2::getFloatArray(int size, float v)
{
...
//________________________________________________________________________
TH1D * AliAnalysisTaskBFR2::createHisto1D(const TString &  name, const TString &  title, int n, double xMin, double xMax, const TString &  xTitle, const TString &  yTitle)
{
...
//________________________________________________________________________
TH1D * AliAnalysisTaskBFR2::createHisto1D(const TString &  name, const TString &  title, int n, double * bins, const TString &  xTitle, const TString &  yTitle)
{
...
//________________________________________________________________________
TH2D * AliAnalysisTaskBFR2::createHisto2D(const TString &  name, const TString &  title, int nx, double xMin, double xMax, int ny, double yMin, double yMax, const TString &  xTitle, const TString &  yTitle, const TString &  zTitle)
{
...
//________________________________________________________________________
TH2D * AliAnalysisTaskBFR2::createHisto2D(const TString &  name, const TString &  title, int nx, double* xbins, int ny, double yMin, double yMax, const TString &  xTitle, const TString &  yTitle, const TString &  zTitle)
{
...
//// F /////
//________________________________________________________________________
TH1F * AliAnalysisTaskBFR2::createHisto1F(const TString &  name, const TString &  title, int n, double xMin, double xMax, const TString &  xTitle, const TString &  yTitle)
{
  //CreateHisto new 1D historgram
  AliInfo(Form("createHisto 1D histo %s   nBins: %d  xMin: %f   xMax: %f",name.Data(),n,xMin,xMax));
...
//________________________________________________________________________
TH1F * AliAnalysisTaskBFR2::createHisto1F(const TString &  name, const TString &  title, int n, double * bins, const TString &  xTitle, const TString &  yTitle)
{
  AliInfo(Form("createHisto 1D histo %s   with %d non uniform nBins",name.Data(),n));
...
//________________________________________________________________________
TH2F * AliAnalysisTaskBFR2::createHisto2F(const TString &  name, const TString &  title, int nx, double xMin, double xMax, int ny, double yMin, double yMax,const TString &  xTitle, const TString &  yTitle, const TString &  zTitle)
{
  AliInfo(Form("createHisto 2D histo %s  nx: %d  xMin: %f10.4 xMax: %f10.4  ny: %d   yMin: %f10.4 yMax: %f10.4",name.Data(),nx,xMin,xMax,ny,yMin,yMax));
...
//________________________________________________________________________
TH2F * AliAnalysisTaskBFR2::createHisto2F(const TString &  name, const TString &  title, int nx, double* xbins, int ny, double yMin, double yMax, const TString &  xTitle, const TString &  yTitle, const TString &  zTitle)
{
  AliInfo(Form("createHisto 2D histo %s   with %d non uniform nBins",name.Data(),nx));
  TH2F * h;
...
//________________________________________________________________________
TH3F * AliAnalysisTaskBFR2::createHisto3F(const TString &  name, const TString &  title, int nx, double xMin, double xMax, int ny, double yMin, double yMax, int nz, double zMin, double zMax, const TString &  xTitle, const TString &  yTitle, const TString &  zTitle)
{
...
//________________________________________________________________________
TProfile * AliAnalysisTaskBFR2::createProfile(const TString & name, const TString & description, int nx,double xMin,double xMax,const TString &  xTitle, const TString &  yTitle)
{
...
//________________________________________________________________________
TProfile * AliAnalysisTaskBFR2::createProfile(const TString &  name,const TString &  description, int nx,  double* bins,const TString &  xTitle, const TString &  yTitle)
{
...
void   AliAnalysisTaskBFR2::addToList(TH1 *h)
{
...
void AliAnalysisTaskBFR2::CalculateNSigmas( AliVTrack * trk )   //defines data member fnsigmas
{  
...
void AliAnalysisTaskBFR2::CalculateTPCNSigmasElectron( AliVTrack * trk )   //defines data member fnsigmas
{  
  // Compute nsigma for each hypthesis
  AliVParticle * inEvHMain = dynamic_cast < AliVParticle * > ( trk );
  // --- TPC
...
void AliAnalysisTaskBFR2::CheckTOF( AliVTrack * trk )     //check if the particle has TOF Matching
{ 
  //get the PIDResponse
...
Int_t AliAnalysisTaskBFR2::TellParticleSpecies( AliVTrack * trk )  //function to determine the particle ID
{  
...
Int_t AliAnalysisTaskBFR2::TellParticleSpecies_CircularCut( AliVTrack * trk )  //function to determine the particle ID
{  
  CalculateNSigmas( trk );
...
Int_t AliAnalysisTaskBFR2::TellParticleSpecies_by_P( AliVTrack * trk )  //function to determine the particle ID
{  
  CalculateNSigmas( trk );
...
//________________________________________________________________________________________________________________
Int_t AliAnalysisTaskBFR2::TellParticleSpecies_by_P_CircularCut( AliVTrack * trk )  //function to determine the particle ID
{  
  CalculateNSigmas( trk );
...
//________________________________________________________________________________________________________________
Double_t AliAnalysisTaskBFR2::TOFBetaCalculation( AliVTrack * track ) const
{
  Double_t tofTime = 0;
...
//________________________________________________________________________________________________________________
Double_t AliAnalysisTaskBFR2::massSquareCalculation( AliVTrack * track ) const
{
...
//________________________________________________________________________________________________________________
Float_t AliAnalysisTaskBFR2::TPC_EventPlane(AliAODEvent *fAOD)
{
...
//________________________________________________________________________________________________________________
Bool_t AliAnalysisTaskBFR2::Is2015PileUpEvent()
{
...
Bool_t AliAnalysisTaskBFR2::StoreEventMultiplicities(AliVEvent *event)
{  
...
//________________________________________________________________________________________________________________
Double_t AliAnalysisTaskBFR2::CalculateSharedFraction (const TBits *triggerClusterMap,const TBits *assocClusterMap,const TBits *triggerShareMap,const TBits *assocShareMap)
{
  Double_t nofhits=0;
