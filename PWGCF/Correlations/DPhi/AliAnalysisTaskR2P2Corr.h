#ifndef AliAnalysisTaskR2P2Corr_H_Included
#define AliAnalysisTaskR2P2Corr_H_Included
...
class AliAnalysisTaskR2P2Corr : public AliAnalysisTaskSE
{
public:
    AliAnalysisTaskR2P2Corr();
    AliAnalysisTaskR2P2Corr(const TString & name);
...
private:
    ...
    AliAnalysisTaskR2P2Corr(const  AliAnalysisTaskR2P2Corr&);
    const AliAnalysisTaskR2P2Corr& operator=(const  AliAnalysisTaskR2P2Corr&);
    
public:
    virtual ~AliAnalysisTaskR2P2Corr();
...
protected:
    ...
    ClassDef(AliAnalysisTaskR2P2Corr,1)
}; 
