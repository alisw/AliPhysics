#ifndef AlianalysisTaskDptPID_H_Included
#define AlianalysisTaskDptPID_H_Included
...
class AlianalysisTaskDptPID : public AliAnalysisTaskSE
{
public:
  AlianalysisTaskDptPID();  
  AlianalysisTaskDptPID(const TString & name);
  
private:
  AlianalysisTaskDptPID(const  AlianalysisTaskDptPID&);
  const AlianalysisTaskDptPID& operator=(const  AlianalysisTaskDptPID&);

public:
  virtual ~AlianalysisTaskDptPID();
...
protected:      
 ...
 //float * _phi_1;             //!
  ...
  ClassDef(AlianalysisTaskDptPID,1)
}; 
