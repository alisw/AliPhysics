#ifndef AliAnalysisTaskGeneralBF_H_Included
#define AliAnalysisTaskGeneralBF_H_Included
...
class AliAnalysisTaskGeneralBF : public AliAnalysisTaskSE
{
public:
  AliAnalysisTaskGeneralBF();
  AliAnalysisTaskGeneralBF(const TString & name);
...
private:
  ...
  AliAnalysisTaskGeneralBF(const  AliAnalysisTaskGeneralBF&);
  const AliAnalysisTaskGeneralBF& operator=(const  AliAnalysisTaskGeneralBF&);
  
public:
  virtual ~AliAnalysisTaskGeneralBF();
