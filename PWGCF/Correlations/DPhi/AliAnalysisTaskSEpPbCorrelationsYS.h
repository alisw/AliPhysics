...
public:
 ...
 private:
	AliAnalysisTaskSEpPbCorrelationsYS(const  AliAnalysisTaskSEpPbCorrelationsYS &det);
	AliAnalysisTaskSEpPbCorrelationsYS&   operator=(const  AliAnalysisTaskSEpPbCorrelationsYS &det);
	...
	void FillCorrelationTracks(Double_t MultipOrCent, TObjArray*triggerArray,TObjArray*selectedTrackArray,
								AliTHn*triggerHist,AliTHn* associateHist, Bool_t, Float_t, Float_t, Float_t,Int_t);
...
//---------------------------------------------------------------------------------------
Float_t AliAnalysisTaskSEpPbCorrelationsYS::GetDPhiStar(Float_t phi1, Float_t pt1, Float_t charge1, Float_t phi2, Float_t pt2, Float_t charge2, Float_t radius, Float_t bSign)
{ 
  //
...
public:
  ...
  fCharge(charge), 
    ...
    virtual Int_t    PdgCode()            const { AliFatal("Not implemented"); return 0;}
    virtual const    Double_t *PID()      const { AliFatal("Not implemented"); return 0;}
    virtual Short_t  WhichCandidate()     const { AliFatal("Not implemented"); return 0;}
    virtual Int_t		 GetID()     					const { AliFatal("Not implemented"); return 0;}
    virtual Int_t		 GetIDFirstDaughter()     					const{ AliFatal("Not implemented"); return 0;}
    virtual Int_t		 GetIDSecondDaughter()     					const{ AliFatal("Not implemented"); return 0;}
    virtual Double_t Multiplicity()       const { AliFatal("Not implemented"); return 0;}
