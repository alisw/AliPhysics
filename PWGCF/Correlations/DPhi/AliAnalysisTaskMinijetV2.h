#ifndef AliAnalysisTaskMinijetV2_H
#define AliAnalysisTaskMinijetV2_H
...
class AliAnalysisTaskMinijetV2 : public AliAnalysisTaskSE {
 public:
  AliAnalysisTaskMinijetV2(const char *name="<default name>");
  virtual ~AliAnalysisTaskMinijetV2();
 ...
 private:
  ...
  AliAnalysisTaskMinijetV2(const AliAnalysisTaskMinijetV2&); // not implemented
  AliAnalysisTaskMinijetV2& operator=(const AliAnalysisTaskMinijetV2&); // not implemented
  
  ClassDef(AliAnalysisTaskMinijetV2, 2); // mini jet analysis with two particle correlations
};
