...
ClassImp(AliAnalysisTaskpxpx)

AliAnalysisTaskpxpx::AliAnalysisTaskpxpx()
: AliAnalysisTaskSE(),
fAODEvent(0), 
...
AliAnalysisTaskpxpx::AliAnalysisTaskpxpx(const TString & name)
...
void AliAnalysisTaskpxpx::UserCreateOutputObjects()
{
  OpenFile(0);
  ...
  if (_useWeights)
    ...
    if (_weight_1)
      ...
      {
      AliError("AliAnalysisTaskpxpx:: _weight_1 is a null pointer.");
      return;
      }
    if (!_sameFilter) 
      {
  ...
  //cout<< "AliAnalysisTaskpxpx::CreateOutputObjects() DONE " << endl;
  
}

void  AliAnalysisTaskpxpx::createHistograms()
{
  AliInfo(" AliAnalysisTaskpxpx::createHistoHistograms() Creating Event Histos");
  TString name;
  ...
  AliInfo(" AliAnalysisTaskpxpx::createHistoHistograms() All Done"); 
}
//-----------------------//

void  AliAnalysisTaskpxpx::finalizeHistograms()
{
  
  AliInfo("AliAnalysisTaskpxpx::finalizeHistograms() starting");
  ...
  AliInfo("AliAnalysisTaskpxpx::finalizeHistograms()  Done ");
}
//--------------//


void  AliAnalysisTaskpxpx::UserExec(Option_t */*option*/)
{
  ...
  if(fAODEvent)
    {
      ...
      if (centralityObject)
	{
	  //cout << "AliAnalysisTaskpxpx::UserExec(Option_t *option) - 6" << endl;
	...
	{
	  AliError("AliAnalysisTaskpxpx::Exec(Option_t *option) iVertex<0 || iVertex>=_nBins_vertexZ ");
	  return;
	}
      ...
      for (int iTrack=0; iTrack< _nTracks; iTrack++)
	{
	  ...
	  if (_requestedCharge_1 == charge && dedx >=  _dedxMin && dedx < _dedxMax)
		...
		{
		  AliWarning("AliAnalysisTaskpxpx::analyze() iPhi<0 || iPhi>=_nBins_phi_1");
		  return;
		}
		...
		{
		  AliWarning(Form("AliAnalysisTaskpxpx::analyze(AliceEvent * event) Mismatched iEta: %d", iEta));
		  continue;
		}
	      iPt     = int((pt -_min_pt_1 )/_width_pt_1 ); 
	      if (iPt<0  || iPt >=_nBins_pt_1)
		{
		  AliWarning(Form("AliAnalysisTaskpxpx::analyze(AliceEvent * event) Mismatched iPt: %d",iPt));
		  continue;
		}
		...
		{
		  AliWarning("AliAnalysisTaskpxpx::analyze(AliceEvent * event) iZEtaPhiPt<0 || iZEtaPhiPt>=_nBins_zEtaPhiPt_1");
		  continue;
		}
	      ...
	      else
		{
		  ...
		  if (k1>=arraySize)
		    {
		      AliError(Form("AliAnalysisTaskpxpx::analyze(AliceEvent * event) k1 >=arraySize; arraySize: %d",arraySize));
		      return;
		    }
		}
	    }
	  ...
	  if (!_sameFilter && _requestedCharge_2 == charge && 
		...
		{
		  AliWarning("AliAnalysisTaskpxpx::analyze(AliceEvent * event) iZEtaPhiPt<0 || iZEtaPhiPt>=_nBins_zEtaPhiPt_2");
		  continue;
		}
  ...
  AliInfo("AliAnalysisTaskpxpx::UserExec()   -----------------Event Done ");
  PostData(0,_outputHistoList);
  
}

void   AliAnalysisTaskpxpx::FinishTaskOutput()
{
  AliInfo("AliAnalysisTaskpxpx::FinishTaskOutput() Starting.");
  Printf("= 0 ====================================================================");
  finalizeHistograms();
  AliInfo("= 1 ====================================================================");
  PostData(0,_outputHistoList);
  AliInfo("= 2 ====================================================================");
  AliInfo("AliAnalysisTaskpxpx::FinishTaskOutput() Done.");
}

void   AliAnalysisTaskpxpx::Terminate(Option_t* /*option*/)
{
  AliInfo("AliAnalysisTaskpxpx::Terminate() Starting/Done.");
}


//Tools
//===================================================================================================
void  AliAnalysisTaskpxpx::fillHistoWithArray(TH1 * h, float * array, int size)
{
  int i, i1;
...
void  AliAnalysisTaskpxpx::fillHistoWithArray(TH2 * h, float * array, int size1, int size2)
{
  int i, i1;
  int j, j1;
  float v1, ev1, v2, ev2, sum, esum;
...
void  AliAnalysisTaskpxpx::fillHistoWithArray(TH3 * h, float * array, int size1, int size2, int size3)
{
  int i, i1;
  int j, j1;
  int k, k1;
...
void  AliAnalysisTaskpxpx::fillHistoWithArray(TH1 * h, double * array, int size)
{
  int i, i1;
...
void  AliAnalysisTaskpxpx::fillHistoWithArray(TH2 * h, double * array, int size1, int size2)
{
  int i, i1;
  int j, j1;
  double v1, ev1, v2, ev2, sum, esum;
...
void  AliAnalysisTaskpxpx::fillHistoWithArray(TH3 * h, double * array, int size1, int size2, int size3)
{
  int i, i1;
  int j, j1;
  int k, k1;
...
double *  AliAnalysisTaskpxpx::getDoubleArray(int size, double v)
{
...
//________________________________________________________________________
float *  AliAnalysisTaskpxpx::getFloatArray(int size, float v)
{
...
//________________________________________________________________________
TH1D * AliAnalysisTaskpxpx::createHisto1D(const TString &  name, const TString &  title, 
...
//________________________________________________________________________
TH2D * AliAnalysisTaskpxpx::createHisto2D(const TString &  name, const TString &  title, 
...
//// F /////
//________________________________________________________________________
TH1F * AliAnalysisTaskpxpx::createHisto1F(const TString &  name, const TString &  title, 
                                                        int n, double xMin, double xMax, 
                                                        const TString &  xTitle, const TString &  yTitle)
{
  //CreateHisto new 1D historgram
...
//________________________________________________________________________
TH2F * AliAnalysisTaskpxpx::createHisto2F(const TString &  name, const TString &  title, 
                                                        int nx, double xMin, double xMax, int ny, double yMin, double yMax, 
                                                        const TString &  xTitle, const TString &  yTitle, const TString &  zTitle)
{
  AliInfo(Form("createHisto 2D histo %s  nx: %d  xMin: %f10.4 xMax: %f10.4  ny: %d   yMin: %f10.4 yMax: %f10.4",name.Data(),nx,xMin,xMax,ny,yMin,yMax));
...
//________________________________________________________________________
TH3F * AliAnalysisTaskpxpx::createHisto3F(const TString &  name, const TString &  title, 
...
//________________________________________________________________________
TProfile * AliAnalysisTaskpxpx::createProfile(const TString & name, const TString & description, 
                                                            int nx,double xMin,double xMax,
                                                            const TString &  xTitle, const TString &  yTitle)
{
...
void   AliAnalysisTaskpxpx::addToList(TH1 *h)
{
  if (_outputHistoList)
    {
