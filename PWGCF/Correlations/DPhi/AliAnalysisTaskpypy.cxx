...
void AliAnalysisTaskpypy::UserCreateOutputObjects()
{
  ...
  //cout<< "AliAnalysisTaskpypy::CreateOutputObjects() DONE " << endl;
...
void  AliAnalysisTaskpypy::UserExec(Option_t */*option*/)
{
  ...
  if(fAODEvent)
    {
      ...
      if (centralityObject)
	{
	  //cout << "AliAnalysisTaskpypy::UserExec(Option_t *option) - 6" << endl;
...
void   AliAnalysisTaskpypy::Terminate(Option_t* /*option*/)
{
