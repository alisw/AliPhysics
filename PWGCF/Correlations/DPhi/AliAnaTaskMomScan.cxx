...
ClassImp(AliAnaTaskMomScan)

AliAnaTaskMomScan::AliAnaTaskMomScan()
: AliAnalysisTaskSE(),
fAODEvent(0), 
...
AliAnaTaskMomScan::AliAnaTaskMomScan(const TString & name)
...
void AliAnaTaskMomScan::UserCreateOutputObjects()
{
  OpenFile(0);
...
{
  AliInfo(" AliAnaTaskMomScan::createHistoHistograms() Creating Event Histos");
  TString name;
  ...
  AliInfo(" AliAnaTaskMomScan::createHistoHistograms() All Done"); 
}
//-----------------------//
void  AliAnaTaskMomScan::finalizeHistograms()
{
  AliInfo("AliAnaTaskMomScan::finalizeHistograms() starting");
  ...
  AliInfo("AliAnaTaskMomScan::finalizeHistograms()  Done ");
}
//--------------//
void  AliAnaTaskMomScan::UserExec(Option_t */*option*/)
{
  ...
  if(fAODEvent)
	...
	{
	  AliError("AliAnaTaskMomScan::Exec(Option_t *option) iVertex<0 || iVertex>=_nBins_vertexZ ");
	  return;
	}
      ...
      for (int iTrack=0; iTrack< _nTracks; iTrack++)
	{
	  ...
	  if (_requestedCharge_1 == charge && dedx >=  _dedxMin && dedx < _dedxMax &&
	      pt > _min_pt_1 && pt < _max_pt_1)
	    {
	      iPhi   = int( phi/_width_phi_1);
	      if (iPhi<0 || iPhi>=_nBins_phi_1 ) 
		{
		  AliWarning("AliAnaTaskMomScan::analyze() iPhi<0 || iPhi>=_nBins_phi_1");
		  return;
		}
		...
		{
		  AliWarning("AliAnaTaskMomScan::analyze(AliceEvent * event) iZEtaPhiPt<0 || iZEtaPhiPt>=_nBins_zEtaPhiPt_1");
		  continue;
		}
	      if (_singlesOnly)
		{
	      ...
	      else
		{
		  ...
		  if (k1>=arraySize)
		    {
		      AliError(Form("AliAnaTaskMomScan::analyze(AliceEvent * event) k1 >=arraySize; arraySize: %d",arraySize));
		      return;
		    }
		}
	    }
  ...
  AliInfo("AliAnaTaskMomScan::UserExec()   -----------------Event Done ");
  PostData(0,_outputHistoList);
  
}

void   AliAnaTaskMomScan::FinishTaskOutput()
{
  AliInfo("AliAnaTaskMomScan::FinishTaskOutput() Starting.");
  Printf("= 0 ====================================================================");
  finalizeHistograms();
  AliInfo("= 1 ====================================================================");
  PostData(0,_outputHistoList);
  AliInfo("= 2 ====================================================================");
  AliInfo("AliAnaTaskMomScan::FinishTaskOutput() Done.");
}

void   AliAnaTaskMomScan::Terminate(Option_t* /*option*/)
{
  AliInfo("AliAnaTaskMomScan::Terminate() Starting/Done.");
}


//Tools
//===================================================================================================
void  AliAnaTaskMomScan::fillHistoWithArray(TH1 * h, float * array, int size)
{
  int i, i1;
...
void  AliAnaTaskMomScan::fillHistoWithArray(TH2 * h, float * array, int size1, int size2)
{
  int i, i1;
  int j, j1;
  float v1, ev1, v2, ev2, sum, esum;
...
void  AliAnaTaskMomScan::fillHistoWithArray(TH3 * h, float * array, int size1, int size2, int size3)
{
  int i, i1;
  int j, j1;
  int k, k1;
...
void  AliAnaTaskMomScan::fillHistoWithArray(TH1 * h, double * array, int size)
{
  int i, i1;
...
void  AliAnaTaskMomScan::fillHistoWithArray(TH2 * h, double * array, int size1, int size2)
{
  int i, i1;
  int j, j1;
  double v1, ev1, v2, ev2, sum, esum;
...
void  AliAnaTaskMomScan::fillHistoWithArray(TH3 * h, double * array, int size1, int size2, int size3)
{
  int i, i1;
  int j, j1;
  int k, k1;
...
double *  AliAnaTaskMomScan::getDoubleArray(int size, double v)
{
...
//________________________________________________________________________
float *  AliAnaTaskMomScan::getFloatArray(int size, float v)
{
...
//________________________________________________________________________
TH1D * AliAnaTaskMomScan::createHisto1D(const TString &  name, const TString &  title, 
...
//________________________________________________________________________
TH2D * AliAnaTaskMomScan::createHisto2D(const TString &  name, const TString &  title, 
...
//// F /////
//________________________________________________________________________
TH1F * AliAnaTaskMomScan::createHisto1F(const TString &  name, const TString &  title, 
                                                        int n, double xMin, double xMax, 
                                                        const TString &  xTitle, const TString &  yTitle)
{
  //CreateHisto new 1D historgram
...
//________________________________________________________________________
TH2F * AliAnaTaskMomScan::createHisto2F(const TString &  name, const TString &  title, 
                                                        int nx, double xMin, double xMax, int ny, double yMin, double yMax, 
                                                        const TString &  xTitle, const TString &  yTitle, const TString &  zTitle)
{
  AliInfo(Form("createHisto 2D histo %s  nx: %d  xMin: %f xMax: %f  ny: %d   yMin: %f yMax: %f",name.Data(),nx,xMin,xMax,ny,yMin,yMax));
...
//________________________________________________________________________
TH3F * AliAnaTaskMomScan::createHisto3F(const TString &  name, const TString &  title, 
...
//________________________________________________________________________
TProfile * AliAnaTaskMomScan::createProfile(const TString & name, const TString & description, 
                                                            int nx,double xMin,double xMax,
                                                            const TString &  xTitle, const TString &  yTitle)
{
...
void   AliAnaTaskMomScan::addToList(TH1 *h)
{
  if (_outputHistoList)
    {
