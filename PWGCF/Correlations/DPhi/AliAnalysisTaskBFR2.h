#ifndef AliAnalysisTaskBFR2_H_Included
#define AliAnalysisTaskBFR2_H_Included
...
class AliAnalysisTaskBFR2 : public AliAnalysisTaskSE
{
public:
    AliAnalysisTaskBFR2();
    AliAnalysisTaskBFR2(const TString & name);
...
private:
    ...
    AliAnalysisTaskBFR2(const  AliAnalysisTaskBFR2&);
    const AliAnalysisTaskBFR2& operator=(const  AliAnalysisTaskBFR2&);
    
public:
    virtual ~AliAnalysisTaskBFR2();
...
protected:
    ...
    ClassDef(AliAnalysisTaskBFR2,1)
}; 
