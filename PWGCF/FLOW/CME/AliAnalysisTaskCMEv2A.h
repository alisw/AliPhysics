...
class AliAnalysisTaskCMEv2A : public AliAnalysisTaskSE
{
 ...
 public:
  ...
  AliAnalysisTaskCMEv2A(); // default constructor
  AliAnalysisTaskCMEv2A(const char *name); // additional user defined constructor
  //virtual ~AliAnalysisTaskCMEv2A(){} // default destructor
  virtual ~AliAnalysisTaskCMEv2A(); // default destructor
