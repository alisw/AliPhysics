...
/*
 * This is a copy of the code from AliGFWCuts developed by Vytautas, it is the 20220404 version. 
 * This version is used by Mingrui Zhao in Nonlinear Flow Analysis.
 * Some of the cuts are modified from the old version
 * DCAxy function: change to FB96 default
 * DCAxy: 10 -> 6
 */

#ifndef ALIGFWMCUTS__H
#define ALIGFWMCUTS__H
