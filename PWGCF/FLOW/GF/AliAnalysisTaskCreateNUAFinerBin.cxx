...
#include "AliAnalysisTaskCreateNUAFinerBin.h"
#include "AliMultSelection.h"
#include <vector>

class AliAnalysisTaskCreateNUAFinerBin; // your analysis class

using namespace std; // std namespace: so you can do things like 'cout'

ClassImp(AliAnalysisTaskCreateNUAFinerBin) // classimp: necessary for root

    AliAnalysisTaskCreateNUAFinerBin::AliAnalysisTaskCreateNUAFinerBin() : AliAnalysisTaskSE(),
...
AliAnalysisTaskCreateNUAFinerBin::AliAnalysisTaskCreateNUAFinerBin(const char *name) : AliAnalysisTaskSE(name),
...
//_____________________________________________________________________________
AliAnalysisTaskCreateNUAFinerBin::~AliAnalysisTaskCreateNUAFinerBin()
{
  // destructor
  if (fOutputList)
  {
...
//_____________________________________________________________________________
void AliAnalysisTaskCreateNUAFinerBin::UserCreateOutputObjects()
{
  ...
  if (fPeriod.EqualTo("LHC15o") || fPeriod.EqualTo("LHC17n")) { // Only for LHC15o pass1 and LHC17n
    fGFWSelection15o = new AliGFWPbpass23Cuts();
...
//_____________________________________________________________________________
void AliAnalysisTaskCreateNUAFinerBin::Terminate(Option_t *)
{
  // terminate
...
const Int_t AliAnalysisTaskCreateNUAFinerBin::ReturnPosi_WeightList(const Int_t RunNumber, const Int_t sysflag)
{
  if (fPeriod == "LHC16") {
...
Bool_t AliAnalysisTaskCreateNUAFinerBin::AcceptAODTrack(AliAODTrack *mtr, Double_t *ltrackXYZ, Double_t *vtxp)
{
  // Pt cut
  if (mtr->Pt() < fMinPt)
    return kFALSE;
...
//============================================================================
const char *AliAnalysisTaskCreateNUAFinerBin::ReturnPPperiod(const Int_t runNumber) const
{
