...
// =================================================================================================
// AliESEFlowCorrTask - ALICE Unified Flow framework : CorrTask
// Author: Vojtech Pacik (vojtech.pacik@cern.ch), NBI, 2019
// =================================================================================================

#ifndef ESEFLOWCORRTASK_CXX
#define ESEFLOWCORRTASK_CXX

#include <vector>
#include "TObject.h"
#include "TString.h"
#include "TMath.h"
#include "AliESEFlowCorrTask.h"

ClassImp(AliESEFlowCorrTask);

// ============================================================================
AliESEFlowCorrTask::AliESEFlowCorrTask() :
  TObject{},
  fbDoRefs{0},
  fbDoPOIs{0},
  fiNumHarm{0},
...
{}
// ============================================================================
AliESEFlowCorrTask::AliESEFlowCorrTask(Bool_t doRFPs, Bool_t doPOIs, std::vector<Int_t> harms, std::vector<Double_t> gaps) :
  TObject{},
  fbDoRefs{doRFPs},
  fbDoPOIs{doPOIs},
  fiNumHarm{0},
...
// ============================================================================
void AliESEFlowCorrTask::PrintTask() const
{
  printf("AliESEFlowCorrTask::Print():\n");
  printf("# fsName:\t %s\n", fsName.Data());
  printf("# fsLabel:\t %s\n", fsLabel.Data());
  printf("# fbDoRefs:\t %d\n", fbDoRefs);
  printf("# fbDoPOIs:\t %d\n", fbDoPOIs);
