...
class AliPtContainer: public TNamed {
    public:
        ...
        void FillRecursive(double inarr[10][10],const double &lMult, const double &rn);
        ...
        TH1* getRercusiveHist(int ind, int m, unsigned int l_obs);
    ...
    protected:
        ...
        void FillRecursiveProfiles(const vector<double> &corr, const vector<double> &sumw, const double &lMult, const double &rn);
        void CalculateObs();
