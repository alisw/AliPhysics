...
#ifndef ALIANALYSISTASKCORRFORFLOWFMD_ONTHEFLY_H
#define ALIANALYSISTASKCORRFORFLOWFMD_ONTHEFLY_H
...
#include "AliGenAmptEventHeader.h"
...
class AliAnalysisTaskCorrForFlowFMDOnthefly : public AliAnalysisTaskSE
{
    public:

                                AliAnalysisTaskCorrForFlowFMDOnthefly();
                                AliAnalysisTaskCorrForFlowFMDOnthefly(const char *name, Bool_t bUseEff, Bool_t bUseCalib);
        virtual                 ~AliAnalysisTaskCorrForFlowFMDOnthefly();
	...
	void                    PreparePhi(); // Phi
        ...
        AliAnalysisTaskCorrForFlowFMDOnthefly(const AliAnalysisTaskCorrForFlowFMDOnthefly&); // not implemented
        AliAnalysisTaskCorrForFlowFMDOnthefly& operator=(const AliAnalysisTaskCorrForFlowFMDOnthefly&); // not implemented
	...
	Bool_t                  fcheckmassbias_Proton;//(kFALSE),
        ...
        ClassDef(AliAnalysisTaskCorrForFlowFMDOnthefly, 18);
};
