...
*/
#ifndef AliGFWWeightsFinerBin__H
#define AliGFWWeightsFinerBin__H
#include "TObjArray.h"
#include "TNamed.h"
#include "TH3D.h"
#include "TH2D.h"
...
class AliGFWWeightsFinerBin: public TNamed
{
 public:
  AliGFWWeightsFinerBin();
  AliGFWWeightsFinerBin(const AliGFWWeightsFinerBin&);
  ~AliGFWWeightsFinerBin();
  ...
  ClassDef(AliGFWWeightsFinerBin,1);
};
