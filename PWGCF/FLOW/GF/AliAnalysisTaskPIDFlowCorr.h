...
#ifndef ALIANALYSISTASKPIDFlowCorr_H
#define ALIANALYSISTASKPIDFlowCorr_H
...
//class AliAnalysisTaskPIDFlowCorr;
//_____________________________________________________________________________

class AliAnalysisTaskPIDFlowCorr : public AliAnalysisTaskSE
{
    public:
      ...
      enum    Disxaxis {kkPt=0,kPtnq,kKetnq };//distribution  xaxis is pt? or ptnq?or ketnq?
      class CorrTask
      {
        public:
        ...
        private:
                              ...
                              AliAnalysisTaskPIDFlowCorr(); // constructor
                              AliAnalysisTaskPIDFlowCorr(const char *name); // named (primary) constructor
                              AliAnalysisTaskPIDFlowCorr(const AliAnalysisTaskPIDFlowCorr&); // not implemented
                              AliAnalysisTaskPIDFlowCorr& operator=(const AliAnalysisTaskPIDFlowCorr&); // not implemented
      virtual                 ~AliAnalysisTaskPIDFlowCorr(); // destructor
      ...
      void                    SetFlowIntergPt(Double_t min, Double_t max,Int_t a) { fFlowIntergPtMin = min; fFlowIntergPtMax = max;ptorptnqorketnq=a; }
    ...
    private:
      ...
      Bool_t                  ProcessPIDFlowCorrTask(CorrTask* task);//procesisng of PID Flow Correlation Task
      Bool_t                  CalculateFlow(); // main (envelope) method for flow calculations in selected events
      void                    CalculateRecursive(CorrTask* task, PartSpecies species, Double_t& dNom, Double_t& dDenom, Double_t& dNomNeg, Double_t& dDenomNeg, Bool_t bDiff) const;//Recursive algorithm
      ...
      void                    FillRefsVectors(PartSpecies species,Double_t dGap,Double_t dPtLow, Double_t dPtHigh,Disxaxis axis); // fill flow vector Q with RFPs for reference flow
...
//----------------------------------------------------------------------------------------
      ...
      //TComPlex                Four_2Poi_2Ref(Int_t n1, Int_t n2, Int_t n3, Int_t n4);//
...
//fourgap
      ...
      Double_t                fFlowIntergPtMin;//
      Double_t                fFlowIntergPtMax;//
      Int_t                   ptorptnqorketnq;//
      ...
      ClassDef(AliAnalysisTaskPIDFlowCorr, 13);
};
#endif
