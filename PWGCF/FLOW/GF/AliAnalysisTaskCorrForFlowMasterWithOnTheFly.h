#ifndef AliAnalysisTaskCorrForFlowMaster_Anders_H
#define AliAnalysisTaskCorrForFlowMaster_Anders_H
...
class AliAnalysisTaskCorrForFlowMaster_Anders : public AliAnalysisTaskSE
{
    public:

                                AliAnalysisTaskCorrForFlowMaster_Anders();
                                AliAnalysisTaskCorrForFlowMaster_Anders(const char *name, Bool_t bUseEff, Bool_t bUseCalib);
        virtual                 ~AliAnalysisTaskCorrForFlowMaster_Anders();
        ...
        //For On The Fly:
        void                    SetOnTheFly(Bool_t flag=kFALSE){ fOnTheFly = flag; }
        void                    SetGenerator(TString Generator="AMPT"){ fGenerator = Generator;}
        void                    SetImpactParameterMC(Double_t b=-1.0){ fImpactParameterMC=b;}
    ...
    private:
        ...
        AliAnalysisTaskCorrForFlowMaster_Anders(const AliAnalysisTaskCorrForFlowMaster_Anders&); // not implemented
        AliAnalysisTaskCorrForFlowMaster_Anders& operator=(const AliAnalysisTaskCorrForFlowMaster_Anders&); // not implemented
        ...
        TH1D*                   fhEta; //!
        TH1D*                   fhPVz; //!
    //For Dphi~0 troubleshoot:
    //And probably generally usefull...
        TProfile2D*             phDphiPt1Pt2_ME;//!
        TProfile2D*             phDphiPt1Pt2_PtCut_ME;//!
        TH2D*                   phiCorr_ME;//!
        TH2D*                   phiCorr_SE;//!
        ...
        ClassDef(AliAnalysisTaskCorrForFlowMaster_Anders, 17);
};
