...
//(AliAnalysisTaskGammaConvFlowV1.cxx) for
...
void AddTask_GammaConvV1_PbPbV2(
    Int_t trainConfig = 1, // change different set of cuts
    Int_t isMC = 0,        // run MC
    TString photonCutNumberV0Reader = "",
    TString periodNameV0Reader = "",
    // general setting for task
    Int_t enableQAMesonTask = 0,             // enable QA in AliAnalysisTaskGammaConvFlowV1
...
)
{
  ...
  //================================================
  AliAnalysisTaskGammaConvFlowV1 *task = NULL;
  task = new AliAnalysisTaskGammaConvFlowV1(Form("GammaConvV1_%i", trainConfig));
  ...
  for (Int_t i = 0; i < numberOfCuts; i++)
  {
    ...
    {
      if (doWeightingPart == 1 || doWeightingPart == 4 || doWeightingPart == 12)
        analysisEventCuts[i]->SetAddedSignalPDGCode(111);
      if (doWeightingPart == 2 || doWeightingPart == 5 || doWeightingPart == 13)
  ...
  // task->SetTrainconfig(199);
  task->SetfRun(trainConfig);
