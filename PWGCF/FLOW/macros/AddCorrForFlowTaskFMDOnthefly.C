AliAnalysisTaskCorrForFlowFMDOnthefly* AddCorrForFlowTaskFMDOnthefly(TString name = "name", TString efficiencyFile = "",TString calibrationFile = "",const char* suffix = "")
{
    ...
    AliAnalysisTaskCorrForFlowFMDOnthefly* task = new AliAnalysisTaskCorrForFlowFMDOnthefly(taskName.Data(), useEfficiency, useCalibration);
    if(!task) return 0x0;
    mgr->AddTask(task);
