...
)
{
    ...
    //fileName += ":NUA";      // create a subfolder in the file
    // now we create an instance of your task
    AliAnalysisTaskCreateNUAFinerBin* task = new AliAnalysisTaskCreateNUAFinerBin(name.Data());   
    if(!task) return 0x0;
    ...
    // same for the output
    mgr->ConnectOutput(task,1,mgr->CreateContainer(Form("WeightList_%s", uniqueID.Data()), TList::Class(), AliAnalysisManager::kOutputContainer, fileName.Data()));
