...
//($ALIPHYSICS/PWG/FLOW/Tasks/AliAnalysisTaskGammaCaloV2.cxx) for
...
)
{
  ...
  if (strModifiedAcc.Contains("MODIFYACC"))
  {
    ...
    if (!w)
    {
      cout << "ERROR: Could not open file: " << fileNamePtWeights.Data() << endl;
      return;
    }
    histoAcc = (TH1S *)w->Get(tempType.Data());
    if (!histoAcc)
    {
      cout << "ERROR: Could not find histo: " << tempType.Data() << endl;
      return;
    }
  ...
  {
    cout << "ERROR: AddTask_GammaCalo_PbPb during parsing of settingMaxFacPtHard String '" << settingMaxFacPtHard.Data() << "'" << endl;
    return;
  }
  ...
  //================================================
  AliAnalysisTaskGammaCaloV2 *task = NULL;
  task = new AliAnalysisTaskGammaCaloV2(Form("GammaCalo_%i", trainConfig));
  ...
  {                                                                         // EMCAL clusters - added signals pi0 forseen
  ...
  {                                                                         // EMCAL clusters - added signals eta forseen
    cuts.AddCutCalo("50100023", "11111020530a2230000", "01631031000000d0"); // 0-10  // reproduce Astrids cuts with opening angle cut
    cuts.AddCutCalo("50100023", "11111020530a2230000", "0163103100000000"); // 0-10  // reproduce Astrids cuts without opening angle cut
    cuts.AddCutCalo("50100023", "11111710530a2230000", "01631031000000d0");
  }
  else if (trainConfig == 45)
  {                                                                         // EMCAL clusters - added signals other
    cuts.AddCutCalo("50100023", "11111020530a2230000", "01631031000000d0"); // 0-10  // reproduce Astrids cuts with opening angle cut
    cuts.AddCutCalo("50100023", "11111020530a2230000", "0163103100000000"); // 0-10  // reproduce Astrids cuts without opening angle cut
    cuts.AddCutCalo("50100023", "11111710530a2230000", "01631031000000d0");
  }
  ...
  {                                                                         // EMCAL clusters central add sig
  ...
  {                                                                         // EMCAL clusters semi-central add sig
  ...
  {                                                                         // EMCAL clusters peripheral add sig
  ...
  {                                                                         // EMCAL clusters - correction convcalo f1
  ...
  {                                                                         // EMCAL clusters - correction calocalo f2
  ...
  {                                                                         // EMCAL clusters - peripheral centrality selection for PbPb EMCal
  ...
  {                                                                         // EMCAL clusters semi-central, TB
  ...
  {                                                                         // EMCAL clusters - 20180718 - default without corrections
  ...
  {                                                                         // EMCAL clusters - 20180718 - default with peripheral corrections
  ...
  {                                                                         // EMCAL clusters - 20180718 - default with corrections
  ...
  {                                                                         // EMCAL clusters - TM studies with MIP subtraction
  ...
  {                                                                         // EMCAL clusters - studies for flat energy subtraction
    cuts.AddCutCalo("14610a13", "1111187051032230000", "0163103100000050"); //
  ...
  {                                                                         // EMCAL clusters - 20181207 - Peri NL
  ...
  {                                                                         // EMCAL clusters - 20181207 - Peri NL, asym cut on 0.1
  ...
  {                                                                         // EMCAL clusters - 20190215, asym cut on 0.8
  ...
  {                                                                         // EMCAL clusters - 0-80% centrality for XeXe EMCal cluster QA
  ...
  {                                                                         // EMCAL clusters - 0-80% centrality for XeXe EMCal cluster QA - TB nl
    cuts.AddCutCalo("10810013", "411790105k032220000", "01631031000000d0"); // 0-80
  }
  else if (trainConfig == 303)
  {                                                                         // EMCAL clusters - diff centralities for XeXe EMCal cluster QA - TB nl
  ...
  {                                                                         // EMCAL clusters - 0-80% centrality for XeXe EMCal cluster QA - TB nl + pp PCM-EMC tuning
    cuts.AddCutCalo("10810013", "411793105k032220000", "01631031000000d0"); // 0-80
  }
  else if (trainConfig == 305)
  {                                                                         // EMCAL clusters - diff centralities for XeXe EMCal cluster QA - TB nl + pp PCM-EMC tuning
  ...
  {                                                                         // PHOS clusters - 0-80% centrality for XeXe PHOS cluster QA
    cuts.AddCutCalo("10810013", "2446600000012200000", "0163103100000010"); // 0-80
  }
  else if (trainConfig == 401)
  {                                                                         // PHOS clusters - centrality for XeXe PHOS cluster QA
  ...
  {                                                                         // PHOS clusters - 0-80% centrality for XeXe PHOS cluster QA, PHOS TM sigma 2
  ...
  {                                                                         // PHOS clusters - 0-80% centrality for XeXe PHOS cluster QA, PHOS TM sigma 2.5
  ...
  {                                                                         // EMCAL+DCal clusters - default pp TM cut
  ...
  {                                                                         // EG1-CENT- EMCAL clusters - centrality selection for PbPb EMCal
  ...
  {                                                                         // EG2-CENT- EMCAL clusters - centrality selection for PbPb EMCal
  ...
  {                                                                         // EG1-CALO- EMCAL clusters - centrality selection for PbPb EMCal
  ...
  else if (trainConfig == 765)
  {                                                                         // EG2-CALO- EMCAL clusters - centrality selection for PbPb EMCal
  ...
  else if (trainConfig == 770)
  {                                                                         // EMCAL+DCal clusters - QA
    cuts.AddCutCalo("10930013", "4117900000032220000", "01331031000000d0"); //  0-90% QA (open timing)
  }
  else if (trainConfig == 780)
  {                                                                         // EMCAL+DCal clusters - no TM - no Ncell - no raised thresholds
  ...
  {                                                                         // EMCAL+DCal clusters - no TM - new PbPb pileup cut
  ...
  {                                                                         // EMCAL+DCal clusters - no TM - no Ncell - no raised thresholds, strict timing
  ...
  else if (trainConfig == 785)
  {                                                                         // EMCAL+DCal clusters - 13 TeV emcal cuts wo TM
  ...
  else if (trainConfig == 786)
  {                                                                         // EMCAL+DCal clusters - 13 TeV emcal cuts with TM
  ...
  else if (trainConfig == 787)
  {                                                                         // EMCAL+DCal clusters - 13 TeV emcal mixed event wo TM
  ...
  else if (trainConfig == 788)
  {                                                                         // EMCAL+DCal clusters - 13 TeV emcal mixed event cuts with TM
  ...
  else if (trainConfig == 860)
  {                                                                         // PHOS clusters - trigger 20181018
  ...
  else if (trainConfig == 880)
  {                                                                         // PHOS clusters - similar to EMCal 780
  ...
  for (Int_t i = 0; i < numberOfCuts; i++)
  {
    ...
    {
      if (headerSelectionInt == 1 || headerSelectionInt == 4 || headerSelectionInt == 12)
        analysisEventCuts[i]->SetAddedSignalPDGCode(111);
      if (headerSelectionInt == 2 || headerSelectionInt == 5 || headerSelectionInt == 13)
    ...
    if (analysisMesonCuts[i]->DoGammaSwappForBg())
      analysisClusterCuts[i]->SetUseEtaPhiMapForBackCand(kTRUE);
