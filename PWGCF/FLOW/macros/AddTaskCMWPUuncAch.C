...
void AddTaskCMWPUuncAch(Int_t gFilterBit = 768, Double_t fPtMin=0.2, Double_t fPtMax=10.0,Double_t fdcaxy=2.4, Double_t fdcaz=3.2, Double_t fChi2=4.0,Double_t fSlope=3.45, Float_t fConst=100, Bool_t bSkipPileUp=kFALSE, Bool_t usecorrectedach=kFALSE, Double_t fEtaMin=-0.8, Double_t fEtaMax=0.8, Int_t gNclustTPC=70, TString sCentEstimator="V0M", Double_t fCentralityMin=0., Double_t fCentralityMax=90.,
		...
		const char *suffix = "")
{
  // standard with task
  printf("===================================================================================\n");
  printf("\n                PID: Initialising AliAnalysisTaskCMWPUuncAch                             \n");
  printf("===================================================================================\n");
  ...
  AliAnalysisTaskCMWPUuncAch *task_CMW = new AliAnalysisTaskCMWPUuncAch(TaskCMWPID);
  ...
  task_CMW->SetFlagSkipPileUpCuts(bSkipPileUp, usecorrectedach);  
