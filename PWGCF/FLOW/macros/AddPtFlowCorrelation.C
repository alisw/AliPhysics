AliAnalysisTaskPtFlowCorrelation* AddPtFlowCorrelation(TString name = "name")
{
    ...
    AliAnalysisTaskPtFlowCorrelation* task = new AliAnalysisTaskPtFlowCorrelation(name.Data());   
    if(!task) return 0x0;
