AliAnalysisTask * AddTaskQvec(Double_t ptMin=0.2,
                             Double_t ptMax=5.,
                             TString analysisTypeUser="AOD",
                             Int_t AODfilterBit=768,
                             TString sDataSet="2015",
                             TString sIntRuns="high",
                             TString sIntRate="any",
                             TString EvTrigger="MB",
                             Bool_t bSetStoreZDCQVecVtxPos=kTRUE,
                             Bool_t bUseZDC=kTRUE,
                             TString ZDCCalibFileName="alien:///alice/cern.ch/user/j/jmargutt/15oHI_ZDCcalibVar_CenVtxCen_VtxRbR_Ecom_EcomVtx_Cen_VtxFit7.root",
                             TString sCorrWeight="TPCmVZuZDCm",
                             Double_t etaMin=-0.8,
                             Double_t etaMax=0.8,
                             TString Label="15_768",
                             ...
                             Double_t MaxFracSharedITSCl=1,
                             Double_t MaxChi2PerClTPC=4.,
                             Double_t MaxChi2PerClITS=36.,
                             ...
                             Double_t DeltaEta=1,
                             Bool_t bRecZDCVtxRbR=kTRUE,
                             TString PtWeightsFileName="alien:///alice/cern.ch/user/j/jmargutt/15o_FB768_hijing_eff_CorSec.root", //"$ALICE_PHYSICS/PWGCF/
                             TString sPhiEtaWeight="EtaPhiVtxRbR",
                             Bool_t bRemoveSplitMergedTracks=kFALSE,
                             Bool_t bUseTightPileUp=kFALSE,
                             Int_t MinMulZN=10,
                             TString ZDCESEFileName="",
                             TString CenWeightsFileName="alien:///alice/cern.ch/user/j/jmargutt/15oCentrality2.root", 
  ...
  taskCRCname += suffix;
  AliAnalysisTaskQvec *taskQC = new AliAnalysisTaskQvec(taskCRCname, kTRUE);
  ...
  if(MinMulZN==5 && ptMin==0.2 && ptMax==20.2) {
    ...
    for(Int_t c=0; c<5; c++) {
      ...
      cout<<"===> SpecWeightsHist->GetNbinsX() === "<<SpecWeightsHist->GetNbinsX()<<endl;
      if(SpecWeightsHist) {
