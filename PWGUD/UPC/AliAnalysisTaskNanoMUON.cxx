...
AliAnalysisTaskNanoMUON::AliAnalysisTaskNanoMUON() : AliAnalysisTaskSE(), 
  fPeriod(0), fIsMC(0), fAOD(0), fMC(0), fOutputList(0),fCounterH(0),  fNumberMuonsH(0), fNumberMCMuonsH(0),  
  fRAbsMuonH(0), fMuMuMassPtH(0), fMuonTrackCuts(0x0), fRecTree(0),
  fRunNum(0), fTracklets(0), fZNCEnergy(0), fZNAEnergy(0), fZPCEnergy(0), fZPAEnergy(0), fV0AFiredCells(0), fV0CFiredCells(0),
  fV0ADecision(-10), fV0CDecision(-10), fADADecision(-10), fADCDecision(-10), 
  fIR1Map(0), fIR2Map(0), fMuMuPt(0), fMuMuPhi(0), fMuMuY(0), fMuMuM(0), fMuPt1(0), fMuPt2(0),
  fMuEta1(0), fMuEta2(0), fMuPhi1(0), fMuPhi2(0), fMuQ1(0), fMuQ2(0),
  fGenTree(0), fMCRunNum(0), fMCMuMuPt(0), fMCMuMuPhi(0), fMCMuMuY(0), fMCMuMuM(0), 
  fMCMuPt1(0), fMCMuPt2(0), fMCMuEta1(0), fMCMuEta2(0), fMCMuPhi1(0), fMCMuPhi2(0), fMCMuPDG1(0), fMCMuPDG2(0),
  fGenPart(0), fZNAEnergyTimingH(0), fZNCEnergyTimingH(0), fZNATDCTimingH(0), fZNCTDCTimingH(0),
