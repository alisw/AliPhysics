AliAnalysisTaskPolarizationTestJP* AddPolarizationJP(const char* suffix = "")
{
TString name = "PolarizationJP";
name += suffix;     
...
fileName += ":PolarizationJP";     // create a subfolder in the file
fileName += suffix;      	 // specific subfolder name for each subwagon
// now we create an instance of your task
AliAnalysisTaskPolarizationTestJP* task = new AliAnalysisTaskPolarizationTestJP(name.Data());   
if(!task) return 0x0;
