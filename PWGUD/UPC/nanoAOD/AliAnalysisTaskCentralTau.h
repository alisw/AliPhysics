...
public:
		...
		static Int_t GetChipId(Int_t index, Int_t &chipId2, Bool_t debug=0);
		static Bool_t IsSTGFired(const TBits& bits, Int_t dphiMin=4, Int_t dphiMax=10, Bool_t tolerance = 1);
private:
		...
		// PID analysis
		Double_t fPIDpt[2],fTPCsignal[2],fTOFsignal[2];
...
ClassDef(AliAnalysisTaskCentralTau, 27);
};
