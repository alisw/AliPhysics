...
AliAnalysisTaskUpcPhi0::AliAnalysisTaskUpcPhi0()
  : AliAnalysisTaskSE(),
    fPIDResponse(0), isMC(0), debugMode(0), isUsingEffi(0), fTriggerName(0),
  	fTree(0), fMCTree(0), fTPCNcls(50), fOption(0),
...
void AliAnalysisTaskUpcPhi0::UserCreateOutputObjects() 
{
	...
	fTree->Branch("PIDTPCPion_T",&PIDTPCPion_T,"PIDTPCPion_T[2]/F");
	fTree->Branch("PIDTPCKaon_T",&PIDTPCKaon_T,"PIDTPCKaon_T[2]/F");
	fTree->Branch("PIDTPCElectron_T",&PIDTPCElectron_T,"PIDTPCElectron_T[2]/F");
	fTree->Branch("PIDTPCMuon_T",&PIDTPCMuon_T,"PIDTPCMuon_T[2]/F");
	fTree->Branch("TPCsignal_T",&TPCsignal_T,"TPCsignal_T[2]/I");
	fTree->Branch("TrackP_T",&TrackP_T,"TrackP_T[2]/F");
	fTree->Branch("TrackEta_T",&TrackEta_T,"TrackEta_T[2]/F");
	fTree->Branch("TrackPhi_T",&TrackPhi_T,"TrackPhi_T[2]/F");
	fTree->Branch("TrackPx_T",&TrackPx_T,"TrackPx_T[2]/F");
	fTree->Branch("TrackPy_T",&TrackPy_T,"TrackPy_T[2]/F");
	fTree->Branch("TrackPz_T",&TrackPz_T,"TrackPz_T[2]/F");
	fTree->Branch("TrackPt_T",&TrackPt_T,"TrackPt_T[2]/F");
