...
class AliAnalysisTaskUpcEtaCAWP : public AliAnalysisTaskSE {
public:
	AliAnalysisTaskUpcEtaCAWP();
	AliAnalysisTaskUpcEtaCAWP(const char *name);
	virtual ~AliAnalysisTaskUpcEtaCAWP();
...
private:
	...
	AliAnalysisTaskUpcEtaCAWP(const AliAnalysisTaskUpcEtaCAWP&); //not implemented
	AliAnalysisTaskUpcEtaCAWP& operator =(const AliAnalysisTaskUpcEtaCAWP&); //not implemented

	ClassDef(AliAnalysisTaskUpcEtaCAWP, 5);
};
