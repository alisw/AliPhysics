AliAnalysisTaskTOFTrigger *AddTaskTOFTrigger(const char *name,Float_t lowpt,Float_t highpt,Float_t highmult,TString trgcls,Int_t nBCs,Bool_t useEVS,const char* suffix = ""){
  ...
  // Create tasks
  AliAnalysisTaskTOFTrigger *task = new AliAnalysisTaskTOFTrigger(name,lowpt,highpt,highmult,trgcls,nBCs,useEVS);
  mgr->AddTask(task);
