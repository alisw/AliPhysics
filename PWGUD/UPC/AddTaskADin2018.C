AliAnalysisTaskADin2018* AddTaskADin2018( const char* suffix = "" )
{

    TString name = "ADcheck";
    ...
    AliAnalysisTaskADin2018* task = new AliAnalysisTaskADin2018(combinedName.Data());
    if(!task) return 0x0;
