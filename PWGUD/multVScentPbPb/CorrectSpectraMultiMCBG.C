...
void    CorrectSpectraMultiMCBG(const char* flNameData, const char* flNameMC,const char* unique="",int maxBins=10);
...
void    SetHistStyle(TH1* hst,int col=kRed,int mark=20,float mrsize=0.7);
TLatex* AddLabelL(const char*txt,float x=0.1,float y=0.9,int color=kBlack,float size=0.04);
...
void CorrectSpectraMultiMCBG(const char* flNameData, const char* flNameMC, const char* uniqueNm,int maxBin) 
{
 //
  ...
  for (int ib=0;ib<nCentBins;ib++) {
    if (!PrepareHistos(ib,listMC,kTRUE))  continue;//return;
    if (!PrepareHistos(ib,listDt,kFALSE)) continue;//return;
    ProcessHistos(ib); 
    //
  }
  //
...
void PlotDNDEta(int bin)
{
  ...
  //  delete tmpSCorr;
  SetHistStyle(hsigCorr,kRed,20,1.0);
  ...
  delete tmpRawB;
  SetHistStyle(hraws,kRed,23,1.0);
  ...
  delete tmpBg;
  SetHistStyle(hbg,kMagenta,22,1.0);
  ...
  delete tmpRawMC;
  SetHistStyle(hrawMC,kBlue,24,1.0);
  ...
  delete tmpRawBMC;
  SetHistStyle(hrawsMC,kBlue,26,1.0);
  ...
  delete tmpRawLBMC;
  SetHistStyle(hrawsMCLB,kGreen+2,30,1.0);
  ...
  delete tmpBgMCEst;
  SetHistStyle(hbgMCEst,kBlue,26,1.0);
  ...
  delete tmpBgMC;
  SetHistStyle(hbgMC,kGreen+2,25,1.0);
  ...
  //  delete tmpMCTrue;
  SetHistStyle(hMCtrue,kCyan,20,0.8);
  ...
  gPad->SetGrid(1.1);
  gPad->Modified();
  AddLabelL(outTitle,0.1,0.97, kBlack,0.02);
  //
  canvFin->cd();
  //
  //---------------- dsitributions
  ...
  SetHistStyle(mcdst,kBlue, 25,0.7);
  SetHistStyle(mcdstbgLB,kGreen, 7/*32*/,0.5);
  SetHistStyle(mcdstbg,kCyan, 7/*26*/,0.5);
  SetHistStyle(mcDstCombC,kGreen+2, 21,0.7);
  SetHistStyle(mcDstSec,kBlue+2, 22,0.7);
  //
  SetHistStyle(dtdst,kRed, 20,0.7);
  SetHistStyle(dtdstbg,kBlue, 34,0.7);
  //
  ...
  if (creatDnDEtaCMacro) {
    ...
    canvFin->Print(Form("%s/%s_b%d_dNdEta_%s.C",figDir,uniqueName.Data(),bin,outStr));
    canvFin->Print(Form("%s/%s_b%d_dNdEta_%s.gif",figDir,uniqueName.Data(),bin,outStr));
...
void PlotAlphaBeta(int bin) 
{
  ...
  dtBet->Draw("colz");
  AddLabelL("#beta Data",0.2,0.95,kBlack,0.04);
  gPad->Modified();
  ...
  gPad->SetRightMargin(0.15);
  mcBet->Draw("colz");
  AddLabelL("#beta MC (bckg.estimated)",0.2,0.95,kBlack,0.04);
  gPad->Modified();
  ...
  gPad->SetRightMargin(0.15);
  mcBetLB->Draw("colz");
  AddLabelL("#beta MC (bckg.from MC labels)",0.2,0.95,kBlack,0.04);
  gPad->Modified();
  ...
  gPad->SetRightMargin(0.15);
  dtAlp->Draw("colz");
  AddLabelL("#alpha (bckg.estimated)",0.2,0.95,kBlack,0.04);
  gPad->Modified();
  ...
  gPad->SetRightMargin(0.15);
  mcAlp->Draw("colz");
  AddLabelL("#alpha (bckg.from MC labels)",0.2,0.95,kBlack,0.04);
  gPad->Modified();
  ...
  gPad->Modified();
  canvFin->cd(6);
  AddLabelL(outTitle,0.1,0.5, kBlack, 0.02);
  //
  if (creatAlphaBetaCMacro) {
    //    sprintf(buff,"%s/%sAlphaBeta_%s",figDir,uniqueName.Data(),outStr);
    //    SaveCanvas(canvFin,buff,"cg");
    canvFin->Print(Form("%s/%sAlphaBeta_%s.C",figDir,uniqueName.Data(),outStr));
    canvFin->Print(Form("%s/%sAlphaBeta_%s.gif",figDir,uniqueName.Data(),outStr));
  }
  //
}
...
void PlotSpecies() 
{
  ...
  canvFin->cd(1);
  hSpecPrimAll->Draw();
  SetHistStyle(hSpecPrimAll,kBlue,25,1.1);
  hSpecPrimSel->Draw("same");
  SetHistStyle(hSpecPrimSel,kRed,20,1);
  //
  hSpecSecAll->Draw("same");
  SetHistStyle(hSpecSecAll,kGreen,32,1.1);
  hSpecSecSel->Draw("same");
  SetHistStyle(hSpecSecSel,kBlack,22,1);
  //
  ...
  canvFin->cd(2);
  hSpecPrimPAll->Draw();
  SetHistStyle(hSpecPrimPAll,kBlue,25,1.1);
  hSpecPrimPSel->Draw("same");
  SetHistStyle(hSpecPrimPSel,kRed,20,1);
  //
  hSpecSecPAll->Draw("same");
  SetHistStyle(hSpecSecPAll,kGreen,32,1.1);
  hSpecSecPSel->Draw("same");
  SetHistStyle(hSpecSecPSel,kBlack,22,1);
  //
  ...
  if (creatSpeciesCMacro) {
    ...
    //    SaveCanvas(canvFin,buff,"cg");
    canvFin->Print(Form("%s/%sSpecies_%s.C",figDir,uniqueName.Data(),outStr));
    canvFin->Print(Form("%s/%sSpecies_%s.gif",figDir,uniqueName.Data(),outStr));
  }
}
...
void SetHistStyle(TH1* hst,int col,int mark,float mrsize)
{
...
TLatex* AddLabelL(const char*txt,float x,float y,int color,float size)
{
