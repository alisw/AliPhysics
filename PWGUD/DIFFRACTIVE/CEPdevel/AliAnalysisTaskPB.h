...
#ifndef ALIANALYSISTASKPB_H
#define ALIANALYSISTASKPB_H
...
class AliAnalysisTaskPB : public AliAnalysisTaskSE
{
public:
...
private:
	...
	AliAnalysisTaskPB(const AliAnalysisTaskPB  &p);
	AliAnalysisTaskPB& operator=(const AliAnalysisTaskPB  &p);
  ...
  Float_t fPIDnSigmaProbTPC[2][AliPID::kSPECIES+1];
  Float_t fPIDnSigmaTOF[2][AliPID::kSPECIES+1];
  Float_t fPIDnSigmaProbTOF[2][AliPID::kSPECIES+1];
  ...
  // [4] Pz
  // [5] eta
  Float_t fTrackInfo[2][kTrackInfo];
  ...
  // AD
	TH1F *fmulADA;    // multiplicity on ADA
	TH1F *fmulADC;    // multiplicity on ADC
	TH1F *ftimeADA;   // charge on ADA
	TH1F *ftimeADC;   // charge on ADC
