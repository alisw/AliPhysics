...
AliAnalysisTaskf0f2RunTable::AliAnalysisTaskf0f2RunTable() :
    fCollisionType(kUnknownCollType)
{;}

AliAnalysisTaskf0f2RunTable::AliAnalysisTaskf0f2RunTable(Int_t runnumber) 
{
...
AliAnalysisTaskf0f2::AliAnalysisTaskf0f2()
:AliAnalysisTaskSE("AliAnalysisTaskf0f2")
    , fOption() 
    , fOutput(NULL) 
    , fTrigger(NULL)
    , fTrackCuts(NULL)
...
//___________________________________________________________________
AliAnalysisTaskf0f2& AliAnalysisTaskf0f2::operator = 
(
      const AliAnalysisTaskf0f2& ap
)
{
    ...
    this->~AliAnalysisTaskf0f2();
    new(this) AliAnalysisTaskf0f2(ap);
    return *this;
}
//___________________________________________________________________
AliAnalysisTaskf0f2::~AliAnalysisTaskf0f2()
...
//___________________________________________________________________
void AliAnalysisTaskf0f2::UserCreateOutputObjects()
...
//___________________________________________________________________
void AliAnalysisTaskf0f2::UserExec(Option_t* )
{
    ...
    if( IsFirstEvent ) {
        fRunTable = new AliAnalysisTaskf0f2RunTable(runnumber);
        IsFirstEvent = kFALSE;
    }
    ...
    if(!fPIDResponse){
        printf("AliAnalysisTaskf0f2 No PIDd\n");
    }
...
Bool_t AliAnalysisTaskf0f2::GoodTracksSelection(){
...
//___________________________________________________________________
void AliAnalysisTaskf0f2::FinishTaskOutput()
{
    OpenFile(1);
...
//___________________________________________________________________
void AliAnalysisTaskf0f2::Terminate(Option_t*)
{

}
//___________________________________________________________________

Int_t AliAnalysisTaskf0f2::GetPID(AliPIDResponse *pid, const AliVTrack *trk){
...
Bool_t AliAnalysisTaskf0f2::FindPtBin(Double_t pt, UInt_t & bin){
...
Bool_t AliAnalysisTaskf0f2::FindCentBin(Double_t cent, UInt_t & bin){
    for (UInt_t i=0; i<ncentbins; i++) 
