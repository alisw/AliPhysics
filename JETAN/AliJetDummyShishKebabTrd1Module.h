#ifndef ALIJETDUMMYSHISHKEBABTRD1MODULE_H
#define ALIJETDUMMYSHISHKEBABTRD1MODULE_H
...
class AliJetDummyShishKebabTrd1Module : public TNamed {
 public:
  AliJetDummyShishKebabTrd1Module(Double_t theta=0.0, AliJetDummyGeo *g=0);
  AliJetDummyShishKebabTrd1Module(AliJetDummyShishKebabTrd1Module &leftNeighbor);
  void Init(Double_t A, Double_t B);
  void DefineAllStaff();
  AliJetDummyShishKebabTrd1Module(const AliJetDummyShishKebabTrd1Module& mod);

  AliJetDummyShishKebabTrd1Module & operator = (const AliJetDummyShishKebabTrd1Module& /*rvalue*/)  {
    Fatal("operator =", "not implemented") ;  
    return *this ; 
  }

  virtual   ~AliJetDummyShishKebabTrd1Module(void) {}
 ...
 protected:
  // geometry info
  static AliJetDummyGeo *fgGeometry; //!
