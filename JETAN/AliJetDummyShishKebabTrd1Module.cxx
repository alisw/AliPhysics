...
ClassImp(AliJetDummyShishKebabTrd1Module)

  AliJetDummyGeo *AliJetDummyShishKebabTrd1Module::fgGeometry=0; 
  Double_t AliJetDummyShishKebabTrd1Module::fga=0.; 
  Double_t AliJetDummyShishKebabTrd1Module::fga2=0.; 
  Double_t AliJetDummyShishKebabTrd1Module::fgb=0.; 
  Double_t AliJetDummyShishKebabTrd1Module::fgr=0.; 
  Double_t AliJetDummyShishKebabTrd1Module::fgangle=0.;   // around one degree 
  Double_t AliJetDummyShishKebabTrd1Module::fgtanBetta=0; //

//_____________________________________________________________________________
AliJetDummyShishKebabTrd1Module::AliJetDummyShishKebabTrd1Module(Double_t theta, AliJetDummyGeo *g) 
  : TNamed(),
    fOK(),
    fA(0.),
    fB(0.),
...
{ 
  ...
  } else Warning("AliJetDummyShishKebabTrd1Module(theta)","You should call this constractor just once !!");
  DefineName(fTheta);
  AliInfo(Form("AliJetDummyShishKebabTrd1Module - first module:  theta %1.4f geometry %s",fTheta,g->GetName()));  
}

//_____________________________________________________________________________
AliJetDummyShishKebabTrd1Module::AliJetDummyShishKebabTrd1Module(AliJetDummyShishKebabTrd1Module &leftNeighbor) 
  : TNamed(),
    fOK(),
    fA(0.),
    fB(0.),
...
AliJetDummyShishKebabTrd1Module::AliJetDummyShishKebabTrd1Module(const AliJetDummyShishKebabTrd1Module& mod) 
...
//________________________________________________________________
void AliJetDummyShishKebabTrd1Module::Init(Double_t A, Double_t B)
{ 
...
//_____________________________________________________________________________
void AliJetDummyShishKebabTrd1Module::DefineFirstModule()
{
  // Define first module
...
//_____________________________________________________________________________
void AliJetDummyShishKebabTrd1Module::DefineName(Double_t theta)
{
...
//_____________________________________________________________________________
Bool_t AliJetDummyShishKebabTrd1Module::GetParameters()
{
 // Get needing module parameters from EMCAL geometry
  if(!fgGeometry) fgGeometry = AliJetDummyGeo::GetInstance();
...
// service methods
//_____________________________________________________________________________
void AliJetDummyShishKebabTrd1Module::PrintShish(Int_t pri) const
{
  // service method
  if(pri>=0) {
...
//_____________________________________________________________________________
Double_t  AliJetDummyShishKebabTrd1Module::GetThetaInDegree() const 
{
  return fTheta*TMath::RadToDeg();
}

//_____________________________________________________________________________
Double_t  AliJetDummyShishKebabTrd1Module::GetEtaOfCenterOfModule() const 
{ 
  return -TMath::Log(TMath::Tan(fOK.Phi()/2.));
}

//_____________________________________________________________________________
Double_t  AliJetDummyShishKebabTrd1Module::GetMaxEtaOfModule(Int_t pri) const 
{ 
