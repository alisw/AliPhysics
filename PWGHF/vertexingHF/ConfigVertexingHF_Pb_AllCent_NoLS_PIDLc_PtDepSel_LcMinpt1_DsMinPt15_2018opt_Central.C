AliAnalysisVertexingHF* ConfigVertexingHF() {
  ...
  vHF->SetTrackFilter2prongPbCentral(101.,trkFilter1); // for centrality 0-101% in the MC
  ...
  vHF->SetTrackFilter3prongPbCentral(101.,trkFilter2); // for centrality 0-101% in the MC
  ...
  cutsD0toKpi->SetMaxCentrality(101.);
 ...
 //5-999
  ...
  Float_t cutsArrayLctoV0[23]={0.2,0.,0.05,0.05,0.5,0.0,0.0,1000.,1000.,0.99,3.,1000.,0.,0.,0.,0.5,9999.,-9999.,-9999.,-9999.,0.0,1000.,1};
