...
/// \class AliAnalysisTaskSEXic2eleXifromAODtracksnew
...
class AliAnalysisTaskSEXic2eleXifromAODtracksnew : public AliAnalysisTaskSE 
{
 public:
  AliAnalysisTaskSEXic2eleXifromAODtracksnew();
  AliAnalysisTaskSEXic2eleXifromAODtracksnew(const Char_t* name, AliRDHFCutsXictoeleXifromAODtracks* cuts, Bool_t writeVariableTree=kTRUE);
  virtual ~AliAnalysisTaskSEXic2eleXifromAODtracksnew();
 ...
 private:
  ...
  AliAnalysisTaskSEXic2eleXifromAODtracksnew(const AliAnalysisTaskSEXic2eleXifromAODtracksnew &source);
  AliAnalysisTaskSEXic2eleXifromAODtracksnew& operator=(const AliAnalysisTaskSEXic2eleXifromAODtracksnew& source); 
  ...
  /// \cond CLASSIMP
  ClassDef(AliAnalysisTaskSEXic2eleXifromAODtracksnew,42); /// class for Xic->e Xi
  /// \endcond
};
#endif
