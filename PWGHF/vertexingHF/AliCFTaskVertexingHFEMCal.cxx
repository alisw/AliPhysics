...
#include "AliCFTaskVertexingHFEMCal.h"
...
AliCFTaskVertexingHFEMCal::AliCFTaskVertexingHFEMCal() :
  AliAnalysisTaskSE(),
  fCFManager(0x0),
...
AliCFTaskVertexingHFEMCal::AliCFTaskVertexingHFEMCal(const Char_t* name, AliRDHFCuts* cuts, TF1* func) :
...
//___________________________________________________________________________
AliCFTaskVertexingHFEMCal& AliCFTaskVertexingHFEMCal::operator=(const AliCFTaskVertexingHFEMCal& c)
{
  //
  // Assignment operator
  //
...
//___________________________________________________________________________
AliCFTaskVertexingHFEMCal::AliCFTaskVertexingHFEMCal(const AliCFTaskVertexingHFEMCal& c) :
  AliAnalysisTaskSE(c),
  fCFManager(c.fCFManager),
  fHistEventsProcessed(c.fHistEventsProcessed),
...
void AliCFTaskVertexingHFEMCal::Init()
{
  //
  // Initialization
  //

  if (fDebug > 1) printf("AliCFTaskVertexingHFEMCal::Init()");
...
void AliCFTaskVertexingHFEMCal::UserExec(Option_t *)
{
  //
  // Main loop function
  //

// cout << endl << endl << endl << endl << endl << endl << endl << endl << endl << "CFTASK" << endl << endl << endl << endl << endl << endl << endl << endl << endl << endl << endl;
  ...
  // Check simulated EMCal trigger for MC. AliEmcalTriggerMakerTask needs to be run first.
  Bool_t bPassEMCalTrigger = kTRUE;
  if (fUseEMCalTrigger)
  {
    ...
    {
      if (!triggercont->IsEventSelected("EG1") && !triggercont->IsEventSelected("DG1")) bPassEMCalTrigger = kFALSE;
    } else if (!triggercont->IsEventSelected(fTriggerSelectionString)) bPassEMCalTrigger = kFALSE;
  }
  ...
  if(fApplyEMCALClusterEventCut)
  {
    ...
    if(numberOfCaloClustersEvent >= 0)
    {
      ...
      if(!passClusterCuts) bPassEMCalTrigger = kFALSE;
    } else bPassEMCalTrigger = kFALSE;
  }
  ...
  for (Int_t iPart = 0; iPart < mcArray->GetEntriesFast(); iPart++) {
    ...
    if (mcContainerFilled) {
      ...
      if (mcAccepStep) {
        ...
        //MC EMCal trigger step
        if(fUseEMCalTrigger){
          if(bPassEMCalTrigger){
            fCFManager->GetParticleContainer()->Fill(containerInputMC, kStepEmcalTrigger, fWeight);
            AliDebug(3, "MC EMCal trigger cut passed\n");
            icountEMC++;
          } else {
            AliDebug(3, "MC EMCal trigger cut not passed\n");
            continue;
          }
        }

        //MC Vertex step
        Bool_t bMCVertexStep = kTRUE;

        if (!fCuts->IsEventSelected(aodEvent)) bMCVertexStep = kFALSE;
  ...
  AliDebug(2, Form("Found %i MC particles that are %s and satisfy EMCal trigger cuts!!", icountEMC, fPartName.Data()));
  ...
  for (Int_t iCandid = 0; iCandid < arrayBranch->GetEntriesFast(); iCandid++) {
    ...
    if (recoContFilled) {
      ...
      //emcal trigger selection step
      Bool_t triggerCheck = kTRUE;
      if(fUseEMCalTrigger){
        triggerCheck = bPassEMCalTrigger;
      }
      ...
      if (recoStep && recoContFilled && vtxCheck && triggerCheck) {
        if (!fFillMinimumSteps)
...
//___________________________________________________________________________
void AliCFTaskVertexingHFEMCal::Terminate(Option_t*)
{
  ...
  AliInfo(Form("Found %i MC particles that are %s in MC and satisfy EMCal trigger cuts, in %d events", fCountEMC, fPartName.Data(), fEvents));
...
//___________________________________________________________________________
void AliCFTaskVertexingHFEMCal::UserCreateOutputObjects()
{
...
//_________________________________________________________________________
void AliCFTaskVertexingHFEMCal::SetPtWeightsFromFONLL276overLHC12a17a() {
...
//_________________________________________________________________________
void AliCFTaskVertexingHFEMCal::SetPtWeightsFromDataPbPb276overLHC12a17a() {
  // ad-hoc weight function from ratio of
...
//_________________________________________________________________________
void AliCFTaskVertexingHFEMCal::SetPtWeightsFromFONLL276overLHC12a17b() {
...
//_________________________________________________________________________
void AliCFTaskVertexingHFEMCal::SetPtWeightsFromFONLL276andBAMPSoverLHC12a17b() {
  // weight function from the ratio of the LHC12a17b MC
  // and FONLL calculations for pp data
...
//_________________________________________________________________________
void AliCFTaskVertexingHFEMCal::SetPtWeightsFromFONLL5anddataoverLHC16i2a() {
...
//_________________________________________________________________________
void AliCFTaskVertexingHFEMCal::SetPtWeightsFDFromFONLL5anddataoverLHC19c3a() {
...
//_________________________________________________________________________
void AliCFTaskVertexingHFEMCal::SetPtWeightsFDFromFONLL5anddataoverLHC19c3b() {
...
//_________________________________________________________________________
void AliCFTaskVertexingHFEMCal::SetPtWeightsFromFONLL5andLBToverLHC16i2a() {
  // weight function from the ratio of the LHC16i2a MC
...
//_________________________________________________________________________
void AliCFTaskVertexingHFEMCal::SetPtWeightsFromFONLL5overLHC16i2abc() {
...
//_________________________________________________________________________
void AliCFTaskVertexingHFEMCal::SetPtWeightsFromFONLL5andBAMPSoverLHC16i2abc() {
  // weight function from the ratio of the LHC16i2a+b+c MC
  // and FONLL calculations for pp data
  // corrected by the BAMPS Raa calculation for 30-50% CC
  if (fHistoPtWeight) delete fHistoPtWeight;
...
//_________________________________________________________________________
void AliCFTaskVertexingHFEMCal::SetPtWeightsFromFONLL5andTAMUoverLHC16i2abc() {
  // weight function from the ratio of the LHC16i2a+b+c MC
  // and FONLL calculations for pp data
...
//_________________________________________________________________________
void AliCFTaskVertexingHFEMCal::SetPtWeightsFromFONLL5andDplusdataoverLHC16i2a() {
  // weight function from the ratio of the LHC16i2a MC
...
//_________________________________________________________________________
void AliCFTaskVertexingHFEMCal::SetPtWeightsFromD0Cent080dataoverLHC16i2abc() {
  //
...
//_________________________________________________________________________
void AliCFTaskVertexingHFEMCal::SetPtWeightsFromD0Cent080dataModOhoverLHC16i2abc() {
  //
  // weight function from the ratio of the D0 0-80% over lhc16i2abc
...
//_________________________________________________________________________
void AliCFTaskVertexingHFEMCal::SetPtWeightsFromD0Cent080dataModMartinezoverLHC16i2abc() {
  //
  // weight function from the ratio of the D0 0-80% over lhc16i2abc
...
//_________________________________________________________________________
void AliCFTaskVertexingHFEMCal::SetPtWeightsFromFONLL5overLHC13d3() {
...
//_________________________________________________________________________
void AliCFTaskVertexingHFEMCal::SetPtWeightsFromFONLL7overLHC10f6a() {
...
//_________________________________________________________________________
void AliCFTaskVertexingHFEMCal::SetPtWeightsFromFONLL7overLHC12a12() {
...
//_________________________________________________________________________
void AliCFTaskVertexingHFEMCal::SetPtWeightsFromFONLL7overLHC12a12bis() {
...
//_________________________________________________________________________
void AliCFTaskVertexingHFEMCal::SetPtWeightsFromFONLL7overLHC13e2fix() {
...
void AliCFTaskVertexingHFEMCal::SetPtWeightsFromFONLL5overLHC10f6a() {
  // weight function from the ratio of the LHC10f6a MC
  // and FONLL calculations for pp data
  if (fFuncWeight) delete fFuncWeight;
  fFuncWeight = new TF1("funcWeight", "([0]*x)/TMath::Power([2],(1+TMath::Power([3],x/[1])))+[4]*TMath::Exp([5]+[6]*x)+[7]*TMath::Exp([8]*x)", 0.15, 40.);
...
//________________________________________________________________
void AliCFTaskVertexingHFEMCal::SetPtWeightsFromFONLL276overLHC10f6a() {
  // weight function from the ratio of the LHC10f6a MC
  // and FONLL calculations for pp data
  if (fFuncWeight) delete fFuncWeight;
...
//_________________________________________________________________________
void AliCFTaskVertexingHFEMCal::SetPtWeightsFromFONLL5overLHC13d3Lc() {
  // weight function from the ratio of the LHC13d3 MC
...
//_________________________________________________________________________
void AliCFTaskVertexingHFEMCal::SetPtWeightsFromFONLL5overLHC16i6a() {
...
//_________________________________________________________________________
void AliCFTaskVertexingHFEMCal::SetPtWeightsFromFONLL7overLHC11b2Lc() {
...
//_________________________________________________________________________
void AliCFTaskVertexingHFEMCal::SetPtWeightsFromFONLL7overLHC10f7aLc() {
...
//_________________________________________________________________________
void AliCFTaskVertexingHFEMCal::SetPtWeightsFromFONLL8overLHC15l2a2() {
...
//_________________________________________________________________________
void AliCFTaskVertexingHFEMCal::SetPtWeightsFromFONLL13overLHC17c3a12() {
...
//_________________________________________________________________________
void AliCFTaskVertexingHFEMCal::SetPtWeightsFromFONLL5overLHC18a4a2() {
...
//_________________________________________________________________________
Double_t AliCFTaskVertexingHFEMCal::GetWeight(Float_t pt)
{
  //
...
Double_t AliCFTaskVertexingHFEMCal::dNdptFit(Float_t pt, Double_t* par)
{
  //
  // calculating dNdpt
  //
...
//_________________________________________________________________________
Double_t AliCFTaskVertexingHFEMCal::GetPtWeightFromHistogram(Float_t pt)
{
  //
...
//__________________________________________________________________________________________________
Double_t AliCFTaskVertexingHFEMCal::GetZWeight(Float_t z, Int_t runnumber) {
  //
...
//__________________________________________________________________________________________________
Double_t AliCFTaskVertexingHFEMCal::DodzFit(Float_t z, Double_t* par) {
...
//__________________________________________________________________________________________________
Double_t AliCFTaskVertexingHFEMCal::GetNchWeight(Int_t nch) {
  //
...
//__________________________________________________________________________________________________
void AliCFTaskVertexingHFEMCal::CreateMeasuredNchHisto() {
...
//__________________________________________________________________________________________________
Bool_t AliCFTaskVertexingHFEMCal::ProcessDs(Int_t recoAnalysisCuts) const {
...
//__________________________________________________________________________________________________
Bool_t AliCFTaskVertexingHFEMCal::ProcessLctoV0Bachelor(Int_t recoAnalysisCuts) const {
...
TProfile* AliCFTaskVertexingHFEMCal::GetEstimatorHistogram(const AliVEvent* event) {
...
Double_t AliCFTaskVertexingHFEMCal::ComputeTPCq2(AliAODEvent* aod, AliAODMCHeader* mcHeader, Double_t etamin, Double_t etamax, Double_t ptmin, Double_t ptmax) const {
...
Double_t AliCFTaskVertexingHFEMCal::CalculateRTValue(AliAODEvent* esdEvent, AliAODMCHeader *mcHeader, AliCFVertexingHF* cf)
{
...
ULong64_t AliCFTaskVertexingHFEMCal::GetEventIdAsLong(AliVHeader* header)
{
...
TObjArray *AliCFTaskVertexingHFEMCal::FindLeading(TObjArray *array)
{
  if (!array) return 0;
...
void AliCFTaskVertexingHFEMCal::QSortTracks(TObjArray &a, Int_t first, Int_t last)
{
  //Sort array by pT
  static TObject *tmp;
...
TObjArray *AliCFTaskVertexingHFEMCal::SortRegionsRT(const AliVParticle* leading, TObjArray *array)
{
  if (!array) return 0;
...
TObjArray* AliCFTaskVertexingHFEMCal::GetMinMaxRegionRT(TList *transv1, TList *transv2)
{
