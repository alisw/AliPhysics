...
class AliAnalysisTaskSEOmegac2eleOmegafromAODtracks : public AliAnalysisTaskSE 
{
 public:
  ...
  //  void SetMixWithoutConversionFlag(Bool_t a){fMixWithoutConversionFlag=a;}  // new
 ...
 private:
  ...
  THnSparse* fHistoOmegacMCGen;         //!<! electron in mcArray
  THnSparse* fHistoOmegacMCS;         //!<! electron in mcArray
  TH2D *fHistoResponseEleOmegaPt; //!<! Response function e-Omega pT <- OmegacPt
