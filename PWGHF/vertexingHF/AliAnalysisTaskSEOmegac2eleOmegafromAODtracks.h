...
class AliAnalysisTaskSEOmegac2eleOmegafromAODtracks : public AliAnalysisTaskSE 
{
 public:
  ...
  void FillCascROOTObjects(AliAODcascade *casc);
  void FillMCROOTObjects(AliAODMCParticle *part, AliAODMCParticle *mcepart, AliAODMCParticle *mcv0part, Int_t decaytype);
  void MakeMCAnalysis(TClonesArray *mcArray);
  void MakeAnalysis(AliAODEvent *aod, TClonesArray *mcArray);

  void SelectCascade( const AliVEvent *event,Int_t nCasc,Int_t &nSeleCasc, Bool_t *seleCascFlags);
 ...
 private:
  ...
  ClassDef(AliAnalysisTaskSEOmegac2eleOmegafromAODtracks,1); // class for Omegac->e Omega
};
#endif
