#ifndef ALICFTASKVERTEXINGHFEMCal_H
#define ALICFTASKVERTEXINGHFEMCal_H
/**************************************************************************
...
class AliCFTaskVertexingHFEMCal: public AliAnalysisTaskSE {
 public:
  ...
  enum {
    ...
    kStepVertex          = 4,
    kStepRefit           = 5,
    kStepReconstructed   = 6,
    kStepRecoAcceptance  = 7,
    kStepRecoITSClusters = 8,
    kStepRecoPPR         = 9,
    kStepRecoPID         = 10,
    kStepGenLimAccNoAcc  = 11
  };
  ...
  AliCFTaskVertexingHFEMCal(const Char_t* name, AliRDHFCuts* cuts, TF1* func = 0x0);
  AliCFTaskVertexingHFEMCal& operator= (const AliCFTaskVertexingHFEMCal& c);
  AliCFTaskVertexingHFEMCal(const AliCFTaskVertexingHFEMCal& c);
  virtual ~AliCFTaskVertexingHFEMCal();
 ...
 protected:
  ...
  Int_t fCountEMC;              ///  MC particle found that satisfy EMCal trigger cuts
  ...
  /// \cond CLASSIMP     
  ClassDef(AliCFTaskVertexingHFEMCal,1); /// class for HF corrections as a function of many variables
  /// \endcond
};
