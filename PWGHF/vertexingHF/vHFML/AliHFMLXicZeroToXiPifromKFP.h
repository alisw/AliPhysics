#ifndef ALIHFMLXICZEROTOXIPIFROMKFP_H
#define ALIHFMLXICZEROTOXIPIFROMKFP_H

/// \class AliHFMLXicZeroToXiPifromKFP
...
/// lines.
///
/// \author Jianhui Zhu <jianhui.zhu@cern.ch>, INFN-Padova
/// \date Jan 12, 2023
...
class AliHFMLXicZeroToXiPifromKFP : public AliAnalysisTaskSE
{
    public:
                                AliHFMLXicZeroToXiPifromKFP();
                                AliHFMLXicZeroToXiPifromKFP(const char *name, AliRDHFCutsKFP* cuts);
        virtual                 ~AliHFMLXicZeroToXiPifromKFP();
        ...
        void                    SetAnaPbPb(Bool_t IsPbPb) {fIsPbPb=IsPbPb;}
...
//        Float_t*                fVar_AntiXicZero;         //!<! variables of Anti-Xic0 to be written to the tree
        ...
        TH2F*                   f2DHistArmenterosPodolanski; //!<! Histogram of Armenteros-Podolanski of V0
        ...
        Float_t*                fVar_MLoutput;  //!<! variables of the ML output
