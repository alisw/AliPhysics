...
/// \cond CLASSIMP
ClassImp(AliRDHFCutsXicZerotoXiPifromAODtracks);
/// \endcond


//--------------------------------------------------------------------------
AliRDHFCutsXicZerotoXiPifromAODtracks::AliRDHFCutsXicZerotoXiPifromAODtracks(const char* name) :
  AliRDHFCuts(name),
...
//--------------------------------------------------------------------------
AliRDHFCutsXicZerotoXiPifromAODtracks::AliRDHFCutsXicZerotoXiPifromAODtracks(const AliRDHFCutsXicZerotoXiPifromAODtracks &source) :
  AliRDHFCuts(source),
...
//--------------------------------------------------------------------------
AliRDHFCutsXicZerotoXiPifromAODtracks &AliRDHFCutsXicZerotoXiPifromAODtracks::operator=(const AliRDHFCutsXicZerotoXiPifromAODtracks &source)
{
  //
  // assignment operator
  //
...
//---------------------------------------------------------------------------
AliRDHFCutsXicZerotoXiPifromAODtracks::~AliRDHFCutsXicZerotoXiPifromAODtracks() {
  //
  //  Default Destructor
  //
}
...
//---------------------------------------------------------------------------
void AliRDHFCutsXicZerotoXiPifromAODtracks::GetCutVarsForOpt(AliAODRecoDecayHF *d, Float_t *vars, Int_t nvars, Int_t *pdgdaughters) {
  //
  ...
  if (nvars!=fnVarsForOpt) {
    AliError("AliRDHFCutsXicZerotoXiPifromAODtracks wrong number of variables\n");
    return;
  }
...
//---------------------------------------------------------------------------
Int_t AliRDHFCutsXicZerotoXiPifromAODtracks::IsSelected(TObject* obj,Int_t selectionLevel) 
{
  //
  // Apply selection
  //
...
//---------------------------------------------------------------------------
Int_t AliRDHFCutsXicZerotoXiPifromAODtracks::IsSelectedPID(AliAODRecoDecayHF* obj) 
{
  //
  //  PID selection
  //
...
//---------------------------------------------------------------------------
Int_t AliRDHFCutsXicZerotoXiPifromAODtracks::IsSelectedCombinedPID(AliAODRecoDecayHF* obj) {
  //
...
Double_t AliRDHFCutsXicZerotoXiPifromAODtracks::GetPionProbabilityTPCTOF(AliAODTrack* trk) 
{
  //
...
//________________________________________________________________________
Bool_t AliRDHFCutsXicZerotoXiPifromAODtracks::SingleTrkCuts(AliAODTrack *trk)
{
  //
  //  Single Track Cut
  //
...
//________________________________________________________________________
Bool_t AliRDHFCutsXicZerotoXiPifromAODtracks::SingleCascadeCuts(AliAODcascade *casc,Double_t *primvert, Bool_t anaOmegacZero)
{
  //
  //  Single Cascade Cut
  //
  ...
  if(fUseCascadePID)
  {
    ...
    if(anaOmegacZero && fPidObjCascKa->GetPidResponse()==0x0){
      AliAnalysisManager *mgr = AliAnalysisManager::GetAnalysisManager();
      AliInputEventHandler *inputHandler=(AliInputEventHandler*)mgr->GetInputEventHandler();
      AliPIDResponse *pidResp=inputHandler->GetPIDResponse();
...
//________________________________________________________________________
Bool_t AliRDHFCutsXicZerotoXiPifromAODtracks::SingleCascadeCutsRef(AliAODcascade *casc, Double_t *primvert, Bool_t anaOmegacZero)
{
  //
...
//________________________________________________________________________
Bool_t AliRDHFCutsXicZerotoXiPifromAODtracks::SelectWithRoughCuts(AliAODcascade *casc, AliAODTrack *part1)
{
  //
