...
#include "AliAnalysisTaskSEXic2eleXifromAODtracksnew.h"
...
using std::endl;
/// \cond CLASSIMP
ClassImp(AliAnalysisTaskSEXic2eleXifromAODtracksnew);
/// \endcond

//__________________________________________________________________________
AliAnalysisTaskSEXic2eleXifromAODtracksnew::AliAnalysisTaskSEXic2eleXifromAODtracksnew() : 
  AliAnalysisTaskSE(),
  fUseMCInfo(kFALSE),
  fOutput(0),
  fOutputAll(0),
...
AliAnalysisTaskSEXic2eleXifromAODtracksnew::AliAnalysisTaskSEXic2eleXifromAODtracksnew(const Char_t* name,
  ...
  fTriggerCheck(0),
  fUseCentralityV0M(kFALSE),
  //fUseCentralityV0M(kTRUE),
  fUseCentralitySPDTracklet(kFALSE),
  //fUseCentralitySPDTracklet(kTRUE),
  fUseEventPlane(0),
  fEvNumberCounter(0),
  fMCEventType(-9999),
  fMCDoPairAnalysis(kFALSE),
  ...
  fHistoXicMCSWeight13(0)
{
  ...
  //
  Info("AliAnalysisTaskSEXic2eleXifromAODtracksnew","Calling Constructor");
...
AliAnalysisTaskSEXic2eleXifromAODtracksnew::~AliAnalysisTaskSEXic2eleXifromAODtracksnew() {
  ...
  // destructor
  //
  Info("~AliAnalysisTaskSEXic2eleXifromAODtracksnew","Calling Destructor");
...
void AliAnalysisTaskSEXic2eleXifromAODtracksnew::Init() {
  //
  // Initialization
  //
  //
...
//_________________________________________________
void AliAnalysisTaskSEXic2eleXifromAODtracksnew::UserExec(Option_t *)
{
  //
  // UserExec
  //
  ...
  if (fUseMCInfo) {
    ...
    if (!mcHeader) {
      AliError("AliAnalysisTaskSEXic2eleXifromAODtracksnew::UserExec: MC header branch not found!\n");
      return;
    }
  ...
  Bool_t fIsTriggerNotOK = fAnalCuts->IsEventRejectedDueToTrigger();//因为trigger进行不了
  Bool_t fIsPhysSelNotOK = fAnalCuts->IsEventRejectedDuePhysicsSelection();//因为物理筛选
  Bool_t fIsNoVertex = fAnalCuts->IsEventRejectedDueToNotRecoVertex();//因为没有记录到vertex
  ...
  if(fUseEventPlane>0){
    ...
    if(!pl){
      AliError("AliAnalysisTaskSEXic2eleXifromAODtracksnew::UserExec:no eventplane! v2 analysis without eventplane not possible!\n");
      fCEvents->Fill(18);
      return;
    }
    ...
    if(fUseEventPlane==4){
      ...
      fQ = pl->GetQVector();
			if(!fQSub1 || !fQSub2){
				AliError("AliAnalysisTaskSEXic2eleXifromAODtracksnew::UserExec: no Q vectors");
				fCEvents->Fill(19);
				return;
			}
		}
...
void AliAnalysisTaskSEXic2eleXifromAODtracksnew::Terminate(Option_t*)
{    
...
//___________________________________________________________________________
void AliAnalysisTaskSEXic2eleXifromAODtracksnew::UserCreateOutputObjects() 
{ 
  //
...
//-------------------------------------------------------------------------------
void AliAnalysisTaskSEXic2eleXifromAODtracksnew::MakeAnalysis
(
...
////-------------------------------------------------------------------------------
void AliAnalysisTaskSEXic2eleXifromAODtracksnew::DefineTreeVariables() 
{
  //
...
////-------------------------------------------------------------------------------
void AliAnalysisTaskSEXic2eleXifromAODtracksnew::FillROOTObjects(AliAODRecoCascadeHF *exobj, AliAODcascade *casc, AliAODTrack *trk, AliAODTrack *trkpid, AliAODEvent *event, TClonesArray *mcArray) 
{
  //
			...
			if(fUseMCInfo){
				if(mcxic){
					...
					if(abs(pdgcode)==4132 && abs(mcpdgele_array[1])==4132 && abs(mcpdgcasc_array[1])==4132){
                      ...
                      Int_t CheckOrigin = AliVertexingHFUtils::CheckOrigin(mcArray,mcxic,kTRUE);
...
////-------------------------------------------------------------------------------
void AliAnalysisTaskSEXic2eleXifromAODtracksnew::FillMixROOTObjects(TLorentzVector *trke, TLorentzVector *casc, TVector *elevars, TVector *cascvars, Int_t chargexi) 
{
  //
  // Fill histograms or tree depending on fWriteVariableTree 
  //
...
////-------------------------------------------------------------------------------
void AliAnalysisTaskSEXic2eleXifromAODtracksnew::DefineSingleTreeVariables() 
{
  //
...
////-------------------------------------------------------------------------------
void AliAnalysisTaskSEXic2eleXifromAODtracksnew::DefineEleTreeVariables() 
{
  //
...
////-------------------------------------------------------------------------------
void AliAnalysisTaskSEXic2eleXifromAODtracksnew::FillElectronROOTObjects(AliAODTrack *trk, AliAODEvent *event, TClonesArray *mcArray) 
{
  //
  // Fill histograms or tree depending on fWriteVariableTree 
...
////-------------------------------------------------------------------------------
void AliAnalysisTaskSEXic2eleXifromAODtracksnew::DefineCascTreeVariables() 
{
  //
  ...
  fCandidateVariableNames[26]="mcxipt";//fang
...
////-------------------------------------------------------------------------------
void AliAnalysisTaskSEXic2eleXifromAODtracksnew::FillCascROOTObjects(AliAODcascade *casc, AliAODEvent *event, TClonesArray *mcArray) 
{
  //
...
*/
  ...
  fCandidateCascVariables[26] = mcxipt;//fang
...
////-------------------------------------------------------------------------------
void AliAnalysisTaskSEXic2eleXifromAODtracksnew::DefineMCTreeVariables() 
{
  //
  // Define electron tree variables
  //
...
////-------------------------------------------------------------------------------
void AliAnalysisTaskSEXic2eleXifromAODtracksnew::FillMCROOTObjects(AliAODMCParticle *mcpart, AliAODMCParticle *mcepart, AliAODMCParticle *mccascpart, Int_t decaytype,TClonesArray *mcArray ) 
{
  //
  ...
  //
	...
	if(decaytype==0){
		...
		fHistoXicNonPromptMCGen -> Fill(contmc); //  non prompt -- correct one now!
	}else if (decaytype ==12){
		fHistoXicPromptMCGenWeight    -> Fill(contmc,fWeightFit->Eval(mcpart->Pt()) ); //  prompt -- weighted
		fHistoXicPromptMCGen    -> Fill(contmc);  // prompt -- correct now!
...
////-------------------------------------------------------------------------------
void AliAnalysisTaskSEXic2eleXifromAODtracksnew::DefineMCEleTreeVariables() 
{
  //
...
////-------------------------------------------------------------------------------
void AliAnalysisTaskSEXic2eleXifromAODtracksnew::FillMCEleROOTObjects(AliAODMCParticle *mcepart, TClonesArray *mcArray) 
{
  //
...
////-------------------------------------------------------------------------------
void AliAnalysisTaskSEXic2eleXifromAODtracksnew::DefineMCCascTreeVariables() 
{
  //
...
////-------------------------------------------------------------------------------
void AliAnalysisTaskSEXic2eleXifromAODtracksnew::FillMCCascROOTObjects(AliAODMCParticle *mccascpart, TClonesArray *mcArray) 
{
  //
  // Fill histograms or tree depending on fWriteMCVariableTree 
  //
...
////__________________________________________________________________________
void  AliAnalysisTaskSEXic2eleXifromAODtracksnew::DefineGeneralHistograms() {
  //
  ...
  fHCentrality = new TH1F("fHCentrality","conter",100,0.,1.);
...
//__________________________________________________________________________
void  AliAnalysisTaskSEXic2eleXifromAODtracksnew::DefineAnalysisHistograms() 
{
  //
...
AliAODRecoCascadeHF* AliAnalysisTaskSEXic2eleXifromAODtracksnew::MakeCascadeHF(AliAODcascade *casc, AliAODTrack *part, AliAODTrack *partpid, AliAODEvent * aod, AliAODVertex *secVert) 
{
  //
...
//________________________________________________________________________
AliAODVertex* AliAnalysisTaskSEXic2eleXifromAODtracksnew::CallPrimaryVertex(AliAODcascade *casc, AliAODTrack *trk, AliAODEvent* aod)
{
  //
...
//________________________________________________________________________
AliAODVertex* AliAnalysisTaskSEXic2eleXifromAODtracksnew::PrimaryVertex(const TObjArray *trkArray,
								   AliVEvent *event)
{
  //
  //Used only for pp
...
//________________________________________________________________________
AliAODVertex* AliAnalysisTaskSEXic2eleXifromAODtracksnew::ReconstructSecondaryVertex(AliAODcascade *casc, AliAODTrack *part, AliAODEvent * aod) 
{
  //
...
//________________________________________________________________________
Int_t AliAnalysisTaskSEXic2eleXifromAODtracksnew::MatchToMC(AliAODRecoCascadeHF *exobj, TClonesArray *mcArray, Int_t *pdgarray_ele, Int_t *pdgarray_casc, Int_t *labelarray_ele, Int_t *labelarray_casc,  Int_t &ngen_ele, Int_t &ngen_casc) 
{
  //
  // Match to MC
  //
...
//________________________________________________________________________
Int_t AliAnalysisTaskSEXic2eleXifromAODtracksnew::MatchToMCCascade(AliAODcascade *theCascade, Int_t pdgabscasc, Int_t *pdgDgcasc, Int_t *pdgDgv0, TClonesArray *mcArray) const // the cascade
{
	//
...
//________________________________________________________________________
void AliAnalysisTaskSEXic2eleXifromAODtracksnew::SelectTrack( const AliVEvent *event, Int_t trkEntries, Int_t &nSeleTrks,Bool_t *seleFlags, TClonesArray *mcArray)
{
  //
...
//________________________________________________________________________
void AliAnalysisTaskSEXic2eleXifromAODtracksnew::SelectCascade( const AliVEvent *event,Int_t nCascs,Int_t &nSeleCasc, Bool_t *seleCascFlags, TClonesArray *mcArray)
{
  //
...
Int_t AliAnalysisTaskSEXic2eleXifromAODtracksnew::GetPoolIndex(Double_t zvert, Double_t mult, Double_t rp){
	//
...
//_________________________________________________________________
void AliAnalysisTaskSEXic2eleXifromAODtracksnew::DoEventMixingWithPools(Int_t poolIndex)
{
  //
...
//_________________________________________________________________
void AliAnalysisTaskSEXic2eleXifromAODtracksnew::FillBackground(std::vector<TLorentzVector * > mixTypeE,std::vector<TVector * > mixTypeEVars, std::vector<TLorentzVector * > mixTypeL, std::vector<TVector * > mixTypeLVars, Int_t charge_xi)
{     
  //
  // Fill background
  //
...
//_________________________________________________________________
Bool_t AliAnalysisTaskSEXic2eleXifromAODtracksnew::MakeMCAnalysis(TClonesArray *mcArray)
{
	//
					...
					{	
							if(e_flag&&xi_flag){
									if((mcepart ->Charge()>0 && mccascpart ->Charge()< 0) ||(mcepart ->Charge()< 0 && mccascpart ->Charge() > 0)){	
									 decaytype = 11;  // non-prompt, from b
									FillMCROOTObjects(mcpart,mcepart,mccascpart,decaytype,mcArray);
									}
								}
					}
...
////-------------------------------------------------------------------------------
void AliAnalysisTaskSEXic2eleXifromAODtracksnew::DefineMCGenPairTreeVariables() 
{
  //
...
////-------------------------------------------------------------------------------
void AliAnalysisTaskSEXic2eleXifromAODtracksnew::FillMCGenPairROOTObjects(AliAODMCParticle *mcparte, AliAODMCParticle *mcpartv, TClonesArray *mcArray) 
{
  //
...
////-------------------------------------------------------------------------------
void AliAnalysisTaskSEXic2eleXifromAODtracksnew::DefineCorrelationTreeVariables() 
{
  //
  // Define mc pair tree variables
  //
...
////-------------------------------------------------------------------------------
void	AliAnalysisTaskSEXic2eleXifromAODtracksnew::GetMCDecayHistory(AliAODMCParticle *mcpart, TClonesArray *mcArray, Int_t *pdgarray, Int_t *labelarray, Int_t &ngen)
{
//
// MC decay history
//
...
//________________________________________________________________________
void AliAnalysisTaskSEXic2eleXifromAODtracksnew::StoreGlobalTrackReference(AliAODTrack *track, Int_t index){
  //
...
//________________________________________________________________________
void AliAnalysisTaskSEXic2eleXifromAODtracksnew::ResetGlobalTrackReference(){
...
//________________________________________________________________________
Int_t AliAnalysisTaskSEXic2eleXifromAODtracksnew::FromSemileptonicDecays(Int_t *history){
  // 
  // Check the mother 
  // 
...
//________________________________________________________________________
Bool_t AliAnalysisTaskSEXic2eleXifromAODtracksnew::HaveCharmInHistory(Int_t *history){
  // 
...
//________________________________________________________________________
Bool_t AliAnalysisTaskSEXic2eleXifromAODtracksnew::HaveBottomInHistory(Int_t *history){
  // 
...
TProfile* AliAnalysisTaskSEXic2eleXifromAODtracksnew::GetEstimatorHistogram(const AliVEvent* event){
...
//________________________________________________________________________
Float_t AliAnalysisTaskSEXic2eleXifromAODtracksnew::GetEventPlaneForCandidate(AliAODTrack* trk, AliAODcascade *casc,AliEventplane *pl, TVector2* q,TVector2* qsub1,TVector2* qsub2){
	//
...
//________________________________________________________________________
Float_t AliAnalysisTaskSEXic2eleXifromAODtracksnew::GetPhi0Pi(Float_t phi){
