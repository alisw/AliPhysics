...
#ifndef ReadBDT_LHC19c2a_6_8_noNsigma_H
#define ReadBDT_LHC19c2a_6_8_noNsigma_H
...
class ReadBDT_LHC19c2a_6_8_noNsigma : public IClassifierReader
{
 public:
  // Deafult constructor added by ALICE user
  ReadBDT_LHC19c2a_6_8_noNsigma()
      : IClassifierReader(),
        fClassName("ReadBDT_LHC19c2a_6_8_noNsigma"),
        fNvars(7),
        fIsNormalised(false)
  {
    for (int i = 7; i--;)
  ...
  // constructor
 ReadBDT_LHC19c2a_6_8_noNsigma( std::vector<std::string>& theInputVars )
   : IClassifierReader(),
    fClassName( "ReadBDT_LHC19c2a_6_8_noNsigma" ),
    fNvars( 7 ),
    fIsNormalised(false)
   ...
   // destructor
   virtual ~ReadBDT_LHC19c2a_6_8_noNsigma() {
