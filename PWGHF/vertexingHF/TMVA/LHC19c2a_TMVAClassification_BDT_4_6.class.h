...
bachelorPt                    bachelorPt                    bachelorPt                    bachelorPt                                                      'F'    [0.500096082687,5.69633483887]
...
CosThetaStar                  CosThetaStar                  CosThetaStar                  CosThetaStar                                                    'F'    [-0.999986708164,0.964337229729]
signd0                        signd0                        signd0                        signd0                                                          'F'    [2.6137568554e-08,0.499959766865]
bachelorP                     bachelorP                     bachelorP                     bachelorP                                                       'F'    [0.501002728939,7.30046367645]
...
bachTPCmom                    bachTPCmom                    bachTPCmom                    bachTPCmom                                                      'F'    [0.419207453728,250.717025757]
NSpec 15
...
#ifndef ReadBDT_LHC19c2a_4_6_H
#define ReadBDT_LHC19c2a_4_6_H
...
class ReadBDT_LHC19c2a_4_6 : public IClassifierReader
{
 public:
  // Deafult constructor added by ALICE user
  ReadBDT_LHC19c2a_4_6()
      : IClassifierReader(),
        fClassName("ReadBDT_LHC19c2a_4_6"),
        fNvars(14),
        fIsNormalised(false)
  {
    for (int i = 14; i--;)
  ...
  // constructor
 ReadBDT_LHC19c2a_4_6( std::vector<std::string>& theInputVars )
   : IClassifierReader(),
    fClassName( "ReadBDT_LHC19c2a_4_6" ),
    fNvars( 14 ),
    fIsNormalised(false)
