...
#ifndef ReadBDT_LHC19c2b_8_12_noPCts_H
#define ReadBDT_LHC19c2b_8_12_noPCts_H
...
class ReadBDT_LHC19c2b_8_12_noPCts : public IClassifierReader
{
 public:
  // Deafult constructor added by ALICE user
  ReadBDT_LHC19c2b_8_12_noPCts()
      : IClassifierReader(),
        fClassName("ReadBDT_LHC19c2b_8_12_noPCts"),
        fNvars(10),
        fIsNormalised(false)
  {
    for (int i = 10; i--;)
  ...
  // constructor
 ReadBDT_LHC19c2b_8_12_noPCts( std::vector<std::string>& theInputVars )
   : IClassifierReader(),
    fClassName( "ReadBDT_LHC19c2b_8_12_noPCts" ),
    fNvars( 10 ),
    fIsNormalised(false)
   ...
   // destructor
   virtual ~ReadBDT_LHC19c2b_8_12_noPCts() {
