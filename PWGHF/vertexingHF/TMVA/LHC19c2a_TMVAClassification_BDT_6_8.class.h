...
bachelorPt                    bachelorPt                    bachelorPt                    bachelorPt                                                      'F'    [0.720819592476,7.591817379]
...
CosThetaStar                  CosThetaStar                  CosThetaStar                  CosThetaStar                                                    'F'    [-0.999998629093,0.998514294624]
signd0                        signd0                        signd0                        signd0                                                          'F'    [0,0.499470025301]
bachelorP                     bachelorP                     bachelorP                     bachelorP                                                       'F'    [0.740581810474,9.85396099091]
...
bachTPCmom                    bachTPCmom                    bachTPCmom                    bachTPCmom                                                      'F'    [0.725545942783,233.794509888]
NSpec 15
...
#ifndef ReadBDT_LHC19c2a_6_8_H
#define ReadBDT_LHC19c2a_6_8_H
...
class ReadBDT_LHC19c2a_6_8 : public IClassifierReader
{
 public:
  // Deafult constructor added by ALICE user
  ReadBDT_LHC19c2a_6_8()
      : IClassifierReader(),
        fClassName("ReadBDT_LHC19c2a_6_8"),
        fNvars(14),
        fIsNormalised(false)
  {
    for (int i = 14; i--;)
  ...
  // constructor
 ReadBDT_LHC19c2a_6_8( std::vector<std::string>& theInputVars )
   : IClassifierReader(),
    fClassName( "ReadBDT_LHC19c2a_6_8" ),
    fNvars( 14 ),
    fIsNormalised(false)
