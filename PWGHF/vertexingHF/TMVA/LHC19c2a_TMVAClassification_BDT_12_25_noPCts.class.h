...
#ifndef ReadBDT_LHC19c2a_12_25_noPCts_H
#define ReadBDT_LHC19c2a_12_25_noPCts_H
...
class ReadBDT_LHC19c2a_12_25_noPCts : public IClassifierReader
{
 public:
  // Deafult constructor added by ALICE user
  ReadBDT_LHC19c2a_12_25_noPCts()
      : IClassifierReader(),
        fClassName("ReadBDT_LHC19c2a_12_25_noPCts"),
        fNvars(10),
        fIsNormalised(false)
  {
    for (int i = 10; i--;)
  ...
  // constructor
 ReadBDT_LHC19c2a_12_25_noPCts( std::vector<std::string>& theInputVars )
   : IClassifierReader(),
    fClassName( "ReadBDT_LHC19c2a_12_25_noPCts" ),
    fNvars( 10 ),
    fIsNormalised(false)
   ...
   // destructor
   virtual ~ReadBDT_LHC19c2a_12_25_noPCts() {
