...
AliAnalysisTaskSELc2V0bachelorTMVAApp* AddTaskLc2V0bachelor_TMVAApp(TString finname="Lc2V0bachelorCuts.root",
								    TString classReaderFileName="TMVAClassification_BDT_BDT_Default_6_12.class.C",
  ...
  gInterpreter->ProcessLine(Form(".L %s+",classReaderFileName.Data()));
  ...
  //  gROOT->LoadMacro("AliAnalysisTaskSELc2V0bachelorTMVAApp.cxx+g");
