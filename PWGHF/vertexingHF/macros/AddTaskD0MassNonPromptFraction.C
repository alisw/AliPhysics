AliAnalysisTaskSED0MassNonPromptFraction *AddTaskD0MassNonPromptFraction(Int_t flag=0/*0 = D0,1 = LS*/,Bool_t readMC=kFALSE,
				       Bool_t filldistr=kTRUE,Bool_t cutOnDistr=kFALSE,
				       ...
				       Bool_t DrawDetSignal=false, Bool_t PIDCheck=false, Bool_t FillMassY=false)
{
  ...
  AliAnalysisTaskSED0MassNonPromptFraction *massD0Task = new AliAnalysisTaskSED0MassNonPromptFraction(taskname.Data(),RDHFD0toKpi);
  ...
  //  massD0Task->SetRejectSDDClusters(kTRUE);
    ...
    massD0Task-> SetFillAfterCuts(kTRUE);
