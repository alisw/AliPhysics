...
AliCFTaskVertexingHFCutVarFDSub *AddTaskCFVertexingHFCutVarFDSub(const char* cutFile = "./D0toKpiCuts.root",
                                                                 TString cutObjectName="D0toKpiCutsStandard",
                                                                 TString suffix="",
                                                                 Int_t configuration = AliCFTaskVertexingHFCutVarFDSub::kCheetah,
                                                                 ...
                                                                 Int_t multiplicityEstimator = AliCFTaskVertexingHFCutVarFDSub::kNtrk10,
                                                                 ...
                                                                 Bool_t isFineNtrkBin=kFALSE)
{
	...
	else if (configuration == AliCFTaskVertexingHFCutVarFDSub::kCheetah){
	...
	Info("AliCFTaskVertexingHFCutVarFDSub","SETUP CONTAINER");
	...
	*/
	...
	if(multiplicityEstimator==AliCFTaskVertexingHFCutVarFDSub::kVZERO) {
  ...
  container -> SetStepTitle(6, "RecoAcc");
	...
	// create the task
	AliCFTaskVertexingHFCutVarFDSub *task = new AliCFTaskVertexingHFCutVarFDSub("AliCFTaskVertexingHFCutVarFDSub",cutsD0toKpi);
  ...
  AliAnalysisDataContainer *coutput3 = mgr->CreateContainer(output3name, THnSparseD::Class(),AliAnalysisManager::kOutputContainer,outputfile.Data());
	...
	AliAnalysisDataContainer *coutput7 = mgr->CreateContainer(output7name, TH1F::Class(),AliAnalysisManager::kOutputContainer,outputfile.Data());
