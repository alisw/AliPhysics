...
//--- set cuts for single-track selection  
 ...
 //5-999
  ...
  Float_t cutsArrayLctoV0[22]={0.2,0.,0.05,0.05,0.5,0.0,0.0,1000.,1000.,0.99,3.,1000.,0.,0.,0.,0.5,9999.,-9999.,-9999.,-9999.,0.,1000.,1};
  cutsLctoV0->SetUseTrackSelectionWithFilterBits(kFALSE);
  cutsLctoV0->SetMinPtCandidate(2.);
  cutsLctoV0->SetCuts(22,cutsArrayLctoV0);
