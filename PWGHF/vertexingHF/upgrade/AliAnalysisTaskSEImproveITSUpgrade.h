...
#ifndef ALI_ANALYSIS_TASK_SE_IMPROVE_ITS_UPGRADE_H
#define ALI_ANALYSIS_TASK_SE_IMPROVE_ITS_UPGRADE_H
...
class AliAnalysisTaskSEImproveITSUpgrade:public AliAnalysisTaskSE {
public:
  AliAnalysisTaskSEImproveITSUpgrade();
  AliAnalysisTaskSEImproveITSUpgrade(const char *name,
                              const char *resfileCurURI,
                              const char *resfileUpgURI,
                              Bool_t isRunInVertexing,
                              Int_t ndebug);

  virtual ~AliAnalysisTaskSEImproveITSUpgrade();
...
private:
  AliAnalysisTaskSEImproveITSUpgrade(const AliAnalysisTaskSEImproveITSUpgrade&);
  AliAnalysisTaskSEImproveITSUpgrade& operator=(const AliAnalysisTaskSEImproveITSUpgrade&); 
...
*/
  ...
  ClassDef(AliAnalysisTaskSEImproveITSUpgrade,4);
};
