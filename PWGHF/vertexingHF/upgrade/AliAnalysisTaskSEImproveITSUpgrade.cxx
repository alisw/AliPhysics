...
#include "AliAnalysisTaskSEImproveITSUpgrade.h"
...
AliAnalysisTaskSEImproveITSUpgrade::AliAnalysisTaskSEImproveITSUpgrade() 
  :AliAnalysisTaskSE(),
   fD0ZResPCur  (0),
   fD0ZResKCur  (0),
   fD0ZResPiCur (0),
...
AliAnalysisTaskSEImproveITSUpgrade::AliAnalysisTaskSEImproveITSUpgrade(const char *name,
...
void AliAnalysisTaskSEImproveITSUpgrade::UserCreateOutputObjects() {
  //
...
void AliAnalysisTaskSEImproveITSUpgrade::UserExec(Option_t*) {
  //
  // The event loop
  //
  AliAODEvent *ev=0x0;
...
void AliAnalysisTaskSEImproveITSUpgrade::SmearTrack(AliAODTrack *track,const TClonesArray *mcs) {
...
AliESDVertex* AliAnalysisTaskSEImproveITSUpgrade::RecalculateVertex(const AliVVertex *old,TObjArray *tracks,Double_t bField) {
  //
...
Double_t AliAnalysisTaskSEImproveITSUpgrade::EvalGraph(Double_t x,const TGraph *graph/*,const TGraph *graphSA*/) const {
  //
...
ClassImp(AliAnalysisTaskSEImproveITSUpgrade);
