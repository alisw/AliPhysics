AliAnalysisVertexingHF* ConfigVertexingHF() {
  ...
  //vHF->SetCascadesOff();                 
  vHF->SetCascadesOn();                 
  vHF->SetFindVertexForCascades(kFALSE);//put kFALSE 
  ...
  esdTrackCuts->SetClusterRequirementITS(AliESDtrackCuts::kITSU012,
  ...
  esdTrackCutsSoftPi->SetPtRange(0.1,1.e10);// 0.2
  ...
  Float_t cutsArrayDstoKKpi[20]={0.2,0.3,0.3,0.,0.,0.005,0.06,0.,0.,0.9,0.,100000.,0.035,0.0001,-1.,1.,0.,0.,0.,-1.};
  ...
  cutsLctopKpi->SetMinPtCandidate(2.);// era due
 ...
 // D* pt dependent cuts ------------------------------------------
  ...
  //0-5
  rdcutsvalmine[0][0]=0.15;  //D0 inv mass window
  ...
  rdcutsvalmine[9][0]=0.20;   // Dstar inv mass window
 ...
 //5-999
  rdcutsvalmine[0][1]=0.15;   //D0 inv mass window
  ...
  rdcutsvalmine[9][1]=0.20;   // Dstar inv mass window
  ...
  */
  ...
  Float_t cutsArrayLctoV0[17]={1.0,1.0,0.05,0.05,0.0,0.0,0.0,1000.,1000.,0.99,3.,1000.,0.,0.,0.,0.,1.0};
