...
class AliAnalysisTaskSEXicPlusToXi2PifromKFP : public AliAnalysisTaskSE
{
    public:
        ...
        void FillQATreeXicPlusFromCasc_woMassConstForLamAndXi(KFParticle kfpLambda, KFParticle kfpXiMinus_woMassConstForLamAndXi, KFParticle kfpXicPlus_woMassConstForLamAndXi, KFParticle PV, AliAODTrack *trackPiFromXicMinus_LowPt, TClonesArray *mcArray, Int_t lab_XicPlus, AliAODEvent *AODEvent);
        ...
        void FillQATreeXicPlusFromCasc_wMassConstForLam_woMassConstForXi(KFParticle kfpLambda_wMassConst, KFParticle kfpXiMinus_wMassConstForLam_woMassConstForXi, KFParticle kfpXicPlus_wMassConstForLam_woMassConstForXi, KFParticle PV, AliAODTrack *trackPiFromXicMinus_LowPt, TClonesArray *mcArray, Int_t lab_XicPlus, AliAODEvent *AODEvent);
        void FillQATreeXicPlusFromCasc_wMassConstForLamAndXi(KFParticle kfpLambda_wMassConst, KFParticle kfpXiMinus_wMassConstForLamAndXi, KFParticle kfpXicPlus_wMassConstForLamAndXi, KFParticle PV, AliAODTrack *trackPiFromXicPlus_LowPt, TClonesArray *mcArray, Int_t lab_XicPlus, AliAODEvent *AODEvent);
