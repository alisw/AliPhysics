...
#ifndef AliAnalysisTaskSEXic0pp13TeV_H
#define AliAnalysisTaskSEXic0pp13TeV_H
...
class AliAnalysisTaskSEXic0pp13TeV : public AliAnalysisTaskSE
{
  public:

    enum {  kSD=0, kDD, kND, kCD, kAllProc  }; //PN = unlike sign, PP and NN are like signs

    AliAnalysisTaskSEXic0pp13TeV();
    AliAnalysisTaskSEXic0pp13TeV( const char *name, const char *option );
    AliAnalysisTaskSEXic0pp13TeV( const AliAnalysisTaskSEXic0pp13TeV& ap );
    AliAnalysisTaskSEXic0pp13TeV& operator = ( const AliAnalysisTaskSEXic0pp13TeV& ap );
    ~AliAnalysisTaskSEXic0pp13TeV();
    ...
    void SetRunOffset(Int_t runoffset) { RunOffset = runoffset; };
    void SetHighMultiplicity(Bool_t IsHM) { IsHighMul = IsHM; };
    Int_t GetRunOffset() { return RunOffset; };
    ...
    void FillPairEleXi(AliAODcascade *casc, AliAODTrack *trk, Int_t NoFillHistos);
  ...
  private:
    ...
    ClassDef(AliAnalysisTaskSEXic0pp13TeV, 1);
};
