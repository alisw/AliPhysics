...
void AddTaskFlowD2HconfigurableTPC(TString fileNameCuts, TString folderName, Int_t nDmeson, Int_t myHarmonic, 
		     Bool_t bDoQC, Bool_t bDoSPTPC, Bool_t bDoSPVZERO, Bool_t bDoEPTPC, Bool_t bDoEPVZERO, 
		     Int_t ptBinWidth, Double_t gapTPC,
		     Double_t etaTPC1, Double_t etaTPC2, Double_t etaTPC3, Double_t etaTPC4,
		     Double_t etaVZERO1, Double_t etaVZERO2, Double_t etaVZERO3, Double_t etaVZERO4,
  ...
  cutsRFPTPC->SetEtaRange(etaTPC1,etaTPC4);
  ...
  cutsRFPVZE->SetEtaRange(etaVZERO1,etaVZERO4);
  ...
  for(int mb=0; mb!=myMassBands; ++mb) {
    ...
    filterPOISP[mb][0]->SetEtaMin( etaTPC1 );
    filterPOISP[mb][0]->SetEtaMax( etaTPC2 );
    ...
    filterPOISP[mb][1]->SetEtaMin( etaTPC3 );
    filterPOISP[mb][1]->SetEtaMax( etaTPC4 );
    ...
    filterPOIQC[mb]->SetEtaMin( etaTPC1 );
    filterPOIQC[mb]->SetEtaMax( etaTPC4 );
  ...
  for(int mb=0; mb!=myMassBands; ++mb) {
	...
	AddSPmethod( Form("%sSPTPCMB%d",sgn.Data(),mb), fileName.Data(), thecuts.Data(), etaTPC1, etaTPC2-gapTPC*eg, etaTPC3+gapTPC*eg, etaTPC4,
    ...
    if(bDoEPTPC) {
      AddSPmethod( Form("%sEPTPCMB%d",sgn.Data(),mb), fileName.Data(), thecuts.Data(), etaTPC1, etaTPC2, etaTPC3, etaTPC4,
