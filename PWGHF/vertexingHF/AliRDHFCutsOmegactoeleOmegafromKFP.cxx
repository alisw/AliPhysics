...
/// \cond CLASSIMP
ClassImp(AliRDHFCutsOmegactoeleOmegafromKFP);
/// \endcond

//--------------------------------------------------------------------------
AliRDHFCutsOmegactoeleOmegafromKFP::AliRDHFCutsOmegactoeleOmegafromKFP(const char* name) :
  AliRDHFCuts(name),
...
//------- used for KFP
 ...
 fKFPOmega_Chi2geoMax(100.),
 fKFPOmega_Chi2topoMax(100.),
 fKFPOmega_lDeltalMin(0.),
 fKFPOmegac0_Chi2geoMax(100.),
 fPtMinOmegac0(0.),
//-----------
...
//--------------------------------------------------------------------------
AliRDHFCutsOmegactoeleOmegafromKFP::AliRDHFCutsOmegactoeleOmegafromKFP(const AliRDHFCutsOmegactoeleOmegafromKFP &source) :
  AliRDHFCuts(source),
...
//------- used for KFP
 ...
 fKFPOmega_Chi2geoMax(source.fKFPOmega_Chi2geoMax),
 fKFPOmega_Chi2topoMax(source.fKFPOmega_Chi2topoMax),
 fKFPOmega_lDeltalMin(source.fKFPOmega_lDeltalMin),
 fKFPOmegac0_Chi2geoMax(source.fKFPOmegac0_Chi2geoMax),
 fPtMinOmegac0(source.fPtMinOmegac0),
//-------
...
//--------------------------------------------------------------------------
AliRDHFCutsOmegactoeleOmegafromKFP &AliRDHFCutsOmegactoeleOmegafromKFP::operator=(const AliRDHFCutsOmegactoeleOmegafromKFP &source)
{
  //
  // assignment operator
  //
...
//---------------------------------------------------------------------------
AliRDHFCutsOmegactoeleOmegafromKFP::~AliRDHFCutsOmegactoeleOmegafromKFP() {
  //
  //  Default Destructor
  //
...
//---------------------------------------------------------------------------
void AliRDHFCutsOmegactoeleOmegafromKFP::GetCutVarsForOpt(AliAODRecoDecayHF *d,Float_t *vars,Int_t nvars,Int_t *pdgdaughters) {
  //
...
//---------------------------------------------------------------------------
Int_t AliRDHFCutsOmegactoeleOmegafromKFP::IsSelected(TObject* obj, Int_t selectionLevel) {
  //
  // Apply selection
  //
...
//---------------------------------------------------------------------------
Int_t AliRDHFCutsOmegactoeleOmegafromKFP::IsSelectedPID(AliAODRecoDecayHF* obj)
{
  //
  // IsSelectedPID
  //
...
//---------------------------------------------------------------------------
Int_t AliRDHFCutsOmegactoeleOmegafromKFP::IsSelectedCombinedPID(AliAODRecoDecayHF* obj) {
  //
...
Bool_t AliRDHFCutsOmegactoeleOmegafromKFP::SingleTrkCuts(AliAODTrack *trk, AliAODTrack *trkpid, AliAODVertex *primVert)
{
  //
...
Bool_t AliRDHFCutsOmegactoeleOmegafromKFP::SingleTrkCutsNoPID(AliAODTrack *trk, AliAODTrack *trkpid,AliAODVertex *primVert)
{
    //
    // Single Track Cut to be applied before object creation
    //
...
//________________________________________________________________________
Bool_t AliRDHFCutsOmegactoeleOmegafromKFP::IsSelectedeID(AliAODTrack *trk)
{
  //
...
//________________________________________________________________________
Bool_t AliRDHFCutsOmegactoeleOmegafromKFP::IsSelectedCustomizedeID(AliAODTrack *trk)
{
  //
  // electron ID first shot
  //
...
//________________________________________________________________________
Bool_t AliRDHFCutsOmegactoeleOmegafromKFP::IsSelectedCustomizedPtDepeID(AliAODTrack *trk , AliAODTrack *trkpid)
{
...
//________________________________________________________________________
Bool_t AliRDHFCutsOmegactoeleOmegafromKFP::IsSelectedCombinedeID(AliAODTrack *trk)
{
  //
...
//________________________________________________________________________
Bool_t AliRDHFCutsOmegactoeleOmegafromKFP::SingleCascadeCuts(AliAODcascade *casc,Double_t *primvert)
{
  //
  //  Single Cascade Cut
  //
...
//________________________________________________________________________
Bool_t AliRDHFCutsOmegactoeleOmegafromKFP::SelectWithRoughCuts(AliAODcascade *casc, AliAODTrack *part)
{
  //
...
//________________________________________________________________________
Bool_t AliRDHFCutsOmegactoeleOmegafromKFP::IsPeakRegion(AliAODcascade *casc)
{
    Double_t momegaPDG =  TDatabasePDG::Instance()->GetParticle(3334)->Mass();
    Double_t massOmega = casc->MassOmega();
...
//________________________________________________________________________
Bool_t AliRDHFCutsOmegactoeleOmegafromKFP::TagConversions(AliAODTrack *etrk, Int_t *id2index, AliAODEvent *evt, Int_t ntrk, Double_t &minmass)
{
    //
...
//________________________________________________________________________
Bool_t AliRDHFCutsOmegactoeleOmegafromKFP::TagConversionsSameSign(AliAODTrack *etrk, Int_t *id2index, AliAODEvent *evt, Int_t ntrk, Double_t &minmass)
{
    //
    // Tag conversion electron tracks
    //
...
//________________________________________________________________________
Double_t AliRDHFCutsOmegactoeleOmegafromKFP::DeltaPhi(AliAODcascade *casc, AliAODTrack *trk)
{
    //
    // Calculate Delta phi
    //
...
Double_t AliRDHFCutsOmegactoeleOmegafromKFP::DeltaEta(AliAODcascade *casc, AliAODTrack *trk)
{
    //
    // Calculate Delta Eta
    //
...
//________________________________________________________________________
Double_t AliRDHFCutsOmegactoeleOmegafromKFP::CosOpeningAngle(AliAODcascade *casc, AliAODTrack *trk)
{
    //
