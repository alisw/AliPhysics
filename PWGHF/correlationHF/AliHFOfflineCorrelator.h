...
public:
    ...
    void SetStoreSoftPionInME(Bool_t store) {fStoreSoftPiInME=store;}
...
private:
    ...
    Bool_t fStoreSoftPiInME;	//flag to remove soft pions in ME analysis for D0 meson (SE rejection is done in the task)

    ClassDef(AliHFOfflineCorrelator,3); // class for plotting HF correlations
