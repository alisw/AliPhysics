...
void RunFeedown_pPb_Dstar(Int_t collsyst, Bool_t subtrMCclos, Bool_t oldnames, Int_t centbin){
 ...
 /* DEACTIVATED */ //        purities[0]/=1.015;  purities[1]/= 1.010; purities[2]/= 1.042; purities[3]/= 1.063; purities[4]/= 1.069; purities[5]/= 1.038; purities[6]/= 1.063; 
    ...
    for(Int_t iDpt = dPtMin; iDpt <dPtmax; iDpt++){
        for(Int_t ihadpt = 0; ihadpt <dhadPtmax; ihadpt++){
            ...
            outputfilename = "./Final_Plots_pPb/Singlev2Envelope/pPb_FDsubDstar";
            outputfilename += Form("Pt%dto%dassoc%1.1fto%1.1f",(int)Dpt[iDpt], (int)Dpt[iDpt+1], hadpt[ihadpt],hadptMax[ihadpt]);
            SubtractFDexploitingClassDstar(Dpt[iDpt],Dpt[iDpt+1],hadpt[ihadpt],hadptMax[ihadpt],outputfilename.Data(),2,purities[ihadpt],1,inputcorrelation.Data(),inputfc.Data(),templatedir.Data(),collsyst,v2Dmax,v2hadmax,systmode,oldnames,subtrMCclos,centbin);
            ...
            outputfilename = "./Final_Plots_pPb/Singlev2Envelope/pPb_FDsubDstar";
            outputfilename += Form("Pt%dto%dassoc%1.1fto%1.1f",(int)Dpt[iDpt], (int)Dpt[iDpt+1], hadpt[ihadpt],hadptMax[ihadpt]);
            SubtractFDexploitingClassDstar(Dpt[iDpt],Dpt[iDpt+1],hadpt[ihadpt],hadptMax[ihadpt],outputfilename.Data(),2,purities[ihadpt],1,inputcorrelation.Data(),inputfc.Data(),templatedir.Data(),collsyst,v2Dmin,v2hadmax,systmode,oldnames,subtrMCclos,centbin);
            ...
            outputfilename = "./Final_Plots_pPb/Singlev2Envelope/pPb_FDsubDstar";
            outputfilename += Form("Pt%dto%dassoc%1.1fto%1.1f",(int)Dpt[iDpt], (int)Dpt[iDpt+1], hadpt[ihadpt],hadptMax[ihadpt]);
            SubtractFDexploitingClassDstar(Dpt[iDpt],Dpt[iDpt+1],hadpt[ihadpt],hadptMax[ihadpt],outputfilename.Data(),2,purities[ihadpt],1,inputcorrelation.Data(),inputfc.Data(),templatedir.Data(),collsyst,v2Dmax,v2hadmin,systmode,oldnames,subtrMCclos,centbin);
            
            //________________________________________________________________
            // v2 combination 4
            outputfilename = "./Final_Plots_pPb/Singlev2Envelope/pPb_FDsubDstar";
            outputfilename += Form("Pt%dto%dassoc%1.1fto%1.1f",(int)Dpt[iDpt], (int)Dpt[iDpt+1], hadpt[ihadpt],hadptMax[ihadpt]);
            SubtractFDexploitingClassDstar(Dpt[iDpt],Dpt[iDpt+1],hadpt[ihadpt],hadptMax[ihadpt],outputfilename.Data(),2,purities[ihadpt],1,inputcorrelation.Data(),inputfc.Data(),templatedir.Data(),collsyst,v2Dmin,v2hadmin,systmode,oldnames,subtrMCclos,centbin);
        }
 ...
 /* DEACTIVATED */ //        purities[0]/=1.015;  purities[1]/= 1.010; purities[2]/= 1.042; purities[3]/= 1.063; purities[4]/= 1.069; purities[5]/= 1.038; purities[6]/= 1.063; 
    ...
    for(Int_t iDpt = dPtMin; iDpt <dPtmax; iDpt++){
        for(Int_t ihadpt = 0; ihadpt <dhadPtmax; ihadpt++){
            ...
            // running everything
            SubtractFDexploitingClassDstarv2Modulations(Dpt[iDpt],Dpt[iDpt+1],hadpt[ihadpt],hadptMax[ihadpt],outputfilename.Data(),2,purities[ihadpt],1,inputcorrelation.Data(),inputfc.Data(),templatedir.Data(),collsyst,systmode,oldnames,subtrMCclos,centbin); // collsyst is always set to 1!
