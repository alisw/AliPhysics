...
TString betadir="";
Double_t v2had=0.;
std::vector<Double_t> v2DmesonVsPt;
void SetV2values(Bool_t usev2=kTRUE,Double_t v2hadrons=0.1,Double_t v2Dmes3to5=0.1,Double_t v2Dmes5to8=0.1,Double_t v2Dmes8to16=0.1,Double_t v2Dmes16to24=0.1, Bool_t plotseparate=kFALSE){
  v2systOn=usev2;
  plotv2Separated=plotseparate;
  v2DmesonVsPt.push_back(v2Dmes3to5);
  v2DmesonVsPt.push_back(v2Dmes5to8);
  v2DmesonVsPt.push_back(v2Dmes8to16);
  v2DmesonVsPt.push_back(v2Dmes16to24);
  v2had=v2hadrons;
}
...
void Systematics_pPb_03to99had(Bool_t useReflected){
    ...
    systfitter->SetIsv2DvsPt(kTRUE);
    if(v2systOn){
      systfitter->Setv2ForSystematics(v2had, 4, v2DmesonVsPt); // Set v2 values for the systematics (v2had, v2 D x 4 ranges)
    ...
    systfitter->AddSystematicMode(AliHFCorrFitSystematics::kMinVar,kFALSE,0.25*TMath::Pi(),0.375*TMath::Pi(),0,AliHFCorrFitter::kModifNSGausPeriodicityFixBeta);
    systfitter->AddSystematicMode(AliHFCorrFitSystematics::kMaxVar,kFALSE,0.25*TMath::Pi(),0.375*TMath::Pi(),0,AliHFCorrFitter::kModifNSGausPeriodicityFixBeta);
  ...
  //  ishistoadded = systfitter->AddHistoToFit("~/Desktop/FinalPlots/ReflectedAverages/CanvaAndVariedHistoWeightedAverageDzeroDstarDplus_pPb_Pt5to8assocPt0.3to99.0.root");
      ishistoadded = systfitter->AddHistoToFit(Form("%s/CanvaAndVariedHisto%sAverageDzeroDstarDplus_pPb_Pt3to5assocPt0.3to99.0.root",path.Data(),strAverage.Data()));
   ...
   // ishistoadded = systfitter->AddHistoToFit("~/Desktop/FinalPlots/ReflectedAverages/CanvaAndVariedHistoWeightedAverageDzeroDstarDplus_pPb_Pt8to16assocPt0.3to99.0.root");
    ...
    // add histograms to fit (different pt bins of the
   // ishistoadded = systfitter->AddHistoToFit("~/Desktop/FinalPlots/ReflectedAverages/CanvaAndVariedHistoWeightedAverageDzeroDstarDplus_pPb_Pt8to16assocPt0.3to99.0.root");
      ishistoadded = systfitter->AddHistoToFit(Form("%s/CanvaAndVariedHisto%sAverageDzeroDstarDplus_pPb_Pt16to24assocPt0.3to99.0.root",path.Data(),strAverage.Data()));
...
void Systematics_pPb_03to1had(Bool_t useReflected){
...
/*    Bool_t ishistoadded;
    ...
    */
    ...
    ishistoadded = systfitter->AddHistoToFit(Form("%s/CanvaAndVariedHisto%sAverageDzeroDstarDplus_pPb_Pt3to5assocPt0.3to1.0.root",path.Data(),strAverage.Data()));
    systfitter->SetMinCorrelatedSystematicsDeltaPhi(0.05); // set min dphi scale syst uncertainty for the related histo
    systfitter->SetMaxCorrelatedSystematicsDeltaPhi(0.05); // set max dphi scale syst uncertainty for the related histo
    systfitter->SetDptLowEdge(3); systfitter->SetDptUpEdge(5); // set the pt range for the related histo
    if(!ishistoadded){cout << "cannot add histogram, exiting... " << endl; return;}
  ...
  //  ishistoadded = systfitter->AddHistoToFit("~/Desktop/FinalPlots/ReflectedAverages/CanvaAndVariedHistoWeightedAverageDzeroDstarDplus_pPb_Pt8to16assocPt0.3to1.0.root");
    ...
    // add histograms to fit (different pt bins of the
  //  ishistoadded = systfitter->AddHistoToFit("~/Desktop/FinalPlots/ReflectedAverages/CanvaAndVariedHistoWeightedAverageDzeroDstarDplus_pPb_Pt8to16assocPt0.3to1.0.root");
    ishistoadded = systfitter->AddHistoToFit(Form("%s/CanvaAndVariedHisto%sAverageDzeroDstarDplus_pPb_Pt16to24assocPt0.3to1.0.root",path.Data(),strAverage.Data()));
    systfitter->SetMinCorrelatedSystematicsDeltaPhi(0.05); // set min dphi scale syst uncertainty for the related histo
    systfitter->SetMaxCorrelatedSystematicsDeltaPhi(0.05); // set max dphi scale syst uncertainty for the related histo
    systfitter->SetDptLowEdge(16); systfitter->SetDptUpEdge(24); // set the pt range for the related histo
    if(!ishistoadded){cout << "cannot add histogram, exiting... " << endl; return;}    
...
//=========================================================================================================================================================================================================================
//=========================================================================================================================================================================================================================
void Systematics_pPb_1to99had(Bool_t useReflected){
 ...
 /*   Bool_t ishistoadded;
    ...
    */
    ...
    ishistoadded = systfitter->AddHistoToFit(Form("%s/CanvaAndVariedHisto%sAverageDzeroDstarDplus_pPb_Pt3to5assocPt1.0to99.0.root",path.Data(),strAverage.Data()));
    systfitter->SetMinCorrelatedSystematicsDeltaPhi(0.04); // set min dphi scale syst uncertainty for the related histo
    systfitter->SetMaxCorrelatedSystematicsDeltaPhi(0.04); // set max dphi scale syst uncertainty for the related histo
    systfitter->SetDptLowEdge(3); systfitter->SetDptUpEdge(5); // set the pt range for the related histo
    if(!ishistoadded){cout << "cannot add histogram, exiting... " << endl; return;}
    ...
    ishistoadded = systfitter->AddHistoToFit(Form("%s/CanvaAndVariedHisto%sAverageDzeroDstarDplus_pPb_Pt16to24assocPt1.0to99.0.root",path.Data(),strAverage.Data()));//
    systfitter->SetMinCorrelatedSystematicsDeltaPhi(0.04);// set min dphi scale syst uncertainty for the related histo
    systfitter->SetMaxCorrelatedSystematicsDeltaPhi(0.04); // set max dphi scale syst uncertainty for the related histo
    systfitter->SetDptLowEdge(16); systfitter->SetDptUpEdge(24); // set the pt range for the related histo
    if(!ishistoadded){cout << "cannot add histogram, exiting... " << endl; return;}
...
void Systematics_pPb_2to99had(Bool_t useReflected){
    ...
    // set up the sysfitter
    gROOT->ProcessLine(Form(".!mkdir -p %s/FitOutputs_pPb",outputpath.Data()));
    systfitter->CreateOutputFile(Form("%s/FitOutputs_pPb/FitSystematics_pPb_%sAverage_2.0_99.0.root",outputpath.Data(),strAverage.Data())); // set the name of the output file
    systfitter->SetUseCorrelatedSystematics(kTRUE); // kTRUE (will use the Delta phi independent systematics (from the correlation plots) to sum in quadrature for the final systematics)
    systfitter->SetUseCorrelatedSystematicsForWidths(kFALSE); //Delta phi independent systematics for the final systematics, ktrue will use them also for the widths, kfalse not (in my opinion, we should use kfalse)
    systfitter->SetCombineSystematicsMode(AliHFCorrFitSystematics::kEnvelope_RMS_BaselStat); // set method to compute the systematics due to the fixing of the baseline
    systfitter->SetIspPb(kTRUE); // kTrue for pPb, kFALSE for pp
 ...
 /*   Bool_t ishistoadded;
    ...
    */
    ...
    // add histograms to fit (different pt bins of the
    //ishistoadded = systfitter->AddHistoToFit("~/Desktop/FinalPlots/ReflectedAverages/CanvaAndVariedHistoWeightedAverageDzeroDstarDplus_pPb_Pt5to8assocPt1.0to99.0.root");
    ishistoadded = systfitter->AddHistoToFit(Form("%s/CanvaAndVariedHisto%sAverageDzeroDstarDplus_pPb_Pt3to5assocPt2.0to99.0.root",path.Data(),strAverage.Data()));
    systfitter->SetMinCorrelatedSystematicsDeltaPhi(0.04); // set min dphi scale syst uncertainty for the related histo
    systfitter->SetMaxCorrelatedSystematicsDeltaPhi(0.04); // set max dphi scale syst uncertainty for the related histo
    systfitter->SetDptLowEdge(3); systfitter->SetDptUpEdge(5); // set the pt range for the related histo
    if(!ishistoadded){cout << "cannot add histogram, exiting... " << endl; return;}

    ishistoadded = systfitter->AddHistoToFit(Form("%s/CanvaAndVariedHisto%sAverageDzeroDstarDplus_pPb_Pt5to8assocPt2.0to99.0.root",path.Data(),strAverage.Data()));
    systfitter->SetMinCorrelatedSystematicsDeltaPhi(0.04); // set min dphi scale syst uncertainty for the related histo
    systfitter->SetMaxCorrelatedSystematicsDeltaPhi(0.04); // set max dphi scale syst uncertainty for the related histo
    systfitter->SetDptLowEdge(5); systfitter->SetDptUpEdge(8); // set the pt range for the related histo
    if(!ishistoadded){cout << "cannot add histogram, exiting... " << endl; return;}
    
    ishistoadded = systfitter->AddHistoToFit(Form("%s/CanvaAndVariedHisto%sAverageDzeroDstarDplus_pPb_Pt8to16assocPt2.0to99.0.root",path.Data(),strAverage.Data()));//
    systfitter->SetMinCorrelatedSystematicsDeltaPhi(0.04); // set min dphi scale syst uncertainty for the related histo
    systfitter->SetMaxCorrelatedSystematicsDeltaPhi(0.04); // set max dphi scale syst uncertainty for the related histo
    systfitter->SetDptLowEdge(8); systfitter->SetDptUpEdge(16); // set the pt range for the related histo
    if(!ishistoadded){cout << "cannot add histogram, exiting... " << endl; return;}
    
    ishistoadded = systfitter->AddHistoToFit(Form("%s/CanvaAndVariedHisto%sAverageDzeroDstarDplus_pPb_Pt16to24assocPt2.0to99.0.root",path.Data(),strAverage.Data()));//
    systfitter->SetMinCorrelatedSystematicsDeltaPhi(0.05); // set min dphi scale syst uncertainty for the related histo
    systfitter->SetMaxCorrelatedSystematicsDeltaPhi(0.05); // set max dphi scale syst uncertainty for the related histo
    systfitter->SetDptLowEdge(16); systfitter->SetDptUpEdge(24); // set the pt range for the related histo
    if(!ishistoadded){cout << "cannot add histogram, exiting... " << endl; return;}
...
void Systematics_pPb_3to99had(Bool_t useReflected){
    ...
    // set up the sysfitter
    gROOT->ProcessLine(Form(".!mkdir -p %s/FitOutputs_pPb",outputpath.Data()));
    systfitter->CreateOutputFile(Form("%s/FitOutputs_pPb/FitSystematics_pPb_%sAverage_3.0_99.0.root",outputpath.Data(),strAverage.Data())); // set the name of the output file
    systfitter->SetUseCorrelatedSystematics(kTRUE); // kTRUE (will use the Delta phi independent systematics (from the correlation plots) to sum in quadrature for the final systematics)
    systfitter->SetUseCorrelatedSystematicsForWidths(kFALSE); //Delta phi independent systematics for the final systematics, ktrue will use them also for the widths, kfalse not (in my opinion, we should use kfalse)
    systfitter->SetCombineSystematicsMode(AliHFCorrFitSystematics::kEnvelope_RMS_BaselStat); // set method to compute the systematics due to the fixing of the baseline
    systfitter->SetIspPb(kTRUE); // kTrue for pPb, kFALSE for pp
 ...
 /*   Bool_t ishistoadded;
    ...
    */
    ...
    // add histograms to fit (different pt bins of the
    //ishistoadded = systfitter->AddHistoToFit("~/Desktop/FinalPlots/ReflectedAverages/CanvaAndVariedHistoWeightedAverageDzeroDstarDplus_pPb_Pt5to8assocPt1.0to99.0.root");
    ishistoadded = systfitter->AddHistoToFit(Form("%s/CanvaAndVariedHisto%sAverageDzeroDstarDplus_pPb_Pt3to5assocPt3.0to99.0.root",path.Data(),strAverage.Data()));
    systfitter->SetMinCorrelatedSystematicsDeltaPhi(0.04); // set min dphi scale syst uncertainty for the related histo
    systfitter->SetMaxCorrelatedSystematicsDeltaPhi(0.04); // set max dphi scale syst uncertainty for the related histo
    systfitter->SetDptLowEdge(3); systfitter->SetDptUpEdge(5); // set the pt range for the related histo
    if(!ishistoadded){cout << "cannot add histogram, exiting... " << endl; return;}

    ishistoadded = systfitter->AddHistoToFit(Form("%s/CanvaAndVariedHisto%sAverageDzeroDstarDplus_pPb_Pt5to8assocPt3.0to99.0.root",path.Data(),strAverage.Data()));
    systfitter->SetMinCorrelatedSystematicsDeltaPhi(0.04); // set min dphi scale syst uncertainty for the related histo
    systfitter->SetMaxCorrelatedSystematicsDeltaPhi(0.04); // set max dphi scale syst uncertainty for the related histo
    systfitter->SetDptLowEdge(5); systfitter->SetDptUpEdge(8); // set the pt range for the related histo
    if(!ishistoadded){cout << "cannot add histogram, exiting... " << endl; return;}
    
    ishistoadded = systfitter->AddHistoToFit(Form("%s/CanvaAndVariedHisto%sAverageDzeroDstarDplus_pPb_Pt8to16assocPt3.0to99.0.root",path.Data(),strAverage.Data()));//
    systfitter->SetMinCorrelatedSystematicsDeltaPhi(0.04); // set min dphi scale syst uncertainty for the related histo
    systfitter->SetMaxCorrelatedSystematicsDeltaPhi(0.04); // set max dphi scale syst uncertainty for the related histo
    systfitter->SetDptLowEdge(8); systfitter->SetDptUpEdge(16); // set the pt range for the related histo
    if(!ishistoadded){cout << "cannot add histogram, exiting... " << endl; return;}
    
    ishistoadded = systfitter->AddHistoToFit(Form("%s/CanvaAndVariedHisto%sAverageDzeroDstarDplus_pPb_Pt16to24assocPt3.0to99.0.root",path.Data(),strAverage.Data()));//
    systfitter->SetMinCorrelatedSystematicsDeltaPhi(0.05); // set min dphi scale syst uncertainty for the related histo
    systfitter->SetMaxCorrelatedSystematicsDeltaPhi(0.05); // set max dphi scale syst uncertainty for the related histo
    systfitter->SetDptLowEdge(16); systfitter->SetDptUpEdge(24); // set the pt range for the related histo
    if(!ishistoadded){cout << "cannot add histogram, exiting... " << endl; return;}
...
void Systematics_pPb_1to2had(Bool_t useReflected){
    ...
    // set up the sysfitter
    gROOT->ProcessLine(Form(".!mkdir -p %s/FitOutputs_pPb",outputpath.Data()));
    systfitter->CreateOutputFile(Form("%s/FitOutputs_pPb/FitSystematics_pPb_%sAverage_1.0_2.0.root",outputpath.Data(),strAverage.Data())); // set the name of the output file
    systfitter->SetUseCorrelatedSystematics(kTRUE); // kTRUE (will use the Delta phi independent systematics (from the correlation plots) to sum in quadrature for the final systematics)
    systfitter->SetUseCorrelatedSystematicsForWidths(kFALSE); //Delta phi independent systematics for the final systematics, ktrue will use them also for the widths, kfalse not (in my opinion, we should use kfalse)
    systfitter->SetCombineSystematicsMode(AliHFCorrFitSystematics::kEnvelope_RMS_BaselStat); // set method to compute the systematics due to the fixing of the baseline
    systfitter->SetIspPb(kTRUE); // kTrue for pPb, kFALSE for pp
 ...
 /*   Bool_t ishistoadded;
    ...
    */
    ...
    // add histograms to fit (different pt bins of the
    //ishistoadded = systfitter->AddHistoToFit("~/Desktop/FinalPlots/ReflectedAverages/CanvaAndVariedHistoWeightedAverageDzeroDstarDplus_pPb_Pt5to8assocPt1.0to99.0.root");
    ishistoadded = systfitter->AddHistoToFit(Form("%s/CanvaAndVariedHisto%sAverageDzeroDstarDplus_pPb_Pt3to5assocPt1.0to2.0.root",path.Data(),strAverage.Data()));
    systfitter->SetMinCorrelatedSystematicsDeltaPhi(0.04); // set min dphi scale syst uncertainty for the related histo
    systfitter->SetMaxCorrelatedSystematicsDeltaPhi(0.04); // set max dphi scale syst uncertainty for the related histo
    systfitter->SetDptLowEdge(3); systfitter->SetDptUpEdge(5); // set the pt range for the related histo
    if(!ishistoadded){cout << "cannot add histogram, exiting... " << endl; return;}

    ishistoadded = systfitter->AddHistoToFit(Form("%s/CanvaAndVariedHisto%sAverageDzeroDstarDplus_pPb_Pt5to8assocPt1.0to2.0.root",path.Data(),strAverage.Data()));
    systfitter->SetMinCorrelatedSystematicsDeltaPhi(0.04); // set min dphi scale syst uncertainty for the related histo
    systfitter->SetMaxCorrelatedSystematicsDeltaPhi(0.04); // set max dphi scale syst uncertainty for the related histo
    systfitter->SetDptLowEdge(5); systfitter->SetDptUpEdge(8); // set the pt range for the related histo
    if(!ishistoadded){cout << "cannot add histogram, exiting... " << endl; return;}
    
    ishistoadded = systfitter->AddHistoToFit(Form("%s/CanvaAndVariedHisto%sAverageDzeroDstarDplus_pPb_Pt8to16assocPt1.0to2.0.root",path.Data(),strAverage.Data()));//
    systfitter->SetMinCorrelatedSystematicsDeltaPhi(0.04); // set min dphi scale syst uncertainty for the related histo
    systfitter->SetMaxCorrelatedSystematicsDeltaPhi(0.04); // set max dphi scale syst uncertainty for the related histo
    systfitter->SetDptLowEdge(8); systfitter->SetDptUpEdge(16); // set the pt range for the related histo
    if(!ishistoadded){cout << "cannot add histogram, exiting... " << endl; return;}
    
    ishistoadded = systfitter->AddHistoToFit(Form("%s/CanvaAndVariedHisto%sAverageDzeroDstarDplus_pPb_Pt16to24assocPt1.0to2.0.root",path.Data(),strAverage.Data()));//
    systfitter->SetMinCorrelatedSystematicsDeltaPhi(0.04); // set min dphi scale syst uncertainty for the related histo
    systfitter->SetMaxCorrelatedSystematicsDeltaPhi(0.04); // set max dphi scale syst uncertainty for the related histo
    systfitter->SetDptLowEdge(16); systfitter->SetDptUpEdge(24); // set the pt range for the related histo
    if(!ishistoadded){cout << "cannot add histogram, exiting... " << endl; return;}
...
void Systematics_pPb_2to3had(Bool_t useReflected){
    ...
    // set up the sysfitter
    gROOT->ProcessLine(Form(".!mkdir -p %s/FitOutputs_pPb",outputpath.Data()));
    systfitter->CreateOutputFile(Form("%s/FitOutputs_pPb/FitSystematics_pPb_%sAverage_2.0_3.0.root",outputpath.Data(),strAverage.Data())); // set the name of the output file
    systfitter->SetUseCorrelatedSystematics(kTRUE); // kTRUE (will use the Delta phi independent systematics (from the correlation plots) to sum in quadrature for the final systematics)
    systfitter->SetUseCorrelatedSystematicsForWidths(kFALSE); //Delta phi independent systematics for the final systematics, ktrue will use them also for the widths, kfalse not (in my opinion, we should use kfalse)
    systfitter->SetCombineSystematicsMode(AliHFCorrFitSystematics::kEnvelope_RMS_BaselStat); // set method to compute the systematics due to the fixing of the baseline
    systfitter->SetIspPb(kTRUE); // kTrue for pPb, kFALSE for pp
 ...
 /*   Bool_t ishistoadded;
    ...
    */
    ...
    // add histograms to fit (different pt bins of the
    //ishistoadded = systfitter->AddHistoToFit("~/Desktop/FinalPlots/ReflectedAverages/CanvaAndVariedHistoWeightedAverageDzeroDstarDplus_pPb_Pt5to8assocPt1.0to99.0.root");
    ishistoadded = systfitter->AddHistoToFit(Form("%s/CanvaAndVariedHisto%sAverageDzeroDstarDplus_pPb_Pt3to5assocPt2.0to3.0.root",path.Data(),strAverage.Data()));
    systfitter->SetMinCorrelatedSystematicsDeltaPhi(0.04); // set min dphi scale syst uncertainty for the related histo
    systfitter->SetMaxCorrelatedSystematicsDeltaPhi(0.04); // set max dphi scale syst uncertainty for the related histo
    systfitter->SetDptLowEdge(3); systfitter->SetDptUpEdge(5); // set the pt range for the related histo
    if(!ishistoadded){cout << "cannot add histogram, exiting... " << endl; return;}

    ishistoadded = systfitter->AddHistoToFit(Form("%s/CanvaAndVariedHisto%sAverageDzeroDstarDplus_pPb_Pt5to8assocPt2.0to3.0.root",path.Data(),strAverage.Data()));
    systfitter->SetMinCorrelatedSystematicsDeltaPhi(0.04); // set min dphi scale syst uncertainty for the related histo
    systfitter->SetMaxCorrelatedSystematicsDeltaPhi(0.04); // set max dphi scale syst uncertainty for the related histo
    systfitter->SetDptLowEdge(5); systfitter->SetDptUpEdge(8); // set the pt range for the related histo
    if(!ishistoadded){cout << "cannot add histogram, exiting... " << endl; return;}
    
    ishistoadded = systfitter->AddHistoToFit(Form("%s/CanvaAndVariedHisto%sAverageDzeroDstarDplus_pPb_Pt8to16assocPt2.0to3.0.root",path.Data(),strAverage.Data()));//
    systfitter->SetMinCorrelatedSystematicsDeltaPhi(0.04); // set min dphi scale syst uncertainty for the related histo
    systfitter->SetMaxCorrelatedSystematicsDeltaPhi(0.04); // set max dphi scale syst uncertainty for the related histo
    systfitter->SetDptLowEdge(8); systfitter->SetDptUpEdge(16); // set the pt range for the related histo
    if(!ishistoadded){cout << "cannot add histogram, exiting... " << endl; return;}
    
    ishistoadded = systfitter->AddHistoToFit(Form("%s/CanvaAndVariedHisto%sAverageDzeroDstarDplus_pPb_Pt16to24assocPt2.0to3.0.root",path.Data(),strAverage.Data()));//
    systfitter->SetMinCorrelatedSystematicsDeltaPhi(0.04); // set min dphi scale syst uncertainty for the related histo
    systfitter->SetMaxCorrelatedSystematicsDeltaPhi(0.04); // set max dphi scale syst uncertainty for the related histo
    systfitter->SetDptLowEdge(16); systfitter->SetDptUpEdge(24); // set the pt range for the related histo
    if(!ishistoadded){cout << "cannot add histogram, exiting... " << endl; return;}
...
//TEMPLATE CASE
void SystematicsMC_pPb_03to99had(Bool_t useReflected,TString strTemplRootName){
...
void SystematicsMC_pPb_03to1had(Bool_t useReflected,TString strTemplRootName){
...
void SystematicsMC_pPb_1to99had(Bool_t useReflected,TString strTemplRootName){
...
void SystematicsMC_pPb_2to99had(Bool_t useReflected,TString strTemplRootName){
    ...
    gROOT->ProcessLine(Form(".!mkdir -p %s/FitOutputs_pPb",outputpath.Data()));
    systfitter->SetIsFittingTemplate(kTRUE); 
    systfitter->CreateOutputFile(Form("%s/FitOutputs_pPb/FitSystematics_pPb_%s_2.0_99.0.root",outputpath.Data(),mcCase.Data())); // set the name of the output file
    systfitter->SetUseCorrelatedSystematics(kFALSE); // kTRUE (will use the Delta phi independent systematics (from the correlation plots) to sum in quadrature for the final systematics)
    systfitter->SetUseCorrelatedSystematicsForWidths(kFALSE); //Delta phi independent systematics for the final systematics, ktrue will use them also for the widths, kfalse not (in my opinion, we should use kfalse)
    systfitter->SetCombineSystematicsMode(AliHFCorrFitSystematics::kRMS); // set method to compute the systematics due to the fixing of the baseline
    systfitter->SetIspPb(kFALSE); // kTrue for pPb, kFALSE for pp
...
void SystematicsMC_pPb_3to99had(Bool_t useReflected,TString strTemplRootName){
    ...
    gROOT->ProcessLine(Form(".!mkdir -p %s/FitOutputs_pPb",outputpath.Data()));
    systfitter->SetIsFittingTemplate(kTRUE); 
    systfitter->CreateOutputFile(Form("%s/FitOutputs_pPb/FitSystematics_pPb_%s_3.0_99.0.root",outputpath.Data(),mcCase.Data())); // set the name of the output file
    systfitter->SetUseCorrelatedSystematics(kFALSE); // kTRUE (will use the Delta phi independent systematics (from the correlation plots) to sum in quadrature for the final systematics)
    systfitter->SetUseCorrelatedSystematicsForWidths(kFALSE); //Delta phi independent systematics for the final systematics, ktrue will use them also for the widths, kfalse not (in my opinion, we should use kfalse)
    systfitter->SetCombineSystematicsMode(AliHFCorrFitSystematics::kRMS); // set method to compute the systematics due to the fixing of the baseline
    systfitter->SetIspPb(kFALSE); // kTrue for pPb, kFALSE for pp
...
void SystematicsMC_pPb_1to2had(Bool_t useReflected,TString strTemplRootName){
    ...
    gROOT->ProcessLine(Form(".!mkdir -p %s/FitOutputs_pPb",outputpath.Data()));
    systfitter->SetIsFittingTemplate(kTRUE); 
    systfitter->CreateOutputFile(Form("%s/FitOutputs_pPb/FitSystematics_pPb_%s_1.0_2.0.root",outputpath.Data(),mcCase.Data())); // set the name of the output file
    systfitter->SetUseCorrelatedSystematics(kFALSE); // kTRUE (will use the Delta phi independent systematics (from the correlation plots) to sum in quadrature for the final systematics)
    systfitter->SetUseCorrelatedSystematicsForWidths(kFALSE); //Delta phi independent systematics for the final systematics, ktrue will use them also for the widths, kfalse not (in my opinion, we should use kfalse)
    systfitter->SetCombineSystematicsMode(AliHFCorrFitSystematics::kRMS); // set method to compute the systematics due to the fixing of the baseline
    systfitter->SetIspPb(kFALSE); // kTrue for pPb, kFALSE for pp
...
void SystematicsMC_pPb_2to3had(Bool_t useReflected,TString strTemplRootName){
    ...
    gROOT->ProcessLine(Form(".!mkdir -p %s/FitOutputs_pPb",outputpath.Data()));
    systfitter->SetIsFittingTemplate(kTRUE); 
    systfitter->CreateOutputFile(Form("%s/FitOutputs_pPb/FitSystematics_pPb_%s_2.0_3.0.root",outputpath.Data(),mcCase.Data())); // set the name of the output file
    systfitter->SetUseCorrelatedSystematics(kFALSE); // kTRUE (will use the Delta phi independent systematics (from the correlation plots) to sum in quadrature for the final systematics)
    systfitter->SetUseCorrelatedSystematicsForWidths(kFALSE); //Delta phi independent systematics for the final systematics, ktrue will use them also for the widths, kfalse not (in my opinion, we should use kfalse)
    systfitter->SetCombineSystematicsMode(AliHFCorrFitSystematics::kRMS); // set method to compute the systematics due to the fixing of the baseline
    systfitter->SetIspPb(kFALSE); // kTrue for pPb, kFALSE for pp
