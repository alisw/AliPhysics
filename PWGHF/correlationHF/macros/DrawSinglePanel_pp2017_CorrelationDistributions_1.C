...
Double_t minYaxis[nbinAssocpt]={-0.6,-0.65,-0.4}; // or -0.6 for all  
Double_t maxYaxis[nbinAssocpt]={4.4,1.6,3.3};// or 4.1 for the first , 2.9 for the middle and 1.9 for the last
...
void DrawSinglePanel_CorrelationDistributions_1(){
...
*/
  ...
  cFinalPaperStyle->SaveAs(Form("%s/DrawSinglePanel_CorrelationDistributions_%sAverage_1.root",outdir.Data(),avType.Data()));
  cFinalPaperStyle->SaveAs(Form("%s/DrawSinglePanel_CorrelationDistributions_%sAverage_1.png",outdir.Data(),avType.Data()));
  cFinalPaperStyle->SaveAs(Form("%s/DrawSinglePanel_CorrelationDistributions_%sAverage_1.pdf",outdir.Data(),avType.Data()));
  cFinalPaperStyle->SaveAs(Form("%s/DrawSinglePanel_CorrelationDistributions_%sAverage_1.eps",outdir.Data(),avType.Data()));
