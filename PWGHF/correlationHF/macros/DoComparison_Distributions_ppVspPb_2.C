...
*/
  ...
  cFinalPaperStyle->SaveAs(Form("%s/plotComparison_%sAverage_pp_pPb_UniqueCanvas_Style%d_2.root",outdir.Data(),avType.Data(),style));
  cFinalPaperStyle->SaveAs(Form("%s/plotComparison_%sAverage_pp_pPb_UniqueCanvas_Style%d_2.png",outdir.Data(),avType.Data(),style));
  cFinalPaperStyle->SaveAs(Form("%s/plotComparison_%sAverage_pp_pPb_UniqueCanvas_Style%d_2.pdf",outdir.Data(),avType.Data(),style));
  cFinalPaperStyle->SaveAs(Form("%s/plotComparison_%sAverage_pp_pPb_UniqueCanvas_Style%d_2.eps",outdir.Data(),avType.Data(),style));
