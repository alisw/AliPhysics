...
void GetEnvelopeForEachV2(){
    ...
    for(Int_t iDpt = 1; iDpt <3; iDpt++){
	    ...
	    //            inputcorrelation = "./Dzero/Input_Plots_pPb/1D_Signal_WithEMCorr_Normal_Charg_OriginSuper_Integrated";
	    //            inputcorrelation += Form("_Bins%dto%d_Limits_2_4_TreshPt_%1.1fto%1.1f_Displ_0.00_Data.root",(int)Dptbin[0], (int)Dptbin[1], hadpt[ihadpt],hadptMax[ihadpt]); // I guess all your input data files have
	    ...
	    //            outputfilename += Form("Pt%dto%dassoc%1.1fto%1.1f",(int)Dpt[iDpt], (int)Dpt[iDpt+1], hadpt[ihadpt],hadptMax[ihadpt]);
            ...
            outputfilename = "./Final_Plots_pPb/Singlev2Envelope/pPb_FDsubDzero";
            outputfilename += Form("Pt%dto%dassoc%1.1fto%1.1f",(int)Dpt[iDpt], (int)Dpt[iDpt+1], hadpt[ihadpt],hadptMax[ihadpt]);
            SubtractFDexploitingClassDzero(Dpt[iDpt],Dpt[iDpt+1],hadpt[ihadpt],hadptMax[ihadpt],outputfilename.Data(),2,purities[ihadpt],1,inputcorrelation.Data(),inputfc.Data(),templatedir.Data(),collsyst,v2Dmax,v2hadmax,systmode);
            ...
            outputfilename = "./Final_Plots_pPb/Singlev2Envelope/pPb_FDsubDzero";
            outputfilename += Form("Pt%dto%dassoc%1.1fto%1.1f",(int)Dpt[iDpt], (int)Dpt[iDpt+1], hadpt[ihadpt],hadptMax[ihadpt]);
            SubtractFDexploitingClassDzero(Dpt[iDpt],Dpt[iDpt+1],hadpt[ihadpt],hadptMax[ihadpt],outputfilename.Data(),2,purities[ihadpt],1,inputcorrelation.Data(),inputfc.Data(),templatedir.Data(),collsyst,v2Dmin,v2hadmax,systmode);
            ...
            outputfilename = "./Final_Plots_pPb/Singlev2Envelope/pPb_FDsubDzero";
            outputfilename += Form("Pt%dto%dassoc%1.1fto%1.1f",(int)Dpt[iDpt], (int)Dpt[iDpt+1], hadpt[ihadpt],hadptMax[ihadpt]);
            SubtractFDexploitingClassDzero(Dpt[iDpt],Dpt[iDpt+1],hadpt[ihadpt],hadptMax[ihadpt],outputfilename.Data(),2,purities[ihadpt],1,inputcorrelation.Data(),inputfc.Data(),templatedir.Data(),collsyst,v2Dmax,v2hadmin,systmode);
            
            //________________________________________________________________
            // v2 combination 4
            outputfilename = "./Final_Plots_pPb/Singlev2Envelope/pPb_FDsubDzero";
            outputfilename += Form("Pt%dto%dassoc%1.1fto%1.1f",(int)Dpt[iDpt], (int)Dpt[iDpt+1], hadpt[ihadpt],hadptMax[ihadpt]);
            SubtractFDexploitingClassDzero(Dpt[iDpt],Dpt[iDpt+1],hadpt[ihadpt],hadptMax[ihadpt],outputfilename.Data(),2,purities[ihadpt],1,inputcorrelation.Data(),inputfc.Data(),templatedir.Data(),collsyst,v2Dmin,v2hadmin,systmode);
        }
...
void GetTotalEnvelopeFromV2(){
    ...
    for(Int_t iDpt = 1; iDpt <3; iDpt++){
	    ...
	    //            inputcorrelation += Form("_Bins%dto%d_Limits_2_4_TreshPt_%1.1fto%1.1f_Displ_0.00_Data.root",(int)Dptbin[0], (int)Dptbin[1], hadpt[ihadpt],hadptMax[ihadpt]); // I guess all your input data files have
            ...
            // running everything
            SubtractFDexploitingClassDzerov2Modulations(Dpt[iDpt],Dpt[iDpt+1],hadpt[ihadpt],hadptMax[ihadpt],outputfilename.Data(),2,purities[ihadpt],1,inputcorrelation.Data(),inputfc.Data(),templatedir.Data(),1,systmode); // collsyst is always set to 1!
