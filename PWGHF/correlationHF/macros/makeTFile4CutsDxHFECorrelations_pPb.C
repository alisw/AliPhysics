...
//Author: Per-Ivar Lønne
//Based on macro from Fabio Colamaria
//macro to make a .root file which contains an AliRDHFCutsD0toKpi for AliAnalysisTaskSED0Mass task

void makeTFile4CutsDxHFECorrelations_pPb(TString arguments=""){
  TString taskOptions;
  Int_t system=2; //Only used for pPb at the moment
  Int_t D0cutset=0;
  TString outFilename="D0toKpiCuts_DxHFE";
  TString extraname="";
  //Set Centrality
  Float_t minc=0,maxc=100;
  

  //Scanning through arguments
  ...
  if (tokens) {
	...
	cout<<"Use pPb"<<endl;
      ...
      if(argument.BeginsWith("D0cutset=")){
	argument.ReplaceAll("D0cutset=", "");
	D0cutset=argument.Atoi();
      }
  ...
  if(D0cutset==0){//This is the default cutset
  ...
  if(D0cutset==1){//This is an almost completely open cutset. pointing angle and d0xd0 changed from cutset 0 
    Float_t cutsMatrixD0toKpiStand[nptbins][nvars]={{0.400,350.*1E-4,0.8,0.5,0.5,1000.*1E-4,1000.*1E-4,10000.*1E-8,0.5,0.,3.2},/* pt<0.5*/
						    {0.400,350.*1E-4,0.8,0.5,0.5,1000.*1E-4,1000.*1E-4,10000.*1E-8,0.5,0.,3.2},/* 0.5<pt<1*/
						    {0.400,300.*1E-4,0.8,0.4,0.4,1000.*1E-4,1000.*1E-4,10000.*1E-8,0.5,0.,0.},/* 1<pt<2 */
						    {0.400,300.*1E-4,0.8,0.7,0.7,1000.*1E-4,1000.*1E-4,10000.*1E-8,0.5,0.,0.},/* 2<pt<3 */
						    {0.400,300.*1E-4,0.8,0.7,0.7,1000.*1E-4,1000.*1E-4,10000.*1E-8,0.5,0.,0.},/* 3<pt<4 */
						    {0.400,300.*1E-4,0.8,0.7,0.7,1000.*1E-4,1000.*1E-4,10000.*1E-8,0.5,0.,0.},/* 4<pt<5 */
						    {0.400,300.*1E-4,0.8,0.7,0.7,1000.*1E-4,1000.*1E-4,10000.*1E-8,0.5,0.,0.},/* 5<pt<6 */
						    {0.400,300.*1E-4,0.8,0.7,0.7,1000.*1E-4,1000.*1E-4,10000.*1E-8,0.5,0.,0.},/* 6<pt<7 */
						    {0.400,300.*1E-4,0.8,0.7,0.7,1000.*1E-4,1000.*1E-4,10000.*1E-8,0.5,0.,0.},/* 7<pt<8 */
						    {0.400,300.*1E-4,0.9,0.7,0.7,1000.*1E-4,1000.*1E-4,10000.*1E-8,0.5,0.,0.},/* 8<pt<12 */
						    {0.400,300.*1E-4,1.0,0.7,0.7,1000.*1E-4,1000.*1E-4,10000.*1E-8,0.5,0.,0.},/* 12<pt<16 */
						    {0.400,300.*1E-4,1.0,0.7,0.7,1000.*1E-4,1000.*1E-4,10000.*1E-8,0.5,0.,0.},/* 16<pt<20 */
						    {0.400,300.*1E-4,1.0,0.7,0.7,1000.*1E-4,1000.*1E-4,10000.*1E-8,0.5,0.,0.},/* 20<pt<24 */
						    {0.400,300.*1E-4,1.0,0.7,0.7,1000.*1E-4,1000.*1E-4,10000.*1E-8,0.5,0.,0.}};/* pt>24 */
  }


  if(D0cutset==2){//This is a significantly open cutset, but more strict than cutset1. pointing angle and d0xd0 changed from cutset 0 
    Float_t cutsMatrixD0toKpiStand[nptbins][nvars]={{0.400,350.*1E-4,0.8,0.5,0.5,1000.*1E-4,1000.*1E-4,0.,0.7,0.,3.2},/* pt<0.5*/
						    {0.400,350.*1E-4,0.8,0.5,0.5,1000.*1E-4,1000.*1E-4,0.,0.7,0.,3.2},/* 0.5<pt<1*/
						    {0.400,300.*1E-4,0.8,0.4,0.4,1000.*1E-4,1000.*1E-4,0.,0.7,0.,0.},/* 1<pt<2 */
						    {0.400,300.*1E-4,0.8,0.7,0.7,1000.*1E-4,1000.*1E-4,0.,0.7,0.,0.},/* 2<pt<3 */
						    {0.400,300.*1E-4,0.8,0.7,0.7,1000.*1E-4,1000.*1E-4,0.,0.7,0.,0.},/* 3<pt<4 */
						    {0.400,300.*1E-4,0.8,0.7,0.7,1000.*1E-4,1000.*1E-4,0.,0.7,0.,0.},/* 4<pt<5 */
						    {0.400,300.*1E-4,0.8,0.7,0.7,1000.*1E-4,1000.*1E-4,0.,0.7,0.,0.},/* 5<pt<6 */
						    {0.400,300.*1E-4,0.8,0.7,0.7,1000.*1E-4,1000.*1E-4,0.,0.7,0.,0.},/* 6<pt<7 */
						    {0.400,300.*1E-4,0.8,0.7,0.7,1000.*1E-4,1000.*1E-4,0.,0.7,0.,0.},/* 7<pt<8 */
						    {0.400,300.*1E-4,0.9,0.7,0.7,1000.*1E-4,1000.*1E-4,0.,0.7,0.,0.},/* 8<pt<12 */
						    {0.400,300.*1E-4,1.0,0.7,0.7,1000.*1E-4,1000.*1E-4,0.,0.7,0.,0.},/* 12<pt<16 */
						    {0.400,300.*1E-4,1.0,0.7,0.7,1000.*1E-4,1000.*1E-4,0.,0.7,0.,0.},/* 16<pt<20 */
						    {0.400,300.*1E-4,1.0,0.7,0.7,1000.*1E-4,1000.*1E-4,0.,0.7,0.,0.},/* 20<pt<24 */
						    {0.400,300.*1E-4,1.0,0.7,0.7,1000.*1E-4,1000.*1E-4,0.,0.7,0.,0.}};/* pt>24 */
    }

  if(D0cutset==3){//This is a moderately open cutset. More strict than cutset2. pointing angle and d0xd0 changed from cutset 0.
    //More open after 5GeV
    Float_t cutsMatrixD0toKpiStand[nptbins][nvars]={{0.400,350.*1E-4,0.8,0.5,0.5,1000.*1E-4,1000.*1E-4,-5000.*1E-8,0.85,0.,3.2},/* pt<0.5*/
						    {0.400,350.*1E-4,0.8,0.5,0.5,1000.*1E-4,1000.*1E-4,-5000.*1E-8,0.85,0.,3.2},/* 0.5<pt<1*/
						    {0.400,300.*1E-4,0.8,0.4,0.4,1000.*1E-4,1000.*1E-4,-5000.*1E-8,0.85,0.,0.},/* 1<pt<2 */
						    {0.400,300.*1E-4,0.8,0.7,0.7,1000.*1E-4,1000.*1E-4,-5000.*1E-8,0.85,0.,0.},/* 2<pt<3 */
						    {0.400,300.*1E-4,0.8,0.7,0.7,1000.*1E-4,1000.*1E-4,-5000.*1E-8,0.85,0.,0.},/* 3<pt<4 */
						    {0.400,300.*1E-4,0.8,0.7,0.7,1000.*1E-4,1000.*1E-4,-5000.*1E-8,0.85,0.,0.},/* 4<pt<5 */
						    {0.400,300.*1E-4,0.8,0.7,0.7,1000.*1E-4,1000.*1E-4,0.,0.8,0.,0.},/* 5<pt<6 */
						    {0.400,300.*1E-4,0.8,0.7,0.7,1000.*1E-4,1000.*1E-4,0.,0.8,0.,0.},/* 6<pt<7 */
						    {0.400,300.*1E-4,0.8,0.7,0.7,1000.*1E-4,1000.*1E-4,0.,0.8,0.,0.},/* 7<pt<8 */
						    {0.400,300.*1E-4,0.9,0.7,0.7,1000.*1E-4,1000.*1E-4,0.,0.8,0.,0.},/* 8<pt<12 */
						    {0.400,300.*1E-4,1.0,0.7,0.7,1000.*1E-4,1000.*1E-4,0.,0.8,0.,0.},/* 12<pt<16 */
						    {0.400,300.*1E-4,1.0,0.7,0.7,1000.*1E-4,1000.*1E-4,0.,0.8,0.,0.},/* 16<pt<20 */
						    {0.400,300.*1E-4,1.0,0.7,0.7,1000.*1E-4,1000.*1E-4,0.,0.8,0.,0.},/* 20<pt<24 */
						    {0.400,300.*1E-4,1.0,0.7,0.7,1000.*1E-4,1000.*1E-4,0.,0.8,0.,0.}};/* pt>24 */
  }

  if(D0cutset==4){//Based on cutset 0, more open for 5-8GeV
    Float_t cutsMatrixD0toKpiStand[nptbins][nvars]={{0.400,350.*1E-4,0.8,0.5,0.5,1000.*1E-4,1000.*1E-4,-0.000325,0.80,0.,3.2},/* pt<0.5*/
						    {0.400,350.*1E-4,0.8,0.5,0.5,1000.*1E-4,1000.*1E-4,-0.000325,0.80,0.,3.2},/* 0.5<pt<1*/
						    {0.400,300.*1E-4,0.8,0.4,0.4,1000.*1E-4,1000.*1E-4,-35000.*1E-8,0.90,0.,0.},/* 1<pt<2 */
						    {0.400,300.*1E-4,0.8,0.7,0.7,1000.*1E-4,1000.*1E-4,-30000.*1E-8,0.90,0.,0.},/* 2<pt<3 */
						    {0.400,300.*1E-4,0.8,0.7,0.7,1000.*1E-4,1000.*1E-4,-30000.*1E-8,0.90,0.,0.},/* 3<pt<4 */
						    {0.400,300.*1E-4,0.8,0.7,0.7,1000.*1E-4,1000.*1E-4,-15000.*1E-8,0.90,0.,0.},/* 4<pt<5 */
						    {0.400,300.*1E-4,0.8,0.7,0.7,1000.*1E-4,1000.*1E-4,-5000.*1E-8,0.85,0.,0.},/* 5<pt<6 */
						    {0.400,300.*1E-4,0.8,0.7,0.7,1000.*1E-4,1000.*1E-4,-5000.*1E-8,0.85,0.,0.},/* 6<pt<7 */
						    {0.400,300.*1E-4,0.8,0.7,0.7,1000.*1E-4,1000.*1E-4,-5000.*1E-8,0.85,0.,0.},/* 7<pt<8 */
						    {0.400,300.*1E-4,0.9,0.7,0.7,1000.*1E-4,1000.*1E-4,-5000.*1E-8,0.85,0.,0.},/* 8<pt<12 */
						    {0.400,300.*1E-4,1.0,0.7,0.7,1000.*1E-4,1000.*1E-4,10000.*1E-8,0.85,0.,0.},/* 12<pt<16 */
						    {0.400,300.*1E-4,1.0,0.7,0.7,1000.*1E-4,1000.*1E-4,10000.*1E-8,0.85,0.,0.},/* 16<pt<20 */
						    {0.400,300.*1E-4,1.0,0.7,0.7,1000.*1E-4,1000.*1E-4,10000.*1E-8,0.85,0.,0.},/* 20<pt<24 */
...
//  RDHFD0Corr->SetOptPileup(AliRDHFCuts::kRejectPileupEvent);
  ...
  if(system==0){outFilename+="_pp";
  }else if (system==1){outFilename+="_PbPb";
  }else if (system==2){outFilename+="_pPb";
  }
  outFilename+=Form("_cutset%d",D0cutset);
  outFilename+="_"+cent;
  if(!extraname.Length()==0)  outFilename+="_"+extraname;
  outFilename+=".root";
  TFile* fout=new TFile(outFilename,"recreate");   //set this!! 
...
//esdHadrCuts->SetClusterRequirementITS(AliESDtrackCuts::kSPD,AliESDtrackCuts::kAny);
  ...
  TFile* fout=new TFile("AssocPartCuts_pPb_0_100_NewPoolsAndCode_10000Tr.root","recreate");   //set this!! 
  fout->cd();
