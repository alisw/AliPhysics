...
void Systematics_pp_lowpthad(Bool_t useReflected){
...
//=========================================================================================================================================================================================================================
//=========================================================================================================================================================================================================================
void Systematics_pp_highpthad(Bool_t useReflected){
 ...
 //   systfitter->AddSystematicMode(AliHFCorrFitSystematics::k2PointsAtPiHalf,kFALSE);
    ...
    Bool_t ishistoadded;
    // add histograms to fit (different pt bins of the
    //ishistoadded = systfitter->AddHistoToFit("~/Desktop/FinalPlots/ReflectedAverages/CanvaAndVariedHistoWeightedAverageDzeroDstarDplus_pp_Pt3to5assocPt1.0to99.0.root");
    ...
    Bool_t ishistoadded;
    // add histograms to fit (different pt bins of the
    //ishistoadded = systfitter->AddHistoToFit("~/Desktop/FinalPlots/ReflectedAverages/CanvaAndVariedHistoWeightedAverageDzeroDstarDplus_pp_Pt5to8assocPt1.0to99.0.root");
    ...
    Bool_t ishistoadded;
    // add histograms to fit (different pt bins of the
   // ishistoadded = systfitter->AddHistoToFit("~/Desktop/FinalPlots/ReflectedAverages/CanvaAndVariedHistoWeightedAverageDzeroDstarDplus_pp_Pt8to16assocPt1.0to99.0.root");
...
void Systematics_pp_integratedpthad(Bool_t useReflected){
    ...
    Bool_t ishistoadded;
    // add histograms to fit (different pt bins of the
   // ishistoadded = systfitter->AddHistoToFit("~/Desktop/FinalPlots/ReflectedAverages/CanvaAndVariedHistoWeightedAverageDzeroDstarDplus_pp_Pt3to5assocPt0.3to99.0.root");
    ...
    Bool_t ishistoadded;
    // add histograms to fit (different pt bins of the
  //  ishistoadded = systfitter->AddHistoToFit("~/Desktop/FinalPlots/ReflectedAverages/CanvaAndVariedHistoWeightedAverageDzeroDstarDplus_pp_Pt5to8assocPt0.3to99.0.root");
    ...
    Bool_t ishistoadded;
    // add histograms to fit (different pt bins of the
   // ishistoadded = systfitter->AddHistoToFit("~/Desktop/FinalPlots/ReflectedAverages/CanvaAndVariedHistoWeightedAverageDzeroDstarDplus_pp_Pt8to16assocPt0.3to99.0.root");
...
//////// TEMPLATE CASE ///////////////
void SystematicsMC_pp_highpthad(Bool_t useReflected,TString strTemplRootName){
...
void SystematicsMC_pp_lowpthad(Bool_t useReflected,TString strTemplRootName){
...
void SystematicsMC_pp_integrpthad(Bool_t useReflected,TString strTemplRootName){
