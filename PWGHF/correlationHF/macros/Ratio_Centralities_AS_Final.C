...
TFile* totalsyst_ASy_001[4]; //to get baseline var fit unc and v2 fit unc
TFile* totalsyst_ASw_001[4]; //to get baseline var fit unc and v2 fit unc
TFile* totalsyst_ASy_0110[4]; 
TFile* totalsyst_ASw_0110[4]; 
TFile* totalsyst_ASy_1030[4]; 
TFile* totalsyst_ASw_1030[4]; 
TFile* totalsyst_ASy_30100[4]; 
TFile* totalsyst_ASw_30100[4]; 
...
void Ratio_Centralities_AS_Final(){

 data1 = TFile::Open("ComparePPbVsCentFitResults_AwaySide_4x2Bins.root");

 LoadFilesForSystPropagation();

 TCanvas *c1 = (TCanvas*)data1->Get("cPPvsPPbFitResultsFinalPaperStyle_AwaySide");
 c1->ls();
 
 TCanvas * cfinal = new TCanvas("cout","coutput",1000,1000); 

 TPad * ptmp = (TPad*)c1->FindObject("cPPvsPPbFitResultsFinalPaperStyle_AwaySide_1");
 ptmp->SetName("pad1");
 TPad * ptmp = (TPad*)c1->FindObject("cPPvsPPbFitResultsFinalPaperStyle_AwaySide_2");
 ptmp->SetName("pad2");
 TPad * ptmp = (TPad*)c1->FindObject("cPPvsPPbFitResultsFinalPaperStyle_AwaySide_3");
 ptmp->SetName("pad3");
 TPad * ptmp = (TPad*)c1->FindObject("cPPvsPPbFitResultsFinalPaperStyle_AwaySide_4");
 ptmp->SetName("pad4");
 TPad * ptmp = (TPad*)c1->FindObject("cPPvsPPbFitResultsFinalPaperStyle_AwaySide_5");
 ptmp->SetName("pad5");
 TPad * ptmp = (TPad*)c1->FindObject("cPPvsPPbFitResultsFinalPaperStyle_AwaySide_6");
 ptmp->SetName("pad6");
 TPad * ptmp = (TPad*)c1->FindObject("cPPvsPPbFitResultsFinalPaperStyle_AwaySide_7");
 ptmp->SetName("pad7");
 TPad * ptmp = (TPad*)c1->FindObject("cPPvsPPbFitResultsFinalPaperStyle_AwaySide_8");
 ptmp->SetName("pad8");
...
//=========Pad1==========================
 ...
 TH1D *h=(TH1D*)p1->FindObject("hDraw30");
...
//=========Pad2==========================
 ...
 TH1D *h=(TH1D*)p2->FindObject("hDraw31");
 h->GetYaxis()->SetRangeUser(0,3);
...
//=========Pad3==========================
 ...
 TH1D *h=(TH1D*)p3->FindObject("hDraw32");
 h->GetYaxis()->SetRangeUser(0,3);
...
//=========Pad4==========================
 ...
 TH1D *h=(TH1D*)p4->FindObject("hDraw33");
 h->GetYaxis()->SetRangeUser(0,3);
...
//=========Pad5==========================
 ...
 for(int i=20;i>=2;i--) {
  ...
  //1st arg: number of panel, 0 to 7 (ASy*4 ranges, ASw*4 ranges)
...
//=========Pad9==========================
 ...
 TH1D *h=(TH1D*)p12->FindObject("hDraw40");
 h->GetYaxis()->SetTitleSize(25);
 h->GetYaxis()->SetTitleOffset(3);
...
//=========Pad10==========================
 ...
 TH1D *h=(TH1D*)p22->FindObject("hDraw41");
 h->GetXaxis()->SetLabelSize(0);
 h->GetXaxis()->SetTitle("");
 h->GetYaxis()->SetLabelSize(0); 
...
//=========Pad11==========================
 ...
 TH1D *h=(TH1D*)p32->FindObject("hDraw42");
 h->GetXaxis()->SetLabelSize(0);
 h->GetXaxis()->SetTitle("");
 h->GetYaxis()->SetLabelSize(0); 
...
//=========Pad12==========================
 ...
 TH1D *h=(TH1D*)p42->FindObject("hDraw43");
 h->GetXaxis()->SetLabelSize(0);
 h->GetXaxis()->SetTitle("");
 h->GetYaxis()->SetLabelSize(0); 
...
////DEBUG PROVA POINTS DOPO
 ...
 cfinal->SaveAs("Centrality_Ratios_AS_Final.eps");
 cfinal->SaveAs("Centrality_Ratios_AS_Final.png");
 cfinal->SaveAs("Centrality_Ratios_AS_Final.pdf");
 cfinal->SaveAs("Centrality_Ratios_AS_Final.root");
...
Double_t x001[4], y001[4], x0110[4], y0110[4], x1030[4], y1030[4], x30100[4], y30100[4], ex[4], ey001stat[4], ey0110stat[4], ey1030stat[4], ey30100stat[4], ey001systlow[4], ey0110systlow[4], ey1030systlow[4], ey30100systlow[4], ey001systhigh[4], ey0110systhigh[4], ey1030systhigh[4], ey30100systhigh[4];
  ...
  for(int iD=0; iD<4; iD++) {
    ...
    if(ratiopanel < 4) { //AS yield
      c_001 = (TCanvas*)totalsyst_ASy_001[iAss]->Get("TotalSystematicSourcesASYield");
      c_0110 = (TCanvas*)totalsyst_ASy_0110[iAss]->Get("TotalSystematicSourcesASYield");
      c_1030 = (TCanvas*)totalsyst_ASy_1030[iAss]->Get("TotalSystematicSourcesASYield");
      c_30100 = (TCanvas*)totalsyst_ASy_30100[iAss]->Get("TotalSystematicSourcesASYield");
      gr_fitvar_001 = (TGraphAsymmErrors*)c_001->FindObject("grSystBasASYield");
      gr_fitvar_0110 = (TGraphAsymmErrors*)c_0110->FindObject("grSystBasASYield");
      gr_fitvar_1030 = (TGraphAsymmErrors*)c_1030->FindObject("grSystBasASYield");
      gr_fitvar_30100 = (TGraphAsymmErrors*)c_30100->FindObject("grSystBasASYield");
    } else { //AS width
      c_001 = (TCanvas*)totalsyst_ASw_001[iAss]->Get("TotalSystematicSourcesASSigma");
      c_0110 = (TCanvas*)totalsyst_ASw_0110[iAss]->Get("TotalSystematicSourcesASSigma");
      c_1030 = (TCanvas*)totalsyst_ASw_1030[iAss]->Get("TotalSystematicSourcesASSigma");
      c_30100 = (TCanvas*)totalsyst_ASw_30100[iAss]->Get("TotalSystematicSourcesASSigma");      
      gr_fitvar_001 = (TGraphAsymmErrors*)c_001->FindObject("grSystBasASSigma");
      gr_fitvar_0110 = (TGraphAsymmErrors*)c_0110->FindObject("grSystBasASSigma");
      gr_fitvar_1030 = (TGraphAsymmErrors*)c_1030->FindObject("grSystBasASSigma");
      gr_fitvar_30100 = (TGraphAsymmErrors*)c_30100->FindObject("grSystBasASSigma");
    }
    ...
    if(ratiopanel > 3) { //For AS widths PUT THE first two to zero!!!
    ...
    if(ratiopanel < 4) { //AS yield
      ...
      c_1030 = (TCanvas*)totalsyst_ASy_1030[iAss]->Get("TotalSystematicSourcesASYield");
      c_30100 = (TCanvas*)totalsyst_ASy_30100[iAss]->Get("TotalSystematicSourcesASYield");
      gr_v2var_001 = (TGraphAsymmErrors*)c_001->FindObject("grv2ASYield");
      gr_v2var_0110 = (TGraphAsymmErrors*)c_0110->FindObject("grv2ASYield");
      gr_v2var_1030 = (TGraphAsymmErrors*)c_1030->FindObject("grv2ASYield");
      gr_v2var_30100 = (TGraphAsymmErrors*)c_30100->FindObject("grv2ASYield");
    } else { //AS width
      c_001 = (TCanvas*)totalsyst_ASw_001[iAss]->Get("TotalSystematicSourcesASSigma");
      c_0110 = (TCanvas*)totalsyst_ASw_0110[iAss]->Get("TotalSystematicSourcesASSigma");
      c_1030 = (TCanvas*)totalsyst_ASw_1030[iAss]->Get("TotalSystematicSourcesASSigma");
      c_30100 = (TCanvas*)totalsyst_ASw_30100[iAss]->Get("TotalSystematicSourcesASSigma");      
      gr_v2var_001 = (TGraphAsymmErrors*)c_001->FindObject("grv2ASSigma");
      gr_v2var_0110 = (TGraphAsymmErrors*)c_0110->FindObject("grv2ASSigma");
      gr_v2var_1030 = (TGraphAsymmErrors*)c_1030->FindObject("grv2ASSigma");
      gr_v2var_30100 = (TGraphAsymmErrors*)c_30100->FindObject("grv2ASSigma");
    }    
    ...
    if(ratiopanel < 4) { //AS yield
      hist_FDmin_BDflat_001 = (TH1D*)syst_BDflat_001[iAss]->Get("ValueHistoASYield_10");
      hist_FDmax_BDflat_001 = (TH1D*)syst_BDflat_001[iAss]->Get("ValueHistoASYield_11");
      hist_FDmin_BDextr_001 = (TH1D*)syst_BDextr_001[iAss]->Get("ValueHistoASYield_10");
      hist_FDmax_BDextr_001 = (TH1D*)syst_BDextr_001[iAss]->Get("ValueHistoASYield_11");
      hist_FDmin_BDflat_0110 = (TH1D*)syst_BDflat_0110[iAss]->Get("ValueHistoASYield_10");
      hist_FDmax_BDflat_0110 = (TH1D*)syst_BDflat_0110[iAss]->Get("ValueHistoASYield_11");
      hist_FDmin_BDextr_0110 = (TH1D*)syst_BDextr_0110[iAss]->Get("ValueHistoASYield_10");
      hist_FDmax_BDextr_0110 = (TH1D*)syst_BDextr_0110[iAss]->Get("ValueHistoASYield_11");
      hist_FDmin_BDflat_1030 = (TH1D*)syst_BDflat_1030[iAss]->Get("ValueHistoASYield_10");
      hist_FDmax_BDflat_1030 = (TH1D*)syst_BDflat_1030[iAss]->Get("ValueHistoASYield_11");
      hist_FDmin_BDextr_1030 = (TH1D*)syst_BDextr_1030[iAss]->Get("ValueHistoASYield_10");
      hist_FDmax_BDextr_1030 = (TH1D*)syst_BDextr_1030[iAss]->Get("ValueHistoASYield_11");
      hist_FDmin_BDflat_30100 = (TH1D*)syst_BDflat_30100[iAss]->Get("ValueHistoASYield_10");
      hist_FDmax_BDflat_30100 = (TH1D*)syst_BDflat_30100[iAss]->Get("ValueHistoASYield_11");
      hist_FDmin_BDextr_30100 = (TH1D*)syst_BDextr_30100[iAss]->Get("ValueHistoASYield_10");
      hist_FDmax_BDextr_30100 = (TH1D*)syst_BDextr_30100[iAss]->Get("ValueHistoASYield_11");                  
    } else { //AS width
      hist_FDmin_BDflat_001 = (TH1D*)syst_BDflat_001[iAss]->Get("ValueHistoASSigma_10");
      hist_FDmax_BDflat_001 = (TH1D*)syst_BDflat_001[iAss]->Get("ValueHistoASSigma_11");
      hist_FDmin_BDextr_001 = (TH1D*)syst_BDextr_001[iAss]->Get("ValueHistoASSigma_10");
      hist_FDmax_BDextr_001 = (TH1D*)syst_BDextr_001[iAss]->Get("ValueHistoASSigma_11");
      hist_FDmin_BDflat_0110 = (TH1D*)syst_BDflat_0110[iAss]->Get("ValueHistoASSigma_10");
      hist_FDmax_BDflat_0110 = (TH1D*)syst_BDflat_0110[iAss]->Get("ValueHistoASSigma_11");
      hist_FDmin_BDextr_0110 = (TH1D*)syst_BDextr_0110[iAss]->Get("ValueHistoASSigma_10");
      hist_FDmax_BDextr_0110 = (TH1D*)syst_BDextr_0110[iAss]->Get("ValueHistoASSigma_11");
      hist_FDmin_BDflat_1030 = (TH1D*)syst_BDflat_1030[iAss]->Get("ValueHistoASSigma_10");
      hist_FDmax_BDflat_1030 = (TH1D*)syst_BDflat_1030[iAss]->Get("ValueHistoASSigma_11");
      hist_FDmin_BDextr_1030 = (TH1D*)syst_BDextr_1030[iAss]->Get("ValueHistoASSigma_10");
      hist_FDmax_BDextr_1030 = (TH1D*)syst_BDextr_1030[iAss]->Get("ValueHistoASSigma_11");
      hist_FDmin_BDflat_30100 = (TH1D*)syst_BDflat_30100[iAss]->Get("ValueHistoASSigma_10");
      hist_FDmax_BDflat_30100 = (TH1D*)syst_BDflat_30100[iAss]->Get("ValueHistoASSigma_11");
      hist_FDmin_BDextr_30100 = (TH1D*)syst_BDextr_30100[iAss]->Get("ValueHistoASSigma_10");
      hist_FDmax_BDextr_30100 = (TH1D*)syst_BDextr_30100[iAss]->Get("ValueHistoASSigma_11"); 
    }  
...
void LoadFilesForSystPropagation() {
 ...
 totalsyst_ASy_001[0] = TFile::Open("001/Trends_pp/TotalSystematicSourcesASYield_pthad0.3to99.0.root");
 totalsyst_ASw_001[0] = TFile::Open("001/Trends_pp/TotalSystematicSourcesASSigma_pthad0.3to99.0.root");
 totalsyst_ASy_001[1] = TFile::Open("001/Trends_pp/TotalSystematicSourcesASYield_pthad0.3to1.0.root");
 totalsyst_ASw_001[1] = TFile::Open("001/Trends_pp/TotalSystematicSourcesASSigma_pthad0.3to1.0.root");
 totalsyst_ASy_001[2] = TFile::Open("001/Trends_pp/TotalSystematicSourcesASYield_pthad1.0to2.0.root");
 totalsyst_ASw_001[2] = TFile::Open("001/Trends_pp/TotalSystematicSourcesASSigma_pthad1.0to2.0.root");
 totalsyst_ASy_001[3] = TFile::Open("001/Trends_pp/TotalSystematicSourcesASYield_pthad2.0to3.0.root");
 totalsyst_ASw_001[3] = TFile::Open("001/Trends_pp/TotalSystematicSourcesASSigma_pthad2.0to3.0.root");
 
 totalsyst_ASy_0110[0] = TFile::Open("0110/Trends_pp/TotalSystematicSourcesASYield_pthad0.3to99.0.root");
 totalsyst_ASw_0110[0] = TFile::Open("0110/Trends_pp/TotalSystematicSourcesASSigma_pthad0.3to99.0.root");
 totalsyst_ASy_0110[1] = TFile::Open("0110/Trends_pp/TotalSystematicSourcesASYield_pthad0.3to1.0.root");
 totalsyst_ASw_0110[1] = TFile::Open("0110/Trends_pp/TotalSystematicSourcesASSigma_pthad0.3to1.0.root");
 totalsyst_ASy_0110[2] = TFile::Open("0110/Trends_pp/TotalSystematicSourcesASYield_pthad1.0to2.0.root");
 totalsyst_ASw_0110[2] = TFile::Open("0110/Trends_pp/TotalSystematicSourcesASSigma_pthad1.0to2.0.root");
 totalsyst_ASy_0110[3] = TFile::Open("0110/Trends_pp/TotalSystematicSourcesASYield_pthad2.0to3.0.root");
 totalsyst_ASw_0110[3] = TFile::Open("0110/Trends_pp/TotalSystematicSourcesASSigma_pthad2.0to3.0.root");  

 totalsyst_ASy_1030[0] = TFile::Open("1030/Trends_pp/TotalSystematicSourcesASYield_pthad0.3to99.0.root");
 totalsyst_ASw_1030[0] = TFile::Open("1030/Trends_pp/TotalSystematicSourcesASSigma_pthad0.3to99.0.root");
 totalsyst_ASy_1030[1] = TFile::Open("1030/Trends_pp/TotalSystematicSourcesASYield_pthad0.3to1.0.root");
 totalsyst_ASw_1030[1] = TFile::Open("1030/Trends_pp/TotalSystematicSourcesASSigma_pthad0.3to1.0.root");
 totalsyst_ASy_1030[2] = TFile::Open("1030/Trends_pp/TotalSystematicSourcesASYield_pthad1.0to2.0.root");
 totalsyst_ASw_1030[2] = TFile::Open("1030/Trends_pp/TotalSystematicSourcesASSigma_pthad1.0to2.0.root");
 totalsyst_ASy_1030[3] = TFile::Open("1030/Trends_pp/TotalSystematicSourcesASYield_pthad2.0to3.0.root");
 totalsyst_ASw_1030[3] = TFile::Open("1030/Trends_pp/TotalSystematicSourcesASSigma_pthad2.0to3.0.root");

 totalsyst_ASy_30100[0] = TFile::Open("30100/Trends_pp/TotalSystematicSourcesASYield_pthad0.3to99.0.root");      
 totalsyst_ASw_30100[0] = TFile::Open("30100/Trends_pp/TotalSystematicSourcesASSigma_pthad0.3to99.0.root");
 totalsyst_ASy_30100[1] = TFile::Open("30100/Trends_pp/TotalSystematicSourcesASYield_pthad0.3to1.0.root");      
 totalsyst_ASw_30100[1] = TFile::Open("30100/Trends_pp/TotalSystematicSourcesASSigma_pthad0.3to1.0.root");
 totalsyst_ASy_30100[2] = TFile::Open("30100/Trends_pp/TotalSystematicSourcesASYield_pthad1.0to2.0.root");      
 totalsyst_ASw_30100[2] = TFile::Open("30100/Trends_pp/TotalSystematicSourcesASSigma_pthad1.0to2.0.root");
 totalsyst_ASy_30100[3] = TFile::Open("30100/Trends_pp/TotalSystematicSourcesASYield_pthad2.0to3.0.root");      
 totalsyst_ASw_30100[3] = TFile::Open("30100/Trends_pp/TotalSystematicSourcesASSigma_pthad2.0to3.0.root");
 ...
 for(int i=0; i<4; i++) {
  ...
  printf("totalsyst_ASy_001[%d] = %p\n",i,totalsyst_ASy_001[i]); //for the syst uncertainties
  printf("totalsyst_ASw_001[%d] = %p\n",i,totalsyst_ASw_001[i]); //for the syst uncertainties
  printf("totalsyst_ASy_0110[%d] = %p\n",i,totalsyst_ASy_0110[i]); //for the syst uncertainties
  printf("totalsyst_ASw_0110[%d] = %p\n",i,totalsyst_ASw_0110[i]); //for the syst uncertainties
  printf("totalsyst_ASy_1030[%d] = %p\n",i,totalsyst_ASy_1030[i]); //for the syst uncertainties
  printf("totalsyst_ASw_1030[%d] = %p\n",i,totalsyst_ASw_1030[i]); //for the syst uncertainties
  printf("totalsyst_ASy_30100[%d] = %p\n",i,totalsyst_ASy_30100[i]); //for the syst uncertainties
  printf("totalsyst_ASw_30100[%d] = %p\n",i,totalsyst_ASw_30100[i]); //for the syst uncertainties
   for(int j=0; j<4; j++) {
