...
Double_t resizeTextFactor=1.1*900./1000.;//canvasheight/1800.; // size was tuned for canvasheight =1800. 
...
void DoComparison_ppVspPballPanels(){
  ...
  if(skip3to5){
    ...
    cFinalPaperStyle=new TCanvas("cFinalPaperStyle","cFinalPaperStyle",800,800);
    SetPadStyle(cFinalPaperStyle);
