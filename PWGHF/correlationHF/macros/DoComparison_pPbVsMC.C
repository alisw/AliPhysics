...
void LoadFileNamespPbVsMCtemplates(TString pthadron){
  ...
  //load MC Templates1
  filenames[3] = Form("%s/%sCorrelationPlotsPerugia0PtAveragefromC3To5_ptAssall%s_DeltaEta10.root",inputtemplatedirecotry.Data(),strsystHelp.Data(),pthadron.Data());//in the preliminary it was Puthia8
  ...
  filenames[6] = Form("%s/%sCorrelationPlotsPerugia2010PtAveragefromC3To5_ptAssall%s_DeltaEta10.root",inputtemplatedirecotry.Data(),strsystHelp.Data(),pthadron.Data());//in the preliminary it was Puthia8
  ...
  filenames[9] = Form("%s/%sCorrelationPlotsPerugia2011PtAveragefromC3To5_ptAssall%s_DeltaEta10.root",inputtemplatedirecotry.Data(),strsystHelp.Data(),pthadron.Data());//in the preliminary it was Puthia8
