...
void DrawDhCorr_STE_3DEfficiency_in_pTEtaZvtx(TString filename="AnalysisResults.root", TString specie="All") { //Species: "All", "pi", "K", "p", "SigP", "SigM", "Rest"
    ...
    if(specie=="All"||specie=="pi"||specie=="K"||specie=="p"||specie=="SigmaP"||specie=="SigmaM") {
    ...
    } else if(specie=="Rest") {  //one takes "All" num and den, and subtracts the identified species's nums and dens
...
void DrawDhCorr_STE_1DEfficiency_in_pT(TString filename="AnalysisResults.root", TString specie="All") { //Species: "All", "pi", "K", "p", "SigP", "SigM", "Rest"
