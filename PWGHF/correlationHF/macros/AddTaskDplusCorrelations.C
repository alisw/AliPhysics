                                                     ...
                                                     Bool_t useCentrality = kFALSE)
{
  ...
  else DplusCorrCuts = (AliRDHFCutsDplustoKpipi*)fDplusCuts->Get("DPlusHadronCorrelations");
  if(!DplusCorrCuts){
  ...
  HFAssoTrackCuts = (AliHFAssociatedTrackCuts*)fAssoTrackCuts->Get("AssociatedCuts");
  if(!HFAssoTrackCuts){
