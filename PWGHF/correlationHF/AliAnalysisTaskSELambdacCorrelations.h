#ifndef AliAnalysisTaskSELambdacCorrelations_H
#define AliAnalysisTaskSELambdacCorrelations_H

/* Copyright(c) 1998-2012, ALICE Experiment at CERN, All rights reserved. *
 * See cxx source for full Copyright notice                               */

/* $Id: AliAnalysisTaskSELambdacCorrelations.h 63031 2013-06-17 13:30:19Z arossi $ */

//*************************************************************************
// Class AliAnalysisTaskSELambdacCorrelations
// AliAnalysisTaskSE for Lambdac candidates (2Prongs) and hadrons correlations
// Authors:
// S.Sadhu,  samrangy.sadhu@ba.infn.it 
...
class AliAnalysisTaskSELambdacCorrelations : public AliAnalysisTaskSE
{
 public:

  AliAnalysisTaskSELambdacCorrelations();
  AliAnalysisTaskSELambdacCorrelations(const char *name,AliRDHFCutsLctopKpi* cutsLambdac, AliHFAssociatedTrackCuts* cutsTrk);
  virtual ~AliAnalysisTaskSELambdacCorrelations();
 ...
 private:
  ...
  AliAnalysisTaskSELambdacCorrelations(const AliAnalysisTaskSELambdacCorrelations &source);
  AliAnalysisTaskSELambdacCorrelations& operator=(const AliAnalysisTaskSELambdacCorrelations& source); 
  void FillMassHists(AliAODRecoDecayHF3Prong *part, TClonesArray *arrMC, AliRDHFCutsLctopKpi *cuts, TList *listout, AliAODEvent *aod);
  ...
  AliRDHFCutsLctopKpi *fCutsLambdac;    	// Cuts for Lambdac, output 3
  ...
  AliHFMLResponseLambdactopKpi* fMLResponse = nullptr;                 //!<! object to handle ML response
  ...
  ClassDef(AliAnalysisTaskSELambdacCorrelations,18); // AliAnalysisTaskSE for Lambdac->Kpi - h correlations
};
