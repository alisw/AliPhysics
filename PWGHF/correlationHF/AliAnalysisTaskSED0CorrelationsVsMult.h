#ifndef AliAnalysisTaskSED0CorrelationsVsMult_H
#define AliAnalysisTaskSED0CorrelationsVsMult_H
...
//*************************************************************************
// Class AliAnalysisTaskSED0CorrelationsVsMult
...
class AliAnalysisTaskSED0CorrelationsVsMult : public AliAnalysisTaskSE
{
 public:

  AliAnalysisTaskSED0CorrelationsVsMult();
  AliAnalysisTaskSED0CorrelationsVsMult(const char *name,AliRDHFCutsD0toKpi* cutsD0, AliHFAssociatedTrackCuts* cutsTrk);
  virtual ~AliAnalysisTaskSED0CorrelationsVsMult();
  ...
  //---- Added mult variation correlation ---------------------
  //----------------------------------------------------------------------------
 ...
 private:
  ...
  AliAnalysisTaskSED0CorrelationsVsMult(const AliAnalysisTaskSED0CorrelationsVsMult &source);
  AliAnalysisTaskSED0CorrelationsVsMult& operator=(const AliAnalysisTaskSED0CorrelationsVsMult& source); 
 ...
 Double_t fMultipOrCent;

  ClassDef(AliAnalysisTaskSED0CorrelationsVsMult,15); // AliAnalysisTaskSE for D0->Kpi - h correlations
};
