#ifndef ALIANALYSISTASKDMESONSFILTERCJ_H
#define ALIANALYSISTASKDMESONSFILTERCJ_H
/**************************************************************************
...
class AliAnalysisTaskDmesonsFilterCJ : public AliAnalysisTaskEmcal 
{
 ...
 public:
  ...
  AliAnalysisTaskDmesonsFilterCJ();
  AliAnalysisTaskDmesonsFilterCJ(const Char_t* name,AliRDHFCuts* cuts,ECandidateType candtype);
  virtual ~AliAnalysisTaskDmesonsFilterCJ();
