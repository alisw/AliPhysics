...
Double_t AliAnalysisTaskBJetTC::CorrectResolution(Double_t resolution, Double_t pScat, Int_t nVtxContrib, Int_t nITS)
{
	...
	//cout<<"Old Value of Res: "<<resolution<<" And the new value is: "<<CorrResVsPscatNvtxContrib<<" pSat= "<<pScat<<" Alpha pScat: "<<AlphaPullVsPscat<<" nVtxContrib= "<<nVtxContrib<<" Alpha NvtxContrib: "<<AlphaPullVsNvtxContrib<<endl;
