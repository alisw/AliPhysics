...
Int_t AliHFJetsTaggingVertex::FindVertices(const AliEmcalJet* jet,
                                           ...
                                           Int_t&             nDauRejCount)
{
  AliDebug(2, MSGINFO("+++ Executing FindVertices +++"));
  ...
  if (!fCutsHFjets->IsJetSelected(jet)) {
    AliDebugF(3, MSGDEBUG("--> Jet with pt=%3.2f and eta=%3.2f not selected in FindVertices"),
              jet->Pt(), jet->Eta());
    return -2;
  }
