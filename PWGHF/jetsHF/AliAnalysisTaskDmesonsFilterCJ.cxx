...
ClassImp(AliAnalysisTaskDmesonsFilterCJ)

//_______________________________________________________________________________
AliAnalysisTaskDmesonsFilterCJ::AliAnalysisTaskDmesonsFilterCJ() :
...
//_______________________________________________________________________________
AliAnalysisTaskDmesonsFilterCJ::AliAnalysisTaskDmesonsFilterCJ(const char *name, AliRDHFCuts *cuts, ECandidateType candtype) :
  ...
  fHistDeltaRDKR(0)
{
  ...
  Info("AliAnalysisTaskDmesonsFilterCJ","Calling Constructor");
  ...
  switch (fCandidateType) {
    ...
    case 1 :
      ...
      break;
    default :
      Warning("AliAnalysisTaskDmesonsFilterCJ", "%d not accepted!!", fCandidateType);
      break;
  }
...
AliAnalysisTaskDmesonsFilterCJ::~AliAnalysisTaskDmesonsFilterCJ()
{
  ...
  Info("~AliAnalysisTaskDmesonsFilterCJ","Calling Destructor");
...
//_______________________________________________________________________________
void AliAnalysisTaskDmesonsFilterCJ::Init()
{
  //
  // Initialization
  //

  Info("AnalysisTaskDmesonsForJetCorrelations::Init()", "Entering method");
...
//_______________________________________________________________________________
void AliAnalysisTaskDmesonsFilterCJ::UserCreateOutputObjects()
{
  //
...
//_______________________________________________________________________________
void AliAnalysisTaskDmesonsFilterCJ::ExecOnce()
{
  //
...
//_______________________________________________________________________________
void AliAnalysisTaskDmesonsFilterCJ::ProcessD0(AliAODRecoDecayHF2Prong* charmCand, Int_t isSelected)
{
...
//_______________________________________________________________________________
void AliAnalysisTaskDmesonsFilterCJ::ProcessDstar(AliAODRecoCascadeHF* dstar, Int_t isSelected)
{
...
//_______________________________________________________________________________
void AliAnalysisTaskDmesonsFilterCJ::FillD0MCTruthKinHistos(AliAODRecoDecayHF2Prong* charmCand, Int_t isSelected, Int_t isD0)
{
...
//_______________________________________________________________________________
void AliAnalysisTaskDmesonsFilterCJ::FillDStarMCTruthKinHistos(AliAODRecoCascadeHF* dstar, Int_t isSelected, Int_t isDstar)
{
  // Fill some histogram with kinematic information of the D0 candidate.
...
//_______________________________________________________________________________
void AliAnalysisTaskDmesonsFilterCJ::FillDstarSideBands(AliAODRecoCascadeHF* dstar)
{
...
//_______________________________________________________________________________
void AliAnalysisTaskDmesonsFilterCJ::SetMassLimits(Double_t range, Int_t pdg)
{
...
//_______________________________________________________________________________
void AliAnalysisTaskDmesonsFilterCJ::SetMassLimits(Double_t lowlimit, Double_t uplimit)
{
  // Set the mass limits.
...
//_______________________________________________________________________________
Bool_t AliAnalysisTaskDmesonsFilterCJ::SetD0WidthForDStar(Int_t nptbins, Float_t* width)
{
...
//_______________________________________________________________________________
Bool_t AliAnalysisTaskDmesonsFilterCJ::DefineHistoForAnalysis()
{
...
//_______________________________________________________________________________
Float_t AliAnalysisTaskDmesonsFilterCJ::DeltaR(AliVParticle *p1, AliVParticle *p2) const
{
...
//_______________________________________________________________________________
void AliAnalysisTaskDmesonsFilterCJ::AddEventTracks(TClonesArray* coll, AliParticleContainer* tracks)
{
  //
...
//_______________________________________________________________________________
Double_t AliAnalysisTaskDmesonsFilterCJ::AddDaughters(AliAODRecoDecay* cand, TObjArray& daughters)
{
...
//_______________________________________________________________________________
void AliAnalysisTaskDmesonsFilterCJ::AddMCEventTracks(TClonesArray* coll, AliParticleContainer* mctracks)
{
    //
    // Add event tracks to a collection that already contains the D candidates, excluding the daughters of the D candidates
    //
...
//_______________________________________________________________________________
Double_t AliAnalysisTaskDmesonsFilterCJ::AddMCDaughters(AliAODMCParticle* mcDmeson, TObjArray& mcdaughters, TClonesArray* mcArray)
{
    // Add all the dauthers of cand in an array. Follows all the decay cascades.
...
Int_t AliAnalysisTaskDmesonsFilterCJ::CheckOrigin(AliAODRecoDecay* cand, TClonesArray* mcArray)
{
...
//_________________________________________________________________________________________________
Int_t AliAnalysisTaskDmesonsFilterCJ::CheckDecayChannel(AliAODMCParticle* part, TClonesArray* mcArray)
{
...
//_____________________________________________________________________
void AliAnalysisTaskDmesonsFilterCJ::GetMCTrackPrimaryGenerator(AliAODMCParticle *track,AliAODMCHeader *header,TClonesArray *arrayMC,TString &nameGen){
...
//----------------------------------------------------------------------
Bool_t AliAnalysisTaskDmesonsFilterCJ::IsMCTrackInjected(AliAODMCParticle *track,AliAODMCHeader *header,TClonesArray *arrayMC){
  /// method to check if a track comes from the signal event or from the underlying Hijing event
  TString nameGen;
