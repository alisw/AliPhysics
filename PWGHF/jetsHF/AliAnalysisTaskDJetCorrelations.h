#ifndef ALIANALYSISTASKDJETCORRELATIONS_H
#define ALIANALYSISTASKDJETCORRELATIONS_H
/**************************************************************************
...
class AliAnalysisTaskDJetCorrelations : public AliAnalysisTaskEmcalJet
{
...
public:
   ...
   virtual ~AliAnalysisTaskDJetCorrelations();
...
private:
   ...
   AliAnalysisTaskDJetCorrelations(const AliAnalysisTaskDJetCorrelations &source);
   AliAnalysisTaskDJetCorrelations& operator=(const AliAnalysisTaskDJetCorrelations& source);
   ...
   ClassDef(AliAnalysisTaskDJetCorrelations,8); // class for charm-jet CorrelationsExch
};
