...
class AliAnalysisTaskElecHadronCorrel_Run1 : public AliAnalysisTaskSE {
  public:
    AliAnalysisTaskElecHadronCorrel_Run1();
    AliAnalysisTaskElecHadronCorrel_Run1(const char *name);
    virtual ~AliAnalysisTaskElecHadronCorrel_Run1();
  ...
  private:
    ...
    AliAnalysisTaskElecHadronCorrel_Run1(const AliAnalysisTaskElecHadronCorrel_Run1&); // not implemented
    AliAnalysisTaskElecHadronCorrel_Run1& operator=(const AliAnalysisTaskElecHadronCorrel_Run1&); // not implemented

    ClassDef(AliAnalysisTaskElecHadronCorrel_Run1, 2); //!example of analysis
};
