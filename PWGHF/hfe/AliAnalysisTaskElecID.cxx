...
#include "AliAnalysisTaskElecID.h"
...
ClassImp(AliAnalysisTaskElecID)

//________________________________________________________________________//
AliAnalysisTaskElecID::AliAnalysisTaskElecID(): 
AliAnalysisTaskSE(),
...
AliAnalysisTaskElecID::AliAnalysisTaskElecID(const char *name) 
...
void AliAnalysisTaskElecID::Init()
{
  // Initialization	
  if(fDebug > 1) printf("AliAnalysisTaskElecID::Init() \n");
  return;
}
...
//________________________________________________________________________
void AliAnalysisTaskElecID::UserCreateOutputObjects()
{
  // Create histograms
  // Called once
	//Initialize PID
...
void AliAnalysisTaskElecID::UserExec(Option_t *) 
{
...
void AliAnalysisTaskElecID::SelectPhotonicElectronR(Int_t itrack, AliAODTrack *track, Int_t motherindex, Int_t pdg1, Int_t source,Double_t V0Mmult1 , Double_t SPDntr1)
{
...
//=================================================================================================================================
Int_t AliAnalysisTaskElecID::ClassifyTrack(AliAODTrack* track,const AliVVertex* pVtx)
{  
...
//====================================================================================================================================
Int_t AliAnalysisTaskElecID::GetElecSourceType(AliAODMCParticle *electron, TClonesArray *mcArray,Double_t &ptm)
{
    //
...
Int_t AliAnalysisTaskElecID::GetPi0EtaType(AliAODMCParticle *pi0eta, TClonesArray *mcArray)
{
...
Int_t AliAnalysisTaskElecID::GetHFE(AliAODMCParticle *electron, TClonesArray *mcArray)
{
...
Int_t AliAnalysisTaskElecID::GetNcharged(){
...
TProfile* AliAnalysisTaskElecID::GetEstimatorHistogram(const AliAODEvent* fAOD)
{
...
//===================================================================================
Double_t AliAnalysisTaskElecID::Beta(AliAODTrack *track)
{
...
//===================================================================================
void AliAnalysisTaskElecID::Terminate(Option_t *) 
{
