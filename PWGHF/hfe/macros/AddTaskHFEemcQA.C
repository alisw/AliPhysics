AliAnalysisTask *AddTaskHFEemcQA(Bool_t UseTender=kTRUE, Bool_t FillElecSparse=kFALSE, Bool_t ispPb=kFALSE){
  ...
  if(ispPb)
    {
      ...
      hfecalqaTrig01->SetEMCalTriggerEG1();
      ...
      hfecalqaTrig02->SetEMCalTriggerEG2();
