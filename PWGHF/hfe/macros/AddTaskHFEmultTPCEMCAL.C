		...
		)
{
  ...
  {              
    ...
    taskhfe->SetMultiplVsZProfile_18f1_extra(multEstimatorAvg[3]);
    taskhfe->SetMultiplVsZProfile_18f4b(multEstimatorAvg[4]);
    taskhfe->SetMultiplVsZProfile_18period_MB(multEstimatorAvg[5]);
    taskhfe->SetMultiplVsZProfile_18period_EG2(multEstimatorAvg[6]);
    taskhfe->SetMultiplVsZProfile_18period_EG1(multEstimatorAvg[7]);
    taskhfe->SetMultiplVsZProfile_18_GPMC(multEstimatorAvg[8]);
    taskhfe->SetMultiplVsZProfile_18l5b(multEstimatorAvg[9]);
    taskhfe->SetMultiplVsZProfile_17period_MB(multEstimatorAvg[10]);
    taskhfe->SetMultiplVsZProfile_17period_EG2(multEstimatorAvg[11]);
    taskhfe->SetMultiplVsZProfile_17period_EG1(multEstimatorAvg[12]);
    taskhfe->SetMultiplVsZProfile_17_GPMC(multEstimatorAvg[13]);
    taskhfe->SetMultiplVsZProfile_18l5a(multEstimatorAvg[14]);
