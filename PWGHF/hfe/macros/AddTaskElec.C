AliAnalysisTaskElecID *AddTaskElec(
		TString HFEdir="",
		Bool_t isMC=kFALSE,
		...
		)
{
  ...
  // AddTask for the AliAnalysisTaskElecID for HFE multiplicity Dependent study
  //====================================================
  AliAnalysisManager *mgr = AliAnalysisManager::GetAnalysisManager();
  if (!mgr) {
    ::Error("AddTaskElecID", "No analysis manager to connect to.");
    return NULL;
  }
  ...
  AliAnalysisTaskElecID *taskhfe = new AliAnalysisTaskElecID(taskname.Data());
  ...
  {              
    ...
    const Char_t* periodNames[4] = {"16k", "16l", "17d20a1_extra", "17d20a2_extra"};
