...
AliAnalysisTask* AddTaskTPCCalBeauty(Double_t centMin=0, Double_t centMax=10, Double_t m20Cut = 0.35, Double_t minEoPCut = 0.9, Double_t minNSig = -1.0, Double_t dcaBinSize = 0.002, Bool_t fillElecSprs = kFALSE, Bool_t isMC=kFALSE, Bool_t runStackLoop = kFALSE, Int_t nClsTPC=80, TString ContNameExt = " ", Double_t ptAsso = 0.3, Double_t minNSigAsso = -3., Double_t trkMatch=0.05, Bool_t applyCentCut = kTRUE, Bool_t useM02 = kFALSE, Bool_t shingoCheck = kFALSE)
{
    ...
    taskBFEemc->SetShingoCheck(shingoCheck);
    ...
    taskBFEdc->SetShingoCheck(shingoCheck);
    ...
    */
    ...
    if (isMC==kFALSE) {
        ...
        taskBFEeg01emc->SetShingoCheck(shingoCheck);
        ...
        taskBFEdg01dc->SetShingoCheck(shingoCheck);
