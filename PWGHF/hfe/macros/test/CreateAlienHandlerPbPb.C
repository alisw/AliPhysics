...
// Set versions of used packages
   ...
   plugin->SetAliROOTVersion("v5-03-33-AN");
...
//   plugin->SetOutputFiles("Output.root");
   ...
   plugin->SetDefaultOutputs(kFALSE);
     plugin->SetOutputFiles("rbailhac_tpctofv2PbPb2011_out.root"); 
...
// Optionally set a name for the generated analysis macro (default MyAnalysis.C)
   plugin->SetAnalysisMacro("Tpctofv2Analysis.C");
// Optionally set maximum number of input files/subjob (default 100, put 0 to ignore)
//   plugin->SetSplitMaxInputFileNumber(2);
// Optionally modify the executable name (default analysis.sh)
   plugin->SetExecutable("Tpctofv2Analysis.sh");
...
// Optionally modify the name of the generated JDL (default analysis.jdl)
   plugin->SetJDLName("Tpctofv2Analysis.jdl");
