    ...
    if(!useMC){
       ...
       TF1 *hBackground;
        ...
        if(HadronContFunc == 0){
            ...
            hBackground->SetParameter(0, 3.53036e+03);
            hBackground->SetParameter(1, 2.57159e+01);
            hBackground->SetParameter(2, 6.12305e+00);
            //error function
        }
        if(HadronContFunc == 1){
            hBackground = new TF1("hadronicBackgroundFunction", "[0]+[1]*TMath::Erf([2]*x+[3])", 0. ,60.);
            hBackground->SetParameter(0, 3.35535e-01);
            hBackground->SetParameter(1, 3.35534e-01);
            hBackground->SetParameter(2, 5.84673e-01);
