...
//        mgr->ConnectInput(taskMB, 1, corrTask);
    ...
    if(!Is2015){
        ...
        AliAnalysisTaskFlowTPCEMCalEP *taskMB = ConfigHFE_FLOW_TPCEMCal_EP(MCthere,AssPtCut,AssTPCnCut,AssITSrefitCut,TPCnCut,UseNewEP,period);
        AliAnalysisTaskFlowTPCEMCalEP *taskcorrMB = ConfigHFE_FLOW_TPCEMCal_EP(MCthere,AssPtCut,AssTPCnCut,AssITSrefitCut,TPCnCut,UseNewEP,period);
        AliAnalysisTaskFlowTPCEMCalEP *taskTR = ConfigHFE_FLOW_TPCEMCal_EP(MCthere,AssPtCut,AssTPCnCut,AssITSrefitCut,TPCnCut,UseNewEP,period);
    ...
    if(MCthere){
        ...
        AliAnalysisTaskFlowTPCEMCalEP *taskMC = ConfigHFE_FLOW_TPCEMCal_EP(MCthere,AssPtCut,AssTPCnCut,AssITSrefitCut,TPCnCut,UseNewEP,period);
        mgr->AddTask(taskMC);
