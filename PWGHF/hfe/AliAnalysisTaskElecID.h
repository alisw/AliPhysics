...
#ifndef AliAnalysisTaskElecID_cxx
#define AliAnalysisTaskElecID_cxx
...
class AliAnalysisTaskElecID : public AliAnalysisTaskSE {
 public:
   ...
   enum ESourceType {kNoMotherE, kPi0NoFeedDown, kEtaNoFeedDown, kGPi0NoFeedDown, kGEtaNoFeedDown, kDirectGamma, kOthersE};//0,1,2,3,4,5,6
	...
	AliAnalysisTaskElecID() ;
	AliAnalysisTaskElecID(const char *name);
	virtual ~AliAnalysisTaskElecID() ;
  ...
  //---------------------------------------------------------------
   ...
   TProfile* GetEstimatorHistogram(const AliAODEvent* fAOD);
	...
	AliAnalysisTaskElecID(const AliAnalysisTaskElecID&); // not implemented
	AliAnalysisTaskElecID& operator=(const AliAnalysisTaskElecID&); // not implemented
	  
	ClassDef(AliAnalysisTaskElecID, 1); // ClassDef(ClassName,ClassVersionID)  
};
