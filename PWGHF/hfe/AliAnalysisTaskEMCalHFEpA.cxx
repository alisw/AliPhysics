...
Double_t AliAnalysisTaskEMCalHFEpA::CalculateWeight(Int_t pdg_particle, Double_t x)
{
    ...
    if(fUseTrigger){
        ...
        {
            if(x>= 0.000000 &&  x < 0.150000 ) weight=1.144117;
            if(x>= 0.150000 &&  x < 0.300000 ) weight=2.120749;
            if(x>= 0.300000 &&  x < 0.450000 ) weight=2.514389;
            if(x>= 0.450000 &&  x < 0.600000 ) weight=2.443425;
            if(x>= 0.600000 &&  x < 0.750000 ) weight=2.197192;
            if(x>= 0.750000 &&  x < 0.900000 ) weight=1.952507;
            if(x>= 0.900000 &&  x < 1.050000 ) weight=1.761811;
            if(x>= 1.050000 &&  x < 1.200000 ) weight=1.647165;
            if(x>= 1.200000 &&  x < 1.350000 ) weight=1.599619;
            if(x>= 1.350000 &&  x < 1.500000 ) weight=1.616157;
            if(x>= 1.500000 &&  x < 1.650000 ) weight=1.673114;
            if(x>= 1.650000 &&  x < 1.800000 ) weight=1.778883;
            if(x>= 1.800000 &&  x < 1.950000 ) weight=1.934051;
            if(x>= 1.950000 &&  x < 2.100000 ) weight=2.127592;
            if(x>= 2.100000 &&  x < 2.250000 ) weight=2.374862;
            if(x>= 2.250000 &&  x < 2.400000 ) weight=2.685605;
            if(x>= 2.400000 &&  x < 2.550000 ) weight=3.083519;
            if(x>= 2.550000 &&  x < 2.700000 ) weight=3.553225;
            if(x>= 2.700000 &&  x < 2.850000 ) weight=4.084193;
            if(x>= 2.850000 &&  x < 3.000000 ) weight=4.736497;
            if(x>= 3.000000 &&  x < 3.150000 ) weight=5.516008;
            if(x>= 3.150000 &&  x < 3.300000 ) weight=6.426706;
            if(x>= 3.300000 &&  x < 3.450000 ) weight=7.486178;
            if(x>= 3.450000 &&  x < 3.600000 ) weight=8.688324;
            if(x>= 3.600000 &&  x < 3.750000 ) weight=10.159170;
            if(x>= 3.750000 &&  x < 3.900000 ) weight=11.774788;
            if(x>= 3.900000 &&  x < 4.050000 ) weight=13.656919;
            if(x>= 4.050000 &&  x < 4.200000 ) weight=15.910845;
            if(x>= 4.200000 &&  x < 4.350000 ) weight=18.399357;
            if(x>= 4.350000 &&  x < 4.500000 ) weight=21.107893;
            if(x>= 4.500000 &&  x < 4.650000 ) weight=24.578135;
            if(x>= 4.650000 &&  x < 4.800000 ) weight=28.262204;
            if(x>= 4.800000 &&  x < 4.950000 ) weight=32.517915;
            if(x>= 4.950000 &&  x < 5.100000 ) weight=36.886112;
            if(x>= 5.100000 &&  x < 5.250000 ) weight=42.477389;
            if(x>= 5.250000 &&  x < 5.400000 ) weight=48.044397;
            if(x>= 5.400000 &&  x < 5.550000 ) weight=54.908958;
            if(x>= 5.550000 &&  x < 5.700000 ) weight=61.780497;
            if(x>= 5.700000 &&  x < 5.850000 ) weight=71.024127;
            if(x>= 5.850000 &&  x < 6.000000 ) weight=80.309256;
            if(x>= 6.000000 &&  x < 6.150000 ) weight=90.227433;
            if(x>= 6.150000 &&  x < 6.300000 ) weight=102.129777;
            if(x>= 6.300000 &&  x < 6.450000 ) weight=114.217501;
            if(x>= 6.450000 &&  x < 6.600000 ) weight=128.311448;
            if(x>= 6.600000 &&  x < 6.750000 ) weight=143.439220;
            if(x>= 6.750000 &&  x < 6.900000 ) weight=159.585926;
            if(x>= 6.900000 &&  x < 7.050000 ) weight=180.038869;
            if(x>= 7.050000 &&  x < 7.200000 ) weight=199.358506;
            if(x>= 7.200000 &&  x < 7.350000 ) weight=220.560940;
            if(x>= 7.350000 &&  x < 7.500000 ) weight=245.245025;
            if(x>= 7.500000 &&  x < 7.650000 ) weight=274.846016;
            if(x>= 7.650000 &&  x < 7.800000 ) weight=300.497591;
            if(x>= 7.800000 &&  x < 7.950000 ) weight=333.507087;
            if(x>= 7.950000 &&  x < 8.100000 ) weight=369.100929;
            if(x>= 8.100000 &&  x < 8.250000 ) weight=407.268156;
            if(x>= 8.250000 &&  x < 8.400000 ) weight=447.894208;
            if(x>= 8.400000 &&  x < 8.550000 ) weight=489.571734;
            if(x>= 8.550000 &&  x < 8.700000 ) weight=540.592316;
            if(x>= 8.700000 &&  x < 8.850000 ) weight=591.263617;
            if(x>= 8.850000 &&  x < 9.000000 ) weight=647.265819;
            if(x>= 9.000000 &&  x < 9.150000 ) weight=709.986586;
            if(x>= 9.150000 &&  x < 9.300000 ) weight=771.684600;
            if(x>= 9.300000 &&  x < 9.450000 ) weight=847.230009;
            if(x>= 9.450000 &&  x < 9.600000 ) weight=931.324699;
            if(x>= 9.600000 &&  x < 9.750000 ) weight=1003.852954;
            if(x>= 9.750000 &&  x < 9.900000 ) weight=1084.288700;
            if(x>= 9.900000 &&  x < 10.050000 ) weight=1178.097074;
            if(x>= 10.050000 &&  x < 10.200000 ) weight=1285.358413;
            if(x>= 10.200000 &&  x < 10.350000 ) weight=1392.857940;
            if(x>= 10.350000 &&  x < 10.500000 ) weight=1512.534781;
            if(x>= 10.500000 &&  x < 10.650000 ) weight=1636.189860;
            if(x>= 10.650000 &&  x < 10.800000 ) weight=1757.069952;
            if(x>= 10.800000 &&  x < 10.950000 ) weight=1901.139673;
            if(x>= 10.950000 &&  x < 11.100000 ) weight=2051.097329;
            if(x>= 11.100000 &&  x < 11.250000 ) weight=2220.845820;
            if(x>= 11.250000 &&  x < 11.400000 ) weight=2380.164679;
            if(x>= 11.400000 &&  x < 11.550000 ) weight=2581.069437;
            if(x>= 11.550000 &&  x < 11.700000 ) weight=2740.615980;
            if(x>= 11.700000 &&  x < 11.850000 ) weight=2960.304680;
            if(x>= 11.850000 &&  x < 12.000000 ) weight=3179.093836;
            if(x>= 12.000000 &&  x < 12.150000 ) weight=3402.314400;
            if(x>= 12.150000 &&  x < 12.300000 ) weight=3649.249091;
            if(x>= 12.300000 &&  x < 12.450000 ) weight=3915.941819;
            if(x>= 12.450000 &&  x < 12.600000 ) weight=4219.671996;
            if(x>= 12.600000 &&  x < 12.750000 ) weight=4464.144999;
            if(x>= 12.750000 &&  x < 12.900000 ) weight=4823.592992;
            if(x>= 12.900000 &&  x < 13.050000 ) weight=5127.803318;
            if(x>= 13.050000 &&  x < 13.200000 ) weight=5484.527778;
            if(x>= 13.200000 &&  x < 13.350000 ) weight=5815.889206;
            if(x>= 13.350000 &&  x < 13.500000 ) weight=6256.738814;
            if(x>= 13.500000 &&  x < 13.650000 ) weight=6614.233332;
            if(x>= 13.650000 &&  x < 13.800000 ) weight=7034.794010;
            if(x>= 13.800000 &&  x < 13.950000 ) weight=7566.037825;
            if(x>= 13.950000 &&  x < 14.100000 ) weight=7962.641663;
            if(x>= 14.100000 &&  x < 14.250000 ) weight=8589.836883;
            if(x>= 14.250000 &&  x < 14.400000 ) weight=8944.661415;
            if(x>= 14.400000 &&  x < 14.550000 ) weight=9626.300275;
            if(x>= 14.550000 &&  x < 14.700000 ) weight=10223.578014;
            if(x>= 14.700000 &&  x < 14.850000 ) weight=10763.035947;
            if(x>= 14.850000 &&  x < 15.000000 ) weight=11454.065088;
            if(x>= 15.000000 &&  x < 15.150000 ) weight=12158.435374;
            if(x>= 15.150000 &&  x < 15.300000 ) weight=12825.733174;
            if(x>= 15.300000 &&  x < 15.450000 ) weight=13641.801469;
            if(x>= 15.450000 &&  x < 15.600000 ) weight=14355.086106;
            if(x>= 15.600000 &&  x < 15.750000 ) weight=15340.745792;
            if(x>= 15.750000 &&  x < 15.900000 ) weight=16175.265880;
            if(x>= 15.900000 &&  x < 16.050000 ) weight=17094.883041;
            if(x>= 16.050000 &&  x < 16.200000 ) weight=17826.274405;
            if(x>= 16.200000 &&  x < 16.350000 ) weight=18886.965170;
            if(x>= 16.350000 &&  x < 16.500000 ) weight=19847.124206;
            if(x>= 16.500000 &&  x < 16.650000 ) weight=21138.868841;
            if(x>= 16.650000 &&  x < 16.800000 ) weight=22176.500971;
            if(x>= 16.800000 &&  x < 16.950000 ) weight=23289.991061;
            if(x>= 16.950000 &&  x < 17.100000 ) weight=24544.443161;
            if(x>= 17.100000 &&  x < 17.250000 ) weight=26073.874860;
            if(x>= 17.250000 &&  x < 17.400000 ) weight=27381.803946;
            if(x>= 17.400000 &&  x < 17.550000 ) weight=28800.445897;
            if(x>= 17.550000 &&  x < 17.700000 ) weight=30219.610216;
            if(x>= 17.700000 &&  x < 17.850000 ) weight=31785.649094;
            if(x>= 17.850000 &&  x < 18.000000 ) weight=33118.626133;
            if(x>= 18.000000 &&  x < 18.150000 ) weight=35052.844841;
            if(x>= 18.150000 &&  x < 18.300000 ) weight=37193.418948;
            if(x>= 18.300000 &&  x < 18.450000 ) weight=38632.098341;
            if(x>= 18.450000 &&  x < 18.600000 ) weight=40507.253311;
            if(x>= 18.600000 &&  x < 18.750000 ) weight=42491.984492;
            if(x>= 18.750000 &&  x < 18.900000 ) weight=44539.395328;
            if(x>= 18.900000 &&  x < 19.050000 ) weight=46412.353625;
            if(x>= 19.050000 &&  x < 19.200000 ) weight=49044.462842;
            if(x>= 19.200000 &&  x < 19.350000 ) weight=51506.905496;
            if(x>= 19.350000 &&  x < 19.500000 ) weight=53429.554486;
            if(x>= 19.500000 &&  x < 19.650000 ) weight=55746.126650;
            if(x>= 19.650000 &&  x < 19.800000 ) weight=58955.774134;
            if(x>= 19.800000 &&  x < 19.950000 ) weight=61993.534685;
            if(x>= 19.950000 &&  x < 20.100000 ) weight=64176.345029;
            if(x>= 20.100000 &&  x < 20.250000 ) weight=67219.597456;
            if(x>= 20.250000 &&  x < 20.400000 ) weight=70957.035906;
            if(x>= 20.400000 &&  x < 20.550000 ) weight=73371.417186;
            if(x>= 20.550000 &&  x < 20.700000 ) weight=76061.051009;
            if(x>= 20.700000 &&  x < 20.850000 ) weight=79853.569767;
            if(x>= 20.850000 &&  x < 21.000000 ) weight=84442.676760;
            if(x>= 21.000000 &&  x < 21.150000 ) weight=87503.141785;
            if(x>= 21.150000 &&  x < 21.300000 ) weight=91828.320338;
            if(x>= 21.300000 &&  x < 21.450000 ) weight=94871.712089;
            if(x>= 21.450000 &&  x < 21.600000 ) weight=99486.847632;
            if(x>= 21.600000 &&  x < 21.750000 ) weight=103270.142234;
            if(x>= 21.750000 &&  x < 21.900000 ) weight=107484.385385;
            if(x>= 21.900000 &&  x < 22.050000 ) weight=112435.342976;
            if(x>= 22.050000 &&  x < 22.200000 ) weight=117013.401301;
            if(x>= 22.200000 &&  x < 22.350000 ) weight=120682.994621;
            if(x>= 22.350000 &&  x < 22.500000 ) weight=126409.474043;
            if(x>= 22.500000 &&  x < 22.650000 ) weight=131291.781977;
            if(x>= 22.650000 &&  x < 22.800000 ) weight=137227.169067;
            if(x>= 22.800000 &&  x < 22.950000 ) weight=143261.214586;
            if(x>= 22.950000 &&  x < 23.100000 ) weight=148313.903600;
            if(x>= 23.100000 &&  x < 23.250000 ) weight=155630.726343;
            if(x>= 23.250000 &&  x < 23.400000 ) weight=159684.977009;
            if(x>= 23.400000 &&  x < 23.550000 ) weight=166859.013255;
            if(x>= 23.550000 &&  x < 23.700000 ) weight=173056.310980;
            if(x>= 23.700000 &&  x < 23.850000 ) weight=180202.328900;
            if(x>= 23.850000 &&  x < 24.000000 ) weight=187809.190575;
            if(x>= 24.000000 &&  x < 24.150000 ) weight=195018.872958;
            if(x>= 24.150000 &&  x < 24.300000 ) weight=202616.914487;
            if(x>= 24.300000 &&  x < 24.450000 ) weight=210375.814437;
            if(x>= 24.450000 &&  x < 24.600000 ) weight=216861.450918;
            if(x>= 24.600000 &&  x < 24.750000 ) weight=227189.496823;
            if(x>= 24.750000 &&  x < 24.900000 ) weight=234705.607201;
            if(x>= 24.900000 &&  x < 25.050000 ) weight=241942.168352;
            if(x>= 25.050000 &&  x < 25.200000 ) weight=253547.114938;
            if(x>= 25.200000 &&  x < 25.350000 ) weight=263054.668265;
            if(x>= 25.350000 &&  x < 25.500000 ) weight=272572.336797;
            if(x>= 25.500000 &&  x < 25.650000 ) weight=279655.168800;
            if(x>= 25.650000 &&  x < 25.800000 ) weight=292212.267384;
            if(x>= 25.800000 &&  x < 25.950000 ) weight=300684.820630;
            if(x>= 25.950000 &&  x < 26.100000 ) weight=314782.241853;
            if(x>= 26.100000 &&  x < 26.250000 ) weight=322949.197802;
            if(x>= 26.250000 &&  x < 26.400000 ) weight=334168.582172;
            if(x>= 26.400000 &&  x < 26.550000 ) weight=344605.732360;
            if(x>= 26.550000 &&  x < 26.700000 ) weight=358126.462343;
            if(x>= 26.700000 &&  x < 26.850000 ) weight=372834.133469;
            if(x>= 26.850000 &&  x < 27.000000 ) weight=382612.067142;
            if(x>= 27.000000 &&  x < 27.150000 ) weight=393474.662227;
            if(x>= 27.150000 &&  x < 27.300000 ) weight=410152.970249;
            if(x>= 27.300000 &&  x < 27.450000 ) weight=423566.223378;
            if(x>= 27.450000 &&  x < 27.600000 ) weight=439287.521840;
            if(x>= 27.600000 &&  x < 27.750000 ) weight=454190.827642;
            if(x>= 27.750000 &&  x < 27.900000 ) weight=471470.546010;
            if(x>= 27.900000 &&  x < 28.050000 ) weight=490651.942255;
            if(x>= 28.050000 &&  x < 28.200000 ) weight=503068.825917;
            if(x>= 28.200000 &&  x < 28.350000 ) weight=519154.326979;
            if(x>= 28.350000 &&  x < 28.500000 ) weight=531709.751095;
            if(x>= 28.500000 &&  x < 28.650000 ) weight=548793.949592;
            if(x>= 28.650000 &&  x < 28.800000 ) weight=569601.993340;
            if(x>= 28.800000 &&  x < 28.950000 ) weight=584058.054478;
            if(x>= 28.950000 &&  x < 29.100000 ) weight=608854.209699;
            if(x>= 29.100000 &&  x < 29.250000 ) weight=626238.297115;
            if(x>= 29.250000 &&  x < 29.400000 ) weight=643736.752963;
            if(x>= 29.400000 &&  x < 29.550000 ) weight=669795.724532;
            if(x>= 29.550000 &&  x < 29.700000 ) weight=688364.179789;
            if(x>= 29.700000 &&  x < 29.850000 ) weight=707551.522149;
            if(x>= 29.850000 &&  x < 30.000000 ) weight=726182.124006;
            if(x>= 30) weight=726182.124006;
