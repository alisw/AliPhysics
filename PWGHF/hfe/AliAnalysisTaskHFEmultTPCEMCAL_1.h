...
#ifndef AliAnalysisTaskHFEmultTPCEMCAL_1_cxx
#define AliAnalysisTaskHFEmultTPCEMCAL_1_cxx
...
class AliAnalysisTaskHFEmultTPCEMCAL_1;
class AliCFManager;
class AliHFEcuts;
class AliHFEpidQAmanager;
...
class AliAnalysisTaskHFEmultTPCEMCAL_1 : public AliAnalysisTaskSE {
 public:
   ...
   enum ESourceType {kNoMotherE, kPi0NoFeedDown, kEtaNoFeedDown, kGPi0NoFeedDown, kGEtaNoFeedDown, kDirectGamma, kOthersE};//0,1,2,3,4,5,6
	...
	AliAnalysisTaskHFEmultTPCEMCAL_1() ;
	AliAnalysisTaskHFEmultTPCEMCAL_1(const char *name);
	virtual ~AliAnalysisTaskHFEmultTPCEMCAL_1() ;
  ...
  */
  ...
  //---------------------------------------------------------------
   ...
   AliAODMCHeader *fMCHeader;
	...
	TH2F	      *fnSigmaVsP_TPC_old;//!	
	TH2F	      *fnSigmaVsPt_TPC_old;//!
...
//====================MC================
   ...
   TH1F                *fULSElecPt;//!
	...
	AliAnalysisTaskHFEmultTPCEMCAL_1(const AliAnalysisTaskHFEmultTPCEMCAL_1&); // not implemented
	AliAnalysisTaskHFEmultTPCEMCAL_1& operator=(const AliAnalysisTaskHFEmultTPCEMCAL_1&); // not implemented
	  
	ClassDef(AliAnalysisTaskHFEmultTPCEMCAL_1, 1); // ClassDef(ClassName,ClassVersionID)  
};
