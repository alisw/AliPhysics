...
class AliAnalysisTaskJpsiJet : public AliAnalysisTaskSE
{
  ...
  private:
    Bool_t CollectInitialEventInformation();
    ...
    void FillLabelsEventStat(TH1* fHistEventStat);
    void FillElectronLevelVariables();
    void FillEventLevelVariables();
    void FillJetLevelVariables();
  ...
  private:
    ...
    void RunDielectronTask();
    Bool_t BuildTracksWithDielectronPair();
  ...
  private:
    ...
    // Background analysis
  private:
    void InitHistogramsForBackground(const char* histClass);
    Bool_t FillHistogramsForBackground(const char* histClass);
  ...
  private:
    ...
    AliAnalysisCuts   *fEventFilter;                //Event cuts
  ...
  private:
    ClassDef(AliAnalysisTaskJpsiJet, 7);
};
