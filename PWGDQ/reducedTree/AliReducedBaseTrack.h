...
class AliReducedBaseTrack : public TObject {
  ...
  public:
    ...
    Bool_t IsKinkDaughter(Int_t i=0)               const {return (i>=0 && i<3 ? (fQualityFlags&(ULong_t(1)<<(5+i))) : kFALSE);}
    Bool_t IsKinkMother(Int_t i=0) const {return (i>=0 && i<3 ? (fQualityFlags&(ULong_t(1)<<(12+i))) : kFALSE);}
