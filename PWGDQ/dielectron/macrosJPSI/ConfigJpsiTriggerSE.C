...
AliDielectron* ConfigJpsi(AliAnalysisTaskMultiDielectron *task)
{
  ...
  cutsToUse.push_back(maskSPDany);
   cutsToUse.push_back(maskTrackPt35);
   cutsToUse.push_back(maskTrackPt35 | maskSPDany);
  cutsToUse.push_back(maskTriggeredSE);
  cutsToUse.push_back(maskTriggeredSE | maskSPDany);
  cutsToUse.push_back(maskTriggeredSE | maskTrackPt35);
  cutsToUse.push_back(maskTriggeredSE | maskTrackPt35 | maskSPDany);
  TString names = "default+SPDfirst;default+SPDany;Pt>3.5+SPDfirst;Pt>3.5+SPDany;SEtrig+SPDfirst;SEtrig+SPDany;SEtrig+Pt>3.5+SPDfirst;SEtrig+Pt>3.5+SPDany";
