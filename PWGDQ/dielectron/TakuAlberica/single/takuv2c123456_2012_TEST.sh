...
aliroot -b -q  takuv2c123456_2012_TEST.C 
RET=$?
if [ "$RET" != "0" ];then
  echo "======== ERROR : takuv2c123456_2012_TEST.C finished with NON zero code: $RET ========"
...
echo "======== takuv2c123456_2012_TEST.C finished with exit code: $RET ========"
echo "############## memory after: ##############"
free -m
