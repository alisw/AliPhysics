...
ClassImp(AliDielectronDebugTreeTaku)

AliDielectronDebugTreeTaku::AliDielectronDebugTreeTaku() :
  TNamed(),
...
AliDielectronDebugTreeTaku::AliDielectronDebugTreeTaku(const char* name, const char* title) :
  TNamed(name, title),
  fFileName("jpsi_debug.root"),
  fNVars(0),
  fNVarsLeg(0),
...
//______________________________________________
void AliDielectronDebugTreeTaku::Fill(AliDielectronPair *pair)
{
  //
...
//______________________________________________
void AliDielectronDebugTreeTaku::DeleteStreamer()
{
  //
  // delete the streamer
  //
...
//______________________________________________
void AliDielectronDebugTreeTaku::WriteTree()
{
  //
  // Write file
  //
