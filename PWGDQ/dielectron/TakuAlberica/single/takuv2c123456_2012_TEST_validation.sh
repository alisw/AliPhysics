...
if ! [ -f Resultstakuv2c123456_2012_TESTAnalysisResults.root ] ; then
   error=1
   echo "Output file Resultstakuv2c123456_2012_TESTAnalysisResults.root not found. Job FAILED !" >> stdout
   echo "Output file Resultstakuv2c123456_2012_TESTAnalysisResults.root not found. Job FAILED !" >> stderr
fi
