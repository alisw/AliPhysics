...
class AliDielectronDebugTreeTaku : public TNamed {
public:
  AliDielectronDebugTreeTaku();
  AliDielectronDebugTreeTaku(const char*name, const char* title);

  virtual ~AliDielectronDebugTreeTaku();
  ...
  void SetDielectron(AliDielectronTaku * const dielectron) { fDielectron=dielectron; }
...
private:
  ...
  AliDielectronTaku *fDielectron;      //! pointer to mother dielectron manager

  AliDielectronDebugTreeTaku(const AliDielectronDebugTreeTaku &c);
  AliDielectronDebugTreeTaku &operator=(const AliDielectronDebugTreeTaku &c);

  
  ClassDef(AliDielectronDebugTreeTaku,1)         // Dielectron DebugTree
};
