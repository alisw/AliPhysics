...
*/
AliAnalysisTask *AddTask_taku_LMEEPbPb2011Cent(Bool_t runRejection=kFALSE, Bool_t setMC=kFALSE,Bool_t enableCF=kFALSE){
  ...
  PairCutType[0] = PairCutTypeDef[1];
  PairCutType[1] = PairCutTypeDef[4];
  PairCutType[2] = PairCutTypeDef[7];
  PairCutType[3] = PairCutTypeDef[10];
  PairCutType[4] = PairCutTypeDef[13];
  ...
  AliAnalysisDataContainer *coutput1 =
    mgr->CreateContainer("taku_LMEEPbPb2011_cent_tree",
	TTree::Class(),
	AliAnalysisManager::kExchangeContainer,
	"taku_LMEEPbPb2011_cent_default.root");

  AliAnalysisDataContainer *cOutputHist1 =
    mgr->CreateContainer("taku_LMEEPbPb2011_cent_out",
	TList::Class(),
	AliAnalysisManager::kOutputContainer,
	"taku_LMEEPbPb2011_cent_out.root");
  
  AliAnalysisDataContainer *cOutputHist2 = 0x0;
  if (enableCF) {
    cOutputHist2 = 
      mgr->CreateContainer("taku_LMEEPbPb2011_cent_CF",
	  TList::Class(),
	  AliAnalysisManager::kOutputContainer,
	  "taku_LMEEPbPb2011_cent_out.root");
  ...
  AliAnalysisDataContainer *cOutputHist3 =
    mgr->CreateContainer("taku_EventStatPbPb2011_cent",
	TH1D::Class(),
	AliAnalysisManager::kOutputContainer,
	"taku_LMEEPbPb2011_cent_out.root");
