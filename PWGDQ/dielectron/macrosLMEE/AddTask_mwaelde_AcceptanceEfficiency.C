AliAnalysisTask* AddTask_mwaelde_AcceptanceEfficiency(TString name = "name", TString cFileName ="Config_mwaelde_AccEff.C")
  {
    ...
    // TString configBasePath= "$/home/merle/MA/Analysis/AccEff";
    ...
    // same for the output
    mgr->ConnectOutput(task,1,mgr->CreateContainer(Form("MyOutputContainer_cutVari"), TList::Class(), AliAnalysisManager::kOutputContainer, fileName.Data()));
