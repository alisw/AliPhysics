...
void InitHistograms(AliDielectron *die, Int_t cutDefinition)
{
  ...
  // histos->UserHistogram("Track","R","R;R [cm];#tracks",200,0.,0.1,AliDielectronVarManager::kR);
  ...
  histos->UserHistogram("Track","Pt_ImpParXYsigma","ImpParXYsigma; p_{T} (GeV/c); Impact Parameter (#sigma); #counts",100,0.,10.,200,-10.,10.,AliDielectronVarManager::kPt,AliDielectronVarManager::kImpactParXYsigma);
  histos->UserHistogram("Track","Pt_ImpParXY","ImpParXY; p_{T} (GeV/c); Impact Parameter (#sigma); #counts",100,0.,10.,200,-10.,10.,AliDielectronVarManager::kPt,AliDielectronVarManager::kImpactParXY);
