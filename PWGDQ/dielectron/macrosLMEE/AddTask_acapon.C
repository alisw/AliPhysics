AliAnalysisTask *AddTask_acapon(TString outputFileName = "AnalysisResult.root", Bool_t SDDstatus = kFALSE, Bool_t getFromAlien = kFALSE, Bool_t = doMixing){
  ...
  if (getFromAlien //&&
      && (!gSystem->Exec("alien_cp alien:///alice/cern.ch/user/a/acapon/dielectronShizzle/Config_acapon.C ."))
      && (!gSystem->Exec("alien_cp alien:///alice/cern.ch/user/a/acapon/dielectronShizzle/LMEECutLib_acapon.C ."))
  ){
