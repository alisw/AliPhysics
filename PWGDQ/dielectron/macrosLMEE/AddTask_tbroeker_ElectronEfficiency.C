...
//   }
  ...
  //
  AliAnalysisDataContainer *coutput1 = mgr->CreateContainer("tbroeker_ElectronEfficiency", TList::Class(),
                                                           AliAnalysisManager::kOutputContainer,outputFileName);
  AliAnalysisDataContainer *coutput2 = mgr->CreateContainer("tbroeker_supportHistos", TList::Class(),
                                                            AliAnalysisManager::kOutputContainer,outputFileName);
