...
//
  ...
  {"MatchEffITSTPCinPlane", "N_{trk}^{TPC}/N_{trk}^{ITS} #cbar_{#||{#eta}<0.9, 0.79 < #||{#phi^{Track}-#Psi^{TPC}} < 0.79 || 2.35 < #||{#phi^{Track}-#Psi^{TPC}} < 3.15}",  ""},
  {"MatchEffITSTPCoutPlane", "N_{trk}^{TPC}/N_{trk}^{ITS} #cbar_{#||{#eta}<0.9, 0.79 < #||{#phi^{Track}-#Psi^{TPC}} < 2.35}",  ""},
