...
// XX YY XY YX relations
  {"QnTPCx_V0AxDiffH2",         "TPC^{Qn}_{x}-V0A^{Qn}_{x}",                 ""},
  {"QnTPCx_V0AyDiffH2",         "TPC^{Qn}_{x}-V0A^{Qn}_{y}",                 ""},
  {"QnTPCy_V0AxDiffH2",         "TPC^{Qn}_{y}-V0A^{Qn}_{x}",                 ""},
  {"QnTPCy_V0AyDiffH2",         "TPC^{Qn}_{y}-V0A^{Qn}_{y}",                 ""},
  {"QnTPCx_V0CxDiffH2",         "TPC^{Qn}_{x}-V0C^{Qn}_{x}",                 ""},
  {"QnTPCx_V0CyDiffH2",         "TPC^{Qn}_{x}-V0C^{Qn}_{y}",                 ""},
  {"QnTPCy_V0CxDiffH2",         "TPC^{Qn}_{y}-V0C^{Qn}_{x}",                 ""},
  {"QnTPCy_V0CyDiffH2",         "TPC^{Qn}_{y}-V0C^{Qn}_{y}",                 ""},
  {"QnTPCx_SPDxDiffH2",         "TPC^{Qn}_{x}-SPD^{Qn}_{x}",                 ""},
  {"QnTPCx_SPDyDiffH2",         "TPC^{Qn}_{x}-SPD^{Qn}_{y}",                 ""},
  {"QnTPCy_SPDxDiffH2",         "TPC^{Qn}_{y}-SPD^{Qn}_{x}",                 ""},
  {"QnTPCy_SPDyDiffH2",         "TPC^{Qn}_{y}-SPD^{Qn}_{y}",                 ""},
  {"QnTPCx_FMDAxDiffH2",        "TPC^{Qn}_{x}-FMDA^{Qn}_{x}",                 ""},
  {"QnTPCx_FMDAyDiffH2",        "TPC^{Qn}_{x}-FMDA^{Qn}_{y}",                 ""},
  {"QnTPCy_FMDAxDiffH2",        "TPC^{Qn}_{y}-FMDA^{Qn}_{x}",                 ""},
  {"QnTPCy_FMDAyDiffH2",        "TPC^{Qn}_{y}-FMDA^{Qn}_{y}",                 ""},
  {"QnTPCx_FMDCxDiffH2",        "TPC^{Qn}_{x}-FMDC^{Qn}_{x}",                 ""},
  {"QnTPCx_FMDCyDiffH2",        "TPC^{Qn}_{x}-FMDC^{Qn}_{y}",                 ""},
  {"QnTPCy_FMDCxDiffH2",        "TPC^{Qn}_{y}-FMDC^{Qn}_{x}",                 ""},
  {"QnTPCy_FMDCyDiffH2",        "TPC^{Qn}_{y}-FMDC^{Qn}_{y}",                 ""},
  {"QnV0Ax_V0CxDiffH2",         "V0A^{Qn}_{x}-V0C^{Qn}_{x}",                 ""},
  {"QnV0Ax_V0CyDiffH2",         "V0A^{Qn}_{x}-V0C^{Qn}_{y}",                 ""},
  {"QnV0Ay_V0CxDiffH2",         "V0A^{Qn}_{y}-V0C^{Qn}_{x}",                 ""},
  {"QnV0Ay_V0CyDiffH2",         "V0A^{Qn}_{y}-V0C^{Qn}_{y}",                 ""},
  {"QnV0Ax_SPDxDiffH2",         "V0A^{Qn}_{x}-SPD^{Qn}_{x}",                 ""},
  {"QnV0Ax_SPDyDiffH2",         "V0A^{Qn}_{x}-SPD^{Qn}_{y}",                 ""},
  {"QnV0Ay_SPDxDiffH2",         "V0A^{Qn}_{y}-SPD^{Qn}_{x}",                 ""},
  {"QnV0Ay_SPDyDiffH2",         "V0A^{Qn}_{y}-SPD^{Qn}_{y}",                 ""},
  {"QnV0Ax_FMDAxDiffH2",        "V0A^{Qn}_{x}-FMDA^{Qn}_{x}",                 ""},
  {"QnV0Ax_FMDAyDiffH2",        "V0A^{Qn}_{x}-FMDA^{Qn}_{y}",                 ""},
  {"QnV0Ay_FMDAxDiffH2",        "V0A^{Qn}_{y}-FMDA^{Qn}_{x}",                 ""},
  {"QnV0Ay_FMDAyDiffH2",        "V0A^{Qn}_{y}-FMDA^{Qn}_{y}",                 ""},
  {"QnV0Ax_FMDCxDiffH2",        "V0A^{Qn}_{x}-FMDC^{Qn}_{x}",                 ""},
  {"QnV0Ax_FMDCyDiffH2",        "V0A^{Qn}_{x}-FMDC^{Qn}_{y}",                 ""},
  {"QnV0Ay_FMDCxDiffH2",        "V0A^{Qn}_{y}-FMDC^{Qn}_{x}",                 ""},
  {"QnV0Ay_FMDCyDiffH2",        "V0A^{Qn}_{y}-FMDC^{Qn}_{y}",                 ""},
  {"QnV0Cx_FMDAxDiffH2",        "V0C^{Qn}_{x}-FMDA^{Qn}_{x}",                 ""},
  {"QnV0Cx_FMDAyDiffH2",        "V0C^{Qn}_{x}-FMDA^{Qn}_{y}",                 ""},
  {"QnV0Cy_FMDAxDiffH2",        "V0C^{Qn}_{y}-FMDA^{Qn}_{x}",                 ""},
  {"QnV0Cy_FMDAyDiffH2",        "V0C^{Qn}_{y}-FMDA^{Qn}_{y}",                 ""},
  {"QnV0Cx_FMDCxDiffH2",        "V0C^{Qn}_{x}-FMDC^{Qn}_{x}",                 ""},
  {"QnV0Cx_FMDCyDiffH2",        "V0C^{Qn}_{x}-FMDC^{Qn}_{y}",                 ""},
  {"QnV0Cy_FMDCxDiffH2",        "V0C^{Qn}_{y}-FMDC^{Qn}_{x}",                 ""},
  {"QnV0Cy_FMDCyDiffH2",        "V0C^{Qn}_{y}-FMDC^{Qn}_{y}",                 ""},
  {"QnV0Cx_SPDxDiffH2",         "V0C^{Qn}_{x}-SPD^{Qn}_{x}",                 ""},
  {"QnV0Cx_SPDyDiffH2",         "V0C^{Qn}_{x}-SPD^{Qn}_{y}",                 ""},
  {"QnV0Cy_SPDxDiffH2",         "V0C^{Qn}_{y}-SPD^{Qn}_{x}",                 ""},
  {"QnV0Cy_SPDyDiffH2",         "V0C^{Qn}_{y}-SPD^{Qn}_{y}",                 ""},
  {"QnSPDx_FMDAxDiffH2",        "SPD^{Qn}_{x}-FMDA^{Qn}_{x}",                 ""},
  {"QnSPDx_FMDAyDiffH2",        "SPD^{Qn}_{x}-FMDA^{Qn}_{y}",                 ""},
  {"QnSPDy_FMDAxDiffH2",        "SPD^{Qn}_{y}-FMDA^{Qn}_{x}",                 ""},
  {"QnSPDy_FMDAyDiffH2",        "SPD^{Qn}_{y}-FMDA^{Qn}_{y}",                 ""},
  {"QnSPDx_FMDCxDiffH2",        "SPD^{Qn}_{x}-FMDC^{Qn}_{x}",                 ""},
  {"QnSPDx_FMDCyDiffH2",        "SPD^{Qn}_{x}-FMDC^{Qn}_{y}",                 ""},
  {"QnSPDy_FMDCxDiffH2",        "SPD^{Qn}_{y}-FMDC^{Qn}_{x}",                 ""},
  {"QnSPDy_FMDCyDiffH2",        "SPD^{Qn}_{y}-FMDC^{Qn}_{y}",                 ""},
  {"QnFMDAx_FMDCxDiffH2",       "FMDA^{Qn}_{x}-FMDC^{Qn}_{x}",                 ""},
