...
public:
  ...
  enum EFilterBit  { kSwitchOff=0, kTPCqual=1, kITSonly=2, kTPCqualSPDany=4, kTPCqualSPDanyPIDele=8, kGlobalNoDCA=16, kGlobalTightDCA=32, kTPConly=128, kHybridGlobal=256, kHybridConstrained=512};
