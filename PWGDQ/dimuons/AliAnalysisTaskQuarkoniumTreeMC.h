#ifndef AliAnalysisTaskQuarkoniumTreeMC_H
#define AliAnalysisTaskQuarkoniumTreeMC_H
...
class AliAnalysisTaskQuarkoniumTreeMC : public AliAnalysisTaskSE {
  public:

  AliAnalysisTaskQuarkoniumTreeMC();
  AliAnalysisTaskQuarkoniumTreeMC(const char *name);
  virtual ~AliAnalysisTaskQuarkoniumTreeMC();
 ...
 private:
  ...
  Int_t	        fDimuMatch_gen[1000];		// dimuon match
  Double_t      fDimuCostHE_gen[1000]; // cost Helicty frame
  Double_t      fDimuPhiHE_gen[1000]; // phi Helicty fame
  Double_t      fDimuCostCS_gen[1000]; // cost Collins-Soper
  ...
  Double_t      fDimuCostHE_rec[1000]; // cost Helicty frame
  Double_t      fDimuPhiHE_rec[1000]; // phi Helicty fame
  Double_t      fDimuCostCS_rec[1000]; // cost Collins-Soper
  Double_t      fDimuPhiCS_rec[1000]; // phi Collins-Soper

  AliAODEvent* fAODEvent;      //! AOD event  //tolgo !
  
 ClassDef(AliAnalysisTaskQuarkoniumTreeMC,1);
};
