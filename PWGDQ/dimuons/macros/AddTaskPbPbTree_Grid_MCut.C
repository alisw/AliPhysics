AliAnalysisTaskPbPbTree_MCut *AddTaskPbPbTree_Grid_MCut(Double_t MassCut){
...
//****************************************************************************************
   ...
   if (!mgr) {
      ::Error("AddTaskPbPbTree_Grid_MCut", "No analysis manager to connect to.");
      return NULL;
   }
   ...
   AliAnalysisTaskPbPbTree_MCut *TreeTask = new AliAnalysisTaskPbPbTree_MCut("AliAnalysisTaskPbPbTree_MCut");
