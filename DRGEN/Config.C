...
enum PprRun_t 
{
  kDRgen_continuum2PiPi, kDRgen_sigma2PiPi, kDRgen_rho2PiPi, kDRgen_f02PiPi, kDRgen_f22PiPi,
  kDRgen_f2DzeroPom2PiPi, kDRgen_f2DplusminusPom2PiPi,kDRgen_f2DzeroProt2PiPi,
  ...
  kTPHIC_res,
    ...
    kHijing_pA, kPythia6, kPhojet, kPythia8, kPythia8CD,
...
const char* pprRunName[] = {
  ...
  "kTPHIC_res",
    ...
    "kHijing_gj200", "kHijing_pA", "kPythia6", "kPhojet", "kPythia8", "kPythia8CD",
    "kPythia6Jets20_24",   "kPythia6Jets24_29",   "kPythia6Jets29_35",
    "kPythia6Jets35_42",   "kPythia6Jets42_50",   "kPythia6Jets50_60",
    "kPythia6Jets60_72",   "kPythia6Jets72_86",   "kPythia6Jets86_104",
    "kPythia6Jets104_125", "kPythia6Jets125_150", "kPythia6Jets150_180",
...
void Config()
{
    ...
    seed=sseed; // random number seed for pythia8 generator
   ...
   // libraries required by geant321
    ...
    gSystem->Load("libTPHIC.so");
    gSystem->Load("libDRgen.so");//COMPASS generator
  ...
  ((TGeant3*)gMC)->SetSWIT(4,100);
    ...
    // Revmoved as per https://savannah.cern.ch/task/?33183#comment61
...
AliGenerator* GeneratorFactory(PprRun_t srun) {
    ...
    switch (srun) {
    case kDRgen_continuum2PiPi:
      {
	comment = comment.Append(": COMPASS DPE generator, continuum production");
	AliGenDRgen* gener = new AliGenDRgen();
	gener->SetBeamEnergy(energy/2.);
        gener->SetProcess(1,1);
	gGener = gener;
      }
      break;
    case kDRgen_sigma2PiPi:
      {
        comment = comment.Append(": COMPASS DPE generator, sigma production");
        AliGenDRgen* gener = new AliGenDRgen();
        gener->SetBeamEnergy(energy/2.);
        gener->SetProcess(2,2);
        gGener = gener;
      }
      break;
    case kDRgen_rho2PiPi:
      {
        comment = comment.Append(": COMPASS DPE generator, rho production");
        AliGenDRgen* gener = new AliGenDRgen();
        gener->SetBeamEnergy(energy/2.);
        gener->SetProcess(3,3);
        gGener = gener;
      }
      break;
    case kDRgen_f02PiPi:
      {
        comment = comment.Append(": COMPASS DPE generator, f0 production");
        AliGenDRgen* gener = new AliGenDRgen();
        gener->SetBeamEnergy(energy/2.);
    ...
    case kDRgen_f22PiPi:
      {
        comment = comment.Append(": COMPASS DPE generator, f2 production");
        AliGenDRgen* gener = new AliGenDRgen();
        gener->SetBeamEnergy(energy/2.);
        gener->SetProcess(5,5);
        gGener = gener;
      }
      break;
    case kDRgen_f2DzeroPom2PiPi:
      {
        comment = comment.Append(": COMPASS DPE generator, f2 Dzero wave (Pom-Pom system) production");
	AliGenDRgen* gener = new AliGenDRgen();
        gener->SetBeamEnergy(energy/2.);
	gener->SetProcess(6,6);
        gGener = gener;
      }
      break;
    case kDRgen_f2DplusminusPom2PiPi:
      {
        comment = comment.Append(": COMPASS DPE generator, f2 Dplus + Dminus waves (no interference, Pom-Pom system) production");
        AliGenDRgen* gener = new AliGenDRgen();
        gener->SetBeamEnergy(energy/2.);
        gener->SetProcess(7,7);
        gGener = gener;
      }
      break;
    case kDRgen_f2DzeroProt2PiPi:
      {
        comment = comment.Append(": COMPASS DPE generator, f2 Dzero wave (prot-prot system) production");
        AliGenDRgen* gener = new AliGenDRgen();
        gener->SetBeamEnergy(energy/2.);
        gener->SetProcess(8,8);
        gGener = gener;
      }
      break;
    case kDRgen_f2DplusminusProt2PiPi:
      {
        comment = comment.Append(": COMPASS DPE generator, f2 Dplus + Dminus waves (no interference, prot-prot system) production");
        AliGenDRgen* gener = new AliGenDRgen();
        gener->SetBeamEnergy(energy/2.);
        gener->SetProcess(9,9);
        gGener = gener;
      }
      break;
    case kTPHIC_res:
      {
	comment = comment.Append(":tphic resonance production");
        AliGenTPHIC *gener = new AliGenTPHIC();
	gener->SetBeamEnergy(3500.);
	gener->SetBeamZ(1);
	gener->SetBeamA(1);
	gener->SetProcess(2);
	gener->SetKfOnium(10221); // f0(980)
	gener->SetGGwidthOnium(0.060); //f0(980) width. pdg gives 0.040 to 0.100
	gener->SetMggRange(0.5,3.);
	gGener=gener;
      }
      break;
    case test50:
...
//
	...
	gGener=gener;
      ...
      case kPythia6:
      {
        comment = comment.Append(":Pythia p-p");
		...
		case kPythia8:
      {
        comment = comment.Append(":Pythia8 p-p");
		  ...
		  (AliPythia8::Instance())->ReadString(Form("Random:seed = %ld", seed)); 
        gGener=gener;
      }
        break;
		case kPythia8CD:
      {
        comment = comment.Append(":Pythia8 p-p Central Diffraction");

		  AliGenPythiaPlus* gener = new AliGenPythiaPlus(AliPythia8::Instance());
		  gener->SetProcess(kPyMBRCentralDiffraction);
		  //   Centre of mass energy
		  gener->SetEnergyCMS(energy);
		  //   Initialize generator
		  gener->SetEventListRange(-1, 2); 
		  seed = seed%900000000;
		  (AliPythia8::Instance())->ReadString("Diffraction:MBRm2Min = 2.25");
		  (AliPythia8::Instance())->ReadString("Random:setSeed = on");
		  (AliPythia8::Instance())->ReadString(Form("Random:seed = %ld", seed)); 
      ...
      {
        comment = comment.Append(":Pythia jets 20-24 GeV");
        AliGenPythia * gener = new AliGenPythia(-1);
      ...
      {
        comment = comment.Append(":Pythia jets 24-29 GeV");
        AliGenPythia * gener = new AliGenPythia(-1);
        gener->SetEnergyCMS(energy);//        Centre of mass energy
        gener->SetProcess(kPyJets);//        Process type
        gener->SetJetEtaRange(-0.5, 0.5);//  Final state kinematic cuts
      ...
      {
        comment = comment.Append(":Pythia jets 29-35 GeV");
        AliGenPythia * gener = new AliGenPythia(-1);
        gener->SetEnergyCMS(energy);//        Centre of mass energy
        gener->SetProcess(kPyJets);//        Process type
        gener->SetJetEtaRange(-0.5, 0.5);//  Final state kinematic cuts
      ...
      {
        comment = comment.Append(":Pythia jets 35-42 GeV");
        AliGenPythia * gener = new AliGenPythia(-1);
        gener->SetEnergyCMS(energy);//        Centre of mass energy
        gener->SetProcess(kPyJets);//        Process type
        gener->SetJetEtaRange(-0.5, 0.5);//  Final state kinematic cuts
      ...
      {
        comment = comment.Append(":Pythia jets 42-50 GeV");
        AliGenPythia * gener = new AliGenPythia(-1);
        gener->SetEnergyCMS(energy);//        Centre of mass energy
        gener->SetProcess(kPyJets);//        Process type
        gener->SetJetEtaRange(-0.5, 0.5);//  Final state kinematic cuts
      ...
      {
        comment = comment.Append(":Pythia jets 50-60 GeV");
        AliGenPythia * gener = new AliGenPythia(-1);
        gener->SetEnergyCMS(energy);//        Centre of mass energy
        gener->SetProcess(kPyJets);//        Process type
        gener->SetJetEtaRange(-0.5, 0.5);//  Final state kinematic cuts
      ...
      {
        comment = comment.Append(":Pythia jets 60-72 GeV");
        AliGenPythia * gener = new AliGenPythia(-1);
        gener->SetEnergyCMS(energy);//        Centre of mass energy
        gener->SetProcess(kPyJets);//        Process type
        gener->SetJetEtaRange(-0.5, 0.5);//  Final state kinematic cuts
      ...
      {
        comment = comment.Append(":Pythia jets 72-86 GeV");
        AliGenPythia * gener = new AliGenPythia(-1);
        gener->SetEnergyCMS(energy);//        Centre of mass energy
        gener->SetProcess(kPyJets);//        Process type
        gener->SetJetEtaRange(-0.5, 0.5);//  Final state kinematic cuts
      ...
      {
        comment = comment.Append(":Pythia jets 86-104 GeV");
        AliGenPythia * gener = new AliGenPythia(-1);
        gener->SetEnergyCMS(energy);//        Centre of mass energy
        gener->SetProcess(kPyJets);//        Process type
        gener->SetJetEtaRange(-0.5, 0.5);//  Final state kinematic cuts
    ...
    case kPythia6Jets104_125:
      {
        comment = comment.Append(":Pythia jets 105-125 GeV");
        AliGenPythia * gener = new AliGenPythia(-1);
        gener->SetEnergyCMS(energy);//        Centre of mass energy
        gener->SetProcess(kPyJets);//        Process type
        gener->SetJetEtaRange(-0.5, 0.5);//  Final state kinematic cuts
      ...
      {
        comment = comment.Append(":Pythia jets 125-150 GeV");
        AliGenPythia * gener = new AliGenPythia(-1);
        gener->SetEnergyCMS(energy);//        Centre of mass energy
        gener->SetProcess(kPyJets);//        Process type
        gener->SetJetEtaRange(-0.5, 0.5);//  Final state kinematic cuts
      ...
      case kD0PbPb5500:
      {
        comment = comment.Append(" D0 in Pb-Pb");
    ...
    case kCharmSemiElPbPb5500:
      {
        comment = comment.Append(" Charm in Pb-Pb");
        AliGenPythia * gener = new AliGenPythia(10);
      ...
      case kBeautySemiElPbPb5500:
      {
        comment = comment.Append(" Beauty in Pb-Pb");
        AliGenPythia *gener = new AliGenPythia(10);
      ...
      case kCocktailTRD:
      {
        comment = comment.Append(" Cocktail for TRD");
        AliGenCocktail *gener  = new AliGenCocktail();
    ...
    case kPyJJ:
      {
        comment = comment.Append(" Jet-jet");
        AliGenPythia *gener = new AliGenPythia(-1);
        gener->SetEnergyCMS(energy);
      ...
      case kPyGJ:
      {
        comment = comment.Append(" Gamma-jet");
        AliGenPythia *gener = new AliGenPythia(-1);
        gener->SetEnergyCMS(energy);
