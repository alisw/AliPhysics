...
AliAnalysisTaskEMCALPhotonTagged *AddTaskEMCALPhotonTagged(
						     ...
						     )
{
  ...
  if (!mgr) {
    ::Error("AddTaskEMCALPhotonTagged", "No analysis manager to connect to.");
    return NULL;
  }  
  
  // Create the task and configure it.
  //===========================================================================
  AliAnalysisTaskEMCALPhotonTagged* ana = new  AliAnalysisTaskEMCALPhotonTagged("");
  ...
  mgr->AddTask(ana);
  TString containername = "histEMCPhotonTagged."+trigbitname;
