...
*             /home/amorreal/Alice/Work/taskEMCal/AliAddedSignalsTask.cxx
*
...
///\cond CLASSIMP
ClassImp(AliAddedSignalsTask)
///\endcond

//________________________________________________________________________
AliAddedSignalsTask::AliAddedSignalsTask(const char *name) :
...
//________________________________________________________________________
AliAddedSignalsTask::~AliAddedSignalsTask()
{
...
//________________________________________________________________________
void AliAddedSignalsTask::UserCreateOutputObjects( void )
{
...
//________________________________________________________________________
void AliAddedSignalsTask::UserExec( Option_t* )
{
    ...
    for( Int_t iPart = firstetaParticle; iPart < lastetaParticle; iPart++ )
    {
            ...
            )
        {
            ...
            fClusterMCStatCount++;
        }//choose only flat etas

    } //iPartHijingGeneratorName
...
//________________________________________________________________________
Double_t AliAddedSignalsTask ::GetMaxCellEnergy(const AliVCluster *cluster, Int_t &id) const
{
...
//________________________________________________________________________
void AliAddedSignalsTask::Terminate(const Option_t*)
{}
