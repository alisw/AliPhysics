      ...
      fMap_TH1_ExponentialInterpolation()
{
   ...
   utils_TH1::TH1_ExponentialInterpolation *lInstance = new utils_TH1::TH1_ExponentialInterpolation(
        id,
        *this,
        _th1,
        _integrate,
...
{   
    ...
    utils_TH1::TH1_ExponentialInterpolation *lExpInter = new utils_TH1::TH1_ExponentialInterpolation(
         "",
        *this,
         _th1,
         _integrate,
    ...
    auto &lPair_key_value = *new std::pair<TH1 const*, utils_TH1::TH1_ExponentialInterpolation*>({ &_th1, lExpInter }); 
