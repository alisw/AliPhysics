...
AliConvEventCuts::AliConvEventCuts(const char *name, const char *title) : AliAnalysisCuts(name, title),
                                                                          fHistograms(NULL),
                                                                          fHeaderList(NULL),
                                                                          fDoLightOutput(0),
                                                                          fEventQuality(-1),
                                                                          ...
                                                                          hReweightMCHistPi0_var(NULL),
                                                                          hReweightMCHistEta_inv(NULL),
                                                                          hReweightMCHistEta_var(NULL),
                                                                          hReweightMCHistK0s_inv(NULL),
                                                                          hReweightMCHistK0s_var(NULL),
                                                                          fFitDataPi0_inv(NULL),
                                                                          fFitDataPi0_var(NULL),
                                                                          fFitDataEta_inv(NULL),
                                                                          fFitDataEta_var(NULL),
                                                                          fFitDataK0s_inv(NULL),
                                                                          fFitDataK0s_var(NULL),
...
//________________________________________________________________________
AliConvEventCuts::AliConvEventCuts(const AliConvEventCuts &ref) : AliAnalysisCuts(ref),
                                                                  fHistograms(NULL),
                                                                  ...
                                                                  hReweightMCHistPi0_var(ref.hReweightMCHistPi0_var),
                                                                  hReweightMCHistEta_inv(ref.hReweightMCHistEta_inv),
                                                                  hReweightMCHistEta_var(ref.hReweightMCHistEta_var),
                                                                  hReweightMCHistK0s_inv(ref.hReweightMCHistK0s_inv),
                                                                  hReweightMCHistK0s_var(ref.hReweightMCHistK0s_var),
                                                                  fFitDataPi0_inv(ref.fFitDataPi0_inv),
                                                                  fFitDataPi0_var(ref.fFitDataPi0_var),
                                                                  fFitDataEta_inv(ref.fFitDataEta_inv),
                                                                  fFitDataEta_var(ref.fFitDataEta_var),
                                                                  fFitDataK0s_inv(ref.fFitDataK0s_inv),
                                                                  fFitDataK0s_var(ref.fFitDataK0s_var),
...
void AliConvEventCuts::InitCutHistograms(TString name, Bool_t preCut)
{
  ...
  if (fHistograms == NULL)
  {
    ...
    if (name == "")
      fHistograms->SetName(Form("ConvEventCuts_%s", GetCutNumber().Data()));
    else
      fHistograms->SetName(Form("%s_%s", name.Data(), GetCutNumber().Data()));
  }
  ...
  { // high mult 0.1%
    ...
    if (!fDoLightOutput && fDetectorCentrality != -1)
      hCentralityVsNumberOfPrimaryTracks = new TH2F(Form("Centrality vs Primary Tracks %s", GetCutNumber().Data()), "Centrality vs Primary Tracks ", centBins, arrCent, maxNTracks, 0, maxNTracks);
  }
  ...
  else
  {
    ...
    if (!fDoLightOutput && fDetectorCentrality != -1)
      hCentralityVsNumberOfPrimaryTracks = new TH2F(Form("Centrality vs Primary Tracks %s", GetCutNumber().Data()), "Centrality vs Primary Tracks ", 210, 0, 105, maxNTracks, 0, maxNTracks);
  }
...
Bool_t AliConvEventCuts::EventIsSelected(AliVEvent *event, AliMCEvent *mcEvent)
{
  ...
  if (hSPDClusterTrackletBackgroundBefore)
    hSPDClusterTrackletBackgroundBefore->Fill(nTracklets, (nClustersLayer0 + nClustersLayer1));
    ...
    else
    {
      ...
      if (fRemovePileUpSPD)
      {
        if (fUtils->IsPileUpEvent(event))
        {
          if (fHistoEventCuts)
            fHistoEventCuts->Fill(cutindex);
          if (hPileupVertexToPrimZSPDPileup)
        ...
        if (fUtils->IsSPDClusterVsTrackletBG(event))
        {
          if (fHistoEventCuts)
            fHistoEventCuts->Fill(cutindex);
          if (hPileupVertexToPrimZTrackletvsHits)
  ...
  if (fHistoEventCuts)
    fHistoEventCuts->Fill(cutindex);
  if (hCentrality)
    hCentrality->Fill(GetCentrality(event));
  if (hVertexZ)
    hVertexZ->Fill(event->GetPrimaryVertex()->GetZ());
  if (hCentralityVsNumberOfPrimaryTracks)
    hCentralityVsNumberOfPrimaryTracks->Fill(GetCentrality(event),
                                             ((AliV0ReaderV1 *)AliAnalysisManager::GetAnalysisManager()
                                                  ->GetTask(fV0ReaderName.Data()))
                                                 ->GetNumberOfPrimaryTracks());
  ...
  if (fIsHeavyIon == 1)
  {
    ...
    if (hEventPlaneAngle)
      hEventPlaneAngle->Fill(TMath::Abs(fEventPlaneAngle));
  }
  if (hSPDClusterTrackletBackground)
    hSPDClusterTrackletBackground->Fill(nTracklets, (nClustersLayer0 + nClustersLayer1));
...
void AliConvEventCuts::LoadWeightingFlatCentralityFromFile()
{
  ...
  if (fNameHistoNotFlatCentrality.CompareTo("") != 0 && (fDoCentralityFlat > 0))
  {
    ...
    if (hCentralityNotFlat)
      AliInfo(Form("%s has been loaded from %s", fNameHistoNotFlatCentrality.Data(), fPathWeightsFlatCent.Data()));
    else
      AliWarning(Form("%s not found in %s", fNameHistoNotFlatCentrality.Data(), fPathWeightsFlatCent.Data()));
...
void AliConvEventCuts::LoadWeightingMultiplicityFromFile()
{
  ...
  if (fNameHistoReweightingMultData.CompareTo("") != 0 && (fDoMultiplicityWeighting > 0))
  {
    ...
    if (hReweightMultDatatemp)
    {
      ...
      AliError(Form("%s was not contained in %s", fNameHistoReweightingMultData.Data(), fPathReweightingMult.Data()));
  }
  if (fNameHistoReweightingMultMC.CompareTo("") != 0 && (fDoMultiplicityWeighting > 0))
  {
    ...
    if (hReweightMultMCtemp)
    {
      ...
      AliError(Form("%s was not contained in %s", fNameHistoReweightingMultMC.Data(), fPathReweightingMult.Data()));
  }
...
void AliConvEventCuts::LoadReweightingHistosMCFromFile()
{
  ...
  if (fNameHistoReweightingPi0.CompareTo("") != 0 && fDoReweightHistoMCPi0)
  {
    ...
    if (hReweightMCHistPi0temp)
    {
      ...
      AliWarning(Form("%s not found in %s", fNameHistoReweightingPi0.Data(), fPathTrFReweighting.Data()));
  }
  if (fNameFitDataPi0.CompareTo("") != 0 && fDoReweightHistoMCPi0)
  {
    ...
    if (fFitDataPi0temp)
    {
      fFitDataPi0_inv = new TF1(*fFitDataPi0temp);
      AliInfo(Form("%s has been loaded from %s", fNameFitDataPi0.Data(), fPathTrFReweighting.Data()));
    }
    else
      AliWarning(Form("%s not found in %s", fPathTrFReweighting.Data(), fNameFitDataPi0.Data()));
  }
  ...
  if (fNameHistoReweightingEta.CompareTo("") != 0 && fDoReweightHistoMCEta)
  {
    ...
    {
      hReweightMCHistEta_inv = new TH1D(*hReweightMCHistEtatemp);
      ...
      AliWarning(Form("%s not found in %s", fNameHistoReweightingEta.Data(), fPathTrFReweighting.Data()));
  }
  ...
  if (fNameFitDataEta.CompareTo("") != 0 && fDoReweightHistoMCEta)
  {
    ...
    if (fFitDataEtatemp)
    {
      fFitDataEta_inv = new TF1(*fFitDataEtatemp);
      AliInfo(Form("%s has been loaded from %s", fNameFitDataEta.Data(), fPathTrFReweighting.Data()));
    }
    else
      AliWarning(Form("%s not found in %s", fNameFitDataEta.Data(), fPathTrFReweighting.Data()));
  }
  if (fNameHistoReweightingK0s.CompareTo("") != 0 && fDoReweightHistoMCK0s)
  {
    ...
    {
      hReweightMCHistK0s_inv = new TH1D(*hReweightMCHistK0stemp);
      ...
      AliWarning(Form("%s not found in %s", fNameHistoReweightingK0s.Data(), fPathTrFReweighting.Data()));
  }
  ...
  if (fNameFitDataK0s.CompareTo("") != 0 && fDoReweightHistoMCK0s)
  {
    ...
    if (fFitDataK0stemp)
    {
      fFitDataK0s_inv = new TF1(*fFitDataK0stemp);
      AliInfo(Form("%s has been loaded from %s", fNameFitDataK0s.Data(), fPathTrFReweighting.Data()));
    }
    else
      AliWarning(Form("%s not found in %s", fNameFitDataK0s.Data(), fPathTrFReweighting.Data()));
  }
  f->Close();
  delete f;
}
...
void AliConvEventCuts::LoadGammaPtReweightingHistosMCFromFile()
{
  ...
  if (fNameHistoReweightingGamma.CompareTo("") != 0 && fDoReweightHistoMCGamma)
  {
    ...
    if (hReweightMCHistGammatemp)
    {
      ...
      AliWarning(Form("%s not found in %s", fNameHistoReweightingGamma.Data(), fPathTrFGammaReweighting.Data()));
  }
  if (fNameDataHistoReweightingGamma.CompareTo("") != 0 && fDoReweightHistoMCGamma)
  {
    ...
    if (hReweightDataHistGammatemp)
    {
      ...
      AliWarning(Form("%s not found in %s", fPathTrFGammaReweighting.Data(), fNameDataHistoReweightingGamma.Data()));
  }
...
void AliConvEventCuts::PrintCutsWithValues()
{
  ...
  if (fIsHeavyIon == 0)
  {
    ...
    else if (fSpecialTrigger == 1)
    {
      ...
      if (fRejectTriggerOverlap)
        printf("\t        reject trigger overlaps");
    }
    else if (fSpecialTrigger > 1)
    {
  ...
  if (fEnableVertexCut)
    printf("\t Vertex cut with |Z_{vtx}| <%2.2f \n", fMaxVertexZ);
  else
    printf("\t No vertex cut \n");
  ...
  if (fRejectExtraSignals == 0)
    printf("\t no rejection was applied \n");
  else if (fRejectExtraSignals == 1)
    printf("\t only MB header will be inspected \n");
  else if (fRejectExtraSignals == 4)
    printf("\t special handling for Jets embedded in MB events \n");
  else if (fRejectExtraSignals == 5)
    printf("\t reject particles from out-of-bunch pileup \n");
  else if (fRejectExtraSignals > 1)
    printf("\t special header have been selected \n");
...
Bool_t AliConvEventCuts::SetSelectSubTriggerClass(Int_t selectSpecialSubTriggerClass)
{
  ...
  { // AND with different detectors
    switch (selectSpecialSubTriggerClass)
    {
    case 0:
    case 4: // with VZERO general implementation of V0AND (periods LHC11c onwards)
      fSpecialTrigger = 0;
      fSpecialSubTrigger = 0;
  ...
  { // Selecting kCentral and kSemiCentral from trigger classes, not aliases
    switch (selectSpecialSubTriggerClass)
    {
    case 0: // all together
      fSpecialSubTrigger = 0;
  ...
  { // Subdivision of TRD trigger classes
    switch (selectSpecialSubTriggerClass)
    {
    case 0: // all together
      fSpecialSubTrigger = 0;
  ...
  { // Subdivision of kEMC trigger classes
    switch (selectSpecialSubTriggerClass)
    {
    case 0: // all together
      fSpecialSubTrigger = 0;
  ...
  { // Subdivision of kPHI trigger classes
    switch (selectSpecialSubTriggerClass)
    {
    case 0: // all together
      fSpecialSubTrigger = 0;
  ...
  { // Subdivision of kHighMult trigger classes
    switch (selectSpecialSubTriggerClass)
    {
    case 0: // all together
      fSpecialSubTrigger = 0;
  ...
  { // Subdivision of kEMCEGA trigger classes
    switch (selectSpecialSubTriggerClass)
    {
    case 0: // all together
      fSpecialSubTrigger = 0;
  ...
  { // Subdivision of kEMCEJE trigger classes
    switch (selectSpecialSubTriggerClass)
    {
    case 0: // all together
      fSpecialSubTrigger = 0;
  ...
  else if (fSpecialTrigger == 11)
  { // selection of double gap events
    switch (selectSpecialSubTriggerClass)
    {
  ...
  else if (fSpecialTrigger == 12)
  { // selection of UPC events
    switch (selectSpecialSubTriggerClass)
    {
    case 0: // CCUP8
      fSpecialSubTrigger = 1;
  ...
  else if (fSpecialTrigger == 13)
  { // software trigger on min bias data
    switch (selectSpecialSubTriggerClass)
    {
  ...
  else if (fSpecialTrigger == 14)
  { // software trigger on EMCal triggered data
    switch (selectSpecialSubTriggerClass)
    {
  ...
  else if (fSpecialTrigger == 15)
  { // jet triggers without overlapp rejection for gamma triggers
    switch (selectSpecialSubTriggerClass)
    {
    case 0: // all together
      fSpecialSubTrigger = 0;
...
{ // Set Cut
  ...
  if (fDoPileUpRejectV0MTPCout)
    fLabelNamePileupCutTPC = "Pileup V0M-TPCout Tracks";
  if (fFPileUpRejectSDDSSDTPC)
    fLabelNamePileupCutTPC = "Pileup SDD+SSD-TPC clusters";
...
Bool_t AliConvEventCuts::GetUseNewMultiplicityFramework()
{
  ...
  case kLHC16rsGJ:
  case kLHC16rsP2GJ:
  case kLHC16rsP2JJLow:
  case kLHC16rsP2JJHigh:
  // Xe-Xe 5.44 TeV
  case kLHC17n:
  // Xe-Xe 5.44 TeV MC
  case kLHC17XeXeHi:
...
{ // Get Event Centrality
  ...
  if (aodEvent)
  {
    ...
    else
    {
      ...
      {
        return ((AliVAODHeader *)aodEvent->GetHeader())->GetCentrality();
      }
    }
    // Estimation using EMCal clusters
    if (fDetectorCentrality == 4)
...
Bool_t AliConvEventCuts::IsCentralitySelected(AliVEvent *event, AliMCEvent *mcEvent)
{
  ...
  if (fCentralityMin == fCentralityMax)
    return kTRUE; // 0-100%
  else if (fCentralityMax == 0)
    fCentralityMax = 10; // CentralityRange = fCentralityMin-10*multfactor
  Double_t centrality = GetCentrality(event);
  if (centrality < 0 && !mcEvent)
    return kFALSE;
  ...
  { // EMCal nCluster multiplicity classes
    centralityC = Int_t(centrality);
    if (centralityC >= fCentralityMin && centralityC < fCentralityMax)
    {
      return kTRUE;
  ...
  if (fModCentralityClass == 3)
  {
    if (mcEvent)
    {
               ...
               fPeriodEnum == kLHC16i3b || fPeriodEnum == kLHC16i3c)
      {
        ...
        if (centralityC >= fCentralityMin && centralityC < fCentralityMax)
        {
          if (fCentralityMin == 0 && nprimaryTracks >= PrimaryTracksLHC15o10[0][column])
            return kFALSE;
          else
            return kTRUE;
        }
  ...
  else if (fModCentralityClass == 4)
  {
    if (mcEvent)
    {
               ...
               fPeriodEnum == kLHC16i2c || fPeriodEnum == kLHC16i3a || fPeriodEnum == kLHC16i3b || fPeriodEnum == kLHC16i3c)
      {
        ...
        if (centralityC >= fCentralityMin * 5 && centralityC < fCentralityMax * 5)
        {
          if (fCentralityMin == 0 && nprimaryTracks >= PrimaryTracksLHC15o5[0][column])
            return kFALSE;
          else
            return kTRUE;
        }
...
Bool_t AliConvEventCuts::VertexZCut(AliVEvent *event)
{
  ...
  if (TMath::Abs(fVertexZ) > fMaxVertexZ)
    return kFALSE;

  if (fPeriodEnum == kLHC11h)
  {
    if (TMath::Abs(fVertexZ - fVertexZSPD) > 0.1)
      return kFALSE;
  }
  if (fIsHeavyIon == 2)
  {
...
Bool_t AliConvEventCuts::IsOutOfBunchPileupPastFuture(AliVEvent *event)
{
  ...
  for (Int_t i = pf1; i <= pf2; i++)
  {
    if (i == 0)
      continue;
    if (i <= pf2maxForT0)
      isOutOfBunchPileup |= fIR2.TestBitNumber(90 + i); // T0-based clean-up
    if (i > 0 && i <= ir1skip)
      continue;                                       // skip next 2 for old IR definitions
...
Int_t AliConvEventCuts::GetNumberOfTPCClusters(AliVEvent *event) const
{
  ...
  if (dynamic_cast<AliAODEvent *>(event))
    return dynamic_cast<AliAODEvent *>(event)->GetNumberOfTPCClusters();
  else if (dynamic_cast<AliESDEvent *>(event))
    return dynamic_cast<AliESDEvent *>(event)->GetNumberOfTPCClusters();
  else
  {
    AliError("event is a nullptr");
    return -1;
...
void AliConvEventCuts::FillTPCOccupancyHistograms(AliVEvent *event)
{
  ...
  if (hTPCoutTracks)
  {
    hTPCoutTracks->Fill(GetV0Reader()->GetNumberOfTPCoutTracks());
  }
  if (hTPCclusters)
  {
    hTPCclusters->Fill(GetNumberOfTPCClusters(event));
  }
}
...
Bool_t AliConvEventCuts::IsJetJetMCEventAccepted(AliMCEvent *mcEvent, Double_t &weight, Float_t &pthard, AliVEvent *event, Double_t maxJetPt)
{
  ...
  if (fPeriodEnum != kLHC18b8 && fPeriodEnum != kLHC18b10 && fPeriodEnum != kLHC18l2 &&        // LHC17pq pp 5TeV JetJet MC's
      fPeriodEnum != kLHC19i3a1 && fPeriodEnum != kLHC19i3a2 &&                                // LHC18 gammaJet MC in EMCal/DCal acceptance
      ...
      fPeriodEnum != kLHC16rsP2GJ &&                                                           // LHC16sr pPb 8TeV GammaJet MC's
      fPeriodEnum != kLHC16rsP2JJLow &&                                                        // LHC16sr pPb 8TeV Jet-Jet MC's
      fPeriodEnum != kLHC16rsP2JJHigh &&                                                       // LHC16sr pPb 8TeV Jet-Jet MC's
  ...
  if (headerFound)
  {
    ...
    for (Int_t i = 0; i < genHeaders->GetEntries(); i++)
    {
      ...
      if (GeneratorName.CompareTo("AliGenPythiaEventHeader") == 0 || GeneratorName.Contains("Pythia8Jets"))
      {
        ...
        Int_t pthardbin = -1;
        if (fUseFilePathForPthard)
          pthardbin = GetPtHardBinFromPath(GetV0Reader()->GetCurrentFileName(), event);
        ...
        if (fPeriodEnum == kLHC16P1JJLowB || fPeriodEnum == kLHC17P1JJLowB)
        {
          ...
          Int_t bin = 0;
          while (!((ptHard < ptHardBinRanges[bin + 1] && ptHard > ptHardBinRanges[bin]) || (ptHard == ptHardBinRanges[bin])))
            bin++;
          if (bin < 20)
            weight = weightsBins[bin];
          if (fUseFilePathForPthard && (pthardbin > -1))
          {
            weight = weightsBins[pthardbin - 1];
            if (fUseAdditionalOutlierRejection && ((ptHard < ptHardBinRanges[pthardbin - 1]) || (ptHard > ptHardBinRanges[pthardbin])))
              eventAccepted = kFALSE;
          }
        }
        ...
        else if (fPeriodEnum == kLHC15g1a)
        {
          ...
          if (binFromFile != -1 && binFromFile > 9 && ptHard < 57)
            bin = 9;
          while (!((ptHard < ptHardBinRanges[bin + 1] && ptHard > ptHardBinRanges[bin]) || (ptHard == ptHardBinRanges[bin])))
            bin++;
          if (bin < 19)
        ...
        else if (fPeriodEnum == kLHC17g6a1)
        { // ALIROOT-7271 - GJ
        ...
        else if (fPeriodEnum == kLHC17g6a2)
        { // ALIROOT-7271 - JJ low EMC trigg
        ...
        else if (fPeriodEnum == kLHC17g6a3)
        { // ALIROOT-7271 - JJ high EMC trigg
        ...
        { // preliminary weights obtained from local running
        ...
        else if (fPeriodEnum == kLHC16rP1JJ)
        { // preliminary weights obtained from local running
          Double_t ptHardBinRanges[21] = {5, 7, 9, 12, 16, 21, 28, 36, 45, 57, 70, 85, 99, 115, 132, 150, 169, 190, 212, 235, 10000};
        ...
        else if (fPeriodEnum == kLHC16sP1JJ)
        { // preliminary weights obtained from local running
          Double_t ptHardBinRanges[21] = {5, 7, 9, 12, 16, 21, 28, 36, 45, 57, 70, 85, 99, 115, 132, 150, 169, 190, 212, 235, 10000};
        ...
        else if (fPeriodEnum == kLHC16rsGJ)
        { // preliminary weights obtained from local running
          Double_t ptHardBinRanges[7] = {5, 11, 21, 36, 57, 84, 10000};
        ...
        else if (fPeriodEnum == kLHC16rsP2GJ)
        { // preliminary weights obtained from local running
          Double_t ptHardBinRanges[7] = {5, 11, 21, 36, 57, 84, 10000};
          Double_t weightsBins[6] = {2.46048404e-04, 3.23150378e-05, 5.01353260e-06, 8.80704885e-07, 1.85959645e-07, 6.85755854e-08};
          Int_t bin = 0;
          while (!((ptHard < ptHardBinRanges[bin + 1] && ptHard > ptHardBinRanges[bin]) || (ptHard == ptHardBinRanges[bin])))
            bin++;
          if (bin < 6)
        ...
        else if (fPeriodEnum == kLHC16rsP2JJLow)
        { // preliminary weights obtained from local running
          Double_t ptHardBinRanges[7] = {5, 7, 9, 12, 16, 21, 10000};
          Double_t weightsBins[6] = {4.33534333e-02, 3.33723750e-02, 3.22837010e-02, 2.37287478e-02, 1.49079058e-02, 1.94491916e-02};
          Int_t bin = 0;
        ...
        else if (fPeriodEnum == kLHC16rsP2JJHigh)
        { // preliminary weights obtained from local running
        ...
        else if (fPeriodEnum == kLHC17i3a1)
        { // weights obtained from ga_pp_mc_aod train 912
          Double_t ptHardBinRanges[7] = {5, 11, 21, 36, 57, 84, 10000};
        ...
        else if (fPeriodEnum == kLHC17i3b1)
        { // preliminary weights obtained from local running
          Double_t ptHardBinRanges[9] = {8, 10, 14, 19, 26, 35, 48, 66, 10000};
        ...
        else if (fPeriodEnum == kLHC17i3b2)
        { // preliminary weights obtained from local running
          Double_t ptHardBinRanges[9] = {8, 10, 14, 19, 26, 35, 48, 66, 10000};
          Double_t weightsBins[8] = {0.000813592, 0.00172074, 0.00187963, 0.00184331, 0.00142672, 0.0010083, 0.000599846, 0.000499877};
          Int_t bin = 0;
        ...
        else if (fPeriodEnum == kLHC17i3c1)
        { // preliminary weights obtained from local running
          Double_t ptHardBinRanges[9] = {8, 10, 14, 19, 26, 35, 48, 66, 10000};
          Double_t weightsBins[8] = {0.000813592, 0.00172074, 0.00187963, 0.00184331, 0.00142672, 0.0010083, 0.000599846, 0.000499877};
          Int_t bin = 0;
        ...
        else if (fPeriodEnum == kLHC17i3c2)
        { // preliminary weights obtained from local running
          Double_t ptHardBinRanges[9] = {8, 10, 14, 19, 26, 35, 48, 66, 10000};
          Double_t weightsBins[8] = {0.000813592, 0.00172074, 0.00187963, 0.00184331, 0.00142672, 0.0010083, 0.000599846, 0.000499877};
          Int_t bin = 0;
        ...
        else if (fPeriodEnum == kLHC20b1b1)
        { // preliminary weights obtained from local running
        ...
        else if (fPeriodEnum == kLHC20b1b2)
        { // preliminary weights obtained from local running
          Double_t ptHardBinRanges[7] = {5, 7, 9, 12, 16, 22, 10000};
        ...
        else if (fPeriodEnum == kLHC20b1c1)
        { // preliminary weights obtained from local running
          Double_t ptHardBinRanges[9] = {8, 10, 14, 19, 26, 35, 48, 66, 10000};
        ...
        else if (fPeriodEnum == kLHC20b1c2)
        { // preliminary weights obtained from local running
          Double_t ptHardBinRanges[9] = {8, 10, 14, 19, 26, 35, 48, 66, 10000};
        ...
        else if (fPeriodEnum == kLHC18l6c1)
        { // preliminary weights obtained from local running
          Double_t ptHardBinRanges[9] = {8, 10, 14, 19, 26, 35, 48, 66, 10000};
        ...
        else if (fPeriodEnum == kLHC18l6c2)
        { // preliminary weights obtained from local running
          Double_t ptHardBinRanges[9] = {8, 10, 14, 19, 26, 35, 48, 66, 10000};
        ...
        else if (fPeriodEnum == kLHC18l6b1)
        { // preliminary weights obtained from local running
          Double_t ptHardBinRanges[7] = {5, 7, 9, 12, 16, 21, 10000};
        ...
        else if (fPeriodEnum == kLHC18l6b2)
        { // preliminary weights obtained from local running
          Double_t ptHardBinRanges[7] = {5, 7, 9, 12, 16, 21, 10000};
        ...
        else if (fPeriodEnum == kLHC19i3a1)
        { // preliminary weights obtained from local running
          Double_t ptHardBinRanges[7] = {5, 11, 21, 36, 57, 84, 10000};
          Double_t weightsBins[6] = {0.00023064, 3.13309e-05, 5.09325e-06, 9.40947e-07, 2.09717e-07, 8.09758e-08};
          Int_t bin = 0;
          while (!((ptHard < ptHardBinRanges[bin + 1] && ptHard > ptHardBinRanges[bin]) || (ptHard == ptHardBinRanges[bin])))
            bin++;
          if (bin < 6)
        ...
        else if (fPeriodEnum == kLHC19i3a2)
        { // preliminary weights obtained from local running
          Double_t ptHardBinRanges[7] = {5, 11, 21, 36, 57, 84, 10000};
          Double_t weightsBins[6] = {0.000154678, 2.26273e-05, 3.54107e-06, 7.05763e-07, 1.60986e-07, 5.62113e-08};
          Int_t bin = 0;
          while (!((ptHard < ptHardBinRanges[bin + 1] && ptHard > ptHardBinRanges[bin]) || (ptHard == ptHardBinRanges[bin])))
            bin++;
          if (bin < 6)
        ...
        else if (fPeriodEnum == kLHC19i3b1)
        { // preliminary weights obtained from local running
          Double_t ptHardBinRanges[7] = {5, 7, 9, 12, 16, 21, 10000};
          Double_t weightsBins[6] = {0.0479994, 0.039711, 0.039082, 0.0287247, 0.0182263, 0.0248411};
          Int_t bin = 0;
        ...
        else if (fPeriodEnum == kLHC19i3b2)
        { // preliminary weights obtained from local running
          Double_t ptHardBinRanges[7] = {5, 7, 9, 12, 16, 21, 10000};
        ...
        else if (fPeriodEnum == kLHC19i3c1)
        { // preliminary weights obtained from local running
          Double_t ptHardBinRanges[9] = {8, 10, 14, 19, 26, 35, 48, 66, 10000};
        ...
        else if (fPeriodEnum == kLHC19i3c2)
        { // preliminary weights obtained from local running
          Double_t ptHardBinRanges[9] = {8, 10, 14, 19, 26, 35, 48, 66, 10000};
          Double_t weightsBins[8] = {0.000583836, 0.00124525, 0.00133701, 0.00132045, 0.0010136, 0.000738478, 0.00043112, 0.00035756};
          Int_t bin = 0;
        ...
        else if (fPeriodEnum == kLHC17g6b2a)
        { // preliminary weights obtained from local running
          Double_t ptHardBinRanges[7] = {5, 7, 9, 12, 16, 21, 10000};
        ...
        else if (fPeriodEnum == kLHC17g6b2b)
        { // preliminary weights obtained from local running
          Double_t ptHardBinRanges[7] = {5, 7, 9, 12, 16, 21, 10000};
        ...
        else if (fPeriodEnum == kLHC17g6b3a)
        { // preliminary weights obtained from local running
          Double_t ptHardBinRanges[9] = {8, 10, 14, 19, 26, 35, 48, 66, 10000};
        ...
        else if (fPeriodEnum == kLHC17g6b3b)
        { // preliminary weights obtained from local running
          Double_t ptHardBinRanges[9] = {8, 10, 14, 19, 26, 35, 48, 66, 10000};
  ...
  else
  {
    ...
    { // special case for pythia8jets embedded in EPOSLHC for AODs
      if (event->IsA() == AliAODEvent::Class())
      {
...
void AliConvEventCuts::GetXSectionAndNTrials(AliMCEvent *mcEvent, Float_t &XSection, Float_t &NTrials, AliVEvent *event)
{
  ...
  if (fPeriodEnum != kLHC18b8 && fPeriodEnum != kLHC18b10 && fPeriodEnum != kLHC18l2 &&        // LHC17pq pp 5TeV JetJet MC's
      ...
      fPeriodEnum != kLHC16rsGJ &&                                                             // LHC16sr pPb 8TeV GammaJet MC's
      fPeriodEnum != kLHC16rsP2GJ &&                                                           // LHC16sr pPb 8TeV GammaJet MC's
      fPeriodEnum != kLHC16rsP2JJLow && fPeriodEnum != kLHC16rsP2JJHigh &&                     // LHC16sr pPb 8TeV GammaJet MC's
      fPeriodEnum != kLHC17g6b2a && fPeriodEnum != kLHC17g6b2b &&                              // LHC16sr pPb 8TeV JetJet MC's
      fPeriodEnum != kLHC17g6b3a && fPeriodEnum != kLHC17g6b3b &&                              // LHC16sr pPb 8TeV JetJet MC's
      fPeriodEnum != kLHC16P1JJ && fPeriodEnum != kLHC16P1JJLowB &&                            // LHC16X Jet Jet MC's
      fPeriodEnum != kLHC17P1JJ && fPeriodEnum != kLHC17P1JJLowB &&                            // LHC17X Jet Jet MC's
      ...
      fPeriodEnum != kLHC15a3a && fPeriodEnum != kLHC15a3a_plus && fPeriodEnum != kLHC15a3b && // LHC13g Jet Jet MC's
      fPeriodEnum != kLHC15g1a && fPeriodEnum != kLHC15g1b &&                                  // LHC11a Jet Jet MC's
      fPeriodEnum != kLHC17HERJJ &&                                                            // LHC17 HERWIG JJ MC
      fPeriodEnum != kLHC13b4_fix && fPeriodEnum != kLHC13b4_plus &&                           // LHC13 pPb Jet Jet MC's
      fPeriodEnum != kLHC19a4 &&                                                               // LHC13 pPb Jet Jet MC's
      fPeriodEnum != kLHC16c3a && fPeriodEnum != kLHC16c3b && fPeriodEnum != kLHC16c3c &&      // LHC13 pPb Jet Jet MC's
      fPeriodEnum != kLHC17g6a1 && fPeriodEnum != kLHC17g6a2 && fPeriodEnum != kLHC17g6a3 &&   // LHC13 pPb Jet Jet MC's
      ...
      fPeriodEnum != kLHC19i3a1 &&                                                             // LHC18 gammaJet MC anchored to LHC18 (in EMC acc.)
      fPeriodEnum != kLHC19i3a2 &&                                                             // LHC18 gammaJet MC anchored to LHC18 (in DMC acc.)
  ...
  if (headerFound)
  {
    ...
    for (Int_t i = 0; i < genHeaders->GetEntries(); i++)
    {
      ...
      { // somehow this string comparison should go! too slow
        ...
        if (mch)
        {
          ...
          if (nGenerators > 0)
          {
            for (Int_t igen = 0; igen < nGenerators; igen++)
            {
              ...
              else if (fPeriodEnum == kLHC17HERJJ && name.EqualTo("AliGenHepMCEventHeader"))
              { // somehow this string comparison should go! too slow
...
Float_t AliConvEventCuts::GetPtHard(AliMCEvent *mcEvent, AliVEvent *event)
{
  ...
  if (fPeriodEnum != kLHC18b8 && fPeriodEnum != kLHC18b10 && fPeriodEnum != kLHC18l2 &&        // LHC17pq pp 5TeV JetJet MC's
      fPeriodEnum != kLHC19i3a1 && fPeriodEnum != kLHC19i3a2 &&                                // LHC18 gammaJet MC in EMCal/DCal acc.
      ...
      fPeriodEnum != kLHC16rsGJ &&                                                             // LHC16sr pPb 8TeV GammaJet MC's
      fPeriodEnum != kLHC16rsP2GJ &&                                                           // LHC16sr pPb 8TeV GammaJet MC's
      fPeriodEnum != kLHC16rsP2JJLow &&                                                        // LHC16sr pPb 8TeV GammaJet MC's
      fPeriodEnum != kLHC16rsP2JJHigh &&                                                       // LHC16sr pPb 8TeV GammaJet MC's
      fPeriodEnum != kLHC17g6b2a && fPeriodEnum != kLHC17g6b2b &&                              // LHC16sr pPb 8TeV JetJet MC's
      fPeriodEnum != kLHC17g6b3a && fPeriodEnum != kLHC17g6b3b &&                              // LHC16sr pPb 8TeV JetJet MC's
      fPeriodEnum != kLHC16P1JJ && fPeriodEnum != kLHC16P1JJLowB &&                            // LHC16X Jet Jet MC's
      fPeriodEnum != kLHC17P1JJ && fPeriodEnum != kLHC17P1JJLowB &&                            // LHC17X Jet Jet MC's
...
Bool_t AliConvEventCuts::MimicTrigger(AliVEvent *event, Bool_t isMC)
{
  ...
  if (!fMimicTrigger)
    return kTRUE;
  if (!(fSpecialTrigger == 5 || fSpecialTrigger == 6 || fSpecialTrigger == 8 || fSpecialTrigger == 9 || fSpecialTrigger == 10 || fSpecialTrigger == 13 || fSpecialTrigger == 14 || fSpecialTrigger == 15))
    return kTRUE; // not the correct trigger for mimcking
  ...
  if (fMimicTrigger == 2)
  {
    ...
    else
    {
      ...
      {
        if ((triggercont->IsEventSelected("EG2")) || (triggercont->IsEventSelected("DG2")))
          return kTRUE;
      }
      ...
      {
        if ((triggercont->IsEventSelected("EG1")) || (triggercont->IsEventSelected("DG1")) || (triggercont->IsEventSelected("EGA")))
          return kTRUE;
      }
      else if (fSpecialTrigger == 5 || fSpecialTrigger == 10)
      {
        if (triggercont->IsEventSelected("EMCL0") || triggercont->IsEventSelected("DMCL0"))
          return kTRUE;
      }
      else if (fSpecialTrigger == 9 || fSpecialTrigger == 15)
      {
        ...
        {
          if (triggercont->IsEventSelected("EJ2") || triggercont->IsEventSelected("DJ2"))
            return kTRUE;
        }
        if (fSpecialSubTriggerName.Contains("EJ1") || fSpecialSubTriggerName.Contains("DJ1"))
        {
          if (triggercont->IsEventSelected("EJ1") || triggercont->IsEventSelected("DJ1"))
            return kTRUE;
        }
      }
      else
  ...
  if (fMimicTrigger == 1)
  {
    ...
    if (!fHistoTriggThresh || fRunNumberTriggerOADB != runnumber)
    {
      ...
      if (!fPathTriggerMimicSpecialInput.CompareTo(""))
      { // load from standard OADB on EOS
      ...
      { // load from special OADB file from AliEn
      ...
      if ((fSpecialTrigger == 8 || fSpecialTrigger == 10) && (fSpecialSubTriggerName.CompareTo("7EGA") == 0 || fSpecialSubTriggerName.CompareTo("8EGA") == 0 ||
                                                              fSpecialSubTriggerName.CompareTo("7EG1") == 0 || fSpecialSubTriggerName.CompareTo("8EG1") == 0))
        fHistoTriggThresh = (TH1S *)arrayTriggThresh->FindObject("EMCalL1G1");
      // EMCal L1 G1 trigger
        ...
        fHistoTriggThresh = (TH1S *)arrayTriggThresh->FindObject("EMCalL1G2");
      // PHOS L0 trigger
      else if (fSpecialTrigger == 5 || fSpecialTrigger == 10)
        fHistoTriggThresh = (TH1S *)arrayTriggThresh->FindObject("EMCalL0");
      // EMCal L1 G2 trigger
      else if ((fSpecialTrigger == 6) && (fSpecialSubTriggerName.CompareTo("CPHI7") == 0))
        fHistoTriggThresh = (TH1S *)arrayTriggThresh->FindObject("PHOSL0");
      // return true if mimicking for fSpecialTrigger is not defined
      else
      {
        AliError(Form("Selected a trigger (%s) that is not available for mimicking. Please add the trigger!", fSpecialSubTriggerName.Data()));
        return kFALSE;
      }
    ...
    if (fSpecialTrigger != 6)
    {
      ...
      if (!fGeomEMCAL)
      {
        AliFatal("EMCal geometry not initialized!");
      }
    }
    ...
    for (Int_t i = 0; i < nclus; i++)
    {
      ...
      if (fTriggThresh[iSuperModule] < 0.1)
        fTriggThresh[iSuperModule] = fRandom.Gaus(fHistoTriggThresh->GetBinContent(iSuperModule + 1) * 0.01, fHistoTriggThresh->GetBinError(iSuperModule + 1) * 0.01);
  ...
  if (!event || event->IsA() == AliESDEvent::Class())
  {
    for (Long_t i = 0; i < lMCevent->GetNumberOfTracks(); i++)
    {
      if (IsConversionPrimaryESD(lMCevent, i, mcProdVtxX, mcProdVtxY, mcProdVtxZ))
      {
        ...
        if (!particle)
          continue;
        if (TMath::Abs(particle->Charge()) < 0.001)
          continue;
...
Bool_t AliConvEventCuts::IsTriggerSelected(AliVEvent *event, Bool_t isMC)
{
  ...
  if (fInputHandler->GetEventSelection() || event->IsA() == AliAODEvent::Class())
  {
    ...
    {
      if (firedTrigClass.Contains(fSpecialSubTriggerName.Data()))
        isSelected = 1;
    }
    ...
    if (fOfflineTriggerMask)
    {
      ...
      if (isSelected && !fPreSelCut)
      {
        ...
        {
          if (fNSpecialSubTriggerOptions == 2)
          { // in case two special triggers are available
            ...
            {
              if (!firedTrigClass.Contains(fSpecialSubTriggerName.Data()) && !firedTrigClass.Contains(fSpecialSubTriggerNameAdditional.Data()))
                isSelected = 0;
            }
          }
          else
          { // standard case for just one trigger
            if (!firedTrigClass.Contains(fSpecialSubTriggerName.Data()))
              isSelected = 0;
          }
          if (fRejectTriggerOverlap)
          {
            ...
            if (fSpecialTrigger == 5)
            {
              if (fNSpecialSubTriggerOptions == 2)
              {
                ...
                {
                  if (fInputHandler->IsEventSelected() & AliVEvent::kINT8)
                    isSelected = 0;
                }
              }
              else
            ...
            if (fSpecialTrigger == 8)
            {
              ...
              {
                // trigger rejection for EMC and DMC triggers together
                if ((fSpecialSubTriggerName.CompareTo("7EG1") == 0 && fSpecialSubTriggerNameAdditional.CompareTo("7DG1") == 0) || (fSpecialSubTriggerName.CompareTo("7EG1_EGA_sw") == 0 && fSpecialSubTriggerNameAdditional.CompareTo("7DG1_EGA_sw") == 0))
                {
                  if (fInputHandler->IsEventSelected() & AliVEvent::kINT7)
                    isSelected = 0;
                  if (fInputHandler->IsEventSelected() & AliVEvent::kEMC7)
                    isSelected = 0;
                  if (firedTrigClass.Contains("7EG2"))
                    isSelected = 0;
                  if (firedTrigClass.Contains("7DG2"))
                    isSelected = 0;
                ...
                else if ((fSpecialSubTriggerName.CompareTo("8EG1") == 0 && fSpecialSubTriggerNameAdditional.CompareTo("8DG1") == 0) || (fSpecialSubTriggerName.CompareTo("7EG1_EGA_sw") == 0 && fSpecialSubTriggerNameAdditional.CompareTo("7DG1_EGA_sw") == 0))
                {
                  if (fInputHandler->IsEventSelected() & AliVEvent::kINT8)
                    isSelected = 0;
                  if (fInputHandler->IsEventSelected() & AliVEvent::kEMC7)
                    isSelected = 0;
                  if (firedTrigClass.Contains("8EG2"))
                    isSelected = 0;
                  if (firedTrigClass.Contains("8DG2"))
                    isSelected = 0;
                  if (isSelected != 0 && fMimicTrigger == 2)
                  {
                    auto triggercont = static_cast<PWG::EMCAL::AliEmcalTriggerDecisionContainer *>(event->FindListObject("EmcalTriggerDecision"));
                ...
                else if ((fSpecialSubTriggerName.CompareTo("7EG2") == 0 && fSpecialSubTriggerNameAdditional.CompareTo("7DG2") == 0) || (fSpecialSubTriggerName.CompareTo("7EG2_EGA_sw") == 0 && fSpecialSubTriggerNameAdditional.CompareTo("7DG2_EGA_sw") == 0))
                {
                  if (fInputHandler->IsEventSelected() & AliVEvent::kINT7)
                    isSelected = 0;
                  if (fInputHandler->IsEventSelected() & AliVEvent::kEMC7)
                ...
                else if ((fSpecialSubTriggerName.CompareTo("8EG2") == 0 && fSpecialSubTriggerNameAdditional.CompareTo("8DG2") == 0) || (fSpecialSubTriggerName.CompareTo("7EG2_EGA_sw") == 0 && fSpecialSubTriggerNameAdditional.CompareTo("7DG2_EGA_sw") == 0))
                {
                  if (fInputHandler->IsEventSelected() & AliVEvent::kINT7)
                    isSelected = 0;
                  if (fInputHandler->IsEventSelected() & AliVEvent::kEMC7)
              ...
              else
              {
                ...
                if (fSpecialSubTriggerName.CompareTo("7EG1") == 0)
                {
                  ...
                  {
                    auto triggercont = static_cast<PWG::EMCAL::AliEmcalTriggerDecisionContainer *>(event->FindListObject("EmcalTriggerDecision"));
                    if (!triggercont->IsEventSelected("EG1"))
                      isSelected = 0;
                  }
                }
                ...
                else if (fSpecialSubTriggerName.CompareTo("7EG2") == 0)
                {
                  ...
                  {
                    auto triggercont = static_cast<PWG::EMCAL::AliEmcalTriggerDecisionContainer *>(event->FindListObject("EmcalTriggerDecision"));
                    if (!triggercont->IsEventSelected("EG2"))
                      isSelected = 0;
                  }
                }
                ...
                else if (fSpecialSubTriggerName.CompareTo("7DG1") == 0)
                {
                  ...
                  {
                    auto triggercont = static_cast<PWG::EMCAL::AliEmcalTriggerDecisionContainer *>(event->FindListObject("EmcalTriggerDecision"));
                    if (!triggercont->IsEventSelected("DG1"))
                      isSelected = 0;
                  }
                }
                ...
                else if (fSpecialSubTriggerName.CompareTo("7DG2") == 0)
                {
                  ...
                  {
                    auto triggercont = static_cast<PWG::EMCAL::AliEmcalTriggerDecisionContainer *>(event->FindListObject("EmcalTriggerDecision"));
                    if (!triggercont->IsEventSelected("DG2"))
                      isSelected = 0;
                  }
                }
            ...
            if (fSpecialTrigger == 9)
            {
              if (fNSpecialSubTriggerOptions == 2)
              {
                ...
                if (fSpecialSubTriggerName.CompareTo("7EJ1") == 0 && fSpecialSubTriggerNameAdditional.CompareTo("7DJ1") == 0)
                {
                  ...
                  if (firedTrigClass.Contains("7EG2"))
                    isSelected = 0;
                  if (firedTrigClass.Contains("7EG1"))
                    isSelected = 0;
                  if (firedTrigClass.Contains("7EJ2"))
                    isSelected = 0;
                  if (firedTrigClass.Contains("7DG2"))
                    isSelected = 0;
                  if (firedTrigClass.Contains("7DG1"))
                    isSelected = 0;
                  if (firedTrigClass.Contains("7DJ2"))
                    isSelected = 0;
                }
              ...
              else
              {
                ...
                if (fSpecialSubTriggerName.CompareTo("7EJE") == 0)
                {
                  ...
                  if (fInputHandler->IsEventSelected() & AliVEvent::kEMC7)
                    isSelected = 0;
                  if (firedTrigClass.Contains("7EGA"))
                    isSelected = 0;
                }
                else if (fSpecialSubTriggerName.CompareTo("8EJE") == 0)
                {
                  ...
                  if (fInputHandler->IsEventSelected() & AliVEvent::kEMC7)
                    isSelected = 0;
                  if (firedTrigClass.Contains("8EGA"))
                    isSelected = 0;
                }
                ...
                else if (fSpecialSubTriggerName.CompareTo("8EJ1") == 0)
                {
                  ...
                  if (firedTrigClass.Contains("8EG2"))
                    isSelected = 0;
                  if (firedTrigClass.Contains("8EG1"))
                    isSelected = 0;
                  if (firedTrigClass.Contains("8EJ2"))
                    isSelected = 0;
                }
                ...
                else if (fSpecialSubTriggerName.CompareTo("8DJ1") == 0)
                {
                  ...
                  if (fInputHandler->IsEventSelected() & AliVEvent::kEMC7)
                    isSelected = 0;
                  if (firedTrigClass.Contains("8DG1"))
                    isSelected = 0;
                  if (firedTrigClass.Contains("8DG2"))
                    isSelected = 0;
                  if (firedTrigClass.Contains("8DJ2"))
                    isSelected = 0;
                }
            ...
            if (fSpecialTrigger == 10 && (fInputHandler->IsEventSelected() & AliVEvent::kCaloOnly))
            {
              if (fNSpecialSubTriggerOptions == 2)
              {
                ...
                if (fSpecialSubTriggerName.CompareTo("7EJ1") == 0 && fSpecialSubTriggerNameAdditional.CompareTo("7DJ1") == 0)
                {
                  if (firedTrigClass.Contains("INT7-"))
                    isSelected = 0;
                ...
                {
                  if (firedTrigClass.Contains("INT8-"))
                    isSelected = 0;
                  if (firedTrigClass.Contains("EMC8-"))
                    isSelected = 0;
                  if (firedTrigClass.Contains("DMC8-"))
                    isSelected = 0;
                  if (firedTrigClass.Contains("8EG2"))
                    isSelected = 0;
                  if (firedTrigClass.Contains("8DG2"))
              ...
              else
              {
                ...
                {
                  if (firedTrigClass.Contains("INT1-"))
                    isSelected = 0;
                }
                else if (fSpecialSubTriggerName.CompareTo("CEMC8-") == 0)
                {
            ...
            if (fSpecialTrigger == 15)
            {
              if (fNSpecialSubTriggerOptions == 2)
              {
                ...
                if (fSpecialSubTriggerName.CompareTo("7EJ1") == 0 && fSpecialSubTriggerNameAdditional.CompareTo("7DJ1") == 0)
                {
                  if (fInputHandler->IsEventSelected() & AliVEvent::kINT7)
                    isSelected = 0;
                  else if (firedTrigClass.Contains("7DJ2"))
                    isSelected = 0;
                  else if (firedTrigClass.Contains("7EJ2"))
                    isSelected = 0;
                  else if (fMimicTrigger == 2)
                  {
                    auto triggercont = static_cast<PWG::EMCAL::AliEmcalTriggerDecisionContainer *>(event->FindListObject("EmcalTriggerDecision"));
                    if (!(triggercont->IsEventSelected("DJ1") || triggercont->IsEventSelected("EJ1")))
                      isSelected = 0;
                  }
                }
                else if (fSpecialSubTriggerName.CompareTo("7EJ2") == 0 && fSpecialSubTriggerNameAdditional.CompareTo("7DJ2") == 0)
                {
                  ...
                  {
                    auto triggercont = static_cast<PWG::EMCAL::AliEmcalTriggerDecisionContainer *>(event->FindListObject("EmcalTriggerDecision"));
                    if (!(triggercont->IsEventSelected("DJ2") || triggercont->IsEventSelected("EJ2")))
                      isSelected = 0;
                  }
                }
              }
              else
              {
                ...
                if (fSpecialSubTriggerName.CompareTo("7EJE") == 0)
                {
                  ...
                  {
                    auto triggercont = static_cast<PWG::EMCAL::AliEmcalTriggerDecisionContainer *>(event->FindListObject("EmcalTriggerDecision"));
                    if (!triggercont->IsEventSelected("EJE"))
                      isSelected = 0;
                  }
                }
                else if (fSpecialSubTriggerName.CompareTo("8EJE") == 0)
                ...
                else if (fSpecialSubTriggerName.CompareTo("7EJ1") == 0)
                {
                  ...
                  {
                    auto triggercont = static_cast<PWG::EMCAL::AliEmcalTriggerDecisionContainer *>(event->FindListObject("EmcalTriggerDecision"));
                    if (!triggercont->IsEventSelected("EJ1"))
                      isSelected = 0;
                  }
                }
                else if (fSpecialSubTriggerName.CompareTo("8EJ1") == 0)
                {
                  if (fInputHandler->IsEventSelected() & AliVEvent::kINT8)
                    isSelected = 0;
                  else if (firedTrigClass.Contains("8EJ2"))
                    isSelected = 0;
                  else if (fMimicTrigger == 2)
                  {
                    auto triggercont = static_cast<PWG::EMCAL::AliEmcalTriggerDecisionContainer *>(event->FindListObject("EmcalTriggerDecision"));
                    if (!triggercont->IsEventSelected("EJ2"))
                      isSelected = 0;
                  }
                }
                else if (fSpecialSubTriggerName.CompareTo("7EJ2") == 0)
                ...
                else if (fSpecialSubTriggerName.CompareTo("7DJ1") == 0)
                {
                  ...
                  {
                    auto triggercont = static_cast<PWG::EMCAL::AliEmcalTriggerDecisionContainer *>(event->FindListObject("EmcalTriggerDecision"));
                    if (!triggercont->IsEventSelected("DJ1"))
                      isSelected = 0;
                  }
                }
                else if (fSpecialSubTriggerName.CompareTo("8DJ1") == 0)
                {
                  if (fInputHandler->IsEventSelected() & AliVEvent::kINT8)
                    isSelected = 0;
                  else if (firedTrigClass.Contains("8DJ2"))
                    isSelected = 0;
                  else if (fMimicTrigger == 2)
                  {
                    auto triggercont = static_cast<PWG::EMCAL::AliEmcalTriggerDecisionContainer *>(event->FindListObject("EmcalTriggerDecision"));
                ...
                else if (fSpecialSubTriggerName.CompareTo("7DJ2") == 0)
                {
                  ...
                  {
                    auto triggercont = static_cast<PWG::EMCAL::AliEmcalTriggerDecisionContainer *>(event->FindListObject("EmcalTriggerDecision"));
                    if (!triggercont->IsEventSelected("DJ2"))
                      isSelected = 0;
                  }
                }
          ...
          if (isSelected != 0)
          {
            if (fSpecialTrigger == 5 || fSpecialTrigger == 8 || fSpecialTrigger == 9 || fSpecialTrigger == 15)
            {
              if (hTriggerClassesCorrelated)
              {
                ...
                if (fInputHandler->IsEventSelected() & AliVEvent::kINT7)
                  hTriggerClassesCorrelated->Fill(1);
                if (fInputHandler->IsEventSelected() & AliVEvent::kEMC1)
                  hTriggerClassesCorrelated->Fill(2);
                if ((fInputHandler->IsEventSelected() & AliVEvent::kEMC7) && firedTrigClass.Contains("EMC"))
                  hTriggerClassesCorrelated->Fill(3);
                if (firedTrigClass.Contains("7EJE") || firedTrigClass.Contains("8EJE"))
                  hTriggerClassesCorrelated->Fill(4);
                if (firedTrigClass.Contains("7EJ1") || firedTrigClass.Contains("8EJ1"))
                  hTriggerClassesCorrelated->Fill(5);
                if (firedTrigClass.Contains("7EJ2") || firedTrigClass.Contains("8EJ2"))
                  hTriggerClassesCorrelated->Fill(6);
                if (firedTrigClass.Contains("7EGA") || firedTrigClass.Contains("8EGA"))
                  hTriggerClassesCorrelated->Fill(7);
                if (firedTrigClass.Contains("7EG1") || firedTrigClass.Contains("8EG1"))
                  hTriggerClassesCorrelated->Fill(8);
                if (firedTrigClass.Contains("7EG2") || firedTrigClass.Contains("8EG2"))
                  hTriggerClassesCorrelated->Fill(9);
                if ((fInputHandler->IsEventSelected() & AliVEvent::kEMC7) && firedTrigClass.Contains("DMC"))
                  hTriggerClassesCorrelated->Fill(10);
                if (firedTrigClass.Contains("7DJE") || firedTrigClass.Contains("8DJE"))
                  hTriggerClassesCorrelated->Fill(11);
                if (firedTrigClass.Contains("7DJ1") || firedTrigClass.Contains("8DJ1"))
                  hTriggerClassesCorrelated->Fill(12);
                if (firedTrigClass.Contains("7DJ2") || firedTrigClass.Contains("8DJ2"))
                  hTriggerClassesCorrelated->Fill(13);
                if (firedTrigClass.Contains("7DGA") || firedTrigClass.Contains("8DGA"))
                  hTriggerClassesCorrelated->Fill(14);
                if (firedTrigClass.Contains("7DG1") || firedTrigClass.Contains("8DG1"))
                  hTriggerClassesCorrelated->Fill(15);
                if (firedTrigClass.Contains("7DG2") || firedTrigClass.Contains("8DG2"))
                  hTriggerClassesCorrelated->Fill(16);

                if (fEnergyEnum == kpPb8TeV)
                {
                  if (firedTrigClass.Contains("CENTNOPMD") && (!firedTrigClass.Contains("CENTNOTRD")))
                    hTriggerClassesCorrelated->Fill(17); // CENT
                  if (firedTrigClass.Contains("CENTNOPMD") && (firedTrigClass.Contains("CENTNOTRD")))
                    hTriggerClassesCorrelated->Fill(17); // if both count also as cent
                  if (!firedTrigClass.Contains("CENTNOPMD") && (firedTrigClass.Contains("CENTNOTRD")))
                    hTriggerClassesCorrelated->Fill(18); // noTRD
                }
                else
                {
                  if (firedTrigClass.Contains("CENT-") && (!firedTrigClass.Contains("CENTNOTRD")))
                    hTriggerClassesCorrelated->Fill(17);
                  if (!firedTrigClass.Contains("CENT-") && (firedTrigClass.Contains("CENTNOTRD")))
                    hTriggerClassesCorrelated->Fill(18);
                }
                if (firedTrigClass.Contains("CVHMSH2-B"))
                  hTriggerClassesCorrelated->Fill(19);
                if (firedTrigClass.Contains("CVHMV0M-B"))
                  hTriggerClassesCorrelated->Fill(20);
              }
            }
            else if (fSpecialTrigger == 10)
            {
              if (hTriggerClassesCorrelated)
              {
                if (fInputHandler->IsEventSelected() & AliVEvent::kCaloOnly)
                {
                  ...
                  if (firedTrigClass.Contains("INT7-"))
                    hTriggerClassesCorrelated->Fill(1);
                  if (firedTrigClass.Contains("EMC1-"))
                    hTriggerClassesCorrelated->Fill(2);
                  if (firedTrigClass.Contains("EMC7-") || firedTrigClass.Contains("EMC8-"))
                    hTriggerClassesCorrelated->Fill(3);
                  if (firedTrigClass.Contains("7EJE") || firedTrigClass.Contains("8EJE"))
                    hTriggerClassesCorrelated->Fill(4);
                  if (firedTrigClass.Contains("7EJ1") || firedTrigClass.Contains("8EJ1"))
                  ...
                  if (firedTrigClass.Contains("7EG2") || firedTrigClass.Contains("8EG2"))
                    hTriggerClassesCorrelated->Fill(9);
                  if (firedTrigClass.Contains("DMC7-") || firedTrigClass.Contains("DMC8-"))
                    hTriggerClassesCorrelated->Fill(10);
                  if (firedTrigClass.Contains("7DJE") || firedTrigClass.Contains("8DJE"))
                    hTriggerClassesCorrelated->Fill(11);
                  if (firedTrigClass.Contains("7DJ1") || firedTrigClass.Contains("8DJ1"))
        ...
        {
          if (fSpecialTrigger == 5 || fSpecialTrigger == 6 || fSpecialTrigger == 8 || fSpecialTrigger == 9 || fSpecialTrigger == 15)
          { // EMCAL triggers
            // isSelected = 0;
        ...
        if (fSpecialSubTrigger == 1)
        {
          if (fSpecialSubTriggerName.Contains("|") && GetCentrality(event) <= 10.)
          {
            ...
            for (Int_t i = 0; i < ClassesList->GetEntriesFast(); ++i)
            {
              ...
              if (firedTrigClass.Contains(NameClass->GetString()))
                isSelected = 1;
            }
          }
  ...
  if (fINELgtZEROTrigger)
    isINELgtZERO = IsEventINELgtZERO(event);
  ...
  if (hTriggerClass)
  {
    ...
    if (mimickedTrigger && (!fINELgtZEROTrigger || (fINELgtZEROTrigger && isINELgtZERO)))
    {
      ...
      if (fInputHandler->IsEventSelected() & AliVEvent::kMUS7)
        hTriggerClass->Fill(11);
      if (fInputHandler->IsEventSelected() & AliVEvent::kPHI1)
        hTriggerClass->Fill(12);
      if (fInputHandler->IsEventSelected() & AliVEvent::kPHI7)
      ...
      if (fInputHandler->IsEventSelected() & AliVEvent::kDG5)
        hTriggerClass->Fill(18);
      if (fInputHandler->IsEventSelected() & AliVEvent::kZED)
        hTriggerClass->Fill(19);
      if (fInputHandler->IsEventSelected() & AliVEvent::kSPI7)
      ...
      if (fInputHandler->IsEventSelected() & AliVEvent::kTRD)
        hTriggerClass->Fill(28);
      if (fInputHandler->IsEventSelected() & AliVEvent::kFastOnly)
        hTriggerClass->Fill(29);
      if (fInputHandler->IsEventSelected() & AliVEvent::kCaloOnly)
        hTriggerClass->Fill(30);
      if (fInputHandler->IsEventSelected() & AliVEvent::kAnyINT)
        hTriggerClass->Fill(31);
      if (fInputHandler->IsEventSelected() & AliVEvent::kAny)
        hTriggerClass->Fill(32);
      if (!fInputHandler->IsEventSelected())
        hTriggerClass->Fill(35);
    }
    if (mimickedTrigger && fMimicTrigger)
      hTriggerClass->Fill(36);
    if (fINELgtZEROTrigger && isINELgtZERO)
      hTriggerClass->Fill(37);
  }
  ...
  if (hTriggerClassSelected && isSelected)
  {
    ...
    {
      if (!fIsSDDFired)
        hTriggerClassSelected->Fill(33);
      if (fInputHandler->IsEventSelected() & AliVEvent::kMB)
        hTriggerClassSelected->Fill(0);
      if (fInputHandler->IsEventSelected() & AliVEvent::kINT7)
        hTriggerClassSelected->Fill(1);
      if (fInputHandler->IsEventSelected() & AliVEvent::kMUON)
        hTriggerClassSelected->Fill(2);
      if (fInputHandler->IsEventSelected() & AliVEvent::kHighMult)
        hTriggerClassSelected->Fill(3);
      if (fInputHandler->IsEventSelected() & AliVEvent::kEMC1)
        hTriggerClassSelected->Fill(4);
      if (fInputHandler->IsEventSelected() & AliVEvent::kCINT5)
        hTriggerClassSelected->Fill(5);
      if (fInputHandler->IsEventSelected() & AliVEvent::kCMUS5)
        hTriggerClassSelected->Fill(6);
      //       if (fInputHandler->IsEventSelected() & AliVEvent::kMUSPB)hTriggerClassSelected->Fill(6);
      if (fInputHandler->IsEventSelected() & AliVEvent::kMUSH7)
        hTriggerClassSelected->Fill(7);
      //       if (fInputHandler->IsEventSelected() & AliVEvent::kMUSHPB)hTriggerClassSelected->Fill(7);
      if (fInputHandler->IsEventSelected() & AliVEvent::kMUL7)
        hTriggerClassSelected->Fill(8);
      //       if (fInputHandler->IsEventSelected() & AliVEvent::kMuonLikePB)hTriggerClassSelected->Fill(8);
      if (fInputHandler->IsEventSelected() & AliVEvent::kMUU7)
        hTriggerClassSelected->Fill(9);
      //       if (fInputHandler->IsEventSelected() & AliVEvent::kMuonUnlikePB)hTriggerClassSelected->Fill(9);
      if (fInputHandler->IsEventSelected() & AliVEvent::kEMC7)
        hTriggerClassSelected->Fill(10);
      //       if (fInputHandler->IsEventSelected() & AliVEvent::kEMC8)hTriggerClassSelected->Fill(10);
      if (fInputHandler->IsEventSelected() & AliVEvent::kMUS7)
        hTriggerClassSelected->Fill(11);
      if (fInputHandler->IsEventSelected() & AliVEvent::kPHI1)
        hTriggerClassSelected->Fill(12);
      if (fInputHandler->IsEventSelected() & AliVEvent::kPHI7)
        hTriggerClassSelected->Fill(13);
      ...
      if (fInputHandler->IsEventSelected() & AliVEvent::kEMCEJE)
        hTriggerClassSelected->Fill(14);
      if (fInputHandler->IsEventSelected() & AliVEvent::kEMCEGA)
        hTriggerClassSelected->Fill(15);
      if (fInputHandler->IsEventSelected() & AliVEvent::kCentral)
        hTriggerClassSelected->Fill(16);
      if (fInputHandler->IsEventSelected() & AliVEvent::kSemiCentral)
        hTriggerClassSelected->Fill(17);
      if (fInputHandler->IsEventSelected() & AliVEvent::kDG5)
        hTriggerClassSelected->Fill(18);
      if (fInputHandler->IsEventSelected() & AliVEvent::kZED)
        hTriggerClassSelected->Fill(19);
      if (fInputHandler->IsEventSelected() & AliVEvent::kSPI7)
        hTriggerClassSelected->Fill(20);
      //       if (fInputHandler->IsEventSelected() & AliVEvent::kSPI)hTriggerClassSelected->Fill(20);
      if (fInputHandler->IsEventSelected() & AliVEvent::kINT8)
        hTriggerClassSelected->Fill(21);
      if (fInputHandler->IsEventSelected() & AliVEvent::kMuonSingleLowPt8)
        hTriggerClassSelected->Fill(22);
      if (fInputHandler->IsEventSelected() & AliVEvent::kMuonSingleHighPt8)
        hTriggerClassSelected->Fill(23);
      if (fInputHandler->IsEventSelected() & AliVEvent::kMuonLikeLowPt8)
        hTriggerClassSelected->Fill(24);
      if (fInputHandler->IsEventSelected() & AliVEvent::kMuonUnlikeLowPt8)
        hTriggerClassSelected->Fill(25);
      if (fInputHandler->IsEventSelected() & AliVEvent::kMuonUnlikeLowPt0)
        hTriggerClassSelected->Fill(26);
      if (fInputHandler->IsEventSelected() & AliVEvent::kUserDefined)
        hTriggerClassSelected->Fill(27);
      if (fInputHandler->IsEventSelected() & AliVEvent::kTRD)
        hTriggerClassSelected->Fill(28);
      if (fInputHandler->IsEventSelected() & AliVEvent::kFastOnly)
        hTriggerClassSelected->Fill(29);
      if (fInputHandler->IsEventSelected() & AliVEvent::kAnyINT)
        hTriggerClassSelected->Fill(30);
      if (fInputHandler->IsEventSelected() & AliVEvent::kAny)
        hTriggerClassSelected->Fill(31);
    }
    if (mimickedTrigger && fMimicTrigger)
      hTriggerClassSelected->Fill(34);
    if (fINELgtZEROTrigger && isINELgtZERO)
      hTriggerClassSelected->Fill(35);
  }
...
void AliConvEventCuts::GetNotRejectedParticles(Int_t rejection, TList *HeaderList, AliVEvent *event)
{
  ...
  if (event->IsA() == AliAODEvent::Class())
  { // event is a AODEvent in case of AOD
            ...
            if (GeneratorInList.Contains(GeneratorName))
            {
              ...
              if (GeneratorInList.BeginsWith("PARAM") || GeneratorInList.CompareTo("BOX") == 0)
              {
                if (fMCEvent)
                {
                  ...
                  {
                    if (fDebugLevel > 2)
                      cout << "number of produced particle: " << gh->NProduced() << endl;
                    if (fDebugLevel > 2)
                      cout << "pdg-code of first particle: " << fMCEvent->GetTrack(firstindexA)->PdgCode() << endl;
                    if (fMCEvent->GetTrack(firstindexA)->PdgCode() == fAddedSignalPDGCode)
                    {
                      ...
                      {
                        if (fDebugLevel > 2)
                          cout << "accepted PHOS header " << endl;
                        if (fDebugLevel > 0)
                          cout << "cond 1: " << fnHeaders << endl;
                        fnHeaders++;
                        continue;
...
void AliConvEventCuts::FillHeaderMap(TList *HeaderList, AliVEvent *event)
{
  ...
  if (headerFound)
  {
    TList *genHeaders = 0x0;
    if (cHeader)
      genHeaders = cHeader->GetHeaders(); // ESD
    if (cHeaderAOD)
      genHeaders = cHeaderAOD->GetCocktailHeaders(); // AOD
    AliGenEventHeader *gh = 0;
    fnHeaders = 0;
    int firstindexA = 0;
    int lastindexA = -1;
                                                             ...
                                                             Bool_t &theIsFromSelectedHeader)
{
  ...
  if (!fRejectExtraSignals)
    return kTRUE;

  auto bothFromFirstHeader = [](Int_t thePos, Int_t theNeg)
  { return (thePos + theNeg) == 4; };
  ...
  { // 1,2,4,5
    if (!lIsPosFromMBHeader)
      return kFALSE;
    Int_t lIsNegFromMBHeader = IsParticleFromBGEvent(thePhoton.GetMCLabelNegative(), theMCEvent, theInputEvent);
    if (!lIsNegFromMBHeader)
      return kFALSE;
...
Int_t AliConvEventCuts::IsParticleFromBGEvent(Int_t index, AliMCEvent *mcEvent, AliVEvent *InputEvent, Int_t debug)
{
  ...
  if (!InputEvent || InputEvent->IsA() == AliESDEvent::Class())
  {
    ...
    if (index >= mcEvent->GetNumberOfPrimaries())
    { // initial particle is secondary particle
      if (((AliMCParticle *)mcEvent->GetTrack(index))->GetMother() < 0)
    ...
    for (Int_t i = 0; i < fnHeaders; i++)
    {
      ...
      {
        if (debug > 1)
          cout << "accepted:" << index << "\t header " << fGeneratorNames[i].Data() << ": " << fNotRejectedStart[i] << "\t" << fNotRejectedEnd[i] << endl;
        accepted = 1;
        if (fHeaderMap.at(i) == kMinBias)
          accepted = 2; // MB Header
      }
    }
    if (debug > 1 && !accepted)
      cout << "rejected:" << index << endl;
  }
  else if (InputEvent->IsA() == AliAODEvent::Class())
  {
    if (!fAODMCTrackArray)
      fAODMCTrackArray = dynamic_cast<TClonesArray *>(InputEvent->FindListObject(AliAODMCParticle::StdBranchName()));
    if (fAODMCTrackArray)
    {
      ...
      {
        if (!fAODMCHeader)
          fAODMCHeader = dynamic_cast<AliAODMCHeader *>(InputEvent->FindListObject(AliAODMCHeader::StdBranchName()));
...
TString AliConvEventCuts::GetParticleHeaderName(Int_t index, AliMCEvent *mcEvent, AliVEvent *InputEvent, Int_t debug)
{
  ...
  if (headerFound)
  {
    ...
    {
      if (!mcEvent)
        return headername; // no mcEvent available, return 0
      if (index >= mcEvent->GetNumberOfPrimaries())
      { // initial particle is secondary particle
        if ((mcEvent->GetTrack(index))->GetMother() < 0)
          return headername; // material particle, return 0
...
Int_t AliConvEventCuts::IsEventAcceptedByCut(AliConvEventCuts *ReaderCuts, AliVEvent *event, AliMCEvent *mcEvent, Int_t isHeavyIon, Bool_t isEMCALAnalysis)
{
  ...
  if (isEMCALAnalysis || IsSpecialTrigger() == 5 || IsSpecialTrigger() == 8 || IsSpecialTrigger() == 9)
  {
    ...
    if ((runnumber >= 144871) && (runnumber <= 146860))
    {
      ...
      if (event->IsA() == AliESDEvent::Class())
        AliAnalysisManager::GetAnalysisManager()->LoadBranch("EMCALCells.");
    ...
    if (fRejectEMCalLEDevents && (fPeriodEnum == kLHC12 || fPeriodEnum == kLHC16NomB || fPeriodEnum == kLHC17NomB || fPeriodEnum == kLHC18NomB))
    {
      ...
      for (Int_t iCell = 0; iCell < nCells; ++iCell)
      {
        ...
        if (cellE > 0.1)
          nCellCountInStrip[strip]++;
      }

      Bool_t fIsLedEvent = kFALSE;
      for (Int_t istrip = 0; istrip < 480; istrip++)
      {
        if (nCellCountInStrip[istrip] > 40)
          nStripsLED++;
      }
      if (nStripsLED >= 3)
        fIsLedEvent = kTRUE;
  ...
  if (fRemovePileUp)
  {
    if ((GetDoPileUpRejectV0MTPCout() && IsPileUpV0MTPCout(event)) || (fRemovePileUpSDDSSDTPC && IsPileUpSDDSSDTPC(event)))
    {
      return 13;
    }
  }
...
Float_t AliConvEventCuts::GetWeightForCentralityFlattening(AliVEvent *event)
{
  ...
  if (CorrCentrLoop && GetValueForWeight != 0. && maximum != 0. && isfinite(GetValueForWeight) && isfinite(maximum))
  {
    ...
    if (!isfinite(GetValueForWeight))
      weightCentrality = 1.;
    if (!isfinite(weightCentrality))
      weightCentrality = 1.;
  }
...
Float_t AliConvEventCuts::GetWeightForMultiplicity(Int_t mult)
{
  ...
  if (hReweightMultData == NULL || hReweightMultMC == NULL)
    return weightMult;
  ...
  if (valueMC != 0)
    relativeErrorMC = errorMC / valueMC;
  if (valueData != 0)
    relativeErrorData = errorData / valueData;
...
Float_t AliConvEventCuts::GetWeightForMesonNew(Int_t index, AliMCEvent *mcEvent, AliVEvent *event)
{
  ...
  auto checkAndSanitizeWeight = [&](Double_t theWeight)
  {
    ...
    {
      theWeight = 1.;
      AliWarning(Form("checkAndSanitizeWeight(): WARNING: Weight for meson %d is negative or not finite: %f. It was set back to 1.\n"
...
Float_t AliConvEventCuts::GetWeightForMeson(Int_t index, AliMCEvent *mcEvent, AliVEvent *event)
{
  ...
  if (PDGCode == 111 && fDoReweightHistoMCPi0)
  {
    functionResultMC = hReweightMCHistPi0_inv ? hReweightMCHistPi0_inv->Interpolate(mesonPt)
                                              : hReweightMCHistPi0_var->Interpolate(mesonPt);
  }
  if (PDGCode == 221 && fDoReweightHistoMCEta)
  {
    functionResultMC = hReweightMCHistEta_inv ? hReweightMCHistEta_inv->Interpolate(mesonPt)
                                              : hReweightMCHistEta_var->Interpolate(mesonPt);
  }
  if (PDGCode == 310 && fDoReweightHistoMCK0s)
  {
    functionResultMC = hReweightMCHistK0s_inv ? hReweightMCHistK0s_inv->Interpolate(mesonPt)
                                              : hReweightMCHistK0s_var->Interpolate(mesonPt);
  }
  ...
  if (PDGCode == 111 && fDoReweightHistoMCPi0)
  {
    functionResultData = fFitDataPi0_inv ? fFitDataPi0_inv->Eval(mesonPt)
                                         : fFitDataPi0_var->Eval(mesonPt);
  }
  if (PDGCode == 221 && fDoReweightHistoMCEta)
  {
    functionResultData = fFitDataEta_inv ? fFitDataEta_inv->Eval(mesonPt)
                                         : fFitDataEta_var->Eval(mesonPt);
  }
  if (PDGCode == 310 && fDoReweightHistoMCK0s)
  {
    functionResultData = fFitDataK0s_inv ? fFitDataK0s_inv->Eval(mesonPt)
                                         : fFitDataK0s_var->Eval(mesonPt);
  }
  ...
  if (PDGCode == 111 || PDGCode == 221)
  {
    if (functionResultData != 0. && functionResultMC != 0. && isfinite(functionResultData) && isfinite(functionResultMC))
    {
      ...
      if (!isfinite(functionResultData))
        weight = 1.;
      if (!isfinite(weight))
        weight = 1.;
    }
...
void AliConvEventCuts::GetCorrectEtaShiftFromPeriod()
{
  ...
  else if (fPeriodEnum == kLHC13f)
  {
    ...
    printf(" Gamma Conversion Cuts %s :: Automatic Eta Shift requested but Period is not known -> No Shift \n\n", (GetCutNumber()).Data());
}
  ...
  if (particle->GetMother() != -1)
  {
    ...
    if (dalitzCand || realRadius3D < fSecProdBoundary)
    {
      ...
      while (depth < 20)
      {
        ...
        if (pdgCodeMother == pdgCodeMotherPrev && pdgCodeMother == pdgCodeMotherPPrevMother)
          depth = 20;
...
void AliConvEventCuts::SetPeriodEnum(TString periodName)
{
  ...
  else if (periodName.CompareTo("LHC22b5") == 0)
  { // quasi LHC20e3d
  ...
  else if (periodName.CompareTo("LHC23d8b") == 0)
  { // quasi LHC20e3d
  ...
  else if (periodName.CompareTo("LHC21d2a") == 0)
  {
    fPeriodEnum = kLHC16rsP2GJ;
    fEnergyEnum = kpPb8TeV;
  }
  else if (periodName.CompareTo("LHC21d2b") == 0)
  {
    fPeriodEnum = kLHC16rsP2JJLow;
    fEnergyEnum = kpPb8TeV;
  }
  else if (periodName.CompareTo("LHC21d2c") == 0)
  {
    fPeriodEnum = kLHC16rsP2JJHigh;
    fEnergyEnum = kpPb8TeV;
  ...
  else if (periodName.CompareTo("LHC17HERJJ") == 0 || periodName.CompareTo("LHC20k1") == 0)
  {
    fPeriodEnum = kLHC17HERJJ;
    fEnergyEnum = k13TeV;

    // MC for Xe-Xe
  }
  else if (periodName.CompareTo("LHC17j7") == 0)
  { // HIJING
    fPeriodEnum = kLHC17XeXeHi;
    fEnergyEnum = kXeXe5440GeV;
  }
  else if (periodName.CompareTo("LHC18d2") == 0 || periodName.CompareTo("LHC18d2_1") == 0 || periodName.CompareTo("LHC18d2_2") == 0 || periodName.CompareTo("LHC18d2_3") == 0)
  { // HIJING
    fPeriodEnum = kLHC17XeXeHi;
    fEnergyEnum = kXeXe5440GeV;
  ...
  else if (periodName.Contains("LHC19d3") || periodName.Contains("LHC18P1JJ"))
  {
    ...
    // gammaJet MC with decay photon in EMCal/DCal acc
  }
  else if (periodName.CompareTo("LHC19i3a1") == 0)
  {
    fPeriodEnum = kLHC19i3a1;
    fEnergyEnum = k13TeV;
  }
  else if (periodName.CompareTo("LHC19i3a2") == 0)
  {
    fPeriodEnum = kLHC19i3a2;
    fEnergyEnum = k13TeV;
