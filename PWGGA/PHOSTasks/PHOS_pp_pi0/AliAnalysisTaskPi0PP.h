#ifndef AliAnalysisTaskPi0PP_cxx
#define AliAnalysisTaskPi0PP_cxx
...
class AliAnalysisTaskPi0PP : public AliAnalysisTaskSE {
public:
  AliAnalysisTaskPi0PP(const char *name = "AliAnalysisTaskPi0PP");
  virtual ~AliAnalysisTaskPi0PP() {}
...
private:
  AliAnalysisTaskPi0PP(const AliAnalysisTaskPi0PP&); // not implemented
  AliAnalysisTaskPi0PP& operator=(const AliAnalysisTaskPi0PP&); // not implemented
...
private:
  ...
  ClassDef(AliAnalysisTaskPi0PP, 1); // PHOS analysis task
};
