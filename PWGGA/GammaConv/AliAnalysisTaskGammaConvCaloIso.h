#ifndef ALIANLYSISTASKGAMMAConvCaloIso_cxx
#define ALIANLYSISTASKGAMMAConvCaloIso_cxx
...
class AliAnalysisTaskGammaConvCaloIso : public AliAnalysisTaskSE {
  public:

    AliAnalysisTaskGammaConvCaloIso();
    AliAnalysisTaskGammaConvCaloIso(const char *name);
  ...
  protected:
    ...
    TList**                             fIsolation;             // Container for Photon Isolation
    ...
    TList*                              fIsoCandidates;         // current list of isolated cluster candidates
...
//    TH2F**                  fHistoTrueEtaNonLinearity;                        //! E_truth/E_rec vs E_rec for TrueEtas
  ...
  private:
    AliAnalysisTaskGammaConvCaloIso(const AliAnalysisTaskGammaConvCaloIso&); // Prevent copy-construction
    AliAnalysisTaskGammaConvCaloIso &operator=(const AliAnalysisTaskGammaConvCaloIso&); // Prevent assignment

    ClassDef(AliAnalysisTaskGammaConvCaloIso, 1);
};
