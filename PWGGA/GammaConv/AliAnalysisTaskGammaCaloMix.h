#ifndef ALIANLYSISTASKGAMMACALOMIX_cxx
#define ALIANLYSISTASKGAMMACALOMIX_cxx
...
class AliAnalysisTaskGammaCaloMix : public AliAnalysisTaskSE {
  public:

    AliAnalysisTaskGammaCaloMix();
    AliAnalysisTaskGammaCaloMix(const char *name);
    virtual ~AliAnalysisTaskGammaCaloMix();
    ...
    fClusterCutArray = CutArray;
      ...
      // Setting the cut lists for the calo photons
    void SetCaloCaloCutLists(Int_t nCuts, TList *CutArray, TList *CutArray2){
      fnCuts = nCuts;
      fClusterCutArray = CutArray;
      fClusterCutArray2 = CutArray2;
    }
  ...
  protected:
    ...
    TList*                fClusterCandidates2;                                   //! current list of cluster candidates
    ...
    TList*                fClusterCutArray2;                                     // List with Cluster Cuts
    ...
    TH2F**                fHistCellIDvsClusterEnergy2;                           //! array of histogram with leading cell ID vs cluster Energy
    TH2F**                fHistCellIDvsClusterEnergyMax;                        //! array of histogram with leading cell ID vs maximum cluster energy in event
    TH2F**                fHistCellIDvsClusterEnergyMax2;                        //! array of histogram with leading cell ID vs maximum cluster energy in event
    ...
    TH1F**                fHistoNGammaCandidates2;                               //! array of histos with number of gamma candidates per event
