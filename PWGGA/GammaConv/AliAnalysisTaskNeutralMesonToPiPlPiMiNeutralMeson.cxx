...
void AliAnalysisTaskNeutralMesonToPiPlPiMiNeutralMeson::UserCreateOutputObjects()
{
  ...
  for(Int_t iCut = 0; iCut<fnCuts;iCut++){
    ...
    if (fIsMC>1) fHistoNGoodESDTracks[iCut]->Sumw2();
    ...
    if (fNDMRecoMode > 0){
      ...
      if (fIsMC>1) fHistoClusterGammaPt[iCut]->Sumw2();
      ...
      if (fIsMC>1) fHistoClusterGammaEta[iCut]->Sumw2();
      ...
      if (fIsMC>1) fHistoClusterGammaE[iCut]->Sumw2();
    ...
    if(!fDoLightOutput){
      ...
      if (fIsMC>1) fHistoSPDClusterTrackletBackground[iCut]->Sumw2();
      ...
      if (fIsMC>1) fHistovParticleChi2PerNDF[iCut]->Sumw2();
      ...
      if (fIsMC>1) fHistovParticleChi2PerNDFBothConstrained[iCut]->Sumw2();
      ...
      if (fIsMC>1) fHistovParticleChi2PerNDFOneConstrained[iCut]->Sumw2();
      ...
      if (fIsMC>1) fHistovParticledS[iCut]->Sumw2();
      ...
      if (fIsMC>1) fHistovParticledSBothConstrained[iCut]->Sumw2();
      ...
      if (fIsMC>1) fHistovParticledSOneConstrained[iCut]->Sumw2();
      ...
      if (fNDMRecoMode < 2){
        ...
        if (fIsMC>1) fHistoConvGammaPt[iCut]->Sumw2();
        ...
        if (fIsMC>1) fHistoConvGammaEta[iCut]->Sumw2();
      ...
      if (fIsMC>1) fHistoNegPionPt[iCut]->Sumw2();
      ...
      if (fIsMC>1) fHistoPosPionPt[iCut]->Sumw2();
      ...
      if (fIsMC>1) fHistoNegPionPhi[iCut]->Sumw2();
      ...
      if (fIsMC>1) fHistoPosPionPhi[iCut]->Sumw2();
      ...
      if (fIsMC>1) fHistoPionPionInvMassPt[iCut]->Sumw2();
      ...
      if ( fDoMesonQA>0 ) {
        ...
        if (fIsMC>1) fHistoNegPionEta[iCut]->Sumw2();
        ...
        if (fIsMC>1) fHistoPosPionEta[iCut]->Sumw2();
        ...
        if (fIsMC>1) fHistoNegPionClsTPC[iCut]->Sumw2();
        ...
        if (fIsMC>1) fHistoPosPionClsTPC[iCut]->Sumw2();
        ...
        if (fIsMC>1) fHistoPionDCAxy[iCut]->Sumw2();
        ...
        if (fIsMC>1) fHistoPionDCAz[iCut]->Sumw2();
        ...
        if (fIsMC>1) fHistoPionTPCdEdxNSigma[iCut]->Sumw2();
        ...
        if (fIsMC>1) fHistoPionTPCdEdx[iCut]->Sumw2();
        ...
        if (fIsMC>1) fHistoDalitzPlotPosFixedPzNDM[iCut]->Sumw2();
        ...
        if (fIsMC>1) fHistoDalitzPlotNegFixedPzNDM[iCut]->Sumw2();
        ...
        if (fIsMC>1) fHistoDalitzPlotPosSubNDM[iCut]->Sumw2();
        ...
        if (fIsMC>1) fHistoDalitzPlotNegSubNDM[iCut]->Sumw2();
      ...
      if (fIsMC>1) fHistoGammaGammaInvMassPt[iCut]->Sumw2();
      ...
      if (fIsMC>1) fHistoGammaGammaInvMassPtBeforeCuts[iCut]->Sumw2();
    ...
    if(!fDoLightOutput){
      ...
      if (fIsMC>1) fHistoAngleHNMesonPiPlPiMi[iCut]->Sumw2();
      ...
      if (fIsMC>1) fHistoAngleHNMesonPiMi[iCut]->Sumw2();
      ...
      if (fIsMC>1) fHistoAngleHNMesonPiPl[iCut]->Sumw2();
      ...
      if (fIsMC>1) fHistoAngleHNMesonNDM[iCut]->Sumw2();
      ...
      if (fIsMC>1) fHistoAnglePiPlNDM[iCut]->Sumw2();
      ...
      if (fIsMC>1) fHistoAnglePiPlPiMi[iCut]->Sumw2();
      ...
      if (fIsMC>1) fHistoAngleNDMPiMi[iCut]->Sumw2();
      ...
      if (fIsMC>1) fHistoAngleSum[iCut]->Sumw2();
  ...
  if( fIsMC ){
    ...
    for(Int_t iCut = 0; iCut<fnCuts;iCut++){
      ...
      if(!fDoLightOutput){
        ...
        if (fIsMC>1) fHistoMCAllGammaPt[iCut]->Sumw2();
        ...
        if (fNDMRecoMode < 2){
          ...
          if (fIsMC>1) fHistoMCConvGammaPt[iCut]->Sumw2();
        ...
        if (fIsMC>1) fHistoMCGammaFromNeutralMesonPt[iCut]->Sumw2();
        ...
        if (fIsMC>1) fHistoMCAllPosPionsPt[iCut]->Sumw2();
        ...
        if (fIsMC>1) fHistoMCAllNegPionsPt[iCut]->Sumw2();
        ...
        if (fIsMC>1) fHistoMCNegPionsFromNeutralMesonPt[iCut]->Sumw2();
        ...
        if (fIsMC>1) fHistoMCPosPionsFromNeutralMesonPt[iCut]->Sumw2();
        ...
        if (fDoMesonQA>0){
          ...
          if (fIsMC>1) fHistoMCAllMesonPt[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistoMCAllMesonEta[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistoMCAllMesonPhi[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistoMCMesonFromNeutralMesonPt[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistoMCMesonFromNeutralMesonEta[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistoMCMesonFromNeutralMesonPhi[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistoMCAllPosPionsEta[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistoMCAllPosPionsPhi[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistoMCAllNegPionsEta[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistoMCAllNegPionsPhi[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistoMCPosPionsFromNeutralMesonEta[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistoMCPosPionsFromNeutralMesonPhi[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistoMCNegPionsFromNeutralMesonEta[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistoMCNegPionsFromNeutralMesonPhi[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistoMCHeavyAllPt[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistoMCHeavyAllEta[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistoMCHeavyAllPhi[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistoMCHeavyChannelPt[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistoMCHeavyChannelPhi[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistMCChannelNDMFromHeavyPt[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistMCChannelNDMFromHeavyEta[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistMCChannelNDMFromHeavyPhi[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistMCChannelPiPlusFromHeavyPt[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistMCChannelPiPlusFromHeavyEta[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistMCChannelPiPlusFromHeavyPhi[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistMCChannelPiMinusFromHeavyPt[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistMCChannelPiMinusFromHeavyEta[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistMCChannelPiPMinusFromHeavyPhi[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistMCChannelNDMPtHeavyPt[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistMCChannelPiPlusPtHeavyPt[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistMCChannelPiMinusPtHeavyPt[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistoMCHeavyReconstructiblePt[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistoMCHeavyReconstructiblePhi[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistMCReconstructibleNDMFromHeavyPt[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistMCReconstructibleNDMFromHeavyEta[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistMCReconstructibleNDMFromHeavyPhi[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistMCReconstructiblePiPlusFromHeavyPt[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistMCReconstructiblePiPlusFromHeavyEta[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistMCReconstructiblePiPlusFromHeavyPhi[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistMCReconstructiblePiMinusFromHeavyPt[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistMCReconstructiblePiMinusFromHeavyEta[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistMCReconstructiblePiPMinusFromHeavyPhi[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistMCReconstructibleNDMPtHeavyPt[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistMCReconstructiblePiPlusPtHeavyPt[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistMCReconstructiblePiMinusPtHeavyPt[iCut]->Sumw2();
      ...
      if (fIsMC>1) fHistoMCHNMPiPlPiMiNDMPt[iCut]->Sumw2();
      ...
      if (fIsMC>1) fHistoMCHNMPiPlPiMiNDMInAccPt[iCut]->Sumw2();
      ...
      if(!fDoLightOutput){
        ...
        if (fIsMC>1) fHistoTrueMotherGammaGammaInvMassPt[iCut]->Sumw2();
        ...
        if (fIsMC>1) fHistoTrueMotherGammaGammaFromHNMInvMassPt[iCut]->Sumw2();
        ...
        if (fIsMC>1) fHistoTrueAngleSum[iCut]->Sumw2();
      ...
      fHistoTrueHNMesonPtvsNDMPt[iCut]->GetXaxis()->SetTitle("p_{T} (GeV/c) of HNM");
        ...
        if (fIsMC>1) fHistoTrueHNMesonPtvsNDMPt[iCut]->Sumw2();
        ...
        if (fDoMesonQA>0){
          ...
          if (fIsMC>1) fHistoTruePionPionInvMassPt[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistoTruePionPionFromSameMotherInvMassPt[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistoTruePionPionFromHNMInvMassPt[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistoTruevParticleChi2PerNDF[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistoTruevParticleFromSameMotherChi2PerNDF[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistoTruevParticleFromHNMChi2PerNDF[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistoTruevParticledS[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistoTruevParticleFromSameMotherdS[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistoTruevParticleFromHNMdS[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistoTrueMotherPiPlPiMiNDMDalitzPlotPosFixedPzNDM[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistoTrueMotherPiPlPiMiNDMDalitzPlotNegFixedPzNDM[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistoTrueMotherPiPlPiMiNDMDalitzPlotPosSubNDM[iCut]->Sumw2();
          ...
          if (fIsMC>1) fHistoTrueMotherPiPlPiMiNDMDalitzPlotNegSubNDM[iCut]->Sumw2();
