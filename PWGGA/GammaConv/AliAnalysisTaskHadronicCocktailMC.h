...
class AliAnalysisTaskHadronicCocktailMC : public AliAnalysisTaskSE {
  ...
  protected:
    ...
    TH2F**                      fHistPtDaughterSourceInput;   //! histo for pt correlation of gammas from input particles to source
    TH2F**                      fHistPhiDaughterSourceInput;  //! histo for phi correlation of gammas from input particles to source
  ...
  private:
    ...
    ClassDef(AliAnalysisTaskHadronicCocktailMC, 1);
};
