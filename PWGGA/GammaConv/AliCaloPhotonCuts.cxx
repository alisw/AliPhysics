...
//----------------------------------------------------------------------------------------------------------
		...
		case 81:
			label_case_81:
			if(isMC>0){
				if( fCurrentMC==k13b2_efix ) energy /= FunctionNL_kSDM(energy, 0.976721, -3.60967, -0.43353); //v2
		...
		case 82:
			label_case_82:
			if(isMC>0){
				if( fCurrentMC==k13b2_efix ) energy /= FunctionNL_kSDM(2.0*energy, 0.974951, -2.56938, -0.863324); //v2
