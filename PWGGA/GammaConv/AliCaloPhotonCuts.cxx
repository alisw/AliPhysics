...
// *************** 10 + x **** default tender settings - pp 
    ...
    case 11:
      ...
      if(isMC>0){
        ...
        //pass2
          ...
          energy /= FunctionNL_kSDM(energy, 0.96874*0.991, -3.76064, -0.193181);

        else if( fCurrentMC == k15h2 )
          energy /= FunctionNL_kSDM(energy, 0.969703*0.989, -3.80387, -0.200546);
    ...
    case 12:
      ...
      if(isMC>0){
        ...
        //pass2
          ...
          energy /= FunctionNL_kSDM(energy, 0.963379*0.9985, -3.61217, -0.614043);

        else if( fCurrentMC == k15h2 )
          energy /= FunctionNL_kSDM(energy, 0.96105*0.999, -3.62239, -0.556256);
    ...
    case 15:
      // 8TeV LHC12x
      if ( fCurrentMC==k14e2a || fCurrentMC==k14e2b  || fCurrentMC==k14e2c || fCurrentMC == k15h1 || fCurrentMC == k15h2  || fCurrentMC == k12pp8TeV ){ 
    ...
    case 21:
      ...
      if(isMC>0){
        ...
        if(  fCurrentMC==k12f1a || fCurrentMC==k12i3 )
          ...
          energy /= (FunctionNL_DPOW(energy, 1.1100193881, -0.1389194936, -0.0800000242, 1.1673716264, -0.1853095466, -0.0848801702) - 0.007);
        else if( fCurrentMC==k15a3a || fCurrentMC==k15a3a_plus || fCurrentMC==k15a3b )
          energy /= (FunctionNL_DPOW(energy, 1.0520183153, -0.0806102847, -0.1450415920, 1.0336724056, -0.0467844121, -0.4406992764) - 0.026);
        else if( fCurrentMC == k15h1 )
          energy /= (FunctionNL_DPOW(energy, 1.0654169768, -0.0935785719, -0.1137883054, 1.1814766150, -0.1980098061, -0.0854569214) - 0.010);
        else if( fCurrentMC == k15h2 )
          energy /= (FunctionNL_DPOW(energy, 1.0652493513, -0.0929276101, -0.1113762695, 1.1837801885, -0.1999914832, -0.0854569214) - 0.011);
        else fPeriodNameAvailable = kFALSE;
      }
      break;
    ...
    case 22:
      ...
      if(isMC>0){
        ...
        if(  fCurrentMC==k12f1a || fCurrentMC==k12i3 )
          ...
          energy /= (FunctionNL_DPOW(energy, 1.0106037132, -0.0748250591, -0.4999999996, 1.0383412435, -0.0851830429, -0.4999999996) - 0.004);
        else if( fCurrentMC==k15a3a || fCurrentMC==k15a3a_plus || fCurrentMC==k15a3b ) 
          energy /= (FunctionNL_DPOW(energy, 1.0119417393, -0.0755250741, -0.4999999996, 1.1614181498, -0.1999995361, -0.1711378093) - 0.006);
        else if( fCurrentMC == k15h1 )
          energy /= (FunctionNL_DPOW(energy, 1.1389201636, -0.1999994717, -0.1622237979, 1.1603460704, -0.1999999989, -0.2194447313) - 0.002);
        else if( fCurrentMC == k15h2 )
    ...
    case 31:
      ...
      if(isMC>0){
        ...
        if(  fCurrentMC==k12f1a || fCurrentMC==k12i3 )
          ...
          energy /= FunctionNL_kSDM(energy, 0.983176*0.993, -1.85546, -3.37696);          
        else if( fCurrentMC==k15a3a || fCurrentMC==k15a3a_plus || fCurrentMC==k15a3b )
    ...
    case 32:
      ...
      if(isMC>0){
        ...
        if(  fCurrentMC==k12f1a || fCurrentMC==k12i3 )
          ...
          energy /= FunctionNL_kSDM(energy, 0.974424*0.998, -0.533785, -4.06374);    
        else if ( fCurrentMC==k15a3a || fCurrentMC==k15a3a_plus || fCurrentMC==k15a3b ) 
...
// *************** 40 + x **** default tender Settings - pPb
    ...
    case 41:
      label_case_41:
      if(isMC>0){
        if( fCurrentMC==k13b2_efix ) energy /= FunctionNL_kSDM(energy, 0.995*0.978578, -3.80517, -0.581197);//v4
    ...
    case 42:
      label_case_42:
      if(isMC>0){
        if( fCurrentMC==k13b2_efix ) energy /= FunctionNL_kSDM(energy, 1.002*0.970383, -3.65936, -0.721139);//v4
...
// *************** 50 + x **** modified tender Settings 1 - pPb
    ...
    case 51:
      label_case_51:
      if(isMC>0){
        if( fCurrentMC==k13b2_efix ) energy /= (FunctionNL_DPOW(energy, 1.0754004911, -0.0992327361, -0.0802161499, 1.1849304274, -0.1999999986, -0.0828138864) - 0.005);//v4
          //energy /= FunctionNL_kSDM(energy, 0.977118, -3.46238, -0.575729);v0
          //energy /= FunctionNL_kSDM(energy, 0.975357, -3.54572, -0.398501);v1
          //energy /= FunctionNL_kSDM(energy, 0.9936*0.976721, -3.60967, -0.43353);//v2
          //energy /= FunctionNL_kSDM(energy, 0.982252, -3.49763, -0.969196);//v3
    ...
    case 52:
      label_case_52:
      if(isMC>0){
        if( fCurrentMC==k13b2_efix ) energy /= (FunctionNL_DPOW(energy, 1.0358207569, -0.0914347267, -0.3683743201, 1.1549558754, -0.1942615277, -0.2216281109) + 0.002);//v4
          //energy /= FunctionNL_kSDM(2.0*energy, 0.975467, -1.9989, -1.23208);v0
          //energy /= FunctionNL_kSDM(2.0*energy, 0.974716, -2.56403, -0.85898);v1
          //energy /= FunctionNL_kSDM(2.0*energy, 0.9970*0.974951, -2.56938, -0.863324);//v2
          //energy /= FunctionNL_kSDM(energy, 0.973302, -2.41453, -1.88838);//v3
