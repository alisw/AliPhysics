#ifndef ALIANLYSISTASKGAMMACALOMERGEDML_cxx
#define ALIANLYSISTASKGAMMACALOMERGEDML_cxx
...
class AliAnalysisTaskGammaCaloMergedML : public AliAnalysisTaskSE {
  public:

    AliAnalysisTaskGammaCaloMergedML();
    AliAnalysisTaskGammaCaloMergedML(const char *name);
    virtual ~AliAnalysisTaskGammaCaloMergedML();
