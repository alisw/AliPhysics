...
class AliAnalysisTaskGammaCalo : public AliAnalysisTaskSE {
  ...
  protected:
    ...
    TH1F**                fHistoClusGammaPt_BothBM;                             //! array of histos with cluster, pt; Only clusters, which are good on triggered bad map and analysis bad map; Only MB
    ...
    TH1F**                fHistoClusGammaPt_BothBM_highestE;                    //! array of histos with cluster, pt; Only highest cluster in event, which is good on triggered bad map and analysis bad map; MB and tigger but use only triggered clusters for trigger
    ...
    TH1F**                fHistoClusGammaPt_AnaBM_highestE;                     //! array of histos with cluster, pt; Only highest cluster in event, which is good on analysis bad map; Only MB
    ...
    TH1F**                fHistoClusGammaPt_onlyTriggered;                      //! array of histos with cluster, pt; Only
