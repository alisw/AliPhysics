...
#include "AliESDpid.h"
#include "AliAnalysisTaskGammaCaloMix.h"
...
ClassImp(AliAnalysisTaskGammaCaloMix)

//________________________________________________________________________
AliAnalysisTaskGammaCaloMix::AliAnalysisTaskGammaCaloMix(): AliAnalysisTaskSE(), fV0Reader(NULL), fV0ReaderName("V0ReaderV1"), fCorrTaskSetting(""), fBGHandler(NULL), fInputEvent(NULL), fMCEvent(NULL), fCutFolder(NULL), fESDList(NULL), fBackList(NULL), fMotherList(NULL), fTrueList(NULL), fMCList(NULL), fTreeList(NULL), fClusterTreeList(NULL), fOutputContainer(NULL), fReaderGammas(NULL), fGammaCandidates(NULL), fClusterCandidates(NULL), fClusterCandidates2(NULL), fEventCutArray(NULL), fEventCuts(NULL), fClusterCutArray(NULL), fClusterCutArray2(NULL), fCaloPhotonCuts(NULL), fMesonCutArray(NULL), fMesonCuts(NULL), fConvJetReader(NULL), fConversionCuts(NULL), fOutlierJetReader(NULL), fDoJetAnalysis(kFALSE), fDoJetQA(kFALSE), fDoTrueSphericity(kFALSE), fJetHistograms(NULL), fTrueJetHistograms(NULL), fJetSector(0), fMaxPtNearEMCalPlace(0), fJetNearEMCal(kFALSE), fHistoMotherInvMassPt(NULL), fSparseMotherInvMassPtZM(NULL), fHistoMotherBackInvMassPt(NULL), fSparseMotherBackInvMassPtZM(NULL), fHistoMotherPi0PtY(NULL), fHistoMotherEtaPtY(NULL), fHistoMotherPi0PtAlpha(NULL), fHistoMotherEtaPtAlpha(NULL), fHistoMotherPi0PtOpenAngle(NULL), fHistoMotherEtaPtOpenAngle(NULL), fHistoMotherPtOpenAngle(NULL), fHistoMotherPtOpenAngleBck(NULL), fHistoMotherPi0NGoodESDTracksPt(NULL), fHistoMotherEtaNGoodESDTracksPt(NULL), fHistoMotherInvMassECalib(NULL), fHistoMotherBackInvMassECalib(NULL), fHistoClusGammaPt(NULL), fHistoClusGammaE(NULL), fHistoClusOverlapHeadersGammaPt(NULL), fHistoClusAllHeadersGammaPt(NULL), fHistoClusRejectedHeadersGammaPt(NULL), fHistoClusGammaPtM02(NULL), fHistoMCHeaders(NULL), fHistoMCAllGammaPt(NULL), fHistoMCAllSecondaryGammaPt(NULL), fHistoMCDecayGammaPi0Pt(NULL), fHistoMCDecayGammaRhoPt(NULL), fHistoMCDecayGammaEtaPt(NULL), fHistoMCDecayGammaOmegaPt(NULL), fHistoMCDecayGammaEtapPt(NULL), fHistoMCDecayGammaPhiPt(NULL), fHistoMCDecayGammaSigmaPt(NULL), fHistoMCPi0Pt(NULL), fHistoMCPi0WOWeightPt(NULL), fHistoMCPi0WOEvtWeightPt(NULL), fHistoMCEtaPt(NULL), fHistoMCEtaWOWeightPt(NULL), fHistoMCEtaWOEvtWeightPt(NULL), fHistoMCPi0InAccPt(NULL), fHistoMCEtaInAccPt(NULL), fHistoMCPi0WOEvtWeightInAccPt(NULL), fHistoMCEtaWOEvtWeightInAccPt(NULL), fHistoMCPi0PtY(NULL), fHistoMCEtaPtY(NULL), fHistoMCPi0PtAlpha(NULL), fHistoMCEtaPtAlpha(NULL), fHistoMCPrimary
terEnergyMax2(NULL), fHistoNEvents(NULL), fHistoNEventsWOWeight(NULL), fHistoNGoodESDTracks(NULL), fHistoVertexZ(NULL), fHistoNGammaCandidates(NULL), fHistoNGammaCandidates2(NULL), fHistoNGammaCandidatesBasic(NULL), fHistoNGoodESDTracksVsNGammaCandidates(NULL), fHistoSPDClusterTrackletBackground(NULL), fHistoNV0Tracks(NULL), fProfileEtaShift(NULL), fProfileJetJetXSection(NULL), fHistoJetJetNTrials(NULL), fHistoEventSphericity(NULL), fHistoEventSphericityAxis(NULL), fHistoEventSphericityvsNtracks(NULL), fHistoEventSphericityvsNJets(NULL), fHistoEventMultiplicityvsNJets(NULL), fHistoTrueSphericityvsRecSphericity(NULL), fHistoTrueMultiplicityvsRecMultiplicity(NULL), fHistoEventSphericityvsHighpt(NULL), fHistoEventSphericityvsTotalpt(NULL), fHistoEventSphericityvsMeanpt(NULL), fHistoPionSpectrum(NULL), fHistoProtonSpectrum(NULL), fHistoKaonSpectrum(NULL), fHistoNPionSpectrum(NULL), fHistoEtaSpectrum(NULL), fHistoDMesonSpectrum(NULL), tTreeSphericity(NULL), fRecSph(0), fTrueSph(0), fPi0Pt(0), fPi0InvMass(0), fHistoPtJet(NULL), fHistoJetEta(NULL), fHistoJetPhi(NULL), fHistoJetArea(NULL), fHistoNJets(NULL), fHistoEventwJets(NULL), fHistoJetPi0PtRatio(NULL), fHistoDoubleCounting(NULL), fHistoJetMotherInvMassPt(NULL), fHistoPi0InJetMotherInvMassPt(NULL), fHistoMotherBackJetInvMassPt(NULL), fHistoRJetPi0Cand(NULL), fHistoEtaPhiJetPi0Cand(NULL), fHistoEtaPhiJetWithPi0Cand(NULL), fHistoJetFragmFunc(NULL), fHistoJetFragmFuncZInvMass(NULL), fHistoTruevsRecJetPt(NULL), fHistoTruePi0JetMotherInvMassPt(NULL), fHistoTruePi0InJetMotherInvMassPt(NULL), fHistoTruePrimaryPi0JetInvMassPt(NULL), fHistoTruePrimaryPi0inJetInvMassPt(NULL), fHistoTruePrimaryPi0InJetInvMassTruePt(NULL), fHistoTrueDoubleCountingPi0Jet(NULL), fHistoTrueEtaJetMotherInvMassPt(NULL), fHistoTrueEtaInJetMotherInvMassPt(NULL), fHistoTruePrimaryEtaJetInvMassPt(NULL), fHistoTruePrimaryEtainJetInvMassPt(NULL), fHistoTrueDoubleCountingEtaJet(NULL), fHistoTruePi0JetFragmFunc(NULL), fHistoTruePi0JetFragmFuncZInvMass(NULL), fHistoTrueEtaJetFragmFunc(NULL), fHistoTrueEtaJetFragmFuncZInvMass(NULL), fHistoMCPi0JetInAccPt(NULL), fHistoMCPi0inJetInAccPt(NULL), fHistoMCEtaJetInAccPt(NULL), fHistoMCEtainJetInAccPt(NULL), fHistoMCPi0JetEventGenerated(NULL), fHistoMCPi0inJetGenerated(NULL), fHistoMCEtaJetEventGenerated(NULL), fHistoMCEtainJetGenerated(NULL), fHistoTrueSecondaryPi0FromK0sJetInvMassPt(NULL), fHistoTrueSecondaryPi0FromK0sinJetInvMassPt(NULL), fHistoTrueSecondaryPi0FromLambdaJetInvMassPt(NULL), fHistoTrueSecondaryPi0FromLambdainJetInvMassPt(NULL), fHistoTrueSecondaryPi0FromK0lJetInvMassPt(NULL), fHistoTrueSecondaryPi0FromK0linJetInvMassPt(NULL), fHistoTrueSecondaryPi0InvJetMassPt(NULL), fHistoTrueSecondaryPi0InvinJetMassPt(NULL), fHistoMotherPi0inJetPtY(NULL), fHistoMotherEtainJetPtY(NULL), fHistoMotherPi0inJetPtPhi(NULL), fHistoMotherEtainJetPtPhi(NULL), fNumberOfClusters(NULL), fNumberOfClustersinJets(NULL), fEnergyRatio(NULL), fEnergyRatioinJets(NULL), fEnergyRatioGamma1(NULL), fEnergyRatioGamma1inJets(NULL), fEnergyRatioGammaAnywhere(NULL), fEnergyRatioGammaAnywhereinJets(NULL), fEnergyDeposit(NULL), fEnergyDepositinJets(NULL), fEnergyDepGamma1(NULL), fEnergyDepGamma1inJets(NULL), fEnergyDepGammaAnywhere(NULL), fEnergyDepGammaAnywhereinJets(NULL), fEnergyRatioGamma1Helped(NULL), fEnergyRatioGamma1HelpedinJets(NULL), fClusterEtaPhiJets(NULL), fHistoUnfoldingAsData(NULL), fHistoUnfoldingMissed(NULL), fHistoUnfoldingReject(NULL), fHistoUnfoldingAsDataInvMassZ(NULL), fHistoUnfoldingMissedInvMassZ(NULL), fHistoUnfoldingRejectInvMassZ(NULL), fVectorJetPt(0), fVectorJetPx(0), fVectorJetPy(0), fVectorJetPz(0), fVectorJetEta(0), fVectorJetPhi(0), fVectorJetArea(0), fTrueVectorJetPt(0), fTrueVectorJetPx(0), fTrueVectorJetPy(0), fTrueVectorJetPz(0), fTrueVectorJetEta(0), fTrueVectorJetPhi(0), tTrueInvMassROpenABPtFlag(NULL), fInvMass(-1), fRconv(-1), fOpenRPrim(-1), fInvMassRTOF(-1), fPt(-1), iFlag(3), tSigInvMassPtAlphaTheta(NULL), tBckInvMassPtAlphaTheta(NULL), fInvMassTreeInvMass(0), fInvMassTreePt(0), fInvMassTreeAlpha(0), fInvMassTreeTheta(0), fInvMassTreeMixPool(0), fInvMassTreeZVertex(0), fInvMassTreeEta(0), tClusterEOverP(NULL), fClusterE(0), fClusterM02(0), fClusterM20(0), fClusterEP(0), fClusterLeadCellID(0), fClusterClassification(0), fDeltaEta(0), fDeltaPhi(0), fTrackPt(0), fTrackPID_e(0), fTrackPID_Pi(0), fTrackPID_K(0), fTrackPID_P(0), fClusterIsoSumClusterEt(0), fClusterIsoSumTrackEt(0), tClusterTimingEff(NULL), fClusterTimeTag(0), fClusterTimeProbe(0), fClusterETag(0), fClusterEProbe(0), fEventPlaneAngle(-100), fRandom(0), fnCuts(0), fiCut(0), fIsHeavyIon(0), fDoLightOutput(kFALSE), fDoMesonAnalysis(kTRUE), fDoMesonQA(0), fDoClusterQA(0), fIsFromDesiredHeader(kTRUE), fIsOverlappingWithOtherHeader(kFALSE), fIsMC(0), fDoTHnSparse(kTRUE), fSetPlotHistsExtQA(kFALSE), fDoSoftAnalysis(kFALSE), fWeightJetJetMC(1), fDoInOutTimingCluster(kFALSE), fMinTimingCluster(0), fMaxTimingCluster(0), fEnableSortForClusMC(kFALSE), fProduceCellIDPlots(kFALSE), fProduceTreeEOverP(kFALSE), tBrokenFiles(NULL), fFileNameBroken(NULL), tClusterQATree(NULL), fCloseHighPtClusters(NULL), fLocalDebugFlag(0), fAllowOverlapHeaders(kTRUE), fNCurrentClusterBasic(0), fTrackMatcherRunningMode(0), fDoPi0Only(kFALSE)
{

}

//________________________________________________________________________
AliAnalysisTaskGammaCaloMix::AliAnalysisTaskGammaCaloMix(const char *name):
AliAnalysisTaskSE(name), fV0Reader(NULL), fV0ReaderName("V0ReaderV1"), fCorrTaskSetting(""), fBGHandler(NULL), fInputEvent(NULL), fMCEvent(NULL), fCutFolder(NULL), fESDList(NULL), fBackList(NULL), fMotherList(NULL), fTrueList(NULL), fMCList(NULL), fTreeList(NULL), fClusterTreeList(NULL), fOutputContainer(NULL), fReaderGammas(NULL), fGammaCandidates(NULL), fClusterCandidates(NULL), fClusterCandidates2(NULL), fEventCutArray(NULL), fEventCuts(NULL), fClusterCutArray(NULL), fClusterCutArray2(NULL), fCaloPhotonCuts(NULL), fMesonCutArray(NULL), fMesonCuts(NULL), fConvJetReader(NULL), fConversionCuts(NULL), fOutlierJetReader(NULL), fDoJetAnalysis(kFALSE), fDoJetQA(kFALSE), fDoTrueSphericity(kFALSE), fJetHistograms(NULL), fTrueJetHistograms(NULL), fJetSector(0), fMaxPtNearEMCalPlace(0), fJetNearEMCal(kFALSE), fHistoMotherInvMassPt(NULL), fSparseMotherInvMassPtZM(NULL), fHistoMotherBackInvMassPt(NULL), fSparseMotherBackInvMassPtZM(NULL), fHistoMotherPi0PtY(NULL), fHistoMotherEtaPtY(NULL), fHistoMotherPi0PtAlpha(NULL), fHistoMotherEtaPtAlpha(NULL), fHistoMotherPi0PtOpenAngle(NULL), fHistoMotherEtaPtOpenAngle(NULL), fHistoMotherPtOpenAngle(NULL), fHistoMotherPtOpenAngleBck(NULL), fHistoMotherPi0NGoodESDTracksPt(NULL), fHistoMotherEtaNGoodESDTracksPt(NULL), fHistoMotherInvMassECalib(NULL), fHistoMotherBackInvMassECalib(NULL), fHistoClusGammaPt(NULL), fHistoClusGammaE(NULL), fHistoClusOverlapHeadersGammaPt(NULL), fHistoClusAllHeadersGammaPt(NULL), fHistoClusRejectedHeadersGammaPt(NULL), fHistoClusGammaPtM02(NULL), fHistoMCHeaders(NULL), fHistoMCAllGammaPt(NULL), fHistoMCAllSecondaryGammaPt(NULL), fHistoMCDecayGammaPi0Pt(NULL), fHistoMCDecayGammaRhoPt(NULL), fHistoMCDecayGammaEtaPt(NULL), fHistoMCDecayGammaOmegaPt(NULL), fHistoMCDecayGammaEtapPt(NULL), fHistoMCDecayGammaPhiPt(NULL), fHistoMCDecayGammaSigmaPt(NULL), fHistoMCPi0Pt(NULL), fHistoMCPi0WOWeightPt(NULL), fHistoMCPi0WOEvtWeightPt(NULL), fHistoMCEtaPt(NULL), fHistoMCEtaWOWeightPt(NULL), fHistoMCEtaWOEvtWeightPt(NULL), fHistoMCPi0InAccPt(NULL), fHistoMCEtaInAccPt(NULL), fHistoMCPi0WOEvtWeightInAccPt(NULL), fHistoMCEtaWOEvtWeightInAccPt(NULL), fHistoMCPi0PtY(NULL), fHistoMCEtaPtY(NULL), fHistoMCPi0PtAlpha(NULL), fHistoMCEtaPtAlpha(NULL), fHistoMCPrimaryPtv
ergyMax2(NULL), fHistoNEvents(NULL), fHistoNEventsWOWeight(NULL), fHistoNGoodESDTracks(NULL), fHistoVertexZ(NULL), fHistoNGammaCandidates(NULL), fHistoNGammaCandidates2(NULL), fHistoNGammaCandidatesBasic(NULL), fHistoNGoodESDTracksVsNGammaCandidates(NULL), fHistoSPDClusterTrackletBackground(NULL), fHistoNV0Tracks(NULL), fProfileEtaShift(NULL), fProfileJetJetXSection(NULL), fHistoJetJetNTrials(NULL), fHistoEventSphericity(NULL), fHistoEventSphericityAxis(NULL), fHistoEventSphericityvsNtracks(NULL), fHistoEventSphericityvsNJets(NULL), fHistoEventMultiplicityvsNJets(NULL), fHistoTrueSphericityvsRecSphericity(NULL), fHistoTrueMultiplicityvsRecMultiplicity(NULL), fHistoEventSphericityvsHighpt(NULL), fHistoEventSphericityvsTotalpt(NULL), fHistoEventSphericityvsMeanpt(NULL), fHistoPionSpectrum(NULL), fHistoProtonSpectrum(NULL), fHistoKaonSpectrum(NULL), fHistoNPionSpectrum(NULL), fHistoEtaSpectrum(NULL), fHistoDMesonSpectrum(NULL), tTreeSphericity(NULL), fRecSph(0), fTrueSph(0), fPi0Pt(0), fPi0InvMass(0), fHistoPtJet(NULL), fHistoJetEta(NULL), fHistoJetPhi(NULL), fHistoJetArea(NULL), fHistoNJets(NULL), fHistoEventwJets(NULL), fHistoJetPi0PtRatio(NULL), fHistoDoubleCounting(NULL), fHistoJetMotherInvMassPt(NULL), fHistoPi0InJetMotherInvMassPt(NULL), fHistoMotherBackJetInvMassPt(NULL), fHistoRJetPi0Cand(NULL), fHistoEtaPhiJetPi0Cand(NULL), fHistoEtaPhiJetWithPi0Cand(NULL), fHistoJetFragmFunc(NULL), fHistoJetFragmFuncZInvMass(NULL), fHistoTruevsRecJetPt(NULL), fHistoTruePi0JetMotherInvMassPt(NULL), fHistoTruePi0InJetMotherInvMassPt(NULL), fHistoTruePrimaryPi0JetInvMassPt(NULL), fHistoTruePrimaryPi0inJetInvMassPt(NULL), fHistoTruePrimaryPi0InJetInvMassTruePt(NULL), fHistoTrueDoubleCountingPi0Jet(NULL), fHistoTrueEtaJetMotherInvMassPt(NULL), fHistoTrueEtaInJetMotherInvMassPt(NULL), fHistoTruePrimaryEtaJetInvMassPt(NULL), fHistoTruePrimaryEtainJetInvMassPt(NULL), fHistoTrueDoubleCountingEtaJet(NULL), fHistoTruePi0JetFragmFunc(NULL), fHistoTruePi0JetFragmFuncZInvMass(NULL), fHistoTrueEtaJetFragmFunc(NULL), fHistoTrueEtaJetFragmFuncZInvMass(NULL), fHistoMCPi0JetInAccPt(NULL), fHistoMCPi0inJetInAccPt(NULL), fHistoMCEtaJetInAccPt(NULL), fHistoMCEtainJetInAccPt(NULL), fHistoMCPi0JetEventGenerated(NULL), fHistoMCPi0inJetGenerated(NULL), fHistoMCEtaJetEventGenerated(NULL), fHistoMCEtainJetGenerated(NULL), fHistoTrueSecondaryPi0FromK0sJetInvMassPt(NULL), fHistoTrueSecondaryPi0FromK0sinJetInvMassPt(NULL), fHistoTrueSecondaryPi0FromLambdaJetInvMassPt(NULL), fHistoTrueSecondaryPi0FromLambdainJetInvMassPt(NULL), fHistoTrueSecondaryPi0FromK0lJetInvMassPt(NULL), fHistoTrueSecondaryPi0FromK0linJetInvMassPt(NULL), fHistoTrueSecondaryPi0InvJetMassPt(NULL), fHistoTrueSecondaryPi0InvinJetMassPt(NULL), fHistoMotherPi0inJetPtY(NULL), fHistoMotherEtainJetPtY(NULL), fHistoMotherPi0inJetPtPhi(NULL), fHistoMotherEtainJetPtPhi(NULL), fNumberOfClusters(NULL), fNumberOfClustersinJets(NULL), fEnergyRatio(NULL), fEnergyRatioinJets(NULL), fEnergyRatioGamma1(NULL), fEnergyRatioGamma1inJets(NULL), fEnergyRatioGammaAnywhere(NULL), fEnergyRatioGammaAnywhereinJets(NULL), fEnergyDeposit(NULL), fEnergyDepositinJets(NULL), fEnergyDepGamma1(NULL), fEnergyDepGamma1inJets(NULL), fEnergyDepGammaAnywhere(NULL), fEnergyDepGammaAnywhereinJets(NULL), fEnergyRatioGamma1Helped(NULL), fEnergyRatioGamma1HelpedinJets(NULL), fClusterEtaPhiJets(NULL), fHistoUnfoldingAsData(NULL), fHistoUnfoldingMissed(NULL), fHistoUnfoldingReject(NULL), fHistoUnfoldingAsDataInvMassZ(NULL), fHistoUnfoldingMissedInvMassZ(NULL), fHistoUnfoldingRejectInvMassZ(NULL), fVectorJetPt(0), fVectorJetPx(0), fVectorJetPy(0), fVectorJetPz(0), fVectorJetEta(0), fVectorJetPhi(0), fVectorJetArea(0), fTrueVectorJetPt(0), fTrueVectorJetPx(0), fTrueVectorJetPy(0), fTrueVectorJetPz(0), fTrueVectorJetEta(0), fTrueVectorJetPhi(0), tTrueInvMassROpenABPtFlag(NULL), fInvMass(-1), fRconv(-1), fOpenRPrim(-1), fInvMassRTOF(-1), fPt(-1), iFlag(3), tSigInvMassPtAlphaTheta(NULL), tBckInvMassPtAlphaTheta(NULL), fInvMassTreeInvMass(0), fInvMassTreePt(0), fInvMassTreeAlpha(0), fInvMassTreeTheta(0), fInvMassTreeMixPool(0), fInvMassTreeZVertex(0), fInvMassTreeEta(0), tClusterEOverP(NULL), fClusterE(0), fClusterM02(0), fClusterM20(0), fClusterEP(0), fClusterLeadCellID(0), fClusterClassification(0), fDeltaEta(0), fDeltaPhi(0), fTrackPt(0), fTrackPID_e(0), fTrackPID_Pi(0), fTrackPID_K(0), fTrackPID_P(0), fClusterIsoSumClusterEt(0), fClusterIsoSumTrackEt(0), tClusterTimingEff(NULL), fClusterTimeTag(0), fClusterTimeProbe(0), fClusterETag(0), fClusterEProbe(0), fEventPlaneAngle(-100), fRandom(0), fnCuts(0), fiCut(0), fIsHeavyIon(0), fDoLightOutput(kFALSE), fDoMesonAnalysis(kTRUE), fDoMesonQA(0), fDoClusterQA(0), fIsFromDesiredHeader(kTRUE), fIsOverlappingWithOtherHeader(kFALSE), fIsMC(0), fDoTHnSparse(kTRUE), fSetPlotHistsExtQA(kFALSE), fDoSoftAnalysis(kFALSE), fWeightJetJetMC(1), fDoInOutTimingCluster(kFALSE), fMinTimingCluster(0), fMaxTimingCluster(0), fEnableSortForClusMC(kFALSE), fProduceCellIDPlots(kFALSE), fProduceTreeEOverP(kFALSE), tBrokenFiles(NULL), fFileNameBroken(NULL), tClusterQATree(NULL), fCloseHighPtClusters(NULL), fLocalDebugFlag(0), fAllowOverlapHeaders(kTRUE), fNCurrentClusterBasic(0), fTrackMatcherRunningMode(0), fDoPi0Only(kFALSE)
{
...
AliAnalysisTaskGammaCaloMix::~AliAnalysisTaskGammaCaloMix()
{
  ...
  if(fClusterCandidates2){
    delete fClusterCandidates2;
    fClusterCandidates2 = 0x0;
  }
  if(fGammaCandidates){
...
void AliAnalysisTaskGammaCaloMix::InitBack(){
  ...
  for(Int_t iCut = 0; iCut<fnCuts;iCut++){
    if (((AliConversionMesonCuts*)fMesonCutArray->At(iCut))->DoBGCalculation()){
      ...
      TString cutstringCalo2  = ((AliCaloPhotonCuts*)fClusterCutArray2->At(iCut))->GetCutNumber();
      ...
      if(fDoTHnSparse){
        ...
        fBackList[iCut]->SetName(Form("%s_%s_%s_%s Back histograms",cutstringEvent.Data(),cutstringCalo.Data(), cutstringCalo2.Data(), cutstringMeson.Data()));
        ...
        fMotherList[iCut]->SetName(Form("%s_%s_%s_%s Mother histograms", cutstringEvent.Data(), cutstringCalo.Data(), cutstringCalo2.Data(), cutstringMeson.Data()));
      ...
      if(((AliConversionMesonCuts*)fMesonCutArray->At(iCut))->BackgroundHandlerType() == 0){
        fBGHandler[iCut] = new AliGammaConversionAODBGHandler(
                                    collisionSystem,centMin,centMax,                                   ((AliConversionMesonCuts*)fMesonCutArray->At(iCut))->GetNumberOfBGEvents(),                                   ((AliConversionMesonCuts*)fMesonCutArray->At(iCut))->UseTrackMultiplicity(),                                   4,8,7);
      }
    }
  }
}
//________________________________________________________________________
void AliAnalysisTaskGammaCaloMix::UserCreateOutputObjects(){
  ...
  if(((AliCaloPhotonCuts*)fClusterCutArray->At(fiCut))->GetDoSecondaryTrackMatching() || ((AliCaloPhotonCuts*)fClusterCutArray2->At(fiCut))->GetDoSecondaryTrackMatching()){
 ...
 Double_t* arrLogBinning = new Double_t[51]{1.00e-03, 1.20e-03, 1.45e-03, 1.74e-03, 2.01e-03, 2.51e-03, 3.02e-03, 3.63e-03, 4.37e-03, 5.25e-03, 6.31e-03, 7.60e-03,                                    9.12e-03, 1.01e-02, 1.32e-02, 1.58e-02, 1.91e-02, 2.29e-02, 2.75e-02, 3.31e-02, 3.98e-02, 4.79e-02, 5.75e-02, 6.91e-02,                                    8.32e-02, 1.00e-01, 1.20e-01, 1.45e-01, 1.74e-01, 2.09e-01, 2.51e-01, 3.02e-01, 3.63e-01, 4.37e-01, 5.25e-01, 6.31e-01,                                    7.59e-01, 9.12e-01, 1.10e+00, 1.32e+00, 1.58e+00, 1.91e+00, 2.29e+00, 2.75e+00, 3.31e+00, 3.98e+00, 4.79e+00, 5.75e+00,                                    6.92e+00, 8.32e+00, 1.00e+01};
  // Create histograms
  ...
  fClusterCandidates2  = new TList();
  fClusterCandidates2->SetOwner(kTRUE);
  ...
  fHistoNGammaCandidates2      = new TH1F*[fnCuts];
  ...
  if(fProduceCellIDPlots){
    ...
    fHistCellIDvsClusterEnergy2      = new TH2F*[fnCuts];
    fHistCellIDvsClusterEnergyMax   = new TH2F*[fnCuts];
    fHistCellIDvsClusterEnergyMax2   = new TH2F*[fnCuts];
  }
  ...
  for(Int_t iCut = 0; iCut<fnCuts;iCut++){
    ...
    fCutFolder[iCut]->SetName(Form("Cut Number %s_%s_%s_%s", cutstringEvent.Data(), cutstringCalo.Data(), cutstringCalo2.Data(), cutstringMeson.Data()));
    fCutFolder[iCut]->SetOwner(kTRUE);
    fOutputContainer->Add(fCutFolder[iCut]);
    fESDList[iCut]          = new TList();
    fESDList[iCut]->SetName(Form("%s_%s_%s_%s ESD histograms", cutstringEvent.Data(), cutstringCalo.Data(), cutstringCalo2.Data(), cutstringMeson.Data()));
    ...
    if(fDoMesonAnalysis){
      ...
      if (fProduceCellIDPlots){
        ...
        nMaxCells      = 12*48*24;
        if(((AliCaloPhotonCuts*)fClusterCutArray2->At(iCut))->GetClusterType() == 2) nMaxCells = 5*56*64;
        fHistCellIDvsClusterEnergy2[iCut]         = new TH2F("CellIDvsClusterEnergy", "CellIDvsClusterEnergy", 100, 0.5, 100., nMaxCells, 0, nMaxCells);
        fHistCellIDvsClusterEnergy2[iCut]->SetXTitle("E_{clus} (GeV)");
        fHistCellIDvsClusterEnergy2[iCut]->SetYTitle("Cell ID");
        SetLogBinningXTH2(fHistCellIDvsClusterEnergy2[iCut]);
        fESDList[iCut]->Add(fHistCellIDvsClusterEnergy2[iCut]);
        fHistCellIDvsClusterEnergyMax2[iCut]      = new TH2F("CellIDvsClusterEnergyMax", "CellIDvsClusterEnergyMax", 100, 0.5, 100., nMaxCells, 0, nMaxCells);
        fHistCellIDvsClusterEnergyMax2[iCut]->SetXTitle("E_{clus} (GeV)");
        fHistCellIDvsClusterEnergyMax2[iCut]->SetYTitle("Cell ID");
        SetLogBinningXTH2(fHistCellIDvsClusterEnergyMax2[iCut]);
        fESDList[iCut]->Add(fHistCellIDvsClusterEnergyMax2[iCut]);
      }

      if (fDoMesonQA == 4 && fIsMC == 0){
        fTreeList[iCut] = new TList();
        fTreeList[iCut]->SetName(Form("%s_%s_%s_%s InvMass Tree", cutstringEvent.Data(), cutstringCalo.Data(), cutstringCalo2.Data(), cutstringMeson.Data()));
      ...
      if (fDoMesonQA == 5 && fIsMC == 0){
        tClusterTimingEff[iCut]   = new TTree(Form("%s_%s_%s_%s ClusterTimingEff", cutstringEvent.Data(), cutstringCalo.Data(), cutstringCalo2.Data(), cutstringMeson.Data()), Form("%s_%s_%s_%s ClusterTimingEff", cutstringEvent.Data(), cutstringCalo.Data(), cutstringCalo2.Data(), cutstringMeson.Data()));
      ...
      if (fProduceTreeEOverP ){
        ...
        fClusterTreeList[iCut]->SetName(Form("%s_%s_%s EoverP Tree",cutstringEvent.Data(),cutstringCalo.Data(), cutstringCalo2.Data()));
    ...
    if(fDoJetAnalysis){
      ...
      fJetHistograms[iCut]->SetName(Form("%s_%s_%s_%s Jet histograms", cutstringEvent.Data(), cutstringCalo.Data(), cutstringCalo2.Data(), cutstringMeson.Data()));
  ...
  if(fIsMC> 0){
    ...
    for(Int_t iCut = 0; iCut<fnCuts;iCut++){
      ...
      fMCList[iCut]->SetName(Form("%s_%s_%s_%s MC histograms", cutstringEvent.Data(), cutstringCalo.Data(), cutstringCalo2.Data(), cutstringMeson.Data()));
      ...
      fTrueList[iCut]->SetName(Form("%s_%s_%s_%s True histograms", cutstringEvent.Data(), cutstringCalo.Data(), cutstringCalo2.Data(), cutstringMeson.Data()));
      fTrueList[iCut]->SetOwner(kTRUE);
      fCutFolder[iCut]->Add(fTrueList[iCut]);

      if(fDoJetAnalysis && !fDoLightOutput){
        fTrueJetHistograms[iCut] = new TList();
        fTrueJetHistograms[iCut]->SetName(Form("%s_%s_%s_%s True Jet histograms", cutstringEvent.Data(), cutstringCalo.Data(), cutstringCalo2.Data(), cutstringMeson.Data()));
      ...
      if(!fDoLightOutput){
        ...
        fHistoTrueSecondaryClusGammaFromXFromK0sMCPtESDPt[iCut] = new TH2F("ESD_TrueSecondaryClusGammaFromXFromK0s_MCPt_Pt", "ESD_TrueSecondaryClusGammaFromXFromK0s_MCPt_Pt",                                                                          nBinsClusterPt, arrClusPtBinning, nBinsClusterPt, arrClusPtBinning);
        ...
        fHistoTrueSecondaryClusConvGammaFromXFromK0sMCPtESDPt[iCut] = new TH2F("ESD_TrueSecondaryClusConvGammaFromXFromK0s_MCPt_Pt", "ESD_TrueSecondaryClusConvGammaFromXFromK0s_MCPt_Pt",                                                                              nBinsClusterPt, arrClusPtBinning, nBinsClusterPt, arrClusPtBinning);
        ...
        fHistoTrueSecondaryClusGammaFromXFromK0lMCPtESDPt[iCut] = new TH2F("ESD_TrueSecondaryClusGammaFromXFromK0l_MCPt_Pt", "ESD_TrueSecondaryClusGammaFromXFromK0l_MCPt_Pt",                                                                          nBinsClusterPt, arrClusPtBinning, nBinsClusterPt, arrClusPtBinning);
        ...
        fHistoTrueSecondaryClusConvGammaFromXFromK0lMCPtESDPt[iCut] = new TH2F("ESD_TrueSecondaryClusConvGammaFromXFromK0l_MCPt_Pt", "ESD_TrueSecondaryClusConvGammaFromXFromK0l_MCPt_Pt",                                                                              nBinsClusterPt, arrClusPtBinning, nBinsClusterPt, arrClusPtBinning);
        ...
        fHistoTrueSecondaryClusGammaFromXFromLambdaMCPtESDPt[iCut] = new TH2F("ESD_TrueSecondaryClusGammaFromXFromLambda_MCPt_Pt", "ESD_TrueSecondaryClusGammaFromXFromLambda_MCPt_Pt",                                                                             nBinsClusterPt, arrClusPtBinning, nBinsClusterPt, arrClusPtBinning);
        ...
        fHistoTrueSecondaryClusConvGammaFromXFromLambdaMCPtESDPt[iCut] = new TH2F("ESD_TrueSecondaryClusConvGammaFromXFromLambda_MCPt_Pt", "ESD_TrueSecondaryClusConvGammaFromXFromLambda_MCPt_Pt",                                                                                 nBinsClusterPt, arrClusPtBinning, nBinsClusterPt, arrClusPtBinning);
      ...
      if(fDoMesonAnalysis){
        ...
        if (fDoMesonQA > 0 && fDoMesonQA < 3){
          if (fIsMC < 2){
            ...
            if( !fDoPi0Only ){
              ...
              fHistoTrueEtaCaloMixedPhotonConvPhotonInvMassPt[iCut]   = new TH2F("ESD_TrueEtaCaloMixedPhotonConvertedPhoton_InvMass_Pt", "ESD_TrueEtaCaloMixedPhotonConvertedPhoton_InvMass_Pt", nBinsMinv, 0, maxMinv,                                                                                nBinsPt, arrPtBinning);
              ...
              fHistoTrueEtaCaloMergedClusterPartConvInvMassPt[iCut]   = new TH2F("ESD_TrueEtaCaloMergedClusterPartConv_InvMass_Pt", "ESD_TrueEtaCaloMergedClusterPartConv_InvMass_Pt", nBinsMinv, 0, maxMinv,                                                                                nBinsPt, arrPtBinning);
            ...
            fHistoTruePi0CaloMixedPhotonConvPhotonInvMassPt[iCut]   = new TH2F("ESD_TruePi0CaloMixedPhotonConvertedPhoton_InvMass_Pt", "ESD_TruePi0CaloMixedPhotonConvertedPhoton_InvMass_Pt", nBinsMinv, 0, maxMinv,                                                                              nBinsPt, arrPtBinning);
            ...
            fHistoTruePi0CaloMergedClusterPartConvInvMassPt[iCut]   = new TH2F("ESD_TruePi0CaloMergedClusterPartConv_InvMass_Pt", "ESD_TruePi0CaloMergedClusterPartConv_InvMass_Pt", nBinsMinv, 0, maxMinv,                                                                              nBinsPt, arrPtBinning);
            ...
            fHistoTruePi0NonMergedElectronMergedPhotonInvMassPt[iCut] = new TH2F("ESD_TruePi0NonMergedElectronMergedPhoton_InvMass_Pt", "ESD_TruePi0NonMergedElectronMergedPhoton_InvMass_Pt", nBinsMinv, 0, maxMinv,                                                                                nBinsPt, arrPtBinning);
        ...
        if (fDoMesonQA == 3){
          fTreeList[iCut] = new TList();
          fTreeList[iCut]->SetName(Form("%s_%s_%s_%s True ClusterComb tree", cutstringEvent.Data(), cutstringCalo.Data(), cutstringCalo2.Data(), cutstringMeson.Data()));
          fTreeList[iCut]->SetOwner(kTRUE);
          fCutFolder[iCut]->Add(fTreeList[iCut]);
...
//           tTrueInvMassROpenABPtFlag[iCut]->Branch("Weight",&fWeightJetJetMC,"fWeightJetJetMC/F");
  ...
  for(Int_t iCut = 0; iCut<fnCuts;iCut++){
    ...
    if(!((AliCaloPhotonCuts*)fClusterCutArray2->At(iCut))) continue;
    if(((AliCaloPhotonCuts*)fClusterCutArray2->At(iCut))->GetCutHistograms()){
      fCutFolder[iCut]->Add(((AliCaloPhotonCuts*)fClusterCutArray2->At(iCut))->GetCutHistograms());
    }
    if(fSetPlotHistsExtQA){
      if(!((AliCaloPhotonCuts*)fClusterCutArray2->At(iCut))) continue;
      if(((AliCaloPhotonCuts*)fClusterCutArray2->At(iCut))->GetExtQAHistograms()){
        fCutFolder[iCut]->Add(((AliCaloPhotonCuts*)fClusterCutArray2->At(iCut))->GetExtQAHistograms());
      }
    }
    if(fDoMesonAnalysis){
...
Bool_t AliAnalysisTaskGammaCaloMix::Notify()
{
  for(Int_t iCut = 0; iCut<fnCuts;iCut++){
...
//_____________________________________________________________________________
void AliAnalysisTaskGammaCaloMix::UserExec(Option_t *)
{
  //
  ...
  if(((AliCaloPhotonCuts*)fClusterCutArray->At(fiCut))->GetDoSecondaryTrackMatching() || ((AliCaloPhotonCuts*)fClusterCutArray2->At(fiCut))->GetDoSecondaryTrackMatching())fReaderGammas = fV0Reader->GetReconstructedGammas(); // Gammas from default Cut
  ...
  for(Int_t iCut = 0; iCut<fnCuts; iCut++){
    ...
    if (((AliCaloPhotonCuts*)fClusterCutArray->At(fiCut))->GetClusterType() == 1
     || ((AliCaloPhotonCuts*)fClusterCutArray->At(fiCut))->GetClusterType() == 3
     || ((AliCaloPhotonCuts*)fClusterCutArray->At(fiCut))->GetClusterType() == 4
     || ((AliCaloPhotonCuts*)fClusterCutArray2->At(fiCut))->GetClusterType() == 1
     || ((AliCaloPhotonCuts*)fClusterCutArray2->At(fiCut))->GetClusterType() == 3
     || ((AliCaloPhotonCuts*)fClusterCutArray2->At(fiCut))->GetClusterType() == 4
    ...
    if(((AliCaloPhotonCuts*)fClusterCutArray->At(fiCut))->GetDoSecondaryTrackMatching() || ((AliCaloPhotonCuts*)fClusterCutArray2->At(fiCut))->GetDoSecondaryTrackMatching()) ProcessConversionCandidates(); // process conversion candidates for secondary track matching
    ...
    fHistoNGammaCandidates2[iCut]->Fill(fClusterCandidates2->GetEntries(), fWeightJetJetMC);
    ...
    if(!fDoLightOutput) fHistoNGoodESDTracksVsNGammaCandidates[iCut]->Fill(fV0Reader->GetNumberOfPrimaryTracks(),fClusterCandidates2->GetEntries(), fWeightJetJetMC);
    ...
    if(((AliCaloPhotonCuts*)fClusterCutArray->At(fiCut))->GetDoSecondaryTrackMatching() || ((AliCaloPhotonCuts*)fClusterCutArray2->At(fiCut))->GetDoSecondaryTrackMatching()) fGammaCandidates->Clear();
    fClusterCandidates->Clear(); // delete cluster candidates
    fClusterCandidates2->Clear(); // delete cluster candidates
  }
...
//________________________________________________________________________
void AliAnalysisTaskGammaCaloMix::ProcessClusters()
{
  Int_t nclus                       = 0;
  ...
  if(!fCorrTaskSetting.CompareTo("")){
    ...
    if(!arrClustersProcess)
      AliFatal(Form("%sClustersBranch was not found in AliAnalysisTaskGammaCaloMix! Check the correction framework settings!",fCorrTaskSetting.Data()));
  ...
  ((AliCaloPhotonCuts*)fClusterCutArray2->At(fiCut))->FillHistogramsExtendedQA(fInputEvent,fIsMC);

  // match tracks to clusters
  ((AliCaloPhotonCuts*)fClusterCutArray->At(fiCut))->MatchTracksToClusters(fInputEvent,fWeightJetJetMC,kTRUE, fMCEvent);
  ((AliCaloPhotonCuts*)fClusterCutArray2->At(fiCut))->MatchTracksToClusters(fInputEvent,fWeightJetJetMC,kTRUE, fMCEvent);
  ...
  for(Long_t i = 0; i < nclus; i++){
    ...
    TList*                fClusterCutArraytmp;
    if(((AliCaloPhotonCuts*)fClusterCutArray->At(fiCut))->ClusterIsSelected(clus,fInputEvent,fMCEvent,fIsMC, fWeightJetJetMC,i))
      fClusterCutArraytmp = fClusterCutArray;
    else if(((AliCaloPhotonCuts*)fClusterCutArray2->At(fiCut))->ClusterIsSelected(clus,fInputEvent,fMCEvent,fIsMC, fWeightJetJetMC,i))
      fClusterCutArraytmp = fClusterCutArray2;
    else {
      ...
      if(fProduceTreeEOverP && ((AliCaloPhotonCuts*)fClusterCutArray2->At(fiCut))->ClusterIsSelectedBeforeTrackMatch() ) mapIsClusterAcceptedWithoutTrackMatch[i] = 1;
      if (((AliCaloPhotonCuts*)fClusterCutArray->At(fiCut))->GetIsAcceptedForBasicCounting())fNCurrentClusterBasic++;
      if (((AliCaloPhotonCuts*)fClusterCutArray2->At(fiCut))->GetIsAcceptedForBasicCounting())fNCurrentClusterBasic++;
      delete clus;
      continue;
    }
    ...
    PhotonCandidate->SetLeadingCellID(((AliCaloPhotonCuts*)fClusterCutArraytmp->At(fiCut))->FindLargestCellInCluster(clus,fInputEvent));
    // get MC label
    if(fIsMC> 0){
    ...
    if(fDoJetAnalysis == kTRUE && fIsMC > 0 && fDoClusterQA == kTRUE){
      ...
      if(clus->GetNLabels() > 1){
        ...
        for(Int_t k =0; k< (Int_t)clus->GetNLabels(); k++){
          AliAODMCParticle* dummy  = (AliAODMCParticle*) AODMCTrackArray->At(mclabelsCluster[k]);
    ...
    if ( (fIsFromDesiredHeader && !fIsOverlappingWithOtherHeader && !fAllowOverlapHeaders) || (fIsFromDesiredHeader && fAllowOverlapHeaders) ){
      ...
      if(((AliCaloPhotonCuts*)fClusterCutArray->At(fiCut))->ClusterIsSelected(clus,fInputEvent,fMCEvent,fIsMC, fWeightJetJetMC,i))
        ...
        fClusterCandidates2->Add(PhotonCandidate); // if no second loop is required add to events good gammas
  ...
  if(fProduceCellIDPlots){
    for(Long_t i = 0; i < nclus; i++){
      ...
      Int_t cellID;
      if(((AliCaloPhotonCuts*)fClusterCutArray->At(fiCut))->ClusterIsSelected(clus,fInputEvent,fMCEvent,fIsMC, fWeightJetJetMC,i)){
          cellID = ((AliCaloPhotonCuts*)fClusterCutArray->At(fiCut))->FindLargestCellInCluster(clus,fInputEvent);
          ...
          cellID = ((AliCaloPhotonCuts*)fClusterCutArray2->At(fiCut))->FindLargestCellInCluster(clus,fInputEvent);
          fHistCellIDvsClusterEnergy2[fiCut]->Fill(clus->E(),cellID);
          if (maxClusterID == i && maxClusterID > -1 ) fHistCellIDvsClusterEnergyMax2[fiCut]->Fill(maxClusterEnergy,cellID);
      }
  ...
  if(fProduceTreeEOverP){
    ...
    for(Long_t i = 0; i < nclus; i++){
      ...
      fClusterLeadCellID = ((AliCaloPhotonCuts*)fClusterCutArraytmp->At(fiCut))->FindLargestCellInCluster(clus,fInputEvent);

      Int_t labelTrackMatch = -1;
      if(!((AliCaloPhotonCuts*)fClusterCutArraytmp->At(fiCut))->GetHighestPtMatchedTrackToCluster(fInputEvent,clus,labelTrackMatch)){
        delete clus;
        continue;
      }
      ...
      ((AliCaloTrackMatcher*)((AliCaloPhotonCuts*)fClusterCutArraytmp->At(fiCut))->GetCaloTrackMatcherInstance())->GetTrackClusterMatchingResidual(currTrack->GetID(),clus->GetID(),tempEta,tempPhi);
      fDeltaEta = tempEta;
      fDeltaPhi = tempPhi;
      ...
      fClusterIsoSumTrackEt = ((AliCaloTrackMatcher*)((AliCaloPhotonCuts*)fClusterCutArraytmp->At(fiCut))->GetCaloTrackMatcherInstance())->SumTrackEtAroundCluster(fInputEvent,clus->GetID(),0.2);
      ...
      if(fIsMC > 0) fClusterClassification = ((AliCaloPhotonCuts*)fClusterCutArraytmp->At(fiCut))->ClassifyClusterForTMEffi(clus,fInputEvent,fMCEvent,isESD);
...
//________________________________________________________________________
void AliAnalysisTaskGammaCaloMix::ProcessConversionCandidates(){
...
//________________________________________________________________________
void AliAnalysisTaskGammaCaloMix::ProcessJets()
{
...
//________________________________________________________________________
void AliAnalysisTaskGammaCaloMix::ProcessTrueClusterCandidates(AliAODConversionPhoton *TruePhotonCandidate, AliVCluster* clus)
{
...
//________________________________________________________________________
void AliAnalysisTaskGammaCaloMix::ProcessTrueClusterCandidatesAOD(AliAODConversionPhoton *TruePhotonCandidate, AliVCluster* clus)
{
  const AliVVertex* primVtxMC   = fMCEvent->GetPrimaryVertex();
  Double_t mcProdVtxX   = primVtxMC->GetX();
  Double_t mcProdVtxY   = primVtxMC->GetY();
...
//________________________________________________________________________
void AliAnalysisTaskGammaCaloMix::ProcessAODMCParticles()
{
  const AliVVertex* primVtxMC   = fMCEvent->GetPrimaryVertex();
  Double_t mcProdVtxX   = primVtxMC->GetX();
  Double_t mcProdVtxY   = primVtxMC->GetY();
  ...
  for(Long_t i = 0; i < AODMCTrackArray->GetEntriesFast(); i++) {
    ...
    if (isPrimary){
      ...
      if(!fDoLightOutput){
        if(((AliCaloPhotonCuts*)fClusterCutArray->At(fiCut))->ClusterIsSelectedAODMC(particle,AODMCTrackArray) || ((AliCaloPhotonCuts*)fClusterCutArray2->At(fiCut))->ClusterIsSelectedAODMC(particle,AODMCTrackArray)){
      ...
      if(fDoMesonAnalysis){
        ...
        if(((AliConversionMesonCuts*)fMesonCutArray->At(fiCut))
          ...
          if( (((AliCaloPhotonCuts*)fClusterCutArray->At(fiCut))->ClusterIsSelectedAODMC(daughter0,AODMCTrackArray) &&
              ...
              (((AliCaloPhotonCuts*)fClusterCutArray2->At(fiCut))->ClusterIsSelectedAODMC(daughter0,AODMCTrackArray) &&
              ((AliCaloPhotonCuts*)fClusterCutArray2->At(fiCut))->ClusterIsSelectedAODMC(daughter1,AODMCTrackArray)) ){
...
//________________________________________________________________________
void AliAnalysisTaskGammaCaloMix::ProcessMCParticles()
{
  const AliVVertex* primVtxMC   = fMCEvent->GetPrimaryVertex();
  Double_t mcProdVtxX   = primVtxMC->GetX();
  Double_t mcProdVtxY   = primVtxMC->GetY();
  ...
  for(Long_t i = 0; i < fMCEvent->GetNumberOfTracks(); i++) {
    if (((AliConvEventCuts*)fEventCutArray->At(fiCut))->IsConversionPrimaryESD( fMCEvent, i, mcProdVtxX, mcProdVtxY, mcProdVtxZ)){
      ...
      if(!fDoLightOutput){
        if(((AliCaloPhotonCuts*)fClusterCutArray->At(fiCut))->ClusterIsSelectedMC(particle,fMCEvent) || ((AliCaloPhotonCuts*)fClusterCutArray2->At(fiCut))->ClusterIsSelectedMC(particle,fMCEvent)){
          fHistoMCAllGammaPt[fiCut]->Fill(particle->Pt(), tempParticleWeight); // All MC Gamma
          if(particle->GetMother() >-1){ // Meson Decay Gamma
      ...
      if(fDoMesonAnalysis){
        ...
        if(((AliConversionMesonCuts*)fMesonCutArray->At(fiCut))
          ...
          if( kDaughter0IsPrim && kDaughter1IsPrim &&
              ((((AliCaloPhotonCuts*)fClusterCutArray->At(fiCut))->ClusterIsSelectedMC(daughter0,fMCEvent) && ((AliCaloPhotonCuts*)fClusterCutArray->At(fiCut))->ClusterIsSelectedMC(daughter1,fMCEvent)) ||
              (((AliCaloPhotonCuts*)fClusterCutArray2->At(fiCut))->ClusterIsSelectedMC(daughter0,fMCEvent) && ((AliCaloPhotonCuts*)fClusterCutArray2->At(fiCut))->ClusterIsSelectedMC(daughter1,fMCEvent))) ){
            if(particle->PdgCode() == 111){
              if(!fDoJetAnalysis || (fDoJetAnalysis && !fDoLightOutput)) fHistoMCPi0InAccPt[fiCut]->Fill(particle->Pt(),weighted* tempParticleWeight); // MC Pi0 with gamma in acc
              if(fIsMC > 1) fHistoMCPi0WOEvtWeightInAccPt[fiCut]->Fill(particle->Pt()); // MC Pi0 with gamma in acc
              if(fDoJetAnalysis){
    ...
    // fill secondary histograms
      ...
      if(fDoMesonAnalysis){
        if(((AliConversionMesonCuts*)fMesonCutArray->At(fiCut))->MesonIsSelectedMC(particle,fMCEvent,((AliConvEventCuts*)fEventCutArray->At(fiCut))->GetEtaShift())){
          ...
          if(   (((AliCaloPhotonCuts*)fClusterCutArray->At(fiCut))->ClusterIsSelectedMC(daughter0,fMCEvent) && ((AliCaloPhotonCuts*)fClusterCutArray->At(fiCut))->ClusterIsSelectedMC(daughter1,fMCEvent)) ||
                (((AliCaloPhotonCuts*)fClusterCutArray2->At(fiCut))->ClusterIsSelectedMC(daughter0,fMCEvent) && ((AliCaloPhotonCuts*)fClusterCutArray2->At(fiCut))->ClusterIsSelectedMC(daughter1,fMCEvent))
            ){
            if(particle->PdgCode() == 111){
              Int_t source = GetSourceClassification(111,pdgCode);
...
//________________________________________________________________________
void AliAnalysisTaskGammaCaloMix::CalculatePi0Candidates(){

  // Conversion Gammas
  if(fClusterCandidates->GetEntries()>0 && fClusterCandidates2->GetEntries()>0){
    ...
    for(Int_t firstGammaIndex=0;firstGammaIndex<fClusterCandidates->GetEntries();firstGammaIndex++){
      ...
      for(Int_t secondGammaIndex=0;secondGammaIndex<fClusterCandidates2->GetEntries();secondGammaIndex++){
        AliAODConversionPhoton *gamma1=dynamic_cast<AliAODConversionPhoton*>(fClusterCandidates2->At(secondGammaIndex));
        ...
        if(((AliCaloPhotonCuts*)fClusterCutArray->At(fiCut))->GetDoSecondaryTrackMatching() || ((AliCaloPhotonCuts*)fClusterCutArray2->At(fiCut))->GetDoSecondaryTrackMatching()){
          ...
          for(Int_t ConversionIndex=0;ConversionIndex<fGammaCandidates->GetEntries();ConversionIndex++){
            ...
            Bool_t matchedGamma0 =  (((AliCaloPhotonCuts*)fClusterCutArray->At(fiCut))->MatchConvPhotonToCluster(gammaConversion, Cluster0, fInputEvent, tempPi0CandWeight)) || (((AliCaloPhotonCuts*)fClusterCutArray2->At(fiCut))->MatchConvPhotonToCluster(gammaConversion, Cluster0, fInputEvent, tempPi0CandWeight));
            Bool_t matchedGamma1 =  (((AliCaloPhotonCuts*)fClusterCutArray->At(fiCut))->MatchConvPhotonToCluster(gammaConversion, Cluster1, fInputEvent, tempPi0CandWeight)) || (((AliCaloPhotonCuts*)fClusterCutArray2->At(fiCut))->MatchConvPhotonToCluster(gammaConversion, Cluster1, fInputEvent, tempPi0CandWeight));
          ...
          if(fDoTHnSparse && ((AliConversionMesonCuts*)fMesonCutArray->At(fiCut))->DoBGCalculation()){
            ...
            if(((AliConversionMesonCuts*)fMesonCutArray->At(fiCut))->BackgroundHandlerType() == 0){
              ...
              if(((AliConversionMesonCuts*)fMesonCutArray->At(fiCut))->UseTrackMultiplicity()){
                ...
                mbin = fBGHandler[fiCut]->GetMultiplicityBinIndex(fClusterCandidates->GetEntries()+fClusterCandidates2->GetEntries());
              }
            }
...
void AliAnalysisTaskGammaCaloMix::ProcessTrueMesonCandidates(AliAODConversionMother *Pi0Candidate, AliAODConversionPhoton *TrueGammaCandidate0, AliAODConversionPhoton *TrueGammaCandidate1)
{
  // Process True Mesons
  const AliVVertex* primVtxMC   = fMCEvent->GetPrimaryVertex();
  Double_t mcProdVtxX   = primVtxMC->GetX();
    ...
    if(!isPrimary){ // Secondary Meson
      ...
      if (isTruePi0){
        ...
        if(fDoJetAnalysis){
          ...
          AliMCParticle * gamma0 = (AliMCParticle*)fMCEvent->GetTrack(MCLabelGamma0);
          AliMCParticle * gamma1 = (AliMCParticle*)fMCEvent->GetTrack(MCLabelGamma1);
...
//______________________________________________________________________
void AliAnalysisTaskGammaCaloMix::ProcessTrueMesonCandidatesAOD(AliAODConversionMother *Pi0Candidate, AliAODConversionPhoton *TrueGammaCandidate0, AliAODConversionPhoton *TrueGammaCandidate1)
{
  const AliVVertex* primVtxMC   = fMCEvent->GetPrimaryVertex();
  Double_t mcProdVtxX   = primVtxMC->GetX();
  Double_t mcProdVtxY   = primVtxMC->GetY();
    ...
    if(!isPrimary){ // Secondary Meson
      ...
      if (isTruePi0){
        ...
        if(fDoJetAnalysis){
          Int_t MCLabelGamma0 = TrueGammaCandidate0->GetCaloPhotonMCLabel(0);
          Int_t MCLabelGamma1 = TrueGammaCandidate1->GetCaloPhotonMCLabel(0);
          AliAODMCParticle* gamma0 = static_cast<AliAODMCParticle*>(AODMCTrackArray->At(MCLabelGamma0));
          AliAODMCParticle* gamma1 = static_cast<AliAODMCParticle*>(AODMCTrackArray->At(MCLabelGamma1));
          Double_t TruePtPi0 = TMath::Sqrt(pow((gamma0->Px() + gamma1->Px()),2)+pow((gamma0->Py() + gamma1->Py()),2));
          if(fConvJetReader->GetTrueNJets()>0){
            if(!fDoLightOutput) fHistoTruePrimaryPi0JetInvMassPt[fiCut]->Fill(Pi0Candidate->M(),Pi0Candidate->Pt(),weighted* tempTruePi0CandWeight);
            fTrueVectorJetEta = fConvJetReader->GetTrueVectorJetEta();
      ...
      if (fDoMesonQA > 0 && fDoMesonQA < 3 && fIsMC<2){
        if(isTruePi0){ // Only primary pi0 for resolution
          fHistoTruePrimaryPi0MCPtResolPt[fiCut]->Fill(static_cast<AliAODMCParticle*>(AODMCTrackArray->At(gamma1MotherLabel))->Pt(),                             (Pi0Candidate->Pt()-static_cast<AliAODMCParticle*>(AODMCTrackArray->At(gamma1MotherLabel))->Pt())/static_cast<AliAODMCParticle*>(AODMCTrackArray->At(gamma1MotherLabel))->Pt(),weighted* tempTruePi0CandWeight);

        }
        if (isTrueEta && !fDoPi0Only){ // Only primary eta for resolution
          fHistoTruePrimaryEtaMCPtResolPt[fiCut]->Fill(static_cast<AliAODMCParticle*>(AODMCTrackArray->At(gamma1MotherLabel))->Pt(),                             (Pi0Candidate->Pt()-static_cast<AliAODMCParticle*>(AODMCTrackArray->At(gamma1MotherLabel))->Pt())/static_cast<AliAODMCParticle*>(AODMCTrackArray->At(gamma1MotherLabel))->Pt(),weighted* tempTruePi0CandWeight);
        }
      }
    }
  } else if(!isTruePi0 && !isTrueEta) { // Background
...
//________________________________________________________________________
void AliAnalysisTaskGammaCaloMix::ProcessAODSphericityParticles()
{
  TClonesArray *AODMCTrackArray = dynamic_cast<TClonesArray*>(fInputEvent->FindListObject(AliAODMCParticle::StdBranchName()));
  if (AODMCTrackArray == NULL) return;
  for(Long_t i = 0; i < AODMCTrackArray->GetEntriesFast(); i++) {
...
//________________________________________________________________________
void AliAnalysisTaskGammaCaloMix::CalculateBackground(){
...
//________________________________________________________________________
void AliAnalysisTaskGammaCaloMix::RotateParticle(AliAODConversionPhoton *gamma){
...
//________________________________________________________________________
void AliAnalysisTaskGammaCaloMix::UpdateEventByEventData(){
  //see header file for documentation
  if(fDoJetAnalysis && fConvJetReader->GetNJets() == 0) return;
  if(fClusterCandidates2->GetEntries() >0 ){
    if( ((AliConversionMesonCuts*)fMesonCutArray->At(fiCut))->DoJetMixing() ){
        if(fJetNearEMCal){
          fVectorJetEta = fConvJetReader->GetVectorJetEta();
          fVectorJetPhi = fConvJetReader->GetVectorJetPhi();
      ...
      fBGHandler[fiCut]->AddEvent(fClusterCandidates2,fInputEvent->GetPrimaryVertex()->GetX(),fInputEvent->GetPrimaryVertex()->GetY(),fInputEvent->GetPrimaryVertex()->GetZ(),fV0Reader->GetNumberOfPrimaryTracks(),fEventPlaneAngle);
    } else { // means we use #V0s for multiplicity
      fBGHandler[fiCut]->AddEvent(fClusterCandidates2,fInputEvent->GetPrimaryVertex()->GetX(),fInputEvent->GetPrimaryVertex()->GetY(),fInputEvent->GetPrimaryVertex()->GetZ(),fClusterCandidates->GetEntries()+fClusterCandidates2->GetEntries(),fEventPlaneAngle);
    }
  }
}
...
//________________________________________________________________________
void AliAnalysisTaskGammaCaloMix::FillPhotonBackgroundHist(AliAODConversionPhoton *TruePhotonCandidate, Int_t pdgCode)
{
...
//________________________________________________________________________
void AliAnalysisTaskGammaCaloMix::FillPhotonPlusConversionBackgroundHist(AliAODConversionPhoton *TruePhotonCandidate, Int_t pdgCode)
{
  // Bck = 0 e+-, 1 pi+-, 2 p+-, 3 K+-, 4 n, 5 K0s, 6 Lambda, 7 mu+-, 8 K0l, 9 rest
  Double_t tempParticleWeight       = fWeightJetJetMC;
...
//________________________________________________________________________
void AliAnalysisTaskGammaCaloMix::FillPhotonBackgroundM02Hist(AliAODConversionPhoton *TruePhotonCandidate, AliVCluster* clus, Int_t pdgCode)
{
...
//________________________________________________________________________
void AliAnalysisTaskGammaCaloMix::FillPhotonPlusConversionBackgroundM02Hist(AliAODConversionPhoton *TruePhotonCandidate, AliVCluster* clus, Int_t pdgCode)
{
  // Bck = e+-, pi+-, n, K+-, K0l, rest
  Double_t tempParticleWeight       = fWeightJetJetMC;
  if(!fDoLightOutput  && fDoClusterQA > 1){
...
void AliAnalysisTaskGammaCaloMix::SetLogBinningXTH2(TH2* histoRebin){
...
//_________________________________________________________________________________
Bool_t AliAnalysisTaskGammaCaloMix::CheckVectorForDoubleCount(vector<Int_t> &vec, Int_t tobechecked)
{
  if(tobechecked > -1)
  {
...
//________________________________________________________________________
void AliAnalysisTaskGammaCaloMix::Terminate(const Option_t *)
{
...
//________________________________________________________________________
Int_t AliAnalysisTaskGammaCaloMix::GetSourceClassification(Int_t daughter, Int_t pdgCode){
...
//_________________________________________________________________________________
void AliAnalysisTaskGammaCaloMix::FillMultipleCountMap(map<Int_t,Int_t> &ma, Int_t tobechecked){
...
//_________________________________________________________________________________
void AliAnalysisTaskGammaCaloMix::FillMultipleCountHistoAndClear(map<Int_t,Int_t> &ma, TH1F* hist){
...
//_________________________________________________________________________________
void AliAnalysisTaskGammaCaloMix::DebugMethodPrint1(AliAODConversionMother *pi0cand, AliAODConversionPhoton *gamma0, AliAODConversionPhoton *gamma1){
  if(pi0cand->GetOpeningAngle() < 0.02) DebugMethod(pi0cand,gamma0,gamma1);
  return;
}

//_________________________________________________________________________________
void AliAnalysisTaskGammaCaloMix::DebugMethod(AliAODConversionMother *pi0cand, AliAODConversionPhoton *gamma0, AliAODConversionPhoton *gamma1){
  ...
  for(Int_t iCell=0;iCell<nCellCluster;iCell++){
    Int_t nSupMod, nModule, nIphi, nIeta, nphi, neta;
    ((AliCaloPhotonCuts*)fClusterCutArray->At(fiCut))->GetGeomEMCAL()->GetCellIndex(
          fInputEvent->GetCaloCluster(gamma0->GetCaloClusterRef())->GetCellAbsId(iCell),         nSupMod,         nModule,         nIphi,         nIeta);
    ((AliCaloPhotonCuts*)fClusterCutArray->At(fiCut))->GetGeomEMCAL()->GetCellPhiEtaIndexInSModule(
          nSupMod,         nModule,         nIphi,         nIeta,         nphi,         neta);
  ...
  for(Int_t iCell=0;iCell<nCellCluster;iCell++){
    ...
    ((AliCaloPhotonCuts*)fClusterCutArray->At(fiCut))->GetGeomEMCAL()->GetCellIndex(
          fInputEvent->GetCaloCluster(gamma1->GetCaloClusterRef())->GetCellAbsId(iCell),         nSupMod,         nModule,         nIphi,         nIeta);
    Int_t nphi, neta;
    ((AliCaloPhotonCuts*)fClusterCutArray->At(fiCut))->GetGeomEMCAL()->GetCellPhiEtaIndexInSModule(
          nSupMod,         nModule,         nIphi,         nIeta,         nphi,         neta);
...
//_________________________________________________________________________________
void AliAnalysisTaskGammaCaloMix::EventDebugMethod(){
  ...
  for(Long_t i = 0; i < nclus; i++){
    ...
    for(Int_t iCell=0;iCell<nCellCluster;iCell++){
      Int_t nSupMod, nModule, nIphi, nIeta;
      ((AliCaloPhotonCuts*)fClusterCutArray->At(fiCut))->GetGeomEMCAL()->GetCellIndex(
            clus->GetCellAbsId(iCell),           nSupMod,           nModule,           nIphi,           nIeta);
      Int_t nphi, neta;
      ((AliCaloPhotonCuts*)fClusterCutArray->At(fiCut))->GetGeomEMCAL()->GetCellPhiEtaIndexInSModule(
            nSupMod,           nModule,           nIphi,           nIeta,           nphi,           neta);
