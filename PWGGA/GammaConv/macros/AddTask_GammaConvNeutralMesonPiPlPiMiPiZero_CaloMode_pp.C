...
void AddTask_GammaConvNeutralMesonPiPlPiMiPiZero_CaloMode_pp(    
  ...
  if( trainConfig == 1 ) {
    ...
    //cuts.AddCut("00000113","1111113047032230000","30a330706","0103503900000000","0153503000000000"); // all of the above
      ...
      cuts.AddCut("00000113","1111113047032230000","302040708","0103503900000000","0a53503000000000"); // likesign mixing + charged pion > 400 MeV
//      cuts.AddCut("00000113","1111113047032230000","302010708","0103503900000000","0b53503000000000"); // pi0 sideband left 0.180-0.220
    ...
    cuts.AddCut("00000113","2444400043013300000","302040708","0103503200000000","0153503000000000"); // normal event mixing + pt charged pi > 400 MeV
...
//    cuts.AddCut("00000113","2444400043013300000","302010708","0103503200000000","0b53503000000000"); // pi0 sideband mixing right side (0.180-0.220)
  ...
  //8 TeV
   ...
   // 13 TeV
      ...
      // closing charged pion cuts, minimum TPC cluster = 80, TPC dEdx pi = \pm 3 sigma, pi+pi- mass cut of 0.85, min pt charged pi = 100 MeV
      // closing neural pion cuts, 0.110 < M_gamma,gamma < 0.155
      cuts.AddCut("00010113","1111113047032230000","302010708","0103503900000000","0153503000000000"); // normal event mixing; Triggers: V0AND
      cuts.AddCut("00052113","1111113047032230000","302010708","0103503900000000","0153503000000000"); // normal event mixing; Triggers: CEMC7: V0AND and EMCAL fired
      cuts.AddCut("00083113","1111113047032230000","302010708","0103503900000000","0153503000000000"); // normal event mixing; Triggers: 7EG1 - CINT7 EG1
      cuts.AddCut("00085113","1111113047032230000","302010708","0103503900000000","0153503000000000"); // normal event mixing; Triggers: 7EG2 - CINT7 EG2
   // 13 TeV PHOS
