void AddTask_GammaConvDalitzV1_pPb(    	Int_t trainConfig = 1,
	...
	if( trainConfig == 1 ) {  // No eta shift |Y| < 0.8
		...
		eventCutArray[2] = "80000113"; photonCutArray[2] = "00200009360300007200004000"; ElecCutarray[2] = "20405400233202223710"; MesonCutarray[2] = "0263103500900000"; //standard cut Pi0 pPb 00-100  //Tracks 2011 + kAny   + new psiPair Cut + double counting rejection	
		eventCutArray[3] = "80000113"; photonCutArray[3] = "00200009360300007200004000"; ElecCutarray[3] = "20405400233202223710"; MesonCutarray[3] = "0263103500900000"; //standard cut Pi0 pPb 00-100  //Tracks 2011 + kAny   + new psiPair Cut + double counting rejection	
