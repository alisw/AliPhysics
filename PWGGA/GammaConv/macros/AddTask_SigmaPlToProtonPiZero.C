 ...
 **************************************************************************/
void AddTask_SigmaPlToProtonPiZero(
  ...
  )
{
  ...
  TString addTaskName                 = "AddTask_SigmaPlToProtonPiZero";
  ...
  //================================================
  AliAnalysisTaskSigmaPlToProtonPiZero* task = NULL;
  task = new AliAnalysisTaskSigmaPlToProtonPiZero(addTaskName.Data());
