...
void AddTask_GammaConvFlow_PbPb2(
  ...
  } else if (trainConfig == 21) { //15o
    cuts.AddCut("13500013", "00200009297002008250400000");
    cuts.AddCut("13585013", "00200009297002008250400000");
    cuts.AddCut("13583013", "00200009297002008250400000");
