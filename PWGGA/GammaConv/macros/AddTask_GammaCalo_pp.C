...
// ------------------------------
    ...
    cuts.AddCutCalo("r0a15113","24466190sa01cc00000","0163103100000010");
...
///////////////////////////////////  50-100%
  } else if (trainConfig == 4300){ // track matching variation std a == pt dependent
  ...
  } else if (trainConfig == 4301){ // min nCells & M02 variation, std cc
