...
void AddTask_GammaHeavyMeson_CaloMode_pp(
  ...
  // *****************************************************************************************************
    ...
    cuts.AddCutCalo("00010113","411790106f032230000","0r631031000000d0"); // INT7 NL 12 + TB
  } else if (trainConfig == 2021){ // EMCAL+DCAL clusters standard cuts, EG2, NL , std TM
    cuts.AddCutCalo("0008e113","411790106f032230000","0r631031000000d0"); // EG2  NL 12 + TB
  } else if (trainConfig == 2022){ // EMCAL+DCAL clusters standard cuts, EG1, NL , std TM
    cuts.AddCutCalo("0008d113","411790106f032230000","0r631031000000d0"); // EG1  NL 12 + TB
    ...
    cuts.AddCutCalo("00010113","411791206f032230000","01631031000000h0"); // INT7 Op. Ang. var pT dep.
    ...
    cuts.AddCutCalo("0008e113","411791206f032230000","01631031000000h0"); // EG2 Op. Ang. var pT dep.
    ...
    cuts.AddCutCalo("0008d113","411791206f032230000","01631031000000h0"); // EG1 Op. Ang. var pT dep.
    ...
    cuts.AddCutCalo("m0110113","411791206f032230000","01631031000000d0"); // INT7, NL12, mult. dep 0.0% - 1.0%
