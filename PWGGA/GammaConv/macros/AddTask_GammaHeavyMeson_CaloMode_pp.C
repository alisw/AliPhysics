...
void AddTask_GammaHeavyMeson_CaloMode_pp(   Int_t     selectedMeson                 = 0,                    // select the corresponding meson: 0 pi0, 1 eta, 2 eta'
  ...
  // *********************************************************************************************************
    ...
    cuts.AddCut("00052013","1111100067032220000","01631031000000d0");
    cuts.AddCut("00085013","1111100067032220000","01631031000000d0");
    cuts.AddCut("00083013","1111100067032220000","01631031000000d0");
    ...
    cuts.AddCut("00052013","1111111067032220000","01631031000000d0");
    cuts.AddCut("00085013","1111111067032220000","01631031000000d0");
    cuts.AddCut("00083013","1111111067032220000","01631031000000d0");

    // *********************************************************************************************************
    // 5 TeV  pp Run2 - DMC configurations
    // *********************************************************************************************************
  } else if (trainConfig == 350){ // DCAL clusters // -50ns, 30ns timing cut // no NL
    cuts.AddCut("00010113","3885500067032220000","01631031000000d0");
    cuts.AddCut("00055113","3885500067032220000","01631031000000d0");
    cuts.AddCut("00089113","3885500067032220000","01631031000000d0");
    cuts.AddCut("0008b113","3885500067032220000","01631031000000d0");
  ...
  // *********************************************************************************************************
    ...
    cuts.AddCut("00010113","1111111067032220000","01631031000000d0");
    cuts.AddCut("00085113","1111111067032220000","01631031000000d0");
    cuts.AddCut("00083113","1111111067032220000","01631031000000d0");
