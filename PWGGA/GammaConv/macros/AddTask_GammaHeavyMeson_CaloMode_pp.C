...
void AddTask_GammaHeavyMeson_CaloMode_pp(
  ...
  // *****************************************************************************************************
    ...
    cuts.AddCutCalo("00010113","41179000a7032230000","01631030000000d0"); // no NL INT7
    cuts.AddCutCalo("00052113","41179000a7032230000","01631030000000d0"); // no NL EMC7
    cuts.AddCutCalo("00085113","41179000a7032230000","01631030000000d0"); // no NL EG2
    cuts.AddCutCalo("00083113","41179000a7032230000","01631030000000d0"); // no NL EG1
    cuts.AddCutCalo("00055113","41179000a7032230000","01631030000000d0"); // no NL DMC7
    cuts.AddCutCalo("00089113","41179000a7032230000","01631030000000d0"); // no NL DG2
    cuts.AddCutCalo("0008b113","41179000a7032230000","01631030000000d0"); // no NL DG1
