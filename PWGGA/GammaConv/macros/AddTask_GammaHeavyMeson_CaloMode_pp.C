...
void AddTask_GammaHeavyMeson_CaloMode_pp(
  ...
  // *****************************************************************************************************
    ...
    cuts.AddCutCalo("00010113","4117901067032230000","01631031000000d0"); // INT7 NL21
  } else if (trainConfig == 2021){ // EMCAL+DCAL clusters standard cuts, EG2, NL , std TM
    cuts.AddCutCalo("0008e113","4117901067032230000","01631031000000d0"); // EG2  NL21
  } else if (trainConfig == 2022){ // EMCAL+DCAL clusters standard cuts, EG1, NL , std TM
    cuts.AddCutCalo("0008d113","4117901067032230000","01631031000000d0"); // EG1  NL21
    ...
    cuts.AddCutCalo("00010113","4117921067032230000","01631031000000h0"); // INT7 Op. Ang. var
    ...
    cuts.AddCutCalo("0008e113","4117921067032230000","01631031000000h0"); // EG2 Op. Ang. var
    ...
    cuts.AddCutCalo("0008d113","4117921067032230000","01631031000000h0"); // EG1 Op. Ang. var
