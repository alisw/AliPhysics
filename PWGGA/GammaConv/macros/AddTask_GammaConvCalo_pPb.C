...
void AddTask_GammaConvCalo_pPb(
 ...
 // Material Budget Weights file for Run 2
  ...
  // configurations for pPb 5 and 8 TeV Run2 with EMCAL + DCAL
    ...
    cuts.AddCutPCMCalo("80010123","00200009327000008250400000","411790105f032230000","0h63103100000010"); // INT7
    cuts.AddCutPCMCalo("8008e123","00200009327000008250400000","411790105f032230000","0h63103100000010"); // EG2+DG2
    cuts.AddCutPCMCalo("8008d123","00200009327000008250400000","411790105f032230000","0h63103100000010"); // EG1+DG1
  } else if (trainConfig == 2019){  // EMCal+DCAL clusters standard cuts, triggers, Nico TB NL + FineTuning 57, +-50ns timing (5)
    cuts.AddCutPCMCalo("80010123","00200009327000008250400000","411790105f022230000","0h63103100000010"); // INT7
    cuts.AddCutPCMCalo("8008e123","00200009327000008250400000","411790105f022230000","0h63103100000010"); // EG2+DG2
    cuts.AddCutPCMCalo("8008d123","00200009327000008250400000","411790105f022230000","0h63103100000010"); // EG1+DG1

  } else if (trainConfig == 2020){  // EMCal+DCAL clusters standard cuts, triggers, Nico TB NL + FineTuning 57, +-50ns timing (5)
    cuts.AddCutPCMCalo("80010123","00200009f9730000dge0400000","411794705f032230000","0h63103100000010"); // INT7
    cuts.AddCutPCMCalo("8008e123","00200009f9730000dge0400000","411794705f032230000","0h63103100000010"); // EG2+DG2
    cuts.AddCutPCMCalo("8008d123","00200009f9730000dge0400000","411794705f032230000","0h63103100000010"); // EG1+DG1
  } else if (trainConfig == 2021){  // EMCal+DCAL clusters standard cuts, triggers, Nico TB NL + FineTuning 57, +-50ns timing (5)
    cuts.AddCutPCMCalo("80010123","00200009f9730000dge0400000","411794805f032230000","0h63103100000010"); // INT7
    cuts.AddCutPCMCalo("8008e123","00200009f9730000dge0400000","411794805f032230000","0h63103100000010"); // EG2+DG2
    cuts.AddCutPCMCalo("8008d123","00200009f9730000dge0400000","411794805f032230000","0h63103100000010"); // EG1+DG1
    ...
    cuts.AddCutPCMCalo("80010123","00200009f9730000dge0400000","411795805f032230000","0h63103100000010"); // INT7
    cuts.AddCutPCMCalo("8008e123","00200009f9730000dge0400000","411795805f032230000","0h63103100000010"); // EG2+DG2
    cuts.AddCutPCMCalo("8008d123","00200009f9730000dge0400000","411795805f032230000","0h63103100000010"); // EG1+DG1
