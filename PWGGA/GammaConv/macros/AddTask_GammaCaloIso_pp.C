...
//main function
//***************************************************************************************
void AddTask_GammaCaloIso_pp(  Int_t     trainConfig                   = 1,                      // change different set of cuts
                                Int_t     isMC                          = 0,                      // run MC
  ...
  if(rAddConfigArr->GetEntries()<1){cout << "ERROR: AddTask_GammaCaloIso_pp during parsing of additionalTrainConfig String '" << additionalTrainConfig.Data() << "'" << endl; return;}
  ...
  for(Int_t i = 0; i<rAddConfigArr->GetEntries() ; i++){
    if(i==0) rAdditionalTrainConfig = (TObjString*)rAddConfigArr->At(i);
      ...
      if(tempStr.CompareTo("INVMASSCLUSTree") == 0){
        cout << "INFO: AddTask_GammaCaloIso_pp activating 'INVMASSCLUSTree'" << endl;
        ...
        cout << "INFO: AddTask_GammaCaloIso_pp will use custom branch from Correction Framework!" << endl;
  ...
  //PhotonIsolation Variations, LHC17i3 MC without non linearity
    ...
    cuts.AddCut("00010113","00200009327000008250400000","1221100060032230000","0163103100000010"); //without TrackMatching
    cuts.AddCut("00010113","00200009327000008250400000","b221100060032230000","0163103100000010"); //without TrackMatching
    cuts.AddCut("00010113","00200009327000008250400000","c221100060032230000","0163103100000010"); //without TrackMatching
    cuts.AddCut("00010113","00200009327000008250400000","d221100060032230000","0163103100000010"); //without TrackMatching
    cuts.AddCut("00010113","00200009327000008250400000","e221100060032230000","0163103100000010"); //without TrackMatching

  } else if (trainConfig == 34){ // R=0.4
    cuts.AddCut("00010113","00200009327000008250400000","e221100067032230000","0163103100000010"); //with TrackMatching
    cuts.AddCut("00010113","00200009327000008250400000","d221100067032230000","0163103100000010"); //with TrackMatching

    } else if (trainConfig == 35){ // R=0.2
    cuts.AddCut("00010113","00200009327000008250400000","c221100067032230000","0163103100000010"); //with TrackMatching

  } else if (trainConfig == 36){ // R=0.1
    cuts.AddCut("00010113","00200009327000008250400000","b221100067032230000","0163103100000010"); //with TrackMatching

  } else if (trainConfig == 37){ // without Isolation
    cuts.AddCut("00010113","00200009327000008250400000","1221100067032230000","0163103100000010"); //with TrackMatching,
