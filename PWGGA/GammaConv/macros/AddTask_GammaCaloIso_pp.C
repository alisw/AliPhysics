...
void AddTask_GammaCaloIso_pp(
  ...
  cuts.AddCutCalo("00083113","1111100060032230000","0163103100000050"); //with TrackMatching
  cuts.AddCutCalo("00083113","11111000600322l0000","0163103100000050"); // EMCEG1, with TrackMatcher on
  cuts.AddCutCalo("00083113","11111000670322l0000","0163103100000050"); // EMCEG1, with TrackMatcher off
  cuts.AddCutCalo("00083113","1111100067032230000","0163103100000050"); // EMCEG1, with shape cut changed slightly
  cuts.AddCutCalo("00083113","e1111000600322l0000","0163103100000050"); // EMCEG1, with TrackMatcher off
