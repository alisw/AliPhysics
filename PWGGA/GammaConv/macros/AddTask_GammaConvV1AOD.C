...
//   TString Pattern="*/AliESDs.root";
   TString Pattern="AOD/*/AliAOD.root";
   TString Prefix ="";
  ...
  // run has no AODs's: 138624 (70440 events), 
  //Int_t  run_numbers[100] = {138638, 138652, 138653, 138662, 138666, 138730, 138732, 138837, 138870, 138871, 138872, 139028, 139029, 139036, 139037, 139038, 139104, 139105, 139107, 139173, 139308, 139309, 139310, 139311, 139314, 139328, 139329, 139360, 139437, 139438, 139439, 139465, 139503, 139504, 139505, 139507, 139510};
   ...
   //Int_t run_numbers[10] = {138638, 138652, 138653, 138662, 138666, 138730, 138732, 138837, 138870};
   ...
   handler = new AliAODInputHandler(); mgr->SetInputEventHandler((AliAODInputHandler*)handler);
