...
void AddTask_GammaConvNeutralMesonPiPlPiMiPiZero_MixedMode_pp(    
  ...
  if( trainConfig == 1 ) {
    ...
    cuts.AddCut("00000113","00200009327000008250400000","1111113047032230000","302010706","0103503600000000","0153503000000000"); // only cuts above
    cuts.AddCut("00000113","00200009327000008250400000","1111113047032230000","302010706","0103503500000000","0153503000000000"); // 0.120 < M_gamma,gamma < 0.15
    cuts.AddCut("00000113","00200009327000008250400000","1111113047032230000","302010706","0103503400000000","0153503000000000"); // 0.100 < M_gamma,gamma < 0.15
    ...
    // maxChi2 per cluster TPC <4, require TPC refit, DCA XY pT dependend 0.0182+0.0350/pt^1.01, DCA_Z = 3.0
    cuts.AddCut("00000113","00200009327000008250400000","2444400043013300000","302010706","0103503600000000","0153503000000000"); // only cuts above
    cuts.AddCut("00000113","00200009327000008250400000","2444400043013300000","302010706","0103503500000000","0153503000000000"); // 0.110 < M_gamma,gamma < 0.150
    cuts.AddCut("00000113","00200009327000008250400000","2444400043013300000","302010706","0103503400000000","0153503000000000"); // 0.100 < M_gamma,gamma < 0.150
