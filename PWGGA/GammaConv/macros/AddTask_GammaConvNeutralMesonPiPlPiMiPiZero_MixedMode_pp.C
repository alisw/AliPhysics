...
void AddTask_GammaConvNeutralMesonPiPlPiMiPiZero_MixedMode_pp(    
  ...
  if( trainConfig == 1 ) {
    ...
    // PHOS mode
     ...
     // closing neural pion cuts, 0.120 < M_gamma,gamma < 0.15
     // maxChi2 per cluster TPC <4, require TPC refit, DCA XY pT dependend 0.0182+0.0350/pt^1.01, DCA_Z = 3.0
     cuts.AddCut("00000113","00200009327000008250400000","1111113047032230000","302010702","0103503600000000","0a53503000000000"); // likesign mixing
     cuts.AddCut("00000113","00200009327000008250400000","1111113047032230000","302010702","0103503600000000","0b53503000000000"); // pi0 sideband mixing right (0.180-0.220)
     cuts.AddCut("00000113","00200009327000008250400000","1111113047032230000","302010702","0103503600000000","0c53503000000000"); // pi0 sideband mixing left  (0.01-0.05)
    ...
    // closing neural pion cuts, 0.120 < M_gamma,gamma < 0.150
    // maxChi2 per cluster TPC <4, require TPC refit, DCA XY pT dependend 0.0182+0.0350/pt^1.01, DCA_Z = 3.0
    cuts.AddCut("00000113","00200009327000008250400000","2444400043013300000","302010702","0103503600000000","0a53503000000000"); // likesign event mixing
    cuts.AddCut("00000113","00200009327000008250400000","2444400043013300000","302010702","0103503600000000","0b53503000000000"); // pi0 sideband mixing right (0.180-0.220)
    cuts.AddCut("00000113","00200009327000008250400000","2444400043013300000","302010702","0103503600000000","0c53503000000000"); // pi0 sideband mixing left (0.01-0.05)
