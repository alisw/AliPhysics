...
void AddTask_GammaCalo_pPb(
  ...
  if (trainConfig == 1){ // external NL
    ...
    cuts.AddCutCalo("80010113","411790009fe309v0000","0s631031000000d0"); // 0-100 MB latest 13TeV cuts E/DMC, closed M02(0.7->0.5) cut at high PT
    ...
    cuts.AddCutCalo("80010113","111110009fe309v0000","0s631031000000d0"); // 0-100 MB latest 13TeV cuts EMC, closed M02(0.7->0.5) cut at high PT
    ...
    cuts.AddCutCalo("80010123","411790009fe309v0000","0s631031000000d0"); // 0-100 MB latest 13TeV cuts E/DMC, closed M02(0.7->0.5) cut at high PT
    ...
    cuts.AddCutCalo("80010123","111110009fe309v0000","0s631031000000d0"); // 0-100 MB latest 13TeV cuts EMC, closed M02(0.7->0.5) cut at high PT
    ...
    cuts.AddCutCalo("80052113","111110009fe309v0000","0s631031000000d0"); // 0-100 EMC7 latest 13TeV cuts EMC, closed M02(0.7->0.5) cut at high PT
    ...
    cuts.AddCutCalo("80085113","111110009fe309v0000","0s631031000000d0"); // 0-100 EG2 latest 13TeV cuts EMC, closed M02(0.7->0.5) cut at high PT
    ...
    cuts.AddCutCalo("80083113","111110009fe309v0000","0s631031000000d0"); // 0-100 EG1 latest 13TeV cuts EMC, closed M02(0.7->0.5) cut at high PT
    ...
    cuts.AddCutCalo("80052123","111110009fe309v0000","0s631031000000d0"); // 0-100 EMC7 latest 13TeV cuts EMC, closed M02(0.7->0.5) cut at high PT
  } else if (trainConfig == 7){ // diff MC treatment, external NL
    cuts.AddCutCalo("80085123","111110009fe30220000","0s631031000000d0"); // 0-100 EG2 latest 13TeV cuts EMC
    cuts.AddCutCalo("80085123","111110009fe309v0000","0s631031000000d0"); // 0-100 EG2 latest 13TeV cuts EMC, closed M02(0.7->0.5) cut at high PT
  } else if (trainConfig == 8){ // diff MC treatment, external NL
    cuts.AddCutCalo("80083123","111110009fe30220000","0s631031000000d0"); // 0-100 EG1 latest 13TeV cuts EMC
    cuts.AddCutCalo("80083123","111110009fe309v0000","0s631031000000d0"); // 0-100 EG1 latest 13TeV cuts EMC, closed M02(0.7->0.5) cut at high PT
  ...
  // CONFIGS for sys JJ MC with MB BG + JJ
    ...
    cuts.AddCutCalo("80010123","411793805f032230000","01631031000000d0"); // NL 38
    cuts.AddCutCalo("80010123","411793905f032230000","01631031000000d0"); // NL 39
  } else if (trainConfig == 111) { // CALO variations
    cuts.AddCutCalo("80010123","411793205f03h230000","01631031000000d0"); // NCell cut effi MC (param 1)
    cuts.AddCutCalo("80010123","411793205f03i230000","01631031000000d0"); // NCell cut effi MC (param 2)
    cuts.AddCutCalo("80010123","411793205f03j230000","01631031000000d0"); // NCell cut effi data (param 1)
    cuts.AddCutCalo("80010123","411793205f03k230000","01631031000000d0"); // NCell cut effi data (param 2)    
  } else if (trainConfig == 112) { // CALO variations
    cuts.AddCutCalo("80010123","411793205f032230000","0r631031000000d0"); // 
    cuts.AddCutCalo("80010123","411793205f032230000","0s631031000000d0"); // 
    cuts.AddCutCalo("80010123","411793205f032230000","0t631031000000d0"); // 
  } else if (trainConfig == 113) { // CALO variations
    cuts.AddCutCalo("80010123","411793205f032230000","0u631031000000d0"); // 
  ...
  // CONFIGS for sys JJ MC with MB BG + JJ
  ...
  } else if (trainConfig == 259){ // NL02 for Run2
    cuts.AddCutCalo("80010103","411790205fg32230000","01631031000000d0"); // INT7
    cuts.AddCutCalo("80010103","411790105fg32230000","01631031000000d0"); // INT7
  } else if (trainConfig == 260){ //
    cuts.AddCutCalo("80010103","411790205fg32230000","0r631031000000i0"); // INT7
    cuts.AddCutCalo("80010103","411790105fg32230000","0r631031000000i0"); // INT7
  } else if (trainConfig == 261){ //
    cuts.AddCutCalo("80010103","111110105fg32230000","01631031000000d0"); // INT7
    cuts.AddCutCalo("80010103","111110205fg32230000","01631031000000d0"); // INT7
  } else if (trainConfig == 262){ //
    cuts.AddCutCalo("80010103","111110105fg32230000","0r631031000000i0"); // INT7
    cuts.AddCutCalo("80010103","111110205fg32230000","0r631031000000i0"); // INT7
  } else if (trainConfig == 263){ //
    cuts.AddCutCalo("80085103","111110105fg32230000","01631031000000d0"); // EG2
    cuts.AddCutCalo("80085103","111110205fg32230000","01631031000000d0"); // EG2
    cuts.AddCutCalo("80083103","111110105fg32230000","01631031000000d0"); // EG1
    cuts.AddCutCalo("80083103","111110205fg32230000","01631031000000d0"); // EG1    
  } else if (trainConfig == 264){ //
    cuts.AddCutCalo("80085103","111110105fg32230000","0r631031000000i0"); // EG2
    cuts.AddCutCalo("80085103","111110205fg32230000","0r631031000000i0"); // EG2
    cuts.AddCutCalo("80083103","111110105fg32230000","0r631031000000i0"); // EG1
    cuts.AddCutCalo("80083103","111110205fg32230000","0r631031000000i0"); // EG1
    
  } else if (trainConfig == 270){ // mult EDC
    cuts.AddCutCalo("a0110103","411790105fg32230000","0r631031000000i0"); // INT7
    cuts.AddCutCalo("a1210103","411790105fg32230000","0r631031000000i0"); // INT7
    cuts.AddCutCalo("81210103","411790105fg32230000","0r631031000000i0"); // INT7
    cuts.AddCutCalo("82410103","411790105fg32230000","0r631031000000i0"); // INT7
    cuts.AddCutCalo("84610103","411790105fg32230000","0r631031000000i0"); // INT7
    cuts.AddCutCalo("86810103","411790105fg32230000","0r631031000000i0"); // INT7
    cuts.AddCutCalo("86010103","411790105fg32230000","0r631031000000i0"); // INT7
    cuts.AddCutCalo("88010103","411790105fg32230000","0r631031000000i0"); // INT7
  } else if (trainConfig == 271){ // mult EMC MB
    cuts.AddCutCalo("a0110103","111110105fg32230000","0r631031000000i0"); // INT7
    cuts.AddCutCalo("a1210103","111110105fg32230000","0r631031000000i0"); // INT7
    cuts.AddCutCalo("81210103","111110105fg32230000","0r631031000000i0"); // INT7
    cuts.AddCutCalo("82410103","111110105fg32230000","0r631031000000i0"); // INT7
    cuts.AddCutCalo("84610103","111110105fg32230000","0r631031000000i0"); // INT7
    cuts.AddCutCalo("86810103","111110105fg32230000","0r631031000000i0"); // INT7
    cuts.AddCutCalo("86010103","111110105fg32230000","0r631031000000i0"); // INT7
    cuts.AddCutCalo("88010103","111110105fg32230000","0r631031000000i0"); // INT7
  } else if (trainConfig == 272){ // mult EMC EG2
    cuts.AddCutCalo("a0185103","111110105fg32230000","0r631031000000i0"); // EG2
    cuts.AddCutCalo("a1285103","111110105fg32230000","0r631031000000i0"); // EG2
    cuts.AddCutCalo("81285103","111110105fg32230000","0r631031000000i0"); // EG2
    cuts.AddCutCalo("82485103","111110105fg32230000","0r631031000000i0"); // EG2
    cuts.AddCutCalo("84685103","111110105fg32230000","0r631031000000i0"); // EG2
    cuts.AddCutCalo("86885103","111110105fg32230000","0r631031000000i0"); // EG2
    cuts.AddCutCalo("86085103","111110105fg32230000","0r631031000000i0"); // EG2
    cuts.AddCutCalo("88085103","111110105fg32230000","0r631031000000i0"); // EG2
  } else if (trainConfig == 273){ // mult EMC EG1
    cuts.AddCutCalo("a0183103","111110105fg32230000","0r631031000000i0"); // EG1
    cuts.AddCutCalo("a1283103","111110105fg32230000","0r631031000000i0"); // EG1
    cuts.AddCutCalo("81283103","111110105fg32230000","0r631031000000i0"); // EG1
    cuts.AddCutCalo("82483103","111110105fg32230000","0r631031000000i0"); // EG1
    cuts.AddCutCalo("84683103","111110105fg32230000","0r631031000000i0"); // EG1
    cuts.AddCutCalo("86883103","111110105fg32230000","0r631031000000i0"); // EG1
    cuts.AddCutCalo("86083103","111110105fg32230000","0r631031000000i0"); // EG1
    cuts.AddCutCalo("88083103","111110105fg32230000","0r631031000000i0"); // EG1
    ...
    cuts.AddCutCalo("80010113","388553205f032230000","01631031000000d0"); 
    cuts.AddCutCalo("80010113","388553205f032230000","0r631031000000d0"); 
    cuts.AddCutCalo("80010113","388553205f032230000","0s631031000000d0"); 
    cuts.AddCutCalo("80010113","388553205f032230000","0t631031000000d0"); 
    cuts.AddCutCalo("80010113","388553205f032230000","0u631031000000d0"); 
...
// Variations for systematics - JJ MC
    ...
    // Variations for systematics
  } else if ( trainConfig == 569) { // NL variations (standard: 42 PHOS ML)
    cuts.AddCutCalo("80010113","24466530ua01cc00000","0163103100000010");
    cuts.AddCutCalo("80010113","24466540ua01cc00000","0163103100000010");
    cuts.AddCutCalo("80010113","24466010ua01cc00000","0163103100000010"); // PHOS group NL
    cuts.AddCutCalo("80010113","24466000ua01cc00000","0163103100000010"); // PHOS group NL
  } else if ( trainConfig == 570) { // distance to bad channel variations (standard: no cut)
    cuts.AddCutCalo("80010113","24466531ua01cc00000","0163103100000010"); // dist. to bad channel = 1
    cuts.AddCutCalo("80010113","24466532ua01cc00000","0163103100000010"); // dist. to bad channel = 2
    cuts.AddCutCalo("80010113","24466533ua01cc00000","0163103100000010"); // dist. to bad channel = 3
  } else if ( trainConfig == 571) {  // timing variations - bunch spacing: 100ns (standard: 50ns)
                                    // min. number of cells per cluster variations (standard: 2)
    cuts.AddCutCalo("80010113","24466530wa01cc00000","0163103100000010"); // -30 - 30 cut
    cuts.AddCutCalo("80010113","24466530za01cc00000","0163103100000010"); // -50 - 50 timing cut
    cuts.AddCutCalo("80010113","244665304a01cc00000","0163103100000010"); // -100 - 100 ns timing cut

  } else if ( trainConfig == 572) { // track matching variations
    cuts.AddCutCalo("80010113","24466530u001cc00000","0163103100000010"); // without track matching
    cuts.AddCutCalo("80010113","24466530u501cc00000","0163103100000010"); // tm variation
    cuts.AddCutCalo("80010113","24466530u601cc00000","0163103100000010"); // tm variation
    cuts.AddCutCalo("80010113","24466530ua01cc00000","0263303100000010"); // BG
  } else if ( trainConfig == 573) { // min. cluster energy variations (standard: 0.5 MeV)
    cuts.AddCutCalo("80010113","24466530ua07cc00000","0163103100000010"); // 0.2 MeV
    cuts.AddCutCalo("80010113","24466530ua09cc00000","0163103100000010"); // 0.1 MeV
    cuts.AddCutCalo("80010113","24466530ua08cc00000","0163103100000010"); // 0.4 MeV
    cuts.AddCutCalo("80010113","24466530ua02cc00000","0163103100000010"); // 0.5 MeV
  } else if ( trainConfig == 574) {
    cuts.AddCutCalo("80010113","24466530ua01cb00000","0163103100000010"); // M02 min 0.002, E > 1 GeV
    cuts.AddCutCalo("80010113","24466530ua01cd00000","0163103100000010"); // M02 min 0.2, E > 1 GeV
    cuts.AddCutCalo("80010113","24466530ua01cc00010","0163103100000010"); // dispersion < 2
    cuts.AddCutCalo("80010113","24466530ua01cc00030","0163103100000010"); // dispersion < 2
  } else if ( trainConfig == 575){ // MESON
    cuts.AddCutCalo("80010113","24466530ua01cc00000","0163303100000010"); // rapidity variation  y<0.5
    cuts.AddCutCalo("80010113","24466530ua01cc00000","0163803100000010"); // rapidity variation  y<0.5
    cuts.AddCutCalo("80010113","24466530ua01cc00000","0163106100000010"); // alpha meson variation 1 0<alpha<0.8
    cuts.AddCutCalo("80010113","24466530ua01cc00000","0163105100000010"); // alpha meson variation 2 0<alpha<0.75
  } else if( trainConfig == 576){ // fourth set of variations
    cuts.AddCutCalo("80010113","24466530ua01cc00300","0163103100000010"); // conv rec 0.03
    cuts.AddCutCalo("80010113","24466530ua01cc00200","0163103100000010"); // conv rec 0.025
    cuts.AddCutCalo("80010113","24466530ua01cc00400","0163103100000010"); // conv rec 0.035
  ...
  // no TM
    ...
    cuts.AddCutCalo("80010103","4117931050g32230000","01631031000000d0"); // INT7
    cuts.AddCutCalo("8008e103","4117931050g32230000","01631031000000d0"); // EG2
    cuts.AddCutCalo("8008d103","4117931050g32230000","01631031000000d0"); // EG1
  } else if (trainConfig == 2031){ // EMCAL+DCAL clusters standard cuts, triggers, NL vars
    cuts.AddCutCalo("80010103","4117932050g32230000","01631031000000d0"); // INT7
    cuts.AddCutCalo("8008e103","4117932050g32230000","01631031000000d0"); // EG2
    cuts.AddCutCalo("8008d103","4117932050g32230000","01631031000000d0"); // EG1
    ...
    cuts.AddCutCalo("80010103","411793205fg32230000","01631031000000d0"); // INT7
    cuts.AddCutCalo("8008e103","411793205fg32230000","01631031000000d0"); // EG2
    cuts.AddCutCalo("8008d103","411793205fg32230000","01631031000000d0"); // EG1
    ...
    cuts.AddCutCalo("80011103","411793205fg32230000","01631031000000d0"); // INT7
    cuts.AddCutCalo("8008g103","411793205fg32230000","01631031000000d0"); // EG2
    cuts.AddCutCalo("8008f103","411793205fg32230000","01631031000000d0"); // EG1
  } else if (trainConfig == 2045){ // T0 based triggers no TM
    cuts.AddCutCalo("80011103","4117932050g32230000","01631031000000d0"); // INT7
    cuts.AddCutCalo("8008g103","4117932050g32230000","01631031000000d0"); // EG2
    cuts.AddCutCalo("8008f103","4117932050g32230000","01631031000000d0"); // EG1

  } else if (trainConfig == 2046){ // copy of 2030 for clusterizer cell timing studies NO TRACK MATCHING
    cuts.AddCutCalo("80010123","4117932050g32230000","01631031000000d0"); // INT7
    cuts.AddCutCalo("8008e123","4117932050g32230000","01631031000000d0"); // EG2
    cuts.AddCutCalo("8008d123","4117932050g32230000","01631031000000d0"); // EG1
  ...
  } else if (trainConfig == 2060){ // rapidity vars
    cuts.AddCutCalo("80010103","4117932050032230000","01631031000000d0"); // INT7
    cuts.AddCutCalo("80010103","4117932050032230000","01634031000000d0"); // INT7
    cuts.AddCutCalo("80010103","4117932050032230000","0163a031000000d0"); // INT7
    cuts.AddCutCalo("80010103","4117932050032230000","0163b031000000d0"); // INT7
    cuts.AddCutCalo("80010103","4117932050032230000","0163e031000000d0"); // INT7
    cuts.AddCutCalo("80010103","4117932050032230000","0163f031000000d0"); // INT7
  } else if (trainConfig == 2061){ // rapidity vars
    cuts.AddCutCalo("8008e103","4117932050032230000","01631031000000d0"); // EG2
    cuts.AddCutCalo("8008e103","4117932050032230000","01634031000000d0"); // EG2
    cuts.AddCutCalo("8008e103","4117932050032230000","0163a031000000d0"); // EG2
    cuts.AddCutCalo("8008e103","4117932050032230000","0163b031000000d0"); // EG2
    cuts.AddCutCalo("8008e103","4117932050032230000","0163e031000000d0"); // EG2
    cuts.AddCutCalo("8008e103","4117932050032230000","0163f031000000d0"); // EG2
  } else if (trainConfig == 2062){ // rapidity vars
    cuts.AddCutCalo("8008d103","4117932050032230000","01631031000000d0"); // EG1
    cuts.AddCutCalo("8008d103","4117932050032230000","01634031000000d0"); // EG1
    cuts.AddCutCalo("8008d103","4117932050032230000","0163a031000000d0"); // EG1
    cuts.AddCutCalo("8008d103","4117932050032230000","0163b031000000d0"); // EG1
    cuts.AddCutCalo("8008d103","4117932050032230000","0163e031000000d0"); // EG1
    cuts.AddCutCalo("8008d103","4117932050032230000","0163f031000000d0"); // EG1
  ...
  } else if (trainConfig == 2208){ // EMCAL+DCAL clusters standard cuts, cent vars
    cuts.AddCutCalo("80210103","411793205f032230000","01631031000000d0"); // 20-40
    cuts.AddCutCalo("82410103","411793205f032230000","01631031000000d0"); // 20-40
    cuts.AddCutCalo("84610103","411793205f032230000","01631031000000d0"); // 40-60
  } else if (trainConfig == 2209){ // EMCAL+DCAL clusters standard cuts, cent vars
    cuts.AddCutCalo("86810103","411793205f032230000","01631031000000d0"); // 60-80
    cuts.AddCutCalo("88010103","411793205f032230000","01631031000000d0"); // 80-100
    cuts.AddCutCalo("89010103","411793205f032230000","01631031000000d0"); // 90-100
  ...
  } else if (trainConfig == 2217) { // CALO variations
    cuts.AddCutCalo("8008e103","411793205f03h230000","01631031000000d0"); // NCell cut effi MC (param 1)
    cuts.AddCutCalo("8008e103","411793205f03i230000","01631031000000d0"); // NCell cut effi MC (param 2)
    cuts.AddCutCalo("8008e103","411793205f03j230000","01631031000000d0"); // NCell cut effi data (param 1)
    cuts.AddCutCalo("8008e103","411793205f03k230000","01631031000000d0"); // NCell cut effi data (param 2)
  } else if (trainConfig == 2218){ // EMCAL+DCAL clusters standard cuts, cent vars
    cuts.AddCutCalo("8028e103","411793205f032230000","01631031000000d0"); // 20-40
    cuts.AddCutCalo("8248e103","411793205f032230000","01631031000000d0"); // 20-40
    cuts.AddCutCalo("8468e103","411793205f032230000","01631031000000d0"); // 40-60
  } else if (trainConfig == 2219){ // EMCAL+DCAL clusters standard cuts, cent vars
    cuts.AddCutCalo("8688e103","411793205f032230000","01631031000000d0"); // 60-80
    cuts.AddCutCalo("8808e103","411793205f032230000","01631031000000d0"); // 80-100
    cuts.AddCutCalo("8908e103","411793205f032230000","01631031000000d0"); // 90-100
  ...
  } else if (trainConfig == 2227) { // CALO variations
    cuts.AddCutCalo("8008d103","411793205f03h230000","01631031000000d0"); // NCell cut effi MC (param 1)
    cuts.AddCutCalo("8008d103","411793205f03i230000","01631031000000d0"); // NCell cut effi MC (param 2)
    cuts.AddCutCalo("8008d103","411793205f03j230000","01631031000000d0"); // NCell cut effi data (param 1)
    cuts.AddCutCalo("8008d103","411793205f03k230000","01631031000000d0"); // NCell cut effi data (param 2)
  } else if (trainConfig == 2228){ // EMCAL+DCAL clusters standard cuts, cent vars
    cuts.AddCutCalo("8028d103","411793205f032230000","01631031000000d0"); // 20-40
    cuts.AddCutCalo("8248d103","411793205f032230000","01631031000000d0"); // 20-40
    cuts.AddCutCalo("8468d103","411793205f032230000","01631031000000d0"); // 40-60
  } else if (trainConfig == 2229){ // EMCAL+DCAL clusters standard cuts, cent vars
    cuts.AddCutCalo("8688d103","411793205f032230000","01631031000000d0"); // 60-80
    cuts.AddCutCalo("8808d103","411793205f032230000","01631031000000d0"); // 80-100
    cuts.AddCutCalo("8908d103","411793205f032230000","01631031000000d0"); // 90-100
  ...
  // systematics for pPb8TeV PRL without TM
  ...
  } else if (trainConfig == 2306) { // CALO variations
    cuts.AddCutCalo("80010103","411793205003h230000","01631031000000d0"); // NCell cut effi MC (param 1)
    cuts.AddCutCalo("80010103","411793205003i230000","01631031000000d0"); // NCell cut effi MC (param 2)
    cuts.AddCutCalo("80010103","411793205003j230000","01631031000000d0"); // NCell cut effi data (param 1)
    cuts.AddCutCalo("80010103","411793205003k230000","01631031000000d0"); // NCell cut effi data (param 2)
  } else if (trainConfig == 2307){ // EMCAL+DCAL clusters standard cuts, cent vars
    cuts.AddCutCalo("80210103","4117932050032230000","01631031000000d0"); // 20-40
    cuts.AddCutCalo("82410103","4117932050032230000","01631031000000d0"); // 20-40
    cuts.AddCutCalo("84610103","4117932050032230000","01631031000000d0"); // 40-60
  } else if (trainConfig == 2308){ // EMCAL+DCAL clusters standard cuts, cent vars
    cuts.AddCutCalo("86810103","4117932050032230000","01631031000000d0"); // 60-80
    cuts.AddCutCalo("88010103","4117932050032230000","01631031000000d0"); // 80-100
    cuts.AddCutCalo("89010103","4117932050032230000","01631031000000d0"); // 90-100
    ...
    cuts.AddCutCalo("8008e103","41179320500329k0000","01631031000000d0"); // M02, pT-dep
  ...
  } else if (trainConfig == 2316) { // CALO variations
    cuts.AddCutCalo("8008e103","411793205003h230000","01631031000000d0"); // NCell cut effi MC (param 1)
    cuts.AddCutCalo("8008e103","411793205003i230000","01631031000000d0"); // NCell cut effi MC (param 2)
    cuts.AddCutCalo("8008e103","411793205003j230000","01631031000000d0"); // NCell cut effi data (param 1)
    cuts.AddCutCalo("8008e103","411793205003k230000","01631031000000d0"); // NCell cut effi data (param 2)
  } else if (trainConfig == 2317){ // EMCAL+DCAL clusters standard cuts, cent vars
    cuts.AddCutCalo("8028e103","4117932050032230000","01631031000000d0"); // 20-40
    cuts.AddCutCalo("8248e103","4117932050032230000","01631031000000d0"); // 20-40
    cuts.AddCutCalo("8468e103","4117932050032230000","01631031000000d0"); // 40-60
  } else if (trainConfig == 2318){ // EMCAL+DCAL clusters standard cuts, cent vars
    cuts.AddCutCalo("8688e103","4117932050032230000","01631031000000d0"); // 60-80
    cuts.AddCutCalo("8808e103","4117932050032230000","01631031000000d0"); // 80-100
    cuts.AddCutCalo("8908e103","4117932050032230000","01631031000000d0"); // 90-100
    ...
    cuts.AddCutCalo("8008d103","41179320500329k0000","01631031000000d0"); // M02, pT-dep
  ...
  } else if (trainConfig == 2326) { // CALO variations
    cuts.AddCutCalo("8008d103","411793205003h230000","01631031000000d0"); // NCell cut effi MC (param 1)
    cuts.AddCutCalo("8008d103","411793205003i230000","01631031000000d0"); // NCell cut effi MC (param 2)
    cuts.AddCutCalo("8008d103","411793205003j230000","01631031000000d0"); // NCell cut effi data (param 1)
    cuts.AddCutCalo("8008d103","411793205003k230000","01631031000000d0"); // NCell cut effi data (param 2)
  } else if (trainConfig == 2327){ // EMCAL+DCAL clusters standard cuts, cent vars
    cuts.AddCutCalo("8028d103","4117932050032230000","01631031000000d0"); // 20-40
    cuts.AddCutCalo("8248d103","4117932050032230000","01631031000000d0"); // 20-40
    cuts.AddCutCalo("8468d103","4117932050032230000","01631031000000d0"); // 40-60
  } else if (trainConfig == 2328){ // EMCAL+DCAL clusters standard cuts, cent vars
    cuts.AddCutCalo("8688d103","4117932050032230000","01631031000000d0"); // 60-80
  ...
  // PHOS pPb8TeV
    ...
    // PAPER pPb5TeV
  } else if (trainConfig == 4000){ //16qt
    cuts.AddCutCalo("80010113","411790105fe30230000","0s631031000000d0"); // INT7
    cuts.AddCutCalo("80010113","411790105fe3n230000","0s631031000000d0"); // INT7
  } else if (trainConfig == 4001){ //16qt mixed evt BG
    cuts.AddCutCalo("80010113","411790105fe30230000","01631031000000d0"); // INT7
    cuts.AddCutCalo("80010113","411790105fe3n230000","01631031000000d0"); // INT7
  } else if (trainConfig == 4100){ //13bf no ncell
    cuts.AddCutCalo("80010113","111110105fe30230000","0s631031000000d0"); // INT7
    cuts.AddCutCalo("80085113","111110105fe30230000","0s631031000000d0"); // EG2
    cuts.AddCutCalo("80083113","111110105fe30230000","0s631031000000d0"); // EG1
  } else if (trainConfig == 4101){ //13bf no ncell mixed evt BG
    cuts.AddCutCalo("80010113","111110105fe30230000","01631031000000d0"); // INT7
    cuts.AddCutCalo("80085113","111110105fe30230000","01631031000000d0"); // EG2
    cuts.AddCutCalo("80083113","111110105fe30230000","01631031000000d0"); // EG1
  } else if (trainConfig == 4200){ //13bf ncell>=2
    cuts.AddCutCalo("80010113","111110105fe3n230000","0s631031000000d0"); // INT7
    cuts.AddCutCalo("80085113","111110105fe3n230000","0s631031000000d0"); // EG2
    cuts.AddCutCalo("80083113","111110105fe3n230000","0s631031000000d0"); // EG1
  } else if (trainConfig == 4201){ //13bf ncell>=2 mixed evt BG
    cuts.AddCutCalo("80010113","111110105fe3n230000","01631031000000d0"); // INT7
    cuts.AddCutCalo("80085113","111110105fe3n230000","01631031000000d0"); // EG2
    cuts.AddCutCalo("80083113","111110105fe3n230000","01631031000000d0"); // EG1
