...
void AddTask_GammaCalo_pPb(
  ...
  //-----------------------------------------------------------------------------------------------
    ...
    cuts.AddCutCalo("80010113","1111141057032230000","01631031000000d0"); // default with 17mrad
  ...
  //-----------------------------------------------------------------------------------------------
    ...
    cuts.AddCutCalo("82410113","11111410570322l0000","01631031000000d0"); // 20-40
    ...
    cuts.AddCutCalo("84610113","11111410570322l0000","01631031000000d0"); // 40-60
    ...
    cuts.AddCutCalo("86010113","11111410570322l0000","01631031000000d0"); // 60-80
  ...
  // INT7 triggers
    ...
    cuts.AddCutCalo("80010113","2446600051013200000","0163103100000010"); // no non lin 0-100%
  } else if (trainConfig == 501) {  // PHOS  INT7
    cuts.AddCutCalo("80010113","2446600041013200000","0163103100000010"); // no non lin
    cuts.AddCutCalo("80010113","2446600011013200000","0163103100000010"); // no non lin 1000 \mus
    cuts.AddCutCalo("80010113","2446600061013200000","0163103100000010"); // no non lin, -30, 50ns
    cuts.AddCutCalo("80010113","24466000a1013200000","0163103100000010"); // no non lin, -12.5, 13ns
  } else if (trainConfig == 502) {  // PHOS  INT7 non lin vars
    cuts.AddCutCalo("80010113","2446601051013200000","0163103100000010"); //
    cuts.AddCutCalo("80010113","2446600051013200000","0163103100000010"); //
    cuts.AddCutCalo("80010113","2446651051013200000","0163103100000010"); //
    cuts.AddCutCalo("80010113","2446641051013200000","0163103100000010"); //
  } else if (trainConfig == 503) {  // PHOS  INT7 with cents
    cuts.AddCutCalo("80110113","2446600051013200000","0163103100000010"); // no non lin 0-10%
    cuts.AddCutCalo("81210113","2446600051013200000","0163103100000010"); // no non lin 10-20%
    cuts.AddCutCalo("82410113","2446600051013200000","0163103100000010"); // no non lin 20-40%
    cuts.AddCutCalo("84610113","2446600051013200000","0163103100000010"); // no non lin 40-60%
    cuts.AddCutCalo("86810113","2446600051013200000","0163103100000010"); // no non lin 60-80%
    cuts.AddCutCalo("88010113","2446600051013200000","0163103100000010"); // no non lin 80-100%
  } else if (trainConfig == 504) {  // PHOS  INT7 with cents
    cuts.AddCutCalo("80210113","2446600051013200000","0163103100000010"); // no non lin 0-10%
    cuts.AddCutCalo("86010113","2446600051013200000","0163103100000010"); // no non lin 60-100%
    cuts.AddCutCalo("a0110113","2446600051013200000","0163103100000010"); // no non lin 0-5%
    cuts.AddCutCalo("a1210113","2446600051013200000","0163103100000010"); // no non lin 5-10%
  } else if (trainConfig == 505) {  // PHOS  INT7 with cents
    cuts.AddCutCalo("80110113","2446601051013200000","0163103100000010"); // no non lin 0-10%
    cuts.AddCutCalo("81210113","2446601051013200000","0163103100000010"); // no non lin 10-20%
    cuts.AddCutCalo("82410113","2446601051013200000","0163103100000010"); // no non lin 20-40%
    cuts.AddCutCalo("84610113","2446601051013200000","0163103100000010"); // no non lin 40-60%
    cuts.AddCutCalo("86810113","2446601051013200000","0163103100000010"); // no non lin 60-80%
    cuts.AddCutCalo("88010113","2446601051013200000","0163103100000010"); // no non lin 80-100%
  } else if (trainConfig == 506) {  // PHOS  INT7 with cents
    cuts.AddCutCalo("80210113","2446601051013200000","0163103100000010"); // no non lin 0-10%
    cuts.AddCutCalo("86010113","2446601051013200000","0163103100000010"); // no non lin 60-100%
    cuts.AddCutCalo("a0110113","2446601051013200000","0163103100000010"); // no non lin 0-5%
    cuts.AddCutCalo("a1210113","2446601051013200000","0163103100000010"); // no non lin 5-10%
  } else if (trainConfig == 507){
    cuts.AddCutCalo("80010113","2446641051013200000","0163103100000010"); // TM on
    cuts.AddCutCalo("80010113","2446641050013200000","0163103100000010"); // TM off
  } else if (trainConfig == 508){ // JJ MC AOD validation
    cuts.AddCutCalo("80010123","2446641051013200000","0163103100000010"); // TM on
    cuts.AddCutCalo("80010123","2446641050013200000","0163103100000010"); // TM off
  } else if (trainConfig == 509){ // JJ MC AOD validation PHOS NL
    cuts.AddCutCalo("80010123","2446601051013200000","0163103100000010"); // TM on
    cuts.AddCutCalo("80010123","2446601050013200000","0163103100000010"); // TM off
  } else if (trainConfig == 510){ // JJ MC AOD validation w/o NL
    cuts.AddCutCalo("80010123","2446600051013200000","0163103100000010"); // TM on
    cuts.AddCutCalo("80010123","2446600050013200000","0163103100000010"); // TM off
  ...
  // pPb 8TeV variations for QA
    ...
    cuts.AddCutCalo("80010113","2446600051013200000","0163103100000010"); // INT7
  } else if (trainConfig == 601){ // PHOS clusters standard cuts, triggers, no nonlin, +-50ns
    cuts.AddCutCalo("80062113","2446600051013200000","0163103100000010"); // PHI7
  ...
  // pPb 8TeV variations for QA
    ...
    cuts.AddCutCalo("00055113","3885500017032230000","01631031000000d0"); // EMC7
    cuts.AddCutCalo("00089113","3885500017032230000","01631031000000d0"); // EG2
    cuts.AddCutCalo("0008b113","3885500017032230000","01631031000000d0"); // EG1
    ...
    cuts.AddCutCalo("00055113","3885500057032230000","01631031000000d0"); // EMC7
    cuts.AddCutCalo("00089113","3885500057032230000","01631031000000d0"); // EG2
    cuts.AddCutCalo("0008b113","3885500057032230000","01631031000000d0"); // EG1
