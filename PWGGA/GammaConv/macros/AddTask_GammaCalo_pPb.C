...
void AddTask_GammaCalo_pPb(
  ...
  // INT7 triggers
    ...
    cuts.AddCutCalo("80010113","244664207a012200000","0163103100000010"); // standard
    ...
    cuts.AddCutCalo("80010113","244664207a012200000","0163103100000010"); // non lin 0-100%
    cuts.AddCutCalo("80110113","244664207a012200000","0163103100000010"); // non lin 0-10%
    cuts.AddCutCalo("81210113","244664207a012200000","0163103100000010"); // non lin 10-20%
    cuts.AddCutCalo("82410113","244664207a012200000","0163103100000010"); // non lin 20-40%
    cuts.AddCutCalo("84610113","244664207a012200000","0163103100000010"); // non lin 40-60%
    cuts.AddCutCalo("86810113","244664207a012200000","0163103100000010"); // non lin 60-80%
    cuts.AddCutCalo("88010113","244664207a012200000","0163103100000010"); // non lin 80-100%
  } else if (trainConfig == 504) {  // PHOS  INT7 with cents
    cuts.AddCutCalo("80010113","244664207a012200000","0163103100000010"); // non lin 0-100%
    cuts.AddCutCalo("80210113","244664207a012200000","0163103100000010"); // non lin 0-20%
    cuts.AddCutCalo("86010113","244664207a012200000","0163103100000010"); // non lin 60-100%
    cuts.AddCutCalo("a0110113","244664207a012200000","0163103100000010"); // non lin 0-5%
    cuts.AddCutCalo("a1210113","244664207a012200000","0163103100000010"); // non lin 5-10%
    ...
    cuts.AddCutCalo("80210113","244664207a012200000","0163103100000010"); // no non lin 0-10%
    cuts.AddCutCalo("86010113","244664207a012200000","0163103100000010"); // no non lin 60-100%
    cuts.AddCutCalo("a0110113","244664207a012200000","0163103100000010"); // no non lin 0-5%
    cuts.AddCutCalo("a1210113","244664207a012200000","0163103100000010"); // no non lin 5-10%
    ...
    cuts.AddCutCalo("80010123","244664207a012200000","0163103100000010"); // standard
    ...
    cuts.AddCutCalo("80010123","244664207a012200000","0163103100000010"); // non lin 0-100%
    cuts.AddCutCalo("80110123","244664207a012200000","0163103100000010"); // non lin 0-10%
    cuts.AddCutCalo("81210123","244664207a012200000","0163103100000010"); // non lin 10-20%
    cuts.AddCutCalo("82410123","244664207a012200000","0163103100000010"); // non lin 20-40%
    cuts.AddCutCalo("84610123","244664207a012200000","0163103100000010"); // non lin 40-60%
    cuts.AddCutCalo("86810123","244664207a012200000","0163103100000010"); // non lin 60-80%
    cuts.AddCutCalo("88010123","244664207a012200000","0163103100000010"); // non lin 80-100%
