...
void AddTask_GammaCalo_pPb(
  ...
  for(Int_t i = 0; i<rAddConfigArr->GetEntries() ; i++){
    if(i==0) rAdditionalTrainConfig = (TObjString*)rAddConfigArr->At(i);
      ...
      if(tempStr.CompareTo("EPCLUSTree") == 0){
        ...
        cout << Form("INFO: AddTask_GammaCalo_pPb will use running mode '%i' for the TrackMatcher!",trackMatcherRunningMode) << endl;
      }
    }
  }
  ...
  if (trainConfig == 1){ // no non lin
    ...
    cuts.AddCut("90010113","1111141057032230000","01631031000000d0"); // 0-100
    cuts.AddCut("90210113","1111141057032230000","01631031000000d0"); // 0-20
    cuts.AddCut("92410113","1111141057032230000","01631031000000d0"); // 20-40
    cuts.AddCut("94610113","1111141057032230000","01631031000000d0"); // 40-60
    cuts.AddCut("96010113","1111141057032230000","01631031000000d0"); // 60-100
  } else if (trainConfig == 8){
    cuts.AddCut("e0010113","1111141057032230000","01631031000000d0"); // 0-100
    cuts.AddCut("e0210113","1111141057032230000","01631031000000d0"); // 0-20
    cuts.AddCut("e2410113","1111141057032230000","01631031000000d0"); // 20-40
    cuts.AddCut("e4610113","1111141057032230000","01631031000000d0"); // 40-60
    cuts.AddCut("e6010113","1111141057032230000","01631031000000d0"); // 60-100
    //-----------------------------------------------------------------------------------------------
  // Standard cuts
  //-----------------------------------------------------------------------------------------------
  ...
  //-----------------------------------------------------------------------------------------------
    ...
    cuts.AddCut("80210113","11111410570322l0000","01631031000000d0");
    cuts.AddCut("82410113","11111410570322l0000","01631031000000d0");
    cuts.AddCut("84610113","11111410570322l0000","01631031000000d0");
    cuts.AddCut("86010113","11111410570322l0000","01631031000000d0");
  } else if (trainConfig == 19){ // direct photons CL1
    cuts.AddCut("90010113","11111410570322l0000","01631031000000d0");
    cuts.AddCut("90210113","11111410570322l0000","01631031000000d0");
    cuts.AddCut("92410113","11111410570322l0000","01631031000000d0");
    cuts.AddCut("94610113","11111410570322l0000","01631031000000d0");
    cuts.AddCut("96010113","11111410570322l0000","01631031000000d0");
    ...
    cuts.AddCut("e0010113","11111410570322l0000","01631031000000d0");
    cuts.AddCut("e0210113","11111410570322l0000","01631031000000d0");
    cuts.AddCut("e2410113","11111410570322l0000","01631031000000d0");
    cuts.AddCut("e4610113","11111410570322l0000","01631031000000d0");
    cuts.AddCut("e6010113","11111410570322l0000","01631031000000d0");
    //-----------------------------------------------------------------------------------------------
  ...
  // INT7 triggers
    ...
    cuts.AddCut("80010113","2446641051013200000","0163103100000010"); // TM on
    cuts.AddCut("80010113","2446641050013200000","0163103100000010"); // TM off
    ...
    cuts.AddCut("80010113","2446641051013200000","0163103100000010"); // no dist to bad channel cut, Ncells: 3, min energy 300 MeV
    ...
    cuts.AddCut("80010113","2446641151082200000","0163103100000010"); // dist to bad channel: 1, Ncells: 2, min energy 400 MeV
