...
// other variations
  ...
  // ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    cuts.AddCutHeavyMesonPCMCalo("00010113","0dm00009f9730000dge0404000","411790109fe3n230000","32c51070n","0103603m00000000","0453503000000000"); // INT7
 
    // possible new default pp 13 TeV, 2 sigmas mass cut
  } else if(trainConfig == 225)  { //EDC 13TeV MB, NCell >=1
    cuts.AddCutHeavyMesonPCMCalo("00010113","0dm00009f9730000dge0404000","411790109fe309v0000","32c51079m","f000643600000000","0453503000000000"); // INT7
  } else if(trainConfig == 226)  { //EDC 13TeV MB, NCell >=1
    cuts.AddCutHeavyMesonPCMCalo("0008e113","0dm00009f9730000dge0404000","411790109fe309v0000","32c51079m","f000653600000000","0453503000000000"); // EG2
  } else if(trainConfig == 227)  { //EDC 13TeV MB, NCell >=1
    cuts.AddCutHeavyMesonPCMCalo("0008d113","0dm00009f9730000dge0404000","411790109fe309v0000","32c51079m","f000663600000000","0453503000000000"); // EG1
    // possible new defualt pp 13 TeV, 3 sigmas mass cut
  } else if(trainConfig == 228)  { //EDC 13TeV MB, NCell >=1
    cuts.AddCutHeavyMesonPCMCalo("00010113","0dm00009f9730000dge0404000","411790109fe309v0000","32c51079m","f000643700000000","0453503000000000"); // INT7
  } else if(trainConfig == 229)  { //EDC 13TeV MB, NCell >=1
    cuts.AddCutHeavyMesonPCMCalo("0008e113","0dm00009f9730000dge0404000","411790109fe309v0000","32c51079m","f000653700000000","0453503000000000"); // EG2
  } else if(trainConfig == 230)  { //EDC 13TeV MB, NCell >=1
    cuts.AddCutHeavyMesonPCMCalo("0008d113","0dm00009f9730000dge0404000","411790109fe309v0000","32c51079m","f000663700000000","0453503000000000"); // EG1
    // possible new defualt pp 13 TeV, 4 sigmas mass cut
  } else if(trainConfig == 231)  { //EDC 13TeV MB, NCell >=1
    cuts.AddCutHeavyMesonPCMCalo("00010113","0dm00009f9730000dge0404000","411790109fe309v0000","32c51079m","f000643800000000","0453503000000000"); // INT7
  } else if(trainConfig == 232)  { //EDC 13TeV MB, NCell >=1
    cuts.AddCutHeavyMesonPCMCalo("0008e113","0dm00009f9730000dge0404000","411790109fe309v0000","32c51079m","f000653800000000","0453503000000000"); // EG2
  } else if(trainConfig == 233)  { //EDC 13TeV MB, NCell >=1
    cuts.AddCutHeavyMesonPCMCalo("0008d113","0dm00009f9730000dge0404000","411790109fe309v0000","32c51079m","f000663800000000","0453503000000000"); // EG1

  // high multiplicity triggers 
  } else if(trainConfig == 240){ // 2 sigma for mass cut
    cuts.AddCutHeavyMesonPCMCalo("00074113","0dm00009f9730000dge0404000","411790109fe309v0000","32c51079m","f000643600000000","0453503000000000"); // VOHM
    cuts.AddCutHeavyMesonPCMCalo("00076113","0dm00009f9730000dge0404000","411790109fe309v0000","32c51079m","f000643600000000","0453503000000000"); // VOHM with SPD
  } else if(trainConfig == 241){ // 3 sigma for mass cut
    cuts.AddCutHeavyMesonPCMCalo("00074113","0dm00009f9730000dge0404000","411790109fe309v0000","32c51079m","f000643700000000","0453503000000000"); // VOHM
    cuts.AddCutHeavyMesonPCMCalo("00076113","0dm00009f9730000dge0404000","411790109fe309v0000","32c51079m","f000643700000000","0453503000000000"); // VOHM with SPD
  } else if(trainConfig == 242){ // 4 sigma for mass cut
    cuts.AddCutHeavyMesonPCMCalo("00074113","0dm00009f9730000dge0404000","411790109fe309v0000","32c51079m","f000643800000000","0453503000000000"); // VOHM
    cuts.AddCutHeavyMesonPCMCalo("00076113","0dm00009f9730000dge0404000","411790109fe309v0000","32c51079m","f000643800000000","0453503000000000"); // VOHM with SPD
