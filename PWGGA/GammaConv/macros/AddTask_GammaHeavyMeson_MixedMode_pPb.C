...
//main function
//***************************************************************************************
void AddTask_GammaHeavyMeson_MixedMode_pPb( Int_t     selectedMeson                 = 0,                    // select the corresponding meson: 0 pi0, 1 eta, 2 eta'
  ...
  if(rAddConfigArr->GetEntries()<1){cout << "ERROR: AddTask_GammaHeavyMeson_MixedMode_pPb during parsing of additionalTrainConfig String '" << additionalTrainConfig.Data() << "'" << endl; return;}
  ...
  for(Int_t i = 0; i<rAddConfigArr->GetEntries() ; i++){
    if(i==0) rAdditionalTrainConfig = (TObjString*)rAddConfigArr->At(i);
      ...
      if(tempStr.BeginsWith("MODIFYACC")){
        cout << "INFO: AddTask_GammaHeavyMeson_MixedMode_pPb activating 'MODIFYACC'" << endl;
        ...
        cout << "INFO: AddTask_GammaHeavyMeson_MixedMode_pPb will use custom branch from Correction Framework!" << endl;
  ...
  if (sAdditionalTrainConfig.Atoi() > 0){
    ...
    cout << "INFO: AddTask_GammaHeavyMeson_MixedMode_pPb running additionalTrainConfig '" << sAdditionalTrainConfig.Atoi() << "', train config: '" << trainConfig << "'" << endl;
  }
  ...
  if (!mgr) {
    Error(Form("AddTask_GammaHeavyMeson_MixedMode_pPb_%i",trainConfig), "No analysis manager found.");
    return ;
  }
  ...
  if (trainConfig == 1){
    ...
    cuts.AddCut("80052113","00200009327000008250400000","1111100057022230000","0163103000000010");
    cuts.AddCut("80085113","00200009327000008250400000","1111100057022230000","0163103000000010");
    cuts.AddCut("80083113","00200009327000008250400000","1111100057022230000","0163103000000010");
  } else if (trainConfig == 2){
    cuts.AddCut("80010113","00200009327000008250400000","1111141057022230000","0163103000000010");
    cuts.AddCut("80052113","00200009327000008250400000","1111141057022230000","0163103000000010");
    cuts.AddCut("80085113","00200009327000008250400000","1111141057022230000","0163103000000010");
    cuts.AddCut("80083113","00200009327000008250400000","1111141057022230000","0163103000000010");
  } else if (trainConfig == 3){
    cuts.AddCut("80010113","00200009327000008250400000","1111100057022230000","0163103b00000010");
    cuts.AddCut("80052113","00200009327000008250400000","1111100057022230000","0163103b00000010");
    cuts.AddCut("80085113","00200009327000008250400000","1111100057022230000","0163103b00000010");
    cuts.AddCut("80083113","00200009327000008250400000","1111100057022230000","0163103b00000010");

  //****************************************************************
  // Run 1, PHOS
  //****************************************************************
  } else if (trainConfig == 100){
    cuts.AddCut("80010113","00200009327000008250400000","2444400041013200000","0163103000000010"); // standart cut, kINT7
    cuts.AddCut("80062113","00200009327000008250400000","2444400041013200000","0163103000000010"); // standard cut, kPHI7
  } else if (trainConfig == 101){
    cuts.AddCut("80010113","00200009327000008250400000","2444451041013200000","0163103000000010"); // standart cut, kINT7
    cuts.AddCut("80062113","00200009327000008250400000","2444451041013200000","0163103000000010"); // standard cut, kPHI7
