...
void AddTask_GammaConvCalo_PbPb(  Int_t     trainConfig                     = 1,                      // change different set of cuts
 ...
 // EMCal trigger for LHC11h
  ...
  // Xe-Xe configurations PHOS
    ...
    cuts.AddCut("10810113","00200009327000008250400000","2446601051013200000","0163103100000010"); // 0-80%
    ...
    cuts.AddCut("14810113","00200009327000008250400000","2446601051013200000","0163103100000010"); // 40-80%
  ...
  } else if (trainConfig == 403){ // PHOS clusters - 0-90% centrality
    cuts.AddCut("10810113","00200009327000008250400000","2446600011013200000","0163103100000010"); // 0-80%
    cuts.AddCut("10810113","00200009327000008250400000","2446600051013200000","0163103100000010"); // 0-80%
