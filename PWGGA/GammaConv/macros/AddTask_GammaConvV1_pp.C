...
void AddTask_GammaConvV1_pp(  Int_t   trainConfig                     = 1,                    // change different set of cuts
  ...
  // ------------------------- run 2 configurations ------------------------------------------
    ...
    cuts.AddCut("00010113", "00200009a27300008250904120", "0152103500000000"); // New standard cut for pp 5 TeV analysis VAND
    cuts.AddCut("00010113", "00200079a27300008250904120", "0152103500000000"); // min pT no cut
    cuts.AddCut("00010113", "00200069a27300008250904120", "0152103500000000"); // min pT 40 MeV
    cuts.AddCut("00010113", "00200049a27300008250904120", "0152103500000000"); // min pT 75 MeV
    cuts.AddCut("00010113", "00200008a27300008250904120", "0152103500000000"); // TPC cluster 35%
    cuts.AddCut("00010113", "00200006a27300008250904120", "0152103500000000"); // TPC cluster 70%
  } else if (trainConfig == 119){
    cuts.AddCut("00010113", "00200009a27300008250904120", "0152103500000000"); // edEdx -3,3
    cuts.AddCut("00010113", "00200009b27300008250904120", "0152103500000000"); // edEdx -3,2,3.2
    cuts.AddCut("00010113", "00200009c27300008250904120", "0152103500000000"); // edEdx -2.8,2.8
    cuts.AddCut("00010113", "00200009a57300008250904120", "0152103500000000"); // pidEdx 2,-10
    cuts.AddCut("00010113", "00200009a17300008250904120", "0152103500000000"); // pidEdx 0,-10
  } else if (trainConfig == 120){
    cuts.AddCut("00010113", "00200009a20300008250904120", "0152103500000000"); // pion nsig min mom 0.50 GeV/c
    cuts.AddCut("00010113", "00200009a26300008250904120", "0152103500000000"); // pion nsig min mom 0.25 GeV/c
    cuts.AddCut("00010113", "00200009a27600008250904120", "0152103500000000"); // pion nsig max mom 2.00 GeV/c
    cuts.AddCut("00010113", "00200009a27100008250904120", "0152103500000000"); // pion nsig max mom 5.00 GeV/c
  } else if (trainConfig == 121){
    cuts.AddCut("00010113", "00200009a27300003250904120", "0152103500000000"); // qT max 0.05 1D
    cuts.AddCut("00010113", "00200009a27300002250904120", "0152103500000000"); // qT max 0.06 2D
    cuts.AddCut("00010113", "00200009a27300008210904120", "0152103500000000"); // Psi pair 0.1  1D
    cuts.AddCut("00010113", "00200009a27300008260904120", "0152103500000000"); // Psi pair 0.05 2D
    cuts.AddCut("00010113", "00020009a27300008280904120", "0152103500000000"); // Psi pair 0.2  2D
  } else if (trainConfig == 122){
    cuts.AddCut("00010113", "00200009a27300008210904120", "0152103500000000"); // variation chi2 30 psi pair 0.1 1D
    cuts.AddCut("00010113", "00200009a27300008860904120", "0152103500000000"); // variation chi2 20 psi pair 0.05 2D
    cuts.AddCut("00010113", "00200009a27300008180904120", "0152103500000000"); // variation chi2 50 psi pair 0.2 2D
    cuts.AddCut("00010113", "00200009a27300008254904120", "0152103500000000"); // Photon Asymmetry Cut
    ...
    cuts.AddCut("00010113", "00200009a27300008250900120", "0152103500000000"); // no double counting
    cuts.AddCut("00010113", "00200009a27300008250904120", "0152105500000000"); // meson alpha < 0.75
    cuts.AddCut("00010113", "00200009a27300008250904120", "0152107500000000"); // meson alpha < 0.85
  } else if (trainConfig == 124){
    cuts.AddCut("00010113", "00200009a27300008250904130", "0152103500000000"); // dcaz 4cm
    cuts.AddCut("00010113", "00200009a27300008250904140", "0152103500000000"); // dcaz 3cm
    cuts.AddCut("00010113", "00200009a27300008250904220", "0152103500000000"); // dcar 5cm
    cuts.AddCut("00010113", "00200009a27300008250904320", "0152105500000000"); // dcar 4cm
