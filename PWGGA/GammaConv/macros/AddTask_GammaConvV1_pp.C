void AddTask_GammaConvV1_pp(  Int_t 	trainConfig 				= 1,  								// change different set of cuts
	...
	if ( trainConfig == 75) numberOfCuts = 3;	
	...
	if(trainConfig == 1){
		...
		eventCutArray[ 0] = "00005211"; photonCutArray[ 0] = "00200009227302008250400000"; mesonCutArray[0] = "0152103500000000"; // trigger kEMC7
		eventCutArray[ 1] = "00006211"; photonCutArray[ 1] = "00200009227302008250400000"; mesonCutArray[1] = "0152103500000000"; // trigger kPHI7
		eventCutArray[ 2] = "00008111"; photonCutArray[ 2] = "00200009227302008250400000"; mesonCutArray[2] = "0152103500000000"; // trigger kEMCEGA + CINT7
