void AddTask_GammaConvV1_pp(  Int_t trainConfig = 1,  //change different set of cuts
   ...
   if(trainConfig == 1){
      ...
      cutarray[ 1] = "00000010320929700282504000000"; mesonCutArray[0] = "01525065000000"; //variation eta 0.65
      cutarray[ 2] = "00000010420929700282504000000"; mesonCutArray[2] = "01525065000000"; //variation eta 0.75
      cutarray[ 3] = "00000010020929500282504000000"; mesonCutArray[3] = "01525065000000"; //variation pion p dEdx 0.3-5.
   } else if (trainConfig == 13) {
      cutarray[ 0] = "00000010024929700282504000000"; mesonCutArray[0] = "01525065000000"; //variation pt 0.075 
      cutarray[ 1] = "00000010021929700282504000000"; mesonCutArray[0] = "01525065000000"; //variation pt 0.1
      cutarray[ 2] = "00000010020629700282504000000"; mesonCutArray[2] = "01525065000000"; //variation TPC cls 0.7
      cutarray[ 3] = "00000010020829700282504000000"; mesonCutArray[3] = "01525065000000"; //variation TPC cls 0.35 
   } else if (trainConfig == 14) {
      cutarray[ 0] = "00000010020939700282504000000"; mesonCutArray[0] = "01525065000000"; //variation edEdx -4,5
      cutarray[ 1] = "00000010020969700282504000000"; mesonCutArray[0] = "01525065000000"; //variation edEdx -2.5,4
      cutarray[ 2] = "00000010020929700382504000000"; mesonCutArray[2] = "01525065000000"; //variation TOF el. PID -3,5
      cutarray[ 3] = "00000010020929700482504000000"; mesonCutArray[3] = "01525065000000"; //variation TOF el. PID -2,3
   } else if (trainConfig == 15) {
      cutarray[ 0] = "00000010020929700292504000000"; mesonCutArray[0] = "01525065000000"; //variation qt 0.03
      ...
      cutarray[ 3] = "00000010020929700282504000000"; mesonCutArray[3] = "01525055000000"; //variation alpha 0.75
   } else {
