...
void AddTask_GammaCalo_PbPb(  Int_t     trainConfig                     = 1,                    // change different set of cuts
  ...
  // EMCal trigger for LHC11h
    ...
    cuts.AddCut("50100013","1111100053032230000","01631031000000d0"); // 0-10
    cuts.AddCut("52500013","1111100053032230000","01631031000000d0"); // 20-50
    cuts.AddCut("50100013","1111101053032230000","01631031000000d0"); // 0-10
    cuts.AddCut("52500013","1111101053032230000","01631031000000d0"); // 20-50
  } else if (trainConfig == 37){ // EMCAL clusters
    cuts.AddCut("50100013","11111000530a2230000","0163103100000000"); // 0-10
    cuts.AddCut("52500013","11111000530a2230000","0163103100000000"); // 20-50
    cuts.AddCut("50100013","11111010530a2230000","0163103100000000"); // 0-10
    cuts.AddCut("52500013","11111010530a2230000","0163103100000000"); // 20-50
  ...
  // first look
    ...
    cuts.AddCut("50110113","1111181053032230000","0163103100000050"); // 0-10
    cuts.AddCut("51210113","1111181053032230000","0163103100000050"); // 10-20
  ...
  // Xe-xe configurations
    ...
    cuts.AddCut("50910113","1111100007032230000","01631031000000d0"); // 0-90
  } else if (trainConfig == 301){ // EMCAL clusters - 0-90% centrality for XeXe EMCal cluster QA
    cuts.AddCut("50210113","1111100007032230000","01631031000000d0"); // 0-20
    cuts.AddCut("52410113","1111100007032230000","01631031000000d0"); // 20-40
    cuts.AddCut("50410113","1111100007032230000","01631031000000d0"); // 0-40
    cuts.AddCut("54910113","1111100007032230000","01631031000000d0"); // 40-90
  } else if (trainConfig == 302){ // EMCAL clusters - 0-90% centrality for XeXe EMCal cluster QA - TB nl
    cuts.AddCut("50910113","1111101007032230000","01631031000000d0"); // 0-90
  } else if (trainConfig == 303){ // EMCAL clusters - diff centralities for XeXe EMCal cluster QA - TB nl
    cuts.AddCut("50210113","1111101007032230000","01631031000000d0"); // 0-20
    cuts.AddCut("52410113","1111101007032230000","01631031000000d0"); // 20-40
    cuts.AddCut("50410113","1111101007032230000","01631031000000d0"); // 0-40
    cuts.AddCut("54910113","1111101007032230000","01631031000000d0"); // 40-90
