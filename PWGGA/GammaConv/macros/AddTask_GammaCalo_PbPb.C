...
void AddTask_GammaCalo_PbPb(  Int_t     trainConfig                     = 1,                    // change different set of cuts
  ...
  // EMCal trigger for LHC11h
    ...
    cuts.AddCut("50110113","1111101053032230000","0163103100000050"); // 0-10
    cuts.AddCut("52510113","1111101053032230000","0163103100000050"); // 20-50
  } else if (trainConfig == 37){ // EMCAL clusters
    cuts.AddCut("50110113","1111100053052230000","0163103100000000"); // 0-10
    cuts.AddCut("52510113","1111100053052230000","0163103100000000"); // 20-50
    cuts.AddCut("50110113","1111101053052230000","0163103100000000"); // 0-10
    cuts.AddCut("52510113","1111101053052230000","0163103100000000"); // 20-50
