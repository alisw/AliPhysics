...
void AddTask_GammaCalo_PbPb(  Int_t     trainConfig                     = 1,                    // change different set of cuts
  ...
  // EMCal trigger for LHC11h
    ...
    cuts.AddCut("50110113","1111100053032230000","01631031000000d0"); // 0-10
    cuts.AddCut("52510113","1111100053032230000","01631031000000d0"); // 20-50
    cuts.AddCut("50110113","1111101053032230000","01631031000000d0"); // 0-10
    cuts.AddCut("52510113","1111101053032230000","01631031000000d0"); // 20-50
  } else if (trainConfig == 37){ // EMCAL clusters
    cuts.AddCut("50110113","11111000530a2230000","0163103100000000"); // 0-10
    cuts.AddCut("52510113","11111000530a2230000","0163103100000000"); // 20-50
    cuts.AddCut("50110113","11111010530a2230000","0163103100000000"); // 0-10
    cuts.AddCut("52510113","11111010530a2230000","0163103100000000"); // 20-50
