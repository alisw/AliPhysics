...
void AddTask_GammaCalo_PbPb(
  ...
  // **********************************************************************************************************
    ...
    cuts.AddCutCalo("10810013","411790005k032220000","01631031000000d0"); // 0-80
  } else if (trainConfig == 301){ // EMCAL clusters - 0-80% centrality for XeXe EMCal cluster QA
    cuts.AddCutCalo("10210013","411790005k032220000","01631031000000d0"); // 0-20
    cuts.AddCutCalo("12410013","411790005k032220000","01631031000000d0"); // 20-40
    cuts.AddCutCalo("10410013","411790005k032220000","01631031000000d0"); // 0-40
    cuts.AddCutCalo("14810013","411790005k032220000","01631031000000d0"); // 40-80
