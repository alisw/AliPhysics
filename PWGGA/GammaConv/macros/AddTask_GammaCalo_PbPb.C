void AddTask_GammaCalo_PbPb( 	  	Int_t 		trainConfig 				= 1,  								// change different set of cuts
	...
	if (trainConfig == 1){ // EMCAL clusters
        eventCutArray[ 0] = "6010001"; clusterCutArray[0] = "10000040032230000"; mesonCutArray[ 0] = "01631031000000"; // 0-5%
        eventCutArray[ 1] = "6120001"; clusterCutArray[1] = "10000040032230000"; mesonCutArray[ 1] = "01631031000000"; // 5-10%
        eventCutArray[ 2] = "5010001"; clusterCutArray[2] = "10000040032230000"; mesonCutArray[ 2] = "01631031000000"; // 0-10%
        eventCutArray[ 3] = "5240001"; clusterCutArray[3] = "10000040032230000"; mesonCutArray[ 3] = "01631031000000"; // 20-40%
        eventCutArray[ 4] = "5250001"; clusterCutArray[4] = "10000040032230000"; mesonCutArray[ 4] = "01631031000000"; // 20-50%
	} else if (trainConfig == 2){ // EMCAL clusters
        eventCutArray[ 0] = "6010001"; clusterCutArray[0] = "10000040032230000"; mesonCutArray[ 0] = "01631031000000"; // 0-5%
        eventCutArray[ 1] = "6120001"; clusterCutArray[1] = "10000040032230000"; mesonCutArray[ 1] = "01631031000000"; // 5-10%
        eventCutArray[ 2] = "5010001"; clusterCutArray[2] = "10000040032230000"; mesonCutArray[ 2] = "01631031000000"; // 0-10%
        eventCutArray[ 3] = "5120001"; clusterCutArray[3] = "10000040032230000"; mesonCutArray[ 3] = "01631031000000"; // 10-20%
        eventCutArray[ 4] = "5240001"; clusterCutArray[4] = "10000040032230000"; mesonCutArray[ 4] = "01631031000000"; // 20-40%
	} else if (trainConfig == 3){ // EMCAL clusters
        eventCutArray[ 0] = "5460001"; clusterCutArray[0] = "10000040032230000"; mesonCutArray[ 0] = "01631031000000"; // 40-60%
        eventCutArray[ 1] = "5680001"; clusterCutArray[1] = "10000040032230000"; mesonCutArray[ 1] = "01631031000000"; // 60-80%
        eventCutArray[ 2] = "5260001"; clusterCutArray[2] = "10000040032230000"; mesonCutArray[ 2] = "01631031000000"; // 20-60%
        eventCutArray[ 3] = "5480001"; clusterCutArray[3] = "10000040032230000"; mesonCutArray[ 3] = "01631031000000"; // 40-80%
        eventCutArray[ 4] = "5250001"; clusterCutArray[4] = "10000040032230000"; mesonCutArray[ 4] = "01631031000000"; // 20-50%
