...
void AddTask_GammaCalo_PbPb(  Int_t     trainConfig                     = 1,                    // change different set of cuts
  ...
  // trainconfig for PbPb studies in 5 TeV with no  nonlin
    ...
    cuts.AddCut("30110a13","11111840510b2230000","0163103100000050"); //
    cuts.AddCut("31210a13","11111840510b2230000","0163103100000050"); //
    cuts.AddCut("10110a13","11111840510b2230000","0163103100000050"); //
    cuts.AddCut("11210a13","11111850510b2230000","0163103100000050"); //
