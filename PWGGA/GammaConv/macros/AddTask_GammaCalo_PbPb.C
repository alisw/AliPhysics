...
void AddTask_GammaCalo_PbPb(  Int_t     trainConfig                     = 1,                    // change different set of cuts
  ...
  // Xe-xe configurations
    ...
    cuts.AddCut("10910113","1111101007032230000","01631031000000d0"); // 0-90
  } else if (trainConfig == 303){ // EMCAL clusters - diff centralities for XeXe EMCal cluster QA - TB nl
    cuts.AddCut("10210113","1111101007032230000","01631031000000d0"); // 0-20
    cuts.AddCut("12410113","1111101007032230000","01631031000000d0"); // 20-40
    cuts.AddCut("10410113","1111101007032230000","01631031000000d0"); // 0-40
    cuts.AddCut("14910113","1111101007032230000","01631031000000d0"); // 40-90
