void AddTask_GammaConvV1_PbPb(  Int_t trainConfig = 1,  //change different set of cuts
	...
	} else if ( trainConfig == 138){//cut study for dedx and electron pion line
		eventCutArray[ 0] = "5010001"; photonCutArray[ 0] = "00200009297002008250400000"; mesonCutArray[ 0] = "01525065000000"; //std 3.0sigma
		eventCutArray[ 1] = "5010001"; photonCutArray[ 0] = "00200009290002008250400000"; mesonCutArray[ 0] = "01525065000000"; //3.0sigma @ 0.5GeV/c
		eventCutArray[ 2] = "5010001"; photonCutArray[ 1] = "00200009230002008250400000"; mesonCutArray[ 1] = "01525065000000"; //2.5sigma @ 0.5GeV/c
		eventCutArray[ 2] = "5010001"; photonCutArray[ 2] = "00200009250002008250400000"; mesonCutArray[ 2] = "01525065000000"; //2.0sigma @ 0.5GeV/c
		eventCutArray[ 3] = "5010001"; photonCutArray[ 3] = "00200009280402008250400000"; mesonCutArray[ 3] = "01525065000000"; //2.0sigma @ 0.5GeV/c, high pt 1sigma @3.GeV/c
	} else if ( trainConfig == 139){//cut study for dedx and electron pion line with phi cut
		eventCutArray[ 0] = "5010001"; photonCutArray[ 0] = "00216609297002008250400000"; mesonCutArray[ 0] = "01525065000000"; // 20-40%
		eventCutArray[ 1] = "5010001"; photonCutArray[ 1] = "00216609290002008250400000"; mesonCutArray[ 1] = "01525065000000"; // 20-50%
		eventCutArray[ 2] = "5010001"; photonCutArray[ 2] = "00216609230002008250400000"; mesonCutArray[ 2] = "01525065000000"; // 20-30%
		eventCutArray[ 3] = "5010001"; photonCutArray[ 3] = "00216609250002008250400000"; mesonCutArray[ 3] = "01525065000000"; // 30-40%
		eventCutArray[ 4] = "5010001"; photonCutArray[ 4] = "00216609280402008250400000"; mesonCutArray[ 4] = "01525065000000"; // 40-50%
	} else {
