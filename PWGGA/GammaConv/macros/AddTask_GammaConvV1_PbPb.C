...
void AddTask_GammaConvV1_PbPb(  Int_t     trainConfig                     = 1,                              //change different set of cuts
  ...
  if (trainConfig == 1){ // Standard cuts
    ...
    cuts.AddCut("50100033", "00200009247002008850404000", "0152501500000000"); //
  } else if ( trainConfig == 314){ //
    cuts.AddCut("50100033", "00216609247002008850404000", "0152501500000000"); //
  } else if ( trainConfig == 315){ // dir photons (tighter dEdx+TOF)
    cuts.AddCut("52400033", "00200009247002008850404000", "0152501500000000"); //
    cuts.AddCut("52500033", "00200009247002008850404000", "0152501500000000"); //
  } else if ( trainConfig == 316){ //
    cuts.AddCut("52400033", "00216609247002008850404000", "0152501500000000"); //
    cuts.AddCut("52500033", "00216609247002008850404000", "0152501500000000"); //
    
  } else if ( trainConfig == 317){ // phi variation 1
    cuts.AddCut("50100033", "00215509247002008850404000", "0152501500000000"); // 2 - 4 rad
  } else if ( trainConfig == 318){ // phi variation 2
    cuts.AddCut("50100033", "00217709247002008850404000", "0152501500000000"); // 2.6 - 3.4 rad
  } else if ( trainConfig == 319){ // phi variation 1
    cuts.AddCut("52400033", "00215509247002008850404000", "0152501500000000"); // 
    cuts.AddCut("52500033", "00215509247002008850404000", "0152501500000000"); //
  } else if ( trainConfig == 320){ // phi variation 2
    cuts.AddCut("52400033", "00217709247002008850404000", "0152501500000000"); // 
    cuts.AddCut("52500033", "00217709247002008850404000", "0152501500000000"); // 
  } else if ( trainConfig == 321){ // single pt variation
    cuts.AddCut("50100033", "00200049247002008850404000", "0152501500000000"); // 0.075
    cuts.AddCut("50100033", "00200019247002008850404000", "0152501500000000"); // 0.1
  } else if ( trainConfig == 322){ //  single pt variation - phi
    cuts.AddCut("50100033", "00216649247002008850404000", "0152501500000000"); // 0.075
    cuts.AddCut("50100033", "00216619247002008850404000", "0152501500000000"); // 0.1
  } else if ( trainConfig == 323){ // single pt variation    
    cuts.AddCut("52400033", "00200049247002008850404000", "0152501500000000"); // 0.075
    cuts.AddCut("52400033", "00200019247002008850404000", "0152501500000000"); // 0.1
    cuts.AddCut("52500033", "00200049247002008850404000", "0152501500000000"); // 0.075
    cuts.AddCut("52500033", "00200019247002008850404000", "0152501500000000"); // 0.1
  } else if ( trainConfig == 324){ //  single pt variation - phi
    cuts.AddCut("52400033", "00216649247002008850404000", "0152501500000000"); // 0.075
    cuts.AddCut("52400033", "00216619247002008850404000", "0152501500000000"); // 0.1
    cuts.AddCut("52500033", "00216649247002008850404000", "0152501500000000"); // 0.075
    cuts.AddCut("52500033", "00216619247002008850404000", "0152501500000000"); // 0.1
  } else if ( trainConfig == 325){ // TPC clusters
    cuts.AddCut("50100033", "00200008247002008850404000", "0152501500000000"); // 0.35
    cuts.AddCut("50100033", "00200006247002008850404000", "0152501500000000"); // 0.7
  } else if ( trainConfig == 326){ // TPC clusters - phi
    cuts.AddCut("50100033", "00216608247002008850404000", "0152501500000000"); // 0.35
    cuts.AddCut("50100033", "00216606247002008850404000", "0152501500000000"); // 0.7
  } else if ( trainConfig == 327){ // TPC clusters
    cuts.AddCut("52400033", "00200008247002008850404000", "0152501500000000"); // 0.35
    cuts.AddCut("52400033", "00200006247002008850404000", "0152501500000000"); // 0.7
    cuts.AddCut("52500033", "00200008247002008850404000", "0152501500000000"); // 0.35
    cuts.AddCut("52500033", "00200006247002008850404000", "0152501500000000"); // 0.7
  } else if ( trainConfig == 328){ // TPC clusters - phi
    cuts.AddCut("52400033", "00216608247002008850404000", "0152501500000000"); // 0.35
    cuts.AddCut("52400033", "00216606247002008850404000", "0152501500000000"); // 0.7
    cuts.AddCut("52500033", "00216608247002008850404000", "0152501500000000"); // 0.35
    cuts.AddCut("52500033", "00216606247002008850404000", "0152501500000000"); // 0.7
  } else if ( trainConfig == 329){ // edEdx
    cuts.AddCut("50100033", "00200009347002008850404000", "0152501500000000"); // -4, 5
    cuts.AddCut("50100033", "00200009947002008850404000", "0152501500000000"); // -2.5, 5
  } else if ( trainConfig == 330){ // edEdx - phi
    cuts.AddCut("50100033", "00216609347002008850404000", "0152501500000000"); // -4, 5
    cuts.AddCut("50100033", "00216609947002008850404000", "0152501500000000"); // -2.5, 5
  } else if ( trainConfig == 331){ // edEdx
    cuts.AddCut("52400033", "00200009347002008850404000", "0152501500000000"); // -4, 5
    cuts.AddCut("52400033", "00200009947002008850404000", "0152501500000000"); // -2.5, 5
    cuts.AddCut("52500033", "00200009347002008850404000", "0152501500000000"); // -4, 5
    cuts.AddCut("52500033", "00200009947002008850404000", "0152501500000000"); // -2.5, 5
  } else if ( trainConfig == 332){ // edEdx - phi
    cuts.AddCut("52400033", "00216609347002008850404000", "0152501500000000"); // -4, 5
    cuts.AddCut("52400033", "00216609947002008850404000", "0152501500000000"); // -2.5, 5
    cuts.AddCut("52500033", "00216609347002008850404000", "0152501500000000"); // -4, 5
    cuts.AddCut("52500033", "00216609947002008850404000", "0152501500000000"); // -2.5, 5
  } else if ( trainConfig == 333){ // pdEdx
    cuts.AddCut("50100033", "00200009240002008850404000", "0152501500000000"); // low pt at 0.5
    cuts.AddCut("50100033", "00200009247602008850404000", "0152501500000000"); // 3&1sigma
  } else if ( trainConfig == 334){ // pdEdx - phi
    cuts.AddCut("50100033", "00216609240002008850404000", "0152501500000000"); // low pt at 0.5
    cuts.AddCut("50100033", "00216609247602008850404000", "0152501500000000"); // 3&1sigma
  } else if ( trainConfig == 335){ // pdEdx
    cuts.AddCut("52400033", "00200009240002008850404000", "0152501500000000"); // low pt at 0.5
    cuts.AddCut("52400033", "00200009247602008850404000", "0152501500000000"); // 3&1sigma
    cuts.AddCut("52500033", "00200009240002008850404000", "0152501500000000"); // low pt at 0.5
    cuts.AddCut("52500033", "00200009247602008850404000", "0152501500000000"); // 3&1sigma
  } else if ( trainConfig == 336){ // pdEdx - phi
    cuts.AddCut("52400033", "00216609240002008850404000", "0152501500000000"); // low pt at 0.5
    cuts.AddCut("52400033", "00216609247602008850404000", "0152501500000000"); // 3&1sigma
    cuts.AddCut("52500033", "00216609240002008850404000", "0152501500000000"); // low pt at 0.5
    cuts.AddCut("52500033", "00216609247602008850404000", "0152501500000000"); // 3&1sigma
  } else if ( trainConfig == 337){ // pdEdx & TOF
    cuts.AddCut("50100033", "00200009237002008850404000", "0152501500000000"); // 2.5sigma
    cuts.AddCut("50100033", "00200009247005008850404000", "0152501500000000"); // TOF -3, 3
  } else if ( trainConfig == 338){ // pdEdx & TOF - phi
    cuts.AddCut("50100033", "00216609237002008850404000", "0152501500000000"); // 2.5sigma
    cuts.AddCut("50100033", "00216609247005008850404000", "0152501500000000"); // TOF -3, 3
  } else if ( trainConfig == 339){ // pdEdx & TOF
    cuts.AddCut("52400033", "00200009237002008850404000", "0152501500000000"); // 2.5sigma
    cuts.AddCut("52400033", "00200009247005008850404000", "0152501500000000"); // TOF -3, 3
    cuts.AddCut("52500033", "00200009237002008850404000", "0152501500000000"); // 2.5sigma
    cuts.AddCut("52500033", "00200009247005008850404000", "0152501500000000"); // TOF -3, 3
  } else if ( trainConfig == 340){ // pdEdx & TOF - phi
    cuts.AddCut("52400033", "00216609237002008850404000", "0152501500000000"); // 2.5sigma
    cuts.AddCut("52400033", "00216609247005008850404000", "0152501500000000"); // TOF -3, 3
    cuts.AddCut("52500033", "00216609237002008850404000", "0152501500000000"); // 2.5sigma
    cuts.AddCut("52500033", "00216609247005008850404000", "0152501500000000"); // TOF -3, 3
  } else if ( trainConfig == 341){ // qT
    cuts.AddCut("50100033", "00200009247002002850404000", "0152501500000000"); // 0.06 2D
    cuts.AddCut("50100033", "00200009247002009850404000", "0152501500000000"); // 0.03 2D
  } else if ( trainConfig == 342){ // qT - phi
    cuts.AddCut("50100033", "00216609247002002850404000", "0152501500000000"); // 0.06 2D
    cuts.AddCut("50100033", "00216609247002009850404000", "0152501500000000"); // 0.03 2D
  } else if ( trainConfig == 343){ // qT
    cuts.AddCut("52400033", "00200009247002002850404000", "0152501500000000"); // 0.06 2D
    cuts.AddCut("52400033", "00200009247002009850404000", "0152501500000000"); // 0.03 2D
    cuts.AddCut("52500033", "00200009247002002850404000", "0152501500000000"); // 0.06 2D
    cuts.AddCut("52500033", "00200009247002009850404000", "0152501500000000"); // 0.03 2D
  } else if ( trainConfig == 344){ // qT - phi
    cuts.AddCut("52400033", "00216609247002002850404000", "0152501500000000"); // 0.06 2D
    cuts.AddCut("52400033", "00216609247002009850404000", "0152501500000000"); // 0.03 2D
    cuts.AddCut("52500033", "00216609247002002850404000", "0152501500000000"); // 0.06 2D
    cuts.AddCut("52500033", "00216609247002009850404000", "0152501500000000"); // 0.03 2D
  } else if ( trainConfig == 345){ // chi2 + psi pair
    cuts.AddCut("50100033", "00200009247002008750404000", "0152501500000000"); // 10+0.1 2D
    cuts.AddCut("50100033", "00200009247002008a50404000", "0152501500000000"); // 25+0.1 2D
  } else if ( trainConfig == 346){ // chi2 + psi pair - phi
    cuts.AddCut("50100033", "00216609247002008750404000", "0152501500000000"); // 10+0.1 2D
    cuts.AddCut("50100033", "00216609247002008a50404000", "0152501500000000"); // 25+0.1 2D
  } else if ( trainConfig == 347){ // chi2 + psi pair
    cuts.AddCut("52400033", "00200009247002008750404000", "0152501500000000"); // 10+0.1 2D
    cuts.AddCut("52400033", "00200009247002008a50404000", "0152501500000000"); // 25+0.1 2D
    cuts.AddCut("52500033", "00200009247002008750404000", "0152501500000000"); // 10+0.1 2D
    cuts.AddCut("52500033", "00200009247002008a50404000", "0152501500000000"); // 25+0.1 2D
  } else if ( trainConfig == 348){ // chi2 + psi pair - phi
    cuts.AddCut("52400033", "00216609247002008750404000", "0152501500000000"); // 10+0.1 2D
    cuts.AddCut("52400033", "00216609247002008a50404000", "0152501500000000"); // 25+0.1 2D
    cuts.AddCut("52500033", "00216609247002008750404000", "0152501500000000"); // 10+0.1 2D
    cuts.AddCut("52500033", "00216609247002008a50404000", "0152501500000000"); // 25+0.1 2D
  } else if ( trainConfig == 349){ // chi2 + psi pair
    cuts.AddCut("50100033", "00200009247002008950404000", "0152501500000000"); // 15+0.1 2D
    cuts.AddCut("50100033", "00200009247002008870404000", "0152501500000000"); // 20+0.07 2D
  } else if ( trainConfig == 350){ // chi2 + psi pair - phi
    cuts.AddCut("50100033", "00216609247002008950404000", "0152501500000000"); // 15+0.1 2D
    cuts.AddCut("50100033", "00216609247002008870404000", "0152501500000000"); // 20+0.07 2D
  } else if ( trainConfig == 351){ // chi2 + psi pair
    cuts.AddCut("52400033", "00200009247002008950404000", "0152501500000000"); // 15+0.1 2D
    cuts.AddCut("52400033", "00200009247002008870404000", "0152501500000000"); // 20+0.07 2D
    cuts.AddCut("52500033", "00200009247002008950404000", "0152501500000000"); // 15+0.1 2D
    cuts.AddCut("52500033", "00200009247002008870404000", "0152501500000000"); // 20+0.07 2D
  } else if ( trainConfig == 352){ // chi2 + psi pair - phi
    cuts.AddCut("52400033", "00216609247002008950404000", "0152501500000000"); // 15+0.1 2D
    cuts.AddCut("52400033", "00216609247002008870404000", "0152501500000000"); // 20+0.07 2D
    cuts.AddCut("52500033", "00216609247002008950404000", "0152501500000000"); // 15+0.1 2D
    cuts.AddCut("52500033", "00216609247002008870404000", "0152501500000000"); // 20+0.07 2D
  } else if ( trainConfig == 353){ // asym 1D & cosPA
    cuts.AddCut("50100033", "00200009247002008857404000", "0152501500000000"); // asym > 8GeV
    cuts.AddCut("50100033", "00200009247002008850004000", "0152501500000000"); // cosPA off
  } else if ( trainConfig == 354){ // asym 1D & cosPA - phi
    cuts.AddCut("50100033", "00216609247002008857404000", "0152501500000000"); // asym > 8GeV
    cuts.AddCut("50100033", "00216609247002008850004000", "0152501500000000"); // cosPA off
  } else if ( trainConfig == 355){ // asym 1D & cosPA
    cuts.AddCut("52400033", "00200009247002008857404000", "0152501500000000"); // asym > 8GeV
    cuts.AddCut("52400033", "00200009247002008850004000", "0152501500000000"); // cosPA off
    cuts.AddCut("52500033", "00200009247002008857404000", "0152501500000000"); // asym > 8GeV
    cuts.AddCut("52500033", "00200009247002008850004000", "0152501500000000"); // cosPA off
  } else if ( trainConfig == 356){ // asym 1D & cosPA - phi
    cuts.AddCut("52400033", "00216609247002008857404000", "0152501500000000"); // asym > 8GeV
    cuts.AddCut("52400033", "00216609247002008850004000", "0152501500000000"); // cosPA off
    cuts.AddCut("52500033", "00216609247002008857404000", "0152501500000000"); // asym > 8GeV
    cuts.AddCut("52500033", "00216609247002008850004000", "0152501500000000"); // cosPA off
    ...
    cuts.AddCut("50100013", "0020000924700200850404000", "0152501500000000"); // 30+0.1 2D
    ...
    cuts.AddCut("50100033", "00200009247002008250404000", "0152501500000000"); // 30+0.1 2D
  } else if ( trainConfig == 364){ // chi2 + psi pair - phi
    cuts.AddCut("50100033", "00216609247002008250404000", "0152501500000000"); // 30+0.1 2D
  } else if ( trainConfig == 365){ // chi2 + psi pair
    cuts.AddCut("52400033", "00200009247002008250404000", "0152501500000000"); // 30+0.1 2D
    cuts.AddCut("52500033", "00200009247002008250404000", "0152501500000000"); // 30+0.1 2D
  } else if ( trainConfig == 366){ // chi2 + psi pair - phi
    cuts.AddCut("52400033", "00216609247002008250404000", "0152501500000000"); // 30+0.1 2D
    cuts.AddCut("52500033", "00216609247002008250404000", "0152501500000000"); // 30+0.1 2D
...
//    HeaderList->Add(Header3);
  ...
  for(Int_t i = 0; i<numberOfCuts; i++){
    ...
    if (trainConfig == 186   || trainConfig == 187 || trainConfig == 190   || trainConfig == 191 || trainConfig == 359   || trainConfig == 360 || trainConfig == 313   || trainConfig == 314){
      if (periodName.CompareTo("LHC14a1a") ==0 || periodName.CompareTo("LHC14a1b") ==0 || periodName.CompareTo("LHC14a1c") ==0 ){
    ...
    if (trainConfig == 188   || trainConfig == 189 || trainConfig == 192   || trainConfig == 193 || trainConfig == 361   || trainConfig == 362 || trainConfig == 315   || trainConfig == 316){
      if (periodName.CompareTo("LHC14a1a") ==0 || periodName.CompareTo("LHC14a1b") ==0 || periodName.CompareTo("LHC14a1c") ==0 ){
        if ( i == 0 && doWeighting)  analysisEventCuts[i]->SetUseReweightingWithHistogramFromFile(kTRUE, kTRUE, kFALSE,fileNameInputForWeighting, Form("Pi0_Hijing_%s_PbPb_2760GeV_2040TPC",periodName.Data()), Form("Eta_Hijing_%s_PbPb_2760GeV_2040TPC",periodName.Data()), "","Pi0_Fit_Data_PbPb_2760GeV_2040V0M","Eta_Fit_Data_PbPb_2760GeV_2040V0M");
