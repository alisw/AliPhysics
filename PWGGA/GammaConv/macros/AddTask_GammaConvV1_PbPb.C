...
void AddTask_GammaConvV1_PbPb(  Int_t     trainConfig                     = 1,                              //change different set of cuts
  ...
  if (trainConfig == 1){ // Standard cuts
    ...
    cuts.AddCut("60100013", "03200009247602008250400000", "0152301500000000"); // 0-5%
    cuts.AddCut("61200013", "03200009247602008250400000", "0152301500000000"); // 5-10%
    cuts.AddCut("50100013", "03200009247602008250400000", "0152301500000000"); // 0-10%
    cuts.AddCut("52400013", "03200009247602008250400000", "0152301500000000"); // 20-40%
    cuts.AddCut("52500013", "03200009247602008250400000", "0152301500000000"); // 20-50% 
  } else if ( trainConfig == 71){ // variation eta  0.65 - added signal
    cuts.AddCut("60100023", "03200009247602008250400000", "0152301500000000"); // 0-5%
    cuts.AddCut("61200023", "03200009247602008250400000", "0152301500000000"); // 5-10%
    cuts.AddCut("50100023", "03200009247602008250400000", "0152301500000000"); // 0-10%
    cuts.AddCut("52400023", "03200009247602008250400000", "0152301500000000"); // 20-40%
    cuts.AddCut("52500023", "03200009247602008250400000", "0152301500000000"); // 20-50% 
  } else if ( trainConfig == 72){ // variation eta  0.65 with phi cut 
    cuts.AddCut("60100013", "03216609247602008250400000", "0152301500000000"); // 0-5%
    cuts.AddCut("61200013", "03216609247602008250400000", "0152301500000000"); // 5-10%
    cuts.AddCut("50100013", "03216609247602008250400000", "0152301500000000"); // 0-10%
    cuts.AddCut("52400013", "03216609247602008250400000", "0152301500000000"); // 20-40%
    cuts.AddCut("52500013", "03216609247602008250400000", "0152301500000000"); // 20-50% 
  } else if ( trainConfig == 73){ // variation eta  0.65 with phi cut - added signal
    cuts.AddCut("60100023", "03216609247602008250400000", "0152301500000000"); // 0-5%
    cuts.AddCut("61200023", "03216609247602008250400000", "0152301500000000"); // 5-10%
    cuts.AddCut("50100023", "03216609247602008250400000", "0152301500000000"); // 0-10%
    cuts.AddCut("52400023", "03216609247602008250400000", "0152301500000000"); // 20-40%
    cuts.AddCut("52500023", "03216609247602008250400000", "0152301500000000"); // 20-50% 
  } else if ( trainConfig == 74){ // variation eta  0.75
    cuts.AddCut("60100013", "04200009247602008250400000", "0152201500000000"); // 0-5%
    cuts.AddCut("61200013", "04200009247602008250400000", "0152201500000000"); // 5-10%
    cuts.AddCut("50100013", "04200009247602008250400000", "0152201500000000"); // 0-10%
    cuts.AddCut("52400013", "04200009247602008250400000", "0152201500000000"); // 20-40%
    cuts.AddCut("52500013", "04200009247602008250400000", "0152201500000000"); // 20-50% 
  } else if ( trainConfig == 75){ // variation eta  0.75 added signal
    cuts.AddCut("60100023", "04200009247602008250400000", "0152201500000000"); // 0-5%
    cuts.AddCut("61200023", "04200009247602008250400000", "0152201500000000"); // 5-10%
    cuts.AddCut("50100023", "04200009247602008250400000", "0152201500000000"); // 0-10%
    cuts.AddCut("52400023", "04200009247602008250400000", "0152201500000000"); // 20-40%
    cuts.AddCut("52500023", "04200009247602008250400000", "0152201500000000"); // 20-50% 
  } else if ( trainConfig == 76){ // variation eta  0.75 with phi cut
    cuts.AddCut("60100013", "04216609247602008250400000", "0152201500000000"); // 0-5%
    cuts.AddCut("61200013", "04216609247602008250400000", "0152201500000000"); // 5-10%
    cuts.AddCut("50100013", "04216609247602008250400000", "0152201500000000"); // 0-10%
    cuts.AddCut("52400013", "04216609247602008250400000", "0152201500000000"); // 20-40%
    cuts.AddCut("52500013", "04216609247602008250400000", "0152201500000000"); // 20-50% 
  } else if ( trainConfig == 77){ // variation eta  0.75 with phi cut - added signal
    cuts.AddCut("60100023", "04216609247602008250400000", "0152201500000000"); // 0-5%
    cuts.AddCut("61200023", "04216609247602008250400000", "0152201500000000"); // 5-10%
    cuts.AddCut("50100023", "04216609247602008250400000", "0152201500000000"); // 0-10%
    cuts.AddCut("52400023", "04216609247602008250400000", "0152201500000000"); // 20-40%
    cuts.AddCut("52500023", "04216609247602008250400000", "0152201500000000"); // 20-50% 
  } else if ( trainConfig == 78){ // min R = 35 cm
    cuts.AddCut("60100013", "00700009247602008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00700009247602008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00700009247602008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00700009247602008250400000", "0152501500000000"); // 10-20%
    cuts.AddCut("52500013", "00700009247602008250400000", "0152501500000000"); // 0-20%
  } else if ( trainConfig == 79){ // min R = 35 cm added signal
    cuts.AddCut("60100023", "00700009247602008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00700009247602008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00700009247602008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00700009247602008250400000", "0152501500000000"); // 10-20%
    cuts.AddCut("52500023", "00700009247602008250400000", "0152501500000000"); // 0-20%
  } else if ( trainConfig == 80){ // min R = 35 cm with phi cut
    cuts.AddCut("60100013", "00716609247602008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00716609247602008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00716609247602008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00716609247602008250400000", "0152501500000000"); // 10-20%
    cuts.AddCut("52500013", "00716609247602008250400000", "0152501500000000"); // 0-20%
  } else if ( trainConfig == 81){ // min R = 35 cm with phi cut - added signal
    cuts.AddCut("60100023", "00716609247602008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00716609247602008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00716609247602008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00716609247602008250400000", "0152501500000000"); // 10-20%
    cuts.AddCut("52500023", "00716609247602008250400000", "0152501500000000"); // 0-20%
  } else if ( trainConfig == 82){ // single pt 0.075
    cuts.AddCut("60100013", "00200049247602008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00200049247602008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00200049247602008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00200049247602008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00200049247602008250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 83){ // single pt 0.075 - added signal
    cuts.AddCut("60100023", "00200049247602008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00200049247602008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00200049247602008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00200049247602008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00200049247602008250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 84){ // single pt 0.075 with phi cut
    cuts.AddCut("60100013", "00216649247602008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00216649247602008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00216649247602008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00216649247602008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00216649247602008250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 85){ // single pt 0.075 with phi cut - added signal
    cuts.AddCut("60100023", "00216649247602008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00216649247602008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00216649247602008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00216649247602008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00216649247602008250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 86){ // single pt 0.1
    cuts.AddCut("60100013", "00200019247602008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00200019247602008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00200019247602008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00200019247602008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00200019247602008250400000", "0152501500000000"); //20-50%
  } else if ( trainConfig == 87){ // single pt 0.1 - added signal
    cuts.AddCut("60100023", "00200019247602008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00200019247602008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00200019247602008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00200019247602008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00200019247602008250400000", "0152501500000000"); //20-50%
  } else if ( trainConfig == 88){ // single pt 0.1 with phi cut
    cuts.AddCut("60100013", "00216619247602008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00216619247602008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00216619247602008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00216619247602008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00216619247602008250400000", "0152501500000000"); //20-50%
  } else if ( trainConfig == 89){ // single pt 0.1  with phi cut - added signal
    cuts.AddCut("60100023", "00216619247602008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00216619247602008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00216619247602008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00216619247602008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00216619247602008250400000", "0152501500000000"); //20-50%
  } else if ( trainConfig == 90){ // variation TPC cls 0.7
    cuts.AddCut("60100013", "00200006247602008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00200006247602008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00200006247602008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00200006247602008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00200006247602008250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 91){ // variation TPC cls 0.7 added signal
    cuts.AddCut("60100023", "00200006247602008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00200006247602008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00200006247602008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00200006247602008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00200006247602008250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 92){ // variation TPC cls 0.7 with phi cut 
    cuts.AddCut("60100013", "00216606247602008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00216606247602008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00216606247602008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00216606247602008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00216606247602008250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 93){ // variation TPC cls 0.7 with phi cut - added signal
    cuts.AddCut("60100023", "00216606247602008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00216606247602008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00216606247602008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00216606247602008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00216606247602008250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 94){ // variation TPC cls 0.35
    cuts.AddCut("60100013", "00200008247602008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00200008247602008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00200008247602008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00200008247602008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00200008247602008250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 95){ // variation TPC cls 0.35 - added signal
    cuts.AddCut("60100023", "00200008247602008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00200008247602008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00200008247602008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00200008247602008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00200008247602008250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 96){ // variation TPC cls 0.35 with phi cut
    cuts.AddCut("60100013", "00216608247602008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00216608247602008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00216608247602008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00216608247602008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00216608247602008250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 97){ // variation TPC cls 0.35  with phi cut - added signal
    cuts.AddCut("60100023", "00216608247602008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00216608247602008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00216608247602008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00216608247602008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00216608247602008250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 98){ // variation edEdx  -4,5
    cuts.AddCut("60100013", "00200009347602008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00200009347602008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00200009347602008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00200009347602008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00200009347602008250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 99){ // variation edEdx  -4,5 - added signal
    cuts.AddCut("60100023", "00200009347602008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00200009347602008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00200009347602008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00200009347602008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00200009347602008250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 100){ // variation edEdx  -4,5 with phi cut
    cuts.AddCut("60100013", "00216609347602008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00216609347602008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00216609347602008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00216609347602008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00216609347602008250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 101){ // variation edEdx  -4,5 with phi cut - added signal
    cuts.AddCut("60100023", "00216609347602008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00216609347602008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00216609347602008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00216609347602008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00216609347602008250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 102){ // variation edEdx  -2.5,4
    cuts.AddCut("60100013", "00200009647602008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00200009647602008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00200009647602008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00200009647602008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00200009647602008250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 103){ // variation edEdx  -2.5,4 - added signal
    cuts.AddCut("60100023", "00200009647602008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00200009647602008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00200009647602008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00200009647602008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00200009647602008250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 104){ // variation edEdx  -2.5,4 with phi cut
    cuts.AddCut("60100013", "00216609647602008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00216609647602008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00216609647602008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00216609647602008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00216609647602008250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 105){ // variation edEdx  -2.5,4 with phi cut - added signal
    cuts.AddCut("60100023", "00216609647602008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00216609647602008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00216609647602008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00216609647602008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00216609647602008250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 106){ //variation pion p dEdx 2.0 sigma, 1 sigma high pt cut
    cuts.AddCut("60100013", "00200009287602008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00200009287602008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00200009287602008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00200009287602008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00200009287602008250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 107){ //variation pion p dEdx 2.0 sigma, 1 sigma high pt cut - added signal
    cuts.AddCut("60100023", "00200009287602008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00200009287602008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00200009287602008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00200009287602008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00200009287602008250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 108){ //variation pion p dEdx 2.0 sigma, 1 sigma high pt cut with phi cut
    cuts.AddCut("60100013", "00216609287602008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00216609287602008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00216609287602008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00216609287602008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00216609287602008250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 109){ //variation pion p dEdx 2.0 sigma, 1 sigma high pt cut with phi cut - added signal
    cuts.AddCut("60100023", "00216609287602008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00216609287602008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00216609287602008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00216609287602008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00216609287602008250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 110){ //variation pion p dEdx 3.0 sigma, no high pt cut
    cuts.AddCut("60100013", "00200009247002008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00200009247002008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00200009247002008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00200009247002008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00200009247002008250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 111){ //variation pion p dEdx 3.0 sigma, no high pt cut - added signal
    cuts.AddCut("60100023", "00200009247002008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00200009247002008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00200009247002008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00200009247002008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00200009247002008250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 112){ //variation pion p dEdx 3.0 sigma, no high pt cut with phi cut
    cuts.AddCut("60100013", "00216609247002008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00216609247002008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00216609247002008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00216609247002008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00216609247002008250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 113){ //variation pion p dEdx 3.0 sigma, no high pt cut  with phi cut - added signal
    cuts.AddCut("60100023", "00216609247002008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00216609247002008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00216609247002008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00216609247002008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00216609247002008250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 114){ //variation pion p dEdx std (3.0) sigma, but 0.3-3.
    cuts.AddCut("60100013", "00200009245402008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00200009245402008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00200009245402008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00200009245402008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00200009245402008250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 115){ //variation pion p dEdx 3.0 sigma,  0.3-3. - added signal
    cuts.AddCut("60100023", "00200009245402008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00200009245402008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00200009245402008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00200009245402008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00200009245402008250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 116){ //variation pion p dEdx 3.0 sigma, 0.3-3. with phi cut
    cuts.AddCut("60100013", "00216609245402008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00216609245402008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00216609245402008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00216609245402008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00216609245402008250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 117){ //variation pion p dEdx 3.0 sigma,  0.3-3. with phi cut - added signal
    cuts.AddCut("60100023", "00216609245402008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00216609245402008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00216609245402008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00216609245402008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00216609245402008250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 118){ // TOF el. PID -3,5
    cuts.AddCut("60100013", "00200009247603008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00200009247603008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00200009247603008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00200009247603008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00200009247603008250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 119){ // TOF el. PID -3,5 - added signal
    cuts.AddCut("60100023", "00200009247603008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00200009247603008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00200009247603008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00200009247603008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00200009247603008250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 120){ // TOF el. PID -3,5 with phi cut 
    cuts.AddCut("60100013", "00216609247603008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00216609247603008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00216609247603008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00216609247603008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00216609247603008250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 121){ // TOF el. PID -3,5 with phi cut - added signal
    cuts.AddCut("60100023", "00216609247603008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00216609247603008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00216609247603008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00216609247603008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00216609247603008250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 122){ // TOF el. PID -2,3
    cuts.AddCut("60100013", "00200009247604008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00200009247604008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00200009247604008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00200009247604008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00200009247604008250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 123){ // TOF el. PID -2,3 - added signal
    cuts.AddCut("60100023", "00200009247604008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00200009247604008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00200009247604008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00200009247604008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00200009247604008250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 124){ // TOF el. PID -2,3 with phi cut 
    cuts.AddCut("60100013", "00216609247604008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00216609247604008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00216609247604008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00216609247604008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00216609247604008250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 125){ // TOF el. PID -2,3  with phi cut - added signal
    cuts.AddCut("60100023", "00216609247604008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00216609247604008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00216609247604008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00216609247604008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00216609247604008250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 126){ // qt 0.03 2D
    cuts.AddCut("60100013", "00200009247602009250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00200009247602009250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00200009247602009250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00200009247602009250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00200009247602009250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 127){ // qt 0.03 2D - added signal
    cuts.AddCut("60100023", "00200009247602009250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00200009247602009250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00200009247602009250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00200009247602009250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00200009247602009250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 128){ // qt 0.03 2D with phi cut 
    cuts.AddCut("60100013", "00216609247602009250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00216609247602009250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00216609247602009250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00216609247602009250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00216609247602009250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 129){ // qt 0.03 2D with phi cut - added signal
    cuts.AddCut("60100023", "00216609247602009250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00216609247602009250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00216609247602009250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00216609247602009250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00216609247602009250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 130){ // qt 0.06 2D
    cuts.AddCut("60100013", "00200009247602002250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00200009247602002250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00200009247602002250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00200009247602002250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00200009247602002250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 131){ // qt 0.06 2D - added signal
    cuts.AddCut("60100023", "00200009247602002250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00200009247602002250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00200009247602002250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00200009247602002250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00200009247602002250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 132){ // qt 0.06 2D with phi cut 
    cuts.AddCut("60100013", "00216609247602002250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00216609247602002250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00216609247602002250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00216609247602002250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00216609247602002250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 133){ // qt 0.06 2D with phi cut - added signal
    cuts.AddCut("60100023", "00216609247602002250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00216609247602002250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00216609247602002250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00216609247602002250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00216609247602002250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 134){ // chi2  50.
    cuts.AddCut("60100013", "00200009247602008150400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00200009247602008150400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00200009247602008150400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00200009247602008150400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00200009247602008150400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 135){ // chi2  50.  added signal
    cuts.AddCut("60100023", "00200009247602008150400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00200009247602008150400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00200009247602008150400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00200009247602008150400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00200009247602008150400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 136){ // chi2  50. with phi cut 
    cuts.AddCut("60100013", "00216609247602008150400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00216609247602008150400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00216609247602008150400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00216609247602008150400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00216609247602008150400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 137){ // chi2  50. with phi cut - added signal
    cuts.AddCut("60100023", "00216609247602008150400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00216609247602008150400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00216609247602008150400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00216609247602008150400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00216609247602008150400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 138){ // chi2  20.
    cuts.AddCut("60100013", "00200009247602008850400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00200009247602008850400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00200009247602008850400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00200009247602008850400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00200009247602008850400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 139){ // chi2  20.  added signal
    cuts.AddCut("60100023", "00200009247602008850400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00200009247602008850400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00200009247602008850400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00200009247602008850400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00200009247602008850400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 140){ // chi2  20. with phi cut 
    cuts.AddCut("60100013", "00216609247602008850400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00216609247602008850400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00216609247602008850400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00216609247602008850400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00216609247602008850400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 141){ // chi2  20. with phi cut - added signal
    cuts.AddCut("60100023", "00216609247602008850400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00216609247602008850400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00216609247602008850400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00216609247602008850400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00216609247602008850400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 142){ // psi pair 0.05 2D
    cuts.AddCut("60100013", "00200009247602008260400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00200009247602008260400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00200009247602008260400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00200009247602008260400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00200009247602008260400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 143){ // psi pair 0.05 2D - added signal
    cuts.AddCut("60100023", "00200009247602008260400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00200009247602008260400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00200009247602008260400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00200009247602008260400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00200009247602008260400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 144){ // psi pair 0.05 2D with phi cut 
    cuts.AddCut("60100013", "00216609247602008260400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00216609247602008260400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00216609247602008260400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00216609247602008260400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00216609247602008260400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 145){ // psi pair 0.05 2D with phi cut - added signal
    cuts.AddCut("60100023", "00216609247602008260400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00216609247602008260400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00216609247602008260400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00216609247602008260400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00216609247602008260400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 146){ // psi pair 0.2 2D
    cuts.AddCut("60100013", "00200009247602008280400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00200009247602008280400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00200009247602008280400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00200009247602008280400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00200009247602008280400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 147){ // psi pair 0.2 2D - added signal
    cuts.AddCut("60100023", "00200009247602008280400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00200009247602008280400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00200009247602008280400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00200009247602008280400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00200009247602008280400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 148){ // psi pair 0.2 2D with phi cut 
    cuts.AddCut("60100013", "00216609247602008280400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00216609247602008280400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00216609247602008280400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00216609247602008280400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00216609247602008280400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 149){ // psi pair 0.2 2D with phi cut - added signal
    cuts.AddCut("60100023", "00216609247602008280400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00216609247602008280400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00216609247602008280400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00216609247602008280400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00216609247602008280400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 150){ // cosPA -1
    cuts.AddCut("60100013", "00200009247602008250000000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00200009247602008250000000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00200009247602008250000000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00200009247602008250000000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00200009247602008250000000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 151){ // cosPA -1 - added signal
    cuts.AddCut("60100023", "00200009247602008250000000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00200009247602008250000000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00200009247602008250000000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00200009247602008250000000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00200009247602008250000000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 152){ // cosPA -1 with phi cut
    cuts.AddCut("60100013", "00216609247602008250000000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00216609247602008250000000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00216609247602008250000000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00216609247602008250000000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00216609247602008250000000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 153){ // cosPA -1 with phi cut - added signal
    cuts.AddCut("60100023", "00216609247602008250000000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00216609247602008250000000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00216609247602008250000000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00216609247602008250000000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00216609247602008250000000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 154){ // variation alpha 0.75
    cuts.AddCut("60100013", "00200009247602008250400000", "0152505500000000"); // 0-5%
    cuts.AddCut("61200013", "00200009247602008250400000", "0152505500000000"); // 5-10%
    cuts.AddCut("50100013", "00200009247602008250400000", "0152505500000000"); // 0-10%
    cuts.AddCut("52400013", "00200009247602008250400000", "0152505500000000"); // 20-40%
    cuts.AddCut("52500013", "00200009247602008250400000", "0152505500000000"); // 20-50%
  } else if ( trainConfig == 155){ // variation alpha 0.75 - added signal
    cuts.AddCut("60100023", "00200009247602008250400000", "0152505500000000"); // 0-5%
    cuts.AddCut("61200023", "00200009247602008250400000", "0152505500000000"); // 5-10%
    cuts.AddCut("50100023", "00200009247602008250400000", "0152505500000000"); // 0-10%
    cuts.AddCut("52400023", "00200009247602008250400000", "0152505500000000"); // 20-40%
    cuts.AddCut("52500023", "00200009247602008250400000", "0152505500000000"); // 20-50%
  } else if ( trainConfig == 156){ // variation alpha 0.75 with phi cut
    cuts.AddCut("60100013", "00216609247602008250400000", "0152505500000000"); // 0-5%
    cuts.AddCut("61200013", "00216609247602008250400000", "0152505500000000"); // 5-10%
    cuts.AddCut("50100013", "00216609247602008250400000", "0152505500000000"); // 0-10%
    cuts.AddCut("52400013", "00216609247602008250400000", "0152505500000000"); // 20-40%
    cuts.AddCut("52500013", "00216609247602008250400000", "0152505500000000"); // 20-50%
  } else if ( trainConfig == 157){ // variation alpha 0.75 with phi cut - added signal
    cuts.AddCut("60100023", "00216609247602008250400000", "0152505500000000"); // 0-5%
    cuts.AddCut("61200023", "00216609247602008250400000", "0152505500000000"); // 5-10%
    cuts.AddCut("50100023", "00216609247602008250400000", "0152505500000000"); // 0-10%
    cuts.AddCut("52400023", "00216609247602008250400000", "0152505500000000"); // 20-40%
    cuts.AddCut("52500023", "00216609247602008250400000", "0152505500000000"); // 20-50%
  } else if ( trainConfig == 158){ // variation alpha 1.
    cuts.AddCut("60100013", "00200009247602008250400000", "0152503500000000"); // 0-5%
    cuts.AddCut("61200013", "00200009247602008250400000", "0152503500000000"); // 5-10%
    cuts.AddCut("50100013", "00200009247602008250400000", "0152503500000000"); // 0-10%
    cuts.AddCut("52400013", "00200009247602008250400000", "0152503500000000"); // 20-40%
    cuts.AddCut("52500013", "00200009247602008250400000", "0152503500000000"); // 20-50%
  } else if ( trainConfig == 159){ // variation alpha 1. - added signal
    cuts.AddCut("60100023", "00200009247602008250400000", "0152503500000000"); // 0-5%
    cuts.AddCut("61200023", "00200009247602008250400000", "0152503500000000"); // 5-10%
    cuts.AddCut("50100023", "00200009247602008250400000", "0152503500000000"); // 0-10%
    cuts.AddCut("52400023", "00200009247602008250400000", "0152503500000000"); // 20-40%
    cuts.AddCut("52500023", "00200009247602008250400000", "0152503500000000"); // 20-50%
  } else if ( trainConfig == 160){ // variation alpha 1. with phi cut
    cuts.AddCut("60100013", "00216609247602008250400000", "0152503500000000"); // 0-5%
    cuts.AddCut("61200013", "00216609247602008250400000", "0152503500000000"); // 5-10%
    cuts.AddCut("50100013", "00216609247602008250400000", "0152503500000000"); // 0-10%
    cuts.AddCut("52400013", "00216609247602008250400000", "0152503500000000"); // 20-40%
    cuts.AddCut("52500013", "00216609247602008250400000", "0152503500000000"); // 20-50%
  } else if ( trainConfig == 161){ // variation alpha 1. with phi cut - added signal
    cuts.AddCut("60100023", "00216609247602008250400000", "0152503500000000"); // 0-5%
    cuts.AddCut("61200023", "00216609247602008250400000", "0152503500000000"); // 5-10%
    cuts.AddCut("50100023", "00216609247602008250400000", "0152503500000000"); // 0-10%
    cuts.AddCut("52400023", "00216609247602008250400000", "0152503500000000"); // 20-40%
    cuts.AddCut("52500023", "00216609247602008250400000", "0152503500000000"); // 20-50%
  } else if ( trainConfig == 162){ // standard LHC11h cut selection
    cuts.AddCut("60100013", "00200009247602008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00200009247602008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00200009247602008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00200009247602008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00200009247602008250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 163){ // standard LHC11h cut selection - added signal
    cuts.AddCut("60100023", "00200009247602008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00200009247602008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00200009247602008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00200009247602008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00200009247602008250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 164){ // standard LHC11h cut selection with phi cut
    cuts.AddCut("60100013", "00216609247602008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00216609247602008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00216609247602008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00216609247602008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00216609247602008250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 165){ // standard LHC11h cut selection with phi cut - added signal
    cuts.AddCut("60100023", "00216609247602008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00216609247602008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00216609247602008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00216609247602008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00216609247602008250400000", "0152501500000000"); // 20-50%
    ...
    cuts.AddCut("52400013", "00200009247602008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00200009247602008250400000", "0152501500000000"); // 20-50%
//     cuts.AddCut("51200013", "00200009247602008250400000", "0152501500000000"); //with fDoCentralityFlat = 2
//     cuts.AddCut("50800013", "00200009247602008250400000", "0152501500000000"); //with fDoCentralityFlat = 8
    ...
    cuts.AddCut("52400013", "00200009247602008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00200009247602008250400000", "0152501500000000"); // 20-50%
//     cuts.AddCut("51200023", "00200009247602008250400000", "0152501500000000"); //with fDoCentralityFlat = 2
//     cuts.AddCut("50800023", "00200009247602008250400000", "0152501500000000"); //with fDoCentralityFlat = 8
    ...
    cuts.AddCut("52400013", "00200009247602008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00200009247602008250400000", "0152501500000000"); // 20-50%
//     cuts.AddCut("51200013", "00216609247602008250400000", "0152501500000000"); //with fDoCentralityFlat = 2
//     cuts.AddCut("50800013", "00216609247602008250400000", "0152501500000000"); //with fDoCentralityFlat = 8
    ...
    cuts.AddCut("52400013", "00200009247602008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00200009247602008250400000", "0152501500000000"); // 20-50%
//     cuts.AddCut("51200023", "00216609247602008250400000", "0152501500000000"); //with fDoCentralityFlat = 2
//     cuts.AddCut("50800023", "00216609247602008250400000", "0152501500000000"); //with fDoCentralityFlat = 8
  } else if ( trainConfig == 186){ // variation with phi cut at 2.0 - 4.0
    cuts.AddCut("60100013", "00215509247602008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00215509247602008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00215509247602008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00215509247602008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00215509247602008250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 187){ // variation with phi cut at 2.0 - 4.0 - added signal
    cuts.AddCut("60100023", "00215509247602008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00215509247602008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00215509247602008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00215509247602008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00215509247602008250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 188){ // variation with phi cut at 2.4 - 3.6
    cuts.AddCut("60100013", "00217709247602008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00217709247602008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00217709247602008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00217709247602008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00217709247602008250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 189){ // variation with phi cut at 2.4 - 3.6 - added signal
    cuts.AddCut("60100023", "00217709247602008250400000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00217709247602008250400000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00217709247602008250400000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00217709247602008250400000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00217709247602008250400000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 190){ // open an. cut studies 
    cuts.AddCut("50100013", "00200009247602008250400000", "0152501500000000"); // std: 0 - 3.14 (pi)
    cuts.AddCut("50100013", "00200009247602008250400000", "0152501500000002"); // 0 - pt dep
    cuts.AddCut("50100013", "00200009247602008250400000", "0152501500000022"); // pt dep - pt dep
    cuts.AddCut("50100013", "00200009247602008250400000", "0152501500000001"); // 0 - pt dep
    cuts.AddCut("50100013", "00200009247602008250400000", "0152501500000021"); // pt dep - pt dep
  } else if ( trainConfig == 191){ // open an. cut studies - added signal
    cuts.AddCut("50100023", "00200009247602008250400000", "0152501500000000"); // std: 0 - 3.14 (pi)
    cuts.AddCut("50100023", "00200009247602008250400000", "0152501500000002"); // 0 - pt dep
    cuts.AddCut("50100023", "00200009247602008250400000", "0152501500000022"); // pt dep - pt dep
    cuts.AddCut("50100023", "00200009247602008250400000", "0152501500000001"); // 0 - pt dep
    cuts.AddCut("50100023", "00200009247602008250400000", "0152501500000021"); // pt dep - pt dep
  } else if ( trainConfig == 192){ // open an. cut studies - with phi cut 
    cuts.AddCut("50100013", "00216609247602008250400000", "0152501500000000"); // std: 0 - 3.14 (pi)
    cuts.AddCut("50100013", "00216609247602008250400000", "0152501500000002"); // 0 - pt dep
    cuts.AddCut("50100013", "00216609247602008250400000", "0152501500000022"); // pt dep - pt dep
    cuts.AddCut("50100013", "00216609247602008250400000", "0152501500000001"); // 0 - pt dep
    cuts.AddCut("50100013", "00216609247602008250400000", "0152501500000021"); // pt dep - pt dep
  } else if ( trainConfig == 193){ // open an. cut studies - with phi cut added signals
    cuts.AddCut("50100023", "00216609247602008250400000", "0152501500000000"); // std: 0 - 3.14 (pi)
    cuts.AddCut("50100023", "00216609247602008250400000", "0152501500000002"); // 0 - pt dep
    cuts.AddCut("50100023", "00216609247602008250400000", "0152501500000022"); // pt dep - pt dep
    cuts.AddCut("50100023", "00216609247602008250400000", "0152501500000001"); // 0 - pt dep
    cuts.AddCut("50100023", "00216609247602008250400000", "0152501500000021"); // pt dep - pt dep
  ...
  } else if ( trainConfig == 198){ // kappa cut (0 - 1.5) on top of std cut
    cuts.AddCut("60100013", "00200009400002008250404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00200009400002008250404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00200009400002008250404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00200009400002008250404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00200009400002008250404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 199){ // kappa cut (0 - 1.5) on top of std cut - Added sig.
    cuts.AddCut("60100023", "00200009400002008250404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00200009400002008250404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00200009400002008250404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00200009400002008250404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00200009400002008250404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 200){ // kappa cut (0 - 1.5) on top of std cut
    cuts.AddCut("60100013", "00216609400002008250404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00216609400002008250404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00216609400002008250404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00216609400002008250404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00216609400002008250404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 201){ // kappa cut (0 - 1.5) on top of std cut - Added sig.
    cuts.AddCut("60100023", "00216609400002008250404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00216609400002008250404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00216609400002008250404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00216609400002008250404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00216609400002008250404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 202){ // psi pair 0.2 2D + kappa cut (0 - 1.5)
    cuts.AddCut("60100013", "00200009400002008280404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00200009400002008280404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00200009400002008280404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00200009400002008280404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00200009400002008280404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 203){ // psi pair 0.2 2D + kappa cut (0 - 1.5) - added signal
    cuts.AddCut("60100023", "00200009400002008280404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00200009400002008280404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00200009400002008280404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00200009400002008280404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00200009400002008280404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 204){ // psi pair 0.2 2D + kappa cut (0 - 1.5) with phi cut 
    cuts.AddCut("60100013", "00216609400002008280404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00216609400002008280404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00216609400002008280404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00216609400002008280404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00216609400002008280404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 205){ // psi pair 0.2 2D + kappa cut (0 - 1.5) with phi cut - added signal
    cuts.AddCut("60100023", "00216609400002008280404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00216609400002008280404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00216609400002008280404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00216609400002008280404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00216609400002008280404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 206){ // kappa cut (0 - 2) on top of std cut
    cuts.AddCut("60100013", "00200009300002008250404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00200009300002008250404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00200009300002008250404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00200009300002008250404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00200009300002008250404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 207){ // kappa cut (0 - 2) on top of std cut - Added sig.
    cuts.AddCut("60100023", "00200009300002008250404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00200009300002008250404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00200009300002008250404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00200009300002008250404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00200009300002008250404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 208){ // kappa cut (0 - 2) on top of std cut
    cuts.AddCut("60100013", "00216609300002008250404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00216609300002008250404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00216609300002008250404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00216609300002008250404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00216609300002008250404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 209){ // kappa cut (0 - 2) on top of std cut - Added sig.
    cuts.AddCut("60100023", "00216609300002008250404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00216609300002008250404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00216609300002008250404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00216609300002008250404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00216609300002008250404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 210){ // psi pair 0.2 2D + kappa cut (0 - 2)
    cuts.AddCut("60100013", "00200009300002008280404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00200009300002008280404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00200009300002008280404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00200009300002008280404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00200009300002008280404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 211){ // psi pair 0.2 2D + kappa cut (0 - 2) - added signal
    cuts.AddCut("60100023", "00200009300002008280404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00200009300002008280404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00200009300002008280404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00200009300002008280404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00200009300002008280404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 212){ // psi pair 0.2 2D + kappa cut (0 - 2) with phi cut 
    cuts.AddCut("60100013", "00216609300002008280404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00216609300002008280404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00216609300002008280404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00216609300002008280404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00216609300002008280404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 213){ // psi pair 0.2 2D + kappa cut (0 - 2) with phi cut - added signal
    cuts.AddCut("60100023", "00216609300002008280404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00216609300002008280404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00216609300002008280404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00216609300002008280404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00216609300002008280404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 214){ // standard LH11h with asymmetry pt dependent cut
    cuts.AddCut("60100013", "00200009247602008254404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00200009247602008254404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00200009247602008254404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00200009247602008254404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00200009247602008254404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 215){ //  standard LH11h with asymmetry pt dependent cut - added signal
    cuts.AddCut("60100023", "00200009247602008254404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00200009247602008254404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00200009247602008254404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00200009247602008254404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00200009247602008254404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 216){ // standard LH11h with asymmetry pt dependent cut
    cuts.AddCut("60100013", "00216609247602008254404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00216609247602008254404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00216609247602008254404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00216609247602008254404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00216609247602008254404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 217){ // standard LH11h with asymmetry pt dependent cut - added signal
    cuts.AddCut("60100023", "00216609247602008254404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00216609247602008254404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00216609247602008254404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00216609247602008254404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00216609247602008254404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 218){ // asymmetry pt dependent cut + psi pair 0.2 2D
    cuts.AddCut("60100013", "00200009247602008284404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00200009247602008284404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00200009247602008284404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00200009247602008284404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00200009247602008284404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 219){ // asymmetry pt dependent cut + psi pair 0.2 2D - added signal
    cuts.AddCut("60100023", "00200009247602008284404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00200009247602008284404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00200009247602008284404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00200009247602008284404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00200009247602008284404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 220){ // asymmetry pt dependent cut + psi pair 0.2 2D
    cuts.AddCut("60100013", "00216609247602008284404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00216609247602008284404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00216609247602008284404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00216609247602008284404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00216609247602008284404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 221){ // asymmetry pt dependent cut + psi pair 0.2 2D - added signal
    cuts.AddCut("60100023", "00216609247602008284404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00216609247602008284404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00216609247602008284404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00216609247602008284404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00216609247602008284404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 222){ // low pt sigma rejection
    cuts.AddCut("60100013", "00200009247642008250404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00200009247642008250404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00200009247642008250404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00200009247642008250404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00200009247642008250404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 223){ // low pt sigma rejection - added signal
    cuts.AddCut("60100023", "00200009247642008250404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00200009247642008250404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00200009247642008250404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00200009247642008250404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00200009247642008250404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 224){ // low pt sigma rejection with phi cut
    cuts.AddCut("60100013", "00216609247642008250404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00216609247642008250404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00216609247642008250404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00216609247642008250404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00216609247642008250404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 225){ // low pt sigma rejection with phi cut - added signal
    cuts.AddCut("60100023", "00216609247642008250404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00216609247642008250404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00216609247642008250404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00216609247642008250404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00216609247642008250404000", "0152501500000000"); // 20-50%
  ...
  } else if ( trainConfig == 230){ // standard LHC11h cut selection - psi pair 1D
    cuts.AddCut("60100013", "00200009247602008210404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00200009247602008210404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00200009247602008210404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00200009247602008210404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00200009247602008210404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 231){ // standard LHC11h cut selection - psi pair 1D - added signal
    cuts.AddCut("60100023", "00200009247602008210404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00200009247602008210404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00200009247602008210404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00200009247602008210404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00200009247602008210404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 232){ // standard LHC11h cut selection - psi pair 1D with phi cut
    cuts.AddCut("60100013", "00216609247602008210404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00216609247602008210404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00216609247602008210404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00216609247602008210404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00216609247602008210404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 233){ // standard LHC11h cut selection - psi pair 1D with phi cut - added signal
    cuts.AddCut("60100023", "00216609247602008210404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00216609247602008210404000", "0152501500000000"); // 5-10%
    ...
    cuts.AddCut("50100113", "00200009247602008250404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400113", "00200009247602008250404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500113", "00200009247602008250404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 236){ // SPD pileup rejection
    cuts.AddCut("60100123", "00200009247602008250404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200123", "00200009247602008250404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100123", "00200009247602008250404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400123", "00200009247602008250404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500123", "00200009247602008250404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 237){ // SPD pileup rejection
    cuts.AddCut("60100113", "00216609247602008250404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200113", "00216609247602008250404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100113", "00216609247602008250404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400113", "00216609247602008250404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500113", "00216609247602008250404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 238){ // SPD pileup rejection
    cuts.AddCut("60100123", "00216609247602008250404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200123", "00216609247602008250404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100123", "00216609247602008250404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400123", "00216609247602008250404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500123", "00216609247602008250404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 239){ // different std cut 
    cuts.AddCut("60100013", "00200009345602008250404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00200009345602008250404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00200009345602008250404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00200009345602008250404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00200009345602008250404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 240){ //  different std cut 
    cuts.AddCut("60100023", "00200009345602008250404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00200009345602008250404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00200009345602008250404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00200009345602008250404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00200009345602008250404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 241){ //  different std cut 
    cuts.AddCut("60100013", "00216609345602008250404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00216609345602008250404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00216609345602008250404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00216609345602008250404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00216609345602008250404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 242){ //  different std cut 
    cuts.AddCut("60100023", "00216609345602008250404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00216609345602008250404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00216609345602008250404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00216609345602008250404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00216609345602008250404000", "0152501500000000"); // 20-50%
    ...
    cuts.AddCut("21210113", "00200009227302008250404000", "0152201500900000"); // 10-20%
    cuts.AddCut("22510113", "00200009227302008250404000", "0152201500900000"); // 20-50%
    cuts.AddCut("25910113", "00200009227302008250404000", "0152201500900000"); // 50-90%
    cuts.AddCut("20010113", "00200009227302008250404000", "0152201500900000"); //  0-100%
...
//    HeaderList->Add(Header3);
  ...
  for(Int_t i = 0; i<numberOfCuts; i++){
    ...
    if (trainConfig == 70    || trainConfig == 72    || trainConfig == 74    || trainConfig == 76   || trainConfig == 78   || 
        ...
        trainConfig == 186   || trainConfig == 188   || trainConfig == 194   || trainConfig == 196  || trainConfig == 198  || 
        trainConfig == 200   || trainConfig == 202   || trainConfig == 204   || trainConfig == 206  || trainConfig == 208  ||
        trainConfig == 210   || trainConfig == 212   || trainConfig == 214   || trainConfig == 216  || trainConfig == 218  ||
        trainConfig == 220   || trainConfig == 222   || trainConfig == 224   || trainConfig == 226  || trainConfig == 228  ||
        trainConfig == 230   || trainConfig == 232	 || trainConfig == 235   || trainConfig == 237  || trainConfig == 239  ||
        trainConfig == 241){
      if (periodName.CompareTo("LHC14a1a") ==0 || periodName.CompareTo("LHC14a1b") ==0 || periodName.CompareTo("LHC14a1c") ==0 ){
        if ( i == 0 && doWeighting)  analysisEventCuts[i]->SetUseReweightingWithHistogramFromFile(kTRUE, kTRUE, kFALSE,fileNameInputForWeighting, Form("Pi0_Hijing_%s_PbPb_2760GeV_0005TPC",periodName.Data()), Form("Eta_Hijing_%s_PbPb_2760GeV_0005TPC",periodName.Data()), "","Pi0_Fit_Data_PbPb_2760GeV_0005V0M","Eta_Fit_Data_PbPb_2760GeV_0005V0M");
        if ( i == 1 && doWeighting)  analysisEventCuts[i]->SetUseReweightingWithHistogramFromFile(kTRUE, kTRUE, kFALSE,fileNameInputForWeighting, Form("Pi0_Hijing_%s_PbPb_2760GeV_0510TPC",periodName.Data()), Form("Eta_Hijing_%s_PbPb_2760GeV_0510TPC",periodName.Data()), "","Pi0_Fit_Data_PbPb_2760GeV_0510V0M","Eta_Fit_Data_PbPb_2760GeV_0510V0M");
    ...
    if (trainConfig == 71    || trainConfig == 73    || trainConfig == 75    || trainConfig == 77    || trainConfig == 79    ||
        ...
        trainConfig == 187   || trainConfig == 189   || trainConfig == 195   || trainConfig == 197   || trainConfig == 199   || 
        trainConfig == 201   || trainConfig == 203   || trainConfig == 205   || trainConfig == 207   || trainConfig == 209   ||
        trainConfig == 211   || trainConfig == 213   || trainConfig == 215   || trainConfig == 217   || trainConfig == 219   ||
        trainConfig == 221   || trainConfig == 223   || trainConfig == 225   || trainConfig == 227   || trainConfig == 229   ||
        trainConfig == 231   || trainConfig == 233	 || trainConfig == 236   || trainConfig == 238   || trainConfig == 240   ||
        trainConfig == 242){
      if (periodName.CompareTo("LHC14a1a") ==0 || periodName.CompareTo("LHC14a1b") ==0 || periodName.CompareTo("LHC14a1c") ==0 ){
        if ( i == 0 && doWeighting)  analysisEventCuts[i]->SetUseReweightingWithHistogramFromFile(kTRUE, kTRUE, kFALSE,fileNameInputForWeighting, Form("Pi0_Hijing_%s_addSig_PbPb_2760GeV_0005TPC",periodName.Data()), Form("Eta_Hijing_%s_addSig_PbPb_2760GeV_0005TPC",periodName.Data()), "","Pi0_Fit_Data_PbPb_2760GeV_0005V0M","Eta_Fit_Data_PbPb_2760GeV_0005V0M");
        if ( i == 1 && doWeighting)  analysisEventCuts[i]->SetUseReweightingWithHistogramFromFile(kTRUE, kTRUE, kFALSE,fileNameInputForWeighting, Form("Pi0_Hijing_%s_addSig_PbPb_2760GeV_0510TPC",periodName.Data()), Form("Eta_Hijing_%s_addSig_PbPb_2760GeV_0510TPC",periodName.Data()), "","Pi0_Fit_Data_PbPb_2760GeV_0510V0M","Eta_Fit_Data_PbPb_2760GeV_0510V0M");
    ...
    if (trainConfig == 300 || trainConfig == 301 || trainConfig == 302  || trainConfig == 303  || trainConfig == 304  || trainConfig == 305 || 
        ...
        (trainConfig >= 198 && trainConfig <=213) ) 
