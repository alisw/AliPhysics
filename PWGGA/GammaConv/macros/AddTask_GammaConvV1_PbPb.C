...
//     cuts.AddCutPCM("52400013", "00200009247002008250404000", "0152501500000000"); // 30+0.1 2D
  ...
  //****************************************************************************************************
    ...
    // LHC15o photon cuts
      ...
      cuts.AddCutPCM("16810a13", "00200009247605008250404000", "0152501500000000"); // 60-80%
      ...
      cuts.AddCutPCM("16810a23", "00200009247605008250404000", "0152501500000000"); // 60-80%
      ...
      // stricter pT dependent Chi2 PsiPair (lj instead of 25)
  } else if (trainConfig == 916){//----------------__-------
      cuts.AddCutPCM("10110a13", "00200009247600008lj0404000", "0152501500000000"); // 0-10%
      cuts.AddCutPCM("12410a13", "00200009247600008lj0404000", "0152501500000000"); // 20-40%
      cuts.AddCutPCM("16810a13", "00200009247600008lj0404000", "0152501500000000"); // 60-80%
  } else if (trainConfig == 917){  // added particles
      cuts.AddCutPCM("10110a23", "00200009247600008lj0404000", "0152501500000000"); // 0-10%
      cuts.AddCutPCM("12410a23", "00200009247600008lj0404000", "0152501500000000"); // 20-40%
      cuts.AddCutPCM("16810a23", "00200009247600008lj0404000", "0152501500000000"); // 60-80%
