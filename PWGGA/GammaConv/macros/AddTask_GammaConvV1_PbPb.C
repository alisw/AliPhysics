...
//     cuts.AddCutPCM("52400013", "00200009247002008250404000", "0152501500000000"); // 30+0.1 2D
  ...
  //****************************************************************************************************
    ...
    // LHC15o photon cuts
      ...
      cuts.AddCutPCM("10210a13", "0d20000924770c00amd0404000", "0152101500000000"); // 0-20%
      cuts.AddCutPCM("12410a13", "0d20000924770c00amd0404000", "0152101500000000"); // 20-40%
      cuts.AddCutPCM("14610a13", "0d20000924770c00amd0404000", "0152101500000000"); // 40-60%
      cuts.AddCutPCM("16810a13", "0d20000924770c00amd0404000", "0152101500000000"); // 60-80% 
  } else if (trainConfig == 935){ // added particles
      cuts.AddCutPCM("10110a23", "0d200009a4770c00amd0404000", "0152101500000000"); // 0-10%
      cuts.AddCutPCM("10210a23", "0d20000924770c00amd0404000", "0152101500000000"); // 0-20%
      cuts.AddCutPCM("12410a23", "0d20000924770c00amd0404000", "0152101500000000"); // 20-40%
      cuts.AddCutPCM("14610a23", "0d20000924770c00amd0404000", "0152101500000000"); // 40-60%
      cuts.AddCutPCM("16810a23", "0d20000924770c00amd0404000", "0152101500000000"); // 60-80%
