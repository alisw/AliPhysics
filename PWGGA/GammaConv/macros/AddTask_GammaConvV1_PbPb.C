...
void AddTask_GammaConvV1_PbPb(  Int_t     trainConfig                     = 1,                              //change different set of cuts
  ...
  } else if ( trainConfig == 192){ // dir photons (flat pdEdx, 10 chi2, .1 2Dpsi)
    cuts.AddCut("50100013", "00200009247002008750404000", "0152501500000000"); //
  } else if ( trainConfig == 193){
    cuts.AddCut("50100013", "00216609247002008750404000", "0152501500000000"); //
  } else if ( trainConfig == 194){
    cuts.AddCut("52400013", "00200009247002008750404000", "0152501500000000"); //
  } else if ( trainConfig == 195){
    cuts.AddCut("52400013", "00216609247002008750404000", "0152501500000000"); //
  } else if ( trainConfig == 196){ // dir photons (flat pdEdx, 10 chi2, .1 2Dpsi, asymm)
    cuts.AddCut("50100013", "00200009247002008754404000", "0152501500000000"); //
  } else if ( trainConfig == 197){ //
    cuts.AddCut("50100013", "00216609247002008754404000", "0152501500000000"); //
  } else if ( trainConfig == 198){ //
    cuts.AddCut("52400013", "00200009247002008754404000", "0152501500000000"); //
  } else if ( trainConfig == 199){ //
    cuts.AddCut("52400013", "00216609247002008754404000", "0152501500000000"); //
  } else if ( trainConfig == 200){ //  dir photons (tighter dEdx+TOF, asymm)
    cuts.AddCut("50100013", "00200009847005008754404000", "0152501500000000"); //
  } else if ( trainConfig == 201){ //
    cuts.AddCut("50100013", "00216609847005008754404000", "0152501500000000"); //
  } else if ( trainConfig == 202){ //
    cuts.AddCut("52400013", "00200009847005008754404000", "0152501500000000"); //
  } else if ( trainConfig == 203){ //
    cuts.AddCut("52400013", "00216609847005008754404000", "0152501500000000"); //

  } else if ( trainConfig == 204){ // K on the signal -3, 5
...
//    HeaderList->Add(Header3);
  ...
  for(Int_t i = 0; i<numberOfCuts; i++){
    ...
    if (trainConfig == 204   || trainConfig == 205   || trainConfig == 206   || trainConfig == 207  || trainConfig == 208  || trainConfig == 209){
      if (periodName.CompareTo("LHC14a1a") ==0 || periodName.CompareTo("LHC14a1b") ==0 || periodName.CompareTo("LHC14a1c") ==0 ){
        if ( i == 0 && doWeighting)  analysisEventCuts[i]->SetUseReweightingWithHistogramFromFile(kTRUE, kTRUE, kFALSE,fileNameInputForWeighting, Form("Pi0_Hijing_%s_PbPb_2760GeV_0010TPC",periodName.Data()), Form("Eta_Hijing_%s_PbPb_2760GeV_0010TPC",periodName.Data()), "","Pi0_Fit_Data_PbPb_2760GeV_0010V0M","Eta_Fit_Data_PbPb_2760GeV_0010V0M");
    ...
    if (trainConfig == 300 || trainConfig == 301 || trainConfig == 302  || trainConfig == 303  || trainConfig == 304  || trainConfig == 305 || 
        ...
        trainConfig == 204 || trainConfig == 205 || trainConfig == 206  || trainConfig == 207  || trainConfig == 208  || trainConfig == 209)
