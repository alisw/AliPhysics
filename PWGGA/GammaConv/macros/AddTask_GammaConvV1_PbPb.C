...
void AddTask_GammaConvV1_PbPb(  Int_t     trainConfig                     = 1,                              //change different set of cuts
  ...
  } else if ( trainConfig == 194){ // dir photons (flat pdEdx, 10 chi2, .1 2Dpsi)
...
//     cuts.AddCut("61200013", "00216609247002008750404000", "0152501500000000"); // 5-10%
  ...
  } else if ( trainConfig == 196){ // dir photons (flat pdEdx, 10 chi2, .1 2Dpsi, asymm)
...
//     cuts.AddCut("61200013", "00216609247002008754404000", "0152501500000000"); // 5-10%
  ...
  } else if ( trainConfig == 198){ // dir photons (tighter dEdx+TOF)
//     cuts.AddCut("60100013", "00200009847005008750404000", "0152501500000000"); // 0-5%
//     cuts.AddCut("61200013", "00200009847005008750404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00200009847005008750404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00200009847005008750404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00200009847005008750404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 199){ //
//     cuts.AddCut("60100013", "00216609847005008750404000", "0152501500000000"); // 0-5%
//     cuts.AddCut("61200013", "00216609847005008750404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00216609847005008750404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00216609847005008750404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00216609847005008750404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 200){ // dir photons (tighter dEdx+TOF, asymm)
...
//     cuts.AddCut("61200013", "00216609847005008754404000", "0152501500000000"); // 5-10%
  ...
  } else if ( trainConfig == 202){ // dir photons (vs Kcut: 00200009007000008250400000)
...
//     cuts.AddCut("60100013", "00200009500000008250404000", "0152501500000000"); // 0-5%
//     cuts.AddCut("61200013", "00200009500000008250404000", "0152501500000000"); // 5-10%
...
//     cuts.AddCut("60100013", "00216609500000008250404000", "0152501500000000"); // 0-5%
//     cuts.AddCut("61200013", "00216609500000008250404000", "0152501500000000"); // 5-10%
...
//     cuts.AddCut("60100013", "00200009600000008250404000", "0152501500000000"); // 0-5%
//     cuts.AddCut("61200013", "00200009600000008250404000", "0152501500000000"); // 5-10%
...
//     cuts.AddCut("60100013", "00216609600000008250404000", "0152501500000000"); // 0-5%
//     cuts.AddCut("61200013", "00216609600000008250404000", "0152501500000000"); // 5-10%
...
//     cuts.AddCut("60100013", "00200009700000008250404000", "0152501500000000"); // 0-5%
//     cuts.AddCut("61200013", "00200009700000008250404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00200009700000008250404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00200009700000008250404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00200009700000008250404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 209){ //
//     cuts.AddCut("60100013", "00216609700000008250404000", "0152501500000000"); // 0-5%
//     cuts.AddCut("61200013", "00216609700000008250404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00216609700000008250404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00216609700000008250404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00216609700000008250404000", "0152501500000000"); // 20-50%
  ...
  } else if ( trainConfig == 238){ // RP EM V0 mult background
    cuts.AddCut("60100113", "00200009247602008250404000", "0652501500000000"); // RP EM V0 mult background
    cuts.AddCut("61200113", "00200009247602008250404000", "0652501500000000"); // RP EM V0 mult background
    cuts.AddCut("50100113", "00200009247602008250404000", "0652501500000000"); // RP EM V0 mult background
    cuts.AddCut("52400113", "00200009247602008250404000", "0652501500000000"); // RP EM V0 mult background
    cuts.AddCut("52500113", "00200009247602008250404000", "0652501500000000"); // RP EM V0 mult background
  } else if ( trainConfig == 239){ //RP EM V0 mult background - added signals
    cuts.AddCut("60100123", "00200009247602008250404000", "0652501500000000"); // RP EM V0 mult background
    cuts.AddCut("61200123", "00200009247602008250404000", "0652501500000000"); // RP EM V0 mult background
    cuts.AddCut("50100123", "00200009247602008250404000", "0652501500000000"); // RP EM V0 mult background
    cuts.AddCut("52400123", "00200009247602008250404000", "0652501500000000"); // RP EM V0 mult background
    cuts.AddCut("52500123", "00200009247602008250404000", "0652501500000000"); // RP EM V0 mult background
  } else if ( trainConfig == 240){ // RP EM V0 mult background with phi cut
    cuts.AddCut("60100113", "00216609247602008250404000", "0652501500000000"); // RP EM V0 mult background
    cuts.AddCut("61200113", "00216609247602008250404000", "0652501500000000"); // RP EM V0 mult background
    cuts.AddCut("50100113", "00216609247602008250404000", "0652501500000000"); // RP EM V0 mult background
    cuts.AddCut("52400113", "00216609247602008250404000", "0652501500000000"); // RP EM V0 mult background
    cuts.AddCut("52500113", "00216609247602008250404000", "0652501500000000"); // RP EM V0 mult background
  } else if ( trainConfig == 241){ // RP EM V0 mult background with phi cut - added signals
    cuts.AddCut("60100123", "00216609247602008250404000", "0652501500000000"); // RP EM V0 mult background
    cuts.AddCut("61200123", "00216609247602008250404000", "0652501500000000"); // RP EM V0 mult background
    cuts.AddCut("50100123", "00216609247602008250404000", "0652501500000000"); // RP EM V0 mult background
    cuts.AddCut("52400123", "00216609247602008250404000", "0652501500000000"); // RP EM V0 mult background
    cuts.AddCut("52500123", "00216609247602008250404000", "0652501500000000"); // RP EM V0 mult background
...
//    HeaderList->Add(Header3);
  ...
  for(Int_t i = 0; i<numberOfCuts; i++){
    ...
    if (trainConfig == 70    || trainConfig == 72    || trainConfig == 74    || trainConfig == 76   || trainConfig == 78   || 
        ...
        trainConfig == 186   || trainConfig == 188   || trainConfig == 190   || trainConfig == 192  || trainConfig == 226  ||
        trainConfig == 228   || trainConfig == 234   || trainConfig == 236   || trainConfig == 238   || trainConfig == 240){
      if (periodName.CompareTo("LHC14a1a") ==0 || periodName.CompareTo("LHC14a1b") ==0 || periodName.CompareTo("LHC14a1c") ==0 ){
        if ( i == 0 && doWeighting)  analysisEventCuts[i]->SetUseReweightingWithHistogramFromFile(kTRUE, kTRUE, kFALSE,fileNameInputForWeighting, Form("Pi0_Hijing_%s_PbPb_2760GeV_0005TPC",periodName.Data()), Form("Eta_Hijing_%s_PbPb_2760GeV_0005TPC",periodName.Data()), "","Pi0_Fit_Data_PbPb_2760GeV_0005V0M","Eta_Fit_Data_PbPb_2760GeV_0005V0M");
        if ( i == 1 && doWeighting)  analysisEventCuts[i]->SetUseReweightingWithHistogramFromFile(kTRUE, kTRUE, kFALSE,fileNameInputForWeighting, Form("Pi0_Hijing_%s_PbPb_2760GeV_0510TPC",periodName.Data()), Form("Eta_Hijing_%s_PbPb_2760GeV_0510TPC",periodName.Data()), "","Pi0_Fit_Data_PbPb_2760GeV_0510V0M","Eta_Fit_Data_PbPb_2760GeV_0510V0M");
        if ( i == 2 && doWeighting)  analysisEventCuts[i]->SetUseReweightingWithHistogramFromFile(kTRUE, kTRUE, kFALSE,fileNameInputForWeighting, Form("Pi0_Hijing_%s_PbPb_2760GeV_0010TPC",periodName.Data()), Form("Eta_Hijing_%s_PbPb_2760GeV_0010TPC",periodName.Data()), "","Pi0_Fit_Data_PbPb_2760GeV_0010V0M","Eta_Fit_Data_PbPb_2760GeV_0010V0M");
    ...
    if(trainConfig == 194  || trainConfig == 195   || trainConfig == 196   || trainConfig == 197   || trainConfig == 198  || trainConfig == 199  ||
        trainConfig == 200   || trainConfig == 201   ||  trainConfig == 202   || trainConfig == 203 || trainConfig == 204 || trainConfig == 205 ||
        trainConfig == 206  || trainConfig == 207  || trainConfig == 208  || trainConfig == 209){
      if (periodName.CompareTo("LHC14a1a") ==0 || periodName.CompareTo("LHC14a1b") ==0 || periodName.CompareTo("LHC14a1c") ==0 ){
    ...
    if (trainConfig == 71    || trainConfig == 73    || trainConfig == 75    || trainConfig == 77    || trainConfig == 79    ||
        ...
        trainConfig == 229   || trainConfig == 235   || trainConfig == 237 || trainConfig == 239   || trainConfig == 241){
      if (periodName.CompareTo("LHC14a1a") ==0 || periodName.CompareTo("LHC14a1b") ==0 || periodName.CompareTo("LHC14a1c") ==0 ){
        if ( i == 0 && doWeighting)  analysisEventCuts[i]->SetUseReweightingWithHistogramFromFile(kTRUE, kTRUE, kFALSE,fileNameInputForWeighting, Form("Pi0_Hijing_%s_addSig_PbPb_2760GeV_0005TPC",periodName.Data()), Form("Eta_Hijing_%s_addSig_PbPb_2760GeV_0005TPC",periodName.Data()), "","Pi0_Fit_Data_PbPb_2760GeV_0005V0M","Eta_Fit_Data_PbPb_2760GeV_0005V0M");
        if ( i == 1 && doWeighting)  analysisEventCuts[i]->SetUseReweightingWithHistogramFromFile(kTRUE, kTRUE, kFALSE,fileNameInputForWeighting, Form("Pi0_Hijing_%s_addSig_PbPb_2760GeV_0510TPC",periodName.Data()), Form("Eta_Hijing_%s_addSig_PbPb_2760GeV_0510TPC",periodName.Data()), "","Pi0_Fit_Data_PbPb_2760GeV_0510V0M","Eta_Fit_Data_PbPb_2760GeV_0510V0M");
        if ( i == 2 && doWeighting)  analysisEventCuts[i]->SetUseReweightingWithHistogramFromFile(kTRUE, kTRUE, kFALSE,fileNameInputForWeighting, Form("Pi0_Hijing_%s_addSig_PbPb_2760GeV_0010TPC",periodName.Data()), Form("Eta_Hijing_%s_addSig_PbPb_2760GeV_0010TPC",periodName.Data()), "","Pi0_Fit_Data_PbPb_2760GeV_0010V0M","Eta_Fit_Data_PbPb_2760GeV_0010V0M");
