...
//     cuts.AddCut("50800023", "00216609247602008250400000", "0152501500000000"); //with fDoCentralityFlat = 8
  ...
  } else if ( trainConfig == 198){ // kappa cut (0 - 2.5) on top of std cut
    cuts.AddCut("60100013", "00200009200002008250404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00200009200002008250404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00200009200002008250404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00200009200002008250404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00200009200002008250404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 199){ // kappa cut (0 - 2.5) on top of std cut - Added sig.
    cuts.AddCut("60100023", "00200009200002008250404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00200009200002008250404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00200009200002008250404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00200009200002008250404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00200009200002008250404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 200){ // kappa cut (0 - 2.5) on top of std cut
    cuts.AddCut("60100013", "00216609200002008250404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00216609200002008250404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00216609200002008250404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00216609200002008250404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00216609200002008250404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 201){ // kappa cut (0 - 2.5) on top of std cut - Added sig.
    cuts.AddCut("60100023", "00216609200002008250404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00216609200002008250404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00216609200002008250404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00216609200002008250404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00216609200002008250404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 202){ // psi pair 0.2 2D + kappa cut (0 - 2.5)
    cuts.AddCut("60100013", "00200009200002008280404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00200009200002008280404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00200009200002008280404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00200009200002008280404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00200009200002008280404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 203){ // psi pair 0.2 2D + kappa cut (0 - 2.5) - added signal
    cuts.AddCut("60100023", "00200009200002008280404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00200009200002008280404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00200009200002008280404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00200009200002008280404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00200009200002008280404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 204){ // psi pair 0.2 2D + kappa cut (0 - 2.5) with phi cut 
  ...
  } else if ( trainConfig == 205){ // psi pair 0.2 2D + kappa cut (0 - 2.5) with phi cut - added signal
    cuts.AddCut("60100023", "00216609200002008280404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00216609200002008280404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00216609200002008280404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00216609200002008280404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00216609200002008280404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 206){ // kappa cut (0 - 3) on top of std cut
    cuts.AddCut("60100013", "00200009100002008250404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00200009100002008250404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00200009100002008250404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00200009100002008250404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00200009100002008250404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 207){ // kappa cut (0 - 3) on top of std cut - Added sig.
    cuts.AddCut("60100023", "00200009100002008250404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00200009100002008250404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00200009100002008250404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00200009100002008250404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00200009100002008250404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 208){ // kappa cut (0 - 3) on top of std cut
    cuts.AddCut("60100013", "00216609100002008250404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00216609100002008250404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00216609100002008250404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00216609100002008250404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00216609100002008250404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 209){ // kappa cut (0 - 3) on top of std cut - Added sig.
    cuts.AddCut("60100023", "00216609100002008250404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00216609100002008250404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00216609100002008250404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00216609100002008250404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00216609100002008250404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 210){ // psi pair 0.2 2D + kappa cut (0 - 3)
    cuts.AddCut("60100013", "00200009100002008280404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00200009100002008280404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00200009100002008280404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00200009100002008280404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00200009100002008280404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 211){ // psi pair 0.2 2D + kappa cut (0 - 3) - added signal
    cuts.AddCut("60100023", "00200009100002008280404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00200009100002008280404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00200009100002008280404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00200009100002008280404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00200009100002008280404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 212){ // psi pair 0.2 2D + kappa cut (0 - 3) with phi cut 
    cuts.AddCut("60100013", "00216609100002008280404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200013", "00216609100002008280404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100013", "00216609100002008280404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400013", "00216609100002008280404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500013", "00216609100002008280404000", "0152501500000000"); // 20-50%
  } else if ( trainConfig == 213){ // psi pair 0.2 2D + kappa cut (0 - 3) with phi cut - added signal
    cuts.AddCut("60100023", "00216609100002008280404000", "0152501500000000"); // 0-5%
    cuts.AddCut("61200023", "00216609100002008280404000", "0152501500000000"); // 5-10%
    cuts.AddCut("50100023", "00216609100002008280404000", "0152501500000000"); // 0-10%
    cuts.AddCut("52400023", "00216609100002008280404000", "0152501500000000"); // 20-40%
    cuts.AddCut("52500023", "00216609100002008280404000", "0152501500000000"); // 20-50%
