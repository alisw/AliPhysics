...
void AddTask_GammaCaloMerged_pp(
  ...
  //pp 13 TeV with triggers
    ...
    cuts.AddCutMergedCalo("00010113","411790109fe32200000","411790106fe22700001","0163300000000000"); // INT7
  } else if (trainConfig == 1514){
    cuts.AddCutMergedCalo("0008e113","411790109fe32200000","411790106fe22700001","0163300000000000"); // EG2+DG2
    cuts.AddCutMergedCalo("0008d113","411790109fe32200000","411790106fe22700001","0163300000000000"); // EG1+DG1
  } else if (trainConfig == 1515){ //TB NL, -20ns, 25ns timing cut, No TM, with exotic cut (F+=0.95, TCard requirement > 50GeV)
    cuts.AddCutMergedCalo("00010113","4117901090e32200000","4117901060e22700001","0163300000000000"); // INT7 No TM
  } else if (trainConfig == 1516){
    cuts.AddCutMergedCalo("0008e113","4117901090e32200000","4117901060e22700001","0163300000000000"); // EG2+DG2 No TM
    cuts.AddCutMergedCalo("0008d113","4117901090e32200000","4117901060e22700001","0163300000000000"); // EG1+DG1 No TM
    ...
    cuts.AddCutMergedCalo("00010113","411790109fe32200000","411790106fe22700001","0163300000000000"); // INT7 NLM = 1
    cuts.AddCutMergedCalo("00010113","411790109fe32200000","411790106fe22700002","0163300000000000"); // INT7 NLM = 2
    cuts.AddCutMergedCalo("00010113","411790109fe32200000","411790106fe22700004","0163300000000000"); // INT7 NLM > 2
  } else if (trainConfig == 1518){
    cuts.AddCutMergedCalo("0008e113","411790109fe32200000","411790106fe22700001","0163300000000000"); // EG2+DG2 INT7 NLM = 1
    cuts.AddCutMergedCalo("0008e113","411790109fe32200000","411790106fe22700002","0163300000000000"); // EG2+DG2 INT7 NLM = 2
    cuts.AddCutMergedCalo("0008e113","411790109fe32200000","411790106fe22700004","0163300000000000"); // EG2+DG2 NLM > 2
  } else if (trainConfig == 1519){
    cuts.AddCutMergedCalo("0008d113","411790109fe32200000","411790106fe22700001","0163300000000000"); // EG1+DG1 INT7 NLM = 1
    cuts.AddCutMergedCalo("0008d113","411790109fe32200000","411790106fe22700002","0163300000000000"); // EG1+DG1 INT7 NLM = 2
    cuts.AddCutMergedCalo("0008d113","411790109fe32200000","411790106fe22700004","0163300000000000"); // EG1+DG1 NLM > 2
    ...
    cuts.AddCutMergedCalo("00010113","4117901090e32200000","4117901060e22700001","0163300000000000"); // INT7 NLM = 1
    cuts.AddCutMergedCalo("00010113","4117901090e32200000","4117901060e22700002","0163300000000000"); // INT7 NLM = 2
    cuts.AddCutMergedCalo("00010113","4117901090e32200000","4117901060e22700003","0163300000000000"); // INT7 NLM <= 2
    cuts.AddCutMergedCalo("00010113","4117901090e32200000","4117901060e22700004","0163300000000000"); // INT7 NLM > 2
  } else if (trainConfig == 1521){
    cuts.AddCutMergedCalo("0008e113","4117901090e32200000","4117901060e22700001","0163300000000000"); // EG2+DG2 INT7 NLM = 1
    cuts.AddCutMergedCalo("0008e113","4117901090e32200000","4117901060e22700002","0163300000000000"); // EG2+DG2 INT7 NLM = 2
    cuts.AddCutMergedCalo("0008e113","4117901090e32200000","4117901060e22700003","0163300000000000"); // EG2+DG2 INT7 NLM <= 2
    cuts.AddCutMergedCalo("0008e113","4117901090e32200000","4117901060e22700004","0163300000000000"); // EG2+DG2 NLM > 2
  } else if (trainConfig == 1522){
    cuts.AddCutMergedCalo("0008d113","4117901090e32200000","4117901060e22700001","0163300000000000"); // EG1+DG1 INT7 NLM = 1
    cuts.AddCutMergedCalo("0008d113","4117901090e32200000","4117901060e22700002","0163300000000000"); // EG1+DG1 INT7 NLM = 2
    cuts.AddCutMergedCalo("0008d113","4117901090e32200000","4117901060e22700003","0163300000000000"); // EG1+DG1 INT7 NLM <= 2
    cuts.AddCutMergedCalo("0008d113","4117901090e32200000","4117901060e22700004","0163300000000000"); // EG1+DG1 NLM > 2
  ...
  // No M02 and M20 cut for QA
    ...
    cuts.AddCutMergedCalo("00010113","411790109fe32200000","411790106fe02000001","0163300000000000"); // INT7
  } else if (trainConfig == 1524){
    cuts.AddCutMergedCalo("0008e113","411790109fe32000000","411790106fe02000001","0163300000000000"); // EG2+DG2
    cuts.AddCutMergedCalo("0008d113","411790109fe32000000","411790106fe02000001","0163300000000000"); // EG1+DG1
  ...
  // No M02 and M20 cut for QA (for V1 Clusterizer without NLM cut)
    ...
    cuts.AddCutMergedCalo("00010113","411790109fe32200000","411790106fe02000000","0163300000000000"); // INT7
  } else if (trainConfig == 1526){
    cuts.AddCutMergedCalo("0008e113","411790109fe32000000","411790106fe02000000","0163300000000000"); // EG2+DG2
    cuts.AddCutMergedCalo("0008d113","411790109fe32000000","411790106fe02000000","0163300000000000"); // EG1+DG1
  ...
  // No M02 and M20 cut for QA (for V1 Clusterizer NLM cut 1 + 2 NLM)
    ...
    cuts.AddCutMergedCalo("00010113","411790109fe32200000","411790106fe02000003","0163300000000000"); // INT7
  } else if (trainConfig == 1528){
    cuts.AddCutMergedCalo("0008e113","411790109fe32000000","411790106fe02000003","0163300000000000"); // EG2+DG2
    cuts.AddCutMergedCalo("0008d113","411790109fe32000000","411790106fe02000003","0163300000000000"); // EG1+DG1


  } else if (trainConfig == 1530){ //TB NL, -20ns, 25ns timing cut, TM without E/p, with exotic cut (F+=0.95, TCard requirement > 50GeV)
    cuts.AddCutMergedCalo("00010113","411790109ce32200000","411790106ce22700001","0163300000000000"); // INT7
  } else if (trainConfig == 1531){
    cuts.AddCutMergedCalo("0008e113","411790109ce32200000","411790106ce22700001","0163300000000000"); // EG2+DG2
    cuts.AddCutMergedCalo("0008d113","411790109ce32200000","411790106ce22700001","0163300000000000"); // EG1+DG1


  } else if (trainConfig == 1532){ //TB NL, -20ns, 25ns timing cut, E/p TM variation, with exotic cut (F+=0.95, TCard requirement > 50GeV)
    cuts.AddCutMergedCalo("00010113","411790109de32200000","411790106de22700001","0163300000000000"); // INT7
    cuts.AddCutMergedCalo("00010113","411790109de32200000","411790106he22700001","0163300000000000"); // INT7
  } else if (trainConfig == 1533){
    cuts.AddCutMergedCalo("0008e113","411790109de32200000","411790106de22700001","0163300000000000"); // EG2+DG2
    cuts.AddCutMergedCalo("0008e113","411790109he32200000","411790106he22700001","0163300000000000"); // EG2+DG2
    cuts.AddCutMergedCalo("0008d113","411790109de32200000","411790106de22700001","0163300000000000"); // EG1+DG1
    cuts.AddCutMergedCalo("0008d113","411790109he32200000","411790106he22700001","0163300000000000"); // EG1+DG1
    ...
    cuts.AddCutMergedCalo("00010113","411790109fe32200000","411790106fe22700001","0163300000000000"); // INT7 0 overlaps
  } else if (trainConfig == 1535){ //TB NL, -20ns, 25ns timing cut, E/p TM, with exotic cut (F+=0.95, TCard requirement > 50GeV)
    cuts.AddCutMergedCalo("00010113","411790109fe32200000","411790106fe22700001","0163300000000000"); // INT7  1 overlaps
  } else if (trainConfig == 1536){ //TB NL, -20ns, 25ns timing cut, E/p TM, with exotic cut (F+=0.95, TCard requirement > 50GeV)
    cuts.AddCutMergedCalo("00010113","411790109fe32200000","411790106fe22700001","0163300000000000"); // INT7  2 overlaps
    ...
    cuts.AddCutMergedCalo("00010113","411790109fe32200000","411790106fe22700001","0163300000000000"); // INT7  > 3 overlaps


    // systematics pp 13 TeV INT7
  } else if (trainConfig == 1550){ //TB NL variations
    cuts.AddCutMergedCalo("00010113","411793309fe32200000","411793306fe22700001","0163300000000000"); // INT7 NL 33
    cuts.AddCutMergedCalo("00010113","411793409fe32200000","411793406fe22700001","0163300000000000"); // INT7 NL 34
    cuts.AddCutMergedCalo("00010113","411793809fe32200000","411793806fe22700001","0163300000000000"); // INT7 NL 38
    cuts.AddCutMergedCalo("00010113","411793909fe32200000","411793906fe22700001","0163300000000000"); // INT7 NL 39
  } else if (trainConfig == 1551){ //M02 variation
    cuts.AddCutMergedCalo("00010113","411790109fe32200000","411790106fe22d00001","0163300000000000"); // INT7 M02 < 0.33
    cuts.AddCutMergedCalo("00010113","411790109fe32200000","411790106fe22600001","0163300000000000"); // INT7 M02 < 0.3
    cuts.AddCutMergedCalo("00010113","411790109fe32200000","411790106fe22800001","0163300000000000"); // INT7 M02 < 0.25
    cuts.AddCutMergedCalo("00010113","411790109fe32200000","411790106fe22k00001","0163300000000000"); // INT7 M02 < 0.2
  } else if (trainConfig == 1552){  // dist to bad channel
    cuts.AddCutMergedCalo("00010113","411790109fe32200000","411790116fe22700001","0163300000000000"); // INT7 dist to bad channel 1
    cuts.AddCutMergedCalo("00010113","411790109fe32200000","411790126fe22700001","0163300000000000"); // INT7 dist to bad channel 2
  } else if (trainConfig == 1553){  // exotics
    cuts.AddCutMergedCalo("00010113","411790109fb32200000","411790106fb22700001","0163300000000000"); // INT7 F+ < 0.95
    cuts.AddCutMergedCalo("00010113","411790109f532200000","411790106f522700001","0163300000000000"); // INT7 F+ < 0.97 no TCard
    cuts.AddCutMergedCalo("00010113","411790109fg32200000","411790106fg22700001","0163300000000000"); // INT7 exotics in corr framework
    ...
    cuts.AddCutMergedCalo("00010113","411790106fe32200000","411790109fe22700001","0163300000000000"); // INT7 timing: -30 to 35
    ...
    cuts.AddCutMergedCalo("00010113","4117901090e32200000","4117901060e22700001","0163300000000000"); // INT7 no TM
    cuts.AddCutMergedCalo("00010113","4117901097e32200000","4117901067e22700001","0163300000000000"); // INT7 no E/p TM
    cuts.AddCutMergedCalo("00010113","411790109he32200000","411790106he22700001","0163300000000000"); // INT7 E/p = 1.25 (strict)
    cuts.AddCutMergedCalo("00010113","411790109de32200000","411790106de22700001","0163300000000000"); // INT7 E/p = 3.0 (loose)
  } else if (trainConfig == 1556){  // rapidity
    cuts.AddCutMergedCalo("00010113","411790109fe32200000","411790106fe22700001","0163100000000000"); // INT7 rap = 0.8
    cuts.AddCutMergedCalo("00010113","411790109fe32200000","411790106fe22700001","0163200000000000"); // INT7 rap = 0.7
  } else if (trainConfig == 1557){  // EMCal/DCal
    cuts.AddCutMergedCalo("00010113","111110109fe32200000","411790106fe22700001","0163300000000000"); // INT7 EMCal
    cuts.AddCutMergedCalo("00010113","388550109fe32200000","411790106fe22700001","0163300000000000"); // INT7 DCal
  } else if (trainConfig == 1558){  // clusterization settings
    cuts.AddCutMergedCalo("00010113","411790109fe32200000","411790106fe22700001","0163300000000000"); // INT7 Eagg = 150MeV
  } else if (trainConfig == 1559){  // clusterization settings
    cuts.AddCutMergedCalo("00010113","411790109fe32200000","411790106fe22700001","0163300000000000"); // INT7 Eagg = 75MeV


  } else if (trainConfig == 1570){ //TB NL variations
    cuts.AddCutMergedCalo("0008e113","411793309fe32200000","411793306fe22700001","0163300000000000"); // EG2 NL 33
    cuts.AddCutMergedCalo("0008e113","411793409fe32200000","411793406fe22700001","0163300000000000"); // EG2 NL 34
    cuts.AddCutMergedCalo("0008e113","411793809fe32200000","411793806fe22700001","0163300000000000"); // EG2 NL 38
    cuts.AddCutMergedCalo("0008e113","411793909fe32200000","411793906fe22700001","0163300000000000"); // EG2 NL 39
  } else if (trainConfig == 1571){ //M02 variation
    cuts.AddCutMergedCalo("0008e113","411790109fe32200000","411790106fe22d00001","0163300000000000"); // EG2 M02 < 0.33
    cuts.AddCutMergedCalo("0008e113","411790109fe32200000","411790106fe22600001","0163300000000000"); // EG2 M02 < 0.3
    cuts.AddCutMergedCalo("0008e113","411790109fe32200000","411790106fe22800001","0163300000000000"); // EG2 M02 < 0.25
    cuts.AddCutMergedCalo("0008e113","411790109fe32200000","411790106fe22k00001","0163300000000000"); // EG2 M02 < 0.2
  } else if (trainConfig == 1572){  // dist to bad channel
    cuts.AddCutMergedCalo("0008e113","411790109fe32200000","411790116fe22700001","0163300000000000"); // EG2 dist to bad channel 1
    cuts.AddCutMergedCalo("0008e113","411790109fe32200000","411790126fe22700001","0163300000000000"); // EG2 dist to bad channel 2
  } else if (trainConfig == 1573){  // exotics
    cuts.AddCutMergedCalo("0008e113","411790109fb32200000","411790106fb22700001","0163300000000000"); // EG2 F+ < 0.95
    cuts.AddCutMergedCalo("0008e113","411790109f532200000","411790106f522700001","0163300000000000"); // EG2 F+ < 0.97 no TCard
    cuts.AddCutMergedCalo("0008e113","411790109fg32200000","411790106fg22700001","0163300000000000"); // EG2 exotics in corr framework
    ...
    cuts.AddCutMergedCalo("0008e113","411790106fe32200000","411790109fe22700001","0163300000000000"); // EG2 timing: -20 to 25
    ...
    cuts.AddCutMergedCalo("0008e113","4117901090e32200000","4117901060e22700001","0163300000000000"); // EG2 no TM
    cuts.AddCutMergedCalo("0008e113","4117901097e32200000","4117901067e22700001","0163300000000000"); // EG2 no E/p TM
    cuts.AddCutMergedCalo("0008e113","411790109he32200000","411790106he22700001","0163300000000000"); // EG2 E/p = 1.25 (strict)
    cuts.AddCutMergedCalo("0008e113","411790109de32200000","411790106de22700001","0163300000000000"); // EG2 E/p = 3.0 (loose)
  } else if (trainConfig == 1576){  // rapidity
    cuts.AddCutMergedCalo("0008e113","411790109fe32200000","411790106fe22700001","0163100000000000"); // EG2 rap = 0.8
    cuts.AddCutMergedCalo("0008e113","411790109fe32200000","411790106fe22700001","0163200000000000"); // EG2 rap = 0.7
  } else if (trainConfig == 1577){  // EMCal/DCal
    cuts.AddCutMergedCalo("00085113","111110109fe32200000","411790106fe22700001","0163300000000000"); // EG2 EMCal
    cuts.AddCutMergedCalo("00089113","388550109fe32200000","411790106fe22700001","0163300000000000"); // EG2 DCal
  } else if (trainConfig == 1578){  // clusterization settings
    cuts.AddCutMergedCalo("0008e113","411790109fe32200000","411790106fe22700001","0163300000000000"); // EG2 Eagg = 150MeV
  } else if (trainConfig == 1579){  // clusterization settings
    cuts.AddCutMergedCalo("0008e113","411790109fe32200000","411790106fe22700001","0163300000000000"); // EG2 Eagg = 75MeV


  } else if (trainConfig == 1590){ //TB NL variations
    cuts.AddCutMergedCalo("0008d113","411793309fe32200000","411793306fe22700001","0163300000000000"); // EG1 NL 33
    cuts.AddCutMergedCalo("0008d113","411793409fe32200000","411793406fe22700001","0163300000000000"); // EG1 NL 34
    cuts.AddCutMergedCalo("0008d113","411793809fe32200000","411793806fe22700001","0163300000000000"); // EG1 NL 38
    cuts.AddCutMergedCalo("0008d113","411793909fe32200000","411793906fe22700001","0163300000000000"); // EG1 NL 39
  } else if (trainConfig == 1591){ //M02 variation
    cuts.AddCutMergedCalo("0008d113","411790109fe32200000","411790106fe22d00001","0163300000000000"); // EG1 M02 < 0.33
    cuts.AddCutMergedCalo("0008d113","411790109fe32200000","411790106fe22600001","0163300000000000"); // EG1 M02 < 0.3
    cuts.AddCutMergedCalo("0008d113","411790109fe32200000","411790106fe22800001","0163300000000000"); // EG1 M02 < 0.25
    cuts.AddCutMergedCalo("0008d113","411790109fe32200000","411790106fe22k00001","0163300000000000"); // EG1 M02 < 0.2
  } else if (trainConfig == 1592){  // dist to bad channel
    cuts.AddCutMergedCalo("0008d113","411790109fe32200000","411790116fe22700001","0163300000000000"); // EG1 dist to bad channel 1
    cuts.AddCutMergedCalo("0008d113","411790109fe32200000","411790126fe22700001","0163300000000000"); // EG1 dist to bad channel 2
  } else if (trainConfig == 1593){  // exotics
    cuts.AddCutMergedCalo("0008d113","411790109fb32200000","411790106fb22700001","0163300000000000"); // EG1 F+ < 0.95
    cuts.AddCutMergedCalo("0008d113","411790109f532200000","411790106f522700001","0163300000000000"); // EG1 F+ < 0.97 no TCard
    cuts.AddCutMergedCalo("0008d113","411790109fg32200000","411790106fg22700001","0163300000000000"); // EG1 exotics in corr framework
    ...
    cuts.AddCutMergedCalo("0008d113","411790106fe32200000","411790109fe22700001","0163300000000000"); // EG1 timing: -20 to 25
    ...
    cuts.AddCutMergedCalo("0008d113","4117901090e32200000","4117901060e22700001","0163300000000000"); // EG1 no TM
    cuts.AddCutMergedCalo("0008d113","4117901097e32200000","4117901067e22700001","0163300000000000"); // EG1 no E/p TM
    cuts.AddCutMergedCalo("0008d113","411790109he32200000","411790106he22700001","0163300000000000"); // EG1 E/p = 1.25 (strict)
    cuts.AddCutMergedCalo("0008d113","411790109de32200000","411790106de22700001","0163300000000000"); // EG1 E/p = 3.0 (loose)
  } else if (trainConfig == 1596){  // rapidity
    cuts.AddCutMergedCalo("0008d113","411790109fe32200000","411790106fe22700001","0163100000000000"); // EG1 rap = 0.8
    cuts.AddCutMergedCalo("0008d113","411790109fe32200000","411790106fe22700001","0163200000000000"); // EG1 rap = 0.7
  } else if (trainConfig == 1597){  // EMCal/DCal
    cuts.AddCutMergedCalo("00083113","111110109fe32200000","411790106fe22700001","0163300000000000"); // EG1 EMCal
    cuts.AddCutMergedCalo("0008b113","388550109fe32200000","411790106fe22700001","0163300000000000"); // EG1 DCal
  } else if (trainConfig == 1598){  // clusterization settings
    cuts.AddCutMergedCalo("0008d113","411790109fe32200000","411790106fe22700001","0163300000000000"); // EG1 Eagg = 150MeV
  } else if (trainConfig == 1599){  // clusterization settings
    cuts.AddCutMergedCalo("0008d113","411790109fe32200000","411790106fe22700001","0163300000000000"); // EG1 Eagg = 75MeV

  // In Jet
  } else if (trainConfig == 1700){ //TB NL, -20ns, 25ns timing cut, E/p TM, with exotic cut (F+=0.95, TCard requirement > 50GeV)
    cuts.AddCutMergedCalo("00010113","411790109fe32200000","411790106fe22700001","2163300000000000"); // INT7
  } else if (trainConfig == 1701){
    cuts.AddCutMergedCalo("0008e113","411790109fe32200000","411790106fe22700001","2163300000000000"); // EG2+DG2
    cuts.AddCutMergedCalo("0008d113","411790109fe32200000","411790106fe22700001","2163300000000000"); // EG1+DG1
    // Out of jet
  } else if (trainConfig == 1702){ //TB NL, -20ns, 25ns timing cut, E/p TM, with exotic cut (F+=0.95, TCard requirement > 50GeV)
    cuts.AddCutMergedCalo("00010113","411790109fe32200000","411790106fe22700001","6163300000000000"); // INT7, out of Jet
  } else if (trainConfig == 1703){
    cuts.AddCutMergedCalo("0008e113","411790109fe32200000","411790106fe22700001","6163300000000000"); // EG2+DG2, out of Jet
    cuts.AddCutMergedCalo("0008d113","411790109fe32200000","411790106fe22700001","6163300000000000"); // EG1+DG1, out of Jet
  } else if (trainConfig == 1704){ //TB NL, -20ns, 25ns timing cut, E/p TM, with exotic cut (F+=0.95, TCard requirement > 50GeV)
    cuts.AddCutMergedCalo("00010113","411790109fe32200000","411790106fe22700001","7163300000000000"); // INT7, out of Jet on away side
  } else if (trainConfig == 1705){
    cuts.AddCutMergedCalo("0008e113","411790109fe32200000","411790106fe22700001","7163300000000000"); // EG2+DG2, out of Jet on away side
    cuts.AddCutMergedCalo("0008d113","411790109fe32200000","411790106fe22700001","7163300000000000"); // EG1+DG1, out of Jet on away side
  } else if (trainConfig == 1706){ //TB NL, -20ns, 25ns timing cut, E/p TM, with exotic cut (F+=0.95, TCard requirement > 50GeV)
    cuts.AddCutMergedCalo("00010113","411790109fe32200000","411790106fe22700001","8163300000000000"); // INT7, out of Jet with donut shape around jet axis
  } else if (trainConfig == 1707){
    cuts.AddCutMergedCalo("0008e113","411790109fe32200000","411790106fe22700001","8163300000000000"); // EG2+DG2, out of Jet with donut shape around jet axis
    cuts.AddCutMergedCalo("0008d113","411790109fe32200000","411790106fe22700001","8163300000000000"); // EG1+DG1, out of Jet with donut shape around jet axis

  //--------------------------------------------------------------------
  // pp 13TeV mult dependent configs
  //--------------------------------------------------------------------
  } else if (trainConfig == 1900){ // slices using MB trigger
    cuts.AddCutMergedCalo("m0110113","411790109fe32200000","411790106fe22700001","0163300000000000"); // INT7 mult. dep 0.0% - 1.0%
    cuts.AddCutMergedCalo("m1210113","411790109fe32200000","411790106fe22700001","0163300000000000"); // INT7 mult. dep 1.0% - 2.0%
    cuts.AddCutMergedCalo("m2310113","411790109fe32200000","411790106fe22700001","0163300000000000"); // INT7 mult. dep 2.0% - 3.0%
    cuts.AddCutMergedCalo("m3410113","411790109fe32200000","411790106fe22700001","0163300000000000"); // INT7 mult. dep 3.0% - 4.0%
    cuts.AddCutMergedCalo("m4510113","411790109fe32200000","411790106fe22700001","0163300000000000"); // INT7 mult. dep 4.0% - 5.0%
    cuts.AddCutMergedCalo("m5710113","411790109fe32200000","411790106fe22700001","0163300000000000"); // INT7 mult. dep 5.0% - 7.0%
    cuts.AddCutMergedCalo("m7a10113","411790109fe32200000","411790106fe22700001","0163300000000000"); // INT7 mult. dep 7.0% - 10.0%
  } else if (trainConfig == 1901){ // slices using MB trigger
    cuts.AddCutMergedCalo("n0110113","411790109fe32200000","411790106fe22700001","0163300000000000"); // INT7 mult. dep 0% - 10.0%
    cuts.AddCutMergedCalo("n1210113","411790109fe32200000","411790106fe22700001","0163300000000000"); // INT7 mult. dep 10% - 20.0%
    cuts.AddCutMergedCalo("n2510113","411790109fe32200000","411790106fe22700001","0163300000000000"); // INT7 mult. dep 20.0% - 50.0%
    cuts.AddCutMergedCalo("n5a10113","411790109fe32200000","411790106fe22700001","0163300000000000"); // INT7 mult. dep 50.0% - 100.0%

  } else if (trainConfig == 1902){ // slices using V0M high mult trigger
    cuts.AddCutMergedCalo("r0176113","411790109fe32200000","411790106fe22700001","0163300000000000"); // INT7 mult. dep 0.0% - 0.01%
    cuts.AddCutMergedCalo("r1276113","411790109fe32200000","411790106fe22700001","0163300000000000"); // INT7 mult. dep 0.01% - 0.02%
    cuts.AddCutMergedCalo("r2376113","411790109fe32200000","411790106fe22700001","0163300000000000"); // INT7 mult. dep 0.02% - 0.03%
    cuts.AddCutMergedCalo("r3476113","411790109fe32200000","411790106fe22700001","0163300000000000"); // INT7 mult. dep 0.03% - 0.04%
    cuts.AddCutMergedCalo("r4576113","411790109fe32200000","411790106fe22700001","0163300000000000"); // INT7 mult. dep 0.04% - 0.05%
    cuts.AddCutMergedCalo("r5776113","411790109fe32200000","411790106fe22700001","0163300000000000"); // INT7 mult. dep 0.05% - 0.07%
    cuts.AddCutMergedCalo("r7a76113","411790109fe32200000","411790106fe22700001","0163300000000000"); // INT7 mult. dep 0.07% - 0.1%
  } else if (trainConfig == 1903){ // slices using SPD high mult trigger
    cuts.AddCutMergedCalo("r0175113","411790109fe32200000","411790106fe22700001","0163300000000000"); // INT7 mult. dep 0.0% - 0.01%
    cuts.AddCutMergedCalo("r1275113","411790109fe32200000","411790106fe22700001","0163300000000000"); // INT7 mult. dep 0.01% - 0.02%
    cuts.AddCutMergedCalo("r2375113","411790109fe32200000","411790106fe22700001","0163300000000000"); // INT7 mult. dep 0.02% - 0.03%
    cuts.AddCutMergedCalo("r3475113","411790109fe32200000","411790106fe22700001","0163300000000000"); // INT7 mult. dep 0.03% - 0.04%
    cuts.AddCutMergedCalo("r4575113","411790109fe32200000","411790106fe22700001","0163300000000000"); // INT7 mult. dep 0.04% - 0.05%
    cuts.AddCutMergedCalo("r5775113","411790109fe32200000","411790106fe22700001","0163300000000000"); // INT7 mult. dep 0.05% - 0.07%
    cuts.AddCutMergedCalo("r7a75113","411790109fe32200000","411790106fe22700001","0163300000000000"); // INT7 mult. dep 0.07% - 0.1%
