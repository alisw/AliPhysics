...
void AddTask_GammaCaloMerged_pp(  Int_t     trainConfig                 = 1,                  // change different set of cuts
  ...
  // T0AND cuts
    ...
    // 13 TeV default
  } else if (trainConfig == 416){  // default, taken from 116, only different triggers
    cuts.AddCut("00010113","1111111067032200000","1111111067022700001","0163300000000000"); // INT7
    cuts.AddCut("00052113","1111111067032200000","1111111067022700001","0163300000000000"); // EMC7
    cuts.AddCut("00085113","1111111067032200000","1111111067022700001","0163300000000000"); // EG2
    cuts.AddCut("00083113","1111111067032200000","1111111067022700001","0163300000000000"); // EG1
