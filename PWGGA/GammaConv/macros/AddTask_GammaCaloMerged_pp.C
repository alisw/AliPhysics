...
void AddTask_GammaCaloMerged_pp(  Int_t     trainConfig                 = 1,                  // change different set of cuts
  ...
  // INT1 variations
  } else if (trainConfig == 10){ // NLM 1 M02 var  
  ...
  } else if (trainConfig == 11){  // EMCAL clusters, variation track matching to cluster & mass variations INT1 NLM1 
  ...
  } else if (trainConfig == 13){ // Alpha cut variations & TRD material INT1, NLM1
  ...
  } else if (trainConfig == 14){ // NLM1 varied exoctics
  ...
  // EMC1 variations  
  } else if (trainConfig == 20){ // NLM 1 M02 var  
  ...
  } else if (trainConfig == 21){ // EMCAL clusters, variation track matching to cluster & mass variations EMC1 NLM1 
  ...
  } else if (trainConfig == 23){ // Alpha cut variations & TRD material EMC1, NLM1
  ...
  } else if (trainConfig == 24){ // NLM1 varied exoctics
  ...
  } else if (trainConfig == 54){ // NLM1 varied exoctics
  ...
  } else if (trainConfig == 55){  // EMCAL clusters, variation of mass and alpha cut NLM1 INT7
  ...
  } else if (trainConfig == 64){ // NLM1 varied exoctics
  ...
  } else if (trainConfig == 74){ // NLM1 varied exoctics
  ...
  } else if (trainConfig == 75){  // EMCAL clusters, variation of mass and alpha cut NLM1 EG2
  ...
  } else if (trainConfig == 84){ // NLM1 varied exoctics
  ...
  } else if (trainConfig == 85){  // EMCAL clusters, variation of mass and alpha cut NLM1 EG1
  ...
  // default
    ...
    cuts.AddCut("00010113","1111111063032200000","1111111063022210001","0163301100000000"); // INT7
    cuts.AddCut("00052113","1111111063032200000","1111111063022210001","0163301100000000"); // EMC7
    cuts.AddCut("00081113","1111111063032200000","1111111063022210001","0163301100000000"); // EMCEGA,
  ...
  } else if (trainConfig == 114){  // Mass only band at 0, no explicit exotics cut, M02 cut at 0.27  
  ...
  } else if (trainConfig == 115){  // Mass only band at 0, explicit exotics cut at 0.97, M02 cut at 0.27  
  ...
  // NLM2 cuts  
  } else if (trainConfig == 160){  // EMCAL clusters, different triggers no NonLinearity
  ...
  } else if (trainConfig == 161){  // EMCAL clusters, different triggers with NonLinearity
    cuts.AddCut("00010113","1111111060032200000","1111111060022210002","0163302200000000"); // INT7
    cuts.AddCut("00052113","1111111060032200000","1111111060022210002","0163302200000000"); // EMC7
    cuts.AddCut("00081113","1111111060032200000","1111111060022210002","0163302200000000"); // EMCEGA,
  } else if (trainConfig == 162){  // EMCAL clusters, different triggers with NonLinearity track matching to cluster
    cuts.AddCut("00010113","1111111063032200000","1111111063022210002","0163302200000000"); // INT7
    cuts.AddCut("00052113","1111111063032200000","1111111063022210002","0163302200000000"); // EMC7
    cuts.AddCut("00081113","1111111063032200000","1111111063022210002","0163302200000000"); // EMCEGA,
  } else if (trainConfig == 163){  // NLM2 no M02, no mass, no alpha
