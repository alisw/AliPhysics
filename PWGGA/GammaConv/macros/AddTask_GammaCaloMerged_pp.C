...
void AddTask_GammaCaloMerged_pp(  Int_t     trainConfig                 = 1,                  // change different set of cuts
  ...
  if (trainConfig == 1){ // all defaults for LHC11a
    ...
    cuts.AddCut("00003113","1111121050032200000","1111121053022700001","0163300000000000"); // M02 < 0.27, no exotics
    cuts.AddCut("00051013","1111121050032200000","1111121053022700001","0163300000000000"); // M02 < 0.27, no exotics
