...
void AddTask_GammaCaloMerged_pp(  Int_t     trainConfig                 = 1,                  // change different set of cuts
  ...
  // LHC12
  // default
  } else if (trainConfig == 107){  // M02 cut at 0.2, y < 0.7, eta < 0.7
    cuts.AddCut("00010113","1551111063032200000","1551111063022700001","0163200000000000"); // INT7
    cuts.AddCut("00052113","1551111063032200000","1551111063022700001","0163200000000000"); // EMC7
    cuts.AddCut("00081113","1551111063032200000","1551111063022700001","0163200000000000"); // EGA
  } else if (trainConfig == 108){  // M02 cut at 0.27, pt dep TM, y < 0.7, eta < 0.7
    ...
    cuts.AddCut("00010113","1111111060032200000","1111111063022700001","0163300000000000"); // INT7
    cuts.AddCut("00052113","1111111060032200000","1111111063022700001","0163300000000000"); // EMC7
    cuts.AddCut("00081113","1111111060032200000","1111111063022700001","0163300000000000"); // EGA
  } else if (trainConfig == 118){  // NLM1 no M02, TM only in merged
    cuts.AddCut("00010113","1111111060032200000","1111111063022000001","0163300000000000"); // INT7
    cuts.AddCut("00052113","1111111060032200000","1111111063022000001","0163300000000000"); // EMC7
    cuts.AddCut("00081113","1111111060032200000","1111111063022000001","0163300000000000"); // EGA
    
    //kINT7 - NLM1
  } else if (trainConfig == 120){  // TRD material INT7 NLM 1
    cuts.AddCut("00010113","1112111063032200000","1112111063022700001","0163300000000000"); // TRD infront
    cuts.AddCut("00010113","1111311063032200000","1111311063022700001","0163300000000000"); // no TRD infront
  } else if (trainConfig == 121){ // varied exoctics
    cuts.AddCut("00010113","1111111063032200000","1111111063022700001","0163300000000000"); // no exotics
    cuts.AddCut("00010113","1111111063232200000","1111111063222700001","0163300000000000"); // frac = 0.99
    cuts.AddCut("00010113","1111111063332200000","1111111063322700001","0163300000000000"); // frac = 0.98
    cuts.AddCut("00010113","1111111063532200000","1111111063522700001","0163300000000000"); // frac = 0.97
    cuts.AddCut("00010113","1111111063732200000","1111111063722700001","0163300000000000"); // frac = 0.96
    cuts.AddCut("00010113","1111111063932200000","1111111063922700001","0163300000000000"); // frac = 0.94
    ...
    cuts.AddCut("00010113","1111111061032200000","1111121061022700001","0163300000000000"); // looser TM
    ...
    cuts.AddCut("00010113","1111112063032200000","1111112063022700001","0163300000000000"); // SDM loose time
    cuts.AddCut("00010113","1111101063032200000","1111101063022700001","0163300000000000"); // SDM Jason
    cuts.AddCut("00010113","1111100063032200000","1111100063022700001","0163300000000000"); // none

    //kEMC7 - NLM1
  } else if (trainConfig == 130){  // TRD material INT7 NLM 1
    cuts.AddCut("00052113","1112111063032200000","1112111063022700001","0163300000000000"); // TRD infront
    cuts.AddCut("00052113","1111311063032200000","1111311063022700001","0163300000000000"); // no TRD infront
  } else if (trainConfig == 131){ // varied exoctics
    cuts.AddCut("00052113","1111111063032200000","1111111063022700001","0163300000000000"); // no exotics
    cuts.AddCut("00052113","1111111063232200000","1111111063222700001","0163300000000000"); // frac = 0.99
    cuts.AddCut("00052113","1111111063332200000","1111111063322700001","0163300000000000"); // frac = 0.98
    cuts.AddCut("00052113","1111111063532200000","1111111063522700001","0163300000000000"); // frac = 0.97
    cuts.AddCut("00052113","1111111063732200000","1111111063722700001","0163300000000000"); // frac = 0.96
    cuts.AddCut("00052113","1111111063932200000","1111111063922700001","0163300000000000"); // frac = 0.94
    ...
    cuts.AddCut("00052113","1111111061032200000","1111121061022700001","0163300000000000"); // looser TM
    ...
    cuts.AddCut("00052113","1111112063032200000","1111112063022700001","0163300000000000"); // SDM loose time
    cuts.AddCut("00052113","1111101063032200000","1111101063022700001","0163300000000000"); // SDM Jason
    cuts.AddCut("00052113","1111100063032200000","1111100063022700001","0163300000000000"); // none
  
  //kEMCEGA - NLM1
  } else if (trainConfig == 140){  // TRD material INT7 NLM 1
    cuts.AddCut("00081113","1112111063032200000","1112111063022700001","0163300000000000"); // TRD infront
    cuts.AddCut("00081113","1111311063032200000","1111311063022700001","0163300000000000"); // no TRD infront
  } else if (trainConfig == 141){ // varied exoctics
    cuts.AddCut("00081113","1111111063032200000","1111111063022700001","0163300000000000"); // no exotics
    cuts.AddCut("00081113","1111111063232200000","1111111063222700001","0163300000000000"); // frac = 0.99
    cuts.AddCut("00081113","1111111063332200000","1111111063322700001","0163300000000000"); // frac = 0.98
    cuts.AddCut("00081113","1111111063532200000","1111111063522700001","0163300000000000"); // frac = 0.97
    cuts.AddCut("00081113","1111111063732200000","1111111063722700001","0163300000000000"); // frac = 0.96
    cuts.AddCut("00081113","1111111063932200000","1111111063922700001","0163300000000000"); // frac = 0.94
    ...
    cuts.AddCut("00081113","1111111061032200000","1111121061022700001","0163300000000000"); // looser TM
    ...
    cuts.AddCut("00081113","1111112063032200000","1111112063022700001","0163300000000000"); // SDM loose time
    cuts.AddCut("00081113","1111101063032200000","1111101063022700001","0163300000000000"); // SDM Jason
    cuts.AddCut("00081113","1111100063032200000","1111100063022700001","0163300000000000"); // none
  ...
  // NLM2 cuts  
    ...
    cuts.AddCut("00010113","1111111063032200000","1111111063022700000","0163300000000000"); // INT7
    cuts.AddCut("00052113","1111111063032200000","1111111063022700000","0163300000000000"); // EMC7
    cuts.AddCut("00081113","1111111063032200000","1111111063022700000","0163300000000000"); // EGA
  ...
  // 2.76TeV additional configurations  
  } else if (trainConfig == 501){  // new default  |eta| < 0.7, y < 0.7
    cuts.AddCut("00003113","1551121050032200000","1551121053022000001","0163200000000000"); 
    cuts.AddCut("00051013","1551121050032200000","1551121053022000001","0163200000000000"); 
    cuts.AddCut("00003113","1551121057032200000","1551121057022700001","0163200000000000"); 
    cuts.AddCut("00051013","1551121057032200000","1551121057022700001","0163200000000000"); 
  } else if (trainConfig == 502){  // new default without mass, |eta| < 0.7, y < 0.7
    cuts.AddCut("00010113","1551121063032200000","1551121063022700001","0163200000000000"); 
    cuts.AddCut("00052013","1551121063032200000","1551121063022700001","0163200000000000"); 
    cuts.AddCut("00085013","1551121063032200000","1551121063022700001","0163200000000000"); 
    cuts.AddCut("00083013","1551121063032200000","1551121063022700001","0163200000000000"); 
  } else if (trainConfig == 503){  // new default without mass, pt dependent TM, |eta| < 0.7, y < 0.7
    cuts.AddCut("00010113","1551121067032200000","1551121067022700001","0163200000000000"); 
    cuts.AddCut("00052013","1551121067032200000","1551121067022700001","0163200000000000"); 
    cuts.AddCut("00085013","1551121067032200000","1551121067022700001","0163200000000000"); 
    cuts.AddCut("00083013","1551121067032200000","1551121067022700001","0163200000000000"); 
