...
void AddTask_GammaCaloMerged_pp(
  ...
  // MB configs
    ...
    cuts.AddCutMergedCalo("00010113","1111132060032200000","1111132060022600001","0163300000000000"); // min 0.3
    cuts.AddCutMergedCalo("00010113","1111132060032200000","1111132060022900001","0163300000000000"); // min 0.1
    ...
    cuts.AddCutMergedCalo("00010113","1111132060032200000","1111132560022700001","0163300000000000"); // 1 <= row || coll || 0.5*(coll+row)
    cuts.AddCutMergedCalo("00010113","1111132060032200000","1111132660022700001","0163300000000000"); // 2 <= row || coll || 0.5*(coll+row)
  ...
  // EMC7 configs
    ...
    cuts.AddCutMergedCalo("00052113","1111132060032200000","1111132060022600001","0163300000000000"); // min 0.3
    cuts.AddCutMergedCalo("00052113","1111132060032200000","1111132060022900001","0163300000000000"); // min 0.1
    ...
    cuts.AddCutMergedCalo("00052113","1111132060032200000","1111132560022700001","0163300000000000"); // 1 <= row || coll || 0.5*(coll+row)
    cuts.AddCutMergedCalo("00052113","1111132060032200000","1111132660022700001","0163300000000000"); // 2 <= row || coll || 0.5*(coll+row)
  ...
  // EGA configs
    ...
    cuts.AddCutMergedCalo("00081113","1111132060032200000","1111132060022700001","0163300000000000"); // std
  } else if (trainConfig == 3941){ // M02 var 1
    cuts.AddCutMergedCalo("00081113","1111132060032200000","1111132060022600001","0163300000000000"); // min 0.3
    cuts.AddCutMergedCalo("00081113","1111132060032200000","1111132060022900001","0163300000000000"); // min 0.1
    ...
    cuts.AddCutMergedCalo("00081113","1111132060032200000","1111132560022700001","0163300000000000"); // 1 <= row || coll || 0.5*(coll+row)
    cuts.AddCutMergedCalo("00081113","1111132060032200000","1111132660022700001","0163300000000000"); // 2 <= row || coll || 0.5*(coll+row)
  ...
  // EMC7 configs
    ...
    cuts.AddCutMergedCalo("000a1113","4117932060032200000","4117932060022700001","0163300000000000"); // std
  } else if (trainConfig == 4121){ // M02 var 1
    cuts.AddCutMergedCalo("000a1113","4117932060032200000","4117932060022600001","0163300000000000"); // min 0.3
    cuts.AddCutMergedCalo("000a1113","4117932060032200000","4117932060022900001","0163300000000000"); // min 0.1
  } else if (trainConfig == 4122){ // M02 var 2
    cuts.AddCutMergedCalo("000a1113","4117932060032200000","4117932060022d00001","0163300000000000"); // min 0.33
    cuts.AddCutMergedCalo("000a1113","4117932060032200000","4117932060022e00001","0163300000000000"); // min 0.36
  } else if (trainConfig == 4123){ // M02 var 3
    cuts.AddCutMergedCalo("000a1113","4117932060032200000","4117932060022800001","0163300000000000"); // min 0.25
    cuts.AddCutMergedCalo("000a1113","4117932060032200000","4117932060022a00001","0163300000000000"); // min 0.26
  } else if (trainConfig == 4124){  // NL variations 1
    cuts.AddCutMergedCalo("000a1113","4117933060032200000","4117933060022700001","0163300000000000"); // 32
    cuts.AddCutMergedCalo("000a1113","4117934060032200000","4117934060022700001","0163300000000000"); // 33
    ...
    cuts.AddCutMergedCalo("000a1113","4117932060032200000","4117932160022700001","0163300000000000"); // 1 <= coll+row
    cuts.AddCutMergedCalo("000a1113","4117932060032200000","4117932260022700001","0163300000000000"); // 2 <= coll+row
  } else if (trainConfig == 4127){ // dist to bad channel
    cuts.AddCutMergedCalo("000a1113","4117932060032200000","4117932560022700001","0163300000000000"); // 1 <= row || coll || 0.5*(coll+row)
    cuts.AddCutMergedCalo("000a1113","4117932060032200000","4117932660022700001","0163300000000000"); // 2 <= row || coll || 0.5*(coll+row)
  } else if (trainConfig == 4128){  // timing cuts 3
    cuts.AddCutMergedCalo("000a1113","4117932040032200000","4117932040022700001","0163300000000000"); // 10ns
    cuts.AddCutMergedCalo("000a1113","4117932070032200000","4117932070022700001","0163300000000000"); // 30ns
  } else if (trainConfig == 4129){  // timing cuts
    cuts.AddCutMergedCalo("000a1113","4117932090032200000","4117932090022700001","0163300000000000"); // -20 to 25
    cuts.AddCutMergedCalo("000a1113","4117932050032200000","4117932050022700001","0163300000000000"); // -50 to 50
  } else if (trainConfig == 4130){  // timing cuts 2
    cuts.AddCutMergedCalo("000a1113","4117932030032200000","4117932030022700001","0163300000000000"); // -200 to 200
    cuts.AddCutMergedCalo("000a1113","4117932020032200000","4117932020022700001","0163300000000000"); // -500 to 500
  } else if (trainConfig == 4131){  // rapidity
    cuts.AddCutMergedCalo("000a1113","4117932060032200000","4117932060022700001","0163200000000000"); // rapidity < 0.7
    cuts.AddCutMergedCalo("000a1113","4117932060032200000","4117932060022700001","0163100000000000"); // rapidity < 0.8

  // EG1 configs
  } else if (trainConfig == 4140){ // M02 var 1
    cuts.AddCutMergedCalo("000a2113","4117932060032200000","4117932060022700001","0163300000000000"); // std
  } else if (trainConfig == 4141){ // M02 var 1
    cuts.AddCutMergedCalo("000a2113","4117932060032200000","4117932060022600001","0163300000000000"); // min 0.3
    cuts.AddCutMergedCalo("000a2113","4117932060032200000","4117932060022900001","0163300000000000"); // min 0.1
  } else if (trainConfig == 4142){ // M02 var 2
    cuts.AddCutMergedCalo("000a2113","4117932060032200000","4117932060022d00001","0163300000000000"); // min 0.33
    cuts.AddCutMergedCalo("000a2113","4117932060032200000","4117932060022e00001","0163300000000000"); // min 0.36
  } else if (trainConfig == 4143){ // M02 var 3
    cuts.AddCutMergedCalo("000a2113","4117932060032200000","4117932060022800001","0163300000000000"); // min 0.25
    cuts.AddCutMergedCalo("000a2113","4117932060032200000","4117932060022a00001","0163300000000000"); // min 0.26
  } else if (trainConfig == 4144){  // NL variations 1
    cuts.AddCutMergedCalo("000a2113","4117933060032200000","4117933060022700001","0163300000000000"); // 32
    cuts.AddCutMergedCalo("000a2113","4117934060032200000","4117934060022700001","0163300000000000"); // 33
    ...
    cuts.AddCutMergedCalo("000a2113","4117932060032200000","4117932160022700001","0163300000000000"); // 1 <= coll+row
    cuts.AddCutMergedCalo("000a2113","4117932060032200000","4117932260022700001","0163300000000000"); // 2 <= coll+row
  } else if (trainConfig == 4147){ // dist to bad channel
    cuts.AddCutMergedCalo("000a2113","4117932060032200000","4117932560022700001","0163300000000000"); // 1 <= row || coll || 0.5*(coll+row)
    cuts.AddCutMergedCalo("000a2113","4117932060032200000","4117932660022700001","0163300000000000"); // 2 <= row || coll || 0.5*(coll+row)
  } else if (trainConfig == 4148){  // timing cuts 3
    cuts.AddCutMergedCalo("000a2113","4117932040032200000","4117932040022700001","0163300000000000"); // 10ns
    cuts.AddCutMergedCalo("000a2113","4117932070032200000","4117932070022700001","0163300000000000"); // 30ns
  } else if (trainConfig == 4149){  // timing cuts
    cuts.AddCutMergedCalo("000a2113","4117932090032200000","4117932090022700001","0163300000000000"); // -20 to 25
    cuts.AddCutMergedCalo("000a2113","4117932050032200000","4117932050022700001","0163300000000000"); // -50 to 50
  } else if (trainConfig == 4150){  // timing cuts 2
    cuts.AddCutMergedCalo("000a2113","4117932030032200000","4117932030022700001","0163300000000000"); // -200 to 200
    cuts.AddCutMergedCalo("000a2113","4117932020032200000","4117932020022700001","0163300000000000"); // -500 to 500
  } else if (trainConfig == 4151){  // rapidity
    cuts.AddCutMergedCalo("000a2113","4117932060032200000","4117932060022700001","0163200000000000"); // rapidity < 0.7
    cuts.AddCutMergedCalo("000a2113","4117932060032200000","4117932060022700001","0163100000000000"); // rapidity < 0.8
