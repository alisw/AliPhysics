...
void AddTask_GammaCaloMerged_pp(  Int_t     trainConfig                 = 1,                  // change different set of cuts
  ...
  } else if (trainConfig == 3){ // NLM 1 M02 var  
  ...
  } else if (trainConfig == 4){  // EMCAL clusters, variation track matching to cluster & mass variations INT1 NLM1 
  ...
  } else if (trainConfig == 5){ // EMCAL clusters, variation track matching to cluster & mass variations EMC1 NLM1 
  ...
  } else if (trainConfig == 8){ // Alpha cut variations & TRD material INT1, NLM1
  ...
  } else if (trainConfig == 9){ // Alpha cut variations & TRD material EMC1, NLM1
  ...
  } else if (trainConfig == 10){ // no TM in basis cut
  ...
  } else if (trainConfig == 11){ // open M02, open Mass, open Alpha
  ...
  } else if (trainConfig == 12){ // NLM1 varied exoctics
  ...
  } else if (trainConfig == 13){ // NLM1 varied exoctics
  ...
  } else if (trainConfig == 14){  //NLM exotics default frac = 0.97
  ...
  } else if (trainConfig == 15){  // EMCAL clusters, variation of mass and alpha cut NLM1 INT1
  ...
  } else if (trainConfig == 16){  // EMCAL clusters, variation of mass and alpha cut NLM1 EMC1
  ...
  } else if (trainConfig == 41){ // NLM 1 M02 var  
  ...
  } else if (trainConfig == 43){ // NLM 1 M02 var  
  ...
  } else if (trainConfig == 45){  // EMCAL clusters, variation track matching to cluster & Mass INT7 NLM 1
  ...
  } else if (trainConfig == 46){  // EMCAL clusters, variation track matching to cluster & Mass EMC7 NLM 1
  ...
  } else if (trainConfig == 47){  // EMCAL clusters, variation track matching to cluster & Mass EG2 NLM 1
  ...
  } else if (trainConfig == 48){  // EMCAL clusters, variation track matching to cluster & Mass EG1 NLM 1
  ...
  } else if (trainConfig == 49){  // NL variations INT7
  ...
  } else if (trainConfig == 50){  // NL variations EMC7
  ...
  } else if (trainConfig == 51){  // NL variations EG2
  ...
  } else if (trainConfig == 52){  // NL variations EG1
  ...
  } else if (trainConfig == 54){  // Alpha cut variations & TRD material EMC7 NLM 1
  ...
  } else if (trainConfig == 55){  // Alpha cut variations & TRD material EG2 NLM 1
  ...
  } else if (trainConfig == 56){  // Alpha cut variations & TRD material EG1 NLM 1
  ...
  } else if (trainConfig == 57){  // no TM in basis cuts LHC13g NLM1
  ...
  } else if (trainConfig == 58){  // NLM1 no M02, no mass, no alpah
  ...
  } else if (trainConfig == 59){ // NLM1 varied exoctics
  ...
  } else if (trainConfig == 60){ // NLM1 varied exoctics
  ...
  } else if (trainConfig == 61){ // NLM1 varied exoctics
  ...
  } else if (trainConfig == 62){ // NLM1 varied exoctics
  ...
  } else if (trainConfig == 63){  //NLM exotics default frac = 0.97
  ...
  } else if (trainConfig == 64){  // EMCAL clusters, variation of mass and alpha cut NLM1 INT7
  ...
  } else if (trainConfig == 65){  // EMCAL clusters, variation of mass and alpha cut NLM1 EMC7
  ...
  } else if (trainConfig == 66){  // EMCAL clusters, variation of mass and alpha cut NLM1 EG2
  ...
  } else if (trainConfig == 67){  // EMCAL clusters, variation of mass and alpha cut NLM1 EG1
