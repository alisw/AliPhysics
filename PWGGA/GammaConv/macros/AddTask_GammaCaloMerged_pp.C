...
void AddTask_GammaCaloMerged_pp(  Int_t     trainConfig                 = 1,                  // change different set of cuts
  ...
  // default
    ...
    cuts.AddCut("00010113","1111111063032200000","1111111063022700001","0163300700000000"); // no exotics
    cuts.AddCut("00010113","1111111063232200000","1111111063222700001","0163300700000000"); // frac = 0.99
    cuts.AddCut("00010113","1111111063332200000","1111111063322700001","0163300700000000"); // frac = 0.98
    cuts.AddCut("00010113","1111111063532200000","1111111063522700001","0163300700000000"); // frac = 0.97
    cuts.AddCut("00010113","1111111063732200000","1111111063722700001","0163300700000000"); // frac = 0.96
    cuts.AddCut("00010113","1111111063932200000","1111111063922700001","0163300700000000"); // frac = 0.94
  } else if (trainConfig == 122){  // variation of mass and alpha cut 
    cuts.AddCut("00010113","1111111063032200000","1111111063022700001","0163301700000000"); // only band at 0
    cuts.AddCut("00010113","1111111063032200000","1111111063022700001","0163300700000000"); // only band at 0, no alpha
    cuts.AddCut("00010113","1111111063032200000","1111111063022700001","0163301000000000"); // no mass cut
    cuts.AddCut("00010113","1111111063032200000","1111111063022700001","0163300000000000"); // no mass cut, no alpha
    cuts.AddCut("00010113","1111111063032200000","1111111063022700001","0163300100000000"); // no alpha
  } else if (trainConfig == 123){ // varied M02
    cuts.AddCut("00010113","1111111063032200000","1111111063022600001","0163300700000000"); // min M02= 0.3
    cuts.AddCut("00010113","1111111063032200000","1111111063022800001","0163300700000000"); // min M02= 0.25
    cuts.AddCut("00010113","1111111063032200000","1111111063022600001","0163300000000000"); // no mass, min M02 = 0.3
    ...
    cuts.AddCut("00010113","1111111063032200000","1111111063022700001","0163300900000000"); // tighter mass cut
  } else if (trainConfig == 125){ // NL var new defaults
    cuts.AddCut("00010113","1111112063032200000","1111112063022700001","0163300700000000"); // SDM loose time
    cuts.AddCut("00010113","1111101063032200000","1111101063022700001","0163300700000000"); // SDM Jason
    cuts.AddCut("00010113","1111100063032200000","1111100063022700001","0163300700000000"); // none
    ...
    cuts.AddCut("00052113","1111111063032200000","1111111063022700001","0163300700000000"); // no exotics
    cuts.AddCut("00052113","1111111063232200000","1111111063222700001","0163300700000000"); // frac = 0.99
    cuts.AddCut("00052113","1111111063332200000","1111111063322700001","0163300700000000"); // frac = 0.98
    cuts.AddCut("00052113","1111111063532200000","1111111063522700001","0163300700000000"); // frac = 0.97
    cuts.AddCut("00052113","1111111063732200000","1111111063722700001","0163300700000000"); // frac = 0.96
    cuts.AddCut("00052113","1111111063932200000","1111111063922700001","0163300700000000"); // frac = 0.94
  } else if (trainConfig == 132){  // variation of mass and alpha cut 
    cuts.AddCut("00052113","1111111063032200000","1111111063022700001","0163301700000000"); // only band at 0
    cuts.AddCut("00052113","1111111063032200000","1111111063022700001","0163300700000000"); // only band at 0, no alpha
    cuts.AddCut("00052113","1111111063032200000","1111111063022700001","0163301000000000"); // no mass cut
    cuts.AddCut("00052113","1111111063032200000","1111111063022700001","0163300000000000"); // no mass cut, no alpha
    cuts.AddCut("00052113","1111111063032200000","1111111063022700001","0163300100000000"); // no alpha
  } else if (trainConfig == 133){ // varied M02
    cuts.AddCut("00052113","1111111063032200000","1111111063022600001","0163300700000000"); // min M02= 0.3
    cuts.AddCut("00052113","1111111063032200000","1111111063022800001","0163300700000000"); // min M02= 0.25
    cuts.AddCut("00052113","1111111063032200000","1111111063022600001","0163300000000000"); // no mass, min M02 = 0.3
    ...
    cuts.AddCut("00052113","1111111063032200000","1111111063022700001","0163300900000000"); // tighter mass cut
  } else if (trainConfig == 135){ // NL var new defaults
    cuts.AddCut("00052113","1111112063032200000","1111112063022700001","0163300700000000"); // SDM loose time
    cuts.AddCut("00052113","1111101063032200000","1111101063022700001","0163300700000000"); // SDM Jason
    cuts.AddCut("00052113","1111100063032200000","1111100063022700001","0163300700000000"); // none
  ...
  //kEMCEGA - NLM1
    ...
    cuts.AddCut("00081113","1111111063032200000","1111111063022700001","0163300700000000"); // no exotics
    cuts.AddCut("00081113","1111111063232200000","1111111063222700001","0163300700000000"); // frac = 0.99
    cuts.AddCut("00081113","1111111063332200000","1111111063322700001","0163300700000000"); // frac = 0.98
    cuts.AddCut("00081113","1111111063532200000","1111111063522700001","0163300700000000"); // frac = 0.97
    cuts.AddCut("00081113","1111111063732200000","1111111063722700001","0163300700000000"); // frac = 0.96
    cuts.AddCut("00081113","1111111063932200000","1111111063922700001","0163300700000000"); // frac = 0.94
  } else if (trainConfig == 142){  // variation of mass and alpha cut 
    cuts.AddCut("00081113","1111111063032200000","1111111063022700001","0163301700000000"); // only band at 0
    cuts.AddCut("00081113","1111111063032200000","1111111063022700001","0163300700000000"); // only band at 0, no alpha
    cuts.AddCut("00081113","1111111063032200000","1111111063022700001","0163301000000000"); // no mass cut
    cuts.AddCut("00081113","1111111063032200000","1111111063022700001","0163300000000000"); // no mass cut, no alpha
    cuts.AddCut("00081113","1111111063032200000","1111111063022700001","0163300100000000"); // no alpha
  } else if (trainConfig == 143){ // varied M02
    cuts.AddCut("00081113","1111111063032200000","1111111063022600001","0163300700000000"); // min M02= 0.3
    cuts.AddCut("00081113","1111111063032200000","1111111063022800001","0163300700000000"); // min M02= 0.25
    cuts.AddCut("00081113","1111111063032200000","1111111063022600001","0163300000000000"); // no mass, min M02 = 0.3
    ...
    cuts.AddCut("00081113","1111111063032200000","1111111063022700001","0163300900000000"); // tighter mass cut
  } else if (trainConfig == 145){ // NL var new defaults
    cuts.AddCut("00081113","1111112063032200000","1111112063022700001","0163300700000000"); // SDM loose time
    cuts.AddCut("00081113","1111101063032200000","1111101063022700001","0163300700000000"); // SDM Jason
    cuts.AddCut("00081113","1111100063032200000","1111100063022700001","0163300700000000"); // none
