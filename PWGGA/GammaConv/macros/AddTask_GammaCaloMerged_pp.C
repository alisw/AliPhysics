...
void AddTask_GammaCaloMerged_pp(  Int_t     trainConfig                 = 1,                  // change different set of cuts
  ...
  } else if (trainConfig == 20){ // NLM1 varied exoctics
    cuts.AddCut("00003113","1111121053032200000","1111121053022110001","0163301100000000"); // no exotics
    cuts.AddCut("00003113","1111121053232200000","1111121053222110001","0163301100000000"); // frac = 0.99
    cuts.AddCut("00003113","1111121053332200000","1111121053322110001","0163301100000000"); // frac = 0.98
    cuts.AddCut("00003113","1111121053532200000","1111121053522110001","0163301100000000"); // frac = 0.97
    cuts.AddCut("00003113","1111121053732200000","1111121053722110001","0163301100000000"); // frac = 0.96
    cuts.AddCut("00003113","1111121053932200000","1111121053922110001","0163301100000000"); // frac = 0.94
  } else if (trainConfig == 21){ // NLM1 varied exoctics
    cuts.AddCut("00051013","1111121053032200000","1111121053022110001","0163301100000000"); // no exotics
    cuts.AddCut("00051013","1111121053232200000","1111121053222110001","0163301100000000"); // frac = 0.99
    cuts.AddCut("00051013","1111121053332200000","1111121053322110001","0163301100000000"); // frac = 0.98
    cuts.AddCut("00051013","1111121053532200000","1111121053522110001","0163301100000000"); // frac = 0.97
    cuts.AddCut("00051013","1111121053732200000","1111121053722110001","0163301100000000"); // frac = 0.96
    cuts.AddCut("00051013","1111121053932200000","1111121053922110001","0163301100000000"); // frac = 0.94
  } else if (trainConfig == 23){  //NLM exotics default frac = 0.97
  ...
  } else if (trainConfig == 24){  // EMCAL clusters, variation of mass and alpha cut NLM1 INT1
    cuts.AddCut("00003113","1111121053032200000","1111121053022210001","0163301700000000"); // only band at 0
    cuts.AddCut("00003113","1111121053032200000","1111121053022210001","0163300700000000"); // only band at 0, no alpha
    cuts.AddCut("00003113","1111121053032200000","1111121053022210001","0163301000000000"); // no mass cut
    cuts.AddCut("00003113","1111121053032200000","1111121053022210001","0163300000000000"); // no mass cut, no alpha
    cuts.AddCut("00003113","1111121053032200000","1111121053022210001","0163300100000000"); // no alpha
  } else if (trainConfig == 25){  // EMCAL clusters, variation of mass and alpha cut NLM1 EMC1
    cuts.AddCut("00051013","1111121053032200000","1111121053022210001","0163301700000000"); // only band at 0
    cuts.AddCut("00051013","1111121053032200000","1111121053022210001","0163300700000000"); // only band at 0, no alpha
    cuts.AddCut("00051013","1111121053032200000","1111121053022210001","0163301000000000"); // no mass cut
  ...
  // LHC13g
    ...
    cuts.AddCut("00010113","1111121063032200000","1111121063022110002","0163302200000000"); // min 0.3 function default
    cuts.AddCut("00010113","1111121063032200000","1111121063022310002","0163302200000000"); // min 0.25 function default
    cuts.AddCut("00010113","1111121063032200000","1111121063022410002","0163302200000000"); // min 0.27, tighter lower func
    cuts.AddCut("00010113","1111121063032200000","1111121063022520002","0163302200000000"); // min 0.27, looser func up and low
    cuts.AddCut("00010113","1111121063032200000","1111121063022430002","0163302200000000"); // min 0.27, tighter func up and low
    ...
    cuts.AddCut("00052013","1111121063032200000","1111121063022110002","0163302200000000"); // min 0.3 function default
    cuts.AddCut("00052013","1111121063032200000","1111121063022310002","0163302200000000"); // min 0.25 function default
    cuts.AddCut("00052013","1111121063032200000","1111121063022410002","0163302200000000"); // min 0.27, tighter lower func
    cuts.AddCut("00052013","1111121063032200000","1111121063022520002","0163302200000000"); // min 0.27, looser func up and low
    cuts.AddCut("00052013","1111121063032200000","1111121063022430002","0163302200000000"); // min 0.27, tighter func up and low
    ...
    cuts.AddCut("00085013","1111121063032200000","1111121063022110002","0163302200000000"); // min 0.3 function default
    cuts.AddCut("00085013","1111121063032200000","1111121063022310002","0163302200000000"); // min 0.25 function default
    cuts.AddCut("00085013","1111121063032200000","1111121063022410002","0163302200000000"); // min 0.27, tighter lower func
    cuts.AddCut("00085013","1111121063032200000","1111121063022520002","0163302200000000"); // min 0.27, looser func up and low
    cuts.AddCut("00085013","1111121063032200000","1111121063022430002","0163302200000000"); // min 0.27, tighter func up and low
    ...
    cuts.AddCut("00083013","1111121063032200000","1111121063022110002","0163302200000000"); // min 0.3 function default
    cuts.AddCut("00083013","1111121063032200000","1111121063022310002","0163302200000000"); // min 0.25 function default
    cuts.AddCut("00083013","1111121063032200000","1111121063022410002","0163302200000000"); // min 0.27, tighter lower func
    cuts.AddCut("00083013","1111121063032200000","1111121063022520002","0163302200000000"); // min 0.27, looser func up and low
    cuts.AddCut("00083013","1111121063032200000","1111121063022430002","0163302200000000"); // min 0.27, tighter func up and low
    ...
    cuts.AddCut("00010113","1111121061032200000","1111121061022210002","0163302200000000"); // looser TM
    cuts.AddCut("00010113","1111121066032200000","1111121066022210002","0163302200000000"); // tighter TM
    cuts.AddCut("00010113","1111121063032200000","1111121063022210002","0163302400000000"); // tighter mass cut
    cuts.AddCut("00010113","1111121063032200000","1111121063022210002","0163302600000000"); // looser mass cut
    ...
    cuts.AddCut("00010113","1111122063032200000","1111122063022210002","0163302200000000"); // SDM loose time
    cuts.AddCut("00010113","1111111063032200000","1111111063022210002","0163302200000000"); // conv calo tight time
    cuts.AddCut("00010113","1111101063032200000","1111101063022210002","0163302200000000"); // SDM Jason
    cuts.AddCut("00010113","1111100063032200000","1111100063022210002","0163302200000000"); // none
    ...
    cuts.AddCut("00010113","1111121063032200000","1111121063022210002","0163304200000000"); // NLM 2 looser
    cuts.AddCut("00010113","1111121063032200000","1111121063022210002","0163306200000000"); // NLM 2 tighter
    cuts.AddCut("00010113","1112121063032200000","1112121063022210002","0163302200000000"); // TRD infront
    cuts.AddCut("00010113","1111321063032200000","1111321063022210002","0163302200000000"); // no TRD infront
    ...
    cuts.AddCut("00010113","1111121060032200000","1111121063022210002","0163302200000000"); // INT7
    ...
    cuts.AddCut("00010113","1111121063032200000","1111121063022210001","0163301100000000"); // INT7
  } else if (trainConfig == 80){ // NLM1 varied exoctics
    cuts.AddCut("00010113","1111121063032200000","1111121063022110001","0163301100000000"); // no exotics
    cuts.AddCut("00010113","1111121063232200000","1111121063222110001","0163301100000000"); // frac = 0.99
    cuts.AddCut("00010113","1111121063332200000","1111121063322110001","0163301100000000"); // frac = 0.98
    cuts.AddCut("00010113","1111121063532200000","1111121063522110001","0163301100000000"); // frac = 0.97
    cuts.AddCut("00010113","1111121063732200000","1111121063722110001","0163301100000000"); // frac = 0.96
    cuts.AddCut("00010113","1111121063932200000","1111121063922110001","0163301100000000"); // frac = 0.94
  } else if (trainConfig == 81){ // NLM1 varied exoctics
    cuts.AddCut("00052013","1111121063032200000","1111121063022110001","0163301100000000"); // no exotics
    cuts.AddCut("00052013","1111121063232200000","1111121063222110001","0163301100000000"); // frac = 0.99
    cuts.AddCut("00052013","1111121063332200000","1111121063322110001","0163301100000000"); // frac = 0.98
    cuts.AddCut("00052013","1111121063532200000","1111121063522110001","0163301100000000"); // frac = 0.97
    cuts.AddCut("00052013","1111121063732200000","1111121063722110001","0163301100000000"); // frac = 0.96
    cuts.AddCut("00052013","1111121063932200000","1111121063922110001","0163301100000000"); // frac = 0.94
  } else if (trainConfig == 82){ // NLM1 varied exoctics
    cuts.AddCut("00085013","1111121063032200000","1111121063022110001","0163301100000000"); // no exotics
    cuts.AddCut("00085013","1111121063232200000","1111121063222110001","0163301100000000"); // frac = 0.99
    cuts.AddCut("00085013","1111121063332200000","1111121063322110001","0163301100000000"); // frac = 0.98
    cuts.AddCut("00085013","1111121063532200000","1111121063522110001","0163301100000000"); // frac = 0.97
    cuts.AddCut("00085013","1111121063732200000","1111121063722110001","0163301100000000"); // frac = 0.96
    cuts.AddCut("00085013","1111121063932200000","1111121063922110001","0163301100000000"); // frac = 0.94
  } else if (trainConfig == 83){ // NLM1 varied exoctics
    cuts.AddCut("00083013","1111121063032200000","1111121063022110001","0163301100000000"); // no exotics
    cuts.AddCut("00083013","1111121063232200000","1111121063222110001","0163301100000000"); // frac = 0.99
    cuts.AddCut("00083013","1111121063332200000","1111121063322110001","0163301100000000"); // frac = 0.98
    cuts.AddCut("00083013","1111121063532200000","1111121063522110001","0163301100000000"); // frac = 0.97
    cuts.AddCut("00083013","1111121063732200000","1111121063722110001","0163301100000000"); // frac = 0.96
    cuts.AddCut("00083013","1111121063932200000","1111121063922110001","0163301100000000"); // frac = 0.94
  } else if (trainConfig == 84){  //NLM exotics default frac = 0.97
  ...
  } else if (trainConfig == 85){  // EMCAL clusters, variation of mass and alpha cut NLM1 INT7
    cuts.AddCut("00010113","1111121063032200000","1111121063022210001","0163301700000000"); // only band at 0
    cuts.AddCut("00010113","1111121063032200000","1111121063022210001","0163300700000000"); // only band at 0, no alpha
    cuts.AddCut("00010113","1111121063032200000","1111121063022210001","0163301000000000"); // no mass cut
    cuts.AddCut("00010113","1111121063032200000","1111121063022210001","0163300000000000"); // no mass cut, no alpha
    cuts.AddCut("00010113","1111121063032200000","1111121063022210001","0163300100000000"); // no alpha
  } else if (trainConfig == 86){  // EMCAL clusters, variation of mass and alpha cut NLM1 EMC7
    cuts.AddCut("00052013","1111121063032200000","1111121063022210001","0163301700000000"); // only band at 0
    cuts.AddCut("00052013","1111121063032200000","1111121063022210001","0163300700000000"); // only band at 0, no alpha
    cuts.AddCut("00052013","1111121063032200000","1111121063022210001","0163301000000000"); // no mass cut
    cuts.AddCut("00052013","1111121063032200000","1111121063022210001","0163300000000000"); // no mass cut, no alpha
    cuts.AddCut("00052013","1111121063032200000","1111121063022210001","0163300100000000"); // no alpha
  } else if (trainConfig == 87){  // EMCAL clusters, variation of mass and alpha cut NLM1 EG2
    cuts.AddCut("00085013","1111121063032200000","1111121063022210001","0163301700000000"); // only band at 0
    cuts.AddCut("00085013","1111121063032200000","1111121063022210001","0163300700000000"); // only band at 0, no alpha
    cuts.AddCut("00085013","1111121063032200000","1111121063022210001","0163301000000000"); // no mass cut
    cuts.AddCut("00085013","1111121063032200000","1111121063022210001","0163300000000000"); // no mass cut, no alpha
    cuts.AddCut("00085013","1111121063032200000","1111121063022210001","0163300100000000"); // no alpha
  } else if (trainConfig == 88){  // EMCAL clusters, variation of mass and alpha cut NLM1 EG1
    cuts.AddCut("00083013","1111121063032200000","1111121063022210001","0163301700000000"); // only band at 0
    cuts.AddCut("00083013","1111121063032200000","1111121063022210001","0163300700000000"); // only band at 0, no alpha
    cuts.AddCut("00083013","1111121063032200000","1111121063022210001","0163301000000000"); // no mass cut
  ...
  // default
    ...
    cuts.AddCut("00010113","1111100060032200000","1111100060022110001","0163301100000000"); // INT7
    cuts.AddCut("00052113","1111100060032200000","1111100060022110001","0163301100000000"); // EMC7
    ...
    cuts.AddCut("00010113","1111100060032200000","1111100060022110002","0163302200000000"); // INT7
    cuts.AddCut("00052113","1111100060032200000","1111100060022110002","0163302200000000"); // EMC7
    ...
    cuts.AddCut("00010113","1111111060032200000","1111111060022110001","0163301100000000"); // INT7
    cuts.AddCut("00052113","1111111060032200000","1111111060022110001","0163301100000000"); // EMC7
    ...
    cuts.AddCut("00010113","1111111060032200000","1111111060022110002","0163302200000000"); // INT7
    cuts.AddCut("00052113","1111111060032200000","1111111060022110002","0163302200000000"); // EMC7
    ...
    cuts.AddCut("00010113","1111111063032200000","1111111063022110001","0163301100000000"); // INT7
    cuts.AddCut("00052113","1111111063032200000","1111111063022110001","0163301100000000"); // EMC7
    ...
    cuts.AddCut("00010113","1111111063032200000","1111111063022110002","0163302200000000"); // INT7
    cuts.AddCut("00052113","1111111063032200000","1111111063022110002","0163302200000000"); // EMC7
    cuts.AddCut("00081113","1111111063032200000","1111111063022110002","0163302200000000"); // EMCEGA,

  } else if (trainConfig == 117){  // NLM1 no M02, no mass, no alpah
  ...
  } else if (trainConfig == 118){  // NLM2 no M02, no mass, no alpah
    cuts.AddCut("00010113","1111111063032200000","1111111063022000002","0163300000000000"); // INT7
    cuts.AddCut("00052113","1111111063032200000","1111111063022000002","0163300000000000"); // EMC7
    cuts.AddCut("00081113","1111111063032200000","1111111063022000002","0163300000000000"); // EGA

    //kINT7 - NLM1
  } else if (trainConfig == 120){ // NLM 1 M02 var
    cuts.AddCut("00010113","1111111063032200000","1111111063022110001","0163301100000000"); // min 0.3 function default
    cuts.AddCut("00010113","1111111063032200000","1111111063022310001","0163301100000000"); // min 0.25 function default
    cuts.AddCut("00010113","1111111063032200000","1111111063022410001","0163301100000000"); // min 0.27, tighter lower func
    cuts.AddCut("00010113","1111111063032200000","1111111063022520001","0163301100000000"); // min 0.27, looser func up and low
    cuts.AddCut("00010113","1111111063032200000","1111111063022430001","0163301100000000"); // min 0.27, tighter func up and low
  } else if (trainConfig == 121){  // EMCAL clusters, variation track matching to cluster & Mass INT7 NLM 1
    cuts.AddCut("00010113","1111111061032200000","1111111061022110001","0163301100000000"); // looser TM
    cuts.AddCut("00010113","1111111066032200000","1111111066022110001","0163301100000000"); // tighter TM
    cuts.AddCut("00010113","1111111063032200000","1111111063022110001","0163301300000000"); // tighter mass cut
    cuts.AddCut("00010113","1111111063032200000","1111111063022110001","0163301500000000"); // looser mass cut
  } else if (trainConfig == 122){  // NL variations INT7
    cuts.AddCut("00010113","1111112063032200000","1111112063022110001","0163301100000000"); // calo
    cuts.AddCut("00010113","1111111063032200000","1111111063022110001","0163301100000000"); // conv calo
    cuts.AddCut("00010113","1111101063032200000","1111101063022110001","0163301100000000"); // SDM Jason
    cuts.AddCut("00010113","1111100063032200000","1111100063022110001","0163301100000000"); // none
  } else if (trainConfig == 123){  // more NL variations INT7
    cuts.AddCut("00010113","1111112063032200000","1111121063022110001","0163301100000000"); // conv calo
    cuts.AddCut("00010113","1111111063032200000","1111122063022110001","0163301100000000"); // calo
    cuts.AddCut("00010113","1111101063032200000","1111113063022110001","0163301100000000"); //
    cuts.AddCut("00010113","1111100063032200000","1111114063022110001","0163301100000000"); //
  } else if (trainConfig == 124){  // Alpha cut variations & TRD material INT7 NLM 1
    cuts.AddCut("00010113","1111111063032200000","1111111063022110001","0163303100000000"); // NLM 1 looser
    cuts.AddCut("00010113","1111111063032200000","1111111063022110001","0163305100000000"); // NLM 1 tighter
    cuts.AddCut("00010113","1112111063032200000","1112111063022110001","0163301100000000"); // TRD infront
    cuts.AddCut("00010113","1111311063032200000","1111311063022110001","0163301100000000"); // no TRD infront

    //kEMC7 - NLM1
  } else if (trainConfig == 130){ // NLM 1 M02 var
    cuts.AddCut("00052113","1111111063032200000","1111111063022110001","0163301100000000"); // min 0.3 function default
    cuts.AddCut("00052113","1111111063032200000","1111111063022310001","0163301100000000"); // min 0.25 function default
    cuts.AddCut("00052113","1111111063032200000","1111111063022410001","0163301100000000"); // min 0.27, tighter lower func
    cuts.AddCut("00052113","1111111063032200000","1111111063022520001","0163301100000000"); // min 0.27, looser func up and low
    cuts.AddCut("00052113","1111111063032200000","1111111063022430001","0163301100000000"); // min 0.27, tighter func up and low
  } else if (trainConfig == 131){  // EMCAL clusters, variation track matching to cluster & Mass kEMC7 NLM 1
    cuts.AddCut("00052113","1111111061032200000","1111111061022110001","0163301100000000"); // looser TM
    cuts.AddCut("00052113","1111111066032200000","1111111066022110001","0163301100000000"); // tighter TM
    cuts.AddCut("00052113","1111111063032200000","1111111063022110001","0163301300000000"); // tighter mass cut
    cuts.AddCut("00052113","1111111063032200000","1111111063022110001","0163301500000000"); // looser mass cut
  } else if (trainConfig == 132){  // NL variations kEMC7
    cuts.AddCut("00052113","1111112063032200000","1111112063022110001","0163301100000000"); // calo
    cuts.AddCut("00052113","1111111063032200000","1111111063022110001","0163301100000000"); // conv calo
    cuts.AddCut("00052113","1111101063032200000","1111101063022110001","0163301100000000"); // SDM Jason
    cuts.AddCut("00052113","1111100063032200000","1111100063022110001","0163301100000000"); // none
  } else if (trainConfig == 133){  // more NL variations kEMC7
    cuts.AddCut("00052113","1111112063032200000","1111121063022110001","0163301100000000"); // conv calo
    cuts.AddCut("00052113","1111111063032200000","1111122063022110001","0163301100000000"); // calo
    cuts.AddCut("00052113","1111101063032200000","1111113063022110001","0163301100000000"); //
    cuts.AddCut("00052113","1111100063032200000","1111114063022110001","0163301100000000"); //
  } else if (trainConfig == 134){  // Alpha cut variations & TRD material kEMC7 NLM 1
    cuts.AddCut("00052113","1111111063032200000","1111111063022110001","0163303100000000"); // NLM 1 looser
    cuts.AddCut("00052113","1111111063032200000","1111111063022110001","0163305100000000"); // NLM 1 tighter
    cuts.AddCut("00052113","1112111063032200000","1112111063022110001","0163301100000000"); // TRD infront
    cuts.AddCut("00052113","1111311063032200000","1111311063022110001","0163301100000000"); // no TRD infront

  //kEMCEGA - NLM1
  } else if (trainConfig == 140){ // NLM 1 M02 var
    cuts.AddCut("00081113","1111111063032200000","1111111063022110001","0163301100000000"); // min 0.3 function default
    cuts.AddCut("00081113","1111111063032200000","1111111063022310001","0163301100000000"); // min 0.25 function default
    cuts.AddCut("00081113","1111111063032200000","1111111063022410001","0163301100000000"); // min 0.27, tighter lower func
    cuts.AddCut("00081113","1111111063032200000","1111111063022520001","0163301100000000"); // min 0.27, looser func up and low
    cuts.AddCut("00081113","1111111063032200000","1111111063022430001","0163301100000000"); // min 0.27, tighter func up and low
  } else if (trainConfig == 141){  // EMCAL clusters, variation track matching to cluster & Mass EGA NLM 1
    cuts.AddCut("00081113","1111111061032200000","1111111061022110001","0163301100000000"); // looser TM
    cuts.AddCut("00081113","1111111066032200000","1111111066022110001","0163301100000000"); // tighter TM
    cuts.AddCut("00081113","1111111063032200000","1111111063022110001","0163301300000000"); // tighter mass cut
    cuts.AddCut("00081113","1111111063032200000","1111111063022110001","0163301500000000"); // looser mass cut
  } else if (trainConfig == 142){  // NL variations EGA
    cuts.AddCut("00081113","1111112063032200000","1111112063022110001","0163301100000000"); // calo
    cuts.AddCut("00081113","1111111063032200000","1111111063022110001","0163301100000000"); // conv calo
    cuts.AddCut("00081113","1111101063032200000","1111101063022110001","0163301100000000"); // SDM Jason
    cuts.AddCut("00081113","1111100063032200000","1111100063022110001","0163301100000000"); // none
  } else if (trainConfig == 143){  // more NL variations EGA
    cuts.AddCut("00081113","1111112063032200000","1111121063022110001","0163301100000000"); // conv calo
    cuts.AddCut("00081113","1111111063032200000","1111122063022110001","0163301100000000"); // calo
    cuts.AddCut("00081113","1111101063032200000","1111113063022110001","0163301100000000"); //
    cuts.AddCut("00081113","1111100063032200000","1111114063022110001","0163301100000000"); //
  } else if (trainConfig == 144){  // Alpha cut variations & TRD material EGA NLM 1
    cuts.AddCut("00081113","1111111063032200000","1111111063022110001","0163303100000000"); // NLM 1 looser
    cuts.AddCut("00081113","1111111063032200000","1111111063022110001","0163305100000000"); // NLM 1 tighter
    cuts.AddCut("00081113","1112111063032200000","1112111063022110001","0163301100000000"); // TRD infront
    cuts.AddCut("00081113","1111311063032200000","1111311063022110001","0163301100000000"); // no TRD infront
