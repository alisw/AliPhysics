...
void AddTask_GammaCaloMerged_pp(  Int_t     trainConfig                 = 1,                  // change different set of cuts
  ...
  for(Int_t i = 0; i<rAddConfigArr->GetEntries() ; i++){
    if(i==0) rAdditionalTrainConfig = (TObjString*)rAddConfigArr->At(i);
      ...
      if(tempStr.BeginsWith("MODIFYACC")){
        ...
        cout << Form("INFO: AddTask_GammaCaloMerged_pp will use running mode '%i' for the TrackMatcher!",trackMatcherRunningMode) << endl;
      }
    }
  }
  ...
  if (trainConfig == 1){ // all defaults for LHC11a
    ...
    cuts.AddCut("00003113","1111121057032200000","1111121057022000001","0163300000000000"); // no M02, no exotics
    cuts.AddCut("00051013","1111121057032200000","1111121057022000001","0163300000000000"); // no M02, no exotics
  ...
  // LHC13g
    ...
    cuts.AddCut("00010113","1111121063032200000","1111121063022700001","0163300700000000"); // INT7
    cuts.AddCut("00052013","1111121063032200000","1111121063022700001","0163300700000000"); // EMC7
    cuts.AddCut("00085013","1111121063032200000","1111121063022700001","0163300700000000"); // EG2
    cuts.AddCut("00083013","1111121063032200000","1111121063022700001","0163300700000000"); // EG1
  } else if (trainConfig == 44){  // NLM1 no explicit exotics cut, M02 cut at 0.27, TM fixed vs pt
    cuts.AddCut("00010113","1111121063032200000","1111121063022700001","0163300000000000"); // INT7
    cuts.AddCut("00052013","1111121063032200000","1111121063022700001","0163300000000000"); // EMC7
    cuts.AddCut("00085013","1111121063032200000","1111121063022700001","0163300000000000"); // EG2
    cuts.AddCut("00083013","1111121063032200000","1111121063022700001","0163300000000000"); // EG1
    ...
    cuts.AddCut("00010113","1111121060032200000","1111121063022700001","0163300000000000"); // INT7
    cuts.AddCut("00052013","1111121060032200000","1111121063022700001","0163300000000000"); // EMC7
    cuts.AddCut("00085013","1111121060032200000","1111121063022700001","0163300000000000"); // EG2
    cuts.AddCut("00083013","1111121060032200000","1111121063022700001","0163300000000000"); // EG1
    ...
    cuts.AddCut("00052013","1111121067032200000","1111121067022700001","0163300000000000"); // EMC7
    cuts.AddCut("00085013","1111121067032200000","1111121067022700001","0163300000000000"); // EG2
    cuts.AddCut("00083013","1111121067032200000","1111121067022700001","0163300000000000"); // EG1
  } else if (trainConfig == 49){  // pp 2.76TeV paper cuts  w/o mass
    cuts.AddCut("00010113","1111121067032200000","1111121067022000001","0163300000000000");
    cuts.AddCut("00052013","1111121067032200000","1111121067022000001","0163300000000000"); // EMC7
    cuts.AddCut("00085013","1111121067032200000","1111121067022000001","0163300000000000"); // EG2
    cuts.AddCut("00083013","1111121067032200000","1111121067022000001","0163300000000000"); // EG1
  ...
  // new default
    ...
    cuts.AddCut("00010113","1111102067032200000","1111102067022700001","0163300000000000"); // Testbeam (v3) for data, Pi0MCv3 for MC
    cuts.AddCut("00010113","1111106067032200000","1111106067022700001","0163300000000000"); // Testbeam (v4) for data, Pi0MCv3 for MC
    ...
    cuts.AddCut("00052113","1111102067032200000","1111102067022700001","0163300000000000"); // Testbeam (v3) for data, Pi0MCv3 for MC
    cuts.AddCut("00052113","1111106067032200000","1111106067022700001","0163300000000000"); // Testbeam (v4) for data, Pi0MCv3 for MC
  ...
  //kEMCEGA - NLM1
    ...
    cuts.AddCut("00081113","1111102067032200000","1111102067022700001","0163300000000000"); // Testbeam (v3) for data, Pi0MCv3 for MC
    cuts.AddCut("00081113","1111106067032200000","1111106067022700001","0163300000000000"); // Testbeam (v4) for data, Pi0MCv3 for MC
  ...
  // standard cuts (with EOverP reference plots) to test effect of new track matching modes (cf. AliCaloTrackMatcher.h)
    ...
    cuts.AddCut("00081113","1111111060032200000","1111111060022900001","0163300000000000"); // min M02 = 0.10 + min M02 = 0.10
    cuts.AddCut("00081113","1111111060032200000","1111111060022700001","0163300000000000"); // min M02 = 0.10 + min M02 = 0.27
    cuts.AddCut("00081113","1111111060032200000","1111111060022600001","0163300000000000"); // min M02 = 0.10 + min M02 = 0.30
    ...
    cuts.AddCut("00010113","1111101017032200000","1111101017022700001","0163300000000000"); // INT7
    cuts.AddCut("00052113","1111101017032200000","1111101017022700001","0163300000000000"); // EMC7
    cuts.AddCut("00085113","1111101017032200000","1111101017022700001","0163300000000000"); // EG2
    cuts.AddCut("00083113","1111101017032200000","1111101017022700001","0163300000000000"); // EG1
  } else if (trainConfig == 402){  // pp 2.76TeV paper cuts:  w/o mass, open timing, TB nonlin
    cuts.AddCut("00010113","1111101017032200000","1111101017022000001","0163300000000000");
    cuts.AddCut("00052113","1111101017032200000","1111101017022000001","0163300000000000"); // EMC7
    cuts.AddCut("00085113","1111101017032200000","1111101017022000001","0163300000000000"); // EG2
    cuts.AddCut("00083113","1111101017032200000","1111101017022000001","0163300000000000"); // EG1
  } else if (trainConfig == 403){ // pp 2.76TeV paper cuts : open timing, TB nonlin
    cuts.AddCut("00010113","1111100017032200000","1111100017022700001","0163300000000000"); // INT7
    cuts.AddCut("00052113","1111100017032200000","1111100017022700001","0163300000000000"); // EMC7
    cuts.AddCut("00085113","1111100017032200000","1111100017022700001","0163300000000000"); // EG2
    cuts.AddCut("00083113","1111100017032200000","1111100017022700001","0163300000000000"); // EG1
  } else if (trainConfig == 404){  // pp 2.76TeV paper cuts:  w/o mass, open timing, TB nonlin
    cuts.AddCut("00010113","1111100017032200000","1111100017022000001","0163300000000000");
    cuts.AddCut("00052113","1111100017032200000","1111100017022000001","0163300000000000"); // EMC7
    cuts.AddCut("00085113","1111100017032200000","1111100017022000001","0163300000000000"); // EG2
    ...
    cuts.AddCut("00010113","1111111067032200000","1111111067022700001","0163300000000000"); // std INT7
    cuts.AddCut("00010113","111111106c032200000","111111106c022700001","0163300000000000"); // fEOverPMax = 9e9
    cuts.AddCut("00010113","111111106d032200000","111111106d022700001","0163300000000000"); // fEOverPMax = 3.0
    cuts.AddCut("00010113","111111106e032200000","111111106e022700001","0163300000000000"); // fEOverPMax = 2.0
  } else if (trainConfig == 461){ // INT7 EMCAL standard cut but with E/p TM veto
    cuts.AddCut("00010113","111111106f032200000","111111106f022700001","0163300000000000"); // fEOverPMax = 1.75
    cuts.AddCut("00010113","111111106g032200000","111111106g022700001","0163300000000000"); // fEOverPMax = 1.5
    cuts.AddCut("00010113","111111106h032200000","111111106h022700001","0163300000000000"); // fEOverPMax = 1.25
  } else if (trainConfig == 462){ // EMC7 EMCAL standard cut but with E/p TM veto
    cuts.AddCut("00052113","1111111067032200000","1111111067022700001","0163300000000000"); // std EMC7
    cuts.AddCut("00052113","111111106c032200000","111111106c022700001","0163300000000000"); // fEOverPMax = 9e9
    cuts.AddCut("00052113","111111106d032200000","111111106d022700001","0163300000000000"); // fEOverPMax = 3.0
    cuts.AddCut("00052113","111111106e032200000","111111106e022700001","0163300000000000"); // fEOverPMax = 2.0
  } else if (trainConfig == 463){ // EMC7 EMCAL standard cut but with E/p TM veto
    cuts.AddCut("00052113","111111106f032200000","111111106f022700001","0163300000000000"); // fEOverPMax = 1.75
    cuts.AddCut("00052113","111111106g032200000","111111106g022700001","0163300000000000"); // fEOverPMax = 1.5
    cuts.AddCut("00052113","111111106h032200000","111111106h022700001","0163300000000000"); // fEOverPMax = 1.25
  } else if (trainConfig == 464){ // EG1 EMCAL standard cut but with E/p TM veto
    cuts.AddCut("00083113","1111111067032200000","1111111067022700001","0163300000000000"); // std EG1
    cuts.AddCut("00083113","111111106c032200000","111111106c022700001","0163300000000000"); // fEOverPMax = 9e9
    cuts.AddCut("00083113","111111106d032200000","111111106d022700001","0163300000000000"); // fEOverPMax = 3.0
    cuts.AddCut("00083113","111111106e032200000","111111106e022700001","0163300000000000"); // fEOverPMax = 2.0
  } else if (trainConfig == 465){ // EG1 EMCAL standard cut but with E/p TM veto
    cuts.AddCut("00083113","111111106f032200000","111111106f022700001","0163300000000000"); // fEOverPMax = 1.75
    cuts.AddCut("00083113","111111106g032200000","111111106g022700001","0163300000000000"); // fEOverPMax = 1.5
    cuts.AddCut("00083113","111111106h032200000","111111106h022700001","0163300000000000"); // fEOverPMax = 1.25
  } else if (trainConfig == 466){ // EG2 EMCAL standard cut but with E/p TM veto
    cuts.AddCut("00085113","1111111067032200000","1111111067022700001","0163300000000000"); // std EG2
    cuts.AddCut("00085113","111111106c032200000","111111106c022700001","0163300000000000"); // fEOverPMax = 9e9
    cuts.AddCut("00085113","111111106d032200000","111111106d022700001","0163300000000000"); // fEOverPMax = 3.0
    cuts.AddCut("00085113","111111106e032200000","111111106e022700001","0163300000000000"); // fEOverPMax = 2.0
  } else if (trainConfig == 467){ // EG2 EMCAL standard cut but with E/p TM veto
    cuts.AddCut("00085113","111111106f032200000","111111106f022700001","0163300000000000"); // fEOverPMax = 1.75
    cuts.AddCut("00085113","111111106g032200000","111111106g022700001","0163300000000000"); // fEOverPMax = 1.5
    cuts.AddCut("00085113","111111106h032200000","111111106h022700001","0163300000000000"); // fEOverPMax = 1.25
  } else if (trainConfig == 480){ // no TM - CALO+CALOFAST triggers
    cuts.AddCut("000a0113","1111111060032200000","1111111060022700001","0163300000000000"); // INT7
    cuts.AddCut("000a1113","1111111060032200000","1111111060022700001","0163300000000000"); // EMC7
    cuts.AddCut("000a2113","1111111060032200000","1111111060022700001","0163300000000000"); // EG2
    cuts.AddCut("000a3113","1111111060032200000","1111111060022700001","0163300000000000"); // EG1
  } else if (trainConfig == 481){ // no TM
    cuts.AddCut("00010113","1111111060032200000","1111111060022700001","0163300000000000"); // INT7
    cuts.AddCut("00052113","1111111060032200000","1111111060022700001","0163300000000000"); // EMC7
    cuts.AddCut("00085113","1111111060032200000","1111111060022700001","0163300000000000"); // EG2
    cuts.AddCut("00083113","1111111060032200000","1111111060022700001","0163300000000000"); // EG1
  } else {
