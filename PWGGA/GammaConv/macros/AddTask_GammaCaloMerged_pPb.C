...
void AddTask_GammaCaloMerged_pPb(
  ...
  } else if (trainConfig == 3816){ // varied M02 part 1 DMC
    cuts.AddCutMergedCalo("80010123","3885532050032200000","3885532050022g00001","0163300000000000"); // min 0.24
    cuts.AddCutMergedCalo("80010123","3885532050032200000","3885532050022h00001","0163300000000000"); // min 0.23
    cuts.AddCutMergedCalo("80010123","3885532050032200000","3885532050022j00001","0163300000000000"); // min 0.21
  } else if (trainConfig == 3817){ // varied M02 part 2 DMC
  ...
  } else if (trainConfig == 3836){ // varied M02 part 1 DMC
    cuts.AddCutMergedCalo("8008b123","3885532050032200000","3885532050022g00001","0163300000000000"); // min 0.24
    cuts.AddCutMergedCalo("8008b123","3885532050032200000","3885532050022h00001","0163300000000000"); // min 0.23
    cuts.AddCutMergedCalo("8008b123","3885532050032200000","3885532050022j00001","0163300000000000"); // min 0.21
  } else if (trainConfig == 3837){ // varied M02 part 2 DMC
  ...
  // EG1 configs
    ...
    cuts.AddCutMergedCalo("80083123","1111132050032200000","1111132050022l00001","0163300000000000"); // min 0.19
    cuts.AddCutMergedCalo("80083123","1111132050032200000","1111132050022m00001","0163300000000000"); // min 0.18
  } else if (trainConfig == 3856){ // varied M02 part 1 DMC
    cuts.AddCutMergedCalo("80089123","3885532050032200000","3885532050022g00001","0163300000000000"); // min 0.24
    cuts.AddCutMergedCalo("80089123","3885532050032200000","3885532050022h00001","0163300000000000"); // min 0.23
    cuts.AddCutMergedCalo("80089123","3885532050032200000","3885532050022j00001","0163300000000000"); // min 0.21
  } else if (trainConfig == 3857){ // varied M02 part 2 DMC
