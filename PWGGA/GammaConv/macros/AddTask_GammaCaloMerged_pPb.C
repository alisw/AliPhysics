...
void AddTask_GammaCaloMerged_pPb( Int_t     trainConfig                 = 1,                  // change different set of cuts
  ...
  for(Int_t i = 0; i<rAddConfigArr->GetEntries() ; i++){
    if(i==0) rAdditionalTrainConfig = (TObjString*)rAddConfigArr->At(i);
      ...
      if(tempStr.CompareTo("EPCLUSTree") == 0){
        ...
        cout << Form("INFO: AddTask_GammaCaloMerged_pPb will use running mode '%i' for the TrackMatcher!",trackMatcherRunningMode) << endl;
      }
    }
  }
  ...
  // run 2 data
    ...
    cuts.AddCut("800a0113","1111101010032200000","1111101010022700001","0163300000000000"); // INT7
    cuts.AddCut("800a1113","1111101010032200000","1111101010022700001","0163300000000000"); // EMC7
    cuts.AddCut("800a2113","1111101010032200000","1111101010022700001","0163300000000000"); // EG2
    cuts.AddCut("800a3113","1111101010032200000","1111101010022700001","0163300000000000"); // EG1
