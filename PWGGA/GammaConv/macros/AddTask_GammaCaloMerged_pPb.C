...
void AddTask_GammaCaloMerged_pPb(
  ...
  // MB configs
    ...
    cuts.AddCutMergedCalo("80010103","1111100050032200000","1111100050022700001","0163300000000000"); // none
    cuts.AddCutMergedCalo("80010103","1111132050032200000","1111132050022700001","0163300000000000"); // 48
  } else if (trainConfig == 4105){ // varied M02 part 1
    cuts.AddCutMergedCalo("80010103","1111133050032200000","1111133050022700001","0163300000000000"); // 57
    cuts.AddCutMergedCalo("80010103","1111134050032200000","1111134050022700001","0163300000000000"); // tb (65)
   ...
   // EG2 configs
    ...
    cuts.AddCutMergedCalo("80085103","1111100050032200000","1111100050022700001","0163300000000000"); // none
    cuts.AddCutMergedCalo("80085103","1111132050032200000","1111132050022700001","0163300000000000"); // 48
  } else if (trainConfig == 4125){ // varied M02 part 1
    cuts.AddCutMergedCalo("80085103","1111133050032200000","1111133050022700001","0163300000000000"); // 57
    cuts.AddCutMergedCalo("80085103","1111134050032200000","1111134050022700001","0163300000000000"); // tb (65)
  ...
  // EG1 configs
    ...
    cuts.AddCutMergedCalo("80083103","1111100050032200000","1111100050022700001","0163300000000000"); // none
    cuts.AddCutMergedCalo("80083103","1111132050032200000","1111132050022700001","0163300000000000"); // 48
  } else if (trainConfig == 4145){ // varied M02 part 1
    cuts.AddCutMergedCalo("80083103","1111133050032200000","1111133050022700001","0163300000000000"); // 57
    cuts.AddCutMergedCalo("80083103","1111134050032200000","1111134050022700001","0163300000000000"); // tb (65)
