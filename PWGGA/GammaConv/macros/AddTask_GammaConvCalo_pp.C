...
void AddTask_GammaConvCalo_pp(  Int_t     trainConfig                   = 1,                      // change different set of cuts
  ...
  // only std cuts
  } else if (trainConfig == 190){ //std EGA
  ...
  // 7 TeV
    ...
    cuts.AddCut("00000113","00200009327000008250400000","1112111067032230000","0163103100000010"); //only modules with TRD infront
    cuts.AddCut("00000113","00200009327000008250400000","1111311067032230000","0163103100000010"); //no modules with TRD infront
