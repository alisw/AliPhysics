...
void AddTask_GammaConvCalo_pp(
 ...
 //*************************************************************************************************
  ...
  //*************************************************************************************************
      ...
      cuts.AddCutPCMCalo("00010113","0dm00009f9730000dge0404000","24466190pa01cc00000","0163103100000010"); // INT7 no Trigger
  } else if ( trainConfig == 901){ // PHI7, 300MeV
      cuts.AddCutPCMCalo("00062113","0dm00009f9730000dge0404000","24466190pa01cc00000","0163103100000010"); //PHI7
    ...
    cuts.AddCutPCMCalo("00010113","0dm00009f9730000dge0404000","24466190pa012200000","0163103100000010"); // INT7
    cuts.AddCutPCMCalo("00010113","0dm00009f9730000dge0404000","24466190pa012c00000","0163103100000010"); // INT7
    cuts.AddCutPCMCalo("00010113","0dm00009f9730000dge0404000","24466190pa01c200000","0163103100000010"); // INT7
    cuts.AddCutPCMCalo("00010113","0dm00009f9730000dge0404000","24466190pa01cc00000","0163103100000010"); // INT7
    cuts.AddCutPCMCalo("00010113","0dm00009f9730000dge0404000","24466190pa01d200000","0163103100000010"); // INT7
    cuts.AddCutPCMCalo("00010113","0dm00009f9730000dge0404000","24466190pa01dc00000","0163103100000010"); // INT7
  } else if ( trainConfig == 906){ // StdCut
    cuts.AddCutPCMCalo("00010113","0dm00009f9730000dge0404000","24466190pa01cc00000","0163103100000010"); // QA
  } else if ( trainConfig == 907){ // NonLinStudies
    //cuts.AddCutPCMCalo("00010113","0dm00009f9730000dge0404000","24466000pa01cc00000","0163103100000010"); // QA
    //cuts.AddCutPCMCalo("00062113","0dm00009f9730000dge0404000","24466000pa01cc00000","0163103100000010"); // QA
    //-
    //cuts.AddCutPCMCalo("00010113","0dm00009f9730000dge0404000","24466510pa01cc00000","0163103100000010"); // 51 Nonlin MB
    //cuts.AddCutPCMCalo("00062113","0dm00009f9730000dge0404000","24466510pa01cc00000","0163103100000010"); // 51 Nonlin Triggerd
    //-
    cuts.AddCutPCMCalo("00010113","0dm00009f9730000dge0404000","24466110pa01cc00000","0163103100000010"); // QA //case 11=> FunctionNL_kSDM MB PCMPHOS
    cuts.AddCutPCMCalo("00062113","0dm00009f9730000dge0404000","24466110pa01cc00000","0163103100000010"); // QA //case 11=> FunctionNL_kSDM Triggerd PCMPHOS
    //-
    cuts.AddCutPCMCalo("00010113","0dm00009f9730000dge0404000","24466120pa01cc00000","0163103100000010"); // QA //case 12=> FunctionNL_kSDM MB PHOSPHOS
    cuts.AddCutPCMCalo("00062113","0dm00009f9730000dge0404000","24466120pa01cc00000","0163103100000010"); // QA //case 12=> FunctionNL_kSDM Triggerd PHOSPHOS
    //-
    cuts.AddCutPCMCalo("00010113","0dm00009f9730000dge0404000","24466190pa01cc00000","0163103100000010"); // QA //case 19=> FunctionNL_kSDM MB PCMPHOS, Tuned with PHOSPHOS
    cuts.AddCutPCMCalo("00062113","0dm00009f9730000dge0404000","24466190pa01cc00000","0163103100000010"); // QA //case 19=> FunctionNL_kSDM Triggerd PCMPHOS, Tuned with PHOSPHOS
    //-
    //cuts.AddCutPCMCalo("00010113","0dm00009f9730000dge0404000","24466210pa01cc00000","0163103100000010"); // QA //case 21=> unctionNL_DPOW MB
    //cuts.AddCutPCMCalo("00062113","0dm00009f9730000dge0404000","24466210pa01cc00000","0163103100000010"); // QA //case 21=> unctionNL_DPOW Triggerd
  } else if ( trainConfig == 908){  //PHOS MB and PHI7, 100MeV
    cuts.AddCutPCMCalo("00010113","0dm00009f9730000dge0404000","24466190pa00cc00000","0163103100000010"); //no Trigger
    cuts.AddCutPCMCalo("00062113","0dm00009f9730000dge0404000","24466190pa00cc00000","0163103100000010"); //PHI7
  } else if ( trainConfig == 909){  //PHOS Smearing Check
    cuts.AddCutPCMCalo("00010113","0dm00009f9730000dge0404000","24466190pa01cc00000","0163103100400010"); //4
    cuts.AddCutPCMCalo("00010113","0dm00009f9730000dge0404000","24466190pa01cc00000","0163103100500010"); //5
    cuts.AddCutPCMCalo("00010113","0dm00009f9730000dge0404000","24466190pa01cc00000","0163103100a00010"); //a
    cuts.AddCutPCMCalo("00010113","0dm00009f9730000dge0404000","24466190pa01cc00000","0163103100b00010"); //b
    cuts.AddCutPCMCalo("00010113","0dm00009f9730000dge0404000","24466190pa01cc00000","0163103100c00010"); //c
    cuts.AddCutPCMCalo("00010113","0dm00009f9730000dge0404000","24466190pa01cc00000","0163103100d00010"); //d
    cuts.AddCutPCMCalo("00010113","0dm00009f9730000dge0404000","24466190pa01cc00000","0163103100e00010"); //e
  } else if ( trainConfig == 910){  //PHOS Sphericiry Check
    cuts.AddCutPCMCalo("h0510113","0dm00009f9730000dge0404000","24466190pa01cc00000","0163103100000010"); //  0.    - 0.5
    cuts.AddCutPCMCalo("h5a10113","0dm00009f9730000dge0404000","24466190pa01cc00000","0163103100000010"); //  0.5    - 1.
    cuts.AddCutPCMCalo("h0a10113","0dm00009f9730000dge0404000","24466190pa01cc00000","0163103100000010"); //  0.    - 1.
  } else if ( trainConfig == 911){  //PHOS Mult Check
    cuts.AddCutPCMCalo("n0110113","0dm00009f9730000dge0404000","24466190pa01cc00000","0163103100000010"); // INT7 0-10%
    cuts.AddCutPCMCalo("n1210113","0dm00009f9730000dge0404000","24466190pa01cc00000","0163103100000010"); // INT7 10-20%
    cuts.AddCutPCMCalo("n2510113","0dm00009f9730000dge0404000","24466190pa01cc00000","0163103100000010"); // INT7 20-50%
    cuts.AddCutPCMCalo("n5a10113","0dm00009f9730000dge0404000","24466190pa01cc00000","0163103100000010"); // INT7 50-100%
    cuts.AddCutPCMCalo("m0110113","0dm00009f9730000dge0404000","24466190pa01cc00000","0163103100000010"); // INT7
    cuts.AddCutPCMCalo("m1510113","0dm00009f9730000dge0404000","24466190pa01cc00000","0163103100000010"); // INT7
    cuts.AddCutPCMCalo("m5a10113","0dm00009f9730000dge0404000","24466190pa01cc00000","0163103100000010"); // INT7
  } else if ( trainConfig == 912){  //PHOS MB and PHI7 Timing Cut 0; 100MeV
    cuts.AddCutPCMCalo("00010113","0dm00009f9730000dge0404000","244661900a00cc00000","0163103100000010"); //no Trigger
    cuts.AddCutPCMCalo("00062113","0dm00009f9730000dge0404000","244661900a00cc00000","0163103100000010"); //PHI7
    ...
    cuts.AddCutPCMCalo("00010113","0d200009f9730000dge0404000","24466190pa01cc00000","0163103100000010");
    cuts.AddCutPCMCalo("00010113","0da00009f9730000dge0404000","24466190pa01cc00000","0163103100000010");
    cuts.AddCutPCMCalo("00010113","0db00009f9730000dge0404000","24466190pa01cc00000","0163103100000010");
    cuts.AddCutPCMCalo("00010113","0dc00009f9730000dge0404000","24466190pa01cc00000","0163103100000010");
    //Normal B Option
    ...
    cuts.AddCutPCMCalo("00010113","0da00009f9730000dge0404000","24466190pa01cc00000","0163103100000010"); // INT7   RBins
    cuts.AddCutPCMCalo("00010113","0db00009f9730000dge0404000","24466190pa01cc00000","0163103100000010"); // INT7
    cuts.AddCutPCMCalo("00010113","0dc00009f9730000dge0404000","24466190pa01cc00000","0163103100000010"); // INT7
 } else if ( trainConfig == 922){ // Default cut, with TM   with eta<0.8
    cuts.AddCutPCMCalo("00010113","0dh00009f9730000dge0404000","24466190pa01cc00000","0163103100000010"); // INT7   RBins
    cuts.AddCutPCMCalo("00010113","0di00009f9730000dge0404000","24466190pa01cc00000","0163103100000010"); // INT7
    cuts.AddCutPCMCalo("00010113","0dj00009f9730000dge0404000","24466190pa01cc00000","0163103100000010"); // INT7
    cuts.AddCutPCMCalo("00010113","0dk00009f9730000dge0404000","24466190pa01cc00000","0163103100000010"); // INT7
    cuts.AddCutPCMCalo("00010113","0dl00009f9730000dge0404000","24466190pa01cc00000","0163103100000010"); // INT7
    cuts.AddCutPCMCalo("00010113","0dg00009f9730000dge0404000","24466190pa01cc00000","0163103100000010"); // INT7

    //Low B Option
 } else if ( trainConfig == 923){ // Default cut, with TM   with eta<0.8
    cuts.AddCutPCMCalo("00010113","0d200089327000008250404000","24466190pa01cc00000","0163103100000010"); // INT7
 } else if ( trainConfig == 924){ // Default cut, with TM   with eta<0.8
    cuts.AddCutPCMCalo("00010113","0da00089327000008250404000","24466190pa01cc00000","0163103100000010"); // INT7   RBins
    cuts.AddCutPCMCalo("00010113","0db00089327000008250404000","24466190pa01cc00000","0163103100000010"); // INT7
    cuts.AddCutPCMCalo("00010113","0dc00089327000008250404000","24466190pa01cc00000","0163103100000010"); // INT7
  ...
  //*************************************************************************************************
    ...
    cuts.AddCutPCMCalo("00010113","0dm00009f9730000dge0404000","4117911067032230000","0163103100b00010"); // no timing cut, no NL INT7
    ...
    cuts.AddCutPCMCalo("00010113", "0dm00009f9730000dge0404000","411790006f032230000","0163103100b00010"); // NonLin TB
  } else if ( trainConfig == 2016){ // min bias // EDC  // NonLin settings
    cuts.AddCutPCMCalo("00010113", "0dm00009f9730000dge0404000","411793206f032230000","0163103100b00010"); // NonLin TB
