...
void AddTask_GammaConvCalo_pp(
 ...
 //*************************************************************************************************
  ...
  //*************************************************************************************************
    ...
    cuts.AddCutPCMCalo("00010113","0d200009327000008250404000","24466000g4012200000","0163103100000010"); // QA
  } else if ( trainConfig == 907){ // NonLinStudies
    cuts.AddCutPCMCalo("00010113","0d200009327000008250404000","24466000g4012200000","0163103100000010"); // QA
    cuts.AddCutPCMCalo("00010113","0d200009327000008250404000","24466110g4012200000","0163103100000010"); // QA //case 11=> FunctionNL_kSDM
    cuts.AddCutPCMCalo("00010113","0d200009327000008250404000","24466210g4012200000","0163103100000010"); // QA //case 21=> unctionNL_DPOW
  } else if ( trainConfig == 908){  //PHOS MB and PHI7
    cuts.AddCutPCMCalo("00010113","0d200009327000008250404000","24466000g4012200000","0163103100000010"); //no Trigger
    cuts.AddCutPCMCalo("00062113","0d200009327000008250404000","24466000g4012200000","0163103100000010"); //PHI7
  } else if ( trainConfig == 909){  //PHOS Smearing Check
    cuts.AddCutPCMCalo("00010113","0d200009327000008250404000","24466000g4012200000","0163103100400010"); //4
    cuts.AddCutPCMCalo("00010113","0d200009327000008250404000","24466000g4012200000","0163103100500010"); //5
    cuts.AddCutPCMCalo("00010113","0d200009327000008250404000","24466000g4012200000","0163103100600010"); //6
    cuts.AddCutPCMCalo("00010113","0d200009327000008250404000","24466000g4012200000","0163103100a00010"); //a => 10
    cuts.AddCutPCMCalo("00010113","0d200009327000008250404000","24466000g4012200000","0163103100b00010"); //b => 11
    cuts.AddCutPCMCalo("00010113","0d200009327000008250404000","24466000g4012200000","0163103100c00010"); //c => 12
  } else if ( trainConfig == 910){  //PHOS Sphericiry Check
    cuts.AddCutPCMCalo("h0510113","0d200009327000008250404000","24466000g4012200000","0163103100000010"); //  0.    - 0.5
    cuts.AddCutPCMCalo("h5a10113","0d200009327000008250404000","24466000g4012200000","0163103100000010"); //  0.5    - 1.
    cuts.AddCutPCMCalo("h0a10113","0d200009327000008250404000","24466000g4012200000","0163103100000010"); //  0.    - 1.
  } else if ( trainConfig == 911){  //PHOS Mult Check
    cuts.AddCutPCMCalo("n0110113","0d200009327000008250404000","24466000g4012200000","0163103100000010"); // INT7 0-10%
    cuts.AddCutPCMCalo("n1210113","0d200009327000008250404000","24466000g4012200000","0163103100000010"); // INT7 10-20%
    cuts.AddCutPCMCalo("n2510113","0d200009327000008250404000","24466000g4012200000","0163103100000010"); // INT7 20-50%
    cuts.AddCutPCMCalo("n5a10113","0d200009327000008250404000","24466000g4012200000","0163103100000010"); // INT7 50-100%
  } else if ( trainConfig == 917){ // Material Budget Checks
    cuts.AddCutPCMCalo("00010113","0d200009327000008250404000","24466000g4012200000","0163103100000010");
    cuts.AddCutPCMCalo("00010113","0da00009327000008250404000","24466000g4012200000","0163103100000010");
    cuts.AddCutPCMCalo("00010113","0db00009327000008250404000","24466000g4012200000","0163103100000010");
    cuts.AddCutPCMCalo("00010113","0dc00009327000008250404000","24466000g4012200000","0163103100000010");
    //Normal B Option
 } else if ( trainConfig == 920){ // Default cut, with TM   with eta<0.8
    cuts.AddCutPCMCalo("00010113","0d200009327000008250404000","24466000g4012200000","0163103100000010"); // INT7
 } else if ( trainConfig == 921){ // Default cut, with TM   with eta<0.8
    cuts.AddCutPCMCalo("00010113","0da00009327000008250404000","24466000g4012200000","0163103100000010"); // INT7   RBins
    cuts.AddCutPCMCalo("00010113","0db00009327000008250404000","24466000g4012200000","0163103100000010"); // INT7
    cuts.AddCutPCMCalo("00010113","0dc00009327000008250404000","24466000g4012200000","0163103100000010"); // INT7
 } else if ( trainConfig == 922){ // Default cut, with TM   with eta<0.8
    cuts.AddCutPCMCalo("00010113","0dh00009327000008250404000","24466000g4012200000","0163103100000010"); // INT7   RBins
    cuts.AddCutPCMCalo("00010113","0di00009327000008250404000","24466000g4012200000","0163103100000010"); // INT7

    //Low B Option
 } else if ( trainConfig == 923){ // Default cut, with TM   with eta<0.8
    cuts.AddCutPCMCalo("00010113","0d200089327000008250404000","24466000g4012200000","0163103100000010"); // INT7
 } else if ( trainConfig == 924){ // Default cut, with TM   with eta<0.8
    cuts.AddCutPCMCalo("00010113","0da00089327000008250404000","24466000g4012200000","0163103100000010"); // INT7   RBins
    cuts.AddCutPCMCalo("00010113","0db00089327000008250404000","24466000g4012200000","0163103100000010"); // INT7
    cuts.AddCutPCMCalo("00010113","0dc00089327000008250404000","24466000g4012200000","0163103100000010"); // INT7
 } else if ( trainConfig == 925){ // Default cut, with TM   with eta<0.8
    cuts.AddCutPCMCalo("00010113","0dh00089327000008250404000","24466000g4012200000","0163103100000010"); // INT7   RBins
    cuts.AddCutPCMCalo("00010113","0di00089327000008250404000","24466000g4012200000","0163103100000010"); // INT7
