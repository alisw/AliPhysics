...
void AddTask_GammaConvCalo_pp(
 ...
 //*************************************************************************************************
  ...
  //*************************************************************************************************
    ...
    cuts.AddCutPCMCalo("00010113","00200089327000008250400000","4117900067032230000","01631031000000d0"); // -50ns, 30ns timing cut, MB trigger
    cuts.AddCutPCMCalo("00010113","00200089327000008250400000","4117900007032230000","01631031000000d0"); // no timing, MB trigger
    cuts.AddCutPCMCalo("00074113","00200089327000008250400000","4117900067032230000","01631031000000d0"); // -50ns, 30ns timing cut, no NL VOHM
    cuts.AddCutPCMCalo("00076113","00200089327000008250400000","4117900067032230000","01631031000000d0"); // -50ns, 30ns timing cut, no NL VOHM with SPD
  //*****************************************************************************************************
  // pp 5 TeV DMC setup
  //*****************************************************************************************************
  ...
  //*************************************************************************************************
    ...
    cuts.AddCutPCMCalo("00010113","00200089327000008250400000","2446600044012300000","0163103100000010"); // -50ns, 30ns timing cut, MB trigger
    cuts.AddCutPCMCalo("00010113","00200089327000008250400000","2446600004012300000","0163103100000010"); // no timing, MB trigger
    cuts.AddCutPCMCalo("00074113","00200089327000008250400000","2446600044012300000","0163103100000010"); // -50ns, 30ns timing cut, no NL VOHM
    cuts.AddCutPCMCalo("00076113","00200089327000008250400000","2446600044012300000","0163103100000010"); // -50ns, 30ns timing cut, no NL VOHM with SPD
  //*************************************************************************************************
