...
void AddTask_GammaConvCalo_pp(
  ...
  } else if ( trainConfig == 365){ // QtMaxCut
  ...
  } else if ( trainConfig == 366){ // Chi2GammaCut
  ...
  } else if ( trainConfig == 367){ // PsiPair
  ...
  } else if ( trainConfig == 368){ // NonLin
  ...
  } else if ( trainConfig == 369){ // Timing diff
  ...
  } else if ( trainConfig == 370){ // Track Matching
  ...
  } else if ( trainConfig == 371){ // MinEnergy (of cluster)
  ...
  } else if ( trainConfig == 372){ // MinNCells
  ...
  } else if ( trainConfig == 373){ // MinMaxM02
    cuts.AddCutPCMCalo("00000113","00200009227000008250400000","1111111047032330000","0163103100000010");
    cuts.AddCutPCMCalo("00000113","00200009227000008250400000","1111111047032130000","0163103100000010");
