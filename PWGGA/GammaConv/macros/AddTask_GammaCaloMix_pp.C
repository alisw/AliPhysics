...
void AddTask_GammaCaloMix_pp(
  ...
  if (trainConfig == 1){
    cuts.AddCutCaloCalo("00010113","24466190sa01cc00000","388550109fe30220000","0163103100000050");
} else if (trainConfig == 2){  //    Timing Variations   Std s: +- 30 ns + TC effi
    cuts.AddCutCaloCalo("00010113","244661905a01cc00000","388550109fe30220000","0163103100000050");  // 50 ns
    cuts.AddCutCaloCalo("00010113","244661904a01cc00000","388550109fe30220000","0163103100000050");  // 100 ns
} else if (trainConfig == 3){  //    Clus Energy Phos  Variations
    cuts.AddCutCaloCalo("00010113","24466190sa09cc00000","388550109fe30220000","0163103100000050");  // PHOS energy cut 0.5
    cuts.AddCutCaloCalo("00010113","24466190sa07cc00000","388550109fe30220000","0163103100000050");  // PHOS energy cut 0.2
    cuts.AddCutCaloCalo("00010113","24466190sa01cc00000","388550109f000220000","0163103100000050");    // 0.1 EMCal energy cut
    cuts.AddCutCaloCalo("00010113","24466190sa01cc00000","388550109f010220000","0163103100000050");    // 0.5 EMCal energy cut
  } else if (trainConfig == 4){
    cuts.AddCutCaloCalo("00010113","24466190sa01cc00000","111110109fe30220000","0163103100000050");    // PHOS EMCAL; PHOS energy cut 0.3
    cuts.AddCutCaloCalo("00010113","24466190sa01cc00000","411790109fe30220000","0163103100000050");    // PHOS EDC; PHOS energy cut 0.3
    cuts.AddCutCaloCalo("00010113","1111112067032230000","388550109fe30220000","0163103100000050");    // EMCAL DCAL
    cuts.AddCutCaloCalo("00010113","1111112067032230000","388550109fe10220000","0163103100000050");    // EMCAL DCAL
