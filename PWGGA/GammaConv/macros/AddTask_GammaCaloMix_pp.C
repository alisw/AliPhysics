...
void AddTask_GammaCaloMix_pp(
 ...
 if (trainConfig == 1){
...
} else if (trainConfig == 2){  //    Timing Variations   std: 50 ns 
...
} else if (trainConfig == 3){  //    Clus Energy   Variations std Phos: 0.1 EMCal 0.5
  ...
  } else if (trainConfig == 4){ //  Opening angle std 0.005
