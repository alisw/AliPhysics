...
void AddTask_GammaConvDalitzV1_pp(  Int_t trainConfig = 1,  //change different set of cuts
  ...
  if(trainConfig == 1){
 ...
 }  else if (trainConfig == 118) {   // Full range in R, primary get de/dx TPCsigma -4,5 and <1.0pT & 0.015 mass, >1.0pT & 0.035 mass.

    cuts.AddCut("00010113", "00200009266300008854404000", "0263103100900000", "20475400253202321710");//Primary default

    cuts.AddCut("00010113", "00200009266300008854404000", "0263103100900000", "20575400253202321710");//Primary, change de/dx TPCsigma -3,5
    cuts.AddCut("00010113", "00200009266300008854404000", "0263103100900000", "20675400253202321710");//Primary, change de/dx TPCsigma -4,4
    ...
    cuts.AddCut("00010113", "00200009266300008854404000", "0263103100900000", "20475400253002321710");//Primary, change PsiPair cut all
