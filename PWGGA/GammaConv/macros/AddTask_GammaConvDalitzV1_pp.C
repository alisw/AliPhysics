...
void AddTask_GammaConvDalitzV1_pp(  Int_t trainConfig = 1,  //change different set of cuts
 ...
 }  else if (trainConfig == 118) {   // as iConfig R scan to be used with MBW, wirh New Cut in the mass(0.547GeV)

    cuts.AddCut("00010113", "00200009266300008854404000", "0263103100900000", "20475400253202321a10");
    cuts.AddCut("00010113", "00a00009266300008854404000", "0263103100900000", "20475400253202321a10");
    cuts.AddCut("00010113", "00b00009266300008854404000", "0263103100900000", "20475400253202321a10");
    cuts.AddCut("00010113", "00c00009266300008854404000", "0263103100900000", "20475400253202321a10");
