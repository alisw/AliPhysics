...
void AddTask_GammaConvDalitzV1_pp(  Int_t trainConfig = 1,  //change different set of cuts
  ...
  if(trainConfig == 1){
    ...
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008250404000", "204b6600263202263710", "0152103500000000");

    ///////////////////////////////Study on electrons cuts////////////////////////////////////
//0->8, 0.05 to 0.02, position 7
 }  else if (trainConfig == 301) {//Variation on the dE/dx standar -4 to 5
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008250404000", "205b6600263202263710", "0152103500000000");//Primary, change de/dx TPCsigma -3,5
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008250404000", "206b6600263202263710", "0152103500000000");//Primary, change de/dx TPCsigma -4,4
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008250404000", "208b6600263202263710", "0152103500000000");//Primary, change de/dx TPCsigma -2,3.5
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008250404000", "209b6600263202263710", "0152103500000000");//Primary, change de/dx TPCsigma -3,4
  }  else if (trainConfig == 302) {  //Variation on Mass_{e^+e^-}.0pT & 0.015 mass, >1.0p, Primary, change <1T & 0.035 mass
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008250404000", "204b6600263202263a10", "0152103500000000");//Primary, change <1.0pT & 0.02 mass, >1.0pT & 0.03 mass
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008250404000", "204b6600263202263b10", "0152103500000000");//Primary, change <1.0pT & 0.027 mass, >1.0pT & 0.057 mass
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008250404000", "204b6600263202263c10", "0152103500000000");//Primary, change < 0.02 mass
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008250404000", "204b6600263202263d10", "0152103500000000");//Primary, change < 0.04 mass
  }  else if (trainConfig == 303) {  //Variation on Mass_{e^+e^-}.0pT & 0.015 mass, >1.0p, Primary, change <1T & 0.035 mass
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008250404000", "204b6600263202263e10", "0152103500000000");//Primary, change < 0.06 mass
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008250404000", "204b6600263202263f10", "0152103500000000");//Primary, change < 0.08 mass
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008250404000", "204b6600263202263g10", "0152103500000000");//Primary, change < 0.15 mass
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008250404000", "204b6600263202263h10", "0152103500000000");//Primary, change < 0.2 mass
}  else if (trainConfig == 300) {//Primary cut (No Standard yet!)dard cut from Lucia at 5, there are the stanTeV plus Pedro cuts for 7 Tev or 5.02 TeV pPb on electrons.
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008250404000", "204b6600263202263710", "0152103500000000");
  //////////////// systematic variations for 5 TeV 2017 (Lucia)/////////////////////////////

  } else if (trainConfig == 310){
    cuts.AddCutPCMDalitz("00010113", "00200089227300008250404000", "204b6600263202263710", "0152103500000000"); // eta < 0.9
    cuts.AddCutPCMDalitz("00010113", "0c200089227300008250404000", "204b6600263202263710", "0152103500000000"); // eta < 0.85
    cuts.AddCutPCMDalitz("00010113", "0d200089247300008250404000", "204b6600263202263710", "0152103500000000"); // pidEdx 3, 1
    cuts.AddCutPCMDalitz("00010113", "0d200089227100008250404000", "204b6600263202263710", "0152103500000000"); // pion nsig max mom 5.00 GeV/c
  } else if (trainConfig == 311){
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008860404000", "204b6600263202263710", "0152103500000000"); // variation chi2 20 psi pair 0.2 2D
    cuts.AddCutPCMDalitz("00010113", "0d200089227300002252404000", "204b6600263202263710", "0152103500000000"); // variation qT max 0.06 2D, asym var 1
    cuts.AddCutPCMDalitz("00010113", "0d200089227300002254404000", "204b6600263202263710", "0152103500000000"); // variation qT max 0.06 2D, asym vat 2 pt dep
    cuts.AddCutPCMDalitz("00010113", "0d200089227300002256404000", "204b6600263202263710", "0152103500000000"); // variation qT max 0.06 2D, asym var 3
  } else if (trainConfig == 312){
    cuts.AddCutPCMDalitz("00010113", "0d200089a27300008250904120", "204b6600263202263710", "0152103500000000"); //cosPA, 0.99 eta 0.9
    cuts.AddCutPCMDalitz("00010113", "0d200079227300008250404000", "204b6600263202263710", "0152103500000000"); // min pT no cut
    cuts.AddCutPCMDalitz("00010113", "0d200049227300008250404000", "204b6600263202263710", "0152103500000000"); // min pT 75 MeV
    cuts.AddCutPCMDalitz("00010113", "0d200019227300008250404000", "204b6600263202263710", "0152103500000000"); // min pT 100 MeV
    cuts.AddCutPCMDalitz("00010113", "0d200088227300008250404000", "204b6600263202263710", "0152103500000000"); // TPC cluster 35%
    cuts.AddCutPCMDalitz("00010113", "0d200086227300008250404000", "204b6600263202263710", "0152103500000000"); // TPC cluster 70%
  } else if (trainConfig == 313){
    cuts.AddCutPCMDalitz("00010113", "0d200089327300008250404000", "204b6600263202263710", "0152103500000000"); // edEdx -4,5
    cuts.AddCutPCMDalitz("00010113", "0d200089627300008250404000", "204b6600263202263710", "0152103500000000"); // edEdx -2.5,4
    cuts.AddCutPCMDalitz("00010113", "0d200089257300008250404000", "204b6600263202263710", "0152103500000000"); // pidEdx 2,-10
    cuts.AddCutPCMDalitz("00010113", "0d200089217300008250404000", "204b6600263202263710", "0152103500000000"); // pidEdx 0,-10
    cuts.AddCutPCMDalitz("00010113", "0d200089226300008250404000", "204b6600263202263710", "0152103500000000"); // pion nsig min mom 0.25 GeV/c
    cuts.AddCutPCMDalitz("00010113", "0d200089227600008250404000", "204b6600263202263710", "0152103500000000"); // pion nsig max mom 2.00 GeV/c
  } else if (trainConfig == 314){
    cuts.AddCutPCMDalitz("00010113", "0d200089227300002250404000", "204b6600263202263710", "0152103500000000"); // qT max 0.06 2D
    cuts.AddCutPCMDalitz("00010113", "0d200089227300009250404000", "204b6600263202263710", "0152103500000000"); // qT max 0.03 2D
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008260404000", "204b6600263202263710", "0152103500000000"); // Psi pair 0.05 2D, chi2 30.
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008280404000", "204b6600263202263710", "0152103500000000"); // Psi pair 0.2  2D, chi2 30.
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008850404000", "204b6600263202263710", "0152103500000000"); // chi2 20. psi pair 0.1 2D
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008150404000", "204b6600263202263710", "0152103500000000"); // chi2 50. psi pair 0.1 2D
  } else if (trainConfig == 315){
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008254404000", "204b6600263202263710", "0152103500000000"); // Photon Asymmetry Cut
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008250604000", "204b6600263202263710", "0152103500000000"); // CosPA 0.9
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008250004000", "204b6600263202263710", "0152103500000000"); // no CosPA
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008250400000", "204b6600263202263710", "0152103500000000"); // no double counting
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008250404000", "204b6600263202263710", "0152101500000000"); // meson alpha pt dep
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008250404000", "204b6600263202263710", "0152107500000000"); // meson alpha < 0.85
  }  else if (trainConfig == 325) {//Primary cut, +with no mass c psi pair cut cuts.ut,no psi cut, +with
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008250404000", "204b6600263002263010", "0152103500000000");
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    cuts.AddCutPCMDalitz("00010113", "0d200009227300008250404000", "204b6600263202223710", "0152103500000000");

    ///////////////////////////////Study on electrons cuts////////////////////////////////////

  }  else if (trainConfig == 401) {//Variation on the dE/dx standar -4 to 5
    cuts.AddCutPCMDalitz("00010113", "0d200009227300008250404000", "205b6600263202223710", "0152103500000000");//Primary, change de/dx TPCsigma -3,5
    cuts.AddCutPCMDalitz("00010113", "0d200009227300008250404000", "206b6600263202223710", "0152103500000000");//Primary, change de/dx TPCsigma -4,4
    cuts.AddCutPCMDalitz("00010113", "0d200009227300008250404000", "208b6600263202223710", "0152103500000000");//Primary, change de/dx TPCsigma -2,3.5
    cuts.AddCutPCMDalitz("00010113", "0d200009227300008250404000", "209b6600263202223710", "0152103500000000");//Primary, change de/dx TPCsigma -3,4
  }  else if (trainConfig == 402) {  //Variation on Mass_{e^+e^-}.0pT & 0.015 mass, >1.0p, Primary, change <1T & 0.035 mass
    cuts.AddCutPCMDalitz("00010113", "0d200009227300008250404000", "204b6600263202223a10", "0152103500000000");//Primary, change <1.0pT & 0.02 mass, >1.0pT & 0.03 mass
    cuts.AddCutPCMDalitz("00010113", "0d200009227300008250404000", "204b6600263202223b10", "0152103500000000");//Primary, change <1.0pT & 0.027 mass, >1.0pT & 0.057 mass
    cuts.AddCutPCMDalitz("00010113", "0d200009227300008250404000", "204b6600263202223c10", "0152103500000000");//Primary, change < 0.02 mass
    cuts.AddCutPCMDalitz("00010113", "0d200009227300008250404000", "204b6600263202223d10", "0152103500000000");//Primary, change < 0.04 mass
  }  else if (trainConfig == 403) {  //Variation on Mass_{e^+e^-}.0pT & 0.015 mass, >1.0p, Primary, change <1T & 0.035 mass
    cuts.AddCutPCMDalitz("00010113", "0d200009227300008250404000", "204b6600263202223e10", "0152103500000000");//Primary, change < 0.06 mass
    cuts.AddCutPCMDalitz("00010113", "0d200009227300008250404000", "204b6600263202223f10", "0152103500000000");//Primary, change < 0.08 mass
    cuts.AddCutPCMDalitz("00010113", "0d200009227300008250404000", "204b6600263202223g10", "0152103500000000");//Primary, change < 0.15 mass
    cuts.AddCutPCMDalitz("00010113", "0d200009227300008250404000", "204b6600263202223h10", "0152103500000000");//Primary, change < 0.2 mass
  }  else if (trainConfig == 404) {//Primary cut, +with no mass c psi pair cut cuts, Pt eut,no psi cut, +with+e- Primary 0.9.
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008250404000", "204b6600263002273010", "0152103500000000");//No Psi pair cut
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008250404000", "204b6600263202273010", "0152103500000000");//0.60 Psi pair cut

  //////////////// systematic variations for 5 TeV 2017 (Lucia)/////////////////////////////

  } else if (trainConfig == 410){
    cuts.AddCutPCMDalitz("00010113", "00200009227300008250404000", "204b6600263202223710", "0152103500000000"); // eta < 0.9
    cuts.AddCutPCMDalitz("00010113", "0c200009227300008250404000", "204b6600263202223710", "0152103500000000"); // eta < 0.85
    cuts.AddCutPCMDalitz("00010113", "0d200009247300008250404000", "204b6600263202223710", "0152103500000000"); // pidEdx 3, 1
    cuts.AddCutPCMDalitz("00010113", "0d200009227100008250404000", "204b6600263202223710", "0152103500000000"); // pion nsig max mom 5.00 GeV/c
  } else if (trainConfig == 411){
    cuts.AddCutPCMDalitz("00010113", "0d200009227300008860404000", "204b6600263202223710", "0152103500000000"); // variation chi2 20 psi pair 0.2 2D
    cuts.AddCutPCMDalitz("00010113", "0d200009227300002252404000", "204b6600263202223710", "0152103500000000"); // variation qT max 0.06 2D, asym var 1
    cuts.AddCutPCMDalitz("00010113", "0d200009227300002254404000", "204b6600263202223710", "0152103500000000"); // variation qT max 0.06 2D, asym vat 2 pt dep
    cuts.AddCutPCMDalitz("00010113", "0d200009227300002256404000", "204b6600263202223710", "0152103500000000"); // variation qT max 0.06 2D, asym var 3
  } else if (trainConfig == 412){
    cuts.AddCutPCMDalitz("00010113", "0d200009a27300008250904120", "204b6600263202223710", "0152103500000000"); //cosPA, 0.99 eta 0.9
    cuts.AddCutPCMDalitz("00010113", "0d200079227300008250404000", "204b6600263202223710", "0152103500000000"); // min pT no cut
    cuts.AddCutPCMDalitz("00010113", "0d200049227300008250404000", "204b6600263202223710", "0152103500000000"); // min pT 75 MeV
    cuts.AddCutPCMDalitz("00010113", "0d200019227300008250404000", "204b6600263202223710", "0152103500000000"); // min pT 100 MeV
    cuts.AddCutPCMDalitz("00010113", "0d200008227300008250404000", "204b6600263202223710", "0152103500000000"); // TPC cluster 35%
    cuts.AddCutPCMDalitz("00010113", "0d200006227300008250404000", "204b6600263202223710", "0152103500000000"); // TPC cluster 70%
  } else if (trainConfig == 413){
    cuts.AddCutPCMDalitz("00010113", "0d200009327300008250404000", "204b6600263202223710", "0152103500000000"); // edEdx -4,5
    cuts.AddCutPCMDalitz("00010113", "0d200009627300008250404000", "204b6600263202223710", "0152103500000000"); // edEdx -2.5,4
    cuts.AddCutPCMDalitz("00010113", "0d200009257300008250404000", "204b6600263202223710", "0152103500000000"); // pidEdx 2,-10
    cuts.AddCutPCMDalitz("00010113", "0d200009217300008250404000", "204b6600263202223710", "0152103500000000"); // pidEdx 0,-10
    cuts.AddCutPCMDalitz("00010113", "0d200009226300008250404000", "204b6600263202223710", "0152103500000000"); // pion nsig min mom 0.25 GeV/c
    cuts.AddCutPCMDalitz("00010113", "0d200009227600008250404000", "204b6600263202223710", "0152103500000000"); // pion nsig max mom 2.00 GeV/c
  } else if (trainConfig == 414){
    cuts.AddCutPCMDalitz("00010113", "0d200009227300002250404000", "204b6600263202223710", "0152103500000000"); // qT max 0.06 2D
    cuts.AddCutPCMDalitz("00010113", "0d200009227300009250404000", "204b6600263202223710", "0152103500000000"); // qT max 0.03 2D
    cuts.AddCutPCMDalitz("00010113", "0d200009227300008260404000", "204b6600263202223710", "0152103500000000"); // Psi pair 0.05 2D, chi2 30.
    cuts.AddCutPCMDalitz("00010113", "0d200009227300008280404000", "204b6600263202223710", "0152103500000000"); // Psi pair 0.2  2D, chi2 30.
    cuts.AddCutPCMDalitz("00010113", "0d200009227300008850404000", "204b6600263202223710", "0152103500000000"); // chi2 20. psi pair 0.1 2D
    cuts.AddCutPCMDalitz("00010113", "0d200009227300008150404000", "204b6600263202223710", "0152103500000000"); // chi2 50. psi pair 0.1 2D
  } else if (trainConfig == 415){
    cuts.AddCutPCMDalitz("00010113", "0d200009227300008254404000", "204b6600263202223710", "0152103500000000"); // Photon Asymmetry Cut
    cuts.AddCutPCMDalitz("00010113", "0d200009227300008250604000", "204b6600263202223710", "0152103500000000"); // CosPA 0.9
    cuts.AddCutPCMDalitz("00010113", "0d200009227300008250004000", "204b6600263202223710", "0152103500000000"); // no CosPA
    cuts.AddCutPCMDalitz("00010113", "0d200009227300008250400000", "204b6600263202223710", "0152103500000000"); // no double counting
    cuts.AddCutPCMDalitz("00010113", "0d200009227300008250404000", "204b6600263202223710", "0152101500000000"); // meson alpha pt dep
    cuts.AddCutPCMDalitz("00010113", "0d200009227300008250404000", "204b6600263202223710", "0152107500000000"); // meson alpha < 0.85
