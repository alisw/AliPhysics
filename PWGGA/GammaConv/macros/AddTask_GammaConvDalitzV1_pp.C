...
void AddTask_GammaConvDalitzV1_pp(  Int_t trainConfig = 1,  //change different set of cuts
  ...
  if(trainConfig == 1){
    ...
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008250404000", "204c4640263202263710", "0152103500000000");

    ///////////////////////////////Study on electrons cuts////////////////////////////////////
//0->8, 0.05 to 0.02, position 7
 }  else if (trainConfig == 301) {//Variation on the dE/dx standar -4 to 5
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008250404000", "205c4640263202263710", "0152103500000000");//Primary, change de/dx TPCsigma -3,5
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008250404000", "206c4640263202263710", "0152103500000000");//Primary, change de/dx TPCsigma -4,4
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008250404000", "208c4640263202263710", "0152103500000000");//Primary, change de/dx TPCsigma -2,3.5
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008250404000", "209c4640263202263710", "0152103500000000");//Primary, change de/dx TPCsigma -3,4
  }  else if (trainConfig == 302) {  //Variation on Mass_{e^+e^-}.0pT & 0.015 mass, >1.0p, Primary, change <1T & 0.035 mass
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008250404000", "204c4640263202263a10", "0152103500000000");//Primary, change <1.0pT & 0.02 mass, >1.0pT & 0.03 mass
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008250404000", "204c4640263202263b10", "0152103500000000");//Primary, change <1.0pT & 0.027 mass, >1.0pT & 0.057 mass
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008250404000", "204c4640263202263c10", "0152103500000000");//Primary, change < 0.02 mass
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008250404000", "204c4640263202263d10", "0152103500000000");//Primary, change < 0.04 mass
  }  else if (trainConfig == 303) {  //Variation on Mass_{e^+e^-}.0pT & 0.015 mass, >1.0p, Primary, change <1T & 0.035 mass
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008250404000", "204c4640263202263e10", "0152103500000000");//Primary, change < 0.06 mass
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008250404000", "204c4640263202263f10", "0152103500000000");//Primary, change < 0.08 mass
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008250404000", "204c4640263202263g10", "0152103500000000");//Primary, change < 0.15 mass
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008250404000", "204c4640263202263h10", "0152103500000000");//Primary, change < 0.2 mass
  //////////////// systematic variations for 5 TeV 2017 (Lucia)/////////////////////////////

  } else if (trainConfig == 310){
    cuts.AddCutPCMDalitz("00010113", "00200089227300008250404000", "204c4640263202263710", "0152103500000000"); // eta < 0.9
    cuts.AddCutPCMDalitz("00010113", "0c200089227300008250404000", "204c4640263202263710", "0152103500000000"); // eta < 0.85
    cuts.AddCutPCMDalitz("00010113", "0d200089247300008250404000", "204c4640263202263710", "0152103500000000"); // pidEdx 3, 1
    cuts.AddCutPCMDalitz("00010113", "0d200089227100008250404000", "204c4640263202263710", "0152103500000000"); // pion nsig max mom 5.00 GeV/c
  } else if (trainConfig == 311){
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008860404000", "204c4640263202263710", "0152103500000000"); // variation chi2 20 psi pair 0.2 2D
    cuts.AddCutPCMDalitz("00010113", "0d200089227300002252404000", "204c4640263202263710", "0152103500000000"); // variation qT max 0.06 2D, asym var 1
    cuts.AddCutPCMDalitz("00010113", "0d200089227300002254404000", "204c4640263202263710", "0152103500000000"); // variation qT max 0.06 2D, asym vat 2 pt dep
    cuts.AddCutPCMDalitz("00010113", "0d200089227300002256404000", "204c4640263202263710", "0152103500000000"); // variation qT max 0.06 2D, asym var 3
  } else if (trainConfig == 312){
    cuts.AddCutPCMDalitz("00010113", "0d200089a27300008250904120", "204c4640263202263710", "0152103500000000"); //cosPA, 0.99 eta 0.9
    cuts.AddCutPCMDalitz("00010113", "0d200079227300008250404000", "204c4640263202263710", "0152103500000000"); // min pT no cut
    cuts.AddCutPCMDalitz("00010113", "0d200049227300008250404000", "204c4640263202263710", "0152103500000000"); // min pT 75 MeV
    cuts.AddCutPCMDalitz("00010113", "0d200019227300008250404000", "204c4640263202263710", "0152103500000000"); // min pT 100 MeV
    cuts.AddCutPCMDalitz("00010113", "0d200088227300008250404000", "204c4640263202263710", "0152103500000000"); // TPC cluster 35%
    cuts.AddCutPCMDalitz("00010113", "0d200086227300008250404000", "204c4640263202263710", "0152103500000000"); // TPC cluster 70%
  } else if (trainConfig == 313){
    cuts.AddCutPCMDalitz("00010113", "0d200089327300008250404000", "204c4640263202263710", "0152103500000000"); // edEdx -4,5
    cuts.AddCutPCMDalitz("00010113", "0d200089627300008250404000", "204c4640263202263710", "0152103500000000"); // edEdx -2.5,4
    cuts.AddCutPCMDalitz("00010113", "0d200089257300008250404000", "204c4640263202263710", "0152103500000000"); // pidEdx 2,-10
    cuts.AddCutPCMDalitz("00010113", "0d200089217300008250404000", "204c4640263202263710", "0152103500000000"); // pidEdx 0,-10
    cuts.AddCutPCMDalitz("00010113", "0d200089226300008250404000", "204c4640263202263710", "0152103500000000"); // pion nsig min mom 0.25 GeV/c
    cuts.AddCutPCMDalitz("00010113", "0d200089227600008250404000", "204c4640263202263710", "0152103500000000"); // pion nsig max mom 2.00 GeV/c
  } else if (trainConfig == 314){
    cuts.AddCutPCMDalitz("00010113", "0d200089227300002250404000", "204c4640263202263710", "0152103500000000"); // qT max 0.06 2D
    cuts.AddCutPCMDalitz("00010113", "0d200089227300009250404000", "204c4640263202263710", "0152103500000000"); // qT max 0.03 2D
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008260404000", "204c4640263202263710", "0152103500000000"); // Psi pair 0.05 2D, chi2 30.
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008280404000", "204c4640263202263710", "0152103500000000"); // Psi pair 0.2  2D, chi2 30.
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008850404000", "204c4640263202263710", "0152103500000000"); // chi2 20. psi pair 0.1 2D
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008150404000", "204c4640263202263710", "0152103500000000"); // chi2 50. psi pair 0.1 2D
  } else if (trainConfig == 315){
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008254404000", "204c4640263202263710", "0152103500000000"); // Photon Asymmetry Cut
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008250604000", "204c4640263202263710", "0152103500000000"); // CosPA 0.9
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008250004000", "204c4640263202263710", "0152103500000000"); // no CosPA
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008250400000", "204c4640263202263710", "0152103500000000"); // no double counting
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008250404000", "204c4640263202263710", "0152101500000000"); // meson alpha pt dep
    ...
    cuts.AddCutPCMDalitz("00010113", "0d200009227300008250404000", "205c4640263202223710", "0152103500000000");//Primary, change de/dx TPCsigma -3,5
    cuts.AddCutPCMDalitz("00010113", "0d200009227300008250404000", "206c4640263202223710", "0152103500000000");//Primary, change de/dx TPCsigma -4,4
    cuts.AddCutPCMDalitz("00010113", "0d200009227300008250404000", "208c4640263202223710", "0152103500000000");//Primary, change de/dx TPCsigma -2,3.5
    cuts.AddCutPCMDalitz("00010113", "0d200009227300008250404000", "209c4640263202223710", "0152103500000000");//Primary, change de/dx TPCsigma -3,4
  }  else if (trainConfig == 402) {  //Variation on Mass_{e^+e^-}.0pT & 0.015 mass, >1.0p, Primary, change <1T & 0.035 mass
    cuts.AddCutPCMDalitz("00010113", "0d200009227300008250404000", "204c4640263202223a10", "0152103500000000");//Primary, change <1.0pT & 0.02 mass, >1.0pT & 0.03 mass
    cuts.AddCutPCMDalitz("00010113", "0d200009227300008250404000", "204c4640263202223b10", "0152103500000000");//Primary, change <1.0pT & 0.027 mass, >1.0pT & 0.057 mass
    cuts.AddCutPCMDalitz("00010113", "0d200009227300008250404000", "204c4640263202223c10", "0152103500000000");//Primary, change < 0.02 mass
    cuts.AddCutPCMDalitz("00010113", "0d200009227300008250404000", "204c4640263202223d10", "0152103500000000");//Primary, change < 0.04 mass
  }  else if (trainConfig == 403) {  //Variation on Mass_{e^+e^-}.0pT & 0.015 mass, >1.0p, Primary, change <1T & 0.035 mass
    cuts.AddCutPCMDalitz("00010113", "0d200009227300008250404000", "204c4640263202223e10", "0152103500000000");//Primary, change < 0.06 mass
    cuts.AddCutPCMDalitz("00010113", "0d200009227300008250404000", "204c4640263202223f10", "0152103500000000");//Primary, change < 0.08 mass
    cuts.AddCutPCMDalitz("00010113", "0d200009227300008250404000", "204c4640263202223g10", "0152103500000000");//Primary, change < 0.15 mass
    cuts.AddCutPCMDalitz("00010113", "0d200009227300008250404000", "204c4640263202223h10", "0152103500000000");//Primary, change < 0.2 mass
  }  else if (trainConfig == 404) {//No Primary cut, we change a 0 for 8 on second cut, and study the psi pair cut.
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008250404000", "204c4640263002273010", "0152103500000000");//No Psi pair cut
    cuts.AddCutPCMDalitz("00010113", "0d200089227300008250404000", "204c4640263202273010", "0152103500000000");//0.60 Psi pair cut
    ...
    cuts.AddCutPCMDalitz("00010113", "0d200009227300008250404000", "204c4640263202229710", "0152103500000000");//DCAxy change to 0.8cm
    cuts.AddCutPCMDalitz("00010113", "0d200009227300008250404000", "204c464026320222a710", "0152103500000000");//DCAxy change to 1.2cm
    cuts.AddCutPCMDalitz("00010113", "0d200009227300008250404000", "204c4640263202213710", "0152103500000000");//Single pT change to > 1.0GeV
    cuts.AddCutPCMDalitz("00010113", "0d200009227300008250404000", "204c4640263202233710", "0152103500000000");//Single pT change to > 1.5GeV
    ...
    cuts.AddCutPCMDalitz("00010113", "0d200009227300008250404000", "204c4640253202223710", "0152103500000000");//(Number of TPC cluster found)/(Number of TPC cluster findable) > 0.35
    cuts.AddCutPCMDalitz("00010113", "0d200009227300008250404000", "204c4640213202223710", "0152103500000000");//(Number of TPC cluster found)/(Number of TPC cluster findable) > 0.7
    cuts.AddCutPCMDalitz("00010113", "0d200009227300008250404000", "204c46402a3202223710", "0152103500000000");//Number of TPC cluster standar > 80.
    cuts.AddCutPCMDalitz("00010113", "0d200009227300008250404000", "204c46402b3202223710", "0152103500000000");//Number of TPC cluster standar > 60.
  } else if (trainConfig == 407) {//Primary cut, dE/dx sigma, min pT, max pT for pions.
    cuts.AddCutPCMDalitz("00010113", "0d200009227300008250404000", "204c6640263202223710", "0152103500000000");//dE/dx Sigma [2.5,-10] pions
    cuts.AddCutPCMDalitz("00010113", "0d200009227300008250404000", "204c7640263202223710", "0152103500000000");//dE/dx Sigma [2.0,-10] pions
    cuts.AddCutPCMDalitz("00010113", "0d200009227300008250404000", "204c4540263202223710", "0152103500000000");//min pT 0.5 GeV/c pions
    cuts.AddCutPCMDalitz("00010113", "0d200009227300008250404000", "204c4740263202223710", "0152103500000000");//min pT 0.3 GeV/c pions
  ...
  //////////////// systematic variations for 5 TeV 2017 (Lucia)/////////////////////////////
    ...
    cuts.AddCutPCMDalitz("00010113", "00200009227300008250404000", "204c4640263202223710", "0152103500000000"); // eta < 0.9
    cuts.AddCutPCMDalitz("00010113", "0c200009227300008250404000", "204c4640263202223710", "0152103500000000"); // eta < 0.85
    cuts.AddCutPCMDalitz("00010113", "0d200009247300008250404000", "204c4640263202223710", "0152103500000000"); // pidEdx 3, 1
    cuts.AddCutPCMDalitz("00010113", "0d200009227100008250404000", "204c4640263202223710", "0152103500000000"); // pion nsig max mom 5.00 GeV/c
  } else if (trainConfig == 411){
    cuts.AddCutPCMDalitz("00010113", "0d200009227300008860404000", "204c4640263202223710", "0152103500000000"); // variation chi2 20 psi pair 0.2 2D
    cuts.AddCutPCMDalitz("00010113", "0d200009227300002252404000", "204c4640263202223710", "0152103500000000"); // variation qT max 0.06 2D, asym var 1
    cuts.AddCutPCMDalitz("00010113", "0d200009227300002254404000", "204c4640263202223710", "0152103500000000"); // variation qT max 0.06 2D, asym vat 2 pt dep
    cuts.AddCutPCMDalitz("00010113", "0d200009227300002256404000", "204c4640263202223710", "0152103500000000"); // variation qT max 0.06 2D, asym var 3
  } else if (trainConfig == 412){
    cuts.AddCutPCMDalitz("00010113", "0d200009a27300008250904120", "204c4640263202223710", "0152103500000000"); //cosPA, 0.99 eta 0.9
