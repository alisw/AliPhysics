void AddTask_GammaConvV1_pp2(  Int_t trainConfig = 1,  //change different set of cuts
   ...
   if (trainConfig == 1){ 
      ...
      cutarray[ 0] = "0001012002093663003800000000"; mesonCutArray[0] = "01631031009000"; //standard cut Pi0 pp 2.76TeV without SDD, V0AND , only boxes
   } else if (trainConfig == 3) { 
      cutarray[ 0] = "0000012002093260003800000000"; mesonCutArray[0] = "01631031009000"; //standard cut Gamma pp 2-76TeV , only boxes
      ...
      cutarray[ 0] = "0001011002093663003800000000"; mesonCutArray[0] = "01631031009000"; //standard cut Pi0 pp 2.76TeV without SDD, V0AND
   } else if (trainConfig == 6) { 
      cutarray[ 0] = "0000011002093260003800000000"; mesonCutArray[0] = "01631031009000"; //standard cut Gamma pp 2-76TeV
      ...
      cutarray[ 0] = "0003011002093663003800000000"; mesonCutArray[0] = "01631031009000"; //standard cut Pi0 pp 2.76TeV with SDD, V0AND , only Minbias MC
   } else if (trainConfig == 9) {    
      cutarray[ 0] = "0002012002093663003800000000"; mesonCutArray[0] = "01631031009000"; //standard cut Pi0 pp 2.76TeV with SDD , only Boxes MC
   } else if (trainConfig == 10) { 
      cutarray[ 0] = "0003012002093663003800000000"; mesonCutArray[0] = "01631031009000"; //standard cut Pi0 pp 2.76TeV with SDD, V0AND, only Boxes MC
