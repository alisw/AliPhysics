void AddTask_GammaConvV1_pPb( 	Int_t 		trainConfig = 1,  												// change different set of cuts
    ...
    if(trainConfig == 1){
            ...
            eventCutArray[ 0] = "8000011"; photonCutArray[ 0] = "00000009217000008260440000"; mesonCutArray[ 0] = "01621035009000";  // min R =0 cm & only photon quality 3
            eventCutArray[ 1] = "8000011"; photonCutArray[ 1] = "00100009217000008260440000"; mesonCutArray[ 1] = "01621035009000";  // min R =2.8 cm & only photon quality 3
            eventCutArray[ 2] = "8000011"; photonCutArray[ 2] = "00200009217000008260440000"; mesonCutArray[ 2] = "01621035009000";  // min R =5 cm & only photon quality 3
            eventCutArray[ 3] = "8000011"; photonCutArray[ 3] = "00900009217000008260440000"; mesonCutArray[ 3] = "01621035009000";  // min R =7.5 cm & only photon quality 3 
       } else if (trainConfig == 184) {
            eventCutArray[ 0] = "8000012"; photonCutArray[ 0] = "00000009217000008260440000"; mesonCutArray[ 0] = "01621035009000";  // min R =0 cm & only photon quality 3
            eventCutArray[ 1] = "8000012"; photonCutArray[ 1] = "00100009217000008260440000"; mesonCutArray[ 1] = "01621035009000";  // min R =2.8 cm & only photon quality 3
            ...
            eventCutArray[ 0] = "8000011"; photonCutArray[ 0] = "00000009217000008260400000"; mesonCutArray[ 0] = "01621035009000";  // min R =0 cm
            eventCutArray[ 1] = "8000011"; photonCutArray[ 1] = "00100009217000008260400000"; mesonCutArray[ 1] = "01621035009000";  // min R =2.8 cm
            eventCutArray[ 2] = "8000011"; photonCutArray[ 2] = "00200009217000008260400000"; mesonCutArray[ 2] = "01621035009000";  // min R =5 cm
            eventCutArray[ 3] = "8000011"; photonCutArray[ 3] = "00900009217000008260400000"; mesonCutArray[ 3] = "01621035009000";  // min R =7.5 cm
       } else if (trainConfig == 188) {
            eventCutArray[ 0] = "8000012"; photonCutArray[ 0] = "00000009217000008260400000"; mesonCutArray[ 0] = "01621035009000";  // min R =0 cm
            eventCutArray[ 1] = "8000012"; photonCutArray[ 1] = "00100009217000008260400000"; mesonCutArray[ 1] = "01621035009000";  // min R =2.8 cm
            eventCutArray[ 2] = "8000012"; photonCutArray[ 2] = "00200009217000008260400000"; mesonCutArray[ 2] = "01621035009000";  // min R =5 cm
            eventCutArray[ 3] = "8000012"; photonCutArray[ 3] = "00900009217000008260400000"; mesonCutArray[ 3] = "01621035009000";  // min R =7.5 cm
      } else if (trainConfig == 189) {
            eventCutArray[ 0] = "8000011"; photonCutArray[ 0] = "00200009217000008260404000"; mesonCutArray[ 0] = "01621035009000";  // cut to reject double Counting 
            eventCutArray[ 1] = "8000011"; photonCutArray[ 1] = "00200009217000008260405000"; mesonCutArray[ 1] = "01621035009000";  //  cut to reject double Counting
            eventCutArray[ 2] = "8000011"; photonCutArray[ 2] = "00200009217000008260406000"; mesonCutArray[ 2] = "01621035009000";  //  cut to reject double Counting
            eventCutArray[ 3] = "8000011"; photonCutArray[ 3] = "00200009217000008260407000"; mesonCutArray[ 3] = "01621035009000";  //  cut to reject double Counting
       } else if (trainConfig == 190) {
            eventCutArray[ 0] = "8000012"; photonCutArray[ 0] = "00200009217000008260404000"; mesonCutArray[ 0] = "01621035009000";  //  cut to reject double Counting
            eventCutArray[ 1] = "8000012"; photonCutArray[ 1] = "00200009217000008260405000"; mesonCutArray[ 1] = "01621035009000";  //  cut to reject double Counting
            eventCutArray[ 2] = "8000012"; photonCutArray[ 2] = "00200009217000008260406000"; mesonCutArray[ 2] = "01621035009000";  //  cut to reject double Counting
            eventCutArray[ 3] = "8000012"; photonCutArray[ 3] = "00200009217000008260407000"; mesonCutArray[ 3] = "01621035009000";  //  cut to reject double Counting
        } else {
