...
//main function
//***************************************************************************************
void AddTask_GammaConvCaloCalibration_MixedMode_pPb(
  Int_t     selectedMeson                 = 0,        // select the corresponding meson: 0 pi0, 1 eta, 2 eta'
  Int_t     trainConfig                   = 1,        // change different set of cuts
  Int_t     isMC                          = 0,        // run MC
  TString   photonCutNumberV0Reader       = "",       // 0000008400000000100000000 nom. B, 00000088400000000100000000 low B
  ...
  TString addTaskName                 = "AddTask_GammaConvCaloCalibration_MixedMode_pPb";
  ...
  if(rmaxFacPtHardSetting->GetEntries()<1){cout << "ERROR: AddTask_GammaConvCaloCalibration_MixedMode_pPb during parsing of settingMaxFacPtHard String '" << settingMaxFacPtHard.Data() << "'" << endl; return;}
