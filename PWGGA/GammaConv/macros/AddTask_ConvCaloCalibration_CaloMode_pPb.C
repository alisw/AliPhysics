...
//main function
//***************************************************************************************
void AddTask_ConvCaloCalibration_CaloMode_pPb(
  ...
  TString addTaskName                 = "AddTask_ConvCaloCalibration_CaloMode_pPb";
  ...
  if(rmaxFacPtHardSetting->GetEntries()<1){cout << "ERROR: AddTask_ConvCaloCalibration_CaloMode_pPb during parsing of settingMaxFacPtHard String '" << settingMaxFacPtHard.Data() << "'" << endl; return;}
  ...
  if (trainConfig == 1){ // EMCAL + DCal clusters pPb run1
    ...
    cuts.AddCutPCMCalo("80052113","00200009f9730000dge0400000","111110105fg32230000","01631031000000d0"); // EMC7
    cuts.AddCutPCMCalo("80085113","00200009f9730000dge0400000","111110105fg32230000","01631031000000d0"); // EG2+DG2
    cuts.AddCutPCMCalo("80083113","00200009f9730000dge0400000","111110105fg32230000","01631031000000d0"); // EG1+DG1
