...
ClassImp(AliAnalysisTaskMesonJetCorrelation)
  ...
  AliAnalysisTaskMesonJetCorrelation::AliAnalysisTaskMesonJetCorrelation() : AliAnalysisTaskSE(),
                                                                            ...
                                                                            //  fAddV0ToJets(false),
                                                                             ...
                                                                             fVectorGammaClusEnergyInJetsHadCorr({}),
                                                                             ...
                                                                             fHistoPrimPartAbundanceInJet({}),
                                                                             fHistoPrimPartAbundanceInJetAndEMCal({}),
                                                                             ...
                                                                             fHistoJetClusterEfficiencyHadCorr({}),
                                                                             fHistoJetClusterEfficiencyInJetAcc({}),
                                                                             fHistoJetClusterEfficiencyHadCorrInJetAcc({}),
...
void AliAnalysisTaskMesonJetCorrelation::UserCreateOutputObjects()
{
  ...
  if (fIsCalo || fIsConvCalo) {
    ...
    if (fDoMesonQA > 0 && fIsMC) {
      fHistoHadronicInteractionsVsR.resize(fnCuts);
      ...
      fHistoClusterAbundanceInJetEFracHadronic.resize(fnCuts);
      fHistoClusterAbundanceAntiPartInJetEFrac.resize(fnCuts);
      fHistoClusterAbundanceAntiPartInJetEFracHadronic.resize(fnCuts);
  ...
  if(fDoTrackingStudies){
    ...
    fHistoJetClusterEfficiencyHadCorr.resize(fnCuts);
    fHistoJetClusterEfficiencyInJetAcc.resize(fnCuts);
    fHistoJetClusterEfficiencyHadCorrInJetAcc.resize(fnCuts);
  ...
  for (int iCut = 0; iCut < fnCuts; ++iCut) {
    ...
    if (fIsCalo || fIsConvCalo) {
      ...
      if (fDoMesonQA && fIsMC) {
        ...
        fHistoHadronicInteractionsVsR[iCut] = new TH1F("HadronicInterationsVsR", "HadronicInterationsVsR", 500, 0, 500);
        fHistoHadronicInteractionsVsR[iCut]->SetXTitle("R (cm)");
        fESDList[iCut]->Add(fHistoHadronicInteractionsVsR[iCut]);
        ...
        fHistoClusterAbundanceInJetEFracHadronic[iCut] = new TH3F("ClusPartAbundance_InJet_EFracHadronic_VsJetPt", "ClusPartAbundance_InJet_EFracHadronic_VsJetPt", 17, vecEquidistFromMinus05.data(), fVecBinsClusterPt.size() - 1, fVecBinsClusterPt.data(), fVecBinsJetPt.size() - 1, fVecBinsJetPt.data());
        fHistoClusterAbundanceInJetEFracHadronic[iCut]->SetXTitle("Particle Index");
        fHistoClusterAbundanceInJetEFracHadronic[iCut]->SetYTitle("E_{cluster, rec., had corr, EFracHadronic}/E_{jet, rec.}");
        fHistoClusterAbundanceInJetEFracHadronic[iCut]->SetZTitle("P_{t, jet, rec.} (GeV/c)");
        fTrueList[iCut]->Add(fHistoClusterAbundanceInJetEFracHadronic[iCut]);
        ...
        fHistoClusterAbundanceAntiPartInJetEFracHadronic[iCut] = new TH3F("ClusAntiPartAbundance_InJet_EFracHadronic_VsJetPt", "ClusAntiPartAbundance_InJet_EFracHadronic_VsJetPt", 17, vecEquidistFromMinus05.data(), fVecBinsClusterPt.size() - 1, fVecBinsClusterPt.data(), fVecBinsJetPt.size() - 1, fVecBinsJetPt.data());
        fHistoClusterAbundanceAntiPartInJetEFracHadronic[iCut]->SetXTitle("Particle Index");
        fHistoClusterAbundanceAntiPartInJetEFracHadronic[iCut]->SetYTitle("E_{cluster, rec., had corr, EFracHadronic}/E_{jet, rec.}");
        fHistoClusterAbundanceAntiPartInJetEFracHadronic[iCut]->SetZTitle("P_{t, jet, rec.} (GeV/c)");
        fTrueList[iCut]->Add(fHistoClusterAbundanceAntiPartInJetEFracHadronic[iCut]);
    ...
    if (fIsMC) {
      ...
      if(fDoJetQA){
        ...
        fHistoTrueJetPtVsMomFracVsLeadingPart[iCut] = new TH3F("True_JetPt_vs_PartMomFrac_VsPartPDG", "True_JetPt_vs_PartMomFrac_VsPartPDG", 17, vecEquidistFromMinus05.data(), fVecBinsFragment.size()-1, fVecBinsFragment.data(), fVecBinsJetPt.size() - 1, fVecBinsJetPt.data());
        fTrueJetList[iCut]->Add(fHistoTrueJetPtVsMomFracVsLeadingPart[iCut]);

        fHistoTrueMatchedJetPtVsLeadingPart[iCut] = new TH2F("TrueMatched_JetPt_VsPartPDG", "TrueMatched_JetPt_VsPartPDG", fVecBinsJetPt.size() - 1, fVecBinsJetPt.data(), 17, vecEquidistFromMinus05.data());
      ...
      fTrueJetList[iCut]->Add(fHistoTrueJetEta[iCut]);
      fHistoTrueJetPhi[iCut] = new TH1F("TrueJetPhi", "TrueJetPhi", 70, 0, 7);
      fTrueJetList[iCut]->Add(fHistoTrueJetPhi[iCut]);

      if(fDoJetQA){
        
        fHistoGenParticleInJet[iCut] = new TH3F("Particle_Pt_JetPt", "Particle_Pt_JetPt", 17, vecEquidistFromMinus05.data(), fVecBinsClusterPt.size()-1, fVecBinsClusterPt.data(), fVecBinsJetPt.size() - 1, fVecBinsJetPt.data());
        std::vector<TString> vecPartNames = {"#gamma dec.", "#gamma dir.", "#pi^{#pm}", "K^{#pm}", "K^{0}_{s}", "K^{0}_{l}", "p", "n", "#Lambda", "e^{#pm}", "#mu^{#pm}", "#Sigma^{#pm}", "#Sigma^{0}", "#Xi^{#pm}", "#Xi^{0}", "#nu", "other"};
        ...
        fHistoGenParticleInJetMomFrac[iCut] = new TH3F("Particle_Z_JetPt", "Particle_Z_JetPt", 17, vecEquidistFromMinus05.data(), fVecBinsFragment.size()-1, fVecBinsFragment.data(), fVecBinsJetPt.size() - 1, fVecBinsJetPt.data());
        for(size_t i = 0; i < vecPartNames.size(); ++i){
        ...
        fHistoGenLeadParticleInJetMomFrac[iCut] = new TH3F("LeadingParticle_Z_JetPt", "LeadingParticle_Z_JetPt", 17, vecEquidistFromMinus05.data(), fVecBinsFragment.size()-1, fVecBinsFragment.data(), fVecBinsJetPt.size() - 1, fVecBinsJetPt.data());
        for(size_t i = 0; i < vecPartNames.size(); ++i){
        ...
        if(fDoWeightGenParticles>0){
          fHistoGenParticleInJetWeighted[iCut] = new TH3F("Particle_Pt_JetPt_Weighted", "Particle_Pt_JetPt_Weighted", 17, vecEquidistFromMinus05.data(), fVecBinsClusterPt.size()-1, fVecBinsClusterPt.data(), fVecBinsJetPt.size() - 1, fVecBinsJetPt.data());
          for(size_t i = 0; i < vecPartNames.size(); ++i){
        ...
        fHistoGenParticleAllVsJetPt[iCut] = new TH3F("Inclusive_Particle_Pt_JetPt", "Inclusive_Particle_Pt_JetPt", 19, vecEquidistFromMinus05.data(), fVecBinsClusterPt.size()-1, fVecBinsClusterPt.data(), fVecBinsJetPt.size() - 1, fVecBinsJetPt.data());
        std::vector<TString> vecPartNamesPlusPi0 = {"#gamma dec.", "#gamma dir.", "#pi^{#pm}", "K^{#pm}", "K^{0}_{s}", "K^{0}_{l}", "p", "n", "#Lambda", "e^{#pm}", "#mu^{#pm}", "#Sigma^{#pm}", "#Sigma^{0}", "#Xi^{#pm}", "#Xi^{0}", "#nu", "other", "#pi^{0}", "#eta"};
    ...
    if(fDoJetQA){
      ...
      fHistoNJetsVsMult[iCut] = new TH2F("NJets_V0MMult", "NJets_V0MMult", 15, -0.5, 14.5, fVecBinsMult.size() - 1, fVecBinsMult.data());
      fJetList[iCut]->Add(fHistoNJetsVsMult[iCut]);
      ...
      fJetList[iCut]->Add(fHistoJetTrackPtRadialProfile[iCut]);
    ...
    if(fDoTrackingStudies){
      ...
      hTracksAcceptedVsJetPt[iCut] = new TH2F("AccTracks_JetPt", "AccTracks_JetPt", fVecBinsClusterPt.size()-1, fVecBinsClusterPt.data(), fVecBinsJetPt.size()-1, fVecBinsJetPt.data());
      ...
      hGenTracksAcceptedVsJetPt[iCut] = new TH2F("GenTracks_JetPt", "GenTracks_JetPt", fVecBinsClusterPt.size()-1, fVecBinsClusterPt.data(), fVecBinsJetPt.size()-1, fVecBinsJetPt.data());
      ...
      hTracksResolution[iCut] = new TH3F("Tracks_GenVsRecPt", "Tracks_GenVsRecPt", vecResol.size()-1, vecResol.data(), fVecBinsClusterPt.size()-1, fVecBinsClusterPt.data(), fVecBinsJetPt.size()-1, fVecBinsJetPt.data());
      ...
      fHistoJetClusterEfficiency[iCut] = new TH2F("ClusterEfficiencyVsPtJet", "ClusterEfficiencyVsPtJet", 100, 0., 500, 100., 0., 2.);
      fHistoJetClusterEfficiency[iCut]->SetXTitle("p_{T, jet} (GeV/c)");
      fHistoJetClusterEfficiency[iCut]->SetYTitle("E_{rec}/E_{true}");
      fTrueList[iCut]->Add(fHistoJetClusterEfficiency[iCut]);

      fHistoJetClusterEfficiencyHadCorr[iCut] = new TH2F("ClusterEfficiencyVsPtJet_HadCorr", "ClusterEfficiencyVsPtJet_HadCorr", 100, 0., 500, 100., 0., 2.);
      fHistoJetClusterEfficiencyHadCorr[iCut]->SetXTitle("p_{T, jet} (GeV/c)");
      fHistoJetClusterEfficiencyHadCorr[iCut]->SetYTitle("E_{rec}/E_{true}");
      fTrueList[iCut]->Add(fHistoJetClusterEfficiencyHadCorr[iCut]);
      ...
      fHistoJetClusterEfficiencyHadCorrInJetAcc[iCut] = new TH2F("ClusterEfficiencyInJetAcceptanceVsPtJet_HadCorr", "ClusterEfficiencyInJetAcceptanceVsPtJet_HadCorr", 100, 0., 500, 100., 0., 2.);
      fHistoJetClusterEfficiencyHadCorrInJetAcc[iCut]->SetXTitle("p_{T, jet} (GeV/c)");
      fHistoJetClusterEfficiencyHadCorrInJetAcc[iCut]->SetYTitle("E_{rec}/E_{true}");
      fTrueList[iCut]->Add(fHistoJetClusterEfficiencyHadCorrInJetAcc[iCut]);
      ...
      fTrueList[iCut]->Add(fHistoJetTrackEfficiency[iCut]);
    }
  ...
  fOutputContainer->Add(fConvJetReader->GetHistograms());
...
void AliAnalysisTaskMesonJetCorrelation::MakeBinning()
{
  ...
  if (fMesonPDGCode[0] == 111) { // pi0
    ...
    for (int i = 0; i <= 1000; ++i) {
      fVecBinsMesonInvMass.push_back(valInvMass);
      if (valInvMass >= 0.4 - epsilon && valInvMass < 0.6 - epsilon)
        valInvMass += 0.002;
      else
        break;
    }
  ...
  double valMult = -0.5;
  for (int i = 0; i < 1000; ++i) {
    fVecBinsMult.push_back(valMult);
    if (valMult < 1 - -epsilon)
      valMult += 1;
    else if (valMult < 20 - epsilon)
      valMult += 2;
    else if (valMult < 50 - epsilon)
      valMult += 5;
    else if (valMult < 100 - epsilon)
      valMult += 10;
    else
      break;
  }
    ...
    if(fDoWeightGenParticles > 0){
      ...
      for (int i = 0; i < fConvJetReader->GetTrueNJets(); i++) {
        ...
        for(size_t ipart = 0; ipart < vecTruePart.size(); ++ipart){
          ...
          int index = GetParticleIndex(std::abs(tmpPart->PdgCode()), pdgMother);
...
void AliAnalysisTaskMesonJetCorrelation::ProcessJets(int isCurrentEventSelected)
{
  ...
  fVectorGammaClusEnergyInJetsHadCorr.clear();
  ...
  fVectorGammaClusEnergyInJetsHadCorr.resize(fConvJetReader->GetTrueNJets(), 0.);
  ...
  if (fConvJetReader->GetNJets() > 0) {
    ...
    for (int i = 0; i < fConvJetReader->GetNJets(); i++) {
      ...
      // Jet QA
      if(fDoJetQA){
        // Radial profile filled per particle
        float jetEta = fVectorJetEta.at(i);
    ...
    for (int i = 0; i < fConvJetReader->GetTrueNJets(); i++) {
      ...
      if (IsJetInAcc(fConvJetReader->GetAcceptanceType(), fConvJetReader->Get_Jet_Radius(), fTrueVectorJetEta[i], fTrueVectorJetPhi[i])) {
        ...
        if(fDoJetQA){
            ...
            fHistoTrueJetPtVsLeadingPart[fiCut]->Fill(fTrueVectorJetPt.at(i), GetParticleIndex(LeadingPartPDG, 111), fWeightJetJetMC);
          }
      }
      if (!fDoLightOutput) {
        fHistoNPartInTrueJetVsJetPt[fiCut]->Fill(fTrueVectorJetNPart.at(i), fTrueVectorJetPt.at(i));
      ...
      std::array<float, 17> arrPartEnergy = {0};
      double leadingpT = 0;
      int leadingPDG = -1;
      ...
      if(fDoJetQA){
        ...
        for(size_t ipart = 0; ipart < vecTruePart.size(); ++ipart){
          ...
          int motherLabel = tmpPart->GetMother();
          int pdgMother = 0;
          AliAODMCParticle* particleMother = nullptr;
          if(motherLabel > 0){
            particleMother = static_cast<AliAODMCParticle*>(fAODMCTrackArray->At(motherLabel));
            pdgMother = std::abs(particleMother->PdgCode());
          }
          ...
          //   int pdgMotherTmp = pdgMother;
          //   int labelTmp = particleMother->GetLabel();
          //   while(pdgMotherTmp == 22){
          //     // check if particle is in jet
          //     for(size_t partsearch = 0; partsearch < vecTruePart.size(); ++partsearch){
          //       auto tmpParticle = vecTruePart[partsearch];
          //       if(tmpParticle->GetLabel() == labelTmp){
          //         cout << "mother is in jet!!!" << endl;
          //       }
          //     }
          //     AliAODMCParticle* particleMotherTmp = static_cast<AliAODMCParticle*>(fAODMCTrackArray->At(labelTmp));
          //     pdgMotherTmp = std::abs(particleMotherTmp->PdgCode());
          //     labelTmp = particleMotherTmp->GetMother();
          //     cout << "label = " << particleMotherTmp->PdgCode() << "   pt = "  <<  particleMotherTmp->Pt() << endl;
          //   }
          // }
          fHistoGenParticleInJet[fiCut]->Fill(GetParticleIndex(pdgCode, pdgMother), tmpPart->Pt(), fTrueVectorJetPt.at(i), fWeightJetJetMC);
          if(fTrueVectorJetPt.at(i) > 0) {
            fHistoGenParticleInJetMomFrac[fiCut]->Fill(GetParticleIndex(pdgCode, pdgMother), tmpPart->Pt()/fTrueVectorJetPt.at(i), fTrueVectorJetPt.at(i), fWeightJetJetMC);
          }
          if(fDoWeightGenParticles>0){
            fHistoGenParticleInJetWeighted[fiCut]->Fill(GetParticleIndex(pdgCode, pdgMother), tmpPart->Pt(), fTrueVectorJetPt.at(i), fTrueVectorJetWeight.at(i)*fWeightJetJetMC);
          }
          arrPartEnergy[GetParticleIndex(pdgCode, pdgMother)] += tmpPart->Pt();

        }
        if(fTrueVectorJetPt.at(i) > 0) {
          fHistoGenLeadParticleInJetMomFrac[fiCut]->Fill(GetParticleIndex(leadingPDG, leadingPDGMother), leadingpT/fTrueVectorJetPt.at(i), fTrueVectorJetPt.at(i), fWeightJetJetMC);
        }
...
void AliAnalysisTaskMesonJetCorrelation::ProcessTracks(){
  ...
  for (Int_t itr=0;itr<fInputEvent->GetNumberOfTracks();itr++){
    ...
    double jetpT = 1.;
    if (((AliConversionMesonCuts*)fMesonCutArray->At(fiCut))->IsParticleInJet(fTrueVectorJetEta, fTrueVectorJetPhi, fConvJetReader->Get_Jet_Radius(), aodt->Eta(), aodt->Phi(), matchedJet, RJetPi0Cand)) {
      if(std::fabs(aodt->Eta()) < 0.8){ // only consider tracks in TPC acceptance
        fVectorTrackEnergyInJets[matchedJet] += aodt->P();
      }
  ...
  if(fIsMC){
    for(int ijet = 0; ijet < fConvJetReader->GetTrueNJets(); ++ijet){
      if(fVectorChargedParticleEnergyInJets[ijet] > 0){
        fHistoJetTrackEfficiency[fiCut]->Fill(fTrueVectorJetPt[ijet], fVectorTrackEnergyInJets[ijet]/fVectorChargedParticleEnergyInJets[ijet], fWeightJetJetMC);
      }
    }
  }
}
...
bool AliAnalysisTaskMesonJetCorrelation::IsJetInAcc(unsigned int accType, double r, double eta, double phi)
{
  if (accType & AliEmcalJet::kEMCAL) {
    if (IsInEMCalAcc(0, eta, phi)) {
      return true;
    }
  }
  if (accType & AliEmcalJet::kEMCALfid) {
    if (IsInEMCalAcc(r, eta, phi)) {
      return true;
    }
  }
  if (accType & AliEmcalJet::kDCAL) {
    if (IsInDCalAcc(0, eta, phi)) {
      return true;
    }
  }
  if (accType & AliEmcalJet::kDCALfid) {
    if (IsInDCalAcc(r, eta, phi)) {
      return true;
    }
  }
...
void AliAnalysisTaskMesonJetCorrelation::UserExec(Option_t*)
{
  ...
  for (int iCut = 0; iCut < fnCuts; iCut++) {
    ...
    if (fIsConvCalo || fIsConv) {
      if (fLocalDebugFlag) {
        printf("ProcessPhotonCandidates\n");
      }
...
void AliAnalysisTaskMesonJetCorrelation::ProcessClusters()
{
  ...
  for (Long_t i = 0; i < nclus; i++) {
    ...
    if (fIsMC > 0) {
      ProcessTrueClusterCandidatesAOD(PhotonCandidate, matchedJet, clus->GetHadCorrEnergy());
      // Fill extra histogram
      if(fDoMesonQA > 0){
        int matchedTrueJet = -1;
        double RJetPi0CandTrue = 0;
        if (((AliConversionMesonCuts*)fMesonCutArray->At(fiCut))->IsParticleInJet(fTrueVectorJetEta, fTrueVectorJetPhi, fConvJetReader->Get_Jet_Radius(), PhotonCandidate->Eta(), PhotonCandidate->Phi(), matchedTrueJet, RJetPi0CandTrue)) {
          if (matchedTrueJet >= 0) {
            int labelClus = clus->GetLabelAt(0);
            if(labelClus >= 0) {
              AliAODMCParticle* particle = static_cast<AliAODMCParticle*>(fAODMCTrackArray->At(labelClus));
              if(particle) {
                bool isHadronic = false;
                double prodR = sqrt(particle->Xv()*particle->Xv() + particle->Yv()*particle->Yv());
                if(particle->GetMCProcessCode() == 13 && prodR > 1.){
                  isHadronic = true;
                }
                fHistoHadronicInteractionsVsR[fiCut]->Fill(prodR, fWeightJetJetMC);
                ...
                if(isHadronic) fHistoClusterAbundanceInJetEFracHadronic[fiCut]->Fill(indexPart, clus->E()*clus->GetClusterMCEdepFraction(0), fTrueVectorJetPt[matchedTrueJet], fWeightJetJetMC);
                ...
                if(particle->GetPdgCode() < 0){ // treat only anti-particles to check difference between particles and antiparticles
                  ...
                  if(isHadronic) fHistoClusterAbundanceAntiPartInJetEFracHadronic[fiCut]->Fill(indexPart, clus->E()*clus->GetClusterMCEdepFraction(0), fTrueVectorJetPt[matchedTrueJet], fWeightJetJetMC);
  ...
  // fill cluster inside of jets histogram
  if(fIsMC > 0 && fDoTrackingStudies){
    for(int i = 0; i < fConvJetReader->GetTrueNJets(); ++i){
      if(fVectorGammaEnergyInJets[i]>0 && fVectorGammaEnergyInJets[i] > 0.05* fTrueVectorJetPt[i]) {
        fHistoJetClusterEfficiency[fiCut]->Fill(fTrueVectorJetPt[i], fVectorGammaClusEnergyInJets[i]/fVectorGammaEnergyInJets[i], fWeightJetJetMC);
        fHistoJetClusterEfficiencyHadCorr[fiCut]->Fill(fTrueVectorJetPt[i], fVectorGammaClusEnergyInJetsHadCorr[i]/fVectorGammaEnergyInJets[i], fWeightJetJetMC);
      }
      if(fVectorGammaEnergyInJetsJetAcc[i]>0 && fVectorGammaEnergyInJetsJetAcc[i] > 0.05* fTrueVectorJetPt[i]) {
        fHistoJetClusterEfficiencyInJetAcc[fiCut]->Fill(fTrueVectorJetPt[i], fVectorGammaClusEnergyInJets[i]/fVectorGammaEnergyInJetsJetAcc[i], fWeightJetJetMC);
        fHistoJetClusterEfficiencyHadCorrInJetAcc[fiCut]->Fill(fTrueVectorJetPt[i], fVectorGammaClusEnergyInJetsHadCorr[i]/fVectorGammaEnergyInJetsJetAcc[i], fWeightJetJetMC);
      }
    }
  }
}
...
//________________________________________________________________________
float AliAnalysisTaskMesonJetCorrelation::GetFrag(double pt, double arrPartP[3], const int matchedJet, int isTrueJet)
{
  if (!((AliConversionMesonCuts*)fMesonCutArray->At(fiCut))->DoJetAnalysis()) {
    return 0;
  }
  ...
  if (fUsePtForZCalc) {
    if (isTrueJet == 1) {
      z = (fTrueVectorJetPt[matchedJet] == 0) ? 0 : pt / fTrueVectorJetPt[matchedJet];
    } else if (isTrueJet == 2) {
      z = (fTrueVectorJetPartonPt[matchedJet] == 0) ? 0 : pt / fTrueVectorJetPartonPt[matchedJet];
    } else {
      z = (fVectorJetPt[matchedJet] == 0) ? 0 : pt / fVectorJetPt[matchedJet];
    }
  } else {
    ...
    float scalarProd = std::abs(arrPartP[0] * arrJetP[0] + arrPartP[1] * arrJetP[1] + arrPartP[2] * arrJetP[2]);
...
{
  double arrPartP[3] = {Pi0Candidate->Px(), Pi0Candidate->Py(), Pi0Candidate->Pz()};
  return GetFrag(Pi0Candidate->Pt(), arrPartP, matchedJet, isTrueJet);
}
...
void AliAnalysisTaskMesonJetCorrelation::CalculateBackgroundSwapp()
{
  ...
  if (fIsCalo) {
    ...
    for (unsigned int iCurrent1 = 0; iCurrent1 < fClusterCandidates.size(); iCurrent1++) {
      ...
      for (unsigned int iCurrent2 = 0; iCurrent2 < fGammaCandidates.size(); iCurrent2++) {
...
void AliAnalysisTaskMesonJetCorrelation::FillInvMassBackHistograms(AliAODConversionMother* backgroundCandidate, const bool isRotBack)
{
  ...
  if (!isRotBack && fUseMixedBackAdd) {
    if (fDoAnalysisPt) {
      fRespMatrixHandlerMesonBackAddInvMassVsPt[fiCut]->Fill(ptJet, 0.5, backgroundCandidate->M(), backgroundCandidate->Pt(), fWeightJetJetMC);
    } // Inv Mass vs. meson Pt in Jet Pt_rec bins. Needed to subtract background in the Pt-distribution
    if (fDoAnalysisZ) {
      fRespMatrixHandlerMesonBackAddInvMassVsZ[fiCut]->Fill(ptJet, 0.5, backgroundCandidate->M(), z, fWeightJetJetMC);
    } // Inv Mass vs. Z in Jet Pt_rec bins. Needed to subtract background in the Z-distribution
    // if(fDoRadiusDep){
    //   fRespMatrixHandlerMesonBackAddPtInvMassRadius[fiCut]->Fill(vecFillInvMassPtR, vecFillJetPt, fWeightJetJetMC);
    // }
  } else {
    if (fDoAnalysisPt) {
      fRespMatrixHandlerMesonBackInvMassVsPt[fiCut]->Fill(ptJet, 0.5, backgroundCandidate->M(), backgroundCandidate->Pt(), fWeightJetJetMC);
    } // Inv Mass vs. meson Pt in Jet Pt_rec bins. Needed to subtract background in the Pt-distribution
    if (fDoAnalysisZ) {
      fRespMatrixHandlerMesonBackInvMassVsZ[fiCut]->Fill(ptJet, 0.5, backgroundCandidate->M(), z, fWeightJetJetMC);
    } // Inv Mass vs. Z in Jet Pt_rec bins. Needed to subtract background in the Z-distribution
    if (fDoRadiusDep) {
...
void AliAnalysisTaskMesonJetCorrelation::ProcessAODMCParticlesK0sLambda(int isCurrentEventSelected)
{
    ...
    if (isPrimary) {
      ...
      if (particle->Y() > ((AliConversionMesonCuts*)fMesonCutArray->At(fiCut))->GetRapidityCutValueMin() && particle->Y() < ((AliConversionMesonCuts*)fMesonCutArray->At(fiCut))->GetRapidityCutValueMax()) {
        ...
        if (matchedJet >= 0) {
          if (isCurrentEventSelected == 1) {
            fHistoMCMesonPtNotTriggered[fiCut]->Fill(particle->Pt(), fWeightJetJetMC); // All MC Pi0 in not triggered collisions
        ...
        if (matchedJet >= 0) {
          ...
          if (fDoAnalysisPt) {
            fHistoMCJetPtVsMesonPt[fiCut]->Fill(particle->Pt(), fTrueVectorJetPt[matchedJet], fWeightJetJetMC);
          }
          if (fDoAnalysisZ) {
            z_jet = GetFrag(particle, matchedJet, 1);
            z_parton = GetFrag(particle, matchedJet, 2);
            fHistoMCJetPtVsFrag[fiCut]->Fill(z_jet, fTrueVectorJetPt[matchedJet], fWeightJetJetMC);
            fHistoMCPartonPtVsFrag[fiCut]->Fill(z_parton, fTrueVectorJetPartonPt[matchedJet], fWeightJetJetMC);
            if (IsParticleFromPartonFrag(particle, fTrueVectorJetPartonID[matchedJet])) {
              fHistoMCJetPtVsFragTrueParton[fiCut]->Fill(z_jet, fTrueVectorJetPt[matchedJet], fWeightJetJetMC);
              fHistoMCPartonPtVsFragTrueParton[fiCut]->Fill(z_parton, fTrueVectorJetPartonPt[matchedJet], fWeightJetJetMC);
            }
          }

          // Fill radius vs. jet pt vs meson pt histogram
          if (fDoRadiusDep) {
            fHistoMCJetPtVsMesonPtVsRadius[fiCut]->Fill(particle->Pt(), fTrueVectorJetPt[matchedJet], RJetPi0Cand, fWeightJetJetMC);
          }
        }
        // inside rec. jet but fill true jet quantities
        if (matchedRecJet >= 0 && matchedJet >= 0) {
          if (fDoAnalysisZ) {
            fHistoMCRecJetPtVsFrag[fiCut]->Fill(z_jet, fTrueVectorJetPt[matchedJet], fWeightJetJetMC);
          }
          if (fDoAnalysisPt) {
            fHistoMCRecJetPtVsMesonPt[fiCut]->Fill(particle->Pt(), fTrueVectorJetPt[matchedJet], fWeightJetJetMC);
          }
        }
        // Check the acceptance for both gammas
        if (std::abs(daughter0->Eta()) < 0.9 && std::abs(daughter1->Eta()) < 0.9) {
          if (matchedJet >= 0) {
            if (fDoAnalysisPt) {
              fHistoMCMesonInAccPt[fiCut]->Fill(particle->Pt(), fWeightJetJetMC); // MC Pi0 with gamma in acc
              fHistoMCJetPtVsMesonPtInAcc[fiCut]->Fill(particle->Pt(), fTrueVectorJetPt[matchedJet], fWeightJetJetMC);
            }
            if (fDoAnalysisZ) {
              fHistoMCJetPtVsFragInAcc[fiCut]->Fill(z_jet, fTrueVectorJetPt[matchedJet], fWeightJetJetMC);
            }

            if (fDoRadiusDep) {
              fHistoMCJetPtVsMesonPtVsRadiusInAcc[fiCut]->Fill(particle->Pt(), fTrueVectorJetPt[matchedJet], RJetPi0Cand, fWeightJetJetMC);
            }
            if (isCurrentEventSelected == 1)
              fHistoMCMesonInAccPtNotTriggered[fiCut]->Fill(particle->Pt(), fWeightJetJetMC); // MC Pi0 with gamma in acc for not triggered events
            if (fIsMC > 1)
      ...
      if (particle->Y() < 0.8) { // make this a real settable cut
        ...
        if (fDoAnalysisPt) {
          // Check the acceptance for both gammas
          if (std::abs(daughter0->Eta()) < 0.9 && std::abs(daughter1->Eta()) < 0.9) {
            fHistoMCSecMesonInAccPtvsSource[fiCut]->Fill(particle->Pt(), 1, fWeightJetJetMC); // All MC Pi0
          }
        }
      }
    }
...
void AliAnalysisTaskMesonJetCorrelation::ProcessAODMCParticles(int isCurrentEventSelected)
{
  ...
  std::map<int, int> mapTrueJetCellID; // map with true jet index and cellID in the acceptance
  ...
  for (Long_t i = 0; i < fAODMCTrackArray->GetEntriesFast(); i++) {
    ...
    if(fDoTrackingStudies && isCurrentEventSelected == 0){
      if(particle->IsPhysicalPrimary() && particle->Charge() != 0 && std::abs(particle->Eta()) < 0.8){
        ...
        if(matchedJet >= 0) {
          jetPt = fTrueVectorJetPt[matchedJet];
          fVectorChargedParticleEnergyInJets[matchedJet] += particle->P();
        }
        hGenTracksAcceptedVsJetPt[fiCut]->Fill(particle->Pt(), jetPt, fWeightJetJetMC);
      }
      int motherLabel = particle->GetMother();
      bool physPrimMother = false;
      if(motherLabel > 0) {
        AliAODMCParticle* photonMother = static_cast<AliAODMCParticle*>(fAODMCTrackArray->At(motherLabel));
        if(photonMother->GetPdgCode() != 22){
          physPrimMother = photonMother->IsPhysicalPrimary();
        }
      }
      
      if(particle->GetPdgCode() == 22 && (particle->IsPhysicalPrimary() || (!particle->IsPhysicalPrimary() && physPrimMother)) && std::abs(particle->Eta()) < 0.8 && matchedJet >= 0){
    ...
    if(fDoMesonQA > 0 && particle->IsPhysicalPrimary() && std::abs(particle->Eta()) < 0.8 && matchedJet >= 0){ // could be moreged with the code above
      ...
      if(mapTrueJetCellID[matchedJet] >= 0){
        int indexPart = GetParticleIndex(std::abs(particle->PdgCode()), 0);
        fHistoPrimPartAbundanceInJet[fiCut]->Fill(indexPart, particle->E(), fTrueVectorJetPt[matchedJet], fWeightJetJetMC);
        // Now also check if the particle itself hits an EMCal cell
        int cellID = ((AliCaloPhotonCuts*)fClusterCutArray->At(fiCut))->GetCaloCellIdFromEtaPhi(particle->Eta(), static_cast<double>((particle->Phi() < 0) ? particle->Phi() + TMath::Pi() * 2. : particle->Phi()));
        if(cellID >= 0){
          fHistoPrimPartAbundanceInJetAndEMCal[fiCut]->Fill(indexPart, particle->E(), fTrueVectorJetPt[matchedJet], fWeightJetJetMC);
        }
      }
...
//________________________________________________________________________
void AliAnalysisTaskMesonJetCorrelation::ProcessTrueClusterCandidatesAOD(AliAODConversionPhoton* TruePhotonCandidate, const int matchedJet, const double clusHadCorrE)
{
  ...
  if (TruePhotonCandidate->IsLargestComponentPhoton() || (TruePhotonCandidate->IsLargestComponentElectron() && TruePhotonCandidate->IsConversion())) {
    ...
    if(fDoTrackingStudies){
      double RJetPi0CandTrue;
      int matchedTrueJet = -1;
      double phiPart = static_cast<double>((TruePhotonCandidate->Phi() < 0) ? TruePhotonCandidate->Phi() + TMath::Pi() * 2. : TruePhotonCandidate->Phi());
      if (((AliConversionMesonCuts*)fMesonCutArray->At(fiCut))->IsParticleInJet(fTrueVectorJetEta, fTrueVectorJetPhi, fConvJetReader->Get_Jet_Radius(), TruePhotonCandidate->Eta(), phiPart, matchedTrueJet, RJetPi0CandTrue)) {
        fVectorGammaClusEnergyInJets[matchedTrueJet]+=TruePhotonCandidate->E();
        fVectorGammaClusEnergyInJetsHadCorr[matchedTrueJet]+=clusHadCorrE;
      }
    }
  }
}
...
bool AliAnalysisTaskMesonJetCorrelation::ProcessTrueMesonCandidatesAOD(AliAODConversionMother* Pi0Candidate, AliAODConversionPhoton* TrueGammaCandidate0, AliAODConversionPhoton* TrueGammaCandidate1, const int matchedJet, const float RJetPi0Cand, const double weightMatBudget)
{
  ...
  if (isTrueOtherParticle) {
    if (fDoAnalysisPt) {
      fRespMatrixHandlerTrueOtherMesonInvMassVsPt[fiCut]->Fill(jetPtRec, 0.5, Pi0Candidate->M(), Pi0Candidate->Pt(), fWeightJetJetMC * weightMatBudget);
    }
    if (fDoAnalysisZ) {
...
void AliAnalysisTaskMesonJetCorrelation::FillMesonDCATree(AliAODConversionMother* Pi0Candidate, AliAODConversionPhoton* gamma0, AliAODConversionPhoton* gamma1, const int matchedJet, const bool isTrueMeson)
{
  ...
  if ((fDCATree_InvMass < 0.08 * 1000 || fDCATree_InvMass > 0.8 * 1000))
    return;
...
void AliAnalysisTaskMesonJetCorrelation::ProcessK0Lambda(const int pdgCode){
  ...
  for (int iV0 = 0; iV0 < nV0s; iV0++)
   { // This is the begining of the V0 loop
      ...
      if (fDoAnalysisPt) {
        if (fDoMesonQA > 0) {
          fHistoInvMassVsPt_Incl[fiCut]->Fill(massV0, v0->Pt(), fWeightJetJetMC);
        }
      }
      ...
      if (((AliConversionMesonCuts*)fMesonCutArray->At(fiCut))->IsParticleInJet(fVectorJetEta, fVectorJetPhi, fConvJetReader->Get_Jet_Radius(), v0->Eta(), v0->Phi(), matchedJet, RJetPi0Cand)) {
        ...
        if (fDoAnalysisPt) {
          // Fill Inv Mass Histograms
          fHistoInvMassVsPt[fiCut]->Fill(massV0, v0->Pt(), fWeightJetJetMC);

          // Fill the inv. mass histograms for all jet pTs
          fRespMatrixHandlerMesonInvMass[fiCut]->Fill(ptJet, 0.5, massV0, v0->Pt(), fWeightJetJetMC);
        }

      //   // Fill Z histograms
        double v0Momentum[3] = {v0->Px(), v0->Py(), v0->Pz()};
        float z = GetFrag(v0->Pt(), v0Momentum, matchedJet, false);
        if (fDoAnalysisZ) {
          fHistoInvMassVsZ[fiCut]->Fill(massV0, z, fWeightJetJetMC);
          fRespMatrixHandlerMesonInvMassVsZ[fiCut]->Fill(ptJet, 0.5, massV0, z, fWeightJetJetMC); // Inv Mass vs. Z in Jet Pt_rec bins. Needed to subtract background in the Z-distribution
        }
...
void AliAnalysisTaskMesonJetCorrelation::ProcessTrueK0Lambda(const int pdgCode, AliAODv0* v0, const int matchedJet, const double massV0){
  ...
  const int nlab = std::abs(ntrack->GetLabel());
	const int plab = std::abs(ptrack->GetLabel());

  if (!fAODMCTrackArray)
    fAODMCTrackArray = dynamic_cast<TClonesArray*>(fInputEvent->FindListObject(AliAODMCParticle::StdBranchName()));

  AliAODMCParticle *nPart=(AliAODMCParticle*)fAODMCTrackArray->UncheckedAt(nlab);
	AliAODMCParticle *pPart=(AliAODMCParticle*)fAODMCTrackArray->UncheckedAt(plab);

  if(!nPart || !pPart){
    AliError("Could not find daughters of V0...");
  }

  int ipMother = pPart->GetMother();
	int inMother = nPart->GetMother();
  ...
  if(ipMother > 0 && ipMother == inMother){
    ...
    if(pdgCode == v0MCPart->PdgCode()){
      ...
      double v0Momentum[3] = {v0->Px(), v0->Py(), v0->Pz()};
      double v0MomentumTrue[3] = {v0MCPart->Px(), v0MCPart->Py(), v0MCPart->Pz()};
      
      float z_rec = GetFrag(v0->Pt(), v0Momentum, matchedJet, false);
      float z_rec_trueJet = GetFrag(v0->Pt(), v0Momentum, indexTrueJet, true);
      float z_true = GetFrag(v0MCPart->Pt(), v0MomentumTrue, indexTrueJet, true); // is this correct?? with the momentum? Or do we need the mc particle?

      // float RJetPi0CandTrue = GetRadiusJetPart(Pi0Candidate, indexTrueJet, true);
      
      if (fDoAnalysisPt) {
        fRespMatrixHandlerTrueMesonInvMassVsPt[fiCut]->Fill(jetPtRec, 0.5, massV0, v0->Pt(), fWeightJetJetMC);
      }
      if (fDoAnalysisZ) {
        fRespMatrixHandlerTrueMesonInvMassVsZ[fiCut]->Fill(jetPtRec, 0.5, massV0, z_rec, fWeightJetJetMC);
      }

      if (fDoAnalysisPt) {
        if (fDoMesonQA) {
          fHistoTruePrimaryMesonInvMassPt[fiCut]->Fill(massV0, v0->Pt(), fWeightJetJetMC);
          // meson response matrix (no Jet included here). Only use that for x-checks as the response is probably jet pt dependent
          fHistoMesonResponse[fiCut]->Fill(v0->Pt(), v0MCPart->Pt(), fWeightJetJetMC);
          fHistoMesonResolutionJetPt[fiCut]->Fill(v0->Pt(), (v0->Pt() - v0MCPart->Pt()) / v0->Pt(), jetPtRec);
        }
      }

      if (fDoAnalysisPt) {
        fHistoTrueMesonJetPtVsTruePt[fiCut]->Fill(v0MCPart->Pt(), jetPtTrue, fWeightJetJetMC);
        fHistoTrueMesonJetPtVsRecPt[fiCut]->Fill(v0->Pt(), jetPtRec, fWeightJetJetMC);
        fRespMatrixHandlerMesonInvMass[fiCut]->Fill(jetPtRec, jetPtTrue, massV0, v0->Pt(), fWeightJetJetMC);
        // fill 4d response matrix
        fRespMatrixHandlerMesonPt[fiCut]->Fill(jetPtRec, jetPtTrue, v0->Pt(), v0MCPart->Pt(), fWeightJetJetMC);
      }
      if (fDoAnalysisZ) {
...
//________________________________________________________________________
int AliAnalysisTaskMesonJetCorrelation::GetParticleIndex(const int pdgcode, const int motherpdg) const {
  if(pdgcode == 22){ // gamma
    ...
    return 15;
  } else if(pdgcode == 111 ){ // pi0 (special case as not primary)
    return 17;
  } else if(pdgcode == 221 ){ // eta (special case as not primary)
    return 18;
...
//________________________________________________________________________
void AliAnalysisTaskMesonJetCorrelation::InitializePartAbundanceWeighting(){
  TGrid::Connect("alien://");
  cout << "Getting the weighting file " << fNameJetWeightingFile << endl;
  TFile *fWeights = TFile::Open(fNameJetWeightingFile);
  if(!fWeights) AliFatal(Form("file %s not found", fNameJetWeightingFile.Data()));

  fHistWeightingPartAbundance.resize(12);
  for(int i = 0; i <= 11; ++i){
    fHistWeightingPartAbundance[i] =  (TH1F*) fWeights->Get(Form("particle_%i", i));
    if(!fHistWeightingPartAbundance[i]){
  ...
  fWeights->Close();
  delete fWeights;
  cout << "ParticleWeighting initialized" << endl;
}
