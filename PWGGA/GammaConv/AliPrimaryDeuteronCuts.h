#ifndef ALIPRIMARYDEUTERONCUTS_H
#define ALIPRIMARYDEUTERONCUTS_H
...
class AliPrimaryDeuteronCuts : public AliAnalysisCuts {
	...
	AliPrimaryDeuteronCuts(const char *name="DeuteronCuts", const char * title="Deuteron Cuts");
	virtual ~AliPrimaryDeuteronCuts();                            //virtual destructor
	...
	TString GetCutNumber();
		...
		// Cut Selection
    Bool_t DeuteronIsSelectedMC(Int_t labelParticle,AliMCEvent *mcEvent);
    Bool_t DeuteronIsSelectedAODMC(Int_t labelParticle, TClonesArray *AODMCTrackArray);
    Bool_t TrackIsSelected(AliESDtrack* lTrack);
    Bool_t TrackIsSelectedAOD(AliAODTrack* lTrack);
    Bool_t DeuteronIsSelected(AliESDtrack* lTrack);
    Bool_t DeuteronIsSelectedAOD(AliAODTrack* lTrack);
	static AliPrimaryDeuteronCuts * GetStandardCuts2010PbPb();
	static AliPrimaryDeuteronCuts * GetStandardCuts2010pp();
	...
	Bool_t SetTPCdEdxCutDeuteronLine(Int_t pidedxSigmaCut);
	Bool_t SetITSdEdxCutDeuteronLine(Int_t ededxSigmaCut);
	...
	Bool_t SetTOFDeuteronPIDCut(Int_t TOFelectronPID);
	...
	Double_t fPIDnSigmaAboveDeuteronLineITS; // sigma cut ITS
	Double_t fPIDnSigmaBelowDeuteronLineITS; // sigma cut ITS
	Double_t fPIDnSigmaAboveDeuteronLineTPC; // sigma cut TPC
	Double_t fPIDnSigmaBelowDeuteronLineTPC; // sigma cut TPC
	Double_t fPIDnSigmaAboveDeuteronLineTOF; // sigma cut TOF
	Double_t fPIDnSigmaBelowDeuteronLineTOF; // sigma cut TOF 
  ...
  TString fCutStringRead;
	...
	AliPrimaryDeuteronCuts(const AliPrimaryDeuteronCuts&); // not implemented
	AliPrimaryDeuteronCuts& operator=(const AliPrimaryDeuteronCuts&); // not implemented


    ClassDef(AliPrimaryDeuteronCuts,1)
};
