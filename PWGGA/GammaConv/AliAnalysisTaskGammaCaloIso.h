#ifndef ALIANLYSISTASKGAMMACALOISO_cxx
#define ALIANLYSISTASKGAMMACALOISO_cxx
...
class AliAnalysisTaskGammaCaloIso : public AliAnalysisTaskSE {
  public:
  ...
  protected:
    ...
    TH1F**                  fHistoIsoMatSecPhotonfromPi0;       //! array of histograms with Photons from pi0s
    TH2F**                  fHistoIsoPi0MotherPDGtoPtMatSec;          //! array of histograms with Mothers of Pi0s decaying into Photons MatSec
...
//    TH2F**                  fHistoTrueEtaNonLinearity;                        //! E_truth/E_rec vs E_rec for TrueEtas
  ...
  private:
    ...
    ClassDef(AliAnalysisTaskGammaCaloIso, 1);
};
