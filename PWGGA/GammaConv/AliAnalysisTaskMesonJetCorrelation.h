...
class AliAnalysisTaskMesonJetCorrelation : public AliAnalysisTaskSE
{
 ...
 protected:
  ...
  std::vector<TH3F*> fHistoParticleCatEnergyFracVsJetPt;      //! vector of histos with particle category vs energy fraction vs jet pt
  ...
  std::vector<TH2F*> hTracksGlobalConstrained;         //! vector of histos reconstructed track pt vs phi for global constrained tracks
