                                                          ...
                                                          Bool_t  calibrate = kTRUE)
{
  ...
  if(simulation)
  {
    // REMEMBER TO CHANGE IT BACK TO ON WHEN FIXES TO MC ACCESS PROVIDED
    emcalQA->SwitchOffDataMC() ;//Access MC stack and fill more histograms, AOD MC not implemented yet.
