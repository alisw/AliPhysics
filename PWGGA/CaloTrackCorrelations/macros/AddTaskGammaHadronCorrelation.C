                                 ...
                                 Bool_t  printSettings, Int_t  debug)
{
  ...
  if(calorimeter=="EMCAL")
  {
    ...
    {
      histoRanges->SetHistoPhiRangeAndNBins(78*TMath::DegToRad(), 330*TMath::DegToRad(), 122) ;
      histoRanges->SetHistoXRangeAndNBins(-100,90,200); // QA to be checked
      histoRanges->SetHistoYRangeAndNBins(50,450,100);  // QA to be checked
    }
