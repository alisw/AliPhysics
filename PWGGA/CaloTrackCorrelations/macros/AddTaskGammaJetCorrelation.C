...
//    }
  ...
  if(mix)
  {
    ...
    //reader->SetMixEventTriggerMaks(AliTrigger::kMB); // Careful, not all productions work with kMB, try kINT7, kINT1, kAnyINT
    reader->SetMixEventTriggerMaks(AliTrigger::kAnyINT); // Careful, not all productions work with kMB, try kINT7, kINT1, kAnyINT
