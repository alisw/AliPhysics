...
//Origin  A. Badala' and G.S. Pappalardo:  e-mail Angela.Badala@ct.infn.it, Giuseppe.S.Pappalardo@ct.infn.it      
  ...
  localM(3,0)=localM(0,3)=cov[3];
  localM(3,1)=localM(1,3)=cov[4];
  localM(2,0)=localM(0,2)=cov[6];
  localM(2,1)=localM(1,2)=cov[7];
  localM(2,3)=localM(3,2)=cov[8];
  localM(4,0)=localM(0,4)=cov[10];
  localM(4,1)=localM(1,4)=cov[11];
  localM(4,3)=localM(3,4)=cov[12];
  localM(4,2)=localM(2,4)=cov[13];  
