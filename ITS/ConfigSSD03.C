...
void Config(){
    ...
    gener->SetMomentumRange(7.,7.);
    //gener->SetPhiRange(0,0.1);
    gener->SetPhiRange(0,360.0);
    gener->SetThetaRange(0.0, .2);
    //gener->SetThetaRange(0.0,0.0);
    gener->SetOrigin(0.,0.,-650.);   // beam comes ~-6.5 m from telescope
    //vertex position
    ...
    if(iITS) {
	//=================== ITS parameters ============================
	AliITSvSSD03 *ITS  = new AliITSvSSD03("SSD test beam 2003",2003);
    }
    return;
}
