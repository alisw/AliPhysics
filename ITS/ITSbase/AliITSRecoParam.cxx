...
AliITSRecoParam::AliITSRecoParam() : AliDetectorRecoParam(),
 ...
 //
 fOptReco("All"),
 fRemoveFastOrFromDeadRaw(kFALSE),
 fRemoveFastOrFromDeadMC(kTRUE),
 fESDV0Params(NULL)
{
 //
 // constructor
...
//_____________________________________________________________________________
void AliITSRecoParam::PrintFastOrRecoParam() const {
//
// method to add rec information in the logs
// 

 TString recoParamRaw, recoParamMC;
 if(fRemoveFastOrFromDeadRaw) recoParamRaw="IS required";
 else recoParamRaw="IS NOT required";
 if(fRemoveFastOrFromDeadMC) recoParamMC="IS required";
