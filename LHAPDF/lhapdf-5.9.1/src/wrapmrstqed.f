...
!      imem=member(iset)
      ...
      chm=0.d0
      if(qsq.gt.emc2) then
      call jeppe2(imem,xlog,qsqlog,nx,nqc,xxl,qqlc,ccc(0,1,1,1,1,iset),chm)
      endif

      bot=0.d0
      if(qsq.gt.emb2) then
      call jeppe2(imem,xlog,qsqlog,nx,nqb,xxl,qqlb,ccb(0,1,1,1,1,iset),bot)
      endif
...
!      write(*,*)'PDF set ',nm,' first element ',f1(1,1)
   ...
   40 continue
      ...
      call jeppe1(nm,nx,nq,xxl,qql,f9,cc9(0,1,1,1,1,nset))
