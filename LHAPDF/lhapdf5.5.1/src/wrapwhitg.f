...
!-------------------------------------------------------                
!     WHIT1 parton distribution in the photon                           
!                                                                       
!     INPUT:  integer ic  : if ic=0 then qc=0                           
!                           else qc is calculated                       
!             DOUBLE PRECISION  Q2  : energy scale Q^2 (GeV^2)          
!             DOUBLE PRECISION  x   : energy fraction                   
!                                                                       
!     OUTPUT: DOUBLE PRECISION  qu  : up-quark dist.                    
!             DOUBLE PRECISION  qd  : down- or strange-quark dist.      
!             DOUBLE PRECISION  qc  : charm-quark dist.                 
!             DOUBLE PRECISION  g   : gluon dist.                       
!-------------------------------------------------------                
!     Modified by M.Tanaka on July 22, 1994.                            
!     The bug pointed out by M.Drees is fixed.                          
!-------------------------------------------------------                
!     Modified by I.Watanabe on July 22, 1994.                          
!-------------------------------------------------------                
      implicit none 
      external WHIT1G 
      double precision                                                  &
...
!  set  scale s                                                         
         if(Q2.lt.4.0d0) then 
!ccc  for under 4GeV^2 prescription                                     
            s=  0.0d0 
...
!-------------------------------------------------------                
!     WHIT2 parton distribution in the photon                           
!                                                                       
!     INPUT:  integer ic  : if ic=0 then qc=0                           
!                           else qc is calculated                       
!             DOUBLE PRECISION  Q2  : energy scale Q^2 (GeV^2)          
...
!-------------------------------------------------------                
!     WHIT3 parton distribution in the photon                           
!                                                                       
!     INPUT:  integer ic  : if ic=0 then qc=0                           
!                           else qc is calculated                       
!             DOUBLE PRECISION  Q2  : energy scale Q^2 (GeV^2)          
...
!-------------------------------------------------------                
!     WHIT6 parton distribution in the photon                           
!                                                                       
!     INPUT:  integer ic  : if ic=0 then qc=0                           
!                           else qc is calculated                       
!             DOUBLE PRECISION  Q2  : energy scale Q^2 (GeV^2)          
...
!cc INPUTS : x,r=mc^2/Q^2                                               
!cc OUTPUTS:   cv,cs (valence- and sea- charm quark dist)               
!cc                  cv <-- cv / ( alpha / 2PI)                         
!cc                  cs <-- cs / ( alpha_s/2PI)                         
!                                                                       
      implicit none 
! arg                                                                   
...
!  N=15 Gauss int. weights and points                                   
      integer GN,i 
      parameter(GN=15) 
