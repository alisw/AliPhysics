...
c      write(6,*) 'CTEQ6NewAlpha: mc, mb, mt=',
c     &  cmass, bmass, tmass
...
cccccc
      ...
      IF (IRT .EQ. 1) THEN
         CALL CtLhWARNR (IW1, 'AMU < ALAM in CtLhALPI34', 'AMU', AMU,
     >              ALM, BIG, 1)
      ELSEIF (IRT .EQ. 2) THEN
         CALL CtLhWARNR(IW2,'CtLhALPI34 > 3; Be aware!','CtLhALPI34',
     >  CtLhALPI34, D0, D1, 0)
      ENDIF
      RETURN
      END
