...
public:
  ...
  //Legacy PropagateToDCA function
  Double_t PropagateToDCA(AliESDv0 *vtx,AliExternalTrackParam *trk,Double_t b);
  
  //Implementation of curved bachelor propagation
  Double_t PropagateToDCACurvedBachelor(AliESDv0 *vtx,AliExternalTrackParam *trk,Double_t b);
...
private:
  ...
  Bool_t fUseImprovedFinding; //use curved bach propag, casc refit
  
  ClassDef(AliCascadeVertexer,5)  // cascade verterxer
};
