...
#include "AliClusterTGeo.h"
#include "AliLog.h"
#include "AliAlignObj.h"

ClassImp(AliClusterTGeo)

//______________________________________________________________________________
AliClusterTGeo::AliClusterTGeo():
  TObject(),
  fX(0),
  fY(0),
  fZ(0),
...
//______________________________________________________________________________
Bool_t AliClusterTGeo::GetGlobalCov(Float_t cov[6]) const
{
...
//______________________________________________________________________________
Bool_t AliClusterTGeo::GetXRefPlane(Float_t &xref) const
{
...
//______________________________________________________________________________
Bool_t AliClusterTGeo::Misalign()
{
  // ...
  // All the needed information is taken only
  // from TGeo.
...
//______________________________________________________________________________
TGeoHMatrix* AliClusterTGeo::GetMatrix(Bool_t original) const
{
...
//______________________________________________________________________________
const TGeoHMatrix* AliClusterTGeo::GetTracking2LocalMatrix() const
{
...
//______________________________________________________________________________
TGeoPNEntry* AliClusterTGeo::GetPNEntry() const
{
