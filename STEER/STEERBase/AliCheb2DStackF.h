...
class AliCheb2DStackF : public AliCheb2DStack
{
 ...
 protected:
  ...
  void          FillFunValues(stFun_t fun, int slice, const float *grid, const int np[2], float* vals);
  //
 protected:
  //
 ...
 private:
  ...
  //
  ClassDef(AliCheb2DStackF,2)        // stack of 2D->fDimOut Chebyshev parameterization slices
};
