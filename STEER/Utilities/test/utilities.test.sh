...
#--------------------------------------------------------------------------------------------------
# To run the test: 
# ( source $AliRoot_SRC/STEER/Utilities/test/utilities.test.sh; test_all) | tee  test.log
# cat test.log | grep SUCCES

# Run individual tests:
#     ( source $AliRoot_SRC/STEER/Utilities/test/utilities.test.sh; test_guessRunData)
#     ( source $AliRoot_SRC/STEER/Utilities/test/utilities.test.sh; test_OCDBYear)
#     ( source $AliRoot_SRC/STEER/Utilities/test/utilities.test.sh; test_paranoidCopy )
