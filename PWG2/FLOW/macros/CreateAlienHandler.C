AliAnalysisGrid* CreateAlienHandler() {
  ...
  //plugin->SetGridDataDir("/alice/data/2009/LHC09d/000104892/ESDs/pass3");
  plugin->SetGridDataDir("/alice/sim/LHC08d7a/");
  //plugin->SetGridDataDir("/alice/data/2009/LHC09d/000105054/ESDs/pass2");
  // Set data search pattern
  //plugin->SetDataPattern("*tag.root");
  //plugin->SetDataPattern("*ESD.tag.root");
  // ...then add run numbers to be considered
  plugin->AddRunNumber(122080);
  //plugin->AddRunNumber(125025);
  /*
  for(Int_t r=114040;r<=114044;r++)
  {
  ...
  */
  ...
  plugin->SetGridWorkingDir("hijingWithoutFlow/m0to100");
