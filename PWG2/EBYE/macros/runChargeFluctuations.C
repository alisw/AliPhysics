...
void runChargeFluctuations(Int_t analysisMode = kInteractive,
  ...
  //Configure the ChargeFluctuations object
  gROOT->LoadMacro("AddTaskChargeFluctuations.C");
  AliAnalysisTaskChargeFluctuations *taskChargeFluctuations = AddTaskChargeFluctuations();
