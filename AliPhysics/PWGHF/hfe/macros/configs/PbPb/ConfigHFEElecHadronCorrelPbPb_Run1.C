AliAnalysisTaskElecHadronCorrel_Run1* ConfigHFEElecHadronCorrelPbPb_Run1(Bool_t useMC,
...
//  hfecuts->SetQAOn();
 ...
 TString taskName = TaskName;
  ...
  AliAnalysisTaskElecHadronCorrel_Run1 *task = new AliAnalysisTaskElecHadronCorrel_Run1(taskName);
  printf("task ------------------------ %p\n ", task);
