...
nSigmaTOFpr                   nSigmaTOFpr                   nSigmaTOFpr                   nSigmaTOFpr                                                     'F'    [-999,34.6408157349]
nSigmaTPCpr                   nSigmaTPCpr                   nSigmaTPCpr                   nSigmaTPCpr                                                     'F'    [-2.99976944923,2.99991607666]
nSigmaTPCpi                   nSigmaTPCpi                   nSigmaTPCpi                   nSigmaTPCpi                                                     'F'    [-6.55109119415,7.17047023773]
nSigmaTPCka                   nSigmaTPCka                   nSigmaTPCka                   nSigmaTPCka                                                     'F'    [-4.32586193085,8.02573776245]
NSpec 15
...
#ifndef ReadBDT_LHC19c2a_8_12_noP_H
#define ReadBDT_LHC19c2a_8_12_noP_H
...
class ReadBDT_LHC19c2a_8_12_noP : public IClassifierReader
{
 public:
  // Deafult constructor added by ALICE user
  ReadBDT_LHC19c2a_8_12_noP()
      : IClassifierReader(),
        fClassName("ReadBDT_LHC19c2a_8_12_noP"),
        fNvars(11),
        fIsNormalised(false)
  {
    for (int i = 11; i--;)
  ...
  // constructor
 ReadBDT_LHC19c2a_8_12_noP( std::vector<std::string>& theInputVars )
   : IClassifierReader(),
    fClassName( "ReadBDT_LHC19c2a_8_12_noP" ),
    fNvars( 11 ),
    fIsNormalised(false)
   ...
   // destructor
   virtual ~ReadBDT_LHC19c2a_8_12_noP() {
