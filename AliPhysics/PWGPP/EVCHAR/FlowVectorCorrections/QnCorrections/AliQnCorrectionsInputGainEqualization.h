...
private:
  ...
  AliQnCorrectionsHistogramChannelizedSparse *fQANotValidatedBin;    //!<! the histogram with non validated bin information
...
/// \cond CLASSIMP
  ClassDef(AliQnCorrectionsInputGainEqualization, 2);
/// \endcond
};
