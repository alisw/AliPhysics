...
void proc_5568()
{
  ...
  const AliVdMMetaData vdmMetaData(AliVdMMetaData::GetFileName("5568/5568.xml"));

  TFile::Open(AliVdMMetaData::GetFileName("5568/vdm_time_5568_4m12_10p18_1_v3.root"), "READ");
  gDirectory->ls();
  TTree * VdM = nullptr;
  gFile->GetObject("VdM", VdM);
  VdM->AddFriend("DDL2", AliVdMMetaData::GetFileName("5568/vdm_DDL2_5568-4m12_10p18.root"));
