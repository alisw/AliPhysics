...
void AliITSQAchecks_pp(TString option="local",
			  Int_t nRun=225322,
			  TString period="LHC15l1a",
			  TString qaTrain="",
		    TString filenamedata= "MC.root",
		       TString filenameMC="DATA.root",
		       //TString filenameMC="/Users/beole/alice/QA/macros/macros_protoni/QAresults.root",
		    Int_t nRunMC=225322){
//    void AliITSQAchecks_pp_pileup(TString option="grid",                // grid analysis version
//                                  Int_t nRun=236150,
//                                  TString period="LHC15i",
//                                  TString qaTrain="",
//                                  TString filenamedata="QAresults.root",
//                                  TString filenameMC="alien:///alice/sim/2015/LHC15j1/236150/QAresults.root", // attenzione: gRunNumberMC!
//                                  Int_t nRunMC=236150){
...
/* $Id: AliITSQAchecks.C 53441 2011-12-06 16:30:40Z masera $ */
  ...
  if(aux.BeginsWith("alien:")){
    aux=aux.Remove(0,31); // era 35
//    aux=aux.Remove(9,aux.Length());  // OK per confronto con file di dati: 000244918
    aux=aux.Remove(6,aux.Length());    // OK per confronto con file MC: 244918
  ...
  if(option.Contains("local")){
    ...
    if(qaTrain.Contains("QA")){
      ...
      path=Form("/alice/data/%d/%s/%09d/ESDs/pass1/",year,period.Data(),nRun); // cambiare pass!!!
    }
