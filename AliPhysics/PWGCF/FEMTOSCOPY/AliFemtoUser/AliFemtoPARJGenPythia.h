#ifndef ALIFEMTOPARJPYTHIA_H
#define ALIFEMTOPARJPYTHIA_H
...
class AliFemtoPARJGenPythia : public AliGenMC
{
 public:
    ...
    AliFemtoPARJGenPythia();
    AliFemtoPARJGenPythia(Int_t npart);
    virtual ~AliFemtoPARJGenPythia();
...
//    virtual void  SetElectronMinPt(Float_t pt)        {fElectronMinPt = pt;}
  ...
  void LoadEvent(const TObjArray* stack, Int_t flag = 0, Int_t reHadr = 0);
    ...
    //baryon production
    void SetUseFemtoPARJ(Bool_t val) {fUseFemtoPARJ = val;}
    void SetPARJ1(Float_t p) {fPARJ_1 = p;}
    void SetPARJ2(Float_t p) {fPARJ_2 = p;}
    void SetPARJ3(Float_t p) {fPARJ_3 = p;}
    void SetPARJ4(Float_t p) {fPARJ_4 = p;}
    void SetPARJ5(Float_t p) {fPARJ_5 = p;}
    void SetPARJ6(Float_t p) {fPARJ_6 = p;}
    void SetPARJ7(Float_t p) {fPARJ_7 = p;}
    void SetPARJ8(Float_t p) {fPARJ_8 = p;}
    void SetPARJ9(Float_t p) {fPARJ_9 = p;}
    void SetPARJ10(Float_t p) {fPARJ_10 = p;}
 ...
 protected:
    ...
    // baryons
    Bool_t fUseFemtoPARJ;
    Float_t fPARJ_1; // PARJ parameter number 1 (baryons)
    Float_t fPARJ_2; // PARJ parameter number 2 (baryons)
    Float_t fPARJ_3; // PARJ parameter number 3 (baryons)
    Float_t fPARJ_4; // PARJ parameter number 4 (baryons)
    Float_t fPARJ_5; // PARJ parameter number 5 (baryons)
    Float_t fPARJ_6; // PARJ parameter number 6 (baryons)
    Float_t fPARJ_7; // PARJ parameter number 7 (baryons)
    Float_t fPARJ_8; // PARJ parameter number 8 (baryons)
    Float_t fPARJ_9; // PARJ parameter number 8 (baryons)
    Float_t fPARJ_10; // PARJ parameter number 8 (baryons)
 private:
    AliFemtoPARJGenPythia(const AliFemtoPARJGenPythia &Pythia);
    AliFemtoPARJGenPythia & operator=(const AliFemtoPARJGenPythia & rhs);
    ...
    ClassDef(AliFemtoPARJGenPythia, 15) // AliGenerator interface to Pythia
};
#endif
