#ifndef AliFemtoEPSelectionTaskThird_H
#define AliFemtoEPSelectionTaskThird_H
...
class AliFemtoEPSelectionTaskThird : public AliAnalysisTaskSE {

 public:
  
  enum ResoMethod{kRandom,kEta,kCharge};

  AliFemtoEPSelectionTaskThird();
  AliFemtoEPSelectionTaskThird(const char *name);
  virtual ~AliFemtoEPSelectionTaskThird();
 ...
 private:
  ...
  AliFemtoEPSelectionTaskThird(const AliFemtoEPSelectionTaskThird& ep);
  AliFemtoEPSelectionTaskThird& operator= (const AliFemtoEPSelectionTaskThird& ep); 
  ...
  ClassDef(AliFemtoEPSelectionTaskThird,4); 
};
