 ...
 * Dec 14, 2015: Soft gamma cut:                                     *
 * AliFemtoPairCutAntiGammaAlpha(0.9999,0.008,0)//theta ~1 degree    *
 *                                                                   *
 *********************************************************************/
...
//------------------- November 2013 -----------------------------------< 
	 ...
	 dtc2etaphitpc[aniter]->SetMaxImpactZ(DCAz);  
	  ...
	  //soft cut:
	  //AliFemtoPairCutAntiGammaAlpha(0.9999,0.008,0)//theta ~1 degree
	  sqpcetaphitpc[aniter]->SetMaxEEMinv(0.008);          //new antigamma cut
	  sqpcetaphitpc[aniter]->SetMaxAlphaDiff(0.9999);       //new antigamma cut
