  ...
  for (int imult=0; imult<numOfMultBins; imult++) {
	...
	if (runch[ichg]) {
		...
		runshlcms = 1;
	      ...
	      sqp1cetaphitpc[aniter]->SetMinAvgSeparation(0,0);
	      sqp1cetaphitpc[aniter]->SetMinAvgSeparation(1,0);
	      sqp1cetaphitpc[aniter]->SetMinAvgSeparation(2,0);
	      sqp1cetaphitpc[aniter]->SetMinAvgSeparation(3,0);
	      ...
	      sqp2cetaphitpc[aniter]->SetMinAvgSeparation(0,0); //0 - track-pos, 1 - track-neg
	      ...
	      sqp3cetaphitpc[aniter]->SetMinAvgSeparation(1,0);
