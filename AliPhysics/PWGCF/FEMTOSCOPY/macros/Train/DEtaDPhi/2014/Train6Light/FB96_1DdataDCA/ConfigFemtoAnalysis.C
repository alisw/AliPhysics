			...
			for (int ichg = 0; ichg < numOfChTypes; ichg++)
			{
				if (runch[ichg])
				{
					...
					dtc2etaphitpc[aniter]->SetElectronRejection(ifElectronRejection);
					    ...
					    dtc1etaphitpc[aniter]->SetMostProbable(12);
					    dtc2etaphitpc[aniter]->SetMass(ProtonMass);		
					    dtc2etaphitpc[aniter]->SetMostProbable(12);
                                          }
					...
					if (ichg == 3 ||ichg == 4 ||ichg == 5)//kaons 3-5
					    ...
					    dtc1etaphitpc[aniter]->SetMostProbable(11);
					    dtc2etaphitpc[aniter]->SetMass(KaonMass);
					    dtc2etaphitpc[aniter]->SetMostProbable(11);
					    ...
					    dtc1etaphitpc[aniter]->SetMostProbable(10);
					    dtc2etaphitpc[aniter]->SetMass(PionMass);		
					    dtc2etaphitpc[aniter]->SetMostProbable(10);
                                          }
                                        if (ichg == 9)//all
                                          {
					...
					*/
					...
					if(ichg==0 || ichg==1 || ichg==2)
					  cdedpetaphi[aniter]->LoadCorrectionTabFromROOTFile1D("alien:///alice/cern.ch/user/m/majanik/2014/DEtaDPhi/Trains/Corrections/Train4Light/1Dmap_FB96_DCA.root", AliFemtoCorrFctnDEtaDPhiCorrections::kProton, AliFemtoCorrFctnDEtaDPhiCorrections::kProton/*,1,1,1,0*/);
					//cdedpetaphi[aniter]->LoadCorrectionTabFromROOTFile("alien:///alice/cern.ch/user/m/majanik/2014/DEtaDPhi/Trains/Corrections/Train4Light/1Dmap_FB96_DCA.root", AliFemtoCorrFctnDEtaDPhiCorrections::kProton, AliFemtoCorrFctnDEtaDPhiCorrections::kProton,1,1,1,1);
					else if(ichg==3 || ichg==4 || ichg==5)
					  cdedpetaphi[aniter]->LoadCorrectionTabFromROOTFile1D("alien:///alice/cern.ch/user/m/majanik/2014/DEtaDPhi/Trains/Corrections/Train4Light/1Dmap_FB96_DCA.root", AliFemtoCorrFctnDEtaDPhiCorrections::kKaon, AliFemtoCorrFctnDEtaDPhiCorrections::kKaon/*,1,1,1,0*/);
					  //cdedpetaphi[aniter]->LoadCorrectionTabFromROOTFile("alien:///alice/cern.ch/user/m/majanik/2014/DEtaDPhi/Trains/Corrections/Train4Light/1Dmap_FB96_DCA.root", AliFemtoCorrFctnDEtaDPhiCorrections::kKaon, AliFemtoCorrFctnDEtaDPhiCorrections::kKaon,1,1,1,1);	
					 
					else if(ichg==6 || ichg==7 || ichg==8)
					  cdedpetaphi[aniter]->LoadCorrectionTabFromROOTFile1D("alien:///alice/cern.ch/user/m/majanik/2014/DEtaDPhi/Trains/Corrections/Train4Light/1Dmap_FB96_DCA.root", AliFemtoCorrFctnDEtaDPhiCorrections::kPion, AliFemtoCorrFctnDEtaDPhiCorrections::kPion/*,1,1,1,0*/);
					
					  //cdedpetaphi[aniter]->LoadCorrectionTabFromROOTFile("alien:///alice/cern.ch/user/m/majanik/2014/DEtaDPhi/Trains/Corrections/Train4Light/1Dmap_FB96_DCA.root", AliFemtoCorrFctnDEtaDPhiCorrections::kPion, AliFemtoCorrFctnDEtaDPhiCorrections::kPion,1,1,1,1);	
					
					else
					  cdedpetaphi[aniter]->LoadCorrectionTabFromROOTFile1D("alien:///alice/cern.ch/user/m/majanik/2014/DEtaDPhi/Trains/Corrections/Train4Light/1Dmap_FB96_DCA.root", AliFemtoCorrFctnDEtaDPhiCorrections::kAll, AliFemtoCorrFctnDEtaDPhiCorrections::kAll/*,1,1,1,0*/);
					  //cdedpetaphi[aniter]->LoadCorrectionTabFromROOTFile("alien:///alice/cern.ch/user/m/majanik/2014/DEtaDPhi/Trains/Corrections/Train4Light/1Dmap_FB96_DCA.root", AliFemtoCorrFctnDEtaDPhiCorrections::kAll, AliFemtoCorrFctnDEtaDPhiCorrections::kAll,1,1,1,1);
					...
					if (runktdep)
					{
					  ...
					  for(int kit=0;kit<=numOfkTbins;kit++)
						...
						for (int ikt=0; ikt<numOfkTbins; ikt++)
						{
							...
							if(ichg==0 || ichg==1 || ichg==2)
							  cdedpetaphiPt[ktm]->LoadCorrectionTabFromROOTFile1D("alien:///alice/cern.ch/user/m/majanik/2014/DEtaDPhi/Trains/Corrections/Train4Light/1Dmap_FB96_DCA.root", AliFemtoCorrFctnDEtaDPhiCorrections::kProton, AliFemtoCorrFctnDEtaDPhiCorrections::kProton/*,1,1,1,1*/);
							else if(ichg==3 || ichg==4 || ichg==5)
							  cdedpetaphiPt[ktm]->LoadCorrectionTabFromROOTFile1D("alien:///alice/cern.ch/user/m/majanik/2014/DEtaDPhi/Trains/Corrections/Train4Light/1Dmap_FB96_DCA.root", AliFemtoCorrFctnDEtaDPhiCorrections::kKaon, AliFemtoCorrFctnDEtaDPhiCorrections::kKaon);
							else if(ichg==6 || ichg==7 || ichg==8)
							  cdedpetaphiPt[ktm]->LoadCorrectionTabFromROOTFile1D("alien:///alice/cern.ch/user/m/majanik/2014/DEtaDPhi/Trains/Corrections/Train4Light/1Dmap_FB96_DCA.root", AliFemtoCorrFctnDEtaDPhiCorrections::kPion, AliFemtoCorrFctnDEtaDPhiCorrections::kPion);
							else
							  cdedpetaphiPt[ktm]->LoadCorrectionTabFromROOTFile1D("alien:///alice/cern.ch/user/m/majanik/2014/DEtaDPhi/Trains/Corrections/Train4Light/1Dmap_FB96_DCA.root", AliFemtoCorrFctnDEtaDPhiCorrections::kAll, AliFemtoCorrFctnDEtaDPhiCorrections::kAll);
