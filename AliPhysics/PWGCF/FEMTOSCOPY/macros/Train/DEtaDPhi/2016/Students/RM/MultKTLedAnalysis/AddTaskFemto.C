...
//     else
  ...
  //TFile *file = TFile::Open("alien:///alice/cern.ch/user/m/majanik/2015/DEtaDPhi/Trains/Corrections/CorrectionFiles/AnalysisNote/1Dmap_FB96_MCOnlyLHC10f6a_Exclusive2Rej3.root");
  //taskfemto->Set1DCorrectionsPions((TH1D*) file->Get("CorrectionFactorPtEffandContPion"));
  //taskfemto->Set1DCorrectionsKaons((TH1D*) file->Get("CorrectionFactorPtEffandContKaon"));
  //taskfemto->Set1DCorrectionsProtons((TH1D*) file->Get("CorrectionFactorPtEffandContProton"));
  //taskfemto->Set1DCorrectionsAll((TH1D*) file->Get("CorrectionFactorPtEffandContAll"));
  //taskfemto->Set1DCorrectionsLambdas((TH1D*) file->Get("CorrectionFactorPtEffandContAll"));
