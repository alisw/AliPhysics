...
AliGenerator* AddMCGenPythia_He3_EulogioMod(Float_t e_cms = 2760., Double_t ptHardMin = 0., Double_t ptHardMax = 1., Int_t tune = 2,Int_t cr=1, Double_t coalMom_d=0.100, Double_t coalMom_He3=0.127,Double_t coalMom_h3l=0.127, Double_t coalMom_hd=0.100, Float_t ptWeight=0) 
{
