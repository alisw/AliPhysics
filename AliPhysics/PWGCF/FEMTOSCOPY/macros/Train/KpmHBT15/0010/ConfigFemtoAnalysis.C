 ...
 *         KpmHBT14  0010  26-Feb-2016                               *
 *         TOF PID from 0.4 GeV/c                                    *
 *--- TPC Nsigma=1, TOF Nsigma=2,1,0.5-------------------------------*
...
> you need to change in your config to: SetDCAglobalTrack(kFALSE).*/
  ...
  AliFemtoKpmTrackCut           *dtc1etaphitpc[20];
  AliFemtoKpmTrackCut           *dtc2etaphitpc[20];
  ...
  for (int imult=0; imult<cMu/*4*/; imult++) {
	...
	if (runch[ichg]) {
	  ...
	  dtc1etaphitpc[aniter] = new AliFemtoKpmTrackCut();
	  dtc2etaphitpc[aniter] = new AliFemtoKpmTrackCut();//K+-
	  //--- K+- --->
...
//------------------- November 2013 -----------------------------------< 
	 ...
	 dtc1etaphitpc[aniter]->SetNsigmaTPCle250(1.0);
	 dtc1etaphitpc[aniter]->SetNsigmaTPC250_400(1.0);
	 dtc1etaphitpc[aniter]->SetNsigmaTPC400_450(1.0);//cut on e+e- orig(2.0);
	 dtc1etaphitpc[aniter]->SetNsigmaTPC450_500(1.0);//cut on e+e- orig(2.0);
	 ...
	 dtc1etaphitpc[aniter]->SetNsigmaTOF800_1000(1.0);
	 dtc1etaphitpc[aniter]->SetNsigmaTOFge1000(0.5);
	 ...
	 dtc2etaphitpc[aniter]->SetNsigmaTPCle250(1.0);
	 dtc2etaphitpc[aniter]->SetNsigmaTPC250_400(1.0);
	 dtc2etaphitpc[aniter]->SetNsigmaTPC400_450(1.0);//cut on e+e- orig(2.0);
	 dtc2etaphitpc[aniter]->SetNsigmaTPC450_500(1.0);//cut on e+e- orig(2.0);
	 dtc2etaphitpc[aniter]->SetNsigmaTPCge500(3.0);    
	 // new cuts are stronger, better separation of pion in TOF 
	 // when momentum is greater then 800 MeV/c
	 dtc2etaphitpc[aniter]->SetNsigmaTOF500_800(2.0);
	 dtc2etaphitpc[aniter]->SetNsigmaTOF800_1000(1.0);
	 dtc2etaphitpc[aniter]->SetNsigmaTOFge1000(0.5);
	 //K+ contour (default p0=9999, p1=0, p2=0):  
