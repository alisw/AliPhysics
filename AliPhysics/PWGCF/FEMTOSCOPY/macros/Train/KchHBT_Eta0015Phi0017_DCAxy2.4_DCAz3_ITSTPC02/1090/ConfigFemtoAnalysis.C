...
> you need to change in your config to: SetDCAglobalTrack(kFALSE).*/
    ...
    /*On 03/03/2014 06:39 PM, Maciej Szymański wrote:
> Dear Konstantin,
>
> could you please run again your KchKch analysis in the train using your
> previous option: SetDCAglobalTrack(kTRUE)?
>
> I updated the AliFemtoEventReaderAOD class and I removed reading the DCA
> of global tracks with the PropagateToDCA() method. Now, 'global' tracks
> are used to get the absolute position by calling GetXYZ() and then the
> position of the primary vertex is subtracted. See also
> https://indico.cern.ch/event/302741/contribution/1/material/slides/0.pdf
> (in particular slide 6).
>
> 	Best,
> 	Maciej
>*/
...
///	  dtc1etaphitpc[aniter]->SetMass(PionMass);
	  ...
	  dtc1etaphitpc[aniter]->SetNsigmaTPC400_450(2.0);//0.0);
	  dtc1etaphitpc[aniter]->SetNsigmaTPC450_500(2.0);//0.0);
