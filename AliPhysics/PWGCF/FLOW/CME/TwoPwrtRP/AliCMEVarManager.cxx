...
ClassImp(AliCMEVarManager)

const char* AliCMEVarManager::fgkParticleNames[AliCMEVarManager::kNMaxValues][3] = {
  ...
  {"CentralityV0mSPD",       "centrality_{V0M}-centrality_{SPD}",                 "(%)"},
...
AliPIDResponse* AliCMEVarManager::fgPIDResponse      = 0x0;
AliVEvent*      AliCMEVarManager::fgEvent            = 0x0;
AliEventplane*  AliCMEVarManager::fgTPCEventPlane    = 0x0;
AliKFVertex*    AliCMEVarManager::fgKFVertex         = 0x0;
TProfile*       AliCMEVarManager::fgMultEstimatorAvg[6][9] = {{0x0}};
TH3D*           AliCMEVarManager::fgTRDpidEff[10][4] = {{0x0}};
TObject*        AliCMEVarManager::fgLegEffMap           = 0x0;
TObject*        AliCMEVarManager::fgPairEffMap          = 0x0;
TBits*          AliCMEVarManager::fgFillMap          = 0x0;
Double_t        AliCMEVarManager::fgTRDpidEffCentRanges[10][4] = {{0.0}};
TString         AliCMEVarManager::fgVZEROCalibrationFile = "";
TString         AliCMEVarManager::fgVZERORecenteringFile = "";
TString         AliCMEVarManager::fgZDCRecenteringFile = "";
TProfile2D*     AliCMEVarManager::fgVZEROCalib[64] = {0x0};
TProfile2D*     AliCMEVarManager::fgVZERORecentering[2][2] = {{0x0,0x0},{0x0,0x0}};
TProfile3D*     AliCMEVarManager::fgZDCRecentering[3][2] = {{0x0,0x0},{0x0,0x0},{0x0,0x0}};
Int_t           AliCMEVarManager::fgCurrentRun = -1;
Float_t         AliCMEVarManager::fgData[AliCMEVarManager::kNMaxValues] = {0.};
//________________________________________________________________
AliCMEVarManager::AliCMEVarManager() :
  TNamed("AliCMEVarManager","AliCMEVarManager")
{
  //
  // Default constructor
  //
...
//________________________________________________________________
AliCMEVarManager::AliCMEVarManager(const char* name, const char* title) :
  TNamed(name,title)
{
  //
  // Named constructor
...
//________________________________________________________________
UInt_t AliCMEVarManager::GetValueType(const char* valname) {
  //
  // Get value type by value name
  //

  TString name(valname);
  for(UInt_t i=0; i<AliCMEVarManager::kNMaxValues; i++) {
