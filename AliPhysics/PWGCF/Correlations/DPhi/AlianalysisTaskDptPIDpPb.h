#ifndef AlianalysisTaskDptPIDpPb_H_Included
#define AlianalysisTaskDptPIDpPb_H_Included
...
class AlianalysisTaskDptPIDpPb : public AliAnalysisTaskSE
{
public:
  AlianalysisTaskDptPIDpPb();  
  AlianalysisTaskDptPIDpPb(const TString & name);
  
private:
  AlianalysisTaskDptPIDpPb(const  AlianalysisTaskDptPIDpPb&);
  const AlianalysisTaskDptPIDpPb& operator=(const  AlianalysisTaskDptPIDpPb&);

public:
  virtual ~AlianalysisTaskDptPIDpPb();
...
protected:      
 ...
 //float * _phi_1;             //!
  ...
  ClassDef(AlianalysisTaskDptPIDpPb,1)
}; 
