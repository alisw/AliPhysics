#ifndef AliAnalysisTaskpypy_H_Included
#define AliAnalysisTaskpypy_H_Included
...
class AliAnalysisTaskpypy : public AliAnalysisTaskSE
{
public:
  AliAnalysisTaskpypy();  
  AliAnalysisTaskpypy(const TString & name);
  
private:
  AliAnalysisTaskpypy(const  AliAnalysisTaskpypy&);
  const AliAnalysisTaskpypy& operator=(const  AliAnalysisTaskpypy&);

public:
  virtual ~AliAnalysisTaskpypy();
...
protected:      
 ...
 //float * _phi_1;             //!
  ...
  TString vsEtaPhi; 
  TString vsPtVsPt;
  ClassDef(AliAnalysisTaskpypy,1)
}; 
