#ifndef AliAnaTaskMomScan_H_Included
#define AliAnaTaskMomScan_H_Included
...
class AliAnaTaskMomScan : public AliAnalysisTaskSE
{
public:
  AliAnaTaskMomScan();  
  AliAnaTaskMomScan(const TString & name);
  
private:
  AliAnaTaskMomScan(const  AliAnaTaskMomScan&);
  const AliAnaTaskMomScan& operator=(const  AliAnaTaskMomScan&);

public:
  virtual ~AliAnaTaskMomScan();
