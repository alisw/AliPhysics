...
AliAnalysisTask *AddTaskNucleiv2(TString name="name",Int_t ptctype =1,Bool_t dcacut = kFALSE, Float_t vzmax=10., TString CentEstim = "V0M", TString AnalysisType = "ESD", Int_t year = 2015, Int_t harmonic = 2){
