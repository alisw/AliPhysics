AliAnalysisTaskKinkPbPbMC* AddTaskKinkPbPbMC(TString lCustomName="",Float_t lRadiusKUp=200.0, Float_t lRadiusKLow= 130.0, Int_t lNCluster=30, Float_t lLowQtValue=0.12, Float_t yRange=0.5, Float_t lnsigma=3.5, Float_t maxChi=4.0, Float_t Zpos=2.0, Bool_t strongAntiPile = kTRUE, Bool_t sevenSigma = kTRUE, Bool_t sixSigma = kFALSE, Bool_t eightSigma = kFALSE)
   {
     //pp settings         
	...
	AliMCEventHandler* handler = new AliMCEventHandler;
    	...
    	AliAnalysisTaskKinkPbPbMC  *task = new AliAnalysisTaskKinkPbPbMC("AliAnalysisTaskKinkPbPbMC", lRadiusKUp, lRadiusKLow, lNCluster, lLowQtValue, yRange, lnsigma, maxChi, Zpos, strongAntiPile, sevenSigma, sixSigma, eightSigma);
