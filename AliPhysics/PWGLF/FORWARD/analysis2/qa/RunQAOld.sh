...
export PATH=$PATH:$ALICE_PHYSICS/PWGLF/FORWARD/analysis2/qa:../scripts
...
scr=$ALICE_PHYSICS/PWGLF/FORWARD/analysis2/qa/RunQAOld.C
...
style= 
if test -f $ALICE_PHYSICS/PWGLF/FORWARD/analysis2/qa/style.css ; then 
    style=$ALICE_PHYSICS/PWGLF/FORWARD/analysis2/qa/style.css
