...
//SPD
      ...
      fHistXCheckVertexerZ(0)
{
    // Dummy Constructor
    for(Int_t iV0selIdx   = 0; iV0selIdx   < 7; iV0selIdx++   ) {
        fV0Sels          [iV0selIdx   ] = -1.;
    }
}
...
//----------------------------------
    ...
    if(! fHistXCheckVertexerZ) {
        fHistXCheckVertexerZ = new TH2F("fHistXCheckVertexerZ",
                                        "X-check on Vertexer Z effects",
                                        2, 0, 2, 100,0,100);
        fListHistV0->Add(fHistXCheckVertexerZ);
    }
    ...
    {   // This is the begining of the loop on tracks
                ...
                (lCurrentParticleForLambdaCheck->GetPdgCode() == -3122 ) )
        {
            ...
            if( lPdgcodeCurrentPart == 3122 ) {
                ...
                if(lStackNatural) {
                    f3dHistPrimRawPtVsYVsMultNonInjLambda->Fill(lPtCurrentPart, lRapCurrentPart, lMultiplicity);
                }
            ...
            if( lPdgcodeCurrentPart == -3122 ) {
                ...
                if(lStackNatural) {
                    f3dHistPrimRawPtVsYVsMultNonInjAntiLambda->Fill(lPtCurrentPart, lRapCurrentPart, lMultiplicity);
                }
            ...
            if( lPdgcodeCurrentPart == 310 ) {
                ...
                if(lStackNatural) {
                    f3dHistPrimRawPtVsYVsMultNonInjK0Short->Fill(lPtCurrentPart, lRapCurrentPart, lMultiplicity);
                }
            ...
            if( !(lCurrentParticleForLambdaCheck->GetDaughter(0) < 0) ) {
                ...
                if(lDght0ofV0) { // skip if not defined.
                    ...
                    if(TMath::Abs( lPdgcodeCurrentPart ) == 3122 ) {
                        lV0Mass = 1.115683;
                    }
