AliAnalysisTaskStrangenessVsMultiplicityRun2pPb *AddTaskStrangenessVsMultiplicityRun2pPb( Bool_t lSaveEventTree = kTRUE, Bool_t lSaveV0 = kTRUE, Bool_t lSaveCascade = kTRUE, TString lExtraOptions = "", const TString lMasterJobSessionFlag = "")
{
    ...
    AliAnalysisTaskStrangenessVsMultiplicityRun2pPb *taskAuxiliary = new AliAnalysisTaskStrangenessVsMultiplicityRun2pPb(lSaveEventTree, lSaveV0, lSaveCascade, "taskAuxiliary", lExtraOptions);
