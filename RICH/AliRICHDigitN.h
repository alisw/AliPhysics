#ifndef AliRICHDigitN_h
#define AliRICHDigitN_h
/* Copyright(c) 1998-1999, ALICE Experiment at CERN, All rights reserved. *
 * See cxx source for full Copyright notice                               */

#include <AliDigit.h>      //base class  

class AliRICHDigitN :public AliDigit //TObject-AliDigit-AliRICHDigit
{
public:
...
//ctor&dtor    
           AliRICHDigitN(                                     ):AliDigit(),fPad(Abs(-1,-1,-1,-1)) ,fQdc(-1)  {} //default ctor
  inline   AliRICHDigitN(Int_t c,Float_t x,Float_t y,Float_t q);                                                //ctor 
  virtual ~AliRICHDigitN()                                {} //dtor
//framework part    
...
protected:
  ...
  ClassDef(AliRICHDigitN,4) //RICH digit class       
};//class AliRICHDigitN
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
Int_t AliRICHDigitN::Compare(const TObject *pObj) const
{
...
//   Retunrs: -1 if AbsPad less then in pObj, 1 if more and 0 if they are the same      
  if     (fPad==((AliRICHDigitN*)pObj)->Pad()) return  0;
  else if(fPad >((AliRICHDigitN*)pObj)->Pad()) return  1;
  else                                         return -1;
}
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
AliRICHDigitN::AliRICHDigitN(Int_t c,Float_t x,Float_t y,Float_t q):AliDigit(),fPad(Abs(-1,-1,-1,-1)),fQdc(-1)
{
