...
: TNamed(), 
fSig(0),fTau(0),fN(0),fPed(0),fAmp(0),fAmpErr(0),
fT0(0),fT0Err(0),fChi2(0.),fNDF(0),
...
: TNamed(name, title), 
fSig(sig),fTau(tau),fN(n),fPed(0),fAmp(0),fAmpErr(0),
fT0(0),fT0Err(0),fChi2(0.),fNDF(0),
fNoFit(0),fNfit(0),fTfit(0),fAmpfit(0), fStdFun(0)
{
...
: TNamed(obj), 
fSig(0),fTau(0),fN(2.),fPed(0), fAmp(0),fAmpErr(0),
fT0(0),fT0Err(0),fChi2(0.),fNDF(0) 
,fNoFit(0),fNfit(0),fTfit(0),fAmpfit(0), fStdFun(0)
{ }
...
/// h - histogram with altro response, could have empty bin
...
///
/// Input:
/// \param t   - array of time bins
/// \param y   - array of amplitudes after pedestal subtractions;
/// \param nPoints  - number of points 
/// \param sig   - error of amplitude measurement (one value for all channels)
/// \param tau   - filter time response (in timebin units)
/// Output:
/// \param amp - amplitude at t0;
/// \param eamp - error of amplitude; 
/// \param t0 - time of max amplitude; 
/// \param et0 - error of t0;
/// \param chi2 - chi2
//____________________________________________________________________________
...
///
/// Get amplitude 
/// Calculate parameters error too.
