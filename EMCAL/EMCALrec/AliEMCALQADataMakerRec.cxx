...
{  
  ...
  Int_t col2d = 0;
  Int_t row2d = 0;
  Int_t TRU,ADC,EtaTRU,PhiTRU,EtaSM,PhiSM;
  for (Int_t ibin = 1; ibin <= nbinsProf; ibin++) 
  {
    ...
    Bool_t info = ((AliEMCALTriggerMappingV2*)fGeom->GetTriggerMapping()) ->
    GetInfoFromAbsFastORIndex(towerNum, TRU, ADC, EtaTRU, PhiTRU, iSM, EtaSM, PhiSM);
