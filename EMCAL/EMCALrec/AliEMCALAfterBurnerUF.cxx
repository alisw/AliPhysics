...
///
/// \param logWeight: energy log weight of cell parameter, recommended 4.5
/// \param ecaLocMaxCut: minimum energy difference between maxima, recomended 0.03 GeV
/// \param minECut: minimum cell energy
///
//------------------------------------------------------------------------
...
///
/// \param clusArray: list of clusters/recPoints
//------------------------------------------------------------------------
...
/// Unfold clusters.
///
/// \param clusArray: TObjArray with list of clusters, input and output
/// \param cellsEMCAL: list of EMCAL cells
//------------------------------------------------------------------------
