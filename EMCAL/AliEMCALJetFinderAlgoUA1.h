...
#ifndef ALIEMCALJETFINDERALGOUA1_H
#define ALIEMCALJETFINDERALGOUA1_H
...
class AliEMCALJetFinderAlgoUA1 : public AliEMCALJetFinderAlgo
{

public:
  AliEMCALJetFinderAlgoUA1();
  ~AliEMCALJetFinderAlgoUA1();
  void InitUnitArray();                      
...
protected:
  ...
  ClassDef(AliEMCALJetFinderAlgoUA1,1)
