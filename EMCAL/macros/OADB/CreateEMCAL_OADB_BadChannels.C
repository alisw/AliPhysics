...
/// At the end, an OADB container is created receiving these arrays.
/// The histograms with bad channels can be made by a list of towers ID ( see the macro CreateEMCAL_OADB_BadChannelsHistos.C ) or 
...
/// Bad channels histograms must be in existing root files
/// Main method
///
void CreateEMCAL_OADB_BadChannels()
{
  const char *fileName10_1	=	"BadChannels2010_1.root";
  ...
  const char *fileName11c2	=	"BadChannels2011_11c2.root"; 
