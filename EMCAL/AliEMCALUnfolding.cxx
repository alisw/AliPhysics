					  ...
					  Float_t * maxAtEnergy)
{
  ...
  Float_t maximumEne=0.;//0 -> 0. changed
  ...
  while(iparam < nPar )
  {
	...
	//fNumberOfECAClusters--; //it should be like that we don't want to decrease cluster number
	nSplittedClusters--;
