void MakeADPMGainsEntry(const char *outputCDB = "local://$ALICE_ROOT/OCDB")
{
  ...
  Double_t b[16] = {6.957, 6.282, 6.109, 6.125, 6.452, 6.990, 6.099, 6.261,
		    6.549, 5.725, 6.879, 6.471, 6.580, 6.486, 5.848, 6.246};
#else
  // LHC18b HV gain scan (284706-)
  Double_t a[16] = {1345.4, 1482.3, 1416.0, 1381.2, 1433.2, 1310.0, 1302.8, 1455.1,
                    1438.6, 1428.8, 1273.3, 1324.0, 1403.0, 1283.7, 1303.2, 1349.1};

  Double_t b[16] = {6.419, 6.166, 5.910, 6.607, 6.547, 6.451, 6.162, 6.765,
                    6.208, 6.551, 6.255, 6.571, 6.193, 6.592, 5.941, 6.620};
#endif
  ...
  AliCDBId id("AD/Calib/PMGains", 284706, AliCDBRunRange::Infinity());
  man->Put(gains, id, md);
